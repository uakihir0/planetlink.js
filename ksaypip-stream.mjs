...
class StreamClient {
  constructor(uri, accessToken) {
    this.vna_1 = new WebsocketRequest();
    this.wna_1 = false;
    this.xna_1 = null;
    this.yna_1 = null;
    this.zna_1 = null;
...
class StreamResourceImpl {
  constructor(uri, accessToken) {
    this.bnb_1 = uri;
    this.cnb_1 = accessToken;
  }
  dnb() {
    return new RoomStreamImpl(this.bnb_1, this.cnb_1);
  }
}
class Companion {}
class $serializer {
  constructor() {
    ...
    this.enb_1 = tmp0_serialDesc;
  }
  fnb(encoder, value) {
    var tmp0_desc = this.enb_1;
    var tmp1_output = encoder.y13(tmp0_desc);
    if (tmp1_output.u15(tmp0_desc, 0) ? true : !(value.gnb_1 === '')) {
      tmp1_output.n15(tmp0_desc, 0, value.gnb_1);
    }
    if (tmp1_output.u15(tmp0_desc, 1) ? true : !(value.hnb_1 === '')) {
      tmp1_output.n15(tmp0_desc, 1, value.hnb_1);
    }
    tmp1_output.z13(tmp0_desc);
  }
  tz(encoder, value) {
    return this.fnb(encoder, value instanceof Envelope ? value : THROW_CCE());
  }
  uz(decoder) {
    var tmp0_desc = this.enb_1;
    var tmp1_flag = true;
    ...
    return Envelope.inb(tmp3_bitMask0, tmp4_local0, tmp5_local1, null);
  }
  gz() {
    return this.enb_1;
  }
...
class Envelope {
  ...
  static inb(seen0, type, postId, serializationConstructorMarker) {
    if (!(0 === (0 & seen0))) {
      throwMissingFieldException(seen0, 0, $serializer_getInstance().enb_1);
    }
...
class RealtimeEventParser {
  tw(message) {
    ...
    try {
      ...
      var this_0 = InternalUtility_getInstance().qn8_1;
    ...
    var envelope = tmp;
    var tmp_1;
    switch (envelope.gnb_1) {
      case 'post.created':
      case 'post.deleted':
        // Inline function 'kotlin.also' call

        var this_3 = new RealtimeEvent();
        this_3.type = envelope.gnb_1;
        this_3.postId = envelope.hnb_1;
        tmp_1 = this_3;
        break;
      default:
        tmp_1 = null;
...
class RoomStreamImpl {
  constructor(uri, accessToken) {
    this.jnb_1 = uri;
    this.knb_1 = accessToken;
    this.lnb_1 = null;
    this.mnb_1 = null;
    this.nnb_1 = null;
  }
  onb(listener, lifeCycle) {
    // Inline function 'kotlin.also' call
    this.lnb_1 = listener;
    this.mnb_1 = lifeCycle;
    return this;
  }
  *p37($completion) {
    var tmp0 = this.lnb_1;
    ...
    // Inline function 'kotlin.also' call
    var this_1 = new StreamClient(StreamEndpoint_instance.pnb(this.jnb_1), this.knb_1);
    this.nnb_1 = this_1;
    var client = this_1;
    var tmp_0 = client;
    tmp_0.xna_1 = RoomStreamListener$onEvent$ref(listener);
    var tmp_1 = client;
    tmp_1.yna_1 = LifeCycleListener$onConnect$ref(lifeCycle);
    var tmp_2 = client;
    tmp_2.zna_1 = LifeCycleListener$onDisconnect$ref(lifeCycle);
    var tmp_3 = client;
    tmp_3.anb_1 = LifeCycleListener$onError$ref(lifeCycle);
    yield* client.p37($completion);
    return Unit_instance;
  }
  f7() {
    var tmp0_safe_receiver = this.nnb_1;
  ...
  vco() {
    var tmp0_safe_receiver = this.nnb_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.wna_1;
...
function StreamClient$lambda(this$0) {
  return (it) => {
    this$0.wna_1 = true;
    var tmp0_safe_receiver = this$0.yna_1;
    if (tmp0_safe_receiver == null)
      null;
    else
      tmp0_safe_receiver();
...
function StreamClient$lambda_0(this$0) {
  return (it) => {
    this$0.wna_1 = false;
    var tmp0_safe_receiver = this$0.zna_1;
    if (tmp0_safe_receiver == null)
      null;
    else
      tmp0_safe_receiver();
...
function StreamClient$lambda_1(this$0) {
  return (it) => {
    var tmp0_safe_receiver = this$0.anb_1;
    if (tmp0_safe_receiver == null)
      null;
    else
