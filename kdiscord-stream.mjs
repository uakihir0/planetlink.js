...
class $serializer {
  constructor() {
    ...
    this.jlh_1 = tmp0_serialDesc;
  }
  klh(encoder, value) {
    var tmp0_desc = this.jlh_1;
    var tmp1_output = encoder.y13(tmp0_desc);
    if (tmp1_output.u15(tmp0_desc, 0) ? true : !(value.llh_1 === 0)) {
      tmp1_output.i15(tmp0_desc, 0, value.llh_1);
    }
    if (tmp1_output.u15(tmp0_desc, 1) ? true : !(value.mlh_1 == null)) {
      tmp1_output.q15(tmp0_desc, 1, JsonElementSerializer_getInstance(), value.mlh_1);
    }
    if (tmp1_output.u15(tmp0_desc, 2) ? true : !(value.nlh_1 == null)) {
      tmp1_output.q15(tmp0_desc, 2, IntSerializer_getInstance(), value.nlh_1);
    }
    if (tmp1_output.u15(tmp0_desc, 3) ? true : !(value.olh_1 == null)) {
      tmp1_output.q15(tmp0_desc, 3, StringSerializer_getInstance(), value.olh_1);
    }
    tmp1_output.z13(tmp0_desc);
  }
  tz(encoder, value) {
    return this.klh(encoder, value instanceof GatewayPayload ? value : THROW_CCE());
  }
  uz(decoder) {
    var tmp0_desc = this.jlh_1;
    var tmp1_flag = true;
    ...
    return GatewayPayload.plh(tmp3_bitMask0, tmp4_local0, tmp5_local1, tmp6_local2, tmp7_local3, null);
  }
  gz() {
    return this.jlh_1;
  }
...
class GatewayPayload {
  ...
  static plh(seen0, op, d, s, t, serializationConstructorMarker) {
    if (!(0 === (0 & seen0))) {
      throwMissingFieldException(seen0, 0, $serializer_getInstance_0().jlh_1);
    }
...
class $serializer_0 {
  constructor() {
    ...
    this.qlh_1 = tmp0_serialDesc;
  }
  rlh(encoder, value) {
    var tmp0_desc = this.qlh_1;
    var tmp1_output = encoder.y13(tmp0_desc);
    if (tmp1_output.u15(tmp0_desc, 0) ? true : !(value.slh_1 === 0n)) {
      tmp1_output.j15(tmp0_desc, 0, value.slh_1);
    }
    tmp1_output.z13(tmp0_desc);
  }
  tz(encoder, value) {
    return this.rlh(encoder, value instanceof HelloData ? value : THROW_CCE());
  }
  uz(decoder) {
    var tmp0_desc = this.qlh_1;
    var tmp1_flag = true;
    ...
    return HelloData.tlh(tmp3_bitMask0, tmp4_local0, null);
  }
  gz() {
    return this.qlh_1;
  }
...
class HelloData {
  ...
  static tlh(seen0, heartbeatInterval, serializationConstructorMarker) {
    if (!(0 === (0 & seen0))) {
      throwMissingFieldException(seen0, 0, $serializer_getInstance_1().qlh_1);
    }
    var $this = createThis(this);
    if (0 === (seen0 & 1))
      $this.slh_1 = 0n;
    else
      $this.slh_1 = heartbeatInterval;
    return $this;
  }
}
class Companion_1 {}
class $serializer_1 {
  ...
  vlh(encoder, value) {
    ...
    var tmp1_output = encoder.y13(tmp0_desc);
    tmp1_output.n15(tmp0_desc, 0, value.wlh_1);
    if (tmp1_output.u15(tmp0_desc, 1) ? true : !equals(value.xlh_1, new IdentifyProperties())) {
      tmp1_output.p15(tmp0_desc, 1, $serializer_getInstance_3(), value.xlh_1);
    }
    if (tmp1_output.u15(tmp0_desc, 2) ? true : !(value.ylh_1 === false)) {
      tmp1_output.f15(tmp0_desc, 2, value.ylh_1);
    }
    if (tmp1_output.u15(tmp0_desc, 3) ? true : !equals(value.zlh_1, new PresenceData())) {
      tmp1_output.p15(tmp0_desc, 3, $serializer_getInstance_4(), value.zlh_1);
    }
    tmp1_output.z13(tmp0_desc);
  }
  tz(encoder, value) {
    return this.vlh(encoder, value instanceof IdentifyPayload ? value : THROW_CCE());
  }
  uz(decoder) {
    var tmp0_desc = this.ulh_1;
    var tmp1_flag = true;
    ...
    tmp8_input.z13(tmp0_desc);
    return IdentifyPayload.ali(tmp3_bitMask0, tmp4_local0, tmp5_local1, tmp6_local2, tmp7_local3, null);
  }
  gz() {
    return this.ulh_1;
  }
...
class IdentifyPayload {
  constructor(token, properties, compress, presence) {
    ...
    this.wlh_1 = token;
    this.xlh_1 = properties;
    this.ylh_1 = compress;
    this.zlh_1 = presence;
  }
  static ali(seen0, token, properties, compress, presence, serializationConstructorMarker) {
    if (!(1 === (1 & seen0))) {
      throwMissingFieldException(seen0, 1, $serializer_getInstance_2().ulh_1);
    }
    var $this = createThis(this);
    $this.wlh_1 = token;
    if (0 === (seen0 & 2))
      $this.xlh_1 = new IdentifyProperties();
    else
      $this.xlh_1 = properties;
    if (0 === (seen0 & 4))
      $this.ylh_1 = false;
...
class $serializer_2 {
  ...
  cli(encoder, value) {
    ...
    var tmp1_output = encoder.y13(tmp0_desc);
    if (tmp1_output.u15(tmp0_desc, 0) ? true : !(value.dli_1 === 'Windows')) {
      tmp1_output.n15(tmp0_desc, 0, value.dli_1);
    }
    if (tmp1_output.u15(tmp0_desc, 1) ? true : !(value.eli_1 === 'Chrome')) {
      tmp1_output.n15(tmp0_desc, 1, value.eli_1);
    }
    if (tmp1_output.u15(tmp0_desc, 2) ? true : !(value.fli_1 === '')) {
      tmp1_output.n15(tmp0_desc, 2, value.fli_1);
    }
    tmp1_output.z13(tmp0_desc);
  }
  tz(encoder, value) {
    return this.cli(encoder, value instanceof IdentifyProperties ? value : THROW_CCE());
  }
  uz(decoder) {
    var tmp0_desc = this.bli_1;
    var tmp1_flag = true;
    ...
    return IdentifyProperties.gli(tmp3_bitMask0, tmp4_local0, tmp5_local1, tmp6_local2, null);
  }
  gz() {
    return this.bli_1;
  }
...
class IdentifyProperties {
  ...
  static gli(seen0, os, browser, device, serializationConstructorMarker) {
    if (!(0 === (0 & seen0))) {
      throwMissingFieldException(seen0, 0, $serializer_getInstance_3().bli_1);
    }
    var $this = createThis(this);
    if (0 === (seen0 & 1))
      $this.dli_1 = 'Windows';
...
class Companion_3 {
  constructor() {
    ...
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp.hli_1 = [null, lazy(tmp_0, PresenceData$Companion$$childSerializers$_anonymous__yjkh7f), null, null];
  }
}
class $serializer_3 {
  constructor() {
    ...
    this.ili_1 = tmp0_serialDesc;
  }
  jli(encoder, value) {
    var tmp0_desc = this.ili_1;
    var tmp1_output = encoder.y13(tmp0_desc);
    var tmp2_cached = Companion_getInstance_3().hli_1;
    if (tmp1_output.u15(tmp0_desc, 0) ? true : !(value.kli_1 == null)) {
      tmp1_output.q15(tmp0_desc, 0, LongSerializer_getInstance(), value.kli_1);
    }
    var tmp;
    if (tmp1_output.u15(tmp0_desc, 1)) {
      tmp = true;
    } else {
      var tmp_0 = value.lli_1;
      // Inline function 'kotlin.emptyArray' call
      var tmp$ret$0 = [];
      tmp = !equals(tmp_0, tmp$ret$0);
    }
    if (tmp) {
      tmp1_output.p15(tmp0_desc, 1, tmp2_cached[1].d3(), value.lli_1);
    }
    if (tmp1_output.u15(tmp0_desc, 2) ? true : !(value.mli_1 === 'online')) {
      tmp1_output.n15(tmp0_desc, 2, value.mli_1);
    }
    if (tmp1_output.u15(tmp0_desc, 3) ? true : !(value.nli_1 === false)) {
      tmp1_output.f15(tmp0_desc, 3, value.nli_1);
    }
    tmp1_output.z13(tmp0_desc);
  }
  tz(encoder, value) {
    return this.jli(encoder, value instanceof PresenceData ? value : THROW_CCE());
  }
  uz(decoder) {
    var tmp0_desc = this.ili_1;
    var tmp1_flag = true;
    ...
    var tmp8_input = decoder.y13(tmp0_desc);
    var tmp9_cached = Companion_getInstance_3().hli_1;
    if (tmp8_input.n14()) {
    ...
    tmp8_input.z13(tmp0_desc);
    return PresenceData.oli(tmp3_bitMask0, tmp4_local0, tmp5_local1, tmp6_local2, tmp7_local3, null);
  }
  gz() {
    return this.ili_1;
  }
  g1c() {
    var tmp0_cached = Companion_getInstance_3().hli_1;
    // Inline function 'kotlin.arrayOf' call
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
...
class PresenceData {
  constructor(since, activities, status, afk) {
    ...
    this.kli_1 = since;
    this.lli_1 = activities;
    this.mli_1 = status;
    this.nli_1 = afk;
  }
  static oli(seen0, since, activities, status, afk, serializationConstructorMarker) {
    Companion_getInstance_3();
    if (!(0 === (0 & seen0))) {
      throwMissingFieldException(seen0, 0, $serializer_getInstance_4().ili_1);
    }
    var $this = createThis(this);
    if (0 === (seen0 & 1))
      $this.kli_1 = null;
...
class $serializer_4 {
  constructor() {
    ...
    this.pli_1 = tmp0_serialDesc;
  }
  qli(encoder, value) {
    var tmp0_desc = this.pli_1;
    var tmp1_output = encoder.y13(tmp0_desc);
  ...
  tz(encoder, value) {
    return this.qli(encoder, value instanceof ReadyData ? value : THROW_CCE());
  }
  uz(decoder) {
    var tmp0_desc = this.pli_1;
    var tmp1_flag = true;
    ...
    tmp8_input.z13(tmp0_desc);
    return ReadyData.rli(tmp3_bitMask0, tmp4_local0, tmp5_local1, tmp6_local2, tmp7_local3, null);
  }
  gz() {
    return this.pli_1;
  }
...
class ReadyData {
  ...
  static rli(seen0, v, user, sessionId, resumeGatewayUrl, serializationConstructorMarker) {
    if (!(0 === (0 & seen0))) {
      throwMissingFieldException(seen0, 0, $serializer_getInstance_5().pli_1);
    }
    var $this = createThis(this);
    if (0 === (seen0 & 1))
      $this.v = null;
...
class $serializer_5 {
  constructor() {
    ...
    this.wli_1 = tmp0_serialDesc;
  }
  xli(encoder, value) {
    var tmp0_desc = this.wli_1;
    var tmp1_output = encoder.y13(tmp0_desc);
    tmp1_output.n15(tmp0_desc, 0, value.yli_1);
    tmp1_output.n15(tmp0_desc, 1, value.zli_1);
    tmp1_output.i15(tmp0_desc, 2, value.alj_1);
    tmp1_output.z13(tmp0_desc);
  }
  tz(encoder, value) {
    return this.xli(encoder, value instanceof ResumePayload ? value : THROW_CCE());
  }
  uz(decoder) {
    var tmp0_desc = this.wli_1;
    var tmp1_flag = true;
    ...
    tmp7_input.z13(tmp0_desc);
    return ResumePayload.blj(tmp3_bitMask0, tmp4_local0, tmp5_local1, tmp6_local2, null);
  }
  gz() {
    return this.wli_1;
  }
...
class ResumePayload {
  constructor(token, sessionId, seq) {
    this.yli_1 = token;
    this.zli_1 = sessionId;
    this.alj_1 = seq;
  }
  static blj(seen0, token, sessionId, seq, serializationConstructorMarker) {
    if (!(7 === (7 & seen0))) {
      throwMissingFieldException(seen0, 7, $serializer_getInstance_6().wli_1);
    }
    var $this = createThis(this);
    $this.yli_1 = token;
    $this.zli_1 = sessionId;
...
class MessageCreateEvent {
  constructor(message) {
    this.elj_1 = message;
    this.flj_1 = 'MESSAGE_CREATE';
  }
}
class MessageUpdateEvent {
  constructor(message) {
    this.glj_1 = message;
    this.hlj_1 = 'MESSAGE_UPDATE';
  }
}
class MessageDeleteGatewayEvent {
  constructor(data) {
    this.ilj_1 = data;
    this.jlj_1 = 'MESSAGE_DELETE';
  }
}
class GuildCreateEvent {
  constructor(guild) {
    this.klj_1 = guild;
    this.llj_1 = 'GUILD_CREATE';
  }
}
class PresenceUpdateGatewayEvent {
  constructor(data) {
    this.mlj_1 = data;
    this.nlj_1 = 'PRESENCE_UPDATE';
  }
}
class UnknownEvent {
...
class $serializer_6 {
  constructor() {
    ...
    this.qlj_1 = tmp0_serialDesc;
  }
  rlj(encoder, value) {
    var tmp0_desc = this.qlj_1;
    var tmp1_output = encoder.y13(tmp0_desc);
  ...
  tz(encoder, value) {
    return this.rlj(encoder, value instanceof MessageDeleteEvent ? value : THROW_CCE());
  }
  uz(decoder) {
    var tmp0_desc = this.qlj_1;
    var tmp1_flag = true;
    ...
    tmp7_input.z13(tmp0_desc);
    return MessageDeleteEvent.slj(tmp3_bitMask0, tmp4_local0, tmp5_local1, tmp6_local2, null);
  }
  gz() {
    return this.qlj_1;
  }
...
class MessageDeleteEvent {
  ...
  static slj(seen0, id, channelId, guildId, serializationConstructorMarker) {
    if (!(0 === (0 & seen0))) {
      throwMissingFieldException(seen0, 0, $serializer_getInstance_7().qlj_1);
    }
    var $this = createThis(this);
    if (0 === (seen0 & 1))
      $this.id = null;
...
class $serializer_7 {
  ...
  tz(encoder, value) {
    return this.ulj(encoder, value instanceof PresenceUpdateEvent ? value : THROW_CCE());
  }
  uz(decoder) {
    var tmp0_desc = this.tlj_1;
    var tmp1_flag = true;
    ...
    tmp7_input.z13(tmp0_desc);
    return PresenceUpdateEvent.vlj(tmp3_bitMask0, tmp4_local0, tmp5_local1, tmp6_local2, null);
  }
  gz() {
    return this.tlj_1;
  }
...
class PresenceUpdateEvent {
  ...
  static vlj(seen0, user, guildId, status, serializationConstructorMarker) {
    if (!(0 === (0 & seen0))) {
      throwMissingFieldException(seen0, 0, $serializer_getInstance_8().tlj_1);
    }
    var $this = createThis(this);
    if (0 === (seen0 & 1))
      $this.user = null;
...
class GatewayClient {
  constructor(apiHost, token) {
    this.zlj_1 = apiHost;
    this.alk_1 = token;
    this.blk_1 = DiscordFactory_instance.instanceWithApiHost(this.alk_1, this.zlj_1);
    var tmp = this;
    // Inline function 'kotlin.collections.mutableListOf' call
    tmp.clk_1 = ArrayList.j2();
    this.dlk_1 = null;
    this.elk_1 = false;
    this.flk_1 = false;
    this.glk_1 = 0n;
    ...
    this.nlk_1 = null;
    this.olk_1 = 1000n;
    this.plk_1 = CoroutineScope(Dispatchers_getInstance().k2h_1.mp(SupervisorJob()));
    this.qlk_1 = Channel(2147483647);
    this.rlk_1 = false;
  }
  addEventListener(listener) {
    this.clk_1.i2(listener);
  }
  removeEventListener(listener) {
    this.clk_1.f4(listener);
  }
  isConnected() {
    return this.elk_1;
  }
  *ci2($completion) {
    ...
    this.olk_1 = 1000n;
    var tmp = this;
    var tmp_0 = this.plk_1;
    tmp.nlk_1 = launch(tmp_0, VOID, VOID, GatewayClient$start$slambda(this));
  ...
  *di2($completion) {
  ...
  stop() {
    this.flk_1 = true;
    var tmp0_safe_receiver = this.mlk_1;
    if (tmp0_safe_receiver == null)
      null;
    else {
      tmp0_safe_receiver.b27();
    }
    var tmp1_safe_receiver = this.llk_1;
    if (tmp1_safe_receiver == null)
      null;
    else {
      tmp1_safe_receiver.b27();
    }
    var tmp2_safe_receiver = this.nlk_1;
    ...
    try {
      var tmp3_safe_receiver = this.dlk_1;
    ...
    var _iterator__ex2g4s = this.clk_1.l1();
    ...
    try {
      ...
      switch (type) {
        ...
        case 'MESSAGE_UPDATE':
          ...
          var this_6 = InternalUtility_getInstance().qlf_1;
          // Inline function 'kotlinx.serialization.serializer' call
        ...
        case 'MESSAGE_DELETE':
          ...
          var this_9 = InternalUtility_getInstance().qlf_1;
          // Inline function 'kotlinx.serialization.serializer' call
        ...
        case 'GUILD_CREATE':
          ...
          var this_12 = InternalUtility_getInstance().qlf_1;
          // Inline function 'kotlinx.serialization.serializer' call
        ...
        case 'PRESENCE_UPDATE':
          ...
          var this_15 = InternalUtility_getInstance().qlf_1;
          // Inline function 'kotlinx.serialization.serializer' call
...
function *fetchGatewayUrl($this, $completion) {
  var response = yield* getGateway$virtualSuspendBridge($this.blk_1.gateway(), $completion);
...
function *handleFrame($this, raw, $completion) {
  ...
  var tmp0_safe_receiver = payload.nlh_1;
  if (tmp0_safe_receiver == null)
    null;
  else {
    // Inline function 'kotlin.let' call
    $this.hlk_1 = tmp0_safe_receiver;
  }
  switch (payload.llh_1) {
    case 10:
      var tmp2 = payload.mlh_1;
      var tmp$ret$5;
      $l$block: {
      ...
      var hello = tmp$ret$5;
      var tmp_1 = $this;
      var tmp3_elvis_lhs = hello == null ? null : hello.slh_1;
      tmp_1.glk_1 = tmp3_elvis_lhs == null ? 0n : tmp3_elvis_lhs;
      startHeartbeat($this);
      if ($this.rlk_1 && !($this.ilk_1 == null) && !($this.hlk_1 == null)) {
...
function dispatch($this, payload) {
  var tmp0_elvis_lhs = payload.olh_1;
  var tmp;
  if (tmp0_elvis_lhs == null) {
    return Unit_instance;
  } else {
  ...
  if (type === 'READY') {
    ...
    var ready = tmp$ret$0;
    if (!(ready == null)) {
      $this.ilk_1 = ready.sessionId;
      $this.jlk_1 = ready.resumeGatewayUrl;
      $this.elk_1 = true;
      $this.olk_1 = 1000n;
      // Inline function 'kotlin.collections.forEach' call
      var _iterator__ex2g4s = $this.clk_1.l1();
  ...
  var event = GatewayEventSerializer_instance.slk(type, payload.mlh_1);
  if (event instanceof ReadyEvent) {
    // Inline function 'kotlin.collections.forEach' call
    var _iterator__ex2g4s_0 = $this.clk_1.l1();
    while (_iterator__ex2g4s_0.m1()) {
      var element_0 = _iterator__ex2g4s_0.n1();
      element_0.onReady(event.clj_1);
    }
  } else {
    if (event instanceof MessageCreateEvent) {
      // Inline function 'kotlin.collections.forEach' call
      var _iterator__ex2g4s_1 = $this.clk_1.l1();
      while (_iterator__ex2g4s_1.m1()) {
        var element_1 = _iterator__ex2g4s_1.n1();
        element_1.onMessageCreate(event.elj_1);
      }
    } else {
      if (event instanceof MessageUpdateEvent) {
        // Inline function 'kotlin.collections.forEach' call
        var _iterator__ex2g4s_2 = $this.clk_1.l1();
        while (_iterator__ex2g4s_2.m1()) {
          var element_2 = _iterator__ex2g4s_2.n1();
          element_2.onMessageUpdate(event.glj_1);
        }
      } else {
        if (event instanceof MessageDeleteGatewayEvent) {
          // Inline function 'kotlin.collections.forEach' call
          var _iterator__ex2g4s_3 = $this.clk_1.l1();
          while (_iterator__ex2g4s_3.m1()) {
            var element_3 = _iterator__ex2g4s_3.n1();
            element_3.onMessageDelete(event.ilj_1);
          }
        } else {
          if (event instanceof GuildCreateEvent) {
            // Inline function 'kotlin.collections.forEach' call
            var _iterator__ex2g4s_4 = $this.clk_1.l1();
            while (_iterator__ex2g4s_4.m1()) {
              var element_4 = _iterator__ex2g4s_4.n1();
              element_4.onGuildCreate(event.klj_1);
            }
          } else {
            if (event instanceof PresenceUpdateGatewayEvent) {
              // Inline function 'kotlin.collections.forEach' call
              var _iterator__ex2g4s_5 = $this.clk_1.l1();
              while (_iterator__ex2g4s_5.m1()) {
                var element_5 = _iterator__ex2g4s_5.n1();
                element_5.onPresenceUpdate(event.mlj_1);
              }
            } else {
              if (event instanceof UnknownEvent) {
                // Inline function 'kotlin.collections.forEach' call
                var _iterator__ex2g4s_6 = $this.clk_1.l1();
                while (_iterator__ex2g4s_6.m1()) {
                  var element_6 = _iterator__ex2g4s_6.n1();
                  element_6.onUnknownEvent(event.olj_1, event.plj_1);
                }
              }
            }
          }
...
function startHeartbeat($this) {
  var tmp0_safe_receiver = $this.llk_1;
  if (tmp0_safe_receiver == null)
    null;
  else {
    tmp0_safe_receiver.b27();
  ...
  var tmp = $this;
  var tmp_0 = $this.plk_1;
  tmp.llk_1 = launch(tmp_0, VOID, VOID, GatewayClient$startHeartbeat$slambda($this));
}
function *sendHeartbeat($this, $completion) {
  var tmp0_safe_receiver = $this.hlk_1;
  var tmp;
  if (tmp0_safe_receiver == null) {
    tmp = null;
  } else {
  ...
  var tmp2_safe_receiver = $this.dlk_1;
  if (tmp2_safe_receiver == null)
    null;
  else
...
function *sendIdentify($this, $completion) {
  var identify = new IdentifyPayload($this.alk_1);
  // Inline function 'kotlinx.serialization.json.buildJsonObject' call
  var builder = new JsonObjectBuilder();
  ...
  var json = builder.c1o();
  var tmp0_safe_receiver = $this.dlk_1;
  if (tmp0_safe_receiver == null)
    null;
  else
...
function *sendResume($this, $completion) {
  var resume = new ResumePayload($this.alk_1, ensureNotNull($this.ilk_1), ensureNotNull($this.hlk_1));
  // Inline function 'kotlinx.serialization.json.buildJsonObject' call
  var builder = new JsonObjectBuilder();
...
function closeSocketForReconnect($this) {
  ...
  try {
    var tmp1_safe_receiver = $this.dlk_1;
    if (tmp1_safe_receiver == null)
      null;
    else {
...
function scheduleReconnect($this, resume) {
  ...
  var tmp = $this;
  var tmp_0 = $this.plk_1;
  tmp.mlk_1 = launch(tmp_0, VOID, VOID, GatewayClient$scheduleReconnect$slambda($this, resume));
}
...
function GatewayClient$start$slambda(this$0) {
  return constructCallableReference(function *($this$launch, $completion) {
    var _iterator__ex2g4s = this$0.qlk_1.l1();
...
function GatewayClient$openWebSocket$lambda_0(this$0) {
  return (it) => {
    this$0.elk_1 = false;
    var tmp0_safe_receiver = this$0.llk_1;
    if (tmp0_safe_receiver == null)
      null;
    else {
      tmp0_safe_receiver.b27();
    ...
    var tmp;
    if (!this$0.flk_1) {
      scheduleReconnect(this$0, !(this$0.ilk_1 == null));
      tmp = Unit_instance;
    } else {
      // Inline function 'kotlin.collections.forEach' call
      var _iterator__ex2g4s = this$0.clk_1.l1();
      while (_iterator__ex2g4s.m1()) {
        var element = _iterator__ex2g4s.n1();
        element.onClose();
      }
...
function GatewayClient$startHeartbeat$slambda(this$0) {
  return constructCallableReference(function *($this$launch, $completion) {
    ...
    $l$loop: while (get_isActive($this$launch)) {
      ...
      yield* delay(this$0.glk_1, $completion);
    }
    return Unit_instance;
  }, 1);
}
function GatewayClient$scheduleReconnect$slambda(this$0, $resume) {
  return constructCallableReference(function *($this$launch, $completion) {
    yield* delay(this$0.olk_1, $completion);
    var tmp = this$0;
    // Inline function 'kotlin.Long.times' call
    var this_0 = this$0.olk_1;
    // Inline function 'kotlin.comparisons.minOf' call
    var a = multiply(this_0, fromInt(2));
    tmp.olk_1 = a <= 30000n ? a : 30000n;
    var tmp_0;
    if (this$0.flk_1) {
      return Unit_instance;
    }
