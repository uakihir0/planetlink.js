...
class Bit32Digest extends Digest {
  ...
  w90(input, offset) {
    ...
    Big_getInstance().a92(input, x, 0, offset, sourceIndexEnd);
    ...
    var k = Companion_getInstance().c92_1;
    var state = this.j92_1;
    var a = state[0];
    var b = state[1];
    var c = state[2];
    var d = state[3];
  ...
  u90(buf, bufPos) {
    var digest = new Int8Array(this.q90());
    this.m92(digest, 0, buf, bufPos);
    return digest;
  }
  m92(dest, destOffset, buf, bufPos) {
    var tmp0_container = this.k92_1.p91(bufPos).f91();
    var bitsLo = tmp0_container.pm();
    var bitsHi = tmp0_container.qm();
    buf[bufPos] = -128;
    if ((bufPos + 1 | 0) > 56) {
      this.w90(buf, 0);
      fill(buf, 0, 0, 56);
    ...
    // Inline function 'org.kotlincrypto.bitops.endian.Big.bePackIntoUnsafe' call
    Big_getInstance();
    Big_getInstance().y91(bitsHi, buf, 56);
    // Inline function 'org.kotlincrypto.bitops.endian.Big.bePackIntoUnsafe' call
    Big_getInstance();
    Big_getInstance().y91(bitsLo, buf, 60);
    this.w90(buf, 0);
    Big_getInstance();
    var tmp2 = this.j92_1;
    // Inline function 'org.kotlincrypto.bitops.endian.Big.bePackIntoUnsafe' call
    var sourceIndexEnd = this.q90() / 4 | 0;
    Big_getInstance().z91(tmp2, dest, destOffset, 0, sourceIndexEnd);
  }
  v90() {
    fill_0(this.i92_1, 0);
    var tmp0 = this.h92_1;
    // Inline function 'kotlin.collections.copyInto' call
    var destination = this.j92_1;
...
class Companion_0 {
  constructor() {
    ...
    var tmp = this;
    // Inline function 'kotlin.intArrayOf' call
    tmp.n92_1 = new Int32Array([1779033703, -1150833019, 1013904242, -1521486534, 1359893119, -1694144372, 528734635, 1541459225]);
  }
}
class SHA256 extends Bit32Digest {
  static w92() {
    Companion_getInstance_0();
    var $this = this.l92(256, Companion_getInstance_0().n92_1);
...
initMetadataForClass(SHA256, 'SHA256', SHA256.w92);
//endregion
