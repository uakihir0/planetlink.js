...
import { Big_getInstance2a0hzz2j69bgw as Big_getInstance } from './bitops-library-endian.mjs';
...
class Bit32Digest extends Digest {
  ...
  y8i(input, offset) {
    ...
    Big_getInstance().c8k(input, x, 0, offset, sourceIndexEnd);
    ...
    var k = Companion_getInstance().e8k_1;
    var state = this.l8k_1;
    var a = state[0];
    var b = state[1];
    var c = state[2];
    var d = state[3];
  ...
  w8i(buf, bufPos) {
    var digest = new Int8Array(this.s8i());
    this.o8k(digest, 0, buf, bufPos);
    return digest;
  }
  o8k(dest, destOffset, buf, bufPos) {
    var tmp0_container = this.m8k_1.r8j(bufPos).h8j();
    var bitsLo = tmp0_container.nl();
    var bitsHi = tmp0_container.ol();
    buf[bufPos] = -128;
    if ((bufPos + 1 | 0) > 56) {
      this.y8i(buf, 0);
      fill(buf, 0, 0, 56);
    ...
    // Inline function 'org.kotlincrypto.bitops.endian.Big.bePackIntoUnsafe' call
    Big_getInstance();
    Big_getInstance().a8k(bitsHi, buf, 56);
    // Inline function 'org.kotlincrypto.bitops.endian.Big.bePackIntoUnsafe' call
    Big_getInstance();
    Big_getInstance().a8k(bitsLo, buf, 60);
    this.y8i(buf, 0);
    Big_getInstance();
    var tmp2 = this.l8k_1;
    // Inline function 'org.kotlincrypto.bitops.endian.Big.bePackIntoUnsafe' call
    var sourceIndexEnd = this.s8i() / 4 | 0;
    Big_getInstance().b8k(tmp2, dest, destOffset, 0, sourceIndexEnd);
  }
  x8i() {
    fill_0(this.k8k_1, 0);
    var tmp0 = this.j8k_1;
    // Inline function 'kotlin.collections.copyInto' call
    var destination = this.l8k_1;
...
class Companion_0 {
  constructor() {
    ...
    var tmp = this;
    // Inline function 'kotlin.intArrayOf' call
    tmp.p8k_1 = new Int32Array([1779033703, -1150833019, 1013904242, -1521486534, 1359893119, -1694144372, 528734635, 1541459225]);
  }
}
class SHA256 extends Bit32Digest {
  static y8k() {
    Companion_getInstance_0();
    var $this = this.n8k(256, Companion_getInstance_0().p8k_1);
...
initMetadataForClass(SHA256, 'SHA256', SHA256.y8k);
//endregion
