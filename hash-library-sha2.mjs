...
class Bit32Digest extends Digest {
  ...
  e8w(input, offset) {
    ...
    Big_getInstance().i8x(input, x, 0, offset, sourceIndexEnd);
    ...
    var k = Companion_getInstance().k8x_1;
    var state = this.r8x_1;
    var a = state[0];
    var b = state[1];
    var c = state[2];
    var d = state[3];
  ...
  c8w(buf, bufPos) {
    var digest = new Int8Array(this.y8v());
    this.u8x(digest, 0, buf, bufPos);
    return digest;
  }
  u8x(dest, destOffset, buf, bufPos) {
    var tmp0_container = this.s8x_1.x8w(bufPos).n8w();
    var bitsLo = tmp0_container.mm();
    var bitsHi = tmp0_container.nm();
    buf[bufPos] = -128;
    if ((bufPos + 1 | 0) > 56) {
      this.e8w(buf, 0);
      fill(buf, 0, 0, 56);
    ...
    // Inline function 'org.kotlincrypto.bitops.endian.Big.bePackIntoUnsafe' call
    Big_getInstance();
    Big_getInstance().g8x(bitsHi, buf, 56);
    // Inline function 'org.kotlincrypto.bitops.endian.Big.bePackIntoUnsafe' call
    Big_getInstance();
    Big_getInstance().g8x(bitsLo, buf, 60);
    this.e8w(buf, 0);
    Big_getInstance();
    var tmp2 = this.r8x_1;
    // Inline function 'org.kotlincrypto.bitops.endian.Big.bePackIntoUnsafe' call
    var sourceIndexEnd = this.y8v() / 4 | 0;
    Big_getInstance().h8x(tmp2, dest, destOffset, 0, sourceIndexEnd);
  }
  d8w() {
    fill_0(this.q8x_1, 0);
    var tmp0 = this.p8x_1;
    // Inline function 'kotlin.collections.copyInto' call
    var destination = this.r8x_1;
...
class Companion_0 {
  constructor() {
    ...
    var tmp = this;
    // Inline function 'kotlin.intArrayOf' call
    tmp.v8x_1 = new Int32Array([1779033703, -1150833019, 1013904242, -1521486534, 1359893119, -1694144372, 528734635, 1541459225]);
  }
}
class SHA256 extends Bit32Digest {
  static e8y() {
    Companion_getInstance_0();
    var $this = this.t8x(256, Companion_getInstance_0().v8x_1);
...
initMetadataForClass(SHA256, 'SHA256', SHA256.e8y);
//endregion
