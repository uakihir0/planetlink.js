...
class Bit32Digest extends Digest {
  ...
  q8x(input, offset) {
    ...
    Big_getInstance().u8y(input, x, 0, offset, sourceIndexEnd);
    ...
    var k = Companion_getInstance().w8y_1;
    var state = this.d8z_1;
    var a = state[0];
    var b = state[1];
    var c = state[2];
    var d = state[3];
  ...
  o8x(buf, bufPos) {
    var digest = new Int8Array(this.k8x());
    this.g8z(digest, 0, buf, bufPos);
    return digest;
  }
  g8z(dest, destOffset, buf, bufPos) {
    var tmp0_container = this.e8z_1.j8y(bufPos).z8x();
    var bitsLo = tmp0_container.nm();
    var bitsHi = tmp0_container.om();
    buf[bufPos] = -128;
    if ((bufPos + 1 | 0) > 56) {
      this.q8x(buf, 0);
      fill(buf, 0, 0, 56);
    ...
    // Inline function 'org.kotlincrypto.bitops.endian.Big.bePackIntoUnsafe' call
    Big_getInstance();
    Big_getInstance().s8y(bitsHi, buf, 56);
    // Inline function 'org.kotlincrypto.bitops.endian.Big.bePackIntoUnsafe' call
    Big_getInstance();
    Big_getInstance().s8y(bitsLo, buf, 60);
    this.q8x(buf, 0);
    Big_getInstance();
    var tmp2 = this.d8z_1;
    // Inline function 'org.kotlincrypto.bitops.endian.Big.bePackIntoUnsafe' call
    var sourceIndexEnd = this.k8x() / 4 | 0;
    Big_getInstance().t8y(tmp2, dest, destOffset, 0, sourceIndexEnd);
  }
  p8x() {
    fill_0(this.c8z_1, 0);
    var tmp0 = this.b8z_1;
    // Inline function 'kotlin.collections.copyInto' call
    var destination = this.d8z_1;
...
class Companion_0 {
  constructor() {
    ...
    var tmp = this;
    // Inline function 'kotlin.intArrayOf' call
    tmp.h8z_1 = new Int32Array([1779033703, -1150833019, 1013904242, -1521486534, 1359893119, -1694144372, 528734635, 1541459225]);
  }
}
class SHA256 extends Bit32Digest {
  static q8z() {
    Companion_getInstance_0();
    var $this = this.f8z(256, Companion_getInstance_0().h8z_1);
...
initMetadataForClass(SHA256, 'SHA256', SHA256.q8z);
//endregion
