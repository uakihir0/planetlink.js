...
class StringTranslator {
  ...
  ad1(input) {
    var stringBuilder = StringBuilder.ec(imul(input.length, 2));
...
class AggregateTranslator extends StringTranslator {
  static wd0() {
    ...
    tmp.vd0_1 = ArrayList.o2();
    return $this;
  }
  static yd0(translators) {
    var $this = this.wd0();
    addAll($this.vd0_1, translators);
    return $this;
  }
  zd0(input, offset, stringBuilder) {
    var _iterator__ex2g4s = this.vd0_1.l1();
    while (_iterator__ex2g4s.m1()) {
      var translator = _iterator__ex2g4s.n1();
      var consumed = translator.zd0(input, offset, stringBuilder);
      if (!(consumed === 0)) {
        return consumed;
      }
    }
...
class EntityMaps {
  constructor() {
    ...
    tmp.fd1_1 = toList(encodeMap);
    this.gd1_1 = invert(this, this.fd1_1);
  }
}
class KsoupEntities {
  constructor() {
    ...
    tmp.od1_1 = AggregateTranslator.yd0([LookupTranslator.ld1(EntityMaps_getInstance().bd1_1), LookupTranslator.ld1(encodeXml11Map), Companion_instance_0.md1(1, 8), Companion_instance_0.md1(14, 31), Companion_instance_0.md1(127, 132), Companion_instance_0.md1(134, 159), UnicodeUnpairedSurrogateRemover.nd1()]);
    this.pd1_1 = AggregateTranslator.yd0([LookupTranslator.ld1(EntityMaps_getInstance().dd1_1)]);
    this.qd1_1 = AggregateTranslator.yd0([LookupTranslator.ld1(EntityMaps_getInstance().fd1_1), Companion_instance_0.md1(1, 8), Companion_instance_0.md1(14, 31), Companion_instance_0.md1(127, 132), Companion_instance_0.md1(134, 159)]);
    this.rd1_1 = AggregateTranslator.yd0([LookupTranslator.ld1(EntityMaps_getInstance().ed1_1), NumericEntityDecoder.vd1([])]);
    this.sd1_1 = AggregateTranslator.yd0([LookupTranslator.ld1(EntityMaps_getInstance().gd1_1), NumericEntityDecoder.vd1([])]);
    this.td1_1 = AggregateTranslator.yd0([LookupTranslator.ld1(EntityMaps_getInstance().cd1_1), NumericEntityDecoder.vd1([])]);
  }
  wd1(input) {
    return this.sd1_1.ad1(input);
  }
  xd1(input) {
    return this.wd1(input);
  }
}
class LookupTranslator extends StringTranslator {
  static ld1(lookupMap) {
    var $this = this.xd0();
    var tmp = $this;
    // Inline function 'kotlin.collections.mutableMapOf' call
    tmp.hd1_1 = LinkedHashMap.l5();
    var tmp_0 = $this;
    // Inline function 'kotlin.collections.mutableSetOf' call
    tmp_0.id1_1 = LinkedHashSet.q2();
    ...
    while (_iterator__ex2g4s.m1()) {
      ...
      $this.id1_1.e2(new UShort(tmp$ret$4));
      var sz = key.length;
    ...
    $this.jd1_1 = currentShortest;
    $this.kd1_1 = currentLongest;
    return $this;
  }
  zd0(input, offset, stringBuilder) {
    // Inline function 'kotlin.code' call
    ...
    if (this.id1_1.n2(new UShort(tmp$ret$1))) {
      var max = this.kd1_1;
      if ((offset + this.kd1_1 | 0) > input.length) {
      ...
      if (last <= inductionVariable)
        do {
          ...
          var result = this.hd1_1.p4(toString(subSeq));
          if (!(result == null)) {
...
class CodePointTranslator extends StringTranslator {
  ...
  zd0(input, offset, stringBuilder) {
    ...
    var consumed = this.zd1(codePoint, stringBuilder);
    return consumed ? 1 : 0;
  }
}
...
class Companion {
  constructor() {
    ...
    this.ad2_1 = setOf(Option_SemiColonRequired_getInstance());
  }
}
class NumericEntityDecoder extends StringTranslator {
  static vd1(options) {
    ...
    if (options.length === 0) {
      tmp_0 = Companion_getInstance().ad2_1;
    } else {
  ...
  zd0(input, offset, stringBuilder) {
    ...
    if (charCodeAt(input, offset) === _Char___init__impl__6a9atx(38) && offset < (seqEnd - 2 | 0) && charCodeAt(input, offset + 1 | 0) === _Char___init__impl__6a9atx(35)) {
      ...
      if (entityValue > 65535) {
        ...
        var indexedObject = CharsUtils_instance.dd2(entityValue);
...
class Companion_0 {
  md1(codePointLow, codePointHigh) {
    return NumericEntityEncoder.gd2(numberRangeToNumber(codePointLow, codePointHigh), true);
  }
}
class NumericEntityEncoder extends CodePointTranslator {
  static gd2(range, between) {
    var $this = this.yd1();
    $this.ed2_1 = range;
    $this.fd2_1 = between;
    return $this;
  ...
  static hd2() {
    return this.gd2(numberRangeToNumber(0, 2147483647), true);
  }
  zd1(codePoint, stringBuilder) {
    if (!(this.fd2_1 === this.ed2_1.uq(codePoint))) {
      return false;
    }
    stringBuilder.i1('&#');
...
function translate($this, input, stringBuilder) {
  ...
  $l$loop: while (pos < len) {
    var consumed = $this.zd0(input, pos, stringBuilder);
    if (consumed === 0) {
...
initMetadataForClass(AggregateTranslator, 'AggregateTranslator', AggregateTranslator.wd0);
...
initMetadataForClass(NumericEntityEncoder, 'NumericEntityEncoder', NumericEntityEncoder.hd2);
initMetadataForClass(UnicodeUnpairedSurrogateRemover, 'UnicodeUnpairedSurrogateRemover', UnicodeUnpairedSurrogateRemover.nd1);
...
export {
  KsoupEntities_getInstance as KsoupEntities_getInstance28t21p34hs21f,
};
//endregion
