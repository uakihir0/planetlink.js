...
class AggregateTranslator extends StringTranslator {
  constructor() {
    return new.target.fcm();
  }
  static fcm() {
    var $this = this.gcm();
    var tmp = $this;
    // Inline function 'kotlin.collections.mutableListOf' call
    tmp.ecm_1 = ArrayList.j2();
    return $this;
  }
  static hcm(translators) {
    var $this = this.fcm();
    addAll($this.ecm_1, translators);
    return $this;
  }
  icm(input, offset, stringBuilder) {
    var _iterator__ex2g4s = this.ecm_1.l1();
    while (_iterator__ex2g4s.m1()) {
      var translator = _iterator__ex2g4s.n1();
      var consumed = translator.icm(input, offset, stringBuilder);
      if (!(consumed === 0)) {
        return consumed;
      }
    }
...
class EntityMaps {
  constructor() {
    ...
    tmp.ocm_1 = toList(encodeMap);
    this.pcm_1 = invert(this, this.ocm_1);
  }
}
class KsoupEntities {
  constructor() {
    ...
    tmp.xcm_1 = AggregateTranslator.hcm([LookupTranslator.ucm(EntityMaps_getInstance().kcm_1), LookupTranslator.ucm(encodeXml11Map), Companion_instance_0.vcm(1, 8), Companion_instance_0.vcm(14, 31), Companion_instance_0.vcm(127, 132), Companion_instance_0.vcm(134, 159), UnicodeUnpairedSurrogateRemover.wcm()]);
    this.ycm_1 = AggregateTranslator.hcm([LookupTranslator.ucm(EntityMaps_getInstance().mcm_1)]);
    this.zcm_1 = AggregateTranslator.hcm([LookupTranslator.ucm(EntityMaps_getInstance().ocm_1), Companion_instance_0.vcm(1, 8), Companion_instance_0.vcm(14, 31), Companion_instance_0.vcm(127, 132), Companion_instance_0.vcm(134, 159)]);
    this.acn_1 = AggregateTranslator.hcm([LookupTranslator.ucm(EntityMaps_getInstance().ncm_1), NumericEntityDecoder.ecn([])]);
    this.bcn_1 = AggregateTranslator.hcm([LookupTranslator.ucm(EntityMaps_getInstance().pcm_1), NumericEntityDecoder.ecn([])]);
    this.ccn_1 = AggregateTranslator.hcm([LookupTranslator.ucm(EntityMaps_getInstance().lcm_1), NumericEntityDecoder.ecn([])]);
  }
  fcn(input) {
    return this.bcn_1.jcm(input);
  }
  gcn(input) {
    return this.fcn(input);
  }
}
class LookupTranslator extends StringTranslator {
  constructor(lookupMap) {
    return new.target.ucm(lookupMap);
  }
  static ucm(lookupMap) {
    var $this = this.gcm();
    var tmp = $this;
    // Inline function 'kotlin.collections.mutableMapOf' call
    tmp.qcm_1 = LinkedHashMap.r5();
    var tmp_0 = $this;
    // Inline function 'kotlin.collections.mutableSetOf' call
    tmp_0.rcm_1 = LinkedHashSet.p2();
    ...
    while (_iterator__ex2g4s.m1()) {
      ...
      $this.rcm_1.e2(new UShort(tmp$ret$4));
      var sz = key.length;
    ...
    $this.scm_1 = currentShortest;
    $this.tcm_1 = currentLongest;
    return $this;
  }
  icm(input, offset, stringBuilder) {
    // Inline function 'kotlin.code' call
    ...
    if (this.rcm_1.o2(new UShort(tmp$ret$1))) {
      var max = this.tcm_1;
      if ((offset + this.tcm_1 | 0) > input.length) {
      ...
      if (last <= inductionVariable)
        do {
          ...
          var result = this.qcm_1.v4(toString(subSeq));
          if (!(result == null)) {
...
class CodePointTranslator extends StringTranslator {
  ...
  icm(input, offset, stringBuilder) {
    ...
    var consumed = this.icn(codePoint, stringBuilder);
    return consumed ? 1 : 0;
  }
}
...
class Companion {
  constructor() {
    ...
    this.jcn_1 = setOf(Option_SemiColonRequired_getInstance());
  }
}
class NumericEntityDecoder extends StringTranslator {
  constructor(options) {
    return new.target.ecn(options);
  }
  static ecn(options) {
    ...
    if (options.length === 0) {
      tmp_0 = Companion_getInstance().jcn_1;
    } else {
  ...
  icm(input, offset, stringBuilder) {
    ...
    if (charCodeAt(input, offset) === _Char___init__impl__6a9atx(38) && offset < (seqEnd - 2 | 0) && charCodeAt(input, offset + 1 | 0) === _Char___init__impl__6a9atx(35)) {
      ...
      if (entityValue > 65535) {
        ...
        var indexedObject = CharsUtils_instance.mcn(entityValue);
...
class Companion_0 {
  vcm(codePointLow, codePointHigh) {
    return NumericEntityEncoder.pcn(numberRangeToNumber(codePointLow, codePointHigh), true);
  }
}
class NumericEntityEncoder extends CodePointTranslator {
  constructor(range, between) {
    return new.target.pcn(range, between);
  }
  static pcn(range, between) {
    var $this = this.hcn();
    $this.ncn_1 = range;
    $this.ocn_1 = between;
    return $this;
  ...
  static qcn() {
    return this.pcn(numberRangeToNumber(0, 2147483647), true);
  }
  icn(codePoint, stringBuilder) {
    if (!(this.ocn_1 === this.ncn_1.yr(codePoint))) {
      return false;
    }
    stringBuilder.i1('&#');
...
function translate($this, input, stringBuilder) {
  ...
  $l$loop: while (pos < len) {
    var consumed = $this.icm(input, pos, stringBuilder);
    if (consumed === 0) {
...
initMetadataForClass(AggregateTranslator, 'AggregateTranslator', AggregateTranslator.fcm);
...
initMetadataForClass(NumericEntityEncoder, 'NumericEntityEncoder', NumericEntityEncoder.qcn);
initMetadataForClass(UnicodeUnpairedSurrogateRemover, 'UnicodeUnpairedSurrogateRemover', UnicodeUnpairedSurrogateRemover.wcm);
