...
class StringTranslator {
  ...
  xcb(input) {
    var stringBuilder = StringBuilder.kc(imul(input.length, 2));
...
class AggregateTranslator extends StringTranslator {
  constructor() {
    return new.target.tcb();
  }
  static tcb() {
    var $this = this.ucb();
    var tmp = $this;
    // Inline function 'kotlin.collections.mutableListOf' call
    tmp.scb_1 = ArrayList.p2();
    return $this;
  }
  static vcb(translators) {
    var $this = this.tcb();
    addAll($this.scb_1, translators);
    return $this;
  }
  wcb(input, offset, stringBuilder) {
    var _iterator__ex2g4s = this.scb_1.l1();
    while (_iterator__ex2g4s.m1()) {
      var translator = _iterator__ex2g4s.n1();
      var consumed = translator.wcb(input, offset, stringBuilder);
      if (!(consumed === 0)) {
        return consumed;
      }
    }
...
class EntityMaps {
  constructor() {
    ...
    tmp.ccc_1 = toList(encodeMap);
    this.dcc_1 = invert(this, this.ccc_1);
  }
}
class KsoupEntities {
  constructor() {
    ...
    tmp.lcc_1 = AggregateTranslator.vcb([LookupTranslator.icc(EntityMaps_getInstance().ycb_1), LookupTranslator.icc(encodeXml11Map), Companion_instance_0.jcc(1, 8), Companion_instance_0.jcc(14, 31), Companion_instance_0.jcc(127, 132), Companion_instance_0.jcc(134, 159), UnicodeUnpairedSurrogateRemover.kcc()]);
    this.mcc_1 = AggregateTranslator.vcb([LookupTranslator.icc(EntityMaps_getInstance().acc_1)]);
    this.ncc_1 = AggregateTranslator.vcb([LookupTranslator.icc(EntityMaps_getInstance().ccc_1), Companion_instance_0.jcc(1, 8), Companion_instance_0.jcc(14, 31), Companion_instance_0.jcc(127, 132), Companion_instance_0.jcc(134, 159)]);
    this.occ_1 = AggregateTranslator.vcb([LookupTranslator.icc(EntityMaps_getInstance().bcc_1), NumericEntityDecoder.scc([])]);
    this.pcc_1 = AggregateTranslator.vcb([LookupTranslator.icc(EntityMaps_getInstance().dcc_1), NumericEntityDecoder.scc([])]);
    this.qcc_1 = AggregateTranslator.vcb([LookupTranslator.icc(EntityMaps_getInstance().zcb_1), NumericEntityDecoder.scc([])]);
  }
  tcc(input) {
    return this.pcc_1.xcb(input);
  }
  ucc(input) {
    return this.tcc(input);
  }
}
class LookupTranslator extends StringTranslator {
  constructor(lookupMap) {
    return new.target.icc(lookupMap);
  }
  static icc(lookupMap) {
    var $this = this.ucb();
    var tmp = $this;
    // Inline function 'kotlin.collections.mutableMapOf' call
    tmp.ecc_1 = LinkedHashMap.r5();
    var tmp_0 = $this;
    // Inline function 'kotlin.collections.mutableSetOf' call
    tmp_0.fcc_1 = LinkedHashSet.o2();
    ...
    while (_iterator__ex2g4s.m1()) {
      ...
      $this.fcc_1.e2(new UShort(tmp$ret$4));
      var sz = key.length;
    ...
    $this.gcc_1 = currentShortest;
    $this.hcc_1 = currentLongest;
    return $this;
  }
  wcb(input, offset, stringBuilder) {
    // Inline function 'kotlin.code' call
    ...
    if (this.fcc_1.n2(new UShort(tmp$ret$1))) {
      var max = this.hcc_1;
      if ((offset + this.hcc_1 | 0) > input.length) {
      ...
      if (last <= inductionVariable)
        do {
          ...
          var result = this.ecc_1.v4(toString(subSeq));
          if (!(result == null)) {
...
class CodePointTranslator extends StringTranslator {
  ...
  wcb(input, offset, stringBuilder) {
    ...
    var consumed = this.wcc(codePoint, stringBuilder);
    return consumed ? 1 : 0;
  }
}
...
class Companion {
  constructor() {
    ...
    this.xcc_1 = setOf(Option_SemiColonRequired_getInstance());
  }
}
class NumericEntityDecoder extends StringTranslator {
  constructor(options) {
    return new.target.scc(options);
  }
  static scc(options) {
    ...
    if (options.length === 0) {
      tmp_0 = Companion_getInstance().xcc_1;
    } else {
  ...
  wcb(input, offset, stringBuilder) {
    ...
    if (charCodeAt(input, offset) === _Char___init__impl__6a9atx(38) && offset < (seqEnd - 2 | 0) && charCodeAt(input, offset + 1 | 0) === _Char___init__impl__6a9atx(35)) {
      ...
      if (entityValue > 65535) {
        ...
        var indexedObject = CharsUtils_instance.acd(entityValue);
...
class Companion_0 {
  jcc(codePointLow, codePointHigh) {
    return NumericEntityEncoder.dcd(numberRangeToNumber(codePointLow, codePointHigh), true);
  }
}
class NumericEntityEncoder extends CodePointTranslator {
  constructor(range, between) {
    return new.target.dcd(range, between);
  }
  static dcd(range, between) {
    var $this = this.vcc();
    $this.bcd_1 = range;
    $this.ccd_1 = between;
    return $this;
  ...
  static ecd() {
    return this.dcd(numberRangeToNumber(0, 2147483647), true);
  }
  wcc(codePoint, stringBuilder) {
    if (!(this.ccd_1 === this.bcd_1.zq(codePoint))) {
      return false;
    }
    stringBuilder.i1('&#');
...
function translate($this, input, stringBuilder) {
  ...
  $l$loop: while (pos < len) {
    var consumed = $this.wcb(input, pos, stringBuilder);
    if (consumed === 0) {
...
initMetadataForClass(AggregateTranslator, 'AggregateTranslator', AggregateTranslator.tcb);
...
initMetadataForClass(NumericEntityEncoder, 'NumericEntityEncoder', NumericEntityEncoder.ecd);
initMetadataForClass(UnicodeUnpairedSurrogateRemover, 'UnicodeUnpairedSurrogateRemover', UnicodeUnpairedSurrogateRemover.kcc);
