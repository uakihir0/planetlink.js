...
class TimeBased extends DateTimeUnit {
  constructor(nanoseconds) {
    super();
    this.i56_1 = nanoseconds;
    // Inline function 'kotlin.require' call
    if (!(this.i56_1 > 0n)) {
      var message = 'Unit duration must be positive, but was ' + this.i56_1.toString() + ' ns.';
      throw IllegalArgumentException.a2(toString(message));
    }
    if (modulo(this.i56_1, 3600000000000n) === 0n) {
      this.j56_1 = 'HOUR';
      this.k56_1 = divide(this.i56_1, 3600000000000n);
    } else {
      if (modulo(this.i56_1, 60000000000n) === 0n) {
        this.j56_1 = 'MINUTE';
        this.k56_1 = divide(this.i56_1, 60000000000n);
      } else {
        var tmp0 = this.i56_1;
        ...
        if (modulo(tmp0, fromInt(other)) === 0n) {
          this.j56_1 = 'SECOND';
          var tmp = this;
          var tmp0_0 = this.i56_1;
          // Inline function 'kotlin.Long.div' call
          var other_0 = 1000000000;
          tmp.k56_1 = divide(tmp0_0, fromInt(other_0));
        } else {
          // Inline function 'kotlin.Long.rem' call
          var this_0 = this.i56_1;
          if (modulo(this_0, fromInt(1000000)) === 0n) {
            this.j56_1 = 'MILLISECOND';
            var tmp_0 = this;
            // Inline function 'kotlin.Long.div' call
            var this_1 = this.i56_1;
            tmp_0.k56_1 = divide(this_1, fromInt(1000000));
          } else {
            // Inline function 'kotlin.Long.rem' call
            var this_2 = this.i56_1;
            if (modulo(this_2, fromInt(1000)) === 0n) {
              this.j56_1 = 'MICROSECOND';
              var tmp_1 = this;
              // Inline function 'kotlin.Long.div' call
              var this_3 = this.i56_1;
              tmp_1.k56_1 = divide(this_3, fromInt(1000));
            } else {
              this.j56_1 = 'NANOSECOND';
              this.k56_1 = this.i56_1;
            }
          }
        }
      }
  ...
  l56(scalar) {
    return new TimeBased(safeMultiply(this.i56_1, fromInt(scalar)));
  }
  equals(other) {
    var tmp;
    if (this === other) {
  ...
  hashCode() {
    return convertToInt(this.i56_1) ^ convertToInt(shiftRight(this.i56_1, 32));
  }
  toString() {
    return this.m56(this.k56_1, this.j56_1);
  }
}
...
class DayBased extends DateBased {
  constructor(days) {
    ...
    // Inline function 'kotlin.require' call
    if (!(this.o56_1 > 0)) {
      var message = 'Unit duration must be positive, but was ' + this.o56_1 + ' days.';
      throw IllegalArgumentException.a2(toString(message));
    }
  }
  l56(scalar) {
    return new DayBased(safeMultiply_0(this.o56_1, scalar));
  }
  equals(other) {
    var tmp;
    if (this === other) {
  ...
  hashCode() {
    return this.o56_1 ^ 65536;
  }
  toString() {
    return (this.o56_1 % 7 | 0) === 0 ? this.n56(this.o56_1 / 7 | 0, 'WEEK') : this.n56(this.o56_1, 'DAY');
  }
}
class MonthBased extends DateBased {
  constructor(months) {
    ...
    // Inline function 'kotlin.require' call
    if (!(this.p56_1 > 0)) {
      var message = 'Unit duration must be positive, but was ' + this.p56_1 + ' months.';
      throw IllegalArgumentException.a2(toString(message));
    }
  }
  l56(scalar) {
    return new MonthBased(safeMultiply_0(this.p56_1, scalar));
  }
  equals(other) {
    var tmp;
    if (this === other) {
  ...
  hashCode() {
    return this.p56_1 ^ 131072;
  }
  toString() {
    return (this.p56_1 % 1200 | 0) === 0 ? this.n56(this.p56_1 / 1200 | 0, 'CENTURY') : (this.p56_1 % 12 | 0) === 0 ? this.n56(this.p56_1 / 12 | 0, 'YEAR') : (this.p56_1 % 3 | 0) === 0 ? this.n56(this.p56_1 / 3 | 0, 'QUARTER') : this.n56(this.p56_1, 'MONTH');
  }
}
class Companion_3 {
  constructor() {
    Companion_instance_3 = this;
    this.q56_1 = new TimeBased(1n);
    this.r56_1 = this.q56_1.l56(1000);
    this.s56_1 = this.r56_1.l56(1000);
    this.t56_1 = this.s56_1.l56(1000);
    this.u56_1 = this.t56_1.l56(60);
    this.v56_1 = this.u56_1.l56(60);
    this.w56_1 = new DayBased(1);
    this.x56_1 = this.w56_1.l56(7);
    this.y56_1 = new MonthBased(1);
    this.z56_1 = this.y56_1.l56(3);
    this.a57_1 = this.y56_1.l56(12);
    this.b57_1 = this.a57_1.l56(100);
  }
}
class DayOfWeek extends Enum {}
class Companion_4 {
  constructor() {
    this.c57_1 = 4231196759387994100n;
  }
}
...
class Companion_5 {
  constructor() {
    this.k57_1 = -3207806170214997982n;
  }
}
...
class AbstractDateTimeFormat {
  s57(value) {
    ...
    this.v57().c58().d58(this.w57(value), this_0);
    return this_0.toString();
  }
  xu(input) {
    var tmp;
    try {
      tmp = Parser__match$default_impl_x2xlti(_Parser___init__impl__gdyfby(this.v57().e58()), input, this.y57());
    } catch ($p) {
      var tmp_0;
      if ($p instanceof ParseException) {
        var e = $p;
        throw DateTimeFormatException.j57("Failed to parse value from '" + toString(input) + "'", e);
      } else {
        throw $p;
      }
    }
    var matched = tmp;
    try {
      return this.x57(matched);
    } catch ($p_0) {
      if ($p_0 instanceof IllegalArgumentException) {
        var e_0 = $p_0;
        var message = e_0.message;
        throw DateTimeFormatException.j57(message == null ? "The value parsed from '" + toString(input) + "' is invalid" : '' + message + " (when parsing '" + toString(input) + "')", e_0);
      } else {
        throw $p_0;
      }
    }
...
function year$default(padding, $super) {
  ...
  if ($super === VOID) {
    ...
    tmp = $super.f58.call(this, padding);
  }
  return tmp;
}
function monthNumber$default(padding, $super) {
  ...
  if ($super === VOID) {
    ...
    tmp = $super.h58.call(this, padding);
  }
  return tmp;
}
class WithDate {}
function day$default(padding, $super) {
  ...
  if ($super === VOID) {
    ...
    tmp = $super.k58.call(this, padding);
  }
  return tmp;
}
class WithTime {}
...
function minute$default(padding, $super) {
  ...
  if ($super === VOID) {
    ...
    tmp = $super.p58.call(this, padding);
  }
  return tmp;
}
function second$default(padding, $super) {
  ...
  if ($super === VOID) {
    ...
    tmp = $super.r58.call(this, padding);
  }
  return tmp;
}
class WithUtcOffset {}
...
function offsetSecondsOfMinute$default(padding, $super) {
  ...
  if ($super === VOID) {
    ...
    tmp = $super.z58.call(this, padding);
  }
  return tmp;
}
...
function appendAlternativeParsingImpl(otherFormats, mainFormat) {
  ...
  var this_1 = this.e59();
  mainFormat(this_1);
  var main = this_1.d59().l40();
  this.d59().g59(new AlternativesParsingFormatStructure(main, others));
}
function appendOptionalImpl(onZero, format) {
  ...
  var this_0 = this.e59();
  format(this_0);
  tmp.g59(new OptionalFormatStructure(onZero, this_0.d59().l40()));
}
function chars(value) {
  return this.d59().g59(new ConstantFormatStructure(value));
}
function build() {
  return new CachedFormatStructure(this.d59().l40().h59_1);
}
class IncompleteLocalDate {
  constructor(yearMonth, day, dayOfWeek, dayOfYear) {
    ...
    this.j59_1 = yearMonth;
    this.k59_1 = day;
    this.l59_1 = dayOfWeek;
    this.m59_1 = dayOfYear;
  }
  n59(_set____db54di) {
    this.k59_1 = _set____db54di;
  }
  o59() {
    return this.k59_1;
  }
  p59(_set____db54di) {
    this.l59_1 = _set____db54di;
  }
  q59() {
    return this.l59_1;
  }
  r59(_set____db54di) {
    this.m59_1 = _set____db54di;
  }
  s59() {
    return this.m59_1;
  }
  t59() {
    var year = requireParsedField(this.u59(), 'year');
    var dayOfYear = this.m59_1;
    var tmp;
    if (dayOfYear == null) {
      tmp = LocalDate.y59(year, requireParsedField(this.a5a(), 'monthNumber'), requireParsedField(this.k59_1, 'day'));
    } else {
      // Inline function 'kotlin.also' call
      var this_0 = plus_0(LocalDate.y59(year, 1, 1), dayOfYear - 1 | 0, Companion_getInstance_4().w56_1);
      if (!(this_0.v59_1 === year)) {
        throw DateTimeFormatException.i57('Can not create a LocalDate from the given input: ' + ('the day of year is ' + dayOfYear + ', which is not a valid day of year for the year ' + year));
      }
      if (!(this.a5a() == null) && !(get_number(this_0.z59()) === this.a5a())) {
        throw DateTimeFormatException.i57('Can not create a LocalDate from the given input: ' + ('the day of year is ' + dayOfYear + ', which is ' + this_0.z59().toString() + ', ') + ('but ' + this.a5a() + ' was specified as the month number'));
      }
      if (!(this.k59_1 == null) && !(this_0.w59_1 === this.k59_1)) {
        throw DateTimeFormatException.i57('Can not create a LocalDate from the given input: ' + ('the day of year is ' + dayOfYear + ', which is the day ' + this_0.w59_1 + ' of ' + this_0.z59().toString() + ', ') + ('but ' + this.k59_1 + ' was specified as the day of month'));
      }
      tmp = this_0;
    }
    var date = tmp;
    ...
    if (tmp0_safe_receiver == null)
      ...
      if (!(tmp0_safe_receiver === get_isoDayNumber(date.q59()))) {
        throw DateTimeFormatException.i57('Can not create a LocalDate from the given input: ' + ('the day of week is ' + DayOfWeek_0(tmp0_safe_receiver).toString() + ' but the date is ' + date.toString() + ', which is a ' + date.q59().toString()));
      }
    }
    return date;
  }
  b5a(date) {
    this.c5a(date.v59_1);
    this.d5a(get_number(date.z59()));
    this.k59_1 = date.w59_1;
    this.l59_1 = get_isoDayNumber(date.q59());
    this.m59_1 = date.s59();
  }
  e5a() {
    return new IncompleteLocalDate(this.j59_1.e5a(), this.k59_1, this.l59_1, this.m59_1);
  }
  equals(other) {
    var tmp;
    var tmp_0;
    ...
    if (other instanceof IncompleteLocalDate) {
      tmp_2 = this.j59_1.equals(other.j59_1);
    } else {
      tmp_2 = false;
    }
    if (tmp_2) {
      tmp_1 = this.k59_1 == other.k59_1;
    } else {
      tmp_1 = false;
    }
    if (tmp_1) {
      tmp_0 = this.l59_1 == other.l59_1;
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
      tmp = this.m59_1 == other.m59_1;
    } else {
      tmp = false;
    }
    return tmp;
  ...
  toString() {
    var tmp;
    if (this.m59_1 == null) {
      var tmp_0 = this.j59_1.toString();
      var tmp0_elvis_lhs = this.k59_1;
      var tmp_1 = toString(tmp0_elvis_lhs == null ? '??' : tmp0_elvis_lhs);
      var tmp1_elvis_lhs = this.l59_1;
      tmp = tmp_0 + '-' + tmp_1 + ' (day of week is ' + toString(tmp1_elvis_lhs == null ? '??' : tmp1_elvis_lhs) + ')';
    } else if (this.k59_1 == null && this.a5a() == null) {
      var tmp2_elvis_lhs = this.j59_1.f5a_1;
      var tmp_2 = toString(tmp2_elvis_lhs == null ? '??' : tmp2_elvis_lhs);
      var tmp_3 = this.m59_1;
      var tmp3_elvis_lhs = this.l59_1;
      tmp = '(' + tmp_2 + ')-' + tmp_3 + ' (day of week is ' + toString(tmp3_elvis_lhs == null ? '??' : tmp3_elvis_lhs) + ')';
    } else {
      var tmp_4 = this.j59_1.toString();
      var tmp4_elvis_lhs = this.k59_1;
      var tmp_5 = toString(tmp4_elvis_lhs == null ? '??' : tmp4_elvis_lhs);
      var tmp5_elvis_lhs = this.l59_1;
      tmp = tmp_4 + '-' + tmp_5 + ' (day of week is ' + toString(tmp5_elvis_lhs == null ? '??' : tmp5_elvis_lhs) + ', day of year is ' + this.m59_1 + ')';
    }
    return tmp;
  }
  c5a(_set____db54di) {
    this.j59_1.f5a_1 = _set____db54di;
  }
  u59() {
    return this.j59_1.f5a_1;
  }
  d5a(_set____db54di) {
    this.j59_1.g5a_1 = _set____db54di;
  }
  a5a() {
    return this.j59_1.g5a_1;
  }
}
class Companion_7 {
  h5a(block) {
    ...
    block(builder);
    return new LocalDateFormat(builder.l40());
  }
}
class AbstractWithYearMonthBuilder {}
function year(padding) {
  return this.k5a(new BasicFormatStructure(new YearDirective(padding)));
}
function monthNumber(padding) {
  return this.k5a(new BasicFormatStructure(new MonthDirective(padding)));
}
...
function day(padding) {
  return this.j5a(new BasicFormatStructure(new DayDirective(padding)));
}
function date(format) {
  return this.j5a((format instanceof LocalDateFormat ? format : THROW_CCE()).l5a_1);
}
class Builder {
  constructor(actualBuilder) {
    this.i5a_1 = actualBuilder;
  }
  d59() {
    return this.i5a_1;
  }
  j5a(structure) {
    return this.i5a_1.g59(structure);
  }
  e59() {
...
class LocalDateFormat extends AbstractDateTimeFormat {
  ...
  w57(value) {
    return this.m5a(value instanceof LocalDate ? value : THROW_CCE());
  }
  n5a(intermediate) {
    return intermediate.t59();
  }
  x57(intermediate) {
    return this.n5a(intermediate instanceof IncompleteLocalDate ? intermediate : THROW_CCE());
  }
  y57() {
...
class UnsignedIntFieldFormatDirective {
  constructor(field, minDigits, spacePadding) {
    this.w5a_1 = field;
    this.x5a_1 = minDigits;
    this.y5a_1 = spacePadding;
    this.z5a_1 = this.w5a_1.e5h_1;
    // Inline function 'kotlin.require' call
    if (!(this.x5a_1 >= 0)) {
      var message = 'The minimum number of digits (' + this.x5a_1 + ') is negative';
      throw IllegalArgumentException.a2(toString(message));
    }
    // Inline function 'kotlin.require' call
    if (!(this.z5a_1 >= this.x5a_1)) {
      var message_0 = 'The maximum number of digits (' + this.z5a_1 + ') is less than the minimum number of digits (' + this.x5a_1 + ')';
      throw IllegalArgumentException.a2(toString(message_0));
    }
    if (!(this.y5a_1 == null)) {
      // Inline function 'kotlin.require' call
      if (!(this.y5a_1 > this.x5a_1)) {
        var message_1 = 'The space padding (' + this.y5a_1 + ') should be more than the minimum number of digits (' + this.x5a_1 + ')';
  ...
  c58() {
    var formatter = new UnsignedIntFormatterStructure(Accessor$getterNotNull$ref(this.w5a_1.y5g_1), this.x5a_1);
    return !(this.y5a_1 == null) ? new SpacePaddedFormatter(formatter, this.y5a_1) : formatter;
  }
  e58() {
    return spaceAndZeroPaddedUnsignedInt(this.x5a_1, this.z5a_1, this.y5a_1, this.w5a_1.y5g_1, this.w5a_1.b5h_1);
  }
}
class DayDirective extends UnsignedIntFieldFormatDirective {
  constructor(padding) {
    var tmp = DateFields_getInstance().o5a_1;
  ...
  equals(other) {
    ...
    if (other instanceof DayDirective) {
      tmp = this.v5a_1.equals(other.v5a_1);
    } else {
      tmp = false;
    }
    return tmp;
...
class DateFields {
  constructor() {
    ...
    tmp.o5a_1 = new UnsignedFieldSpec(new PropertyAccessor(getPropertyCallableRef('day', 1, tmp_0, tmp_1, DateFieldContainer$_set_day_$ref_s0jsax())), 1, 31);
    var tmp_2 = this;
    var tmp_3 = KMutableProperty1;
    var tmp_4 = DateFieldContainer$_get_dayOfWeek_$ref_thwqom();
    tmp_2.p5a_1 = new UnsignedFieldSpec(new PropertyAccessor(getPropertyCallableRef('dayOfWeek', 1, tmp_3, tmp_4, DateFieldContainer$_set_dayOfWeek_$ref_ea586a())), 1, 7);
    var tmp_5 = this;
    var tmp_6 = KMutableProperty1;
    var tmp_7 = DateFieldContainer$_get_dayOfYear_$ref_2m6gfz();
    tmp_5.q5a_1 = new UnsignedFieldSpec(new PropertyAccessor(getPropertyCallableRef('dayOfYear', 1, tmp_6, tmp_7, DateFieldContainer$_set_dayOfYear_$ref_cll22d())), 1, 366);
  }
}
class Companion_8 {
  b5b(block) {
    ...
    block(builder);
    return new LocalDateTimeFormat(builder.l40());
  }
}
class AbstractWithTimeBuilder {}
function hour(padding) {
  return this.i59(new BasicFormatStructure(new HourDirective(padding)));
}
function minute(padding) {
  return this.i59(new BasicFormatStructure(new MinuteDirective(padding)));
}
function second(padding) {
  return this.i59(new BasicFormatStructure(new SecondDirective(padding)));
}
function secondFraction(minLength, maxLength) {
  return this.i59(new BasicFormatStructure(new FractionalSecondDirective(minLength, maxLength)));
}
function time(format) {
  return this.i59((format instanceof LocalTimeFormat ? format : THROW_CCE()).t5c_1);
}
...
class Builder_0 {
  constructor(actualBuilder) {
    this.c5b_1 = actualBuilder;
  }
  d59() {
    return this.c5b_1;
  }
  d5b(structure) {
    this.c5b_1.g59(structure);
  }
  e59() {
...
class LocalDateTimeFormat extends AbstractDateTimeFormat {
  ...
  w57(value) {
    return this.f5b(value instanceof LocalDateTime ? value : THROW_CCE());
  }
  j5b(intermediate) {
    return intermediate.k5b();
  }
  x57(intermediate) {
    return this.j5b(intermediate instanceof IncompleteLocalDateTime ? intermediate : THROW_CCE());
  }
  y57() {
...
function set_fractionOfSecond(value) {
  this.z5b(value == null ? null : value.l5c(9));
}
function get_fractionOfSecond() {
  var tmp0_safe_receiver = this.a5c();
  var tmp;
  if (tmp0_safe_receiver == null) {
    tmp = null;
  } else {
...
class IncompleteLocalDateTime {
  ...
  k5b() {
    return LocalDateTime.u5b(this.g5b_1.t59(), this.h5b_1.r5b());
  }
  i5b(dateTime) {
    this.g5b_1.b5a(dateTime.s5b_1);
    this.h5b_1.v5b(dateTime.t5b_1);
  }
  e5a() {
    return new IncompleteLocalDateTime(this.g5b_1.e5a(), this.h5b_1.e5a());
  }
  n59(_set____db54di) {
    this.g5b_1.k59_1 = _set____db54di;
  }
  o59() {
    return this.g5b_1.k59_1;
  }
  p59(_set____db54di) {
    this.g5b_1.l59_1 = _set____db54di;
  }
  q59() {
    return this.g5b_1.l59_1;
  }
  r59(_set____db54di) {
    this.g5b_1.m59_1 = _set____db54di;
  }
  s59() {
    return this.g5b_1.m59_1;
  }
  c5a(_set____db54di) {
    this.g5b_1.c5a(_set____db54di);
  }
  u59() {
    return this.g5b_1.u59();
  }
  d5a(_set____db54di) {
    this.g5b_1.d5a(_set____db54di);
  }
  a5a() {
    return this.g5b_1.a5a();
  }
  w5b(_set____db54di) {
    this.h5b_1.o5b_1 = _set____db54di;
  }
  x5b() {
    return this.h5b_1.o5b_1;
  }
  y5b(_set____db54di) {
    this.h5b_1.p5b_1 = _set____db54di;
  }
  lw() {
    return this.h5b_1.p5b_1;
  }
  z5b(_set____db54di) {
    this.h5b_1.q5b_1 = _set____db54di;
  }
  a5c() {
    return this.h5b_1.q5b_1;
  }
  b5c(_set____db54di) {
    this.h5b_1.l5b_1 = _set____db54di;
  }
  c5c() {
    return this.h5b_1.l5b_1;
  }
  d5c(_set____db54di) {
    this.h5b_1.m5b_1 = _set____db54di;
  }
  e5c() {
    return this.h5b_1.m5b_1;
  }
  f5c(_set____db54di) {
    this.h5b_1.n5b_1 = _set____db54di;
  }
  g5c() {
    return this.h5b_1.n5b_1;
  }
  h5c(value) {
    this.h5b_1.h5c(value);
  }
  i5c() {
    return this.h5b_1.i5c();
  }
}
class IncompleteLocalTime {
  constructor(hour, hourOfAmPm, amPm, minute, second, nanosecond) {
    ...
    this.l5b_1 = hour;
    this.m5b_1 = hourOfAmPm;
    this.n5b_1 = amPm;
    this.o5b_1 = minute;
    this.p5b_1 = second;
    this.q5b_1 = nanosecond;
  }
  b5c(_set____db54di) {
    this.l5b_1 = _set____db54di;
  }
  c5c() {
    return this.l5b_1;
  }
  d5c(_set____db54di) {
    this.m5b_1 = _set____db54di;
  }
  e5c() {
    return this.m5b_1;
  }
  f5c(_set____db54di) {
    this.n5b_1 = _set____db54di;
  }
  g5c() {
    return this.n5b_1;
  }
  w5b(_set____db54di) {
    this.o5b_1 = _set____db54di;
  }
  x5b() {
    return this.o5b_1;
  }
  y5b(_set____db54di) {
    this.p5b_1 = _set____db54di;
  }
  lw() {
    return this.p5b_1;
  }
  z5b(_set____db54di) {
    this.q5b_1 = _set____db54di;
  }
  a5c() {
    return this.q5b_1;
  }
  r5b() {
    var tmp0_safe_receiver = this.l5b_1;
    var tmp;
    if (tmp0_safe_receiver == null) {
      tmp = null;
    } else {
      // Inline function 'kotlin.let' call
      var tmp0_safe_receiver_0 = this.m5b_1;
      ...
      var tmp1_safe_receiver = this.n5b_1;
    ...
    if (tmp1_elvis_lhs == null) {
      var tmp2_safe_receiver = this.m5b_1;
      var tmp_1;
      if (tmp2_safe_receiver == null) {
        tmp_1 = null;
      } else {
        // Inline function 'kotlin.let' call
        var tmp0_safe_receiver_1 = this.n5b_1;
        var tmp_2;
    ...
    if (tmp3_elvis_lhs == null) {
      throw DateTimeFormatException.i57('Incomplete time: missing hour');
    } else {
      tmp_3 = tmp3_elvis_lhs;
    }
    var hour = tmp_3;
    var tmp_4 = requireParsedField(this.o5b_1, 'minute');
    var tmp4_elvis_lhs = this.p5b_1;
    var tmp_5 = tmp4_elvis_lhs == null ? 0 : tmp4_elvis_lhs;
    var tmp5_elvis_lhs = this.q5b_1;
    return LocalTime.q5c(hour, tmp_4, tmp_5, tmp5_elvis_lhs == null ? 0 : tmp5_elvis_lhs);
  }
  v5b(localTime) {
    this.l5b_1 = localTime.m5c_1;
    this.m5b_1 = ((localTime.m5c_1 + 11 | 0) % 12 | 0) + 1 | 0;
    this.n5b_1 = localTime.m5c_1 >= 12 ? AmPmMarker_PM_getInstance() : AmPmMarker_AM_getInstance();
    this.o5b_1 = localTime.n5c_1;
    this.p5b_1 = localTime.o5c_1;
    this.q5b_1 = localTime.p5c_1;
  }
  e5a() {
    return new IncompleteLocalTime(this.l5b_1, this.m5b_1, this.n5b_1, this.o5b_1, this.p5b_1, this.q5b_1);
  }
  equals(other) {
    var tmp;
    var tmp_0;
    ...
    if (other instanceof IncompleteLocalTime) {
      tmp_4 = this.l5b_1 == other.l5b_1;
    } else {
      tmp_4 = false;
    }
    if (tmp_4) {
      tmp_3 = this.m5b_1 == other.m5b_1;
    } else {
      tmp_3 = false;
    }
    if (tmp_3) {
      tmp_2 = equals(this.n5b_1, other.n5b_1);
    } else {
      tmp_2 = false;
    }
    if (tmp_2) {
      tmp_1 = this.o5b_1 == other.o5b_1;
    } else {
      tmp_1 = false;
    }
    if (tmp_1) {
      tmp_0 = this.p5b_1 == other.p5b_1;
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
      tmp = this.q5b_1 == other.q5b_1;
    } else {
      tmp = false;
    }
    return tmp;
...
class Companion_9 {
  r5c(block) {
    ...
    block(builder);
    return new LocalTimeFormat(builder.l40());
  }
}
class Builder_1 {
  constructor(actualBuilder) {
    this.s5c_1 = actualBuilder;
  }
  d59() {
    return this.s5c_1;
  }
  i59(structure) {
    this.s5c_1.g59(structure);
  }
  e59() {
...
class LocalTimeFormat extends AbstractDateTimeFormat {
  ...
  w57(value) {
    return this.u5c(value instanceof LocalTime ? value : THROW_CCE());
  }
  v5c(intermediate) {
    return intermediate.r5b();
  }
  x57(intermediate) {
    return this.v5c(intermediate instanceof IncompleteLocalTime ? intermediate : THROW_CCE());
  }
  y57() {
...
class HourDirective extends UnsignedIntFieldFormatDirective {
  constructor(padding) {
    var tmp = TimeFields_getInstance().w5c_1;
    // Inline function 'kotlinx.datetime.format.minDigits' call
    var tmp_0 = padding.equals(Padding_ZERO_getInstance()) ? 2 : 1;
    // Inline function 'kotlinx.datetime.format.spaces' call
    super(tmp, tmp_0, padding.equals(Padding_SPACE_getInstance()) ? 2 : null);
  ...
  equals(other) {
    ...
    if (other instanceof HourDirective) {
      tmp = this.g5d_1.equals(other.g5d_1);
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    return this.g5d_1.hashCode();
  }
}
class MinuteDirective extends UnsignedIntFieldFormatDirective {
  constructor(padding) {
    var tmp = TimeFields_getInstance().x5c_1;
    // Inline function 'kotlinx.datetime.format.minDigits' call
    var tmp_0 = padding.equals(Padding_ZERO_getInstance()) ? 2 : 1;
    // Inline function 'kotlinx.datetime.format.spaces' call
    super(tmp, tmp_0, padding.equals(Padding_SPACE_getInstance()) ? 2 : null);
  ...
  equals(other) {
    ...
    if (other instanceof MinuteDirective) {
      tmp = this.l5d_1.equals(other.l5d_1);
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    return this.l5d_1.hashCode();
  }
}
class SecondDirective extends UnsignedIntFieldFormatDirective {
  constructor(padding) {
    var tmp = TimeFields_getInstance().y5c_1;
    // Inline function 'kotlinx.datetime.format.minDigits' call
    var tmp_0 = padding.equals(Padding_ZERO_getInstance()) ? 2 : 1;
    // Inline function 'kotlinx.datetime.format.spaces' call
    super(tmp, tmp_0, padding.equals(Padding_SPACE_getInstance()) ? 2 : null);
  ...
  equals(other) {
    ...
    if (other instanceof SecondDirective) {
      tmp = this.q5d_1.equals(other.q5d_1);
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    return this.q5d_1.hashCode();
  }
}
class Companion_10 {
  constructor() {
    Companion_instance_10 = this;
    this.r5d_1 = listOf([0, 0, 0, 0, 0, 0, 0, 0, 0]);
    this.s5d_1 = listOf([2, 1, 0, 2, 1, 0, 2, 1, 0]);
  }
}
class DecimalFractionFieldFormatDirective {
  constructor(field, minDigits, maxDigits, zerosToAdd) {
    this.z5d_1 = field;
    this.a5e_1 = minDigits;
    this.b5e_1 = maxDigits;
    this.c5e_1 = zerosToAdd;
  }
  a5b() {
    return this.z5d_1;
  }
  c58() {
    return new DecimalFractionFormatterStructure(Accessor$getterNotNull$ref_0(this.z5d_1.w2y()), this.a5e_1, this.b5e_1, this.c5e_1);
  }
  e58() {
    return new ParserStructure(listOf_0(new NumberSpanParserOperation(listOf_0(new FractionPartConsumer(this.a5e_1, this.b5e_1, this.z5d_1.w2y(), this.z5d_1.d1())))), emptyList());
  }
}
class FractionalSecondDirective extends DecimalFractionFieldFormatDirective {
  constructor(minDigits, maxDigits, zerosToAdd) {
    ...
    zerosToAdd = zerosToAdd === VOID ? Companion_getInstance_11().r5d_1 : zerosToAdd;
    super(TimeFields_getInstance().z5c_1, minDigits, maxDigits, zerosToAdd);
    this.x5d_1 = minDigits;
    this.y5d_1 = maxDigits;
  }
  equals(other) {
    var tmp;
    var tmp_0;
    if (other instanceof FractionalSecondDirective) {
      tmp_0 = this.x5d_1 === other.x5d_1;
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
      tmp = this.y5d_1 === other.y5d_1;
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    return imul(31, this.x5d_1) + this.y5d_1 | 0;
  }
}
class TimeFields {
  constructor() {
    ...
    tmp.w5c_1 = new UnsignedFieldSpec(new PropertyAccessor(getPropertyCallableRef('hour', 1, tmp_0, tmp_1, TimeFieldContainer$_set_hour_$ref_l7vnde())), 0, 23);
    var tmp_2 = this;
    var tmp_3 = KMutableProperty1;
    var tmp_4 = TimeFieldContainer$_get_minute_$ref_evb2i2();
    tmp_2.x5c_1 = new UnsignedFieldSpec(new PropertyAccessor(getPropertyCallableRef('minute', 1, tmp_3, tmp_4, TimeFieldContainer$_set_minute_$ref_6xin6())), 0, 59);
    var tmp_5 = this;
    var tmp_6 = KMutableProperty1;
    var tmp_7 = TimeFieldContainer$_get_second_$ref_t7tjxy();
    tmp_5.y5c_1 = new UnsignedFieldSpec(new PropertyAccessor(getPropertyCallableRef('second', 1, tmp_6, tmp_7, TimeFieldContainer$_set_second_$ref_qr1wvy())), 0, 59, VOID, 0);
    var tmp_8 = this;
    var tmp_9 = KMutableProperty1;
    var tmp_10 = TimeFieldContainer$_get_fractionOfSecond_$ref_u85by5();
    tmp_8.z5c_1 = new GenericFieldSpec(new PropertyAccessor(getPropertyCallableRef('fractionOfSecond', 1, tmp_9, tmp_10, TimeFieldContainer$_set_fractionOfSecond_$ref_quw20n()), 'nanosecond'), VOID, new DecimalFraction(0, 9));
    var tmp_11 = this;
    var tmp_12 = KMutableProperty1;
    var tmp_13 = TimeFieldContainer$_get_amPm_$ref_u9tt1b();
    tmp_11.a5d_1 = new GenericFieldSpec(new PropertyAccessor(getPropertyCallableRef('amPm', 1, tmp_12, tmp_13, TimeFieldContainer$_set_amPm_$ref_hgxhkj())));
    var tmp_14 = this;
    var tmp_15 = KMutableProperty1;
    var tmp_16 = TimeFieldContainer$_get_hourOfAmPm_$ref_okyxye();
    tmp_14.b5d_1 = new UnsignedFieldSpec(new PropertyAccessor(getPropertyCallableRef('hourOfAmPm', 1, tmp_15, tmp_16, TimeFieldContainer$_set_hourOfAmPm_$ref_y4i32())), 1, 12);
  }
}
...
class IncompleteUtcOffset {
  constructor(offsetIsNegative, offsetHours, offsetMinutesOfHour, offsetSecondsOfMinute) {
    ...
    this.l5e_1 = offsetIsNegative;
    this.m5e_1 = offsetHours;
    this.n5e_1 = offsetMinutesOfHour;
    this.o5e_1 = offsetSecondsOfMinute;
  }
  d5e(_set____db54di) {
  ...
  p5e() {
    var sign = this.l5e_1 === true ? -1 : 1;
    var tmp0_safe_receiver = this.m5e_1;
    var tmp;
    if (tmp0_safe_receiver == null) {
      tmp = null;
    } else {
    ...
    var tmp_0 = tmp;
    var tmp1_safe_receiver = this.n5e_1;
    var tmp_1;
    if (tmp1_safe_receiver == null) {
      tmp_1 = null;
    } else {
    ...
    var tmp_2 = tmp_1;
    var tmp2_safe_receiver = this.o5e_1;
    var tmp_3;
    if (tmp2_safe_receiver == null) {
      tmp_3 = null;
    } else {
  ...
  q5e(offset) {
    this.l5e_1 = offset.r5e_1 < 0;
    // Inline function 'kotlin.math.absoluteValue' call
    var this_0 = offset.r5e_1;
    var totalSecondsAbs = abs(this_0);
    this.m5e_1 = totalSecondsAbs / 3600 | 0;
    this.n5e_1 = (totalSecondsAbs / 60 | 0) % 60 | 0;
    this.o5e_1 = totalSecondsAbs % 60 | 0;
  }
  equals(other) {
    var tmp;
    var tmp_0;
    ...
    if (other instanceof IncompleteUtcOffset) {
      tmp_2 = this.l5e_1 == other.l5e_1;
    } else {
      tmp_2 = false;
    }
    if (tmp_2) {
      tmp_1 = this.m5e_1 == other.m5e_1;
    } else {
      tmp_1 = false;
    }
    if (tmp_1) {
      tmp_0 = this.n5e_1 == other.n5e_1;
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
      tmp = this.o5e_1 == other.o5e_1;
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    // Inline function 'kotlin.hashCode' call
    var tmp0_safe_receiver = this.l5e_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : hashCode(tmp0_safe_receiver);
    var tmp = tmp1_elvis_lhs == null ? 0 : tmp1_elvis_lhs;
    // Inline function 'kotlin.hashCode' call
    var tmp0_safe_receiver_0 = this.m5e_1;
    var tmp1_elvis_lhs_0 = tmp0_safe_receiver_0 == null ? null : hashCode(tmp0_safe_receiver_0);
    var tmp_0 = tmp + (tmp1_elvis_lhs_0 == null ? 0 : tmp1_elvis_lhs_0) | 0;
    // Inline function 'kotlin.hashCode' call
    var tmp0_safe_receiver_1 = this.n5e_1;
    var tmp1_elvis_lhs_1 = tmp0_safe_receiver_1 == null ? null : hashCode(tmp0_safe_receiver_1);
    var tmp_1 = tmp_0 + (tmp1_elvis_lhs_1 == null ? 0 : tmp1_elvis_lhs_1) | 0;
    // Inline function 'kotlin.hashCode' call
    var tmp0_safe_receiver_2 = this.o5e_1;
    var tmp1_elvis_lhs_2 = tmp0_safe_receiver_2 == null ? null : hashCode(tmp0_safe_receiver_2);
    return tmp_1 + (tmp1_elvis_lhs_2 == null ? 0 : tmp1_elvis_lhs_2) | 0;
  }
  e5a() {
    return new IncompleteUtcOffset(this.l5e_1, this.m5e_1, this.n5e_1, this.o5e_1);
  }
  toString() {
    var tmp0_safe_receiver = this.l5e_1;
    var tmp;
    ...
    var tmp2_elvis_lhs = this.m5e_1;
    var tmp_1 = toString(tmp2_elvis_lhs == null ? '??' : tmp2_elvis_lhs);
    var tmp3_elvis_lhs = this.n5e_1;
    var tmp_2 = toString(tmp3_elvis_lhs == null ? '??' : tmp3_elvis_lhs);
    var tmp4_elvis_lhs = this.o5e_1;
...
class UtcOffsetWholeHoursDirective extends UnsignedIntFieldFormatDirective {
  constructor(padding) {
    var tmp = OffsetFields_getInstance().t5e_1;
    // Inline function 'kotlinx.datetime.format.minDigits' call
    var tmp_0 = padding.equals(Padding_ZERO_getInstance()) ? 2 : 1;
    // Inline function 'kotlinx.datetime.format.spaces' call
    super(tmp, tmp_0, padding.equals(Padding_SPACE_getInstance()) ? 2 : null);
  ...
  equals(other) {
    ...
    if (other instanceof UtcOffsetWholeHoursDirective) {
      tmp = this.a5f_1.equals(other.a5f_1);
    } else {
      tmp = false;
    }
    return tmp;
...
class Companion_11 {
  b5f(block) {
    ...
    block(builder);
    return new UtcOffsetFormat(builder.l40());
  }
}
class AbstractWithOffsetBuilder {}
function offsetHours(padding) {
  return this.d5f(new SignedFormatStructure(new BasicFormatStructure(new UtcOffsetWholeHoursDirective(padding)), true));
}
function offsetMinutesOfHour(padding) {
  return this.d5f(new BasicFormatStructure(new UtcOffsetMinuteOfHourDirective(padding)));
}
function offsetSecondsOfMinute(padding) {
  return this.d5f(new BasicFormatStructure(new UtcOffsetSecondOfMinuteDirective(padding)));
}
class Builder_2 {
  constructor(actualBuilder) {
    this.c5f_1 = actualBuilder;
  }
  d59() {
    return this.c5f_1;
  }
  d5f(structure) {
    this.c5f_1.g59(structure);
  }
  e59() {
...
class UtcOffsetFormat extends AbstractDateTimeFormat {
  ...
  w57(value) {
    return this.f5f(value instanceof UtcOffset ? value : THROW_CCE());
  }
  g5f(intermediate) {
    return intermediate.p5e();
  }
  x57(intermediate) {
    return this.g5f(intermediate instanceof IncompleteUtcOffset ? intermediate : THROW_CCE());
  }
  y57() {
...
class OffsetFields$sign$1 {
  constructor() {
    ...
    tmp.h5f_1 = new PropertyAccessor(getPropertyCallableRef('offsetIsNegative', 1, tmp_0, tmp_1, UtcOffsetFieldContainer$_set_offsetIsNegative_$ref_h7e0jq()));
  }
  i5f() {
    return this.h5f_1;
  }
  ...
  k5f(obj) {
    return this.j5f((!(obj == null) ? isInterface(obj, UtcOffsetFieldContainer) : false) ? obj : THROW_CCE());
  }
}
class OffsetFields {
  constructor() {
    ...
    var tmp = this;
    tmp.s5e_1 = new OffsetFields$sign$1();
    var tmp_0 = this;
    ...
    var tmp1_sign = this.s5e_1;
    tmp_0.t5e_1 = new UnsignedFieldSpec(tmp0_accessor, 0, 18, VOID, 0, tmp1_sign);
    var tmp_3 = this;
    ...
    var tmp1_sign_0 = this.s5e_1;
    tmp_3.u5e_1 = new UnsignedFieldSpec(tmp0_accessor_0, 0, 59, VOID, 0, tmp1_sign_0);
    var tmp_6 = this;
    ...
    var tmp1_sign_1 = this.s5e_1;
    tmp_6.v5e_1 = new UnsignedFieldSpec(tmp0_accessor_1, 0, 59, VOID, 0, tmp1_sign_1);
  }
}
class UtcOffsetMinuteOfHourDirective extends UnsignedIntFieldFormatDirective {
  constructor(padding) {
    var tmp = OffsetFields_getInstance().u5e_1;
    // Inline function 'kotlinx.datetime.format.minDigits' call
    var tmp_0 = padding.equals(Padding_ZERO_getInstance()) ? 2 : 1;
    // Inline function 'kotlinx.datetime.format.spaces' call
    super(tmp, tmp_0, padding.equals(Padding_SPACE_getInstance()) ? 2 : null);
  ...
  equals(other) {
    ...
    if (other instanceof UtcOffsetMinuteOfHourDirective) {
      tmp = this.p5f_1.equals(other.p5f_1);
    } else {
      tmp = false;
    }
    return tmp;
...
class UtcOffsetSecondOfMinuteDirective extends UnsignedIntFieldFormatDirective {
  ...
  equals(other) {
    ...
    if (other instanceof UtcOffsetSecondOfMinuteDirective) {
      tmp = this.u5f_1.equals(other.u5f_1);
    } else {
      tmp = false;
    }
    return tmp;
...
class IncompleteYearMonth {
  constructor(year, monthNumber) {
    ...
    this.f5a_1 = year;
    this.g5a_1 = monthNumber;
  }
  c5a(_set____db54di) {
    this.f5a_1 = _set____db54di;
  }
  u59() {
    return this.f5a_1;
  }
  d5a(_set____db54di) {
    this.g5a_1 = _set____db54di;
  }
  a5a() {
    return this.g5a_1;
  }
  v5f() {
    var year = requireParsedField(this.f5a_1, 'year');
    var month = requireParsedField(this.g5a_1, 'monthNumber');
    return YearMonth.y5f(year, month);
  }
  z5f(yearMonth) {
    this.f5a_1 = yearMonth.w5f_1;
    this.g5a_1 = get_number(yearMonth.z59());
  }
  e5a() {
    return new IncompleteYearMonth(this.f5a_1, this.g5a_1);
  }
  equals(other) {
    var tmp;
    var tmp_0;
    if (other instanceof IncompleteYearMonth) {
      tmp_0 = this.f5a_1 == other.f5a_1;
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
      tmp = this.g5a_1 == other.g5a_1;
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    // Inline function 'kotlin.hashCode' call
    var tmp0_safe_receiver = this.f5a_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : hashCode(tmp0_safe_receiver);
    var tmp$ret$0 = tmp1_elvis_lhs == null ? 0 : tmp1_elvis_lhs;
    var tmp = imul(tmp$ret$0, 31);
    // Inline function 'kotlin.hashCode' call
    var tmp0_safe_receiver_0 = this.g5a_1;
    var tmp1_elvis_lhs_0 = tmp0_safe_receiver_0 == null ? null : hashCode(tmp0_safe_receiver_0);
    return tmp + (tmp1_elvis_lhs_0 == null ? 0 : tmp1_elvis_lhs_0) | 0;
  }
  toString() {
    var tmp0_elvis_lhs = this.f5a_1;
    var tmp = toString(tmp0_elvis_lhs == null ? '??' : tmp0_elvis_lhs);
    var tmp1_elvis_lhs = this.g5a_1;
...
class Companion_12 {
  a5g(block) {
    ...
    block(builder);
    return new YearMonthFormat(builder.l40());
  }
}
class Builder_3 {
  constructor(actualBuilder) {
    this.b5g_1 = actualBuilder;
  }
  d59() {
    return this.b5g_1;
  }
  k5a(structure) {
    return this.b5g_1.g59(structure);
  }
  e59() {
...
class YearMonthFormat extends AbstractDateTimeFormat {
  ...
  w57(value) {
    return this.d5g(value instanceof YearMonth ? value : THROW_CCE());
  }
  e5g(intermediate) {
    return intermediate.v5f();
  }
  x57(intermediate) {
    return this.e5g(intermediate instanceof IncompleteYearMonth ? intermediate : THROW_CCE());
  }
  y57() {
...
class SignedIntFieldFormatDirective {
  constructor(field, minDigits, maxDigits, spacePadding, outputPlusOnExceededWidth) {
    this.o5g_1 = field;
    this.p5g_1 = minDigits;
    this.q5g_1 = maxDigits;
    this.r5g_1 = spacePadding;
    this.s5g_1 = outputPlusOnExceededWidth;
    // Inline function 'kotlin.require' call
    if (!(this.p5g_1 == null || this.p5g_1 >= 0)) {
      var message = 'The minimum number of digits (' + this.p5g_1 + ') is negative';
      throw IllegalArgumentException.a2(toString(message));
    }
    // Inline function 'kotlin.require' call
    if (!(this.q5g_1 == null || this.p5g_1 == null || this.q5g_1 >= this.p5g_1)) {
      var message_0 = 'The maximum number of digits (' + this.q5g_1 + ') is less than the minimum number of digits (' + this.p5g_1 + ')';
      throw IllegalArgumentException.a2(toString(message_0));
    }
  }
  a5b() {
  ...
  c58() {
    var tmp = Accessor$getterNotNull$ref_1(this.o5g_1.w2y());
    var tmp0_elvis_lhs = this.p5g_1;
    var formatter = new SignedIntFormatterStructure(tmp, tmp0_elvis_lhs == null ? 0 : tmp0_elvis_lhs, this.s5g_1);
    return !(this.r5g_1 == null) ? new SpacePaddedFormatter(formatter, this.r5g_1) : formatter;
  }
  e58() {
    return SignedIntParser(this.p5g_1, this.q5g_1, this.r5g_1, this.o5g_1.w2y(), this.o5g_1.d1(), this.s5g_1);
  }
}
class YearDirective extends SignedIntFieldFormatDirective {
  constructor(padding, isYearOfEra) {
    ...
    var tmp = YearMonthFields_getInstance().f5g_1;
    // Inline function 'kotlinx.datetime.format.minDigits' call
    ...
    this.m5g_1 = padding;
    this.n5g_1 = isYearOfEra;
  }
  equals(other) {
    var tmp;
    var tmp_0;
    if (other instanceof YearDirective) {
      tmp_0 = this.m5g_1.equals(other.m5g_1);
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
      tmp = this.n5g_1 === other.n5g_1;
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    return imul(this.m5g_1.hashCode(), 31) + getBooleanHashCode(this.n5g_1) | 0;
  }
}
class MonthDirective extends UnsignedIntFieldFormatDirective {
  constructor(padding) {
    var tmp = YearMonthFields_getInstance().g5g_1;
    // Inline function 'kotlinx.datetime.format.minDigits' call
    var tmp_0 = padding.equals(Padding_ZERO_getInstance()) ? 2 : 1;
    // Inline function 'kotlinx.datetime.format.spaces' call
    super(tmp, tmp_0, padding.equals(Padding_SPACE_getInstance()) ? 2 : null);
  ...
  equals(other) {
    ...
    if (other instanceof MonthDirective) {
      tmp = this.x5g_1.equals(other.x5g_1);
    } else {
      tmp = false;
    }
    return tmp;
...
class YearMonthFields {
  constructor() {
    ...
    tmp.f5g_1 = new GenericFieldSpec(new PropertyAccessor(getPropertyCallableRef('year', 1, tmp_0, tmp_1, YearMonthFieldContainer$_set_year_$ref_kc0aub())));
    var tmp_2 = this;
    var tmp_3 = KMutableProperty1;
    var tmp_4 = YearMonthFieldContainer$_get_monthNumber_$ref_pn0wu5();
    tmp_2.g5g_1 = new UnsignedFieldSpec(new PropertyAccessor(getPropertyCallableRef('monthNumber', 1, tmp_3, tmp_4, YearMonthFieldContainer$_set_monthNumber_$ref_fjapbl())), 1, 12);
  }
}
class AppendableFormatStructure {
  constructor() {
    ...
    tmp.f59_1 = ArrayList.j2();
  }
  l40() {
    return new ConcatenatedFormatStructure(this.f59_1);
  }
  g59(format) {
    if (isInterface(format, NonConcatenatedFormatStructure))
      this.f59_1.e2(format);
    else {
      if (format instanceof ConcatenatedFormatStructure) {
        // Inline function 'kotlin.collections.forEach' call
        var _iterator__ex2g4s = format.h59_1.l1();
        while (_iterator__ex2g4s.m1()) {
          var element = _iterator__ex2g4s.n1();
          this.f59_1.e2(element);
        }
      } else {
...
class AbstractFieldSpec {
  toString() {
    return 'The field ' + this.d1() + ' (default value is ' + toString_1(this.j5h()) + ')';
  }
}
...
function getterNotNull(container) {
  var tmp0_elvis_lhs = this.p5h(container);
  var tmp;
...
class PropertyAccessor {
  ...
  n5h(container, newValue) {
    var oldValue = this.l5h_1.get(container);
    var tmp;
    if (oldValue === null) {
      this.l5h_1.set(container, newValue);
      tmp = null;
  ...
  o5h(container, newValue) {
    return this.n5h(container, newValue);
  }
  p5h(container) {
    return this.l5h_1.get(container);
  }
}
class UnsignedFieldSpec extends AbstractFieldSpec {
  constructor(accessor, minValue, maxValue, name, defaultValue, sign) {
    ...
    this.a5h_1 = maxValue;
    this.b5h_1 = name;
    this.c5h_1 = defaultValue;
    this.d5h_1 = sign;
    var tmp = this;
    var tmp_0;
    if (this.a5h_1 < 10) {
      tmp_0 = 1;
    } else if (this.a5h_1 < 100) {
      tmp_0 = 2;
    } else if (this.a5h_1 < 1000) {
      tmp_0 = 3;
    } else {
      throw IllegalArgumentException.a2('Max value ' + this.a5h_1 + ' is too large');
    }
    tmp.e5h_1 = tmp_0;
  }
  w2y() {
...
class ConcatenatedFormatStructure {
  ...
  toString() {
    return 'ConcatenatedFormatStructure(' + joinToString(this.h59_1, ', ') + ')';
  }
  equals(other) {
    var tmp;
    if (other instanceof ConcatenatedFormatStructure) {
      tmp = equals(this.h59_1, other.h59_1);
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    return hashCode(this.h59_1);
  }
  e58() {
    // Inline function 'kotlin.collections.map' call
    var this_0 = this.h59_1;
    // Inline function 'kotlin.collections.mapTo' call
...
class CachedFormatStructure extends ConcatenatedFormatStructure {
  constructor(formats) {
    super(formats);
    this.a58_1 = super.c58();
    this.b58_1 = super.e58();
  }
  c58() {
    return this.a58_1;
  }
...
class BasicFormatStructure {
  constructor(directive) {
    this.r5h_1 = directive;
  }
  toString() {
    return 'BasicFormatStructure(' + toString(this.r5h_1) + ')';
  }
  equals(other) {
    var tmp;
    if (other instanceof BasicFormatStructure) {
      tmp = equals(this.r5h_1, other.r5h_1);
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    return hashCode(this.r5h_1);
  }
  e58() {
    return this.r5h_1.e58();
  }
  c58() {
    return this.r5h_1.c58();
  }
}
class ConstantFormatStructure {
  ...
  toString() {
    return 'ConstantFormatStructure(' + this.s5h_1 + ')';
  }
  equals(other) {
    var tmp;
    if (other instanceof ConstantFormatStructure) {
      tmp = this.s5h_1 === other.s5h_1;
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    return getStringHashCode(this.s5h_1);
  }
  e58() {
    var tmp;
    // Inline function 'kotlin.text.isEmpty' call
    var this_0 = this.s5h_1;
    if (charSequenceLength(this_0) === 0) {
      ...
      var tmp_0;
      if (isAsciiDigit(charCodeAt(this.s5h_1, 0))) {
        var tmp0 = this.s5h_1;
        var tmp$ret$5;
        $l$block: {
        ...
        this_1.e2(new NumberSpanParserOperation(listOf_0(new ConstantNumberConsumer(tmp$ret$5))));
        var tmp0_0 = this.s5h_1;
        var tmp$ret$7;
        $l$block_0: {
      ...
      if (charSequenceLength(suffix) > 0) {
        if (isAsciiDigit(charCodeAt(suffix, suffix.length - 1 | 0))) {
          ...
          this_1.e2(new PlainStringParserOperation(tmp$ret$10));
          var tmp$ret$12;
          $l$block_2: {
          ...
          this_1.e2(new NumberSpanParserOperation(listOf_0(new ConstantNumberConsumer(tmp$ret$12))));
        } else {
  ...
  c58() {
    return new ConstantStringFormatterStructure(this.s5h_1);
  }
}
class SignedFormatStructure {
  constructor(format, withPlusSign) {
    this.t5h_1 = format;
    this.u5h_1 = withPlusSign;
    var tmp = this;
    // Inline function 'kotlin.collections.mapNotNull' call
    var tmp0 = basicFormats(this.t5h_1);
    ...
    while (_iterator__ex2g4s.m1()) {
      var element = _iterator__ex2g4s.n1();
      var tmp0_safe_receiver = element.a5b().k5h();
      if (tmp0_safe_receiver == null)
        null;
      else {
        // Inline function 'kotlin.let' call
  ...
  toString() {
    return 'SignedFormatStructure(' + toString(this.t5h_1) + ')';
  }
  equals(other) {
    var tmp;
    var tmp_0;
    if (other instanceof SignedFormatStructure) {
      tmp_0 = equals(this.t5h_1, other.t5h_1);
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
      tmp = this.u5h_1 === other.u5h_1;
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    return imul(31, hashCode(this.t5h_1)) + getBooleanHashCode(this.u5h_1) | 0;
  }
  e58() {
    return concat(listOf([new ParserStructure(listOf_0(new SignParser(SignedFormatStructure$parser$lambda(this), this.u5h_1, 'sign for ' + toString(this.v5h_1))), emptyList()), this.t5h_1.e58()]));
  }
  c58() {
    var innerFormat = this.t5h_1.c58();
    return new SignedFormatter(innerFormat, SignedFormatStructure$formatter$checkIfAllNegative$ref(this), this.u5h_1);
  }
}
class Companion_13 {
  w5h(field) {
    var default_0 = field.j5h();
    // Inline function 'kotlin.require' call
    if (!!(default_0 == null)) {
      var message = "The field '" + field.d1() + "' does not define a default value";
      throw IllegalArgumentException.a2(toString(message));
    }
    return new PropertyWithDefault(field.w2y(), default_0);
  }
}
class PropertyWithDefault {
  constructor(accessor, defaultValue) {
    this.x5h_1 = accessor;
    this.y5h_1 = defaultValue;
  }
}
class OptionalFormatStructure {
  constructor(onZero, format) {
    ...
    var tmp = this;
    // Inline function 'kotlin.collections.map' call
    var this_0 = basicFormats(this.a5i_1);
    // Inline function 'kotlin.collections.mapTo' call
    var destination = ArrayList.d2(collectionSizeOrDefault(this_0, 10));
    var _iterator__ex2g4s = this_0.l1();
    while (_iterator__ex2g4s.m1()) {
      var item = _iterator__ex2g4s.n1();
      var tmp$ret$2 = item.a5b();
      destination.e2(tmp$ret$2);
    }
    // Inline function 'kotlin.collections.map' call
    ...
    while (_iterator__ex2g4s_0.m1()) {
      ...
      var tmp$ret$5 = Companion_instance_13.w5h(item_0);
      destination_0.e2(tmp$ret$5);
    }
    tmp.b5i_1 = destination_0;
  }
  toString() {
    return 'Optional(' + this.z5h_1 + ', ' + toString(this.a5i_1) + ')';
  }
  equals(other) {
    var tmp;
    var tmp_0;
    if (other instanceof OptionalFormatStructure) {
      tmp_0 = this.z5h_1 === other.z5h_1;
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
      tmp = equals(this.a5i_1, other.a5i_1);
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    return imul(31, getStringHashCode(this.z5h_1)) + hashCode(this.a5i_1) | 0;
  }
  e58() {
    var tmp = emptyList();
    var tmp_0 = this.a5i_1.e58();
    var tmp_1 = (new ConstantFormatStructure(this.z5h_1)).e58();
    var tmp_2;
    if (this.b5i_1.j1()) {
      tmp_2 = emptyList();
    } else {
  ...
  c58() {
    ...
    while (_iterator__ex2g4s.m1()) {
      ...
      var tmp$ret$2 = new ComparisonPredicate(item.y5h_1, Accessor$getter$ref(item.x5h_1));
      destination.e2(tmp$ret$2);
    }
    var predicate = conjunctionPredicate(destination);
    var tmp;
    if (predicate instanceof Truth) {
      tmp = new ConstantStringFormatterStructure(this.z5h_1);
    } else {
      var tmp_0 = to(Predicate$test$ref(predicate), new ConstantStringFormatterStructure(this.z5h_1));
...
class AlternativesParsingFormatStructure {
  constructor(mainFormat, formats) {
    this.c5i_1 = mainFormat;
    this.d5i_1 = formats;
  }
  toString() {
    return 'AlternativesParsing(' + toString(this.d5i_1) + ')';
  }
  equals(other) {
    var tmp;
    var tmp_0;
    if (other instanceof AlternativesParsingFormatStructure) {
      tmp_0 = equals(this.c5i_1, other.c5i_1);
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
      tmp = equals(this.d5i_1, other.d5i_1);
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    return imul(31, hashCode(this.c5i_1)) + hashCode(this.d5i_1) | 0;
  }
  e58() {
    var tmp = emptyList();
    // Inline function 'kotlin.collections.buildList' call
    ...
    this_0.e2(this.c5i_1.e58());
    var _iterator__ex2g4s = this.d5i_1.l1();
    while (_iterator__ex2g4s.m1()) {
      var format = _iterator__ex2g4s.n1();
      this_0.e2(format.e58());
    }
    var tmp$ret$0 = this_0.k5();
    return new ParserStructure(tmp, tmp$ret$0);
  }
  c58() {
    return this.c5i_1.c58();
  }
}
class ComparisonPredicate {
  constructor(expectedValue, getter) {
    this.e5i_1 = expectedValue;
    this.f5i_1 = getter;
  }
  g5i(value) {
    return equals(this.f5i_1(value), this.e5i_1);
  }
}
class Truth {
  h5i(value) {
  ...
  g5i(value) {
    return this.h5i(value);
  }
}
class ConjunctionPredicate {
  constructor(predicates) {
    this.i5i_1 = predicates;
  }
  g5i(value) {
    var tmp0 = this.i5i_1;
    var tmp$ret$0;
...
function format$default(obj, builder, minusNotRequired, $super) {
  ...
  var tmp;
  if ($super === VOID) {
    this.j5i(obj, builder, minusNotRequired);
    tmp = Unit_instance;
  } else {
    tmp = $super.j5i.call(this, obj, builder, minusNotRequired);
  }
  return tmp;
}
class SpacePaddedFormatter {
  constructor(formatter, padding) {
    this.k5i_1 = formatter;
    this.l5i_1 = padding;
  }
  j5i(obj, builder, minusNotRequired) {
    // Inline function 'kotlin.let' call
    var it = StringBuilder.h1();
    this.k5i_1.j5i(obj, it, minusNotRequired);
    var string = it.toString();
    // Inline function 'kotlin.repeat' call
    var times = this.l5i_1 - string.length | 0;
    var inductionVariable = 0;
...
class SignedFormatter {
  constructor(formatter, allSubFormatsNegative, alwaysOutputSign) {
    this.m5i_1 = formatter;
    this.n5i_1 = allSubFormatsNegative;
    this.o5i_1 = alwaysOutputSign;
  }
  j5i(obj, builder, minusNotRequired) {
    var tmp;
    if (!minusNotRequired && this.n5i_1(obj)) {
    ...
    this.m5i_1.j5i(obj, builder, tmp_2);
  }
}
class ConditionalFormatter {
  constructor(formatters) {
    this.p5i_1 = formatters;
  }
  j5i(obj, builder, minusNotRequired) {
    var _iterator__ex2g4s = this.p5i_1.l1();
    while (_iterator__ex2g4s.m1()) {
      var _destruct__k2r9zo = _iterator__ex2g4s.n1();
      var condition = _destruct__k2r9zo.nm();
      var formatter = _destruct__k2r9zo.om();
      if (condition(obj)) {
        formatter.j5i(obj, builder, minusNotRequired);
...
class ConcatenatedFormatter {
  constructor(formatters) {
    this.q5i_1 = formatters;
  }
  j5i(obj, builder, minusNotRequired) {
    var _iterator__ex2g4s = this.q5i_1.l1();
    while (_iterator__ex2g4s.m1()) {
...
class UnsignedIntFormatterStructure {
  constructor(number, zeroPadding) {
    this.r5i_1 = number;
    this.s5i_1 = zeroPadding;
    // Inline function 'kotlin.require' call
    if (!(this.s5i_1 >= 0)) {
      var message = 'The minimum number of digits (' + this.s5i_1 + ') is negative';
      throw IllegalArgumentException.a2(toString(message));
    }
    // Inline function 'kotlin.require' call
    if (!(this.s5i_1 <= 9)) {
      var message_0 = 'The minimum number of digits (' + this.s5i_1 + ') exceeds the length of an Int';
      throw IllegalArgumentException.a2(toString(message_0));
    }
  }
  j5i(obj, builder, minusNotRequired) {
    var num = this.r5i_1(obj);
    var numberStr = num.toString();
    // Inline function 'kotlin.repeat' call
    var times = this.s5i_1 - numberStr.length | 0;
    var inductionVariable = 0;
    if (inductionVariable < times)
      do {
        var index = inductionVariable;
...
class DecimalFractionFormatterStructure {
  constructor(number, minDigits, maxDigits, zerosToAdd) {
    this.t5i_1 = number;
    this.u5i_1 = minDigits;
    this.v5i_1 = maxDigits;
    this.w5i_1 = zerosToAdd;
    var containsArg = this.u5i_1;
    // Inline function 'kotlin.require' call
    if (!(1 <= containsArg ? containsArg <= 9 : false)) {
      var message = 'The minimum number of digits (' + this.u5i_1 + ') is not in range 1..9';
      throw IllegalArgumentException.a2(toString(message));
    }
    var containsLower = this.u5i_1;
    var containsArg_0 = this.v5i_1;
    // Inline function 'kotlin.require' call
    if (!(containsLower <= containsArg_0 ? containsArg_0 <= 9 : false)) {
      var message_0 = 'The maximum number of digits (' + this.v5i_1 + ') is not in range ' + this.u5i_1 + '..9';
      throw IllegalArgumentException.a2(toString(message_0));
    }
  }
  j5i(obj, builder, minusNotRequired) {
    var number = this.t5i_1(obj);
    var numberWithRequiredPrecision = number.l5c(this.v5i_1);
    var zerosToStrip = 0;
    while (this.v5i_1 > (this.u5i_1 + zerosToStrip | 0) && (numberWithRequiredPrecision % get_POWERS_OF_TEN()[zerosToStrip + 1 | 0] | 0) === 0) {
      zerosToStrip = zerosToStrip + 1 | 0;
    }
    var zerosToAddBack = this.w5i_1.n2((this.v5i_1 - zerosToStrip | 0) - 1 | 0);
    if (zerosToStrip >= zerosToAddBack)
      zerosToStrip = zerosToStrip - zerosToAddBack | 0;
    var digitsToOutput = this.v5i_1 - zerosToStrip | 0;
...
class SignedIntFormatterStructure {
  constructor(number, zeroPadding, outputPlusOnExceededWidth) {
    ...
    this.z5i_1 = outputPlusOnExceededWidth;
    // Inline function 'kotlin.require' call
    if (!(this.y5i_1 >= 0)) {
  ...
  j5i(obj, builder, minusNotRequired) {
    ...
    // Inline function 'kotlin.let' call
    var it = this.x5i_1(obj);
    var number = minusNotRequired && it < 0 ? -it | 0 : it;
    if (!(this.z5i_1 == null) && number >= get_POWERS_OF_TEN()[this.z5i_1]) {
      innerBuilder.k1(_Char___init__impl__6a9atx(43));
    }
    // Inline function 'kotlin.math.absoluteValue' call
    if (abs(number) < get_POWERS_OF_TEN()[this.y5i_1 - 1 | 0]) {
      if (number >= 0) {
        innerBuilder.nh(number + get_POWERS_OF_TEN()[this.y5i_1] | 0).sh(0);
      } else {
        innerBuilder.nh(number - get_POWERS_OF_TEN()[this.y5i_1] | 0).sh(1);
      }
    } else {
      innerBuilder.nh(number);
    }
...
class FractionPartConsumer extends NumberConsumer {
  constructor(minLength, maxLength, setter, name) {
    ...
    this.d5j_1 = minLength;
    this.e5j_1 = maxLength;
    this.f5j_1 = setter;
    var containsArg = this.d5j_1;
    // Inline function 'kotlin.require' call
    if (!(1 <= containsArg ? containsArg <= 9 : false)) {
      var message = 'Invalid minimum length ' + this.d5j_1 + ' for field ' + this.h5j_1 + ': expected 1..9';
      throw IllegalArgumentException.a2(toString(message));
    }
    var containsLower = this.d5j_1;
    var containsArg_0 = this.e5j_1;
    // Inline function 'kotlin.require' call
    if (!(containsLower <= containsArg_0 ? containsArg_0 <= 9 : false)) {
      var message_0 = 'Invalid maximum length ' + this.e5j_1 + ' for field ' + this.h5j_1 + ': expected ' + this.d5j_1 + '..9';
      throw IllegalArgumentException.a2(toString(message_0));
    }
  }
  i5j(storage, input, start, end) {
    return (end - start | 0) < this.d5j_1 ? new TooFewDigits(this.d5j_1) : (end - start | 0) > this.e5j_1 ? new TooManyDigits(this.e5j_1) : setWithoutReassigning(this.f5j_1, storage, new DecimalFraction(parseAsciiInt(input, start, end), end - start | 0));
  }
}
class ConstantNumberConsumer extends NumberConsumer {
  ...
  i5j(storage, input, start, end) {
    ...
    if (toString(charSequenceSubSequence(input, start, end)) === this.l5j_1) {
      tmp = null;
    } else {
      tmp = new WrongConstant(this.l5j_1);
    }
    return tmp;
  }
}
...
class TooManyDigits {
  constructor(maxDigits) {
    this.n5j_1 = maxDigits;
  }
  m5j() {
    return 'expected at most ' + this.n5j_1 + ' digits';
  }
}
class TooFewDigits {
  constructor(minDigits) {
    this.o5j_1 = minDigits;
  }
  m5j() {
    return 'expected at least ' + this.o5j_1 + ' digits';
  }
}
class WrongConstant {
  constructor(expected) {
  ...
  m5j() {
    return "expected '" + this.p5j_1 + "'";
  }
}
class Conflicting {
  constructor(conflicting) {
    this.q5j_1 = conflicting;
  }
  m5j() {
    return "attempted to overwrite the existing value '" + toString(this.q5j_1) + "'";
  }
}
class UnsignedIntConsumer extends NumberConsumer {
  constructor(minLength, maxLength, setter, name, multiplyByMinus1) {
    ...
    super(minLength == maxLength ? minLength : null, name);
    this.t5j_1 = minLength;
    this.u5j_1 = maxLength;
    this.v5j_1 = setter;
    this.w5j_1 = multiplyByMinus1;
    // Inline function 'kotlin.require' call
    if (!(this.a() == null || numberRangeToNumber(1, 9).yr(this.a()))) {
      var message = 'Invalid length for field ' + this.h5j_1 + ': ' + this.a();
      throw IllegalArgumentException.a2(toString(message));
    }
  }
  i5j(storage, input, start, end) {
    var tmp;
    if (!(this.u5j_1 == null) && (end - start | 0) > this.u5j_1) {
      tmp = new TooManyDigits(this.u5j_1);
    } else if (!(this.t5j_1 == null) && (end - start | 0) < this.t5j_1) {
      tmp = new TooFewDigits(this.t5j_1);
    } else {
      var result = parseAsciiIntOrNull(input, start, end);
      tmp = result == null ? ExpectedInt_instance : setWithoutReassigning(this.v5j_1, storage, this.w5j_1 ? -result | 0 : result);
    }
    return tmp;
  }
}
...
class ParserState {
  constructor(output, parserStructure, inputPosition) {
    this.b5k_1 = output;
    this.c5k_1 = parserStructure;
    this.d5k_1 = inputPosition;
  }
}
class sam$kotlin_Comparator$0 {
  constructor(function_0) {
    this.m5k_1 = function_0;
  }
  qj(a, b) {
    return this.m5k_1(a, b);
  }
  compare(a, b) {
    return this.qj(a, b);
  }
...
class Parser {
  ...
  toString() {
    return Parser__toString_impl_x33iea(this.e5k_1);
  }
  hashCode() {
    return Parser__hashCode_impl_bbxllf(this.e5k_1);
  }
  equals(other) {
    return Parser__equals_impl_djxokv(this.e5k_1, other);
  }
}
class ParserStructure {
  constructor(operations, followedBy) {
    this.f5k_1 = operations;
    this.g5k_1 = followedBy;
  }
  toString() {
    return joinToString(this.f5k_1, ', ') + '(' + joinToString(this.g5k_1, ';') + ')';
  }
}
class Companion_15 {
  constructor() {
    this.n5k_1 = 5691186997393344103n;
  }
}
class ParseException extends Exception {
  constructor(errors) {
    return new.target.k5k(errors);
  }
  static k5k(errors) {
    var $this = this.ve(formatError(errors));
    captureStack($this, $this.j5k_1);
    return $this;
  }
}
class NumberSpanParserOperation {
  constructor(consumers) {
    this.o5k_1 = consumers;
    var tmp = this;
    // Inline function 'kotlin.collections.sumOf' call
    var sum = 0;
    var _iterator__ex2g4s = this.o5k_1.l1();
    while (_iterator__ex2g4s.m1()) {
      var element = _iterator__ex2g4s.n1();
      var tmp_0 = sum;
    ...
    tmp_1.q5k_1 = tmp$ret$2;
    var tmp0_0 = this.o5k_1;
    var tmp$ret$4;
    $l$block_2: {
      // Inline function 'kotlin.collections.all' call
      var tmp_3;
  ...
  h5k(storage, input, startIndex) {
    if ((startIndex + this.p5k_1 | 0) > charSequenceLength(input)) {
      var tmp = Companion_instance_14;
      return tmp.a5k(startIndex, NumberSpanParserOperation$consume$lambda(this));
    }
    ...
    if (digitsInRow._v < this.p5k_1) {
      var tmp_0 = Companion_instance_14;
      return tmp_0.a5k(startIndex, NumberSpanParserOperation$consume$lambda_0(digitsInRow, this));
    }
    var index = startIndex;
    var inductionVariable = 0;
    var last = this.o5k_1.l2() - 1 | 0;
    if (inductionVariable <= last)
      do {
        var i = inductionVariable;
        inductionVariable = inductionVariable + 1 | 0;
        var tmp0_elvis_lhs = this.o5k_1.n2(i).a();
        var length = tmp0_elvis_lhs == null ? (digitsInRow._v - this.p5k_1 | 0) + 1 | 0 : tmp0_elvis_lhs;
        var error = this.o5k_1.n2(i).i5j(storage, input, index, index + length | 0);
        if (!(error == null)) {
          var tmp2 = index;
          // Inline function 'kotlin.text.substring' call
          ...
          var tmp_2 = index;
          return tmp_1.a5k(tmp_2, NumberSpanParserOperation$consume$lambda_1(numberString, this, i, error));
        }
        index = index + length | 0;
      }
       while (inductionVariable <= last);
    return Companion_instance_14.z5j(index);
  }
  toString() {
...
class PlainStringParserOperation {
  constructor(string) {
    ...
    // Inline function 'kotlin.require' call
    if (!!isAsciiDigit(charCodeAt(this.r5k_1, 0))) {
      var message_0 = "String '" + this.r5k_1 + "' starts with a digit";
      throw IllegalArgumentException.a2(toString(message_0));
    }
    // Inline function 'kotlin.require' call
    if (!!isAsciiDigit(charCodeAt(this.r5k_1, this.r5k_1.length - 1 | 0))) {
      var message_1 = "String '" + this.r5k_1 + "' ends with a digit";
      throw IllegalArgumentException.a2(toString(message_1));
    }
  }
  h5k(storage, input, startIndex) {
    if ((startIndex + this.r5k_1.length | 0) > charSequenceLength(input)) {
      var tmp = Companion_instance_14;
      return tmp.a5k(startIndex, PlainStringParserOperation$consume$lambda(this));
    }
    var inductionVariable = 0;
    var last = charSequenceLength(this.r5k_1) - 1 | 0;
    if (inductionVariable <= last)
      do {
        var i = inductionVariable;
        inductionVariable = inductionVariable + 1 | 0;
        if (!(charSequenceGet(input, startIndex + i | 0) === charCodeAt(this.r5k_1, i))) {
          var tmp_0 = Companion_instance_14;
          return tmp_0.a5k(startIndex, PlainStringParserOperation$consume$lambda_0(this, input, startIndex, i));
        }
      }
       while (inductionVariable <= last);
    return Companion_instance_14.z5j(startIndex + this.r5k_1.length | 0);
  }
  toString() {
    return "'" + this.r5k_1 + "'";
  }
...
class SignParser {
  constructor(isNegativeSetter, withPlusSign, whatThisExpects) {
    this.s5k_1 = isNegativeSetter;
    this.t5k_1 = withPlusSign;
    this.u5k_1 = whatThisExpects;
  }
  h5k(storage, input, startIndex) {
    if (startIndex >= charSequenceLength(input))
      return Companion_instance_14.z5j(startIndex);
    var char = charSequenceGet(input, startIndex);
    if (char === _Char___init__impl__6a9atx(45)) {
      this.s5k_1(storage, true);
      return Companion_instance_14.z5j(startIndex + 1 | 0);
    }
    if (char === _Char___init__impl__6a9atx(43) && this.t5k_1) {
      this.s5k_1(storage, false);
      return Companion_instance_14.z5j(startIndex + 1 | 0);
    }
    var tmp = Companion_instance_14;
    return tmp.a5k(startIndex, SignParser$consume$lambda(this, char));
  }
  toString() {
    return this.u5k_1;
  }
...
class DecimalFraction {
  constructor(fractionalPart, digits) {
    this.j5c_1 = fractionalPart;
    this.k5c_1 = digits;
    // Inline function 'kotlin.require' call
    if (!(this.k5c_1 >= 0)) {
      var message = 'Digits must be non-negative, but was ' + this.k5c_1;
      throw IllegalArgumentException.a2(toString(message));
    }
  }
  l5c(newDigits) {
    return newDigits === this.k5c_1 ? this.j5c_1 : newDigits > this.k5c_1 ? imul(this.j5c_1, get_POWERS_OF_TEN()[newDigits - this.k5c_1 | 0]) : this.j5c_1 / get_POWERS_OF_TEN()[this.k5c_1 - newDigits | 0] | 0;
  }
  w5k(other) {
    var tmp0 = this.k5c_1;
    ...
    return compareTo(this.l5c(maxPrecision), other.l5c(maxPrecision));
  }
  d(other) {
    return this.w5k(other instanceof DecimalFraction ? other : THROW_CCE());
  }
  equals(other) {
    var tmp;
    if (other instanceof DecimalFraction) {
      tmp = this.w5k(other) === 0;
    } else {
      tmp = false;
    }
    return tmp;
  ...
  toString() {
    ...
    // Inline function 'kotlin.apply' call
    var this_0 = StringBuilder.h1();
    var denominator = get_POWERS_OF_TEN()[this.k5c_1];
    this_0.nh(this.j5c_1 / denominator | 0);
    this_0.k1(_Char___init__impl__6a9atx(46));
    this_0.i1(removePrefix((denominator + (this.j5c_1 % denominator | 0) | 0).toString(), '1'));
    return this_0.toString();
  }
  hashCode() {
...
class TimeBasedDateTimeUnitSerializer {
  constructor() {
    ...
    tmp.x5k_1 = lazy_0(tmp_0, TimeBasedDateTimeUnitSerializer$descriptor$delegate$lambda);
  }
  ez() {
    var tmp0 = this.x5k_1;
    var tmp = KProperty1;
  ...
  y5k(encoder, value) {
    ...
    var descriptor = this.ez();
    var composite = encoder.w13(descriptor);
    composite.h15(TimeBasedDateTimeUnitSerializer_getInstance().ez(), 0, value.i56_1);
    composite.x13(descriptor);
  }
  rz(encoder, value) {
    return this.y5k(encoder, value instanceof TimeBased ? value : THROW_CCE());
  }
  sz(decoder) {
    var seen = {_v: false};
    ...
    var descriptor = this.ez();
    var composite = decoder.w13(descriptor);
    if (composite.l14()) {
      nanoseconds._v = composite.c14(TimeBasedDateTimeUnitSerializer_getInstance().ez(), 0);
      seen._v = true;
    } else {
      loop: while (true) {
        var elementIndex = composite.m14(TimeBasedDateTimeUnitSerializer_getInstance().ez());
        switch (elementIndex) {
          case 0:
            nanoseconds._v = composite.c14(TimeBasedDateTimeUnitSerializer_getInstance().ez(), 0);
            seen._v = true;
...
class DateBasedDateTimeUnitSerializer extends AbstractPolymorphicSerializer {
  ...
  static a5l() {
    ...
    var tmp = $this;
    var tmp_0 = LazyThreadSafetyMode_PUBLICATION_getInstance();
    tmp.z5k_1 = lazy_0(tmp_0, DateBasedDateTimeUnitSerializer$impl$delegate$lambda);
    return $this;
  }
  c10(decoder, klassName) {
    return _get_impl__d88w17(this).c10(decoder, klassName);
  }
  b5l(encoder, value) {
    return _get_impl__d88w17(this).d10(encoder, value);
  }
  d10(encoder, value) {
    return this.b5l(encoder, value instanceof DateBased ? value : THROW_CCE());
  }
  a10() {
    return getKClass(DateBased);
  }
  ez() {
    return _get_impl__d88w17(this).ez();
  }
}
class DayBasedDateTimeUnitSerializer {
  constructor() {
    ...
    var tmp = this;
    var tmp_0 = LazyThreadSafetyMode_PUBLICATION_getInstance();
    tmp.c5l_1 = lazy_0(tmp_0, DayBasedDateTimeUnitSerializer$descriptor$delegate$lambda);
  }
  ez() {
    var tmp0 = this.c5l_1;
    var tmp = KProperty1;
  ...
  d5l(encoder, value) {
    ...
    var descriptor = this.ez();
    var composite = encoder.w13(descriptor);
    composite.g15(DayBasedDateTimeUnitSerializer_getInstance().ez(), 0, value.o56_1);
    composite.x13(descriptor);
  }
  rz(encoder, value) {
    return this.d5l(encoder, value instanceof DayBased ? value : THROW_CCE());
  }
  sz(decoder) {
    var seen = {_v: false};
    var days = {_v: 0};
    ...
    var composite = decoder.w13(descriptor);
    if (composite.l14()) {
      days._v = composite.b14(DayBasedDateTimeUnitSerializer_getInstance().ez(), 0);
      seen._v = true;
    } else {
      loop: while (true) {
        var elementIndex = composite.m14(DayBasedDateTimeUnitSerializer_getInstance().ez());
        switch (elementIndex) {
          case 0:
            days._v = composite.b14(DayBasedDateTimeUnitSerializer_getInstance().ez(), 0);
            seen._v = true;
    ...
    composite.x13(descriptor);
    if (!seen._v)
      throw MissingFieldException.s11('days', this.ez().m10());
...
class MonthBasedDateTimeUnitSerializer {
  constructor() {
    ...
    var tmp = this;
    var tmp_0 = LazyThreadSafetyMode_PUBLICATION_getInstance();
    tmp.e5l_1 = lazy_0(tmp_0, MonthBasedDateTimeUnitSerializer$descriptor$delegate$lambda);
  }
  ez() {
    var tmp0 = this.e5l_1;
    var tmp = KProperty1;
  ...
  f5l(encoder, value) {
    ...
    var descriptor = this.ez();
    var composite = encoder.w13(descriptor);
    composite.g15(MonthBasedDateTimeUnitSerializer_getInstance().ez(), 0, value.p56_1);
    composite.x13(descriptor);
  }
  rz(encoder, value) {
    return this.f5l(encoder, value instanceof MonthBased ? value : THROW_CCE());
  }
  sz(decoder) {
    var seen = {_v: false};
    var months = {_v: 0};
    ...
    var composite = decoder.w13(descriptor);
    if (composite.l14()) {
      months._v = composite.b14(MonthBasedDateTimeUnitSerializer_getInstance().ez(), 0);
      seen._v = true;
    } else {
      loop: while (true) {
        var elementIndex = composite.m14(MonthBasedDateTimeUnitSerializer_getInstance().ez());
        switch (elementIndex) {
          case 0:
            months._v = composite.b14(MonthBasedDateTimeUnitSerializer_getInstance().ez(), 0);
            seen._v = true;
...
class DateTimeUnitSerializer extends AbstractPolymorphicSerializer {
  ...
  static h5l() {
    ...
    var tmp = $this;
    var tmp_0 = LazyThreadSafetyMode_PUBLICATION_getInstance();
    tmp.g5l_1 = lazy_0(tmp_0, DateTimeUnitSerializer$impl$delegate$lambda);
    return $this;
  }
  c10(decoder, klassName) {
    return _get_impl__d88w17_0(this).c10(decoder, klassName);
  }
  i5l(encoder, value) {
    return _get_impl__d88w17_0(this).d10(encoder, value);
  }
  d10(encoder, value) {
    return this.i5l(encoder, value instanceof DateTimeUnit ? value : THROW_CCE());
  }
  a10() {
    return getKClass(DateTimeUnit);
  }
  ez() {
    return _get_impl__d88w17_0(this).ez();
  }
}
class LocalDateSerializer {
  constructor() {
    LocalDateSerializer_instance = this;
    this.j5l_1 = PrimitiveSerialDescriptor('kotlinx.datetime.LocalDate', STRING_getInstance());
  }
  ez() {
    return this.j5l_1;
  }
  sz(decoder) {
    return Companion_getInstance_17().o5l(decoder.s13());
  }
  p5l(encoder, value) {
    encoder.a15(value.toString());
  }
  rz(encoder, value) {
    return this.p5l(encoder, value instanceof LocalDate ? value : THROW_CCE());
  }
}
class LocalDateTimeSerializer {
  constructor() {
    LocalDateTimeSerializer_instance = this;
    this.q5l_1 = PrimitiveSerialDescriptor('kotlinx.datetime.LocalDateTime', STRING_getInstance());
  }
  ez() {
    return this.q5l_1;
  }
  sz(decoder) {
    return Companion_getInstance_18().t5l(decoder.s13());
  }
  u5l(encoder, value) {
    encoder.a15(value.toString());
  }
  rz(encoder, value) {
    return this.u5l(encoder, value instanceof LocalDateTime ? value : THROW_CCE());
  }
}
class LocalTimeSerializer {
  constructor() {
    LocalTimeSerializer_instance = this;
    this.v5l_1 = PrimitiveSerialDescriptor('kotlinx.datetime.LocalTime', STRING_getInstance());
  }
  ez() {
    return this.v5l_1;
  }
  sz(decoder) {
    return Companion_getInstance_19().y5l(decoder.s13());
  }
  z5l(encoder, value) {
    encoder.a15(value.toString());
  }
  rz(encoder, value) {
    return this.z5l(encoder, value instanceof LocalTime ? value : THROW_CCE());
  }
}
class UtcOffsetSerializer {
  constructor() {
    UtcOffsetSerializer_instance = this;
    this.a5m_1 = PrimitiveSerialDescriptor('kotlinx.datetime.UtcOffset', STRING_getInstance());
  }
  ez() {
    return this.a5m_1;
  }
  sz(decoder) {
    return Companion_getInstance_22().c5m(decoder.s13());
  }
  d5m(encoder, value) {
    encoder.a15(value.toString());
  }
  rz(encoder, value) {
    return this.d5m(encoder, value instanceof UtcOffset ? value : THROW_CCE());
  }
}
class YearMonthSerializer {
  constructor() {
    YearMonthSerializer_instance = this;
    this.e5m_1 = PrimitiveSerialDescriptor('kotlinx.datetime.YearMonth', STRING_getInstance());
  }
  ez() {
    return this.e5m_1;
  }
  sz(decoder) {
    return Companion_instance_22.f5m(decoder.s13());
  }
  g5m(encoder, value) {
    encoder.a15(value.toString());
  }
  rz(encoder, value) {
    return this.g5m(encoder, value instanceof YearMonth ? value : THROW_CCE());
  }
}
class Companion_16 {
  constructor() {
    Companion_instance_16 = this;
    this.k5l_1 = LocalDate.y59(-999999999, 1, 1);
    this.l5l_1 = LocalDate.y59(999999999, 12, 31);
    this.m5l_1 = -365243219162n;
    this.n5l_1 = 365241780471n;
  }
  h5m(input, format) {
    return format.xu(input);
  }
  o5l(input, format, $super) {
    format = format === VOID ? getIsoDateFormat() : format;
    return $super === VOID ? this.h5m(input, format) : $super.h5m.call(this, input, format);
  }
  i5m(epochDays) {
    // Inline function 'kotlin.require' call
    ...
    return LocalDate.j5m(convertToInt(yearEst), month, dom, Unit_instance);
  }
}
class Formats {
  constructor() {
    Formats_instance = this;
    this.q57_1 = get_ISO_DATE_BASIC();
  }
  r57() {
    return get_ISO_DATE();
  }
...
class LocalDate {
  constructor(year, month, day, unit) {
    return new.target.j5m(year, month, day, unit);
  }
  static j5m(year, month, day, unit) {
  ...
  static y59(year, month, day) {
    Companion_getInstance_17();
    var $this = this.j5m(year, month, day, Unit_instance);
    var containsArg = $this.x59_1;
    // Inline function 'kotlin.require' call
    if (!(1 <= containsArg ? containsArg <= 12 : false)) {
      var message = 'Invalid date: month must be a number between 1 and 12, got ' + $this.x59_1;
      throw IllegalArgumentException.a2(toString(message));
    }
  ...
  k5m() {
    var y = fromInt(this.v59_1);
    var m = fromInt(this.x59_1);
    var total = 0n;
  ...
  s59() {
    return (firstDayOfYear(this.z59(), isLeapYear(this.v59_1)) + this.w59_1 | 0) - 1 | 0;
  }
  l5m(other) {
    var y = compareTo(this.v59_1, other.v59_1);
    if (!(y === 0)) {
      return y;
    }
    var m = compareTo(this.x59_1, other.x59_1);
    if (!(m === 0)) {
      return m;
    }
    return compareTo(this.w59_1, other.w59_1);
  }
  d(other) {
    return this.l5m(other instanceof LocalDate ? other : THROW_CCE());
  }
  m5m(monthsToAdd) {
    if (monthsToAdd === 0n) {
      return this;
    }
    var tmp0 = multiply(numberToLong(this.v59_1), 12n);
    // Inline function 'kotlin.Long.plus' call
    var other = this.x59_1 - 1 | 0;
    ...
    return resolvePreviousValid(this, convertToInt(newYear), newMonth, this.w59_1);
  }
  n5m(daysToAdd) {
    return daysToAdd === 0n ? this : Companion_getInstance_17().i5m(safeAdd(this.k5m(), daysToAdd));
  }
  equals(other) {
    var tmp;
    if (this === other) {
  ...
  hashCode() {
    var yearValue = this.v59_1;
    var monthValue = this.x59_1;
    var dayValue = this.w59_1;
    return yearValue & -2048 ^ (((yearValue << 11) + (monthValue << 6) | 0) + dayValue | 0);
  }
  toString() {
    return format(this, Formats_getInstance().r57());
  }
}
class Companion_17 {
  constructor() {
    Companion_instance_17 = this;
    this.r5l_1 = LocalDateTime.u5b(Companion_getInstance_17().k5l_1, Companion_getInstance_19().w5l_1);
    this.s5l_1 = LocalDateTime.u5b(Companion_getInstance_17().l5l_1, Companion_getInstance_19().x5l_1);
  }
  o5m(input, format) {
    return format.xu(input);
  }
  t5l(input, format, $super) {
    format = format === VOID ? getIsoDateTimeFormat() : format;
    return $super === VOID ? this.o5m(input, format) : $super.o5m.call(this, input, format);
  }
}
class Formats_0 {
  constructor() {
    Formats_instance_0 = this;
    this.t57_1 = get_ISO_DATETIME();
  }
}
class LocalDateTime {
  constructor(date, time) {
    return new.target.u5b(date, time);
  }
  static u5b(date, time) {
  ...
  static p5m(year, month, day, hour, minute, second, nanosecond) {
    Companion_getInstance_18();
    second = second === VOID ? 0 : second;
    nanosecond = nanosecond === VOID ? 0 : nanosecond;
    return this.u5b(LocalDate.y59(year, month, day), LocalTime.q5c(hour, minute, second, nanosecond));
  }
  c5c() {
    return this.t5b_1.m5c_1;
  }
  x5b() {
    return this.t5b_1.n5c_1;
  }
  lw() {
    return this.t5b_1.o5c_1;
  }
  a5c() {
    return this.t5b_1.p5c_1;
  }
  q5m(other) {
    var d = this.s5b_1.l5m(other.s5b_1);
    if (!(d === 0)) {
      return d;
    }
    return this.t5b_1.r5m(other.t5b_1);
  }
  d(other) {
    return this.q5m(other instanceof LocalDateTime ? other : THROW_CCE());
  }
  equals(other) {
    var tmp;
    if (this === other) {
...
class Companion_18 {
  constructor() {
    ...
    this.w5l_1 = LocalTime.q5c(0, 0, 0, 0);
    this.x5l_1 = LocalTime.q5c(23, 59, 59, 999999999);
  }
  u5m(input, format) {
    return format.xu(input);
  }
  y5l(input, format, $super) {
    format = format === VOID ? getIsoTimeFormat() : format;
    return $super === VOID ? this.u5m(input, format) : $super.u5m.call(this, input, format);
  }
  v5m(secondOfDay, nanoOfSecond) {
    // Inline function 'kotlin.require' call
    ...
    return LocalTime.w5m(hours, minutes, second, nanoOfSecond, Unit_instance);
  }
}
class Formats_1 {
  r57() {
...
class LocalTime {
  constructor(hour, minute, second, nanosecond, unit) {
    return new.target.w5m(hour, minute, second, nanosecond, unit);
  }
  static w5m(hour, minute, second, nanosecond, unit) {
    Companion_getInstance_19();
    var $this = createThis(this);
    $this.m5c_1 = hour;
    $this.n5c_1 = minute;
    $this.o5c_1 = second;
    $this.p5c_1 = nanosecond;
    return $this;
  }
  static q5c(hour, minute, second, nanosecond) {
    Companion_getInstance_19();
    second = second === VOID ? 0 : second;
    nanosecond = nanosecond === VOID ? 0 : nanosecond;
    var $this = this.w5m(hour, minute, second, nanosecond, Unit_instance);
  ...
  r5m(other) {
    var h = compareTo(this.m5c_1, other.m5c_1);
    if (!(h === 0)) {
      return h;
    }
    var m = compareTo(this.n5c_1, other.n5c_1);
    if (!(m === 0)) {
      return m;
    }
    var s = compareTo(this.o5c_1, other.o5c_1);
    if (!(s === 0)) {
      return s;
    }
    return compareTo(this.p5c_1, other.p5c_1);
  }
  d(other) {
    return this.r5m(other instanceof LocalTime ? other : THROW_CCE());
  }
  hashCode() {
    var nod = this.x5m();
  ...
  t5m() {
    var total = imul(this.m5c_1, 3600);
    total = total + imul(this.n5c_1, 60) | 0;
    total = total + this.o5c_1 | 0;
    return total;
  }
  x5m() {
    var tmp0 = fromInt(this.m5c_1);
    // Inline function 'kotlin.Long.times' call
    var other = 1000000000;
    // Inline function 'kotlin.Long.times' call
...
class TimeZone {
  ...
  b5n(instant) {
    var tmp;
    try {
      tmp = toLocalDateTimeImpl(instant, this.a5n(instant));
    } catch ($p) {
      var tmp_0;
      if ($p instanceof IllegalArgumentException) {
        var e = $p;
        throw DateTimeArithmeticException.p57('Instant ' + instant.toString() + ' is not representable as LocalDateTime.', e);
      } else {
        throw $p;
      }
    }
  ...
  hashCode() {
    return getStringHashCode(this.j3f());
  }
  toString() {
    return this.j3f();
  }
...
class FixedOffsetTimeZone extends TimeZone {
  ...
  b5n(instant) {
    return toLocalDateTime_0(instant, this.y5m_1);
  }
}
class Companion_20 {
  constructor() {
    Companion_instance_20 = this;
    this.c5n_1 = new FixedOffsetTimeZone(Companion_getInstance_22().b5m_1, 'UTC');
  }
}
class Companion_21 {
  constructor() {
    Companion_instance_21 = this;
    this.b5m_1 = new UtcOffset(0);
  }
  d5n(input, format) {
    return format.xu(input);
  }
  c5m(input, format, $super) {
    format = format === VOID ? getIsoUtcOffsetFormat() : format;
    return $super === VOID ? this.d5n(input, format) : $super.d5n.call(this, input, format);
  }
  e5n(hours, minutes, seconds) {
    return hours === 0 && minutes === 0 && seconds === 0 ? this.b5m_1 : this.f5n((imul(hours, 3600) + imul(minutes, 60) | 0) + seconds | 0);
  }
  g5n(hours, minutes, seconds) {
    validate(this, hours, minutes, seconds);
    return this.e5n(hours, minutes, seconds);
  }
  f5n(seconds) {
...
class UtcOffset {
  ...
  toString() {
    return format_2(this, Formats_instance_2.r57());
  }
}
class Companion_22 {
  h5n(input, format) {
  ...
  f5m(input, format, $super) {
    format = format === VOID ? Formats_instance_3.r57() : format;
    return $super === VOID ? this.h5n(input, format) : $super.h5n.call(this, input, format);
  }
}
class Formats_3 {
  r57() {
...
class YearMonth {
  constructor(year, month, unit) {
    return new.target.i5n(year, month, unit);
  }
  static i5n(year, month, unit) {
    var $this = createThis(this);
    $this.w5f_1 = year;
    $this.x5f_1 = month;
    return $this;
  ...
  z59() {
    return Month_0(this.x5f_1);
  }
  static y5f(year, month) {
    var $this = this.i5n(year, month, Unit_instance);
    var containsArg = $this.x5f_1;
    // Inline function 'kotlin.require' call
    if (!(1 <= containsArg ? containsArg <= 12 : false)) {
  ...
  d(other) {
    return this.j5n(other instanceof YearMonth ? other : THROW_CCE());
  }
  toString() {
    return Formats_instance_3.r57().s57(this);
  }
  equals(other) {
    var tmp;
    var tmp_0;
    if (other instanceof YearMonth) {
      tmp_0 = this.w5f_1 === other.w5f_1;
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
      tmp = this.z59().equals(other.z59());
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    return imul(this.w5f_1, 31) + this.z59().hashCode() | 0;
  }
}
//endregion
...
function init_kotlinx_datetime_DateTimeFormatException(_this__u8e3s4) {
  captureStack(_this__u8e3s4, _this__u8e3s4.g57_1);
}
...
function char(_this__u8e3s4, value) {
  return _this__u8e3s4.j58(toString_0(value));
}
function optional(_this__u8e3s4, ifZero, format) {
  ...
  if (isInterface(_this__u8e3s4, AbstractDateTimeFormatBuilder)) {
    _this__u8e3s4.b59(ifZero, typeof format === 'function' ? format : THROW_CCE());
    tmp = Unit_instance;
  } else {
...
function alternativeParsing(_this__u8e3s4, alternativeFormats, primaryFormat) {
  ...
  if (isInterface(_this__u8e3s4, AbstractDateTimeFormatBuilder)) {
    ...
    _this__u8e3s4.c59(tmp_0, typeof primaryFormat === 'function' ? primaryFormat : THROW_CCE());
    tmp = Unit_instance;
  } else {
    throw IllegalStateException.o('impossible');
  }
...
function secondFractionInternal(_this__u8e3s4, minLength, maxLength, grouping) {
  (isInterface(_this__u8e3s4, AbstractWithTimeBuilder) ? _this__u8e3s4 : THROW_CCE()).i59(new BasicFormatStructure(new FractionalSecondDirective(minLength, maxLength, grouping)));
}
...
function DateFieldContainer$_get_day_$ref_2ebhxx() {
  return constructCallableReference((p0) => p0.o59(), 1, 0, 39);
}
...
function DateFieldContainer$_get_dayOfWeek_$ref_thwqom() {
  return constructCallableReference((p0) => p0.q59(), 1, 0, 41);
}
...
function DateFieldContainer$_get_dayOfYear_$ref_2m6gfz() {
  return constructCallableReference((p0) => p0.s59(), 1, 0, 43);
}
...
function ISO_DATE$delegate$lambda() {
  ...
  return tmp.h5a(ISO_DATE$delegate$lambda$lambda);
}
...
function ISO_DATE_BASIC$delegate$lambda() {
  _init_properties_LocalDateFormat_kt__k1uk9u();
  var tmp = Companion_instance_7;
  return tmp.h5a(ISO_DATE_BASIC$delegate$lambda$lambda);
}
...
function ISO_DATETIME$delegate$lambda() {
  ...
  return tmp.b5b(ISO_DATETIME$delegate$lambda$lambda);
}
function ISO_DATETIME$delegate$lambda$lambda($this$build) {
  _init_properties_LocalDateTimeFormat_kt__aloigl();
  $this$build.m58(get_ISO_DATE());
...
function TimeFieldContainer$_get_hour_$ref_8ezbwm() {
  return constructCallableReference((p0) => p0.c5c(), 1, 0, 48);
}
...
function TimeFieldContainer$_get_minute_$ref_evb2i2() {
  return constructCallableReference((p0) => p0.x5b(), 1, 0, 50);
}
...
function TimeFieldContainer$_get_second_$ref_t7tjxy() {
  return constructCallableReference((p0) => p0.lw(), 1, 0, 52);
}
...
function TimeFieldContainer$_get_fractionOfSecond_$ref_u85by5() {
  return constructCallableReference((p0) => p0.i5c(), 1, 0, 54);
}
...
function TimeFieldContainer$_get_amPm_$ref_u9tt1b() {
  return constructCallableReference((p0) => p0.g5c(), 1, 0, 56);
}
...
function TimeFieldContainer$_get_hourOfAmPm_$ref_okyxye() {
  return constructCallableReference((p0) => p0.e5c(), 1, 0, 58);
}
...
function ISO_TIME$delegate$lambda() {
  ...
  return tmp.r5c(ISO_TIME$delegate$lambda$lambda);
}
...
function UtcOffsetFieldContainer$_get_offsetIsNegative_$ref_v5gok2() {
  return constructCallableReference((p0) => p0.e5e(), 1, 0, 61);
}
...
function UtcOffsetFieldContainer$_get_offsetHours_$ref_elsov2() {
  return constructCallableReference((p0) => p0.g5e(), 1, 0, 63);
}
...
function UtcOffsetFieldContainer$_get_offsetMinutesOfHour_$ref_712kt() {
  return constructCallableReference((p0) => p0.i5e(), 1, 0, 65);
}
...
function UtcOffsetFieldContainer$_get_offsetSecondsOfMinute_$ref_xrmftp() {
  return constructCallableReference((p0) => p0.k5e(), 1, 0, 67);
}
...
function ISO_OFFSET$delegate$lambda() {
  ...
  return tmp.b5f(ISO_OFFSET$delegate$lambda$lambda);
}
...
function ISO_OFFSET_BASIC$delegate$lambda() {
  _init_properties_UtcOffsetFormat_kt__9r9ddw();
  var tmp = Companion_instance_11;
  return tmp.b5f(ISO_OFFSET_BASIC$delegate$lambda$lambda);
}
...
function FOUR_DIGIT_OFFSET$delegate$lambda() {
  _init_properties_UtcOffsetFormat_kt__9r9ddw();
  var tmp = Companion_instance_11;
  return tmp.b5f(FOUR_DIGIT_OFFSET$delegate$lambda$lambda);
}
...
function requireParsedField(field, name) {
  _init_properties_YearMonthFormat_kt__i0mmu0();
  if (field == null) {
    throw DateTimeFormatException.i57('Can not create a ' + name + ' from the given input: the field ' + name + ' is missing');
  }
  return field;
}
...
function YearMonthFieldContainer$_get_year_$ref_7j3zdj() {
  return constructCallableReference((p0) => p0.u59(), 1, 0, 70);
}
...
function YearMonthFieldContainer$_get_monthNumber_$ref_pn0wu5() {
  return constructCallableReference((p0) => p0.a5a(), 1, 0, 72);
}
...
function ISO_YEAR_MONTH$delegate$lambda() {
  ...
  return tmp.a5g(ISO_YEAR_MONTH$delegate$lambda$lambda);
}
...
function Accessor$getterNotNull$ref(p0) {
  return constructCallableReference((p0_0) => p0.q5h(p0_0), 1, 0, 75, 'getterNotNull', [p0]);
}
...
function Accessor$getter$ref(p0) {
  return constructCallableReference((p0_0) => p0.p5h(p0_0), 1, 0, 76, 'getter', [p0]);
}
function SignedFormatStructure$parser$lambda(this$0) {
  return (value, isNegative) => {
    var _iterator__ex2g4s = this$0.v5h_1.l1();
    while (_iterator__ex2g4s.m1()) {
      var field = _iterator__ex2g4s.n1();
      var wasNegative = field.i5f().p5h(value) === true;
      field.i5f().o5h(value, !(isNegative === wasNegative));
    }
    return Unit_instance;
  };
}
function formatter$checkIfAllNegative(this$0, value) {
  ...
  $l$loop: while (_iterator__ex2g4s.m1()) {
    ...
    if (check.i5f().p5h(value) === true)
      seenNonZero = true;
    else if (check.k5f(value))
      continue $l$loop;
    else
      return false;
  }
...
function OptionalFormatStructure$parser$lambda(this$0) {
  return (it) => {
    ...
    while (_iterator__ex2g4s.m1()) {
      ...
      field.x5h_1.o5h(it, field.y5h_1);
    }
    return Unit_instance;
  };
}
...
function basicFormats$rec($this_buildList, format) {
  if (format instanceof BasicFormatStructure)
    $this_buildList.e2(format.r5h_1);
  else {
    if (format instanceof ConcatenatedFormatStructure) {
      // Inline function 'kotlin.collections.forEach' call
      var _iterator__ex2g4s = format.h59_1.l1();
      ...
      if (!(format instanceof ConstantFormatStructure)) {
        if (format instanceof SignedFormatStructure) {
          basicFormats$rec($this_buildList, format.t5h_1);
        } else {
          if (format instanceof AlternativesParsingFormatStructure) {
            basicFormats$rec($this_buildList, format.c5i_1);
            // Inline function 'kotlin.collections.forEach' call
            var _iterator__ex2g4s_0 = format.d5i_1.l1();
            while (_iterator__ex2g4s_0.m1()) {
              var element_0 = _iterator__ex2g4s_0.n1();
            ...
            if (format instanceof OptionalFormatStructure) {
              basicFormats$rec($this_buildList, format.a5i_1);
            } else {
              noWhenBranchMatchedException();
            }
          }
...
function Predicate$test$ref(p0) {
  return constructCallableReference((p0_0) => p0.g5i(p0_0), 1, 0, 78, 'test', [p0]);
}
function Truth$test$ref(p0) {
  return constructCallableReference((p0_0) => p0.h5i(p0_0), 1, 0, 79, 'test', [p0]);
}
...
function setWithoutReassigning(_this__u8e3s4, receiver, value) {
  var tmp0_elvis_lhs = _this__u8e3s4.o5h(receiver, value);
  var tmp;
  if (tmp0_elvis_lhs == null) {
    return null;
  } else {
...
function Parser__match_impl_nzt83d($this, input, initialContainer, startIndex) {
  ...
  iterate_over_alternatives: while (true) {
    ...
    var state = tmp;
    var output = state.b5k_1.e5a();
    var inputPosition = state.d5k_1;
    var parserStructure = state.c5k_1;
    // Inline function 'kotlin.run' call
    $l$block: {
      var inductionVariable = 0;
      var last = parserStructure.f5k_1.l2() - 1 | 0;
      if (inductionVariable <= last)
        do {
          var ix = inductionVariable;
          inductionVariable = inductionVariable + 1 | 0;
          // Inline function 'kotlinx.datetime.internal.format.parser.ParseResult.match' call
          var this_0 = parserStructure.f5k_1.n2(ix).h5k(output, input, inputPosition);
      ...
      if (parserStructure.g5k_1.j1()) {
        ...
        var inductionVariable_0 = parserStructure.g5k_1.l2() - 1 | 0;
        if (0 <= inductionVariable_0)
          do {
            var ix_0 = inductionVariable_0;
            inductionVariable_0 = inductionVariable_0 + -1 | 0;
            parseOptions.e2(new ParserState(output, parserStructure.g5k_1.n2(ix_0), inputPosition));
          }
  ...
  throw ParseException.k5k(errors);
}
function Parser__match$default_impl_x2xlti($this, input, initialContainer, startIndex, $super) {
  ...
  if ($super === VOID) {
    ...
    var tmp_0 = $super;
    tmp = (tmp_0 == null ? null : new Parser(tmp_0)).l5k.call(new Parser($this), input, initialContainer, startIndex);
  }
  return tmp;
}
...
function Parser__equals_impl_djxokv($this, other) {
  if (!(other instanceof Parser))
    return false;
  var tmp0_other_with_cast = other instanceof Parser ? other.e5k_1 : THROW_CCE();
...
function concat(_this__u8e3s4) {
  ...
  while (_iterator__ex2g4s.m1()) {
    ...
    if (parser.g5k_1.j1()) {
      accumulatedOperations.e2(parser.f5k_1);
    } else {
...
function formatError(errors) {
  if (errors.l2() === 1) {
    return 'Position ' + errors.n2(0).x5j_1 + ': ' + errors.n2(0).y5j_1();
  }
...
function concat$mergeOperations(baseOperations, numberSpan, unconditionalModifications, simplifiedParserStructure) {
  var operationsToMerge = simplifiedParserStructure.f5k_1;
  ...
  if (numberSpan == null) {
    ...
    if (firstOperation instanceof NumberSpanParserOperation) {
      this_0.e2(new NumberSpanParserOperation(plus(numberSpan, firstOperation.o5k_1)));
      ...
      if (inductionVariable <= last)
        do {
          var i = inductionVariable;
          inductionVariable = inductionVariable + 1 | 0;
          this_0.e2(operationsToMerge.n2(i));
        }
         while (!(i === last));
    } else {
      this_0.e2(new NumberSpanParserOperation(numberSpan));
      this_0.m2(operationsToMerge);
    }
  }
  this_0.m2(unconditionalModifications);
  var mergedOperations = this_0.k5();
  return new ParserStructure(mergedOperations, simplifiedParserStructure.g5k_1);
}
function concat$simplifyAndAppend(_this__u8e3s4, other) {
  ...
  var _iterator__ex2g4s = _this__u8e3s4.f5k_1.l1();
  while (_iterator__ex2g4s.m1()) {
    var op = _iterator__ex2g4s.n1();
    if (op instanceof NumberSpanParserOperation) {
      if (!(currentNumberSpan == null)) {
        currentNumberSpan.m2(op.o5k_1);
      } else {
        currentNumberSpan = toMutableList(op.o5k_1);
      }
    } else {
      if (op instanceof UnconditionalModification)
        unconditionalModifications.e2(op);
      else {
        if (!(currentNumberSpan == null)) {
  ...
  while (_iterator__ex2g4s_0.m1()) {
    ...
    var tmp;
    if (simplified.f5k_1.j1()) {
      // Inline function 'kotlin.collections.ifEmpty' call
      var this_0 = simplified.g5k_1;
      var tmp_0;
      if (this_0.j1()) {
  ...
  if (tmp_4) {
    ...
    $l$block_0: {
      ...
      while (_iterator__ex2g4s_1.m1()) {
        ...
        var tmp_6 = firstOrNull(element_0.f5k_1);
...
function formatError$lambda(it) {
  return 'position ' + it.x5j_1 + ": '" + it.y5j_1() + "'";
}
...
function _get_whatThisExpects__4pg11j($this) {
  ...
  while (_iterator__ex2g4s.m1()) {
    var item = _iterator__ex2g4s.n1();
    var length = item.a();
    var tmp$ret$2 = (length == null ? 'at least one digit' : '' + length + ' digits') + (' for ' + item.h5j_1);
    destination.e2(tmp$ret$2);
  }
  var consumerLengths = destination;
  var tmp;
  if ($this.q5k_1) {
    tmp = 'a number with at least ' + $this.p5k_1 + ' digits: ' + toString(consumerLengths);
  } else {
    tmp = 'a number with exactly ' + $this.p5k_1 + ' digits: ' + toString(consumerLengths);
  }
  return tmp;
}
...
function NumberSpanParserOperation$consume$lambda_1($numberString, this$0, $i, $error) {
  return () => "Can not interpret the string '" + $numberString + "' as " + this$0.o5k_1.n2($i).h5j_1 + ': ' + $error.m5j();
}
...
function PlainStringParserOperation$consume$lambda(this$0) {
  return () => "Unexpected end of input: yet to parse '" + this$0.r5k_1 + "'";
}
function PlainStringParserOperation$consume$lambda_0(this$0, $input, $startIndex, $i) {
  return () => {
    ...
    return 'Expected ' + this$0.r5k_1 + ' but got ' + tmp$ret$0;
  };
}
function SignParser$consume$lambda(this$0, $char) {
  return () => 'Expected ' + this$0.u5k_1 + ' but got ' + toString_0($char);
}
...
function TimeBasedDateTimeUnitSerializer$descriptor$delegate$lambda$lambda($this$buildClassSerialDescriptor) {
  ...
  var this_0 = serializer(createKType(PrimitiveClasses_getInstance().rg(), arrayOf([]), false));
  var descriptor = (isInterface(this_0, KSerializer) ? this_0 : THROW_CCE()).ez();
  $this$buildClassSerialDescriptor.t12(elementName, descriptor, annotations, false);
  return Unit_instance;
}
function TimeBasedDateTimeUnitSerializer$_get_descriptor_$ref_ezonyw() {
  return constructCallableReference((p0) => p0.ez(), 1, 0, 80);
}
...
function DateBasedDateTimeUnitSerializer$impl$delegate$lambda() {
  ...
  return SealedClassSerializer.o10('kotlinx.datetime.DateTimeUnit.DateBased', tmp, tmp_0, tmp$ret$3);
}
...
function DateBasedDateTimeUnitSerializer_getInstance() {
  if (DateBasedDateTimeUnitSerializer_instance === VOID)
    DateBasedDateTimeUnitSerializer.a5l();
...
function DayBasedDateTimeUnitSerializer$descriptor$delegate$lambda$lambda($this$buildClassSerialDescriptor) {
  ...
  // Inline function 'kotlinx.serialization.serializer' call
  // Inline function 'kotlinx.serialization.internal.cast' call
  var this_0 = serializer(createKType(PrimitiveClasses_getInstance().qg(), arrayOf([]), false));
  var descriptor = (isInterface(this_0, KSerializer) ? this_0 : THROW_CCE()).ez();
  $this$buildClassSerialDescriptor.t12('days', descriptor, annotations, false);
  return Unit_instance;
}
function DayBasedDateTimeUnitSerializer$_get_descriptor_$ref_2ycvl3() {
  return constructCallableReference((p0) => p0.ez(), 1, 0, 82);
}
...
function MonthBasedDateTimeUnitSerializer$descriptor$delegate$lambda$lambda($this$buildClassSerialDescriptor) {
  ...
  var this_0 = serializer(createKType(PrimitiveClasses_getInstance().qg(), arrayOf([]), false));
  var descriptor = (isInterface(this_0, KSerializer) ? this_0 : THROW_CCE()).ez();
  $this$buildClassSerialDescriptor.t12('months', descriptor, annotations, false);
  return Unit_instance;
}
function MonthBasedDateTimeUnitSerializer$_get_descriptor_$ref_vroatn() {
  return constructCallableReference((p0) => p0.ez(), 1, 0, 83);
}
...
function DateTimeUnitSerializer$impl$delegate$lambda() {
  ...
  return SealedClassSerializer.o10('kotlinx.datetime.DateTimeUnit', tmp, tmp_0, tmp$ret$3);
}
...
function DateTimeUnitSerializer_getInstance() {
  if (DateTimeUnitSerializer_instance === VOID)
    DateTimeUnitSerializer.h5l();
  return DateTimeUnitSerializer_instance;
}
function throwUnknownIndexException(index) {
  throw SerializationException.f11('An unknown field for index ' + index);
}
...
function validateYearAndDay($this) {
  var containsArg = $this.v59_1;
  // Inline function 'kotlin.require' call
  if (!(-999999999 <= containsArg ? containsArg <= 999999999 : false)) {
    var message = 'Invalid date: the year is out of range';
    throw IllegalArgumentException.a2(toString(message));
  }
  var containsArg_0 = $this.w59_1;
  // Inline function 'kotlin.require' call
  if (!(1 <= containsArg_0 ? containsArg_0 <= 31 : false)) {
    var message_0 = 'Invalid date: day of month must be a number between 1 and 31, got ' + $this.w59_1;
    throw IllegalArgumentException.a2(toString(message_0));
  }
  if ($this.w59_1 > 28 && $this.w59_1 > monthLength($this.x59_1, isLeapYear($this.v59_1))) {
    if ($this.w59_1 === 29) {
      throw IllegalArgumentException.a2("Invalid date 'February 29' as '" + $this.v59_1 + "' is not a leap year");
    } else {
      throw IllegalArgumentException.a2("Invalid date '" + $this.z59().toString() + ' ' + $this.w59_1 + "'");
    }
  }
}
...
function resolvePreviousValid($this, year, month, day) {
  ...
  return LocalDate.j5m(year, month, newDay, Unit_instance);
}
function plus_1(_this__u8e3s4, value, unit) {
  ...
  try {
    ...
    if (unit instanceof DayBased) {
      tmp_0 = _this__u8e3s4.n5m(safeMultiply(value, fromInt(unit.o56_1)));
    } else {
      if (unit instanceof MonthBased) {
        tmp_0 = _this__u8e3s4.m5m(safeMultiply(value, fromInt(unit.p56_1)));
      } else {
        noWhenBranchMatchedException();
      }
    }
    ...
    if ($p instanceof ArithmeticException) {
      var e = $p;
      throw DateTimeArithmeticException.p57('Arithmetic overflow when adding a value to a date', e);
    } else {
      if ($p instanceof IllegalArgumentException) {
        var e_0 = $p;
        throw DateTimeArithmeticException.p57('Boundaries of LocalDate exceeded when adding a value', e_0);
      } else {
        throw $p;
      }
    }
...
function ISO_DATETIME_OPTIONAL_SECONDS_TRAILING_ZEROS$delegate$lambda() {
  _init_properties_LocalDateTime_kt__bewbbg();
  var tmp = Companion_instance_8;
  return tmp.b5b(ISO_DATETIME_OPTIONAL_SECONDS_TRAILING_ZEROS$delegate$lambda$lambda);
}
function ISO_DATETIME_OPTIONAL_SECONDS_TRAILING_ZEROS$delegate$lambda$lambda($this$build) {
  ...
  $this$build.u58(get_ISO_TIME_OPTIONAL_SECONDS_TRAILING_ZEROS());
  return Unit_instance;
}
...
function ISO_TIME_OPTIONAL_SECONDS_TRAILING_ZEROS$delegate$lambda() {
  _init_properties_LocalTime_kt__nmhi56();
  var tmp = Companion_instance_9;
  return tmp.r5c(ISO_TIME_OPTIONAL_SECONDS_TRAILING_ZEROS$delegate$lambda$lambda);
}
...
function ISO_TIME_OPTIONAL_SECONDS_TRAILING_ZEROS$delegate$lambda$lambda$lambda$lambda($this$optional) {
  _init_properties_LocalTime_kt__nmhi56();
  char($this$optional, _Char___init__impl__6a9atx(46));
  secondFractionInternal($this$optional, 1, 9, Companion_getInstance_11().s5d_1);
  return Unit_instance;
}
...
function toInstant(_this__u8e3s4, offset, youShallNotPass) {
  youShallNotPass = youShallNotPass === VOID ? Companion_getInstance_7().u57_1 : youShallNotPass;
  _init_properties_TimeZone_kt__dwyks9();
  return Companion_getInstance().uu(_this__u8e3s4.s5m(offset), _this__u8e3s4.a5c());
}
...
function toLocalDateTime(_this__u8e3s4, timeZone) {
  _init_properties_TimeZone_kt__dwyks9();
  return timeZone.b5n(_this__u8e3s4);
}
function toLocalDateTime_0(_this__u8e3s4, offset) {
  ...
  try {
    ...
    if ($p instanceof IllegalArgumentException) {
      var e = $p;
      throw DateTimeArithmeticException.p57('Instant ' + _this__u8e3s4.toString() + ' is not representable as LocalDateTime', e);
    } else {
      throw $p;
    }
  }
...
function toLocalDateTimeImpl(_this__u8e3s4, offset) {
  _init_properties_TimeZone_kt__dwyks9();
  var tmp0 = _this__u8e3s4.zu_1;
  // Inline function 'kotlin.Long.plus' call
  var other = offset.r5e_1;
  ...
  var date = Companion_getInstance_17().i5m(localEpochDay);
  var time = Companion_getInstance_19().v5m(secsOfDay, _this__u8e3s4.av_1);
  return LocalDateTime.u5b(date, time);
}
...
function lenientOffsetFormat$lambda$lambda($this$alternativeParsing) {
  _init_properties_TimeZone_kt__dwyks9();
  $this$alternativeParsing.v58(Padding_NONE_getInstance());
  return Unit_instance;
}
...
function _init_properties_TimeZone_kt__dwyks9() {
  if (!properties_initialized_TimeZone_kt_fgsidh) {
    ...
    var tmp = Companion_instance_11;
    lenientOffsetFormat = tmp.b5f(lenientOffsetFormat$lambda);
  }
}
...
function UtcOffset_0(hours, minutes, seconds) {
  ...
  if (!(hours == null)) {
    ...
    tmp = tmp_0.g5n(hours, tmp_1, seconds == null ? 0 : seconds);
  } else if (!(minutes == null)) {
    var tmp_2 = Companion_getInstance_22();
    var tmp_3 = minutes / 60 | 0;
    var tmp_4 = minutes % 60 | 0;
    tmp = tmp_2.g5n(tmp_3, tmp_4, seconds == null ? 0 : seconds);
  } else {
    var tmp_5 = Companion_getInstance_22();
    tmp = tmp_5.f5n(seconds == null ? 0 : seconds);
  }
  return tmp;
}
...
function validateYear($this) {
  var containsArg = $this.w5f_1;
  // Inline function 'kotlin.require' call
  if (!(-999999999 <= containsArg ? containsArg <= 999999999 : false)) {
    var message = 'Year ' + $this.w5f_1 + ' is out of range: -999999999..999999999';
    throw IllegalArgumentException.a2(toString(message));
  }
}
...
function YearMonth$_get_year_$ref_chp4n6() {
  return constructCallableReference((p0) => p0.w5f_1, 1, 0, 87);
}
function YearMonth$_get_month_$ref_9rphhd() {
  return constructCallableReference((p0) => p0.z59(), 1, 0, 88);
}
function safeAdd(a, b) {
  var sum = add(a, b);
  if ((a ^ sum) < 0n && (a ^ b) >= 0n) {
    throw ArithmeticException.if('Addition overflows a long: ' + a.toString() + ' + ' + b.toString());
  }
  return sum;
}
function safeMultiply(a, b) {
  ...
  if (!(divide(total, b) === a) || (a === -9223372036854775808n && b === -1n) || (b === -9223372036854775808n && a === -1n)) {
    throw ArithmeticException.if('Multiplication overflows a long: ' + a.toString() + ' * ' + b.toString());
  }
  return total;
}
function safeMultiply_0(a, b) {
  ...
  if (total < -2147483648n || total > 2147483647n) {
    throw ArithmeticException.if('Multiplication overflows an int: ' + a + ' * ' + b);
  }
...
initMetadataForClass(DateTimeFormatException, 'DateTimeFormatException', DateTimeFormatException.h57);
initMetadataForCompanion(Companion_5);
initMetadataForClass(DateTimeArithmeticException, 'DateTimeArithmeticException', DateTimeArithmeticException.o57);
...
protoOf(Builder).c59 = appendAlternativeParsingImpl;
protoOf(Builder).b59 = appendOptionalImpl;
protoOf(Builder).j58 = chars;
protoOf(Builder).l40 = build;
protoOf(Builder).k5a = addFormatStructureForYearMonth;
protoOf(Builder).k58 = day;
protoOf(Builder).l58 = day$default;
protoOf(Builder).m58 = date;
protoOf(Builder).f58 = year;
protoOf(Builder).g58 = year$default;
protoOf(Builder).h58 = monthNumber;
protoOf(Builder).i58 = monthNumber$default;
...
protoOf(Builder_0).c59 = appendAlternativeParsingImpl;
protoOf(Builder_0).b59 = appendOptionalImpl;
protoOf(Builder_0).j58 = chars;
protoOf(Builder_0).l40 = build;
protoOf(Builder_0).j5a = addFormatStructureForDate;
protoOf(Builder_0).i59 = addFormatStructureForTime;
protoOf(Builder_0).k5a = addFormatStructureForYearMonth;
protoOf(Builder_0).k58 = day;
protoOf(Builder_0).l58 = day$default;
protoOf(Builder_0).m58 = date;
protoOf(Builder_0).f58 = year;
protoOf(Builder_0).g58 = year$default;
protoOf(Builder_0).h58 = monthNumber;
protoOf(Builder_0).i58 = monthNumber$default;
protoOf(Builder_0).n58 = hour;
protoOf(Builder_0).o58 = hour$default;
protoOf(Builder_0).p58 = minute;
protoOf(Builder_0).q58 = minute$default;
protoOf(Builder_0).r58 = second;
protoOf(Builder_0).s58 = second$default;
protoOf(Builder_0).t58 = secondFraction;
protoOf(Builder_0).u58 = time;
...
protoOf(IncompleteLocalTime).h5c = set_fractionOfSecond;
protoOf(IncompleteLocalTime).i5c = get_fractionOfSecond;
...
protoOf(Builder_1).c59 = appendAlternativeParsingImpl;
protoOf(Builder_1).b59 = appendOptionalImpl;
protoOf(Builder_1).j58 = chars;
protoOf(Builder_1).l40 = build;
protoOf(Builder_1).n58 = hour;
protoOf(Builder_1).o58 = hour$default;
protoOf(Builder_1).p58 = minute;
protoOf(Builder_1).q58 = minute$default;
protoOf(Builder_1).r58 = second;
protoOf(Builder_1).s58 = second$default;
protoOf(Builder_1).t58 = secondFraction;
protoOf(Builder_1).u58 = time;
...
protoOf(Builder_2).c59 = appendAlternativeParsingImpl;
protoOf(Builder_2).b59 = appendOptionalImpl;
protoOf(Builder_2).j58 = chars;
protoOf(Builder_2).l40 = build;
protoOf(Builder_2).v58 = offsetHours;
protoOf(Builder_2).w58 = offsetHours$default;
protoOf(Builder_2).x58 = offsetMinutesOfHour;
protoOf(Builder_2).y58 = offsetMinutesOfHour$default;
protoOf(Builder_2).z58 = offsetSecondsOfMinute;
protoOf(Builder_2).a59 = offsetSecondsOfMinute$default;
...
protoOf(Builder_3).c59 = appendAlternativeParsingImpl;
protoOf(Builder_3).b59 = appendOptionalImpl;
protoOf(Builder_3).j58 = chars;
protoOf(Builder_3).l40 = build;
protoOf(Builder_3).f58 = year;
protoOf(Builder_3).g58 = year$default;
protoOf(Builder_3).h58 = monthNumber;
protoOf(Builder_3).i58 = monthNumber$default;
...
protoOf(PropertyAccessor).q5h = getterNotNull;
