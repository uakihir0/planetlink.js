...
class TimeBased extends DateTimeUnit {
  constructor(nanoseconds) {
    super();
    this.o56_1 = nanoseconds;
    // Inline function 'kotlin.require' call
    if (!(this.o56_1 > 0n)) {
      var message = 'Unit duration must be positive, but was ' + this.o56_1.toString() + ' ns.';
      throw IllegalArgumentException.a2(toString(message));
    }
    if (modulo(this.o56_1, 3600000000000n) === 0n) {
      this.p56_1 = 'HOUR';
      this.q56_1 = divide(this.o56_1, 3600000000000n);
    } else {
      if (modulo(this.o56_1, 60000000000n) === 0n) {
        this.p56_1 = 'MINUTE';
        this.q56_1 = divide(this.o56_1, 60000000000n);
      } else {
        var tmp0 = this.o56_1;
        ...
        if (modulo(tmp0, fromInt(other)) === 0n) {
          this.p56_1 = 'SECOND';
          var tmp = this;
          var tmp0_0 = this.o56_1;
          // Inline function 'kotlin.Long.div' call
          var other_0 = 1000000000;
          tmp.q56_1 = divide(tmp0_0, fromInt(other_0));
        } else {
          // Inline function 'kotlin.Long.rem' call
          var this_0 = this.o56_1;
          if (modulo(this_0, fromInt(1000000)) === 0n) {
            this.p56_1 = 'MILLISECOND';
            var tmp_0 = this;
            // Inline function 'kotlin.Long.div' call
            var this_1 = this.o56_1;
            tmp_0.q56_1 = divide(this_1, fromInt(1000000));
          } else {
            // Inline function 'kotlin.Long.rem' call
            var this_2 = this.o56_1;
            if (modulo(this_2, fromInt(1000)) === 0n) {
              this.p56_1 = 'MICROSECOND';
              var tmp_1 = this;
              // Inline function 'kotlin.Long.div' call
              var this_3 = this.o56_1;
              tmp_1.q56_1 = divide(this_3, fromInt(1000));
            } else {
              this.p56_1 = 'NANOSECOND';
              this.q56_1 = this.o56_1;
            }
          }
        }
      }
  ...
  r56(scalar) {
    return new TimeBased(safeMultiply(this.o56_1, fromInt(scalar)));
  }
  equals(other) {
    var tmp;
    if (this === other) {
  ...
  hashCode() {
    return convertToInt(this.o56_1) ^ convertToInt(shiftRight(this.o56_1, 32));
  }
  toString() {
    return this.s56(this.q56_1, this.p56_1);
  }
}
...
class DayBased extends DateBased {
  constructor(days) {
    ...
    // Inline function 'kotlin.require' call
    if (!(this.u56_1 > 0)) {
      var message = 'Unit duration must be positive, but was ' + this.u56_1 + ' days.';
      throw IllegalArgumentException.a2(toString(message));
    }
  }
  r56(scalar) {
    return new DayBased(safeMultiply_0(this.u56_1, scalar));
  }
  equals(other) {
    var tmp;
    if (this === other) {
  ...
  hashCode() {
    return this.u56_1 ^ 65536;
  }
  toString() {
    return (this.u56_1 % 7 | 0) === 0 ? this.t56(this.u56_1 / 7 | 0, 'WEEK') : this.t56(this.u56_1, 'DAY');
  }
}
class MonthBased extends DateBased {
  constructor(months) {
    ...
    // Inline function 'kotlin.require' call
    if (!(this.v56_1 > 0)) {
      var message = 'Unit duration must be positive, but was ' + this.v56_1 + ' months.';
      throw IllegalArgumentException.a2(toString(message));
    }
  }
  r56(scalar) {
    return new MonthBased(safeMultiply_0(this.v56_1, scalar));
  }
  equals(other) {
    var tmp;
    if (this === other) {
  ...
  hashCode() {
    return this.v56_1 ^ 131072;
  }
  toString() {
    return (this.v56_1 % 1200 | 0) === 0 ? this.t56(this.v56_1 / 1200 | 0, 'CENTURY') : (this.v56_1 % 12 | 0) === 0 ? this.t56(this.v56_1 / 12 | 0, 'YEAR') : (this.v56_1 % 3 | 0) === 0 ? this.t56(this.v56_1 / 3 | 0, 'QUARTER') : this.t56(this.v56_1, 'MONTH');
  }
}
class Companion_3 {
  constructor() {
    Companion_instance_3 = this;
    this.w56_1 = new TimeBased(1n);
    this.x56_1 = this.w56_1.r56(1000);
    this.y56_1 = this.x56_1.r56(1000);
    this.z56_1 = this.y56_1.r56(1000);
    this.a57_1 = this.z56_1.r56(60);
    this.b57_1 = this.a57_1.r56(60);
    this.c57_1 = new DayBased(1);
    this.d57_1 = this.c57_1.r56(7);
    this.e57_1 = new MonthBased(1);
    this.f57_1 = this.e57_1.r56(3);
    this.g57_1 = this.e57_1.r56(12);
    this.h57_1 = this.g57_1.r56(100);
  }
}
class DayOfWeek extends Enum {}
class Companion_4 {
  constructor() {
    this.i57_1 = 4231196759387994100n;
  }
}
...
class Companion_5 {
  constructor() {
    this.q57_1 = -3207806170214997982n;
  }
}
...
class AbstractDateTimeFormat {
  y57(value) {
    ...
    this.b58().i58().j58(this.c58(value), this_0);
    return this_0.toString();
  }
  zu(input) {
    var tmp;
    try {
      tmp = Parser__match$default_impl_x2xlti(_Parser___init__impl__gdyfby(this.b58().k58()), input, this.e58());
    } catch ($p) {
      var tmp_0;
      if ($p instanceof ParseException) {
        var e = $p;
        throw DateTimeFormatException.p57("Failed to parse value from '" + toString(input) + "'", e);
      } else {
        throw $p;
      }
    }
    var matched = tmp;
    try {
      return this.d58(matched);
    } catch ($p_0) {
      if ($p_0 instanceof IllegalArgumentException) {
        var e_0 = $p_0;
        var message = e_0.message;
        throw DateTimeFormatException.p57(message == null ? "The value parsed from '" + toString(input) + "' is invalid" : '' + message + " (when parsing '" + toString(input) + "')", e_0);
      } else {
        throw $p_0;
      }
    }
...
function year$default(padding, $super) {
  ...
  if ($super === VOID) {
    ...
    tmp = $super.l58.call(this, padding);
  }
  return tmp;
}
function monthNumber$default(padding, $super) {
  ...
  if ($super === VOID) {
    ...
    tmp = $super.n58.call(this, padding);
  }
  return tmp;
}
class WithDate {}
function day$default(padding, $super) {
  ...
  if ($super === VOID) {
    ...
    tmp = $super.q58.call(this, padding);
  }
  return tmp;
}
class WithTime {}
function hour$default(padding, $super) {
  ...
  if ($super === VOID) {
    ...
    tmp = $super.t58.call(this, padding);
  }
  return tmp;
}
function minute$default(padding, $super) {
  ...
  if ($super === VOID) {
    ...
    tmp = $super.v58.call(this, padding);
  }
  return tmp;
}
function second$default(padding, $super) {
  ...
  if ($super === VOID) {
    ...
    tmp = $super.x58.call(this, padding);
  }
  return tmp;
}
class WithUtcOffset {}
function offsetHours$default(padding, $super) {
  ...
  if ($super === VOID) {
    ...
    tmp = $super.b59.call(this, padding);
  }
  return tmp;
}
function offsetMinutesOfHour$default(padding, $super) {
  ...
  if ($super === VOID) {
    ...
    tmp = $super.d59.call(this, padding);
  }
  return tmp;
}
function offsetSecondsOfMinute$default(padding, $super) {
  ...
  if ($super === VOID) {
    ...
    tmp = $super.f59.call(this, padding);
  }
  return tmp;
}
...
function appendAlternativeParsingImpl(otherFormats, mainFormat) {
  ...
  var destination = ArrayList.h2(otherFormats.length);
  ...
  var this_1 = this.k59();
  mainFormat(this_1);
  var main = this_1.j59().s40();
  this.j59().m59(new AlternativesParsingFormatStructure(main, others));
}
function appendOptionalImpl(onZero, format) {
  ...
  var this_0 = this.k59();
  format(this_0);
  tmp.m59(new OptionalFormatStructure(onZero, this_0.j59().s40()));
}
function chars(value) {
  return this.j59().m59(new ConstantFormatStructure(value));
}
function build() {
  return new CachedFormatStructure(this.j59().s40().n59_1);
}
class IncompleteLocalDate {
  constructor(yearMonth, day, dayOfWeek, dayOfYear) {
    ...
    this.p59_1 = yearMonth;
    this.q59_1 = day;
    this.r59_1 = dayOfWeek;
    this.s59_1 = dayOfYear;
  }
  t59(_set____db54di) {
    this.q59_1 = _set____db54di;
  }
  u59() {
    return this.q59_1;
  }
  v59(_set____db54di) {
    this.r59_1 = _set____db54di;
  }
  w59() {
    return this.r59_1;
  }
  x59(_set____db54di) {
    this.s59_1 = _set____db54di;
  }
  y59() {
    return this.s59_1;
  }
  z59() {
    var year = requireParsedField(this.a5a(), 'year');
    var dayOfYear = this.s59_1;
    var tmp;
    if (dayOfYear == null) {
      tmp = LocalDate.e5a(year, requireParsedField(this.g5a(), 'monthNumber'), requireParsedField(this.q59_1, 'day'));
    } else {
      // Inline function 'kotlin.also' call
      var this_0 = plus_0(LocalDate.e5a(year, 1, 1), dayOfYear - 1 | 0, Companion_getInstance_4().c57_1);
      if (!(this_0.b5a_1 === year)) {
        throw DateTimeFormatException.o57('Can not create a LocalDate from the given input: ' + ('the day of year is ' + dayOfYear + ', which is not a valid day of year for the year ' + year));
      }
      if (!(this.g5a() == null) && !(get_number(this_0.f5a()) === this.g5a())) {
        throw DateTimeFormatException.o57('Can not create a LocalDate from the given input: ' + ('the day of year is ' + dayOfYear + ', which is ' + this_0.f5a().toString() + ', ') + ('but ' + this.g5a() + ' was specified as the month number'));
      }
      if (!(this.q59_1 == null) && !(this_0.c5a_1 === this.q59_1)) {
        throw DateTimeFormatException.o57('Can not create a LocalDate from the given input: ' + ('the day of year is ' + dayOfYear + ', which is the day ' + this_0.c5a_1 + ' of ' + this_0.f5a().toString() + ', ') + ('but ' + this.q59_1 + ' was specified as the day of month'));
      }
      tmp = this_0;
    }
    var date = tmp;
    var tmp0_safe_receiver = this.r59_1;
    if (tmp0_safe_receiver == null)
      null;
    else {
      // Inline function 'kotlin.let' call
      if (!(tmp0_safe_receiver === get_isoDayNumber(date.w59()))) {
        throw DateTimeFormatException.o57('Can not create a LocalDate from the given input: ' + ('the day of week is ' + DayOfWeek_0(tmp0_safe_receiver).toString() + ' but the date is ' + date.toString() + ', which is a ' + date.w59().toString()));
      }
    }
    return date;
  }
  h5a(date) {
    this.i5a(date.b5a_1);
    this.j5a(get_number(date.f5a()));
    this.q59_1 = date.c5a_1;
    this.r59_1 = get_isoDayNumber(date.w59());
    this.s59_1 = date.y59();
  }
  k5a() {
    return new IncompleteLocalDate(this.p59_1.k5a(), this.q59_1, this.r59_1, this.s59_1);
  }
  equals(other) {
    var tmp;
    var tmp_0;
    ...
    if (other instanceof IncompleteLocalDate) {
      tmp_2 = this.p59_1.equals(other.p59_1);
    } else {
      tmp_2 = false;
    }
    if (tmp_2) {
      tmp_1 = this.q59_1 == other.q59_1;
    } else {
      tmp_1 = false;
    }
    if (tmp_1) {
      tmp_0 = this.r59_1 == other.r59_1;
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
      tmp = this.s59_1 == other.s59_1;
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    var tmp = imul(this.p59_1.hashCode(), 29791);
  ...
  toString() {
    var tmp;
    if (this.s59_1 == null) {
      var tmp_0 = this.p59_1.toString();
      var tmp0_elvis_lhs = this.q59_1;
      var tmp_1 = toString(tmp0_elvis_lhs == null ? '??' : tmp0_elvis_lhs);
      var tmp1_elvis_lhs = this.r59_1;
      tmp = tmp_0 + '-' + tmp_1 + ' (day of week is ' + toString(tmp1_elvis_lhs == null ? '??' : tmp1_elvis_lhs) + ')';
    } else if (this.q59_1 == null && this.g5a() == null) {
      var tmp2_elvis_lhs = this.p59_1.l5a_1;
      var tmp_2 = toString(tmp2_elvis_lhs == null ? '??' : tmp2_elvis_lhs);
      var tmp_3 = this.s59_1;
      var tmp3_elvis_lhs = this.r59_1;
      tmp = '(' + tmp_2 + ')-' + tmp_3 + ' (day of week is ' + toString(tmp3_elvis_lhs == null ? '??' : tmp3_elvis_lhs) + ')';
    } else {
      var tmp_4 = this.p59_1.toString();
      var tmp4_elvis_lhs = this.q59_1;
      var tmp_5 = toString(tmp4_elvis_lhs == null ? '??' : tmp4_elvis_lhs);
      var tmp5_elvis_lhs = this.r59_1;
      tmp = tmp_4 + '-' + tmp_5 + ' (day of week is ' + toString(tmp5_elvis_lhs == null ? '??' : tmp5_elvis_lhs) + ', day of year is ' + this.s59_1 + ')';
    }
    return tmp;
  }
  i5a(_set____db54di) {
    this.p59_1.l5a_1 = _set____db54di;
  }
  a5a() {
    return this.p59_1.l5a_1;
  }
  j5a(_set____db54di) {
    this.p59_1.m5a_1 = _set____db54di;
  }
  g5a() {
    return this.p59_1.m5a_1;
  }
}
class Companion_7 {
  n5a(block) {
    ...
    block(builder);
    return new LocalDateFormat(builder.s40());
  }
}
class AbstractWithYearMonthBuilder {}
function year(padding) {
  return this.q5a(new BasicFormatStructure(new YearDirective(padding)));
}
function monthNumber(padding) {
  return this.q5a(new BasicFormatStructure(new MonthDirective(padding)));
}
...
function day(padding) {
  return this.p5a(new BasicFormatStructure(new DayDirective(padding)));
}
function date(format) {
  return this.p5a((format instanceof LocalDateFormat ? format : THROW_CCE()).r5a_1);
}
class Builder {
  constructor(actualBuilder) {
    this.o5a_1 = actualBuilder;
  }
  j59() {
    return this.o5a_1;
  }
  p5a(structure) {
    return this.o5a_1.m59(structure);
  }
  k59() {
...
class LocalDateFormat extends AbstractDateTimeFormat {
  ...
  c58(value) {
    return this.s5a(value instanceof LocalDate ? value : THROW_CCE());
  }
  t5a(intermediate) {
    return intermediate.z59();
  }
  d58(intermediate) {
    return this.t5a(intermediate instanceof IncompleteLocalDate ? intermediate : THROW_CCE());
  }
  e58() {
...
class UnsignedIntFieldFormatDirective {
  constructor(field, minDigits, spacePadding) {
    ...
    this.e5b_1 = spacePadding;
    this.f5b_1 = this.c5b_1.k5h_1;
    // Inline function 'kotlin.require' call
    if (!(this.d5b_1 >= 0)) {
      var message = 'The minimum number of digits (' + this.d5b_1 + ') is negative';
      throw IllegalArgumentException.a2(toString(message));
    }
    // Inline function 'kotlin.require' call
    if (!(this.f5b_1 >= this.d5b_1)) {
      var message_0 = 'The maximum number of digits (' + this.f5b_1 + ') is less than the minimum number of digits (' + this.d5b_1 + ')';
      throw IllegalArgumentException.a2(toString(message_0));
    }
    if (!(this.e5b_1 == null)) {
      // Inline function 'kotlin.require' call
      if (!(this.e5b_1 > this.d5b_1)) {
        var message_1 = 'The space padding (' + this.e5b_1 + ') should be more than the minimum number of digits (' + this.d5b_1 + ')';
  ...
  i58() {
    var formatter = new UnsignedIntFormatterStructure(Accessor$getterNotNull$ref(this.c5b_1.e5h_1), this.d5b_1);
    return !(this.e5b_1 == null) ? new SpacePaddedFormatter(formatter, this.e5b_1) : formatter;
  }
  k58() {
    return spaceAndZeroPaddedUnsignedInt(this.d5b_1, this.f5b_1, this.e5b_1, this.c5b_1.e5h_1, this.c5b_1.h5h_1);
  }
}
class DayDirective extends UnsignedIntFieldFormatDirective {
  constructor(padding) {
    var tmp = DateFields_getInstance().u5a_1;
  ...
  equals(other) {
    ...
    if (other instanceof DayDirective) {
      tmp = this.b5b_1.equals(other.b5b_1);
    } else {
      tmp = false;
    }
    return tmp;
...
class DateFields {
  constructor() {
    ...
    tmp.u5a_1 = new UnsignedFieldSpec(new PropertyAccessor(getPropertyCallableRef('day', 1, tmp_0, tmp_1, DateFieldContainer$_set_day_$ref_s0jsax())), 1, 31);
    var tmp_2 = this;
    var tmp_3 = KMutableProperty1;
    var tmp_4 = DateFieldContainer$_get_dayOfWeek_$ref_thwqom();
    tmp_2.v5a_1 = new UnsignedFieldSpec(new PropertyAccessor(getPropertyCallableRef('dayOfWeek', 1, tmp_3, tmp_4, DateFieldContainer$_set_dayOfWeek_$ref_ea586a())), 1, 7);
    var tmp_5 = this;
    var tmp_6 = KMutableProperty1;
    var tmp_7 = DateFieldContainer$_get_dayOfYear_$ref_2m6gfz();
    tmp_5.w5a_1 = new UnsignedFieldSpec(new PropertyAccessor(getPropertyCallableRef('dayOfYear', 1, tmp_6, tmp_7, DateFieldContainer$_set_dayOfYear_$ref_cll22d())), 1, 366);
  }
}
class Companion_8 {
  h5b(block) {
    ...
    block(builder);
    return new LocalDateTimeFormat(builder.s40());
  }
}
class AbstractWithTimeBuilder {}
function hour(padding) {
  return this.o59(new BasicFormatStructure(new HourDirective(padding)));
}
function minute(padding) {
  return this.o59(new BasicFormatStructure(new MinuteDirective(padding)));
}
function second(padding) {
  return this.o59(new BasicFormatStructure(new SecondDirective(padding)));
}
function secondFraction(minLength, maxLength) {
  return this.o59(new BasicFormatStructure(new FractionalSecondDirective(minLength, maxLength)));
}
function time(format) {
  return this.o59((format instanceof LocalTimeFormat ? format : THROW_CCE()).z5c_1);
}
...
class Builder_0 {
  constructor(actualBuilder) {
    this.i5b_1 = actualBuilder;
  }
  j59() {
    return this.i5b_1;
  }
  j5b(structure) {
    this.i5b_1.m59(structure);
  }
  k59() {
...
class LocalDateTimeFormat extends AbstractDateTimeFormat {
  ...
  c58(value) {
    return this.l5b(value instanceof LocalDateTime ? value : THROW_CCE());
  }
  p5b(intermediate) {
    return intermediate.q5b();
  }
  d58(intermediate) {
    return this.p5b(intermediate instanceof IncompleteLocalDateTime ? intermediate : THROW_CCE());
  }
  e58() {
...
function set_fractionOfSecond(value) {
  this.f5c(value == null ? null : value.r5c(9));
}
function get_fractionOfSecond() {
  var tmp0_safe_receiver = this.g5c();
  var tmp;
  if (tmp0_safe_receiver == null) {
    tmp = null;
  } else {
...
class IncompleteLocalDateTime {
  ...
  q5b() {
    return LocalDateTime.a5c(this.m5b_1.z59(), this.n5b_1.x5b());
  }
  o5b(dateTime) {
    this.m5b_1.h5a(dateTime.y5b_1);
    this.n5b_1.b5c(dateTime.z5b_1);
  }
  k5a() {
    return new IncompleteLocalDateTime(this.m5b_1.k5a(), this.n5b_1.k5a());
  }
  t59(_set____db54di) {
    this.m5b_1.q59_1 = _set____db54di;
  }
  u59() {
    return this.m5b_1.q59_1;
  }
  v59(_set____db54di) {
    this.m5b_1.r59_1 = _set____db54di;
  }
  w59() {
    return this.m5b_1.r59_1;
  }
  x59(_set____db54di) {
    this.m5b_1.s59_1 = _set____db54di;
  }
  y59() {
    return this.m5b_1.s59_1;
  }
  i5a(_set____db54di) {
    this.m5b_1.i5a(_set____db54di);
  }
  a5a() {
    return this.m5b_1.a5a();
  }
  j5a(_set____db54di) {
    this.m5b_1.j5a(_set____db54di);
  }
  g5a() {
    return this.m5b_1.g5a();
  }
  c5c(_set____db54di) {
    this.n5b_1.u5b_1 = _set____db54di;
  }
  d5c() {
    return this.n5b_1.u5b_1;
  }
  e5c(_set____db54di) {
    this.n5b_1.v5b_1 = _set____db54di;
  }
  nw() {
    return this.n5b_1.v5b_1;
  }
  f5c(_set____db54di) {
    this.n5b_1.w5b_1 = _set____db54di;
  }
  g5c() {
    return this.n5b_1.w5b_1;
  }
  h5c(_set____db54di) {
    this.n5b_1.r5b_1 = _set____db54di;
  }
  i5c() {
    return this.n5b_1.r5b_1;
  }
  j5c(_set____db54di) {
    this.n5b_1.s5b_1 = _set____db54di;
  }
  k5c() {
    return this.n5b_1.s5b_1;
  }
  l5c(_set____db54di) {
    this.n5b_1.t5b_1 = _set____db54di;
  }
  m5c() {
    return this.n5b_1.t5b_1;
  }
  n5c(value) {
    this.n5b_1.n5c(value);
  }
  o5c() {
    return this.n5b_1.o5c();
  }
}
class IncompleteLocalTime {
  constructor(hour, hourOfAmPm, amPm, minute, second, nanosecond) {
    ...
    this.r5b_1 = hour;
    this.s5b_1 = hourOfAmPm;
    this.t5b_1 = amPm;
    this.u5b_1 = minute;
    this.v5b_1 = second;
    this.w5b_1 = nanosecond;
  }
  h5c(_set____db54di) {
    this.r5b_1 = _set____db54di;
  }
  i5c() {
    return this.r5b_1;
  }
  ...
  x5b() {
    var tmp0_safe_receiver = this.r5b_1;
    var tmp;
    if (tmp0_safe_receiver == null) {
      tmp = null;
    } else {
      // Inline function 'kotlin.let' call
      var tmp0_safe_receiver_0 = this.s5b_1;
      ...
      var tmp1_safe_receiver = this.t5b_1;
    ...
    if (tmp1_elvis_lhs == null) {
      var tmp2_safe_receiver = this.s5b_1;
      var tmp_1;
      if (tmp2_safe_receiver == null) {
        tmp_1 = null;
      } else {
        // Inline function 'kotlin.let' call
        var tmp0_safe_receiver_1 = this.t5b_1;
        var tmp_2;
    ...
    if (tmp3_elvis_lhs == null) {
      throw DateTimeFormatException.o57('Incomplete time: missing hour');
    } else {
      tmp_3 = tmp3_elvis_lhs;
    }
    var hour = tmp_3;
    var tmp_4 = requireParsedField(this.u5b_1, 'minute');
    var tmp4_elvis_lhs = this.v5b_1;
    var tmp_5 = tmp4_elvis_lhs == null ? 0 : tmp4_elvis_lhs;
    var tmp5_elvis_lhs = this.w5b_1;
    return LocalTime.w5c(hour, tmp_4, tmp_5, tmp5_elvis_lhs == null ? 0 : tmp5_elvis_lhs);
  }
  b5c(localTime) {
    this.r5b_1 = localTime.s5c_1;
    this.s5b_1 = ((localTime.s5c_1 + 11 | 0) % 12 | 0) + 1 | 0;
    this.t5b_1 = localTime.s5c_1 >= 12 ? AmPmMarker_PM_getInstance() : AmPmMarker_AM_getInstance();
    this.u5b_1 = localTime.t5c_1;
    this.v5b_1 = localTime.u5c_1;
    this.w5b_1 = localTime.v5c_1;
  }
  k5a() {
    return new IncompleteLocalTime(this.r5b_1, this.s5b_1, this.t5b_1, this.u5b_1, this.v5b_1, this.w5b_1);
  }
  equals(other) {
    var tmp;
    var tmp_0;
    ...
    if (other instanceof IncompleteLocalTime) {
      tmp_4 = this.r5b_1 == other.r5b_1;
    } else {
      tmp_4 = false;
    }
    if (tmp_4) {
      tmp_3 = this.s5b_1 == other.s5b_1;
    } else {
      tmp_3 = false;
    }
    if (tmp_3) {
      tmp_2 = equals(this.t5b_1, other.t5b_1);
    } else {
      tmp_2 = false;
    }
    if (tmp_2) {
      tmp_1 = this.u5b_1 == other.u5b_1;
    } else {
      tmp_1 = false;
    }
    if (tmp_1) {
      tmp_0 = this.v5b_1 == other.v5b_1;
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
      tmp = this.w5b_1 == other.w5b_1;
    } else {
      tmp = false;
    }
    return tmp;
...
class Companion_9 {
  x5c(block) {
    ...
    block(builder);
    return new LocalTimeFormat(builder.s40());
  }
}
class Builder_1 {
  constructor(actualBuilder) {
    this.y5c_1 = actualBuilder;
  }
  j59() {
    return this.y5c_1;
  }
  o59(structure) {
    this.y5c_1.m59(structure);
  }
  k59() {
...
class LocalTimeFormat extends AbstractDateTimeFormat {
  ...
  c58(value) {
    return this.a5d(value instanceof LocalTime ? value : THROW_CCE());
  }
  b5d(intermediate) {
    return intermediate.x5b();
  }
  d58(intermediate) {
    return this.b5d(intermediate instanceof IncompleteLocalTime ? intermediate : THROW_CCE());
  }
  e58() {
...
class HourDirective extends UnsignedIntFieldFormatDirective {
  constructor(padding) {
    var tmp = TimeFields_getInstance().c5d_1;
    // Inline function 'kotlinx.datetime.format.minDigits' call
    var tmp_0 = padding.equals(Padding_ZERO_getInstance()) ? 2 : 1;
    // Inline function 'kotlinx.datetime.format.spaces' call
    super(tmp, tmp_0, padding.equals(Padding_SPACE_getInstance()) ? 2 : null);
  ...
  equals(other) {
    ...
    if (other instanceof HourDirective) {
      tmp = this.m5d_1.equals(other.m5d_1);
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    return this.m5d_1.hashCode();
  }
}
class MinuteDirective extends UnsignedIntFieldFormatDirective {
  constructor(padding) {
    var tmp = TimeFields_getInstance().d5d_1;
    // Inline function 'kotlinx.datetime.format.minDigits' call
    var tmp_0 = padding.equals(Padding_ZERO_getInstance()) ? 2 : 1;
    // Inline function 'kotlinx.datetime.format.spaces' call
    super(tmp, tmp_0, padding.equals(Padding_SPACE_getInstance()) ? 2 : null);
...
class SecondDirective extends UnsignedIntFieldFormatDirective {
  constructor(padding) {
    var tmp = TimeFields_getInstance().e5d_1;
    // Inline function 'kotlinx.datetime.format.minDigits' call
    var tmp_0 = padding.equals(Padding_ZERO_getInstance()) ? 2 : 1;
    // Inline function 'kotlinx.datetime.format.spaces' call
    super(tmp, tmp_0, padding.equals(Padding_SPACE_getInstance()) ? 2 : null);
...
class Companion_10 {
  constructor() {
    ...
    this.x5d_1 = listOf([0, 0, 0, 0, 0, 0, 0, 0, 0]);
    this.y5d_1 = listOf([2, 1, 0, 2, 1, 0, 2, 1, 0]);
  }
}
class DecimalFractionFieldFormatDirective {
  constructor(field, minDigits, maxDigits, zerosToAdd) {
    this.f5e_1 = field;
    this.g5e_1 = minDigits;
    this.h5e_1 = maxDigits;
    this.i5e_1 = zerosToAdd;
  }
  g5b() {
    return this.f5e_1;
  }
  i58() {
    return new DecimalFractionFormatterStructure(Accessor$getterNotNull$ref_0(this.f5e_1.c2z()), this.g5e_1, this.h5e_1, this.i5e_1);
  }
  k58() {
    return new ParserStructure(listOf_0(new NumberSpanParserOperation(listOf_0(new FractionPartConsumer(this.g5e_1, this.h5e_1, this.f5e_1.c2z(), this.f5e_1.d1())))), emptyList());
  }
}
class FractionalSecondDirective extends DecimalFractionFieldFormatDirective {
  constructor(minDigits, maxDigits, zerosToAdd) {
    ...
    zerosToAdd = zerosToAdd === VOID ? Companion_getInstance_11().x5d_1 : zerosToAdd;
    super(TimeFields_getInstance().f5d_1, minDigits, maxDigits, zerosToAdd);
    this.d5e_1 = minDigits;
    this.e5e_1 = maxDigits;
  }
  equals(other) {
    var tmp;
    var tmp_0;
    if (other instanceof FractionalSecondDirective) {
      tmp_0 = this.d5e_1 === other.d5e_1;
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
      tmp = this.e5e_1 === other.e5e_1;
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    return imul(31, this.d5e_1) + this.e5e_1 | 0;
  }
}
class TimeFields {
  constructor() {
    ...
    tmp.c5d_1 = new UnsignedFieldSpec(new PropertyAccessor(getPropertyCallableRef('hour', 1, tmp_0, tmp_1, TimeFieldContainer$_set_hour_$ref_l7vnde())), 0, 23);
    var tmp_2 = this;
    var tmp_3 = KMutableProperty1;
    var tmp_4 = TimeFieldContainer$_get_minute_$ref_evb2i2();
    tmp_2.d5d_1 = new UnsignedFieldSpec(new PropertyAccessor(getPropertyCallableRef('minute', 1, tmp_3, tmp_4, TimeFieldContainer$_set_minute_$ref_6xin6())), 0, 59);
    var tmp_5 = this;
    var tmp_6 = KMutableProperty1;
    var tmp_7 = TimeFieldContainer$_get_second_$ref_t7tjxy();
    tmp_5.e5d_1 = new UnsignedFieldSpec(new PropertyAccessor(getPropertyCallableRef('second', 1, tmp_6, tmp_7, TimeFieldContainer$_set_second_$ref_qr1wvy())), 0, 59, VOID, 0);
    var tmp_8 = this;
    var tmp_9 = KMutableProperty1;
    var tmp_10 = TimeFieldContainer$_get_fractionOfSecond_$ref_u85by5();
    tmp_8.f5d_1 = new GenericFieldSpec(new PropertyAccessor(getPropertyCallableRef('fractionOfSecond', 1, tmp_9, tmp_10, TimeFieldContainer$_set_fractionOfSecond_$ref_quw20n()), 'nanosecond'), VOID, new DecimalFraction(0, 9));
    var tmp_11 = this;
    var tmp_12 = KMutableProperty1;
    var tmp_13 = TimeFieldContainer$_get_amPm_$ref_u9tt1b();
    tmp_11.g5d_1 = new GenericFieldSpec(new PropertyAccessor(getPropertyCallableRef('amPm', 1, tmp_12, tmp_13, TimeFieldContainer$_set_amPm_$ref_hgxhkj())));
    var tmp_14 = this;
    var tmp_15 = KMutableProperty1;
    var tmp_16 = TimeFieldContainer$_get_hourOfAmPm_$ref_okyxye();
    tmp_14.h5d_1 = new UnsignedFieldSpec(new PropertyAccessor(getPropertyCallableRef('hourOfAmPm', 1, tmp_15, tmp_16, TimeFieldContainer$_set_hourOfAmPm_$ref_y4i32())), 1, 12);
  }
}
...
class IncompleteUtcOffset {
  constructor(offsetIsNegative, offsetHours, offsetMinutesOfHour, offsetSecondsOfMinute) {
    ...
    this.r5e_1 = offsetIsNegative;
    this.s5e_1 = offsetHours;
    this.t5e_1 = offsetMinutesOfHour;
    this.u5e_1 = offsetSecondsOfMinute;
  }
  j5e(_set____db54di) {
  ...
  v5e() {
    var sign = this.r5e_1 === true ? -1 : 1;
    var tmp0_safe_receiver = this.s5e_1;
    var tmp;
    if (tmp0_safe_receiver == null) {
      tmp = null;
    } else {
    ...
    var tmp_0 = tmp;
    var tmp1_safe_receiver = this.t5e_1;
    var tmp_1;
    if (tmp1_safe_receiver == null) {
      tmp_1 = null;
    } else {
    ...
    var tmp_2 = tmp_1;
    var tmp2_safe_receiver = this.u5e_1;
    var tmp_3;
    if (tmp2_safe_receiver == null) {
      tmp_3 = null;
    } else {
  ...
  w5e(offset) {
    this.r5e_1 = offset.x5e_1 < 0;
    // Inline function 'kotlin.math.absoluteValue' call
    var this_0 = offset.x5e_1;
    var totalSecondsAbs = abs(this_0);
    this.s5e_1 = totalSecondsAbs / 3600 | 0;
    this.t5e_1 = (totalSecondsAbs / 60 | 0) % 60 | 0;
    this.u5e_1 = totalSecondsAbs % 60 | 0;
  }
  equals(other) {
    var tmp;
    var tmp_0;
    ...
    if (other instanceof IncompleteUtcOffset) {
      tmp_2 = this.r5e_1 == other.r5e_1;
    } else {
      tmp_2 = false;
    }
    if (tmp_2) {
      tmp_1 = this.s5e_1 == other.s5e_1;
    } else {
      tmp_1 = false;
    }
    if (tmp_1) {
      tmp_0 = this.t5e_1 == other.t5e_1;
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
      tmp = this.u5e_1 == other.u5e_1;
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    // Inline function 'kotlin.hashCode' call
    var tmp0_safe_receiver = this.r5e_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : hashCode(tmp0_safe_receiver);
    var tmp = tmp1_elvis_lhs == null ? 0 : tmp1_elvis_lhs;
    // Inline function 'kotlin.hashCode' call
    var tmp0_safe_receiver_0 = this.s5e_1;
    var tmp1_elvis_lhs_0 = tmp0_safe_receiver_0 == null ? null : hashCode(tmp0_safe_receiver_0);
    var tmp_0 = tmp + (tmp1_elvis_lhs_0 == null ? 0 : tmp1_elvis_lhs_0) | 0;
    // Inline function 'kotlin.hashCode' call
    var tmp0_safe_receiver_1 = this.t5e_1;
    var tmp1_elvis_lhs_1 = tmp0_safe_receiver_1 == null ? null : hashCode(tmp0_safe_receiver_1);
    var tmp_1 = tmp_0 + (tmp1_elvis_lhs_1 == null ? 0 : tmp1_elvis_lhs_1) | 0;
    // Inline function 'kotlin.hashCode' call
    var tmp0_safe_receiver_2 = this.u5e_1;
    var tmp1_elvis_lhs_2 = tmp0_safe_receiver_2 == null ? null : hashCode(tmp0_safe_receiver_2);
    return tmp_1 + (tmp1_elvis_lhs_2 == null ? 0 : tmp1_elvis_lhs_2) | 0;
  }
  k5a() {
    return new IncompleteUtcOffset(this.r5e_1, this.s5e_1, this.t5e_1, this.u5e_1);
  }
  toString() {
    var tmp0_safe_receiver = this.r5e_1;
    var tmp;
    ...
    var tmp2_elvis_lhs = this.s5e_1;
    var tmp_1 = toString(tmp2_elvis_lhs == null ? '??' : tmp2_elvis_lhs);
    var tmp3_elvis_lhs = this.t5e_1;
    var tmp_2 = toString(tmp3_elvis_lhs == null ? '??' : tmp3_elvis_lhs);
    var tmp4_elvis_lhs = this.u5e_1;
...
class UtcOffsetWholeHoursDirective extends UnsignedIntFieldFormatDirective {
  constructor(padding) {
    var tmp = OffsetFields_getInstance().z5e_1;
    // Inline function 'kotlinx.datetime.format.minDigits' call
    var tmp_0 = padding.equals(Padding_ZERO_getInstance()) ? 2 : 1;
    // Inline function 'kotlinx.datetime.format.spaces' call
    super(tmp, tmp_0, padding.equals(Padding_SPACE_getInstance()) ? 2 : null);
  ...
  equals(other) {
    ...
    if (other instanceof UtcOffsetWholeHoursDirective) {
      tmp = this.g5f_1.equals(other.g5f_1);
    } else {
      tmp = false;
    }
    return tmp;
...
class Companion_11 {
  h5f(block) {
    ...
    block(builder);
    return new UtcOffsetFormat(builder.s40());
  }
}
class AbstractWithOffsetBuilder {}
function offsetHours(padding) {
  return this.j5f(new SignedFormatStructure(new BasicFormatStructure(new UtcOffsetWholeHoursDirective(padding)), true));
}
function offsetMinutesOfHour(padding) {
  return this.j5f(new BasicFormatStructure(new UtcOffsetMinuteOfHourDirective(padding)));
}
function offsetSecondsOfMinute(padding) {
  return this.j5f(new BasicFormatStructure(new UtcOffsetSecondOfMinuteDirective(padding)));
}
class Builder_2 {
  constructor(actualBuilder) {
    this.i5f_1 = actualBuilder;
  }
  j59() {
    return this.i5f_1;
  }
  j5f(structure) {
    this.i5f_1.m59(structure);
  }
  k59() {
...
class UtcOffsetFormat extends AbstractDateTimeFormat {
  ...
  c58(value) {
    return this.l5f(value instanceof UtcOffset ? value : THROW_CCE());
  }
  m5f(intermediate) {
    return intermediate.v5e();
  }
  d58(intermediate) {
    return this.m5f(intermediate instanceof IncompleteUtcOffset ? intermediate : THROW_CCE());
  }
  e58() {
...
class OffsetFields$sign$1 {
  constructor() {
    ...
    tmp.n5f_1 = new PropertyAccessor(getPropertyCallableRef('offsetIsNegative', 1, tmp_0, tmp_1, UtcOffsetFieldContainer$_set_offsetIsNegative_$ref_h7e0jq()));
  }
  o5f() {
    return this.n5f_1;
  }
  ...
  q5f(obj) {
    return this.p5f((!(obj == null) ? isInterface(obj, UtcOffsetFieldContainer) : false) ? obj : THROW_CCE());
  }
}
class OffsetFields {
  constructor() {
    ...
    var tmp = this;
    tmp.y5e_1 = new OffsetFields$sign$1();
    var tmp_0 = this;
    ...
    var tmp1_sign = this.y5e_1;
    tmp_0.z5e_1 = new UnsignedFieldSpec(tmp0_accessor, 0, 18, VOID, 0, tmp1_sign);
    var tmp_3 = this;
    ...
    var tmp1_sign_0 = this.y5e_1;
    tmp_3.a5f_1 = new UnsignedFieldSpec(tmp0_accessor_0, 0, 59, VOID, 0, tmp1_sign_0);
    var tmp_6 = this;
    ...
    var tmp1_sign_1 = this.y5e_1;
    tmp_6.b5f_1 = new UnsignedFieldSpec(tmp0_accessor_1, 0, 59, VOID, 0, tmp1_sign_1);
  }
}
class UtcOffsetMinuteOfHourDirective extends UnsignedIntFieldFormatDirective {
  constructor(padding) {
    var tmp = OffsetFields_getInstance().a5f_1;
    // Inline function 'kotlinx.datetime.format.minDigits' call
    var tmp_0 = padding.equals(Padding_ZERO_getInstance()) ? 2 : 1;
    // Inline function 'kotlinx.datetime.format.spaces' call
    super(tmp, tmp_0, padding.equals(Padding_SPACE_getInstance()) ? 2 : null);
  ...
  equals(other) {
    ...
    if (other instanceof UtcOffsetMinuteOfHourDirective) {
      tmp = this.v5f_1.equals(other.v5f_1);
    } else {
      tmp = false;
    }
    return tmp;
...
class UtcOffsetSecondOfMinuteDirective extends UnsignedIntFieldFormatDirective {
  ...
  equals(other) {
    ...
    if (other instanceof UtcOffsetSecondOfMinuteDirective) {
      tmp = this.a5g_1.equals(other.a5g_1);
    } else {
      tmp = false;
    }
    return tmp;
...
class IncompleteYearMonth {
  constructor(year, monthNumber) {
    ...
    this.l5a_1 = year;
    this.m5a_1 = monthNumber;
  }
  i5a(_set____db54di) {
    this.l5a_1 = _set____db54di;
  }
  a5a() {
    return this.l5a_1;
  }
  j5a(_set____db54di) {
    this.m5a_1 = _set____db54di;
  }
  g5a() {
    return this.m5a_1;
  }
  b5g() {
    var year = requireParsedField(this.l5a_1, 'year');
    var month = requireParsedField(this.m5a_1, 'monthNumber');
    return YearMonth.e5g(year, month);
  }
  f5g(yearMonth) {
    this.l5a_1 = yearMonth.c5g_1;
    this.m5a_1 = get_number(yearMonth.f5a());
  }
  k5a() {
    return new IncompleteYearMonth(this.l5a_1, this.m5a_1);
  }
  equals(other) {
    var tmp;
    var tmp_0;
    if (other instanceof IncompleteYearMonth) {
      tmp_0 = this.l5a_1 == other.l5a_1;
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
      tmp = this.m5a_1 == other.m5a_1;
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    // Inline function 'kotlin.hashCode' call
    var tmp0_safe_receiver = this.l5a_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : hashCode(tmp0_safe_receiver);
    var tmp$ret$0 = tmp1_elvis_lhs == null ? 0 : tmp1_elvis_lhs;
    var tmp = imul(tmp$ret$0, 31);
    // Inline function 'kotlin.hashCode' call
    var tmp0_safe_receiver_0 = this.m5a_1;
    var tmp1_elvis_lhs_0 = tmp0_safe_receiver_0 == null ? null : hashCode(tmp0_safe_receiver_0);
    return tmp + (tmp1_elvis_lhs_0 == null ? 0 : tmp1_elvis_lhs_0) | 0;
  }
  toString() {
    var tmp0_elvis_lhs = this.l5a_1;
    var tmp = toString(tmp0_elvis_lhs == null ? '??' : tmp0_elvis_lhs);
    var tmp1_elvis_lhs = this.m5a_1;
...
class Companion_12 {
  g5g(block) {
    ...
    block(builder);
    return new YearMonthFormat(builder.s40());
  }
}
class Builder_3 {
  constructor(actualBuilder) {
    this.h5g_1 = actualBuilder;
  }
  j59() {
    return this.h5g_1;
  }
  q5a(structure) {
    return this.h5g_1.m59(structure);
  }
  k59() {
...
class YearMonthFormat extends AbstractDateTimeFormat {
  ...
  c58(value) {
    return this.j5g(value instanceof YearMonth ? value : THROW_CCE());
  }
  k5g(intermediate) {
    return intermediate.b5g();
  }
  d58(intermediate) {
    return this.k5g(intermediate instanceof IncompleteYearMonth ? intermediate : THROW_CCE());
  }
  e58() {
...
class SignedIntFieldFormatDirective {
  constructor(field, minDigits, maxDigits, spacePadding, outputPlusOnExceededWidth) {
    this.u5g_1 = field;
    this.v5g_1 = minDigits;
    this.w5g_1 = maxDigits;
    this.x5g_1 = spacePadding;
    this.y5g_1 = outputPlusOnExceededWidth;
    // Inline function 'kotlin.require' call
    if (!(this.v5g_1 == null || this.v5g_1 >= 0)) {
      var message = 'The minimum number of digits (' + this.v5g_1 + ') is negative';
      throw IllegalArgumentException.a2(toString(message));
    }
    // Inline function 'kotlin.require' call
    if (!(this.w5g_1 == null || this.v5g_1 == null || this.w5g_1 >= this.v5g_1)) {
      var message_0 = 'The maximum number of digits (' + this.w5g_1 + ') is less than the minimum number of digits (' + this.v5g_1 + ')';
      throw IllegalArgumentException.a2(toString(message_0));
    }
  }
  g5b() {
  ...
  i58() {
    var tmp = Accessor$getterNotNull$ref_1(this.u5g_1.c2z());
    var tmp0_elvis_lhs = this.v5g_1;
    var formatter = new SignedIntFormatterStructure(tmp, tmp0_elvis_lhs == null ? 0 : tmp0_elvis_lhs, this.y5g_1);
    return !(this.x5g_1 == null) ? new SpacePaddedFormatter(formatter, this.x5g_1) : formatter;
  }
  k58() {
    return SignedIntParser(this.v5g_1, this.w5g_1, this.x5g_1, this.u5g_1.c2z(), this.u5g_1.d1(), this.y5g_1);
  }
}
class YearDirective extends SignedIntFieldFormatDirective {
  constructor(padding, isYearOfEra) {
    ...
    var tmp = YearMonthFields_getInstance().l5g_1;
    // Inline function 'kotlinx.datetime.format.minDigits' call
    ...
    this.s5g_1 = padding;
    this.t5g_1 = isYearOfEra;
  }
  equals(other) {
    var tmp;
    var tmp_0;
    if (other instanceof YearDirective) {
      tmp_0 = this.s5g_1.equals(other.s5g_1);
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
      tmp = this.t5g_1 === other.t5g_1;
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    return imul(this.s5g_1.hashCode(), 31) + getBooleanHashCode(this.t5g_1) | 0;
  }
}
class MonthDirective extends UnsignedIntFieldFormatDirective {
  constructor(padding) {
    var tmp = YearMonthFields_getInstance().m5g_1;
    // Inline function 'kotlinx.datetime.format.minDigits' call
    var tmp_0 = padding.equals(Padding_ZERO_getInstance()) ? 2 : 1;
    // Inline function 'kotlinx.datetime.format.spaces' call
    super(tmp, tmp_0, padding.equals(Padding_SPACE_getInstance()) ? 2 : null);
  ...
  equals(other) {
    ...
    if (other instanceof MonthDirective) {
      tmp = this.d5h_1.equals(other.d5h_1);
    } else {
      tmp = false;
    }
    return tmp;
...
class YearMonthFields {
  constructor() {
    ...
    tmp.l5g_1 = new GenericFieldSpec(new PropertyAccessor(getPropertyCallableRef('year', 1, tmp_0, tmp_1, YearMonthFieldContainer$_set_year_$ref_kc0aub())));
    var tmp_2 = this;
    var tmp_3 = KMutableProperty1;
    var tmp_4 = YearMonthFieldContainer$_get_monthNumber_$ref_pn0wu5();
    tmp_2.m5g_1 = new UnsignedFieldSpec(new PropertyAccessor(getPropertyCallableRef('monthNumber', 1, tmp_3, tmp_4, YearMonthFieldContainer$_set_monthNumber_$ref_fjapbl())), 1, 12);
  }
}
class AppendableFormatStructure {
  constructor() {
    ...
    tmp.l59_1 = ArrayList.j2();
  }
  s40() {
    return new ConcatenatedFormatStructure(this.l59_1);
  }
  m59(format) {
    if (isInterface(format, NonConcatenatedFormatStructure))
      this.l59_1.i2(format);
    else {
      if (format instanceof ConcatenatedFormatStructure) {
        // Inline function 'kotlin.collections.forEach' call
        var _iterator__ex2g4s = format.n59_1.l1();
        while (_iterator__ex2g4s.m1()) {
          var element = _iterator__ex2g4s.n1();
          this.l59_1.i2(element);
        }
      } else {
...
class AbstractFieldSpec {
  toString() {
    return 'The field ' + this.d1() + ' (default value is ' + toString_1(this.p5h()) + ')';
  }
}
...
function getterNotNull(container) {
  var tmp0_elvis_lhs = this.v5h(container);
  var tmp;
...
class PropertyAccessor {
  ...
  t5h(container, newValue) {
    var oldValue = this.r5h_1.get(container);
    var tmp;
    if (oldValue === null) {
      this.r5h_1.set(container, newValue);
      tmp = null;
  ...
  u5h(container, newValue) {
    return this.t5h(container, newValue);
  }
  v5h(container) {
    return this.r5h_1.get(container);
  }
}
class UnsignedFieldSpec extends AbstractFieldSpec {
  constructor(accessor, minValue, maxValue, name, defaultValue, sign) {
    ...
    this.g5h_1 = maxValue;
    this.h5h_1 = name;
    this.i5h_1 = defaultValue;
    this.j5h_1 = sign;
    var tmp = this;
    var tmp_0;
    if (this.g5h_1 < 10) {
      tmp_0 = 1;
    } else if (this.g5h_1 < 100) {
      tmp_0 = 2;
    } else if (this.g5h_1 < 1000) {
      tmp_0 = 3;
    } else {
      throw IllegalArgumentException.a2('Max value ' + this.g5h_1 + ' is too large');
    }
    tmp.k5h_1 = tmp_0;
  }
  c2z() {
...
class ConcatenatedFormatStructure {
  ...
  toString() {
    return 'ConcatenatedFormatStructure(' + joinToString(this.n59_1, ', ') + ')';
  }
  equals(other) {
    var tmp;
    if (other instanceof ConcatenatedFormatStructure) {
      tmp = equals(this.n59_1, other.n59_1);
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    return hashCode(this.n59_1);
  }
  k58() {
    // Inline function 'kotlin.collections.map' call
    var this_0 = this.n59_1;
    // Inline function 'kotlin.collections.mapTo' call
...
class CachedFormatStructure extends ConcatenatedFormatStructure {
  constructor(formats) {
    super(formats);
    this.g58_1 = super.i58();
    this.h58_1 = super.k58();
  }
  i58() {
    return this.g58_1;
  }
...
class BasicFormatStructure {
  constructor(directive) {
    this.x5h_1 = directive;
  }
  toString() {
    return 'BasicFormatStructure(' + toString(this.x5h_1) + ')';
  }
  equals(other) {
    var tmp;
    if (other instanceof BasicFormatStructure) {
      tmp = equals(this.x5h_1, other.x5h_1);
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    return hashCode(this.x5h_1);
  }
  k58() {
    return this.x5h_1.k58();
  }
  i58() {
    return this.x5h_1.i58();
  }
}
class ConstantFormatStructure {
  ...
  toString() {
    return 'ConstantFormatStructure(' + this.y5h_1 + ')';
  }
  equals(other) {
    var tmp;
    if (other instanceof ConstantFormatStructure) {
      tmp = this.y5h_1 === other.y5h_1;
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    return getStringHashCode(this.y5h_1);
  }
  k58() {
    var tmp;
    // Inline function 'kotlin.text.isEmpty' call
    var this_0 = this.y5h_1;
    if (charSequenceLength(this_0) === 0) {
      ...
      var tmp_0;
      if (isAsciiDigit(charCodeAt(this.y5h_1, 0))) {
        var tmp0 = this.y5h_1;
        var tmp$ret$5;
        $l$block: {
        ...
        this_1.i2(new NumberSpanParserOperation(listOf_0(new ConstantNumberConsumer(tmp$ret$5))));
        var tmp0_0 = this.y5h_1;
        var tmp$ret$7;
        $l$block_0: {
      ...
      if (charSequenceLength(suffix) > 0) {
        if (isAsciiDigit(charCodeAt(suffix, suffix.length - 1 | 0))) {
          ...
          this_1.i2(new PlainStringParserOperation(tmp$ret$10));
          var tmp$ret$12;
          $l$block_2: {
          ...
          this_1.i2(new NumberSpanParserOperation(listOf_0(new ConstantNumberConsumer(tmp$ret$12))));
        } else {
          this_1.i2(new PlainStringParserOperation(suffix));
        }
      }
      tmp = this_1.k5();
    }
  ...
  i58() {
    return new ConstantStringFormatterStructure(this.y5h_1);
  }
}
class SignedFormatStructure {
  constructor(format, withPlusSign) {
    this.z5h_1 = format;
    this.a5i_1 = withPlusSign;
    var tmp = this;
    // Inline function 'kotlin.collections.mapNotNull' call
    var tmp0 = basicFormats(this.z5h_1);
    ...
    while (_iterator__ex2g4s.m1()) {
      var element = _iterator__ex2g4s.n1();
      var tmp0_safe_receiver = element.g5b().q5h();
      if (tmp0_safe_receiver == null)
        null;
      else {
        // Inline function 'kotlin.let' call
  ...
  toString() {
    return 'SignedFormatStructure(' + toString(this.z5h_1) + ')';
  }
  equals(other) {
    var tmp;
    var tmp_0;
    if (other instanceof SignedFormatStructure) {
      tmp_0 = equals(this.z5h_1, other.z5h_1);
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
      tmp = this.a5i_1 === other.a5i_1;
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    return imul(31, hashCode(this.z5h_1)) + getBooleanHashCode(this.a5i_1) | 0;
  }
  k58() {
    return concat(listOf([new ParserStructure(listOf_0(new SignParser(SignedFormatStructure$parser$lambda(this), this.a5i_1, 'sign for ' + toString(this.b5i_1))), emptyList()), this.z5h_1.k58()]));
  }
  i58() {
    var innerFormat = this.z5h_1.i58();
    return new SignedFormatter(innerFormat, SignedFormatStructure$formatter$checkIfAllNegative$ref(this), this.a5i_1);
  }
}
class Companion_13 {
  c5i(field) {
    var default_0 = field.p5h();
    // Inline function 'kotlin.require' call
    if (!!(default_0 == null)) {
      var message = "The field '" + field.d1() + "' does not define a default value";
      throw IllegalArgumentException.a2(toString(message));
    }
    return new PropertyWithDefault(field.c2z(), default_0);
  }
}
class PropertyWithDefault {
  constructor(accessor, defaultValue) {
    this.d5i_1 = accessor;
    this.e5i_1 = defaultValue;
  }
}
class OptionalFormatStructure {
  constructor(onZero, format) {
    ...
    var tmp = this;
    // Inline function 'kotlin.collections.map' call
    var this_0 = basicFormats(this.g5i_1);
    // Inline function 'kotlin.collections.mapTo' call
    var destination = ArrayList.h2(collectionSizeOrDefault(this_0, 10));
    var _iterator__ex2g4s = this_0.l1();
    while (_iterator__ex2g4s.m1()) {
      var item = _iterator__ex2g4s.n1();
      var tmp$ret$2 = item.g5b();
      destination.i2(tmp$ret$2);
    }
    // Inline function 'kotlin.collections.map' call
    ...
    while (_iterator__ex2g4s_0.m1()) {
      ...
      var tmp$ret$5 = Companion_instance_13.c5i(item_0);
      destination_0.i2(tmp$ret$5);
    }
    tmp.h5i_1 = destination_0;
  }
  toString() {
    return 'Optional(' + this.f5i_1 + ', ' + toString(this.g5i_1) + ')';
  }
  equals(other) {
    var tmp;
    var tmp_0;
    if (other instanceof OptionalFormatStructure) {
      tmp_0 = this.f5i_1 === other.f5i_1;
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
      tmp = equals(this.g5i_1, other.g5i_1);
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    return imul(31, getStringHashCode(this.f5i_1)) + hashCode(this.g5i_1) | 0;
  }
  k58() {
    var tmp = emptyList();
    var tmp_0 = this.g5i_1.k58();
    var tmp_1 = (new ConstantFormatStructure(this.f5i_1)).k58();
    var tmp_2;
    if (this.h5i_1.j1()) {
      tmp_2 = emptyList();
    } else {
  ...
  i58() {
    ...
    while (_iterator__ex2g4s.m1()) {
      ...
      var tmp$ret$2 = new ComparisonPredicate(item.e5i_1, Accessor$getter$ref(item.d5i_1));
      destination.i2(tmp$ret$2);
    }
    var predicate = conjunctionPredicate(destination);
    var tmp;
    if (predicate instanceof Truth) {
      tmp = new ConstantStringFormatterStructure(this.f5i_1);
    } else {
      var tmp_0 = to(Predicate$test$ref(predicate), new ConstantStringFormatterStructure(this.f5i_1));
...
class AlternativesParsingFormatStructure {
  constructor(mainFormat, formats) {
    this.i5i_1 = mainFormat;
    this.j5i_1 = formats;
  }
  toString() {
    return 'AlternativesParsing(' + toString(this.j5i_1) + ')';
  }
  equals(other) {
    var tmp;
    var tmp_0;
    if (other instanceof AlternativesParsingFormatStructure) {
      tmp_0 = equals(this.i5i_1, other.i5i_1);
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
      tmp = equals(this.j5i_1, other.j5i_1);
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    return imul(31, hashCode(this.i5i_1)) + hashCode(this.j5i_1) | 0;
  }
  k58() {
    var tmp = emptyList();
    // Inline function 'kotlin.collections.buildList' call
    ...
    this_0.i2(this.i5i_1.k58());
    var _iterator__ex2g4s = this.j5i_1.l1();
    while (_iterator__ex2g4s.m1()) {
      var format = _iterator__ex2g4s.n1();
      this_0.i2(format.k58());
    }
    var tmp$ret$0 = this_0.k5();
    return new ParserStructure(tmp, tmp$ret$0);
  }
  i58() {
    return this.i5i_1.i58();
  }
}
class ComparisonPredicate {
  constructor(expectedValue, getter) {
    this.k5i_1 = expectedValue;
    this.l5i_1 = getter;
  }
  m5i(value) {
    return equals(this.l5i_1(value), this.k5i_1);
  }
}
class Truth {
  n5i(value) {
  ...
  m5i(value) {
    return this.n5i(value);
  }
}
class ConjunctionPredicate {
  constructor(predicates) {
    this.o5i_1 = predicates;
  }
  m5i(value) {
    var tmp0 = this.o5i_1;
    var tmp$ret$0;
...
function format$default(obj, builder, minusNotRequired, $super) {
  ...
  var tmp;
  if ($super === VOID) {
    this.p5i(obj, builder, minusNotRequired);
    tmp = Unit_instance;
  } else {
    tmp = $super.p5i.call(this, obj, builder, minusNotRequired);
  }
  return tmp;
}
class SpacePaddedFormatter {
  constructor(formatter, padding) {
    this.q5i_1 = formatter;
    this.r5i_1 = padding;
  }
  p5i(obj, builder, minusNotRequired) {
    // Inline function 'kotlin.let' call
    var it = StringBuilder.h1();
    this.q5i_1.p5i(obj, it, minusNotRequired);
    var string = it.toString();
    // Inline function 'kotlin.repeat' call
    var times = this.r5i_1 - string.length | 0;
    var inductionVariable = 0;
...
class SignedFormatter {
  constructor(formatter, allSubFormatsNegative, alwaysOutputSign) {
    this.s5i_1 = formatter;
    this.t5i_1 = allSubFormatsNegative;
    this.u5i_1 = alwaysOutputSign;
  }
  p5i(obj, builder, minusNotRequired) {
    var tmp;
    if (!minusNotRequired && this.t5i_1(obj)) {
    ...
    if ((tmp_0 == null ? null : new Char(tmp_0)) == null)
      ...
      var tmp_1 = sign;
      // Inline function 'kotlin.let' call
      var it = (tmp_1 == null ? null : new Char(tmp_1)).n3_1;
      builder.k1(it);
    }
    var tmp_2;
    if (minusNotRequired) {
    ...
    this.s5i_1.p5i(obj, builder, tmp_2);
  }
}
class ConditionalFormatter {
  constructor(formatters) {
    this.v5i_1 = formatters;
  }
  p5i(obj, builder, minusNotRequired) {
    var _iterator__ex2g4s = this.v5i_1.l1();
    while (_iterator__ex2g4s.m1()) {
      var _destruct__k2r9zo = _iterator__ex2g4s.n1();
      var condition = _destruct__k2r9zo.pm();
      var formatter = _destruct__k2r9zo.qm();
      if (condition(obj)) {
        formatter.p5i(obj, builder, minusNotRequired);
...
class ConcatenatedFormatter {
  constructor(formatters) {
    this.w5i_1 = formatters;
  }
  p5i(obj, builder, minusNotRequired) {
    var _iterator__ex2g4s = this.w5i_1.l1();
    while (_iterator__ex2g4s.m1()) {
...
class UnsignedIntFormatterStructure {
  constructor(number, zeroPadding) {
    this.x5i_1 = number;
    this.y5i_1 = zeroPadding;
    // Inline function 'kotlin.require' call
    if (!(this.y5i_1 >= 0)) {
      var message = 'The minimum number of digits (' + this.y5i_1 + ') is negative';
      throw IllegalArgumentException.a2(toString(message));
    }
    // Inline function 'kotlin.require' call
    if (!(this.y5i_1 <= 9)) {
      var message_0 = 'The minimum number of digits (' + this.y5i_1 + ') exceeds the length of an Int';
      throw IllegalArgumentException.a2(toString(message_0));
    }
  }
  p5i(obj, builder, minusNotRequired) {
    var num = this.x5i_1(obj);
    var numberStr = num.toString();
    // Inline function 'kotlin.repeat' call
    var times = this.y5i_1 - numberStr.length | 0;
    var inductionVariable = 0;
    if (inductionVariable < times)
      do {
        var index = inductionVariable;
       ...
       while (inductionVariable < times);
    builder.k2(numberStr);
  }
}
class DecimalFractionFormatterStructure {
  constructor(number, minDigits, maxDigits, zerosToAdd) {
    this.z5i_1 = number;
    this.a5j_1 = minDigits;
    this.b5j_1 = maxDigits;
    this.c5j_1 = zerosToAdd;
    var containsArg = this.a5j_1;
    // Inline function 'kotlin.require' call
    if (!(1 <= containsArg ? containsArg <= 9 : false)) {
      var message = 'The minimum number of digits (' + this.a5j_1 + ') is not in range 1..9';
      throw IllegalArgumentException.a2(toString(message));
    }
    var containsLower = this.a5j_1;
    var containsArg_0 = this.b5j_1;
    // Inline function 'kotlin.require' call
    if (!(containsLower <= containsArg_0 ? containsArg_0 <= 9 : false)) {
      var message_0 = 'The maximum number of digits (' + this.b5j_1 + ') is not in range ' + this.a5j_1 + '..9';
      throw IllegalArgumentException.a2(toString(message_0));
    }
  }
  p5i(obj, builder, minusNotRequired) {
    var number = this.z5i_1(obj);
    var numberWithRequiredPrecision = number.r5c(this.b5j_1);
    var zerosToStrip = 0;
    while (this.b5j_1 > (this.a5j_1 + zerosToStrip | 0) && (numberWithRequiredPrecision % get_POWERS_OF_TEN()[zerosToStrip + 1 | 0] | 0) === 0) {
      zerosToStrip = zerosToStrip + 1 | 0;
    }
    var zerosToAddBack = this.c5j_1.n2((this.b5j_1 - zerosToStrip | 0) - 1 | 0);
    if (zerosToStrip >= zerosToAddBack)
      zerosToStrip = zerosToStrip - zerosToAddBack | 0;
    var digitsToOutput = this.b5j_1 - zerosToStrip | 0;
    var numberToOutput = numberWithRequiredPrecision / get_POWERS_OF_TEN()[zerosToStrip] | 0;
    builder.k2(substring_0((numberToOutput + get_POWERS_OF_TEN()[digitsToOutput] | 0).toString(), 1));
  }
}
class SignedIntFormatterStructure {
  constructor(number, zeroPadding, outputPlusOnExceededWidth) {
    this.d5j_1 = number;
    this.e5j_1 = zeroPadding;
    this.f5j_1 = outputPlusOnExceededWidth;
    // Inline function 'kotlin.require' call
    if (!(this.e5j_1 >= 0)) {
      var message = 'The minimum number of digits (' + this.e5j_1 + ') is negative';
      throw IllegalArgumentException.a2(toString(message));
    }
    // Inline function 'kotlin.require' call
    if (!(this.e5j_1 <= 9)) {
      var message_0 = 'The minimum number of digits (' + this.e5j_1 + ') exceeds the length of an Int';
      throw IllegalArgumentException.a2(toString(message_0));
    }
  }
  p5i(obj, builder, minusNotRequired) {
    ...
    // Inline function 'kotlin.let' call
    var it = this.d5j_1(obj);
    var number = minusNotRequired && it < 0 ? -it | 0 : it;
    if (!(this.f5j_1 == null) && number >= get_POWERS_OF_TEN()[this.f5j_1]) {
      innerBuilder.k1(_Char___init__impl__6a9atx(43));
    }
    // Inline function 'kotlin.math.absoluteValue' call
    if (abs(number) < get_POWERS_OF_TEN()[this.e5j_1 - 1 | 0]) {
      if (number >= 0) {
        innerBuilder.ph(number + get_POWERS_OF_TEN()[this.e5j_1] | 0).uh(0);
      } else {
        innerBuilder.ph(number - get_POWERS_OF_TEN()[this.e5j_1] | 0).uh(1);
      }
    } else {
      innerBuilder.ph(number);
    }
    builder.k2(innerBuilder);
  }
}
...
class FractionPartConsumer extends NumberConsumer {
  constructor(minLength, maxLength, setter, name) {
    ...
    this.j5j_1 = minLength;
    this.k5j_1 = maxLength;
    this.l5j_1 = setter;
    var containsArg = this.j5j_1;
    // Inline function 'kotlin.require' call
    if (!(1 <= containsArg ? containsArg <= 9 : false)) {
      var message = 'Invalid minimum length ' + this.j5j_1 + ' for field ' + this.n5j_1 + ': expected 1..9';
      throw IllegalArgumentException.a2(toString(message));
    }
    var containsLower = this.j5j_1;
    var containsArg_0 = this.k5j_1;
    // Inline function 'kotlin.require' call
    if (!(containsLower <= containsArg_0 ? containsArg_0 <= 9 : false)) {
      var message_0 = 'Invalid maximum length ' + this.k5j_1 + ' for field ' + this.n5j_1 + ': expected ' + this.j5j_1 + '..9';
      throw IllegalArgumentException.a2(toString(message_0));
    }
  }
  o5j(storage, input, start, end) {
    return (end - start | 0) < this.j5j_1 ? new TooFewDigits(this.j5j_1) : (end - start | 0) > this.k5j_1 ? new TooManyDigits(this.k5j_1) : setWithoutReassigning(this.l5j_1, storage, new DecimalFraction(parseAsciiInt(input, start, end), end - start | 0));
  }
}
class ConstantNumberConsumer extends NumberConsumer {
  ...
  o5j(storage, input, start, end) {
    ...
    if (toString(charSequenceSubSequence(input, start, end)) === this.r5j_1) {
      tmp = null;
    } else {
      tmp = new WrongConstant(this.r5j_1);
    }
    return tmp;
  }
}
...
class TooManyDigits {
  constructor(maxDigits) {
    this.t5j_1 = maxDigits;
  }
  s5j() {
    return 'expected at most ' + this.t5j_1 + ' digits';
  }
}
class TooFewDigits {
  constructor(minDigits) {
    this.u5j_1 = minDigits;
  }
  s5j() {
    return 'expected at least ' + this.u5j_1 + ' digits';
  }
}
class WrongConstant {
  constructor(expected) {
  ...
  s5j() {
    return "expected '" + this.v5j_1 + "'";
  }
}
class Conflicting {
  constructor(conflicting) {
    this.w5j_1 = conflicting;
  }
  s5j() {
    return "attempted to overwrite the existing value '" + toString(this.w5j_1) + "'";
  }
}
class UnsignedIntConsumer extends NumberConsumer {
  constructor(minLength, maxLength, setter, name, multiplyByMinus1) {
    ...
    super(minLength == maxLength ? minLength : null, name);
    this.z5j_1 = minLength;
    this.a5k_1 = maxLength;
    this.b5k_1 = setter;
    this.c5k_1 = multiplyByMinus1;
    // Inline function 'kotlin.require' call
    if (!(this.a() == null || numberRangeToNumber(1, 9).as(this.a()))) {
      var message = 'Invalid length for field ' + this.n5j_1 + ': ' + this.a();
      throw IllegalArgumentException.a2(toString(message));
    }
  }
  o5j(storage, input, start, end) {
    var tmp;
    if (!(this.a5k_1 == null) && (end - start | 0) > this.a5k_1) {
      tmp = new TooManyDigits(this.a5k_1);
    } else if (!(this.z5j_1 == null) && (end - start | 0) < this.z5j_1) {
      tmp = new TooFewDigits(this.z5j_1);
    } else {
      var result = parseAsciiIntOrNull(input, start, end);
      tmp = result == null ? ExpectedInt_instance : setWithoutReassigning(this.b5k_1, storage, this.c5k_1 ? -result | 0 : result);
    }
    return tmp;
  }
}
...
class ParserState {
  constructor(output, parserStructure, inputPosition) {
    this.h5k_1 = output;
    this.i5k_1 = parserStructure;
    this.j5k_1 = inputPosition;
  }
}
class sam$kotlin_Comparator$0 {
  constructor(function_0) {
    this.s5k_1 = function_0;
  }
  sj(a, b) {
    return this.s5k_1(a, b);
  }
  compare(a, b) {
    return this.sj(a, b);
  }
...
class Parser {
  ...
  toString() {
    return Parser__toString_impl_x33iea(this.k5k_1);
  }
  hashCode() {
    return Parser__hashCode_impl_bbxllf(this.k5k_1);
  }
  equals(other) {
    return Parser__equals_impl_djxokv(this.k5k_1, other);
  }
}
class ParserStructure {
  constructor(operations, followedBy) {
    this.l5k_1 = operations;
    this.m5k_1 = followedBy;
  }
  toString() {
    return joinToString(this.l5k_1, ', ') + '(' + joinToString(this.m5k_1, ';') + ')';
  }
}
class Companion_15 {
  constructor() {
    this.t5k_1 = 5691186997393344103n;
  }
}
class ParseException extends Exception {
  constructor(errors) {
    return new.target.q5k(errors);
  }
  static q5k(errors) {
    var $this = this.xe(formatError(errors));
    captureStack($this, $this.p5k_1);
    return $this;
  }
}
class NumberSpanParserOperation {
  constructor(consumers) {
    this.u5k_1 = consumers;
    var tmp = this;
    // Inline function 'kotlin.collections.sumOf' call
    var sum = 0;
    var _iterator__ex2g4s = this.u5k_1.l1();
    while (_iterator__ex2g4s.m1()) {
      var element = _iterator__ex2g4s.n1();
      var tmp_0 = sum;
    ...
    tmp_1.w5k_1 = tmp$ret$2;
    var tmp0_0 = this.u5k_1;
    var tmp$ret$4;
    $l$block_2: {
      // Inline function 'kotlin.collections.all' call
      var tmp_3;
  ...
  n5k(storage, input, startIndex) {
    if ((startIndex + this.v5k_1 | 0) > charSequenceLength(input)) {
      var tmp = Companion_instance_14;
      return tmp.g5k(startIndex, NumberSpanParserOperation$consume$lambda(this));
    }
    ...
    if (digitsInRow._v < this.v5k_1) {
      var tmp_0 = Companion_instance_14;
      return tmp_0.g5k(startIndex, NumberSpanParserOperation$consume$lambda_0(digitsInRow, this));
    }
    var index = startIndex;
    var inductionVariable = 0;
    var last = this.u5k_1.l2() - 1 | 0;
    if (inductionVariable <= last)
      do {
        var i = inductionVariable;
        inductionVariable = inductionVariable + 1 | 0;
        var tmp0_elvis_lhs = this.u5k_1.n2(i).a();
        var length = tmp0_elvis_lhs == null ? (digitsInRow._v - this.v5k_1 | 0) + 1 | 0 : tmp0_elvis_lhs;
        var error = this.u5k_1.n2(i).o5j(storage, input, index, index + length | 0);
        if (!(error == null)) {
          var tmp2 = index;
          // Inline function 'kotlin.text.substring' call
          var endIndex = index + length | 0;
          var numberString = toString(charSequenceSubSequence(input, tmp2, endIndex));
          var tmp_1 = Companion_instance_14;
          var tmp_2 = index;
          return tmp_1.g5k(tmp_2, NumberSpanParserOperation$consume$lambda_1(numberString, this, i, error));
        }
        index = index + length | 0;
      }
       while (inductionVariable <= last);
    return Companion_instance_14.f5k(index);
  }
  toString() {
...
class PlainStringParserOperation {
  constructor(string) {
    ...
    // Inline function 'kotlin.require' call
    if (!!isAsciiDigit(charCodeAt(this.x5k_1, 0))) {
      var message_0 = "String '" + this.x5k_1 + "' starts with a digit";
      throw IllegalArgumentException.a2(toString(message_0));
    }
    // Inline function 'kotlin.require' call
    if (!!isAsciiDigit(charCodeAt(this.x5k_1, this.x5k_1.length - 1 | 0))) {
      var message_1 = "String '" + this.x5k_1 + "' ends with a digit";
      throw IllegalArgumentException.a2(toString(message_1));
    }
  }
  n5k(storage, input, startIndex) {
    if ((startIndex + this.x5k_1.length | 0) > charSequenceLength(input)) {
      var tmp = Companion_instance_14;
      return tmp.g5k(startIndex, PlainStringParserOperation$consume$lambda(this));
    }
    var inductionVariable = 0;
    var last = charSequenceLength(this.x5k_1) - 1 | 0;
    if (inductionVariable <= last)
      do {
        var i = inductionVariable;
        inductionVariable = inductionVariable + 1 | 0;
        if (!(charSequenceGet(input, startIndex + i | 0) === charCodeAt(this.x5k_1, i))) {
          var tmp_0 = Companion_instance_14;
          return tmp_0.g5k(startIndex, PlainStringParserOperation$consume$lambda_0(this, input, startIndex, i));
        }
      }
       while (inductionVariable <= last);
    return Companion_instance_14.f5k(startIndex + this.x5k_1.length | 0);
  }
  toString() {
    return "'" + this.x5k_1 + "'";
  }
...
class SignParser {
  constructor(isNegativeSetter, withPlusSign, whatThisExpects) {
    this.y5k_1 = isNegativeSetter;
    this.z5k_1 = withPlusSign;
    this.a5l_1 = whatThisExpects;
  }
  n5k(storage, input, startIndex) {
    if (startIndex >= charSequenceLength(input))
      return Companion_instance_14.f5k(startIndex);
    var char = charSequenceGet(input, startIndex);
    if (char === _Char___init__impl__6a9atx(45)) {
      this.y5k_1(storage, true);
      return Companion_instance_14.f5k(startIndex + 1 | 0);
    }
    if (char === _Char___init__impl__6a9atx(43) && this.z5k_1) {
      this.y5k_1(storage, false);
      return Companion_instance_14.f5k(startIndex + 1 | 0);
    }
    var tmp = Companion_instance_14;
    return tmp.g5k(startIndex, SignParser$consume$lambda(this, char));
  }
  toString() {
    return this.a5l_1;
  }
...
class DecimalFraction {
  constructor(fractionalPart, digits) {
    this.p5c_1 = fractionalPart;
    this.q5c_1 = digits;
    // Inline function 'kotlin.require' call
    if (!(this.q5c_1 >= 0)) {
      var message = 'Digits must be non-negative, but was ' + this.q5c_1;
      throw IllegalArgumentException.a2(toString(message));
    }
  }
  r5c(newDigits) {
    return newDigits === this.q5c_1 ? this.p5c_1 : newDigits > this.q5c_1 ? imul(this.p5c_1, get_POWERS_OF_TEN()[newDigits - this.q5c_1 | 0]) : this.p5c_1 / get_POWERS_OF_TEN()[this.q5c_1 - newDigits | 0] | 0;
  }
  c5l(other) {
    var tmp0 = this.q5c_1;
    ...
    return compareTo(this.r5c(maxPrecision), other.r5c(maxPrecision));
  }
  d(other) {
    return this.c5l(other instanceof DecimalFraction ? other : THROW_CCE());
  }
  equals(other) {
    var tmp;
    if (other instanceof DecimalFraction) {
      tmp = this.c5l(other) === 0;
    } else {
      tmp = false;
    }
    return tmp;
  ...
  toString() {
    ...
    // Inline function 'kotlin.apply' call
    var this_0 = StringBuilder.h1();
    var denominator = get_POWERS_OF_TEN()[this.q5c_1];
    this_0.ph(this.p5c_1 / denominator | 0);
    this_0.k1(_Char___init__impl__6a9atx(46));
    this_0.i1(removePrefix((denominator + (this.p5c_1 % denominator | 0) | 0).toString(), '1'));
    return this_0.toString();
  }
  hashCode() {
    throw UnsupportedOperationException.ua('DecimalFraction is not supposed to be used as a hash key');
  }
}
class TimeBasedDateTimeUnitSerializer {
  constructor() {
    ...
    tmp.d5l_1 = lazy_0(tmp_0, TimeBasedDateTimeUnitSerializer$descriptor$delegate$lambda);
  }
  gz() {
    var tmp0 = this.d5l_1;
    var tmp = KProperty1;
  ...
  e5l(encoder, value) {
    ...
    var descriptor = this.gz();
    var composite = encoder.y13(descriptor);
    composite.j15(TimeBasedDateTimeUnitSerializer_getInstance().gz(), 0, value.o56_1);
    composite.z13(descriptor);
  }
  tz(encoder, value) {
    return this.e5l(encoder, value instanceof TimeBased ? value : THROW_CCE());
  }
  uz(decoder) {
    var seen = {_v: false};
    ...
    var descriptor = this.gz();
    var composite = decoder.y13(descriptor);
    if (composite.n14()) {
      nanoseconds._v = composite.e14(TimeBasedDateTimeUnitSerializer_getInstance().gz(), 0);
      seen._v = true;
    } else {
      loop: while (true) {
        var elementIndex = composite.o14(TimeBasedDateTimeUnitSerializer_getInstance().gz());
        switch (elementIndex) {
          case 0:
            nanoseconds._v = composite.e14(TimeBasedDateTimeUnitSerializer_getInstance().gz(), 0);
            seen._v = true;
...
class DateBasedDateTimeUnitSerializer extends AbstractPolymorphicSerializer {
  ...
  static g5l() {
    ...
    var tmp = $this;
    var tmp_0 = LazyThreadSafetyMode_PUBLICATION_getInstance();
    tmp.f5l_1 = lazy_0(tmp_0, DateBasedDateTimeUnitSerializer$impl$delegate$lambda);
    return $this;
  }
  e10(decoder, klassName) {
    return _get_impl__d88w17(this).e10(decoder, klassName);
  }
  h5l(encoder, value) {
    return _get_impl__d88w17(this).f10(encoder, value);
  }
  f10(encoder, value) {
    return this.h5l(encoder, value instanceof DateBased ? value : THROW_CCE());
  }
  c10() {
    return getKClass(DateBased);
  }
  gz() {
    return _get_impl__d88w17(this).gz();
  }
}
class DayBasedDateTimeUnitSerializer {
  constructor() {
    ...
    var tmp = this;
    var tmp_0 = LazyThreadSafetyMode_PUBLICATION_getInstance();
    tmp.i5l_1 = lazy_0(tmp_0, DayBasedDateTimeUnitSerializer$descriptor$delegate$lambda);
  }
  gz() {
    var tmp0 = this.i5l_1;
    var tmp = KProperty1;
  ...
  j5l(encoder, value) {
    ...
    var descriptor = this.gz();
    var composite = encoder.y13(descriptor);
    composite.i15(DayBasedDateTimeUnitSerializer_getInstance().gz(), 0, value.u56_1);
    composite.z13(descriptor);
  }
  tz(encoder, value) {
    return this.j5l(encoder, value instanceof DayBased ? value : THROW_CCE());
  }
  uz(decoder) {
    var seen = {_v: false};
    var days = {_v: 0};
    ...
    var composite = decoder.y13(descriptor);
    if (composite.n14()) {
      days._v = composite.d14(DayBasedDateTimeUnitSerializer_getInstance().gz(), 0);
      seen._v = true;
    } else {
      loop: while (true) {
        var elementIndex = composite.o14(DayBasedDateTimeUnitSerializer_getInstance().gz());
        switch (elementIndex) {
          case 0:
            days._v = composite.d14(DayBasedDateTimeUnitSerializer_getInstance().gz(), 0);
            seen._v = true;
    ...
    composite.z13(descriptor);
    if (!seen._v)
      throw MissingFieldException.u11('days', this.gz().o10());
...
class MonthBasedDateTimeUnitSerializer {
  constructor() {
    ...
    var tmp = this;
    var tmp_0 = LazyThreadSafetyMode_PUBLICATION_getInstance();
    tmp.k5l_1 = lazy_0(tmp_0, MonthBasedDateTimeUnitSerializer$descriptor$delegate$lambda);
  }
  gz() {
    var tmp0 = this.k5l_1;
    var tmp = KProperty1;
  ...
  l5l(encoder, value) {
    ...
    var descriptor = this.gz();
    var composite = encoder.y13(descriptor);
    composite.i15(MonthBasedDateTimeUnitSerializer_getInstance().gz(), 0, value.v56_1);
    composite.z13(descriptor);
  }
  tz(encoder, value) {
    return this.l5l(encoder, value instanceof MonthBased ? value : THROW_CCE());
  }
  uz(decoder) {
    var seen = {_v: false};
    var months = {_v: 0};
    ...
    var composite = decoder.y13(descriptor);
    if (composite.n14()) {
      months._v = composite.d14(MonthBasedDateTimeUnitSerializer_getInstance().gz(), 0);
      seen._v = true;
    } else {
      loop: while (true) {
        var elementIndex = composite.o14(MonthBasedDateTimeUnitSerializer_getInstance().gz());
        switch (elementIndex) {
          case 0:
            months._v = composite.d14(MonthBasedDateTimeUnitSerializer_getInstance().gz(), 0);
            seen._v = true;
...
class DateTimeUnitSerializer extends AbstractPolymorphicSerializer {
  ...
  static n5l() {
    ...
    var tmp = $this;
    var tmp_0 = LazyThreadSafetyMode_PUBLICATION_getInstance();
    tmp.m5l_1 = lazy_0(tmp_0, DateTimeUnitSerializer$impl$delegate$lambda);
    return $this;
  }
  e10(decoder, klassName) {
    return _get_impl__d88w17_0(this).e10(decoder, klassName);
  }
  o5l(encoder, value) {
    return _get_impl__d88w17_0(this).f10(encoder, value);
  }
  f10(encoder, value) {
    return this.o5l(encoder, value instanceof DateTimeUnit ? value : THROW_CCE());
  }
  c10() {
    return getKClass(DateTimeUnit);
  }
  gz() {
    return _get_impl__d88w17_0(this).gz();
  }
}
class LocalDateSerializer {
  constructor() {
    LocalDateSerializer_instance = this;
    this.p5l_1 = PrimitiveSerialDescriptor('kotlinx.datetime.LocalDate', STRING_getInstance());
  }
  gz() {
    return this.p5l_1;
  }
  uz(decoder) {
    return Companion_getInstance_17().u5l(decoder.u13());
  }
  v5l(encoder, value) {
    encoder.c15(value.toString());
  }
  tz(encoder, value) {
    return this.v5l(encoder, value instanceof LocalDate ? value : THROW_CCE());
  }
}
class LocalDateTimeSerializer {
  constructor() {
    LocalDateTimeSerializer_instance = this;
    this.w5l_1 = PrimitiveSerialDescriptor('kotlinx.datetime.LocalDateTime', STRING_getInstance());
  }
  gz() {
    return this.w5l_1;
  }
  uz(decoder) {
    return Companion_getInstance_18().z5l(decoder.u13());
  }
  a5m(encoder, value) {
    encoder.c15(value.toString());
  }
  tz(encoder, value) {
    return this.a5m(encoder, value instanceof LocalDateTime ? value : THROW_CCE());
  }
}
class LocalTimeSerializer {
  constructor() {
    LocalTimeSerializer_instance = this;
    this.b5m_1 = PrimitiveSerialDescriptor('kotlinx.datetime.LocalTime', STRING_getInstance());
  }
  gz() {
    return this.b5m_1;
  }
  uz(decoder) {
    return Companion_getInstance_19().e5m(decoder.u13());
  }
  f5m(encoder, value) {
    encoder.c15(value.toString());
  }
  tz(encoder, value) {
    return this.f5m(encoder, value instanceof LocalTime ? value : THROW_CCE());
  }
}
class UtcOffsetSerializer {
  constructor() {
    UtcOffsetSerializer_instance = this;
    this.g5m_1 = PrimitiveSerialDescriptor('kotlinx.datetime.UtcOffset', STRING_getInstance());
  }
  gz() {
    return this.g5m_1;
  }
  uz(decoder) {
    return Companion_getInstance_22().i5m(decoder.u13());
  }
  j5m(encoder, value) {
    encoder.c15(value.toString());
  }
  tz(encoder, value) {
    return this.j5m(encoder, value instanceof UtcOffset ? value : THROW_CCE());
  }
}
class YearMonthSerializer {
  constructor() {
    YearMonthSerializer_instance = this;
    this.k5m_1 = PrimitiveSerialDescriptor('kotlinx.datetime.YearMonth', STRING_getInstance());
  }
  gz() {
    return this.k5m_1;
  }
  uz(decoder) {
    return Companion_instance_22.l5m(decoder.u13());
  }
  m5m(encoder, value) {
    encoder.c15(value.toString());
  }
  tz(encoder, value) {
    return this.m5m(encoder, value instanceof YearMonth ? value : THROW_CCE());
  }
}
class Companion_16 {
  constructor() {
    Companion_instance_16 = this;
    this.q5l_1 = LocalDate.e5a(-999999999, 1, 1);
    this.r5l_1 = LocalDate.e5a(999999999, 12, 31);
    this.s5l_1 = -365243219162n;
    this.t5l_1 = 365241780471n;
  }
  n5m(input, format) {
    return format.zu(input);
  }
  u5l(input, format, $super) {
    format = format === VOID ? getIsoDateFormat() : format;
    return $super === VOID ? this.n5m(input, format) : $super.n5m.call(this, input, format);
  }
  o5m(epochDays) {
    // Inline function 'kotlin.require' call
    ...
    return LocalDate.p5m(convertToInt(yearEst), month, dom, Unit_instance);
  }
}
class Formats {
  constructor() {
    Formats_instance = this;
    this.w57_1 = get_ISO_DATE_BASIC();
  }
  x57() {
    return get_ISO_DATE();
  }
...
class LocalDate {
  constructor(year, month, day, unit) {
    return new.target.p5m(year, month, day, unit);
  }
  static p5m(year, month, day, unit) {
  ...
  static e5a(year, month, day) {
    Companion_getInstance_17();
    var $this = this.p5m(year, month, day, Unit_instance);
    var containsArg = $this.d5a_1;
    // Inline function 'kotlin.require' call
    if (!(1 <= containsArg ? containsArg <= 12 : false)) {
      var message = 'Invalid date: month must be a number between 1 and 12, got ' + $this.d5a_1;
      throw IllegalArgumentException.a2(toString(message));
    }
  ...
  q5m() {
    var y = fromInt(this.b5a_1);
    var m = fromInt(this.d5a_1);
    var total = 0n;
  ...
  y59() {
    return (firstDayOfYear(this.f5a(), isLeapYear(this.b5a_1)) + this.c5a_1 | 0) - 1 | 0;
  }
  r5m(other) {
    var y = compareTo(this.b5a_1, other.b5a_1);
    if (!(y === 0)) {
      return y;
    }
    var m = compareTo(this.d5a_1, other.d5a_1);
    if (!(m === 0)) {
      return m;
    }
    return compareTo(this.c5a_1, other.c5a_1);
  }
  d(other) {
    return this.r5m(other instanceof LocalDate ? other : THROW_CCE());
  }
  s5m(monthsToAdd) {
    if (monthsToAdd === 0n) {
      return this;
    }
    var tmp0 = multiply(numberToLong(this.b5a_1), 12n);
    // Inline function 'kotlin.Long.plus' call
    var other = this.d5a_1 - 1 | 0;
    ...
    if (!contains(isInterface(this_0, ClosedRange) ? this_0 : THROW_CCE(), newYear)) {
      throw IllegalArgumentException.a2('The result of adding ' + monthsToAdd.toString() + ' months to ' + this.toString() + ' is out of LocalDate range.');
    }
    // Inline function 'kotlin.mod' call
    // Inline function 'kotlin.mod' call
    ...
    return resolvePreviousValid(this, convertToInt(newYear), newMonth, this.c5a_1);
  }
  t5m(daysToAdd) {
    return daysToAdd === 0n ? this : Companion_getInstance_17().o5m(safeAdd(this.q5m(), daysToAdd));
  }
  equals(other) {
    var tmp;
    if (this === other) {
  ...
  hashCode() {
    var yearValue = this.b5a_1;
    var monthValue = this.d5a_1;
    var dayValue = this.c5a_1;
    return yearValue & -2048 ^ (((yearValue << 11) + (monthValue << 6) | 0) + dayValue | 0);
  }
  toString() {
    return format(this, Formats_getInstance().x57());
  }
}
class Companion_17 {
  constructor() {
    Companion_instance_17 = this;
    this.x5l_1 = LocalDateTime.a5c(Companion_getInstance_17().q5l_1, Companion_getInstance_19().c5m_1);
    this.y5l_1 = LocalDateTime.a5c(Companion_getInstance_17().r5l_1, Companion_getInstance_19().d5m_1);
  }
  u5m(input, format) {
    return format.zu(input);
  }
  z5l(input, format, $super) {
    format = format === VOID ? getIsoDateTimeFormat() : format;
    return $super === VOID ? this.u5m(input, format) : $super.u5m.call(this, input, format);
  }
}
class Formats_0 {
  constructor() {
    Formats_instance_0 = this;
    this.z57_1 = get_ISO_DATETIME();
  }
}
class LocalDateTime {
  constructor(date, time) {
    return new.target.a5c(date, time);
  }
  static a5c(date, time) {
  ...
  static v5m(year, month, day, hour, minute, second, nanosecond) {
    Companion_getInstance_18();
    second = second === VOID ? 0 : second;
    nanosecond = nanosecond === VOID ? 0 : nanosecond;
    return this.a5c(LocalDate.e5a(year, month, day), LocalTime.w5c(hour, minute, second, nanosecond));
  }
  i5c() {
    return this.z5b_1.s5c_1;
  }
  d5c() {
    return this.z5b_1.t5c_1;
  }
  nw() {
    return this.z5b_1.u5c_1;
  }
  g5c() {
    return this.z5b_1.v5c_1;
  }
  w5m(other) {
    var d = this.y5b_1.r5m(other.y5b_1);
    if (!(d === 0)) {
      return d;
    }
    return this.z5b_1.x5m(other.z5b_1);
  }
  d(other) {
    return this.w5m(other instanceof LocalDateTime ? other : THROW_CCE());
  }
  equals(other) {
    var tmp;
    if (this === other) {
...
class Companion_18 {
  constructor() {
    ...
    this.c5m_1 = LocalTime.w5c(0, 0, 0, 0);
    this.d5m_1 = LocalTime.w5c(23, 59, 59, 999999999);
  }
  a5n(input, format) {
    return format.zu(input);
  }
  e5m(input, format, $super) {
    format = format === VOID ? getIsoTimeFormat() : format;
    return $super === VOID ? this.a5n(input, format) : $super.a5n.call(this, input, format);
  }
  b5n(secondOfDay, nanoOfSecond) {
    // Inline function 'kotlin.require' call
    ...
    return LocalTime.c5n(hours, minutes, second, nanoOfSecond, Unit_instance);
  }
}
class Formats_1 {
  x57() {
...
class LocalTime {
  constructor(hour, minute, second, nanosecond, unit) {
    return new.target.c5n(hour, minute, second, nanosecond, unit);
  }
  static c5n(hour, minute, second, nanosecond, unit) {
    Companion_getInstance_19();
    var $this = createThis(this);
    $this.s5c_1 = hour;
    $this.t5c_1 = minute;
    $this.u5c_1 = second;
    $this.v5c_1 = nanosecond;
    return $this;
  }
  static w5c(hour, minute, second, nanosecond) {
    Companion_getInstance_19();
    second = second === VOID ? 0 : second;
    nanosecond = nanosecond === VOID ? 0 : nanosecond;
    var $this = this.c5n(hour, minute, second, nanosecond, Unit_instance);
  ...
  x5m(other) {
    var h = compareTo(this.s5c_1, other.s5c_1);
    if (!(h === 0)) {
      return h;
    }
    var m = compareTo(this.t5c_1, other.t5c_1);
    if (!(m === 0)) {
      return m;
    }
    var s = compareTo(this.u5c_1, other.u5c_1);
    if (!(s === 0)) {
      return s;
    }
    return compareTo(this.v5c_1, other.v5c_1);
  }
  d(other) {
    return this.x5m(other instanceof LocalTime ? other : THROW_CCE());
  }
  hashCode() {
    var nod = this.d5n();
  ...
  z5m() {
    var total = imul(this.s5c_1, 3600);
    total = total + imul(this.t5c_1, 60) | 0;
    total = total + this.u5c_1 | 0;
    return total;
  }
  d5n() {
    var tmp0 = fromInt(this.s5c_1);
    // Inline function 'kotlin.Long.times' call
    var other = 1000000000;
    // Inline function 'kotlin.Long.times' call
...
class TimeZone {
  ...
  h5n(instant) {
    var tmp;
    try {
      tmp = toLocalDateTimeImpl(instant, this.g5n(instant));
    } catch ($p) {
      var tmp_0;
      if ($p instanceof IllegalArgumentException) {
        var e = $p;
        throw DateTimeArithmeticException.v57('Instant ' + instant.toString() + ' is not representable as LocalDateTime.', e);
      } else {
        throw $p;
      }
    }
  ...
  hashCode() {
    return getStringHashCode(this.p3f());
  }
  toString() {
    return this.p3f();
  }
...
class FixedOffsetTimeZone extends TimeZone {
  ...
  h5n(instant) {
    return toLocalDateTime_0(instant, this.e5n_1);
  }
}
class Companion_20 {
  constructor() {
    Companion_instance_20 = this;
    this.i5n_1 = new FixedOffsetTimeZone(Companion_getInstance_22().h5m_1, 'UTC');
  }
}
class Companion_21 {
  constructor() {
    Companion_instance_21 = this;
    this.h5m_1 = new UtcOffset(0);
  }
  j5n(input, format) {
    return format.zu(input);
  }
  i5m(input, format, $super) {
    format = format === VOID ? getIsoUtcOffsetFormat() : format;
    return $super === VOID ? this.j5n(input, format) : $super.j5n.call(this, input, format);
  }
  k5n(hours, minutes, seconds) {
    return hours === 0 && minutes === 0 && seconds === 0 ? this.h5m_1 : this.l5n((imul(hours, 3600) + imul(minutes, 60) | 0) + seconds | 0);
  }
  m5n(hours, minutes, seconds) {
    validate(this, hours, minutes, seconds);
    return this.k5n(hours, minutes, seconds);
  }
  l5n(seconds) {
    validateTotal(this, seconds);
    // Inline function 'kotlin.let' call
    return ofSecondsUnsafe(Companion_getInstance_22(), seconds);
  }
}
class Formats_2 {
  x57() {
...
class UtcOffset {
  ...
  toString() {
    return format_2(this, Formats_instance_2.x57());
  }
}
class Companion_22 {
  n5n(input, format) {
  ...
  l5m(input, format, $super) {
    format = format === VOID ? Formats_instance_3.x57() : format;
    return $super === VOID ? this.n5n(input, format) : $super.n5n.call(this, input, format);
  }
}
class Formats_3 {
  x57() {
...
class YearMonth {
  constructor(year, month, unit) {
    return new.target.o5n(year, month, unit);
  }
  static o5n(year, month, unit) {
    var $this = createThis(this);
    $this.c5g_1 = year;
    $this.d5g_1 = month;
    return $this;
  ...
  f5a() {
    return Month_0(this.d5g_1);
  }
  static e5g(year, month) {
    var $this = this.o5n(year, month, Unit_instance);
    var containsArg = $this.d5g_1;
    // Inline function 'kotlin.require' call
    if (!(1 <= containsArg ? containsArg <= 12 : false)) {
  ...
  d(other) {
    return this.p5n(other instanceof YearMonth ? other : THROW_CCE());
  }
  toString() {
    return Formats_instance_3.x57().y57(this);
  }
  equals(other) {
    var tmp;
    var tmp_0;
    if (other instanceof YearMonth) {
      tmp_0 = this.c5g_1 === other.c5g_1;
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
      tmp = this.f5a().equals(other.f5a());
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    return imul(this.c5g_1, 31) + this.f5a().hashCode() | 0;
  }
}
//endregion
...
function DayOfWeek_0(isoDayNumber) {
  ...
  return get_entries().n2(isoDayNumber - 1 | 0);
}
...
function init_kotlinx_datetime_DateTimeFormatException(_this__u8e3s4) {
  captureStack(_this__u8e3s4, _this__u8e3s4.m57_1);
}
...
function Month_0(number) {
  ...
  return get_entries_0().n2(number - 1 | 0);
}
...
function char(_this__u8e3s4, value) {
  return _this__u8e3s4.p58(toString_0(value));
}
function optional(_this__u8e3s4, ifZero, format) {
  ...
  if (isInterface(_this__u8e3s4, AbstractDateTimeFormatBuilder)) {
    _this__u8e3s4.h59(ifZero, typeof format === 'function' ? format : THROW_CCE());
    tmp = Unit_instance;
  } else {
...
function alternativeParsing(_this__u8e3s4, alternativeFormats, primaryFormat) {
  ...
  if (isInterface(_this__u8e3s4, AbstractDateTimeFormatBuilder)) {
    ...
    _this__u8e3s4.i59(tmp_0, typeof primaryFormat === 'function' ? primaryFormat : THROW_CCE());
    tmp = Unit_instance;
  } else {
    throw IllegalStateException.o('impossible');
  }
...
function secondFractionInternal(_this__u8e3s4, minLength, maxLength, grouping) {
  (isInterface(_this__u8e3s4, AbstractWithTimeBuilder) ? _this__u8e3s4 : THROW_CCE()).o59(new BasicFormatStructure(new FractionalSecondDirective(minLength, maxLength, grouping)));
}
...
function DateFieldContainer$_get_day_$ref_2ebhxx() {
  return constructCallableReference((p0) => p0.u59(), 1, 0, 39);
}
...
function DateFieldContainer$_get_dayOfWeek_$ref_thwqom() {
  return constructCallableReference((p0) => p0.w59(), 1, 0, 41);
}
...
function DateFieldContainer$_get_dayOfYear_$ref_2m6gfz() {
  return constructCallableReference((p0) => p0.y59(), 1, 0, 43);
}
...
function ISO_DATE$delegate$lambda() {
  ...
  return tmp.n5a(ISO_DATE$delegate$lambda$lambda);
}
...
function _get_ISO_DATE_$ref_powsum() {
  return constructCallableReference(() => get_ISO_DATE(), 0, 0, 45);
}
function ISO_DATE_BASIC$delegate$lambda() {
  _init_properties_LocalDateFormat_kt__k1uk9u();
  var tmp = Companion_instance_7;
  return tmp.n5a(ISO_DATE_BASIC$delegate$lambda$lambda);
}
...
function _get_ISO_DATE_BASIC_$ref_3fs8eb() {
  return constructCallableReference(() => get_ISO_DATE_BASIC(), 0, 0, 46);
}
...
function ISO_DATETIME$delegate$lambda() {
  ...
  return tmp.h5b(ISO_DATETIME$delegate$lambda$lambda);
}
function ISO_DATETIME$delegate$lambda$lambda($this$build) {
  _init_properties_LocalDateTimeFormat_kt__aloigl();
  $this$build.s58(get_ISO_DATE());
...
function _get_ISO_DATETIME_$ref_5bxm11() {
  return constructCallableReference(() => get_ISO_DATETIME(), 0, 0, 47);
}
...
function TimeFieldContainer$_get_hour_$ref_8ezbwm() {
  return constructCallableReference((p0) => p0.i5c(), 1, 0, 48);
}
...
function TimeFieldContainer$_get_minute_$ref_evb2i2() {
  return constructCallableReference((p0) => p0.d5c(), 1, 0, 50);
}
...
function TimeFieldContainer$_get_second_$ref_t7tjxy() {
  return constructCallableReference((p0) => p0.nw(), 1, 0, 52);
}
...
function TimeFieldContainer$_get_fractionOfSecond_$ref_u85by5() {
  return constructCallableReference((p0) => p0.o5c(), 1, 0, 54);
}
...
function TimeFieldContainer$_get_amPm_$ref_u9tt1b() {
  return constructCallableReference((p0) => p0.m5c(), 1, 0, 56);
}
...
function TimeFieldContainer$_get_hourOfAmPm_$ref_okyxye() {
  return constructCallableReference((p0) => p0.k5c(), 1, 0, 58);
}
...
function ISO_TIME$delegate$lambda() {
  ...
  return tmp.x5c(ISO_TIME$delegate$lambda$lambda);
}
...
function ISO_TIME$delegate$lambda$lambda$lambda$lambda($this$optional) {
  ...
  $this$optional.z58(1, 9);
  return Unit_instance;
}
function _get_ISO_TIME_$ref_kyx2od() {
  return constructCallableReference(() => get_ISO_TIME(), 0, 0, 60);
}
...
function UtcOffsetFieldContainer$_get_offsetIsNegative_$ref_v5gok2() {
  return constructCallableReference((p0) => p0.k5e(), 1, 0, 61);
}
...
function UtcOffsetFieldContainer$_get_offsetHours_$ref_elsov2() {
  return constructCallableReference((p0) => p0.m5e(), 1, 0, 63);
}
...
function UtcOffsetFieldContainer$_get_offsetMinutesOfHour_$ref_712kt() {
  return constructCallableReference((p0) => p0.o5e(), 1, 0, 65);
}
...
function UtcOffsetFieldContainer$_get_offsetSecondsOfMinute_$ref_xrmftp() {
  return constructCallableReference((p0) => p0.q5e(), 1, 0, 67);
}
...
function isoOffset(_this__u8e3s4, zOnZero, useSeparator, outputMinute, outputSecond) {
  _init_properties_UtcOffsetFormat_kt__9r9ddw();
  // Inline function 'kotlin.require' call
  if (!(outputMinute.x4(outputSecond) >= 0)) {
...
function ISO_OFFSET$delegate$lambda() {
  ...
  return tmp.h5f(ISO_OFFSET$delegate$lambda$lambda);
}
...
function _get_ISO_OFFSET_$ref_70d0nn() {
  return constructCallableReference(() => get_ISO_OFFSET(), 0, 0, 69);
}
function ISO_OFFSET_BASIC$delegate$lambda() {
  _init_properties_UtcOffsetFormat_kt__9r9ddw();
  var tmp = Companion_instance_11;
  return tmp.h5f(ISO_OFFSET_BASIC$delegate$lambda$lambda);
}
...
function FOUR_DIGIT_OFFSET$delegate$lambda() {
  _init_properties_UtcOffsetFormat_kt__9r9ddw();
  var tmp = Companion_instance_11;
  return tmp.h5f(FOUR_DIGIT_OFFSET$delegate$lambda$lambda);
}
...
function requireParsedField(field, name) {
  _init_properties_YearMonthFormat_kt__i0mmu0();
  if (field == null) {
    throw DateTimeFormatException.o57('Can not create a ' + name + ' from the given input: the field ' + name + ' is missing');
  }
  return field;
}
...
function YearMonthFieldContainer$_get_year_$ref_7j3zdj() {
  return constructCallableReference((p0) => p0.a5a(), 1, 0, 70);
}
...
function YearMonthFieldContainer$_get_monthNumber_$ref_pn0wu5() {
  return constructCallableReference((p0) => p0.g5a(), 1, 0, 72);
}
...
function ISO_YEAR_MONTH$delegate$lambda() {
  ...
  return tmp.g5g(ISO_YEAR_MONTH$delegate$lambda$lambda);
}
...
function _get_ISO_YEAR_MONTH_$ref_y3tv9a() {
  return constructCallableReference(() => get_ISO_YEAR_MONTH(), 0, 0, 74);
}
...
function Accessor$getterNotNull$ref(p0) {
  return constructCallableReference((p0_0) => p0.w5h(p0_0), 1, 0, 75, 'getterNotNull', [p0]);
}
...
function Accessor$getter$ref(p0) {
  return constructCallableReference((p0_0) => p0.v5h(p0_0), 1, 0, 76, 'getter', [p0]);
}
function SignedFormatStructure$parser$lambda(this$0) {
  return (value, isNegative) => {
    var _iterator__ex2g4s = this$0.b5i_1.l1();
    while (_iterator__ex2g4s.m1()) {
      var field = _iterator__ex2g4s.n1();
      var wasNegative = field.o5f().v5h(value) === true;
      field.o5f().u5h(value, !(isNegative === wasNegative));
    }
    return Unit_instance;
  };
}
function formatter$checkIfAllNegative(this$0, value) {
  ...
  $l$loop: while (_iterator__ex2g4s.m1()) {
    ...
    if (check.o5f().v5h(value) === true)
      seenNonZero = true;
    else if (check.q5f(value))
      continue $l$loop;
    else
      return false;
  }
...
function SignedFormatStructure$formatter$checkIfAllNegative$ref(this$0) {
  return constructCallableReference((p0) => formatter$checkIfAllNegative(this$0, p0), 1, 0, 77, 'checkIfAllNegative', [this$0]);
}
...
function basicFormats$rec($this_buildList, format) {
  if (format instanceof BasicFormatStructure)
    $this_buildList.i2(format.x5h_1);
  else {
    if (format instanceof ConcatenatedFormatStructure) {
      // Inline function 'kotlin.collections.forEach' call
      var _iterator__ex2g4s = format.n59_1.l1();
      ...
      if (!(format instanceof ConstantFormatStructure)) {
        if (format instanceof SignedFormatStructure) {
          basicFormats$rec($this_buildList, format.z5h_1);
        } else {
          if (format instanceof AlternativesParsingFormatStructure) {
            basicFormats$rec($this_buildList, format.i5i_1);
            // Inline function 'kotlin.collections.forEach' call
            var _iterator__ex2g4s_0 = format.j5i_1.l1();
            while (_iterator__ex2g4s_0.m1()) {
              var element_0 = _iterator__ex2g4s_0.n1();
            ...
            if (format instanceof OptionalFormatStructure) {
              basicFormats$rec($this_buildList, format.g5i_1);
            } else {
              noWhenBranchMatchedException();
            }
          }
...
function conjunctionPredicate(predicates) {
  return predicates.j1() ? Truth_instance : predicates.l2() === 1 ? single(predicates) : new ConjunctionPredicate(predicates);
}
var Truth_instance;
...
function Predicate$test$ref(p0) {
  return constructCallableReference((p0_0) => p0.m5i(p0_0), 1, 0, 78, 'test', [p0]);
}
function Truth$test$ref(p0) {
  return constructCallableReference((p0_0) => p0.n5i(p0_0), 1, 0, 79, 'test', [p0]);
}
...
function setWithoutReassigning(_this__u8e3s4, receiver, value) {
  var tmp0_elvis_lhs = _this__u8e3s4.u5h(receiver, value);
  var tmp;
  if (tmp0_elvis_lhs == null) {
    return null;
  } else {
...
function Parser__match_impl_nzt83d($this, input, initialContainer, startIndex) {
  ...
  iterate_over_alternatives: while (true) {
    ...
    var state = tmp;
    var output = state.h5k_1.k5a();
    var inputPosition = state.j5k_1;
    var parserStructure = state.i5k_1;
    // Inline function 'kotlin.run' call
    $l$block: {
      var inductionVariable = 0;
      var last = parserStructure.l5k_1.l2() - 1 | 0;
      if (inductionVariable <= last)
        do {
          var ix = inductionVariable;
          inductionVariable = inductionVariable + 1 | 0;
          // Inline function 'kotlinx.datetime.internal.format.parser.ParseResult.match' call
          var this_0 = parserStructure.l5k_1.n2(ix).n5k(output, input, inputPosition);
      ...
      if (parserStructure.m5k_1.j1()) {
        ...
        var inductionVariable_0 = parserStructure.m5k_1.l2() - 1 | 0;
        if (0 <= inductionVariable_0)
          do {
            var ix_0 = inductionVariable_0;
            inductionVariable_0 = inductionVariable_0 + -1 | 0;
            parseOptions.i2(new ParserState(output, parserStructure.m5k_1.n2(ix_0), inputPosition));
          }
  ...
  throw ParseException.q5k(errors);
}
function Parser__match$default_impl_x2xlti($this, input, initialContainer, startIndex, $super) {
  ...
  if ($super === VOID) {
    ...
    var tmp_0 = $super;
    tmp = (tmp_0 == null ? null : new Parser(tmp_0)).r5k.call(new Parser($this), input, initialContainer, startIndex);
  }
  return tmp;
}
...
function Parser__equals_impl_djxokv($this, other) {
  if (!(other instanceof Parser))
    return false;
  var tmp0_other_with_cast = other instanceof Parser ? other.k5k_1 : THROW_CCE();
...
function formatError(errors) {
  if (errors.l2() === 1) {
    return 'Position ' + errors.n2(0).d5k_1 + ': ' + errors.n2(0).e5k_1();
  }
  var averageMessageLength = 33;
  var tmp0_buffer = StringBuilder.nc(imul(averageMessageLength, errors.l2()));
...
function concat$mergeOperations(baseOperations, numberSpan, unconditionalModifications, simplifiedParserStructure) {
  var operationsToMerge = simplifiedParserStructure.l5k_1;
  ...
  if (numberSpan == null) {
    ...
    if (firstOperation instanceof NumberSpanParserOperation) {
      this_0.i2(new NumberSpanParserOperation(plus(numberSpan, firstOperation.u5k_1)));
      ...
      if (inductionVariable <= last)
        do {
          var i = inductionVariable;
          inductionVariable = inductionVariable + 1 | 0;
          this_0.i2(operationsToMerge.n2(i));
        }
         while (!(i === last));
    } else {
      this_0.i2(new NumberSpanParserOperation(numberSpan));
      this_0.m2(operationsToMerge);
    }
  }
  this_0.m2(unconditionalModifications);
  var mergedOperations = this_0.k5();
  return new ParserStructure(mergedOperations, simplifiedParserStructure.m5k_1);
}
function concat$simplifyAndAppend(_this__u8e3s4, other) {
  // Inline function 'kotlin.collections.mutableListOf' call
  var newOperations = ArrayList.j2();
  var currentNumberSpan = null;
  // Inline function 'kotlin.collections.mutableListOf' call
  var unconditionalModifications = ArrayList.j2();
  var _iterator__ex2g4s = _this__u8e3s4.l5k_1.l1();
  while (_iterator__ex2g4s.m1()) {
    var op = _iterator__ex2g4s.n1();
    if (op instanceof NumberSpanParserOperation) {
      if (!(currentNumberSpan == null)) {
        currentNumberSpan.m2(op.u5k_1);
      } else {
        currentNumberSpan = toMutableList(op.u5k_1);
      }
    } else {
      if (op instanceof UnconditionalModification)
        unconditionalModifications.i2(op);
      else {
        if (!(currentNumberSpan == null)) {
          newOperations.i2(new NumberSpanParserOperation(currentNumberSpan));
          currentNumberSpan = null;
          newOperations.m2(unconditionalModifications);
          unconditionalModifications.j4();
        }
        newOperations.i2(op);
      }
    }
  ...
  while (_iterator__ex2g4s_0.m1()) {
    ...
    var tmp;
    if (simplified.l5k_1.j1()) {
      // Inline function 'kotlin.collections.ifEmpty' call
      var this_0 = simplified.m5k_1;
      var tmp_0;
      if (this_0.j1()) {
  ...
  if (tmp_4) {
    ...
    $l$block_0: {
      ...
      while (_iterator__ex2g4s_1.m1()) {
        ...
        var tmp_6 = firstOrNull(element_0.l5k_1);
  ...
  if (tmp_3) {
    ...
    // Inline function 'kotlin.collections.map' call
    // Inline function 'kotlin.collections.mapTo' call
    var destination_0 = ArrayList.h2(collectionSizeOrDefault(mergedTails, 10));
...
function _get_whatThisExpects__4pg11j($this) {
  ...
  while (_iterator__ex2g4s.m1()) {
    var item = _iterator__ex2g4s.n1();
    var length = item.a();
    var tmp$ret$2 = (length == null ? 'at least one digit' : '' + length + ' digits') + (' for ' + item.n5j_1);
    destination.i2(tmp$ret$2);
  }
  var consumerLengths = destination;
  var tmp;
  if ($this.w5k_1) {
    tmp = 'a number with at least ' + $this.v5k_1 + ' digits: ' + toString(consumerLengths);
  } else {
    tmp = 'a number with exactly ' + $this.v5k_1 + ' digits: ' + toString(consumerLengths);
  }
  return tmp;
}
...
function NumberSpanParserOperation$consume$lambda_1($numberString, this$0, $i, $error) {
  return () => "Can not interpret the string '" + $numberString + "' as " + this$0.u5k_1.n2($i).n5j_1 + ': ' + $error.s5j();
}
function SignedIntParser(minDigits, maxDigits, spacePadding, setter, name, plusOnExceedsWidth) {
  ...
  if (!(plusOnExceedsWidth == null)) {
    parsers.i2(spaceAndZeroPaddedUnsignedInt(minDigits, plusOnExceedsWidth, spacePadding, setter, name));
    parsers.i2(new ParserStructure(listOf([new PlainStringParserOperation('+'), new NumberSpanParserOperation(listOf_0(new UnsignedIntConsumer(plusOnExceedsWidth + 1 | 0, maxDigits, setter, name, false)))]), emptyList()));
  } else {
    parsers.i2(spaceAndZeroPaddedUnsignedInt(minDigits, maxDigits, spacePadding, setter, name));
  }
  return new ParserStructure(emptyList(), parsers);
}
function PlainStringParserOperation$consume$lambda(this$0) {
  return () => "Unexpected end of input: yet to parse '" + this$0.x5k_1 + "'";
}
function PlainStringParserOperation$consume$lambda_0(this$0, $input, $startIndex, $i) {
  return () => {
    ...
    return 'Expected ' + this$0.x5k_1 + ' but got ' + tmp$ret$0;
  };
}
function SignParser$consume$lambda(this$0, $char) {
  return () => 'Expected ' + this$0.a5l_1 + ' but got ' + toString_0($char);
}
function spaceAndZeroPaddedUnsignedInt$numberOfRequiredLengths($withMinus, $setter, $name, minNumberLength, maxNumberLength) {
  ...
  var this_0 = ArrayList.j2();
  if ($withMinus) {
    this_0.i2(new PlainStringParserOperation('-'));
  }
  this_0.i2(new NumberSpanParserOperation(listOf_0(new UnsignedIntConsumer(minNumberLength - ($withMinus ? 1 : 0) | 0, maxNumberLength - ($withMinus ? 1 : 0) | 0, $setter, $name, $withMinus))));
  var tmp$ret$1 = this_0.k5();
...
function TimeBasedDateTimeUnitSerializer$descriptor$delegate$lambda$lambda($this$buildClassSerialDescriptor) {
  ...
  var this_0 = serializer(createKType(PrimitiveClasses_getInstance().tg(), arrayOf([]), false));
  var descriptor = (isInterface(this_0, KSerializer) ? this_0 : THROW_CCE()).gz();
  $this$buildClassSerialDescriptor.v12(elementName, descriptor, annotations, false);
  return Unit_instance;
}
function TimeBasedDateTimeUnitSerializer$_get_descriptor_$ref_ezonyw() {
  return constructCallableReference((p0) => p0.gz(), 1, 0, 80);
}
...
function DateBasedDateTimeUnitSerializer$impl$delegate$lambda() {
  ...
  return SealedClassSerializer.q10('kotlinx.datetime.DateTimeUnit.DateBased', tmp, tmp_0, tmp$ret$3);
}
function DateBasedDateTimeUnitSerializer$_get_impl_$ref_m860rs() {
  return constructCallableReference((p0) => _get_impl__d88w17(p0), 1, 0, 81);
}
...
function DateBasedDateTimeUnitSerializer_getInstance() {
  if (DateBasedDateTimeUnitSerializer_instance === VOID)
    DateBasedDateTimeUnitSerializer.g5l();
...
function DayBasedDateTimeUnitSerializer$descriptor$delegate$lambda$lambda($this$buildClassSerialDescriptor) {
  ...
  // Inline function 'kotlinx.serialization.serializer' call
  // Inline function 'kotlinx.serialization.internal.cast' call
  var this_0 = serializer(createKType(PrimitiveClasses_getInstance().sg(), arrayOf([]), false));
  var descriptor = (isInterface(this_0, KSerializer) ? this_0 : THROW_CCE()).gz();
  $this$buildClassSerialDescriptor.v12('days', descriptor, annotations, false);
  return Unit_instance;
}
function DayBasedDateTimeUnitSerializer$_get_descriptor_$ref_2ycvl3() {
  return constructCallableReference((p0) => p0.gz(), 1, 0, 82);
}
...
function MonthBasedDateTimeUnitSerializer$descriptor$delegate$lambda$lambda($this$buildClassSerialDescriptor) {
  ...
  var this_0 = serializer(createKType(PrimitiveClasses_getInstance().sg(), arrayOf([]), false));
  var descriptor = (isInterface(this_0, KSerializer) ? this_0 : THROW_CCE()).gz();
  $this$buildClassSerialDescriptor.v12('months', descriptor, annotations, false);
  return Unit_instance;
}
function MonthBasedDateTimeUnitSerializer$_get_descriptor_$ref_vroatn() {
  return constructCallableReference((p0) => p0.gz(), 1, 0, 83);
}
...
function validateYearAndDay($this) {
  var containsArg = $this.b5a_1;
  // Inline function 'kotlin.require' call
  if (!(-999999999 <= containsArg ? containsArg <= 999999999 : false)) {
    var message = 'Invalid date: the year is out of range';
    throw IllegalArgumentException.a2(toString(message));
  }
  var containsArg_0 = $this.c5a_1;
  // Inline function 'kotlin.require' call
  if (!(1 <= containsArg_0 ? containsArg_0 <= 31 : false)) {
    var message_0 = 'Invalid date: day of month must be a number between 1 and 31, got ' + $this.c5a_1;
    throw IllegalArgumentException.a2(toString(message_0));
  }
  if ($this.c5a_1 > 28 && $this.c5a_1 > monthLength($this.d5a_1, isLeapYear($this.b5a_1))) {
    if ($this.c5a_1 === 29) {
      throw IllegalArgumentException.a2("Invalid date 'February 29' as '" + $this.b5a_1 + "' is not a leap year");
    } else {
      throw IllegalArgumentException.a2("Invalid date '" + $this.f5a().toString() + ' ' + $this.c5a_1 + "'");
    }
  }
}
...
function resolvePreviousValid($this, year, month, day) {
  ...
  return LocalDate.p5m(year, month, newDay, Unit_instance);
}
function plus_1(_this__u8e3s4, value, unit) {
  ...
  try {
    ...
    if (unit instanceof DayBased) {
      tmp_0 = _this__u8e3s4.t5m(safeMultiply(value, fromInt(unit.u56_1)));
    } else {
      if (unit instanceof MonthBased) {
        tmp_0 = _this__u8e3s4.s5m(safeMultiply(value, fromInt(unit.v56_1)));
      } else {
        noWhenBranchMatchedException();
      }
    }
    ...
    if ($p instanceof ArithmeticException) {
      var e = $p;
      throw DateTimeArithmeticException.v57('Arithmetic overflow when adding a value to a date', e);
    } else {
      if ($p instanceof IllegalArgumentException) {
        var e_0 = $p;
        throw DateTimeArithmeticException.v57('Boundaries of LocalDate exceeded when adding a value', e_0);
      } else {
        throw $p;
      }
    }
...
function ISO_DATETIME_OPTIONAL_SECONDS_TRAILING_ZEROS$delegate$lambda() {
  _init_properties_LocalDateTime_kt__bewbbg();
  var tmp = Companion_instance_8;
  return tmp.h5b(ISO_DATETIME_OPTIONAL_SECONDS_TRAILING_ZEROS$delegate$lambda$lambda);
}
function ISO_DATETIME_OPTIONAL_SECONDS_TRAILING_ZEROS$delegate$lambda$lambda($this$build) {
  ...
  $this$build.a59(get_ISO_TIME_OPTIONAL_SECONDS_TRAILING_ZEROS());
  return Unit_instance;
}
...
function _get_ISO_DATETIME_OPTIONAL_SECONDS_TRAILING_ZEROS_$ref_4ujexv() {
  return constructCallableReference(() => get_ISO_DATETIME_OPTIONAL_SECONDS_TRAILING_ZEROS(), 0, 0, 85);
}
...
function ISO_TIME_OPTIONAL_SECONDS_TRAILING_ZEROS$delegate$lambda() {
  _init_properties_LocalTime_kt__nmhi56();
  var tmp = Companion_instance_9;
  return tmp.x5c(ISO_TIME_OPTIONAL_SECONDS_TRAILING_ZEROS$delegate$lambda$lambda);
}
...
function ISO_TIME_OPTIONAL_SECONDS_TRAILING_ZEROS$delegate$lambda$lambda$lambda$lambda($this$optional) {
  _init_properties_LocalTime_kt__nmhi56();
  char($this$optional, _Char___init__impl__6a9atx(46));
  secondFractionInternal($this$optional, 1, 9, Companion_getInstance_11().y5d_1);
  return Unit_instance;
}
function _get_ISO_TIME_OPTIONAL_SECONDS_TRAILING_ZEROS_$ref_fmwpvv() {
  return constructCallableReference(() => get_ISO_TIME_OPTIONAL_SECONDS_TRAILING_ZEROS(), 0, 0, 86);
}
...
function toInstant(_this__u8e3s4, offset, youShallNotPass) {
  youShallNotPass = youShallNotPass === VOID ? Companion_getInstance_7().a58_1 : youShallNotPass;
  _init_properties_TimeZone_kt__dwyks9();
  return Companion_getInstance().wu(_this__u8e3s4.y5m(offset), _this__u8e3s4.g5c());
}
...
function toLocalDateTime(_this__u8e3s4, timeZone) {
  _init_properties_TimeZone_kt__dwyks9();
  return timeZone.h5n(_this__u8e3s4);
}
function toLocalDateTime_0(_this__u8e3s4, offset) {
  ...
  try {
    ...
    if ($p instanceof IllegalArgumentException) {
      var e = $p;
      throw DateTimeArithmeticException.v57('Instant ' + _this__u8e3s4.toString() + ' is not representable as LocalDateTime', e);
    } else {
      throw $p;
    }
  }
...
function toLocalDateTimeImpl(_this__u8e3s4, offset) {
  _init_properties_TimeZone_kt__dwyks9();
  var tmp0 = _this__u8e3s4.bv_1;
  // Inline function 'kotlin.Long.plus' call
  var other = offset.x5e_1;
  ...
  var date = Companion_getInstance_17().o5m(localEpochDay);
  var time = Companion_getInstance_19().b5n(secsOfDay, _this__u8e3s4.cv_1);
  return LocalDateTime.a5c(date, time);
}
...
function lenientOffsetFormat$lambda$lambda($this$alternativeParsing) {
  _init_properties_TimeZone_kt__dwyks9();
  $this$alternativeParsing.b59(Padding_NONE_getInstance());
  return Unit_instance;
}
...
function _init_properties_TimeZone_kt__dwyks9() {
  if (!properties_initialized_TimeZone_kt_fgsidh) {
    ...
    var tmp = Companion_instance_11;
    lenientOffsetFormat = tmp.h5f(lenientOffsetFormat$lambda);
  }
}
...
function validate($this, hours, minutes, seconds) {
  if (hours < -18 || hours > 18) {
    throw IllegalArgumentException.a2('Zone offset hours not in valid range: value ' + hours + ' is not in the range -18 to 18');
  }
  if (hours > 0) {
    if (minutes < 0 || seconds < 0) {
      throw IllegalArgumentException.a2('Zone offset minutes and seconds must be positive because hours is positive');
    }
  } else if (hours < 0) {
    if (minutes > 0 || seconds > 0) {
      throw IllegalArgumentException.a2('Zone offset minutes and seconds must be negative because hours is negative');
    }
  } else if (minutes > 0 && seconds < 0 || (minutes < 0 && seconds > 0)) {
    throw IllegalArgumentException.a2('Zone offset minutes and seconds must have the same sign');
  }
  if (abs(minutes) > 59) {
    throw IllegalArgumentException.a2('Zone offset minutes not in valid range: abs(value) ' + abs(minutes) + ' is not in the range 0 to 59');
  }
  if (abs(seconds) > 59) {
    throw IllegalArgumentException.a2('Zone offset seconds not in valid range: abs(value) ' + abs(seconds) + ' is not in the range 0 to 59');
  }
  if (abs(hours) === 18 && (abs(minutes) > 0 || abs(seconds) > 0)) {
    throw IllegalArgumentException.a2('Utc offset not in valid range: -18:00 to +18:00');
  }
}
function ofSecondsUnsafe($this, seconds) {
  var tmp;
  if ((seconds % 900 | 0) === 0) {
    var tmp0_elvis_lhs = get_utcOffsetCache().v4(seconds);
    var tmp_0;
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlin.also' call
      var this_0 = new UtcOffset(seconds);
      // Inline function 'kotlin.collections.set' call
      get_utcOffsetCache().o4(seconds, this_0);
      tmp_0 = this_0;
    } else {
...
function UtcOffset_0(hours, minutes, seconds) {
  ...
  if (!(hours == null)) {
    ...
    tmp = tmp_0.m5n(hours, tmp_1, seconds == null ? 0 : seconds);
  } else if (!(minutes == null)) {
    var tmp_2 = Companion_getInstance_22();
    var tmp_3 = minutes / 60 | 0;
    var tmp_4 = minutes % 60 | 0;
    tmp = tmp_2.m5n(tmp_3, tmp_4, seconds == null ? 0 : seconds);
  } else {
    var tmp_5 = Companion_getInstance_22();
    tmp = tmp_5.l5n(seconds == null ? 0 : seconds);
  }
  return tmp;
}
...
function _init_properties_UtcOffset_kt__93zod7() {
  if (!properties_initialized_UtcOffset_kt_4gxffr) {
    ...
    utcOffsetCache = LinkedHashMap.r5();
  }
}
function validateYear($this) {
  var containsArg = $this.c5g_1;
  // Inline function 'kotlin.require' call
  if (!(-999999999 <= containsArg ? containsArg <= 999999999 : false)) {
    var message = 'Year ' + $this.c5g_1 + ' is out of range: -999999999..999999999';
    throw IllegalArgumentException.a2(toString(message));
  }
}
...
function YearMonth$_get_year_$ref_chp4n6() {
  return constructCallableReference((p0) => p0.c5g_1, 1, 0, 87);
}
function YearMonth$_get_month_$ref_9rphhd() {
  return constructCallableReference((p0) => p0.f5a(), 1, 0, 88);
}
function safeAdd(a, b) {
  var sum = add(a, b);
  if ((a ^ sum) < 0n && (a ^ b) >= 0n) {
    throw ArithmeticException.kf('Addition overflows a long: ' + a.toString() + ' + ' + b.toString());
  }
  return sum;
}
function safeMultiply(a, b) {
  ...
  if (!(divide(total, b) === a) || (a === -9223372036854775808n && b === -1n) || (b === -9223372036854775808n && a === -1n)) {
    throw ArithmeticException.kf('Multiplication overflows a long: ' + a.toString() + ' * ' + b.toString());
  }
  return total;
}
function safeMultiply_0(a, b) {
  ...
  if (total < -2147483648n || total > 2147483647n) {
    throw ArithmeticException.kf('Multiplication overflows an int: ' + a + ' * ' + b);
  }
...
initMetadataForClass(DateTimeFormatException, 'DateTimeFormatException', DateTimeFormatException.n57);
initMetadataForCompanion(Companion_5);
initMetadataForClass(DateTimeArithmeticException, 'DateTimeArithmeticException', DateTimeArithmeticException.u57);
...
protoOf(Builder).i59 = appendAlternativeParsingImpl;
protoOf(Builder).h59 = appendOptionalImpl;
protoOf(Builder).p58 = chars;
protoOf(Builder).s40 = build;
protoOf(Builder).q5a = addFormatStructureForYearMonth;
protoOf(Builder).q58 = day;
protoOf(Builder).r58 = day$default;
protoOf(Builder).s58 = date;
protoOf(Builder).l58 = year;
protoOf(Builder).m58 = year$default;
protoOf(Builder).n58 = monthNumber;
protoOf(Builder).o58 = monthNumber$default;
...
protoOf(Builder_0).i59 = appendAlternativeParsingImpl;
protoOf(Builder_0).h59 = appendOptionalImpl;
protoOf(Builder_0).p58 = chars;
protoOf(Builder_0).s40 = build;
protoOf(Builder_0).p5a = addFormatStructureForDate;
protoOf(Builder_0).o59 = addFormatStructureForTime;
protoOf(Builder_0).q5a = addFormatStructureForYearMonth;
protoOf(Builder_0).q58 = day;
protoOf(Builder_0).r58 = day$default;
protoOf(Builder_0).s58 = date;
protoOf(Builder_0).l58 = year;
protoOf(Builder_0).m58 = year$default;
protoOf(Builder_0).n58 = monthNumber;
protoOf(Builder_0).o58 = monthNumber$default;
protoOf(Builder_0).t58 = hour;
protoOf(Builder_0).u58 = hour$default;
protoOf(Builder_0).v58 = minute;
protoOf(Builder_0).w58 = minute$default;
protoOf(Builder_0).x58 = second;
protoOf(Builder_0).y58 = second$default;
protoOf(Builder_0).z58 = secondFraction;
protoOf(Builder_0).a59 = time;
...
protoOf(IncompleteLocalTime).n5c = set_fractionOfSecond;
protoOf(IncompleteLocalTime).o5c = get_fractionOfSecond;
...
protoOf(Builder_1).i59 = appendAlternativeParsingImpl;
protoOf(Builder_1).h59 = appendOptionalImpl;
protoOf(Builder_1).p58 = chars;
protoOf(Builder_1).s40 = build;
protoOf(Builder_1).t58 = hour;
protoOf(Builder_1).u58 = hour$default;
protoOf(Builder_1).v58 = minute;
protoOf(Builder_1).w58 = minute$default;
protoOf(Builder_1).x58 = second;
protoOf(Builder_1).y58 = second$default;
protoOf(Builder_1).z58 = secondFraction;
protoOf(Builder_1).a59 = time;
...
protoOf(Builder_2).i59 = appendAlternativeParsingImpl;
protoOf(Builder_2).h59 = appendOptionalImpl;
protoOf(Builder_2).p58 = chars;
protoOf(Builder_2).s40 = build;
protoOf(Builder_2).b59 = offsetHours;
protoOf(Builder_2).c59 = offsetHours$default;
protoOf(Builder_2).d59 = offsetMinutesOfHour;
protoOf(Builder_2).e59 = offsetMinutesOfHour$default;
protoOf(Builder_2).f59 = offsetSecondsOfMinute;
protoOf(Builder_2).g59 = offsetSecondsOfMinute$default;
...
protoOf(Builder_3).i59 = appendAlternativeParsingImpl;
protoOf(Builder_3).h59 = appendOptionalImpl;
protoOf(Builder_3).p58 = chars;
protoOf(Builder_3).s40 = build;
protoOf(Builder_3).l58 = year;
protoOf(Builder_3).m58 = year$default;
protoOf(Builder_3).n58 = monthNumber;
protoOf(Builder_3).o58 = monthNumber$default;
...
protoOf(PropertyAccessor).w5h = getterNotNull;
...
export {
  Companion_getInstance_21 as Companion_getInstance381h5efhgh2m9,
  Companion_getInstance_22 as Companion_getInstance292xhh8qv7cai,
  LocalDateTime as LocalDateTime3vqv9moe7clf4,
  toInstant as toInstant1fmt1re8uidf7,
