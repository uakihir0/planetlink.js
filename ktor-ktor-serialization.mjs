...
class ContentConvertException extends Exception {
  constructor(message, cause) {
    return new.target.c4k(message, cause);
  }
  static c4k(message, cause) {
    cause = cause === VOID ? null : cause;
    var $this = this.we(message, cause);
    captureStack($this, $this.b4k_1);
    return $this;
  }
}
class JsonConvertException extends ContentConvertException {
  constructor(message, cause) {
    return new.target.z4j(message, cause);
  }
  static z4j(message, cause) {
    cause = cause === VOID ? null : cause;
    var $this = this.c4k(message, cause);
    captureStack($this, $this.y4j_1);
    return $this;
  }
}
class Configuration {}
function register$default(contentType, converter, configuration, $super) {
  ...
  var tmp_0;
  if ($super === VOID) {
    this.d4k(contentType, converter, configuration);
    tmp_0 = Unit_instance;
  } else {
    tmp_0 = $super.d4k.call(this, contentType, converter, configuration);
  }
  return tmp_0;
}
class sam$kotlinx_coroutines_flow_FlowCollector$0 {
  constructor(function_0) {
    this.f4k_1 = function_0;
  }
  *h2n(value, $completion) {
    return yield* this.f4k_1(value, $completion);
  }
  c5() {
    return this.f4k_1;
  }
...
class deserialize$$inlined$map$1 {
  ...
  *g2n(collector, $completion) {
    var tmp = deserialize$o$collect$slambda(collector, this.i4k_1, this.j4k_1, this.k4k_1);
    yield* this.h4k_1.e2n(new sam$kotlinx_coroutines_flow_FlowCollector$0(tmp), $completion);
  ...
  if (!(result == null)) {
    ...
    if (!body.p3m()) {
      ...
      if ((tmp0_safe_receiver == null ? null : tmp0_safe_receiver.c1()) === true) {
        ...
        throw ContentConvertException.c4k('No suitable converter found for ' + typeInfo.toString());
      }
    }
  }
  return tmp_0;
...
function deserialize$o$collect$slambda($$this$unsafeFlow, $charset, $typeInfo, $body) {
  return constructCallableReference(function *(value, $completion) {
    ...
    var tmp$ret$1 = yield* value.g4k($charset, $typeInfo, $body, $completion);
