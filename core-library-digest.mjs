...
class Digest {
  static j8x(algorithm, blockSize, digestLength) {
    ...
    $l$block: {
      ...
      throw InvalidParameterException.e8x(toString(message));
    }
    ...
    $l$block_0: {
      ...
      throw InvalidParameterException.e8x(toString(message_0));
    }
    ...
    $l$block_1: {
      ...
      throw InvalidParameterException.e8x(toString(message_1));
    }
    ...
    $l$block_2: {
      ...
      throw InvalidParameterException.e8x(toString(message_2));
    }
    tmp.h8x_1 = _Buffer___init__impl__mrnqm7(new Int8Array(blockSize));
    $this.f8x_1 = algorithm;
    $this.g8x_1 = digestLength;
    $this.i8x_1 = 0;
    return $this;
  }
  k8x() {
  ...
  equals(other) {
    ...
    if (other instanceof Digest) {
      tmp = equals(other.h8x_1, this.h8x_1);
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    return Buffer__hashCode_impl_3ylui6(this.h8x_1);
  }
  toString() {
    // Inline function 'org.kotlincrypto.core.digest.internal.commonToString' call
    return 'Digest[' + this.l8x() + ']@' + this.hashCode();
  }
}
//endregion
