...
class Digest {
  static p90(algorithm, blockSize, digestLength) {
    ...
    $l$block: {
      ...
      throw InvalidParameterException.k90(toString(message));
    }
    ...
    $l$block_0: {
      ...
      throw InvalidParameterException.k90(toString(message_0));
    }
    ...
    $l$block_1: {
      ...
      throw InvalidParameterException.k90(toString(message_1));
    }
    ...
    $l$block_2: {
      ...
      throw InvalidParameterException.k90(toString(message_2));
    }
    tmp.n90_1 = _Buffer___init__impl__mrnqm7(new Int8Array(blockSize));
    $this.l90_1 = algorithm;
    $this.m90_1 = digestLength;
    $this.o90_1 = 0;
    return $this;
  }
  q90() {
  ...
  equals(other) {
    ...
    if (other instanceof Digest) {
      tmp = equals(other.n90_1, this.n90_1);
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    return Buffer__hashCode_impl_3ylui6(this.n90_1);
  }
  toString() {
    // Inline function 'org.kotlincrypto.core.digest.internal.commonToString' call
    return 'Digest[' + this.r90() + ']@' + this.hashCode();
  }
}
//endregion
