...
class Digest {
  static r8i(algorithm, blockSize, digestLength) {
    ...
    $l$block: {
      ...
      throw InvalidParameterException.m8i(toString(message));
    }
    ...
    $l$block_0: {
      ...
      throw InvalidParameterException.m8i(toString(message_0));
    }
    ...
    $l$block_1: {
      ...
      throw InvalidParameterException.m8i(toString(message_1));
    }
    ...
    $l$block_2: {
      ...
      throw InvalidParameterException.m8i(toString(message_2));
    }
    tmp.p8i_1 = _Buffer___init__impl__mrnqm7(new Int8Array(blockSize));
    $this.n8i_1 = algorithm;
    $this.o8i_1 = digestLength;
    $this.q8i_1 = 0;
    return $this;
  }
  s8i() {
  ...
  equals(other) {
    ...
    if (other instanceof Digest) {
      tmp = equals(other.p8i_1, this.p8i_1);
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    return Buffer__hashCode_impl_3ylui6(this.p8i_1);
  }
  toString() {
    // Inline function 'org.kotlincrypto.core.digest.internal.commonToString' call
    return 'Digest[' + this.t8i() + ']@' + this.hashCode();
  }
}
//endregion
