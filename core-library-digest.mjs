...
class Digest {
  static x8v(algorithm, blockSize, digestLength) {
    ...
    $l$block: {
      ...
      throw InvalidParameterException.s8v(toString(message));
    }
    ...
    $l$block_0: {
      ...
      throw InvalidParameterException.s8v(toString(message_0));
    }
    ...
    $l$block_1: {
      ...
      throw InvalidParameterException.s8v(toString(message_1));
    }
    ...
    $l$block_2: {
      ...
      throw InvalidParameterException.s8v(toString(message_2));
    }
    tmp.v8v_1 = _Buffer___init__impl__mrnqm7(new Int8Array(blockSize));
    $this.t8v_1 = algorithm;
    $this.u8v_1 = digestLength;
    $this.w8v_1 = 0;
    return $this;
  }
  y8v() {
  ...
  equals(other) {
    ...
    if (other instanceof Digest) {
      tmp = equals(other.v8v_1, this.v8v_1);
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    return Buffer__hashCode_impl_3ylui6(this.v8v_1);
  }
  toString() {
    // Inline function 'org.kotlincrypto.core.digest.internal.commonToString' call
    return 'Digest[' + this.z8v() + ']@' + this.hashCode();
  }
}
//endregion
