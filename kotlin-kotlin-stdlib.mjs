...
class AbstractList extends AbstractCollection {
  ...
  d4(fromIndex, toIndex) {
    return SubList_0.hk(this, fromIndex, toIndex);
  }
  equals(other) {
    if (other === this)
      return true;
...
class asList$1 extends AbstractList {
  ...
  b7(index) {
    Companion_instance_10.c7(index, this.k2());
...
class ListIteratorImpl extends IteratorImpl {
  constructor($outer, index, $box) {
    ...
    $box.s7_1 = $outer;
    super($outer, $box);
    Companion_instance_10.t7(index, this.s7_1.k2());
    this.k7_1 = index;
  }
  u7() {
    return this.k7_1 > 0;
...
class AbstractMutableList extends AbstractMutableCollection {
  ...
  e2(element) {
    this.i7();
    this.l4(this.k2(), element);
    return true;
  }
  g4(index, elements) {
    Companion_instance_10.t7(index, this.k2());
    this.i7();
    var _index = index;
    var changed = false;
    var _iterator__ex2g4s = elements.l1();
...
class SubList extends AbstractMutableList {
  ...
  static c8(list, fromIndex, toIndex) {
    ...
    $this.a8_1 = fromIndex;
    $this.b8_1 = 0;
    Companion_instance_10.s6($this.a8_1, toIndex, $this.z7_1.k2());
  ...
  m2(index) {
    ...
    return this.z7_1.m2(this.a8_1 + index | 0);
  }
  m4(index) {
    Companion_instance_10.c7(index, this.b8_1);
...
class AbstractMap {
  ...
  r4() {
    if (this.m8_1 == null) {
      var tmp = this;
      tmp.m8_1 = AbstractMap$keys$1.qk(this);
    }
  ...
  s4() {
    if (this.n8_1 == null) {
      var tmp = this;
      tmp.n8_1 = AbstractMap$values$1.tk(this);
    }
...
class ArrayList extends AbstractMutableList {
  ...
  k5() {
    this.i7();
    this.v1_1 = true;
    return this.k2() > 0 ? this : Companion_getInstance_7().z8_1;
  }
  a9() {
  }
  b9(minCapacity) {
...
class HashMapEntrySetBase extends AbstractMutableSet {
  ...
  j1() {
    return this.ia_1.k2() === 0;
  }
  la(element) {
    return this.ia_1.na(element);
  }
  n2(element) {
...
class HashMapKeysDefault extends AbstractMutableSet {
  ...
  qa(element) {
    throw UnsupportedOperationException.ra('Add is not supported on keys');
  }
  e2(element) {
...
class HashMapValuesDefault extends AbstractMutableCollection {
  ...
  fa(element) {
    throw UnsupportedOperationException.ra('Add is not supported on values');
  }
  e2(element) {
    return this.fa(element);
  }
...
class HashSet extends AbstractMutableSet {
  ...
  static ua() {
    return this.ta(InternalHashMap.p9());
  }
  static va(elements) {
    var $this = this.ta(InternalHashMap.wa(elements.k2()));
    var _iterator__ex2g4s = elements.l1();
    while (_iterator__ex2g4s.m1()) {
      var element = _iterator__ex2g4s.n1();
  ...
  static xa(initialCapacity, loadFactor) {
    return this.ta(InternalHashMap.r9(initialCapacity, loadFactor));
  }
...
class Itr {
  constructor(map) {
    ...
    this.ob_1 = 0;
    this.pb_1 = -1;
    this.qb_1 = this.nb_1.m9_1;
    this.rb();
  }
  rb() {
    while (this.ob_1 < this.nb_1.k9_1 && this.nb_1.h9_1[this.ob_1] < 0) {
      this.ob_1 = this.ob_1 + 1 | 0;
    }
  }
  m1() {
    return this.ob_1 < this.nb_1.k9_1;
  }
  j7() {
    this.sb();
    // Inline function 'kotlin.check' call
    ...
    this.nb_1.da();
    removeEntryAt(this.nb_1, this.pb_1);
    this.pb_1 = -1;
    this.qb_1 = this.nb_1.m9_1;
  }
  sb() {
    if (!(this.nb_1.m9_1 === this.qb_1))
      throw ConcurrentModificationException.tb();
  }
}
class KeysItr extends Itr {
  n1() {
    this.sb();
    if (this.ob_1 >= this.nb_1.k9_1)
      throw NoSuchElementException.n7();
    var tmp = this;
    var _unary__edvuaz = this.ob_1;
    this.ob_1 = _unary__edvuaz + 1 | 0;
    tmp.pb_1 = _unary__edvuaz;
    var result = this.nb_1.f9_1[this.pb_1];
    this.rb();
    return result;
  }
}
class ValuesItr extends Itr {
  n1() {
    ...
    this.ob_1 = _unary__edvuaz + 1 | 0;
    tmp.pb_1 = _unary__edvuaz;
    var result = ensureNotNull(this.nb_1.g9_1)[this.pb_1];
    this.rb();
    return result;
  }
}
class EntriesItr extends Itr {
  n1() {
    ...
    this.ob_1 = _unary__edvuaz + 1 | 0;
    tmp.pb_1 = _unary__edvuaz;
    var result = new EntryRef(this.nb_1, this.pb_1);
    this.rb();
    return result;
  }
  gc() {
    ...
    tmp.pb_1 = _unary__edvuaz;
    // Inline function 'kotlin.hashCode' call
    var tmp0_safe_receiver = this.nb_1.f9_1[this.pb_1];
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : hashCode(tmp0_safe_receiver);
    var tmp_0 = tmp1_elvis_lhs == null ? 0 : tmp1_elvis_lhs;
    // Inline function 'kotlin.hashCode' call
    var tmp0_safe_receiver_0 = ensureNotNull(this.nb_1.g9_1)[this.pb_1];
  ...
  hc(sb) {
    ...
    this.ob_1 = _unary__edvuaz + 1 | 0;
    tmp.pb_1 = _unary__edvuaz;
    var key = this.nb_1.f9_1[this.pb_1];
    if (equals(key, this.nb_1))
      sb.i1('(this Map)');
    else
      sb.o1(key);
    sb.k1(_Char___init__impl__6a9atx(61));
    var value = ensureNotNull(this.nb_1.g9_1)[this.pb_1];
    if (equals(value, this.nb_1))
      sb.i1('(this Map)');
    else
      sb.o1(value);
    this.rb();
...
class EntryRef {
  constructor(map, index) {
    this.cb_1 = map;
    this.db_1 = index;
    this.eb_1 = this.cb_1.m9_1;
  }
  c3() {
    checkForComodification(this);
    return this.cb_1.f9_1[this.db_1];
  }
  d3() {
    checkForComodification(this);
    return ensureNotNull(this.cb_1.g9_1)[this.db_1];
  }
  equals(other) {
    var tmp;
    var tmp_0;
...
class InternalHashMap {
  constructor(keysArray, valuesArray, presenceArray, hashArray, maxProbeDistance, length) {
    return new.target.ic(keysArray, valuesArray, presenceArray, hashArray, maxProbeDistance, length);
  }
  static ic(keysArray, valuesArray, presenceArray, hashArray, maxProbeDistance, length) {
    var $this = createThis(this);
    $this.f9_1 = keysArray;
  ...
  static wa(initialCapacity) {
    return this.ic(arrayOfUninitializedElements(initialCapacity), null, new Int32Array(initialCapacity), new Int32Array(computeHashSize(Companion_instance_8, initialCapacity)), 2, 0);
  }
  static u9(original) {
    var $this = this.wa(original.k2());
    $this.q4(original);
    return $this;
  }
  ...
  hashCode() {
    ...
    var it = this.ka();
    while (it.m1()) {
      result = result + it.gc() | 0;
    }
    return result;
  }
  toString() {
    var sb = StringBuilder.kc(2 + imul_0(this.n9_1, 3) | 0);
    sb.i1('{');
    var i = 0;
    var it = this.ka();
    while (it.m1()) {
...
class EmptyHolder {
  constructor() {
    ...
    var tmp = this;
    // Inline function 'kotlin.also' call
    var this_0 = InternalHashMap.wa(0);
    this_0.jc();
    tmp.mc_1 = LinkedHashMap.nc(this_0);
  }
}
class LinkedHashMap extends HashMap {
  ...
  k5() {
    ...
    if (this.k2() > 0) {
      ...
      // Inline function 'kotlin.js.unsafeCast' call
      // Inline function 'kotlin.js.asDynamic' call
      tmp = EmptyHolder_getInstance().mc_1;
    }
    return tmp;
  }
  i7() {
...
class EmptyHolder_0 {
  constructor() {
    ...
    var this_0 = InternalHashMap.wa(0);
    this_0.jc();
    tmp.qc_1 = LinkedHashSet.rc(this_0);
  }
}
class LinkedHashSet extends HashSet {
  ...
  static sc(initialCapacity, loadFactor) {
    var $this = this.xa(initialCapacity, loadFactor);
    init_kotlin_collections_LinkedHashSet($this);
    return $this;
  }
  static c2(initialCapacity) {
    return this.sc(initialCapacity, 1.0);
  }
  static rc(internalMap) {
    var $this = this.ta(internalMap);
    init_kotlin_collections_LinkedHashSet($this);
    return $this;
  }
  k5() {
    this.s2_1.jc();
    return this.k2() > 0 ? this : EmptyHolder_getInstance_0().qc_1;
  }
  i7() {
    return this.s2_1.da();
  }
...
class AtomicReference {
  ...
  vc(expectedValue, newValue) {
    if (!(this.tc_1 === expectedValue))
      return false;
    this.tc_1 = newValue;
    return true;
  }
  toString() {
    return toString_0(this.tc_1);
  }
}
class AtomicInt {
  constructor(value) {
...
class BufferedOutput extends BaseOutput {
  ...
  zc(message) {
    ...
    // Inline function 'kotlin.io.String' call
    var tmp1_elvis_lhs = message == null ? null : toString_1(message);
    tmp.dd_1 = tmp_0 + (tmp1_elvis_lhs == null ? 'null' : tmp1_elvis_lhs);
  }
}
class BufferedOutputToConsoleLog extends BufferedOutput {
  zc(message) {
    ...
    var i = s.lastIndexOf('\n', 0);
    if (i >= 0) {
      this.dd_1 = this.dd_1 + substring(s, 0, i);
      this.ed();
      s = substring_0(s, i + 1 | 0);
    }
    this.dd_1 = this.dd_1 + s;
  }
  ed() {
    console.log(this.dd_1);
    this.dd_1 = '';
  }
}
class Continuation {}
...
class InterceptedCoroutine {
  ...
  qd() {
    ...
    var tmp;
    if (tmp0_elvis_lhs == null) {
      var tmp1_safe_receiver = this.fd().rd(Key_instance);
      var tmp2_elvis_lhs = tmp1_safe_receiver == null ? null : tmp1_safe_receiver.sd(this);
      // Inline function 'kotlin.also' call
  ...
  pd() {
    ...
    if (!(intercepted == null) && !(intercepted === this)) {
      ensureNotNull(this.fd().rd(Key_instance)).td(intercepted);
    }
...
class GeneratorCoroutineImpl extends InterceptedCoroutine {
  constructor(resultContinuation) {
    ...
    tmp_0.ld_1 = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.fd();
  }
  fd() {
    return ensureNotNull(this.ld_1);
  }
  md(result) {
    var suspended = get_COROUTINE_SUSPENDED();
    var e = Result__exceptionOrNull_impl_p6xea9(result);
    var stepResult = e == null ? this.kd_1.next(_Result___get_value__impl__bjfvqg(result)) : this.kd_1.throw(e);
    ...
    $l$loop_0: while (!done) {
      try {
        ...
        var e_0 = $p;
        var nextStep = this.kd_1.throw(e_0);
      ...
      if (value === suspended)
        break $l$loop_0;
      var nextStep_0 = this.kd_1.next(value);
  ...
  nd(result, $super) {
    ...
    return $super === VOID ? this.md(result) : $super.md.call(this, new Result(result));
  }
  gd(result) {
    var exception = null;
    var tmp;
...
class SafeContinuation {
  constructor(delegate, initialResult) {
    return new.target.wd(delegate, initialResult);
  }
  static wd(delegate, initialResult) {
    var $this = createThis(this);
    $this.ud_1 = delegate;
    $this.vd_1 = initialResult;
    return $this;
  }
  static xd(delegate) {
    return this.wd(delegate, CoroutineSingletons_UNDECIDED_getInstance());
  }
  fd() {
    return this.ud_1.fd();
  }
  hd(result) {
    ...
    if (cur === CoroutineSingletons_UNDECIDED_getInstance()) {
      this.vd_1 = _Result___get_value__impl__bjfvqg(result);
    } else if (cur === get_COROUTINE_SUSPENDED()) {
      this.vd_1 = CoroutineSingletons_RESUMED_getInstance();
      this.ud_1.hd(result);
    } else
      throw IllegalStateException.o('Already resumed');
  }
  yd() {
    if (this.vd_1 === CoroutineSingletons_UNDECIDED_getInstance()) {
      this.vd_1 = get_COROUTINE_SUSPENDED();
      return get_COROUTINE_SUSPENDED();
    }
    var result = this.vd_1;
    var tmp;
...
class PrimitiveKClassImpl extends KClassImpl {
  constructor(jClass, givenSimpleName, isInstanceFunction) {
    super();
    this.qf_1 = jClass;
    this.rf_1 = givenSimpleName;
    this.sf_1 = isInstanceFunction;
  }
  of() {
    return this.qf_1;
  }
  equals(other) {
    if (!(other instanceof PrimitiveKClassImpl))
      return false;
    return super.equals(other) && this.rf_1 === other.rf_1;
  }
  f1() {
    return this.rf_1;
  }
  pf(value) {
    return this.sf_1(value);
  }
}
class NothingKClassImpl extends KClassImpl {
  ...
  of() {
    throw UnsupportedOperationException.ra("There's no native JS class for Nothing type");
  }
  equals(other) {
    return other === this;
  }
...
class SimpleKClassImpl extends KClassImpl {
  constructor(jClass) {
    ...
    var tmp = this;
    // Inline function 'kotlin.js.asDynamic' call
    var tmp0_safe_receiver = this.uf_1.$metadata$;
    // Inline function 'kotlin.js.unsafeCast' call
    tmp.vf_1 = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.simpleName;
  }
  of() {
    return this.uf_1;
  }
  ...
  pf(value) {
    return jsIsType(value, this.uf_1);
  }
}
class KProperty1 {}
...
class CharacterCodingException extends Exception {
  constructor(message) {
    return new.target.bh(message);
  }
  static bh(message) {
    var $this = this.pe(message);
    captureStack($this, $this.ah_1);
    return $this;
  }
  static ch() {
    return this.bh(null);
...
class StringBuilder {
  ...
  eh(value, startIndex, endIndex) {
    return this.fh(value == null ? 'null' : value, startIndex, endIndex);
  }
  o1(value) {
    this.g1_1 = this.g1_1 + toString_0(value);
    return this;
  ...
  fh(value, startIndex, endIndex) {
    var stringCsq = toString_1(value);
    Companion_instance_10.nh(startIndex, endIndex, stringCsq.length);
...
class Companion_9 {
  constructor() {
    ...
    this.oh_1 = new RegExp('[\\\\^$*+?.()|[\\]{}]', 'g');
    this.ph_1 = new RegExp('[\\\\$]', 'g');
    this.qh_1 = new RegExp('\\$', 'g');
  }
  rh(literal) {
    // Inline function 'kotlin.text.nativeReplace' call
    var pattern = this.oh_1;
    // Inline function 'kotlin.js.asDynamic' call
    return literal.replace(pattern, '\\$&');
  }
  sh(literal) {
    // Inline function 'kotlin.text.nativeReplace' call
    var pattern = this.qh_1;
    // Inline function 'kotlin.js.asDynamic' call
    return literal.replace(pattern, '$$$$');
  }
}
class Regex {
  constructor(pattern, options) {
    return new.target.zh(pattern, options);
  }
  static zh(pattern, options) {
    Companion_getInstance_9();
    var $this = createThis(this);
    $this.th_1 = pattern;
    $this.uh_1 = toSet_0(options);
    $this.vh_1 = new RegExp(pattern, toFlags(options, 'gu'));
    $this.wh_1 = null;
    $this.xh_1 = null;
    return $this;
  }
  static ai(pattern, option) {
    Companion_getInstance_9();
    return this.zh(pattern, setOf(option));
  }
  static bi(pattern) {
    Companion_getInstance_9();
    return this.zh(pattern, emptySet());
  }
  ci(input) {
    reset(this.vh_1);
    return this.vh_1.test(toString_1(input));
  }
  yh(input, startIndex) {
    if (startIndex < 0 || startIndex > charSequenceLength(input)) {
      throw IndexOutOfBoundsException.a3('Start index out of bounds: ' + startIndex + ', input length: ' + charSequenceLength(input));
    }
    return findNext(this.vh_1, toString_1(input), startIndex, this.vh_1);
  }
  di(input, startIndex, $super) {
  ...
  gi(input, replacement) {
    if (!contains_10(replacement, _Char___init__impl__6a9atx(92)) && !contains_10(replacement, _Char___init__impl__6a9atx(36))) {
      ...
      // Inline function 'kotlin.text.nativeReplace' call
      var pattern = this.vh_1;
      // Inline function 'kotlin.js.asDynamic' call
      return tmp0.replace(pattern, replacement);
    }
    return this.hi(input, Regex$replace$lambda(replacement));
  }
  hi(input, transform) {
    var match = this.di(input);
    if (match == null)
    ...
    do {
      ...
      sb.eh(input, lastStart, foundMatch.ii().mi());
      sb.j2(transform(foundMatch));
      lastStart = foundMatch.ii().ni() + 1 | 0;
      match = foundMatch.n1();
    }
     while (lastStart < length && !(match == null));
    if (lastStart < length) {
      sb.eh(input, lastStart, length);
    }
    return sb.toString();
  }
  oi(input, limit) {
    ...
    while (_iterator__ex2g4s.m1()) {
      ...
      result.e2(toString_1(charSequenceSubSequence(input, lastStart, match.ii().mi())));
      lastStart = match.ii().ni() + 1 | 0;
    }
...
class MatchGroup {
  ...
  toString() {
    return 'MatchGroup(value=' + this.si_1 + ')';
  }
  hashCode() {
    return getStringHashCode(this.si_1);
  }
  equals(other) {
    if (this === other)
      return true;
...
class findNext$1$groups$1 extends AbstractCollection {
  constructor($match, this$0) {
    return new.target.ej($match, this$0);
  }
  static ej($match, this$0, $box) {
    if ($box === VOID)
      $box = {};
    $box.vi_1 = $match;
    $box.wi_1 = this$0;
  ...
  m2(index) {
    ...
    // Inline function 'kotlin.js.asDynamic' call
    var tmp0_safe_receiver = this.vi_1[index];
    var tmp;
    if (tmp0_safe_receiver == null) {
      tmp = null;
    } else {
  ...
  ui(name) {
    // Inline function 'kotlin.js.asDynamic' call
    var tmp0_elvis_lhs = this.vi_1.groups;
    var tmp;
    if (tmp0_elvis_lhs == null) {
    ...
    var groups = tmp;
    if (!hasOwnPrototypeProperty(this.wi_1, groups, name))
...
class findNext$1$groupValues$1 extends AbstractList {
  ...
  k2() {
    return this.fj_1.length;
  }
  m2(index) {
    // Inline function 'kotlin.js.get' call
    // Inline function 'kotlin.js.asDynamic' call
    var tmp0_elvis_lhs = this.fj_1[index];
...
class findNext$1 {
  constructor($range, $match, $nextPattern, $input) {
    this.aj_1 = $range;
    this.bj_1 = $match;
    this.cj_1 = $nextPattern;
    this.dj_1 = $input;
    this.xi_1 = $range;
    var tmp = this;
    tmp.yi_1 = findNext$1$groups$1.ej($match, this);
    this.zi_1 = null;
  }
  ii() {
    return this.xi_1;
  ...
  hj() {
    if (this.zi_1 == null) {
      var tmp = this;
      tmp.zi_1 = findNext$1$groupValues$1.gj(this.bj_1);
    }
    return ensureNotNull(this.zi_1);
  }
  n1() {
    return findNext(this.cj_1, this.dj_1, this.aj_1.j1() ? advanceToNextCharacter(this, this.aj_1.mi()) : this.aj_1.ni() + 1 | 0, this.cj_1);
  }
}
...
class AbstractIterator {
  ...
  n1() {
    ...
    if (this.zj_1 === 2 || !tryToComputeNext(this)) {
      throw NoSuchElementException.n7();
    }
    this.zj_1 = 0;
    return this.ak_1;
...
class SubList_0 extends AbstractList {
  constructor(list, fromIndex, toIndex) {
    return new.target.hk(list, fromIndex, toIndex);
  }
  static hk(list, fromIndex, toIndex) {
    var $this = this.z6();
    $this.ek_1 = list;
    $this.fk_1 = fromIndex;
    $this.gk_1 = 0;
    Companion_instance_10.s6($this.fk_1, toIndex, $this.ek_1.k2());
    $this.gk_1 = toIndex - $this.fk_1 | 0;
    return $this;
  }
  m2(index) {
    Companion_instance_10.c7(index, this.gk_1);
    return this.ek_1.m2(this.fk_1 + index | 0);
  }
  k2() {
    return this.gk_1;
  }
  d4(fromIndex, toIndex) {
    Companion_instance_10.s6(fromIndex, toIndex, this.gk_1);
    return SubList_0.hk(this.ek_1, this.fk_1 + fromIndex | 0, this.fk_1 + toIndex | 0);
  }
}
class IteratorImpl_0 {
  ...
  n1() {
    ...
    return this.jk_1.m2(_unary__edvuaz);
  }
}
class ListIteratorImpl_0 extends IteratorImpl_0 {
  constructor($outer, index, $box) {
    ...
    $box.mk_1 = $outer;
    super($outer, $box);
    Companion_instance_10.t7(index, this.mk_1.k2());
    this.ik_1 = index;
  }
  u7() {
    return this.ik_1 > 0;
  ...
  w7() {
    if (!this.u7())
      throw NoSuchElementException.n7();
    this.ik_1 = this.ik_1 - 1 | 0;
    return this.mk_1.m2(this.ik_1);
  }
  x7() {
    return this.ik_1 - 1 | 0;
  }
}
class Companion_10 {
  constructor() {
...
class AbstractMap$keys$1$iterator$1 {
  constructor($entryIterator) {
    this.nk_1 = $entryIterator;
  }
  m1() {
    return this.nk_1.m1();
  }
  n1() {
    return this.nk_1.n1().c3();
  }
}
class AbstractMap$values$1$iterator$1 {
  constructor($entryIterator) {
    this.ok_1 = $entryIterator;
  }
  m1() {
    return this.ok_1.m1();
  }
  n1() {
    return this.ok_1.n1().d3();
  }
}
class Companion_11 {}
...
class AbstractMap$keys$1 extends AbstractSet {
  constructor(this$0) {
    return new.target.qk(this$0);
  }
  static qk(this$0, $box) {
    if ($box === VOID)
      $box = {};
    $box.pk_1 = this$0;
    return this.rk($box);
  ...
  l1() {
    var entryIterator = this.pk_1.b3().l1();
...
class AbstractMap$values$1 extends AbstractCollection {
  constructor(this$0) {
    return new.target.tk(this$0);
  }
  static tk(this$0, $box) {
    if ($box === VOID)
      $box = {};
    $box.sk_1 = this$0;
    return this.h7($box);
  ...
  l1() {
    var entryIterator = this.sk_1.b3().l1();
...
class ArrayDeque extends AbstractMutableList {
  ...
  static al() {
    ...
    $this.wk_1 = Companion_getInstance_13().yk_1;
    return $this;
  }
  j1() {
    return this.xk_1 === 0;
  ...
  bl() {
    ...
    if (this.j1()) {
      ...
      var internalIndex = positiveMod(this, this.vk_1 + index | 0);
      tmp = this.wk_1[internalIndex];
    }
    return tmp;
  }
  cl(element) {
    registerModification_0(this);
    ensureCapacity_0(this, this.xk_1 + 1 | 0);
    this.vk_1 = decremented(this, this.vk_1);
    this.wk_1[this.vk_1] = element;
  ...
  dl(element) {
    ...
    // Inline function 'kotlin.collections.ArrayDeque.internalIndex' call
    var index = this.xk_1;
    tmp[positiveMod(this, this.vk_1 + index | 0)] = element;
    this.xk_1 = this.xk_1 + 1 | 0;
  }
  el() {
    if (this.j1())
    ...
    registerModification_0(this);
    // Inline function 'kotlin.collections.ArrayDeque.internalGet' call
    var internalIndex = this.vk_1;
    var element = this.wk_1[internalIndex];
    this.wk_1[this.vk_1] = null;
    this.vk_1 = incremented(this, this.vk_1);
    this.xk_1 = this.xk_1 - 1 | 0;
    return element;
  }
  fl() {
    return this.j1() ? null : this.el();
  }
  gl() {
    if (this.j1())
      throw NoSuchElementException.i2('ArrayDeque is empty.');
    ...
    // Inline function 'kotlin.collections.ArrayDeque.internalIndex' call
    var index = get_lastIndex_3(this);
    var internalLastIndex = positiveMod(this, this.vk_1 + index | 0);
    // Inline function 'kotlin.collections.ArrayDeque.internalGet' call
    var element = this.wk_1[internalLastIndex];
    this.wk_1[internalLastIndex] = null;
    this.xk_1 = this.xk_1 - 1 | 0;
    return element;
  }
  e2(element) {
  ...
  l4(index, element) {
    Companion_instance_10.t7(index, this.xk_1);
    if (index === this.xk_1) {
      this.dl(element);
      return Unit_instance;
    } else if (index === 0) {
    ...
    // Inline function 'kotlin.collections.ArrayDeque.internalIndex' call
    var internalIndex = positiveMod(this, this.vk_1 + index | 0);
    if (index < (this.xk_1 + 1 | 0) >> 1) {
      var decrementedInternalIndex = decremented(this, internalIndex);
      var decrementedHead = decremented(this, this.vk_1);
      if (decrementedInternalIndex >= this.vk_1) {
        this.wk_1[decrementedHead] = this.wk_1[this.vk_1];
        var tmp0 = this.wk_1;
        var tmp2 = this.wk_1;
        var tmp4 = this.vk_1;
        var tmp6 = this.vk_1 + 1 | 0;
        // Inline function 'kotlin.collections.copyInto' call
        var endIndex = decrementedInternalIndex + 1 | 0;
        arrayCopy(tmp0, tmp2, tmp4, tmp6, endIndex);
      } else {
        var tmp0_0 = this.wk_1;
        var tmp2_0 = this.wk_1;
        var tmp4_0 = this.vk_1 - 1 | 0;
        var tmp6_0 = this.vk_1;
        // Inline function 'kotlin.collections.copyInto' call
        var endIndex_0 = this.wk_1.length;
        arrayCopy(tmp0_0, tmp2_0, tmp4_0, tmp6_0, endIndex_0);
        this.wk_1[this.wk_1.length - 1 | 0] = this.wk_1[0];
        var tmp0_1 = this.wk_1;
        var tmp2_1 = this.wk_1;
        // Inline function 'kotlin.collections.copyInto' call
        var endIndex_1 = decrementedInternalIndex + 1 | 0;
        arrayCopy(tmp0_1, tmp2_1, 0, 1, endIndex_1);
      }
      this.wk_1[decrementedInternalIndex] = element;
      this.vk_1 = decrementedHead;
    } else {
      // Inline function 'kotlin.collections.ArrayDeque.internalIndex' call
      var index_0 = this.xk_1;
      var tail = positiveMod(this, this.vk_1 + index_0 | 0);
      if (internalIndex < tail) {
        var tmp0_2 = this.wk_1;
        var tmp2_2 = this.wk_1;
        // Inline function 'kotlin.collections.copyInto' call
        var destinationOffset = internalIndex + 1 | 0;
        arrayCopy(tmp0_2, tmp2_2, destinationOffset, internalIndex, tail);
      } else {
        var tmp0_3 = this.wk_1;
        // Inline function 'kotlin.collections.copyInto' call
        var destination = this.wk_1;
        arrayCopy(tmp0_3, destination, 1, 0, tail);
        this.wk_1[0] = this.wk_1[this.wk_1.length - 1 | 0];
        var tmp0_4 = this.wk_1;
        var tmp2_3 = this.wk_1;
        var tmp4_1 = internalIndex + 1 | 0;
        // Inline function 'kotlin.collections.copyInto' call
        var endIndex_2 = this.wk_1.length - 1 | 0;
        arrayCopy(tmp0_4, tmp2_3, tmp4_1, internalIndex, endIndex_2);
      }
      this.wk_1[internalIndex] = element;
    }
    this.xk_1 = this.xk_1 + 1 | 0;
  }
  l2(elements) {
    if (elements.j1())
      return false;
    registerModification_0(this);
    ensureCapacity_0(this, this.xk_1 + elements.k2() | 0);
    // Inline function 'kotlin.collections.ArrayDeque.internalIndex' call
    var index = this.xk_1;
    var tmp$ret$0 = positiveMod(this, this.vk_1 + index | 0);
  ...
  g4(index, elements) {
    ...
    if (index < (this.xk_1 + 1 | 0) >> 1) {
      var shiftedHead = this.vk_1 - elementsSize | 0;
      if (internalIndex >= this.vk_1) {
        if (shiftedHead >= 0) {
          var tmp0 = this.wk_1;
          var tmp2 = this.wk_1;
          var tmp4 = shiftedHead;
          // Inline function 'kotlin.collections.copyInto' call
          var startIndex = this.vk_1;
          arrayCopy(tmp0, tmp2, tmp4, startIndex, internalIndex);
        } else {
          shiftedHead = shiftedHead + this.wk_1.length | 0;
          var elementsToShift = internalIndex - this.vk_1 | 0;
          var shiftToBack = this.wk_1.length - shiftedHead | 0;
          if (shiftToBack >= elementsToShift) {
            var tmp0_0 = this.wk_1;
            var tmp2_0 = this.wk_1;
            var tmp4_0 = shiftedHead;
            // Inline function 'kotlin.collections.copyInto' call
            var startIndex_0 = this.vk_1;
            ...
            var tmp6 = this.vk_1;
            // Inline function 'kotlin.collections.copyInto' call
            var endIndex = this.vk_1 + shiftToBack | 0;
            arrayCopy(tmp0_1, tmp2_1, tmp4_1, tmp6, endIndex);
            var tmp0_2 = this.wk_1;
            var tmp2_2 = this.wk_1;
            // Inline function 'kotlin.collections.copyInto' call
            var startIndex_1 = this.vk_1 + shiftToBack | 0;
        ...
        if (elementsSize >= internalIndex) {
          var tmp0_4 = this.wk_1;
          var tmp2_4 = this.wk_1;
          // Inline function 'kotlin.collections.copyInto' call
          var destinationOffset = this.wk_1.length - elementsSize | 0;
          arrayCopy(tmp0_4, tmp2_4, destinationOffset, 0, internalIndex);
        } else {
          var tmp0_5 = this.wk_1;
          var tmp2_5 = this.wk_1;
          // Inline function 'kotlin.collections.copyInto' call
          var destinationOffset_0 = this.wk_1.length - elementsSize | 0;
          arrayCopy(tmp0_5, tmp2_5, destinationOffset_0, 0, elementsSize);
          var tmp0_6 = this.wk_1;
          // Inline function 'kotlin.collections.copyInto' call
          var destination = this.wk_1;
          arrayCopy(tmp0_6, destination, 0, elementsSize, internalIndex);
        }
      }
      this.vk_1 = shiftedHead;
      ...
      if (internalIndex < tail) {
        if ((tail + elementsSize | 0) <= this.wk_1.length) {
          var tmp0_7 = this.wk_1;
          // Inline function 'kotlin.collections.copyInto' call
          var destination_0 = this.wk_1;
          arrayCopy(tmp0_7, destination_0, shiftedInternalIndex, internalIndex, tail);
        } else {
          if (shiftedInternalIndex >= this.wk_1.length) {
            var tmp0_8 = this.wk_1;
            var tmp2_6 = this.wk_1;
            // Inline function 'kotlin.collections.copyInto' call
            var destinationOffset_1 = shiftedInternalIndex - this.wk_1.length | 0;
            arrayCopy(tmp0_8, tmp2_6, destinationOffset_1, internalIndex, tail);
          } else {
            var shiftToFront = (tail + elementsSize | 0) - this.wk_1.length | 0;
            var tmp0_9 = this.wk_1;
            var tmp2_7 = this.wk_1;
            // Inline function 'kotlin.collections.copyInto' call
            var startIndex_2 = tail - shiftToFront | 0;
            arrayCopy(tmp0_9, tmp2_7, 0, startIndex_2, tail);
            var tmp0_10 = this.wk_1;
            var tmp2_8 = this.wk_1;
            // Inline function 'kotlin.collections.copyInto' call
        ...
        var tmp0_11 = this.wk_1;
        // Inline function 'kotlin.collections.copyInto' call
        var destination_1 = this.wk_1;
        arrayCopy(tmp0_11, destination_1, elementsSize, 0, tail);
        if (shiftedInternalIndex >= this.wk_1.length) {
          var tmp0_12 = this.wk_1;
          var tmp2_9 = this.wk_1;
          var tmp4_3 = shiftedInternalIndex - this.wk_1.length | 0;
          // Inline function 'kotlin.collections.copyInto' call
          var endIndex_2 = this.wk_1.length;
          arrayCopy(tmp0_12, tmp2_9, tmp4_3, internalIndex, endIndex_2);
        } else {
          var tmp0_13 = this.wk_1;
          var tmp2_10 = this.wk_1;
          var tmp6_1 = this.wk_1.length - elementsSize | 0;
          // Inline function 'kotlin.collections.copyInto' call
          var endIndex_3 = this.wk_1.length;
          arrayCopy(tmp0_13, tmp2_10, 0, tmp6_1, endIndex_3);
          var tmp0_14 = this.wk_1;
          var tmp2_11 = this.wk_1;
          // Inline function 'kotlin.collections.copyInto' call
          var endIndex_4 = this.wk_1.length - elementsSize | 0;
  ...
  m2(index) {
    Companion_instance_10.c7(index, this.xk_1);
    // Inline function 'kotlin.collections.ArrayDeque.internalIndex' call
    // Inline function 'kotlin.collections.ArrayDeque.internalGet' call
    var internalIndex = positiveMod(this, this.vk_1 + index | 0);
    return this.wk_1[internalIndex];
  }
  k4(index, element) {
    Companion_instance_10.c7(index, this.xk_1);
    // Inline function 'kotlin.collections.ArrayDeque.internalIndex' call
    var internalIndex = positiveMod(this, this.vk_1 + index | 0);
    // Inline function 'kotlin.collections.ArrayDeque.internalGet' call
    var oldElement = this.wk_1[internalIndex];
    this.wk_1[internalIndex] = element;
    return oldElement;
  }
  n2(element) {
  ...
  u2(element) {
    // Inline function 'kotlin.collections.ArrayDeque.internalIndex' call
    var index = this.xk_1;
    var tail = positiveMod(this, this.vk_1 + index | 0);
    if (this.vk_1 < tail) {
      var inductionVariable = this.vk_1;
      if (inductionVariable < tail)
        do {
          var index_0 = inductionVariable;
          inductionVariable = inductionVariable + 1 | 0;
          if (equals(element, this.wk_1[index_0]))
            return index_0 - this.vk_1 | 0;
        }
      ...
      if (tmp) {
        var inductionVariable_0 = this.vk_1;
        var last = this.wk_1.length;
        if (inductionVariable_0 < last)
          do {
            var index_1 = inductionVariable_0;
            inductionVariable_0 = inductionVariable_0 + 1 | 0;
            if (equals(element, this.wk_1[index_1]))
              return index_1 - this.vk_1 | 0;
          }
        ...
        if (inductionVariable_1 < tail)
          do {
            ...
            if (equals(element, this.wk_1[index_2]))
              return (index_2 + this.wk_1.length | 0) - this.vk_1 | 0;
          }
      ...
      if (tmp) {
        ...
        if (0 <= inductionVariable_0)
          do {
            ...
            inductionVariable_0 = inductionVariable_0 + -1 | 0;
            if (equals(element, this.wk_1[index_1]))
              return (index_1 + this.wk_1.length | 0) - this.vk_1 | 0;
          }
           while (0 <= inductionVariable_0);
        var inductionVariable_1 = get_lastIndex_0(this.wk_1);
        var last_0 = this.vk_1;
        if (last_0 <= inductionVariable_1)
          do {
            var index_2 = inductionVariable_1;
            inductionVariable_1 = inductionVariable_1 + -1 | 0;
            if (equals(element, this.wk_1[index_2]))
              return index_2 - this.vk_1 | 0;
          }
  ...
  m4(index) {
    ...
    // Inline function 'kotlin.collections.ArrayDeque.internalGet' call
    var element = this.wk_1[internalIndex];
    if (index < this.xk_1 >> 1) {
      if (internalIndex >= this.vk_1) {
        var tmp0 = this.wk_1;
        var tmp2 = this.wk_1;
        var tmp4 = this.vk_1 + 1 | 0;
        // Inline function 'kotlin.collections.copyInto' call
        var startIndex = this.vk_1;
        arrayCopy(tmp0, tmp2, tmp4, startIndex, internalIndex);
      } else {
        ...
        var tmp6 = this.vk_1;
        // Inline function 'kotlin.collections.copyInto' call
        var endIndex = this.wk_1.length - 1 | 0;
      ...
      var internalLastIndex = positiveMod(this, this.vk_1 + index_0 | 0);
      if (internalIndex <= internalLastIndex) {
        ...
        // Inline function 'kotlin.collections.copyInto' call
        var endIndex_1 = this.wk_1.length;
  ...
  h4(elements) {
    ...
    $l$block: {
      ...
      if (this.vk_1 < tail) {
        ...
        if (inductionVariable < tail)
          do {
            var index_0 = inductionVariable;
            inductionVariable = inductionVariable + 1 | 0;
            var element = this.wk_1[index_0];
            if (!elements.n2(element)) {
              var tmp_0 = this.wk_1;
           ...
           while (inductionVariable < tail);
        fill_0(this.wk_1, null, newTail, tail);
      } else {
        var inductionVariable_0 = this.vk_1;
        var last = this.wk_1.length;
        if (inductionVariable_0 < last)
          do {
            var index_1 = inductionVariable_0;
            inductionVariable_0 = inductionVariable_0 + 1 | 0;
            var element_0 = this.wk_1[index_1];
            this.wk_1[index_1] = null;
            if (!elements.n2(element_0)) {
              var tmp_1 = this.wk_1;
        ...
        if (inductionVariable_1 < tail)
          do {
            var index_2 = inductionVariable_1;
            inductionVariable_1 = inductionVariable_1 + 1 | 0;
            var element_1 = this.wk_1[index_2];
            this.wk_1[index_2] = null;
            if (!elements.n2(element_1)) {
              this.wk_1[newTail] = element_1;
      ...
      if (modified) {
        registerModification_0(this);
        this.xk_1 = negativeMod(this, newTail - this.vk_1 | 0);
      }
      tmp$ret$0 = modified;
    }
    return tmp$ret$0;
  ...
  j4() {
    ...
    if (!this.j1()) {
      ...
      var index = this.xk_1;
      var tail = positiveMod(this, this.vk_1 + index | 0);
      nullifyNonEmpty(this, this.vk_1, tail);
    }
    this.vk_1 = 0;
    this.xk_1 = 0;
  }
  hl(array) {
    var tmp = array.length >= this.xk_1 ? array : arrayOfNulls(array, this.xk_1);
    ...
    if (this.vk_1 < tail) {
      ...
      if (!this.j1()) {
        ...
        var tmp6 = this.vk_1;
        // Inline function 'kotlin.collections.copyInto' call
        var endIndex = this.wk_1.length;
        arrayCopy(tmp0_0, dest, 0, tmp6, endIndex);
        var tmp0_1 = this.wk_1;
        // Inline function 'kotlin.collections.copyInto' call
        var destinationOffset = this.wk_1.length - this.vk_1 | 0;
        arrayCopy(tmp0_1, dest, destinationOffset, 0, tail);
      }
    }
    var tmp_0 = terminateCollectionToArray(this.xk_1, dest);
  ...
  c9() {
    ...
    return this.hl(tmp$ret$0);
  }
  toArray() {
    return this.c9();
  }
  e8(fromIndex, toIndex) {
    Companion_instance_10.s6(fromIndex, toIndex, this.xk_1);
    var length = toIndex - fromIndex | 0;
    if (length === 0)
      return Unit_instance;
    else if (length === this.xk_1) {
      this.j4();
      return Unit_instance;
    } else if (length === 1) {
      this.m4(fromIndex);
    ...
    registerModification_0(this);
    if (fromIndex < (this.xk_1 - toIndex | 0)) {
      removeRangeShiftPreceding(this, fromIndex, toIndex);
      var newHead = positiveMod(this, this.vk_1 + length | 0);
      nullifyNonEmpty(this, this.vk_1, newHead);
      this.vk_1 = newHead;
    } else {
...
class EmptyList {
  constructor() {
    this.il_1 = -7390468764508069838n;
  }
  equals(other) {
    var tmp;
    if (!(other == null) ? isInterface(other, KtList) : false) {
...
class ArrayAsCollection {
  ...
  k2() {
    return this.nl_1.length;
  }
  j1() {
    // Inline function 'kotlin.collections.isEmpty' call
    return this.nl_1.length === 0;
  }
  pl(element) {
    return contains_0(this.nl_1, element);
  }
  n2(element) {
    if (!true)
      return false;
    return this.pl(element);
  }
  l1() {
    return arrayIterator(this.nl_1);
  }
}
class IndexedValue {
  ...
  toString() {
    return 'IndexedValue(index=' + this.ql_1 + ', value=' + toString_0(this.rl_1) + ')';
  }
  hashCode() {
    var result = this.ql_1;
    result = imul_0(result, 31) + (this.rl_1 == null ? 0 : hashCode(this.rl_1)) | 0;
    return result;
  }
  equals(other) {
    if (this === other)
...
class IndexingIterable {
  constructor(iteratorFactory) {
    this.ul_1 = iteratorFactory;
  }
  l1() {
    return new IndexingIterator(this.ul_1());
  }
}
class IndexingIterator {
  ...
  n1() {
    var _unary__edvuaz = this.wl_1;
    this.wl_1 = _unary__edvuaz + 1 | 0;
    return new IndexedValue(checkIndexOverflow(_unary__edvuaz), this.vl_1.n1());
  }
}
class MapWithDefault {}
class EmptyMap {
  constructor() {
    this.yl_1 = 8246714829545688274n;
  }
  equals(other) {
    var tmp;
    if (!(other == null) ? isInterface(other, KtMap) : false) {
...
class ReversedList$listIterator$1 {
  constructor(this$0, $index) {
    this.lm_1 = this$0;
    this.km_1 = this$0.gm_1.q2(reversePositionIndex(this$0, $index));
  }
  m1() {
    return this.km_1.u7();
  }
  ...
  v7() {
    return reverseIteratorIndex(this.lm_1, this.km_1.x7());
  }
  w7() {
    return this.km_1.n1();
  }
  x7() {
    return reverseIteratorIndex(this.lm_1, this.km_1.v7());
  }
  j7() {
    return this.km_1.j7();
  }
...
class ReversedList extends AbstractMutableList {
  ...
  m2(index) {
    return this.gm_1.m2(reverseElementIndex(this, index));
  }
  j4() {
    return this.gm_1.j4();
  }
  m4(index) {
    return this.gm_1.m4(reverseElementIndex(this, index));
  }
  mm(index, element) {
    return this.gm_1.k4(reverseElementIndex(this, index), element);
  }
  k4(index, element) {
    return this.mm(index, element);
  }
  nm(index, element) {
    this.gm_1.l4(reversePositionIndex(this, index), element);
  }
  l4(index, element) {
    return this.nm(index, element);
  }
  l1() {
    return this.q2(0);
  }
...
class ReversedListReadOnly$listIterator$1 {
  constructor(this$0, $index) {
    this.pm_1 = this$0;
    this.om_1 = this$0.im_1.q2(reversePositionIndex(this$0, $index));
  }
  m1() {
    return this.om_1.u7();
  }
  ...
  v7() {
    return reverseIteratorIndex(this.pm_1, this.om_1.x7());
  }
  w7() {
    return this.om_1.n1();
  }
  x7() {
    return reverseIteratorIndex(this.pm_1, this.om_1.v7());
  }
}
class ReversedListReadOnly extends AbstractList {
  constructor(delegate) {
    return new.target.jm(delegate);
  }
  static jm(delegate) {
    var $this = this.z6();
    $this.im_1 = delegate;
  ...
  m2(index) {
    return this.im_1.m2(reverseElementIndex(this, index));
  }
  l1() {
    return this.q2(0);
  }
...
class SequenceBuilderIterator extends SequenceScope {
  ...
  m1() {
    while (true) {
      ...
      this.rm_1 = 5;
      var step = ensureNotNull(this.um_1);
      this.um_1 = null;
      // Inline function 'kotlin.coroutines.resume' call
      // Inline function 'kotlin.Companion.success' call
  ...
  n1() {
    switch (this.rm_1) {
      ...
      case 2:
        this.rm_1 = 1;
        return ensureNotNull(this.tm_1).n1();
      case 3:
        this.rm_1 = 0;
...
class sequence$$inlined$Sequence$1 {
  ...
  l1() {
    return iterator(this.wm_1);
  }
}
class TransformingSequence$iterator$1 {
  constructor(this$0) {
    this.ym_1 = this$0;
    this.xm_1 = this$0.zm_1.l1();
  }
  n1() {
    return this.ym_1.an_1(this.xm_1.n1());
  }
  m1() {
    return this.xm_1.m1();
  }
...
class TakeSequence$iterator$1 {
  constructor(this$0) {
    this.bn_1 = this$0.en_1;
    this.cn_1 = this$0.dn_1.l1();
  }
  n1() {
    if (this.bn_1 === 0)
      throw NoSuchElementException.n7();
  ...
  m1() {
    return this.bn_1 > 0 && this.cn_1.m1();
  }
}
class TakeSequence {
  constructor(sequence, count) {
    ...
    // Inline function 'kotlin.require' call
    if (!(this.en_1 >= 0)) {
      var message = 'count must be non-negative, but was ' + this.en_1 + '.';
      throw IllegalArgumentException.a2(toString_1(message));
    }
  }
  k3(n) {
    return n >= this.en_1 ? this : new TakeSequence(this.dn_1, n);
  }
  l1() {
...
class GeneratorSequence {
  constructor(getInitialValue, getNextValue) {
    this.pn_1 = getInitialValue;
    this.qn_1 = getNextValue;
  }
  l1() {
...
class EmptySet {
  constructor() {
    this.rn_1 = 3406603774387020532n;
  }
  equals(other) {
    var tmp;
    if (!(other == null) ? isInterface(other, KtSet) : false) {
...
class RingBuffer$iterator$1 extends AbstractIterator {
  constructor(this$0, $box) {
    ...
    $box.wn_1 = this$0;
    super($box);
    this.un_1 = this$0.ao_1;
    this.vn_1 = this$0.zn_1;
  }
  bk() {
    if (this.un_1 === 0) {
      this.dk();
    } else {
      this.ck(this.wn_1.xn_1[this.vn_1]);
      var tmp = this;
      var tmp0 = this.wn_1;
      // Inline function 'kotlin.collections.RingBuffer.forward' call
      tmp.vn_1 = (this.vn_1 + 1 | 0) % tmp0.yn_1 | 0;
...
class RingBuffer extends AbstractList {
  constructor(buffer, filledSize) {
    return new.target.bo(buffer, filledSize);
  }
  static bo(buffer, filledSize) {
    var $this = this.z6();
    $this.xn_1 = buffer;
    // Inline function 'kotlin.require' call
    if (!(filledSize >= 0)) {
    ...
    // Inline function 'kotlin.require' call
    if (!(filledSize <= $this.xn_1.length)) {
      var message_0 = 'ring buffer filled size: ' + filledSize + ' cannot be larger than the buffer size: ' + $this.xn_1.length;
      throw IllegalArgumentException.a2(toString_1(message_0));
    }
    $this.yn_1 = $this.xn_1.length;
    $this.zn_1 = 0;
    $this.ao_1 = filledSize;
    return $this;
  }
  static co(capacity) {
    // Inline function 'kotlin.arrayOfNulls' call
    var tmp$ret$0 = Array(capacity);
    return this.bo(tmp$ret$0, 0);
  }
  k2() {
    return this.ao_1;
  }
  m2(index) {
    Companion_instance_10.c7(index, this.ao_1);
    // Inline function 'kotlin.collections.RingBuffer.forward' call
    var tmp$ret$0 = (this.zn_1 + index | 0) % this.yn_1 | 0;
    return this.xn_1[tmp$ret$0];
  }
  do() {
    return this.ao_1 === this.yn_1;
  }
  l1() {
  ...
  hl(array) {
    var tmp;
    if (array.length < this.ao_1) {
      // Inline function 'kotlin.collections.copyOf' call
      var newSize = this.ao_1;
    ...
    var widx = 0;
    var idx = this.zn_1;
    while (widx < size && idx < this.yn_1) {
      result[widx] = this.xn_1[idx];
      widx = widx + 1 | 0;
      idx = idx + 1 | 0;
    }
    idx = 0;
  ...
  eo(maxCapacity) {
    var newCapacity = coerceAtMost_0((this.yn_1 + (this.yn_1 >> 1) | 0) + 1 | 0, maxCapacity);
    var tmp;
    if (this.zn_1 === 0) {
      // Inline function 'kotlin.collections.copyOf' call
      ...
      tmp = this.hl(tmp$ret$1);
    }
    var newBuffer = tmp;
    return RingBuffer.bo(newBuffer, this.ao_1);
  }
  fo(element) {
    if (this.do()) {
    ...
    // Inline function 'kotlin.collections.RingBuffer.forward' call
    var tmp$ret$0 = (this.zn_1 + this.ao_1 | 0) % this.yn_1 | 0;
    this.xn_1[tmp$ret$0] = element;
  ...
  go(n) {
    ...
    // Inline function 'kotlin.require' call
    if (!(n <= this.ao_1)) {
      var message_0 = "n shouldn't be greater than the buffer size: n = " + n + ', size = ' + this.ao_1;
      throw IllegalArgumentException.a2(toString_1(message_0));
    }
    if (n > 0) {
      var start = this.zn_1;
      // Inline function 'kotlin.collections.RingBuffer.forward' call
      var end = (start + n | 0) % this.yn_1 | 0;
      if (start > end) {
        fill_0(this.xn_1, null, start, this.yn_1);
        fill_0(this.xn_1, null, 0, end);
      } else {
        fill_0(this.xn_1, null, start, end);
      }
      this.zn_1 = end;
      this.ao_1 = this.ao_1 - n | 0;
    }
  }
}
class Key {}
...
function plus(context) {
  ...
  if (context === EmptyCoroutineContext_instance) {
    ...
    tmp = context.mo(this, CoroutineContext$plus$lambda);
  }
  return tmp;
}
class Element {}
...
function minusKey_0(key) {
  if (key instanceof AbstractCoroutineContextKey) {
    return key.ko(this.c3()) && !(key.jo(this) == null) ? EmptyCoroutineContext_instance : this;
  }
...
class CombinedContext {
  ...
  rd(key) {
    var cur = this;
    while (true) {
      var tmp0_safe_receiver = cur.qo_1.rd(key);
      if (tmp0_safe_receiver == null)
        null;
      else {
        // Inline function 'kotlin.let' call
  ...
  mo(initial, operation) {
    return operation(this.po_1.mo(initial, operation), this.qo_1);
  }
  lo(key) {
    if (this.qo_1.rd(key) == null)
      null;
    else {
      // Inline function 'kotlin.let' call
      return this.po_1;
    }
    var newLeft = this.po_1.lo(key);
    return newLeft === this.po_1 ? this : newLeft === EmptyCoroutineContext_instance ? this.qo_1 : new CombinedContext(newLeft, this.qo_1);
  }
  equals(other) {
    var tmp;
    if (this === other) {
  ...
  hashCode() {
    return hashCode(this.po_1) + hashCode(this.qo_1) | 0;
  }
  toString() {
    return '[' + this.mo('', CombinedContext$toString$lambda) + ']';
  }
}
class AbstractCoroutineContextKey {
  ...
  jo(element) {
    return this.ho_1(element);
  }
  ko(key) {
    return key === this || this.io_1 === key;
  }
}
...
class EnumEntriesList extends AbstractList {
  ...
  k2() {
    return this.so_1.length;
  }
  m2(index) {
    Companion_instance_10.c7(index, this.so_1.length);
    return this.so_1[index];
  }
  uo(element) {
    if (element === null)
      return false;
    var target = getOrNull(this.so_1, element.s1_1);
    return target === element;
  }
  n2(element) {
    if (!(element instanceof Enum))
      return false;
    return this.uo(element instanceof Enum ? element : THROW_CCE());
  }
  vo(element) {
    if (element === null)
      return -1;
    var ordinal = element.s1_1;
    var target = getOrNull(this.so_1, ordinal);
    return target === element ? ordinal : -1;
  }
  u2(element) {
    if (!(element instanceof Enum))
      return -1;
    return this.vo(element instanceof Enum ? element : THROW_CCE());
  }
  wo(element) {
    return this.vo(element);
  }
  b4(element) {
    if (!(element instanceof Enum))
      return -1;
    return this.wo(element instanceof Enum ? element : THROW_CCE());
  }
}
...
class Base64 {
  constructor(isUrlSafe, isMimeScheme, mimeLineLength, paddingOption) {
    Default_getInstance();
    this.xo_1 = isUrlSafe;
    this.yo_1 = isMimeScheme;
    this.zo_1 = mimeLineLength;
    this.ap_1 = paddingOption;
    // Inline function 'kotlin.require' call
    // Inline function 'kotlin.require' call
    if (!(!this.xo_1 || !this.yo_1)) {
      var message = 'Failed requirement.';
      throw IllegalArgumentException.a2(toString_1(message));
    }
    this.bp_1 = this.zo_1 / 4 | 0;
  }
  sp(option) {
    return this.ap_1.equals(option) ? this : new Base64(this.xo_1, this.yo_1, this.zo_1, option);
  }
  tp(source, startIndex, endIndex) {
    // Inline function 'kotlin.io.encoding.platformEncodeToString' call
    var byteResult = this.zp(source, startIndex, endIndex);
    return this.eq(byteResult);
  }
  up(source, startIndex, endIndex, $super) {
    startIndex = startIndex === VOID ? 0 : startIndex;
    endIndex = endIndex === VOID ? source.length : endIndex;
    return $super === VOID ? this.tp(source, startIndex, endIndex) : $super.tp.call(this, source, startIndex, endIndex);
  }
  vp(source, startIndex, endIndex) {
    this.fq(source.length, startIndex, endIndex);
    var decodeSize = this.cq(source, startIndex, endIndex);
  ...
  wp(source, startIndex, endIndex, $super) {
    startIndex = startIndex === VOID ? 0 : startIndex;
    endIndex = endIndex === VOID ? source.length : endIndex;
    return $super === VOID ? this.vp(source, startIndex, endIndex) : $super.vp.call(this, source, startIndex, endIndex);
  }
  xp(source, startIndex, endIndex) {
    // Inline function 'kotlin.io.encoding.platformCharsToBytes' call
    var byteSource = this.dq(source, startIndex, endIndex);
    return this.wp(byteSource);
  }
  yp(source, startIndex, endIndex, $super) {
    startIndex = startIndex === VOID ? 0 : startIndex;
    endIndex = endIndex === VOID ? charSequenceLength(source) : endIndex;
    return $super === VOID ? this.xp(source, startIndex, endIndex) : $super.xp.call(this, source, startIndex, endIndex);
  }
  zp(source, startIndex, endIndex) {
    this.fq(source.length, startIndex, endIndex);
    var encodeSize = this.bq(endIndex - startIndex | 0);
    var destination = new Int8Array(encodeSize);
    this.aq(source, destination, 0, startIndex, endIndex);
    return destination;
  }
  aq(source, destination, destinationOffset, startIndex, endIndex) {
    this.fq(source.length, startIndex, endIndex);
    checkDestinationBounds(this, destination.length, destinationOffset, this.bq(endIndex - startIndex | 0));
    var encodeMap = this.xo_1 ? get_base64UrlEncodeMap() : get_base64EncodeMap();
    var sourceIndex = startIndex;
    var destinationIndex = destinationOffset;
    var groupsPerLine = this.yo_1 ? this.bp_1 : 2147483647;
    while ((sourceIndex + 2 | 0) < endIndex) {
      ...
      if (groups === groupsPerLine && !(sourceIndex === endIndex)) {
        ...
        destination[_unary__edvuaz_6] = Default_getInstance().op_1[0];
        var _unary__edvuaz_7 = destinationIndex;
        destinationIndex = _unary__edvuaz_7 + 1 | 0;
        destination[_unary__edvuaz_7] = Default_getInstance().op_1[1];
      }
    }
  ...
  bq(sourceSize) {
    ...
    if (this.yo_1) {
      size = size + imul_0((size - 1 | 0) / this.zo_1 | 0, 2) | 0;
    }
    if (size < 0) {
      throw IllegalArgumentException.a2('Input is too big');
    }
  ...
  dq(source, startIndex, endIndex) {
    this.fq(charSequenceLength(source), startIndex, endIndex);
  ...
  eq(source) {
    var stringBuilder = StringBuilder.kc(source.length);
    var inductionVariable = 0;
  ...
  fq(sourceSize, startIndex, endIndex) {
    Companion_instance_10.nh(startIndex, endIndex, sourceSize);
  }
}
class Default extends Base64 {
  constructor() {
    ...
    tmp.op_1 = new Int8Array([tmp_0, toByte(tmp$ret$1)]);
    this.pp_1 = new Base64(true, false, -1, PaddingOption_PRESENT_getInstance());
    this.qp_1 = new Base64(false, true, 76, PaddingOption_PRESENT_getInstance());
    this.rp_1 = new Base64(false, true, 64, PaddingOption_PRESENT_getInstance());
  }
}
class Random {
  static iq() {
  ...
  kq(from, until) {
    ...
    if (n > 0 || n === -2147483648) {
      ...
      if ((n & (-n | 0)) === n) {
        ...
        tmp = this.jq(bitCount);
      } else {
        var v;
        do {
          var bits = this.cm() >>> 1 | 0;
          v = bits % n | 0;
        }
  ...
  lq() {
    var tmp0 = shiftLeft(fromInt_0(this.cm()), 32);
    // Inline function 'kotlin.Long.plus' call
    var other = this.cm();
    return add_0(tmp0, fromInt_0(other));
  }
  mq(until) {
    return this.nq(0n, until);
  }
  nq(from, until) {
    ...
    if (n > 0n) {
      ...
      if ((n & negate_0(n)) === n) {
        ...
        if (!(nLow === 0)) {
          ...
          tmp = fromInt_0(this.jq(bitCount)) & 4294967295n;
        } else if (nHigh === 1) {
          tmp = fromInt_0(this.cm()) & 4294967295n;
        } else {
          var bitCount_0 = fastLog2(nHigh);
          tmp = add_0(shiftLeft(fromInt_0(this.jq(bitCount_0)), 32), fromInt_0(this.cm()) & 4294967295n);
        }
        rnd = tmp;
      } else {
        var v;
        $l$1: do {
          $l$0: do {
            var bits = shiftRightUnsigned(this.lq(), 1);
            v = modulo(bits, n);
          }
           while (false);
  ...
  pq(array, fromIndex, toIndex) {
    ...
    var vr = this.jq(imul_0(remainder, 8));
    var inductionVariable_0 = 0;
  ...
  oq(array) {
    return this.pq(array, 0, array.length);
  }
}
class Default_0 extends Random {
  constructor() {
    return new.target.hq();
  }
  static hq() {
    Default_instance_0 = null;
    var $this = this.iq();
    Default_instance_0 = $this;
    $this.gq_1 = defaultPlatformRandom();
    return $this;
  }
  jq(bitCount) {
    return this.gq_1.jq(bitCount);
  }
  cm() {
    return this.gq_1.cm();
  }
  v2(until) {
    return this.gq_1.v2(until);
  }
  kq(from, until) {
    return this.gq_1.kq(from, until);
  }
  lq() {
    return this.gq_1.lq();
  }
  mq(until) {
    return this.gq_1.mq(until);
  }
  nq(from, until) {
    return this.gq_1.nq(from, until);
  }
  oq(array) {
    return this.gq_1.oq(array);
  }
  pq(array, fromIndex, toIndex) {
    return this.gq_1.pq(array, fromIndex, toIndex);
  }
}
class Companion_14 {
  constructor() {
...
class XorWowRandom extends Random {
  constructor(x, y, z, w, v, addend) {
    return new.target.yq(x, y, z, w, v, addend);
  }
  static yq(x, y, z, w, v, addend) {
    var $this = this.iq();
    $this.qq_1 = x;
    $this.rq_1 = y;
    $this.sq_1 = z;
  ...
  static wq(seed1, seed2) {
    return this.yq(seed1, seed2, 0, 0, ~seed1, seed1 << 10 ^ (seed2 >>> 4 | 0));
  }
  cm() {
    var t = this.qq_1;
    t = t ^ (t >>> 2 | 0);
    ...
    t = t ^ t << 1 ^ v0 ^ v0 << 4;
    this.uq_1 = t;
    this.vq_1 = this.vq_1 + 362437 | 0;
    return t + this.vq_1 | 0;
  }
  jq(bitCount) {
    return takeUpperBits(this.cm(), bitCount);
  }
}
class Companion_15 {
  constructor() {
...
function contains(value) {
  return compareTo(value, this.mi()) >= 0 && compareTo(value, this.ni()) <= 0;
}
class IntRange extends IntProgression {
  ...
  j3(value) {
    return this.zq(typeof value === 'number' ? value : THROW_CCE());
  }
  j1() {
...
class Companion_16 {
  constructor() {
    ...
    this.ar_1 = new CharRange(_Char___init__impl__6a9atx(1), _Char___init__impl__6a9atx(0));
  }
}
class CharProgression {
  constructor(start, endInclusive, step) {
    ...
    tmp.gr_1 = numberToChar(getProgressionLastElement(tmp_0, tmp$ret$1, step));
    this.hr_1 = step;
  }
  l1() {
    return new CharProgressionIterator(this.fr_1, this.gr_1, this.hr_1);
  }
  j1() {
    return this.hr_1 > 0 ? Char__compareTo_impl_ypi4mb(this.fr_1, this.gr_1) > 0 : Char__compareTo_impl_ypi4mb(this.fr_1, this.gr_1) < 0;
  }
  equals(other) {
    var tmp;
    if (other instanceof CharProgression) {
      tmp = this.j1() && other.j1() || (this.fr_1 === other.fr_1 && this.gr_1 === other.gr_1 && this.hr_1 === other.hr_1);
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    ...
    if (this.j1()) {
      ...
      var tmp$ret$1 = Char__toInt_impl_vasixd(this_1);
      tmp = imul_0(31, tmp_0 + tmp$ret$1 | 0) + this.hr_1 | 0;
    }
    return tmp;
  }
  toString() {
    return this.hr_1 > 0 ? toString(this.fr_1) + '..' + toString(this.gr_1) + ' step ' + this.hr_1 : toString(this.fr_1) + ' downTo ' + toString(this.gr_1) + ' step ' + (-this.hr_1 | 0);
  }
}
class CharRange extends CharProgression {
  ...
  mi() {
    return new Char(this.er());
  }
  ir() {
    return this.gr_1;
  }
  ni() {
    return new Char(this.ir());
  }
  jr(value) {
    return Char__compareTo_impl_ypi4mb(this.fr_1, value) <= 0 && Char__compareTo_impl_ypi4mb(value, this.gr_1) <= 0;
  }
  j3(value) {
    return this.jr(value instanceof Char ? value.n3_1 : THROW_CCE());
  }
  j1() {
    return Char__compareTo_impl_ypi4mb(this.fr_1, this.gr_1) > 0;
  }
  equals(other) {
    var tmp;
    if (other instanceof CharRange) {
      tmp = this.j1() && other.j1() || (this.fr_1 === other.fr_1 && this.gr_1 === other.gr_1);
    } else {
      tmp = false;
    }
    return tmp;
  ...
  toString() {
    return toString(this.fr_1) + '..' + toString(this.gr_1);
  }
}
class IntProgressionIterator extends IntIterator {
  constructor(first, last, step) {
    ...
    this.kr_1 = step;
    this.lr_1 = last;
    this.mr_1 = this.kr_1 > 0 ? first <= last : first >= last;
    this.nr_1 = this.mr_1 ? first : this.lr_1;
  }
  m1() {
    return this.mr_1;
  }
  cm() {
    ...
    if (value === this.lr_1) {
      ...
      this.nr_1 = this.nr_1 + this.kr_1 | 0;
    }
    return value;
  }
}
class CharProgressionIterator extends CharIterator {
  constructor(first, last, step) {
    ...
    var tmp = this;
    // Inline function 'kotlin.code' call
    tmp.pr_1 = Char__toInt_impl_vasixd(last);
    this.qr_1 = this.or_1 > 0 ? Char__compareTo_impl_ypi4mb(first, last) <= 0 : Char__compareTo_impl_ypi4mb(first, last) >= 0;
    var tmp_0 = this;
    var tmp_1;
    if (this.qr_1) {
      // Inline function 'kotlin.code' call
  ...
  em() {
    ...
    if (value === this.pr_1) {
      ...
      this.rr_1 = this.rr_1 + this.or_1 | 0;
    }
...
class Companion_19 {
  constructor() {
    ...
    this.wf_1 = new KTypeProjection(null, null);
  }
  xf() {
    return this.wf_1;
  }
...
class KTypeProjection {
  constructor(variance, type) {
    ...
    this.tr_1 = type;
    // Inline function 'kotlin.require' call
    if (!(this.sr_1 == null === (this.tr_1 == null))) {
      var message = this.sr_1 == null ? 'Star projection must have no type specified.' : 'The projection variance ' + this.sr_1.toString() + ' requires type to be specified.';
      throw IllegalArgumentException.a2(toString_1(message));
    }
  }
  toString() {
    var tmp0_subject = this.sr_1;
    var tmp;
    switch (tmp0_subject == null ? -1 : tmp0_subject.s1_1) {
      case -1:
        ...
        break;
      case 0:
        tmp = toString_0(this.tr_1);
        break;
      case 1:
        tmp = 'in ' + toString_0(this.tr_1);
        break;
      case 2:
        tmp = 'out ' + toString_0(this.tr_1);
        break;
      default:
        noWhenBranchMatchedException();
        break;
  ...
  hashCode() {
    var result = this.sr_1 == null ? 0 : this.sr_1.hashCode();
    result = imul_0(result, 31) + (this.tr_1 == null ? 0 : hashCode(this.tr_1)) | 0;
    return result;
  }
  equals(other) {
    if (this === other)
...
class Companion_20 {
  constructor() {
    ...
    this.ps_1 = new BytesHexFormat(2147483647, 2147483647, '  ', '', '', '');
  }
}
class Companion_21 {
  constructor() {
    Companion_instance_21 = this;
    this.qs_1 = new NumberHexFormat('', '', false, 1);
  }
}
class BytesHexFormat {
  constructor(bytesPerLine, bytesPerGroup, groupSeparator, byteSeparator, bytePrefix, byteSuffix) {
    Companion_getInstance_20();
    this.gs_1 = bytesPerLine;
    this.hs_1 = bytesPerGroup;
    this.is_1 = groupSeparator;
    this.js_1 = byteSeparator;
    this.ks_1 = bytePrefix;
    this.ls_1 = byteSuffix;
    this.ms_1 = (this.gs_1 === 2147483647 && this.hs_1 === 2147483647);
    var tmp = this;
    var tmp_0;
    var tmp_1;
    ...
    if (charSequenceLength(this_0) === 0) {
      // Inline function 'kotlin.text.isEmpty' call
      var this_1 = this.ls_1;
      tmp_1 = charSequenceLength(this_1) === 0;
    } else {
      tmp_1 = false;
    }
    if (tmp_1) {
      tmp_0 = this.js_1.length <= 1;
    } else {
      tmp_0 = false;
    }
    tmp.ns_1 = tmp_0;
    this.os_1 = isCaseSensitive(this.is_1) || isCaseSensitive(this.js_1) || isCaseSensitive(this.ks_1) || isCaseSensitive(this.ls_1);
  }
  toString() {
    // Inline function 'kotlin.text.buildString' call
    // Inline function 'kotlin.apply' call
    ...
    // Inline function 'kotlin.text.appendLine' call
    this.rs(this_0, '    ').k1(_Char___init__impl__6a9atx(10));
    this_0.i1(')');
    return this_0.toString();
  }
  rs(sb, indent) {
    // Inline function 'kotlin.text.appendLine' call
    // Inline function 'kotlin.text.appendLine' call
    sb.i1(indent).i1('bytesPerLine = ').hh(this.gs_1).i1(',').k1(_Char___init__impl__6a9atx(10));
    // Inline function 'kotlin.text.appendLine' call
    // Inline function 'kotlin.text.appendLine' call
    sb.i1(indent).i1('bytesPerGroup = ').hh(this.hs_1).i1(',').k1(_Char___init__impl__6a9atx(10));
    // Inline function 'kotlin.text.appendLine' call
    // Inline function 'kotlin.text.appendLine' call
    sb.i1(indent).i1('groupSeparator = "').i1(this.is_1).i1('",').k1(_Char___init__impl__6a9atx(10));
    // Inline function 'kotlin.text.appendLine' call
    // Inline function 'kotlin.text.appendLine' call
    sb.i1(indent).i1('byteSeparator = "').i1(this.js_1).i1('",').k1(_Char___init__impl__6a9atx(10));
    // Inline function 'kotlin.text.appendLine' call
    // Inline function 'kotlin.text.appendLine' call
    sb.i1(indent).i1('bytePrefix = "').i1(this.ks_1).i1('",').k1(_Char___init__impl__6a9atx(10));
    sb.i1(indent).i1('byteSuffix = "').i1(this.ls_1).i1('"');
    return sb;
  }
}
class NumberHexFormat {
  constructor(prefix, suffix, removeLeadingZeros, minLength) {
    ...
    tmp.ds_1 = tmp_0;
    this.es_1 = (this.ds_1 && this.cs_1 === 1);
    this.fs_1 = isCaseSensitive(this.zr_1) || isCaseSensitive(this.as_1);
  }
  toString() {
    // Inline function 'kotlin.text.buildString' call
    // Inline function 'kotlin.apply' call
  ...
  rs(sb, indent) {
    // Inline function 'kotlin.text.appendLine' call
    // Inline function 'kotlin.text.appendLine' call
    sb.i1(indent).i1('prefix = "').i1(this.zr_1).i1('",').k1(_Char___init__impl__6a9atx(10));
    // Inline function 'kotlin.text.appendLine' call
    // Inline function 'kotlin.text.appendLine' call
    sb.i1(indent).i1('suffix = "').i1(this.as_1).i1('",').k1(_Char___init__impl__6a9atx(10));
    var tmp0 = sb.i1(indent).i1('removeLeadingZeros = ').gh(this.bs_1);
    // Inline function 'kotlin.text.appendLine' call
    var value = _Char___init__impl__6a9atx(44);
    // Inline function 'kotlin.text.appendLine' call
    tmp0.k1(value).k1(_Char___init__impl__6a9atx(10));
    sb.i1(indent).i1('minLength = ').hh(this.cs_1);
    return sb;
  }
}
class Companion_22 {
  constructor() {
    ...
    this.ur_1 = new HexFormat(false, Companion_getInstance_20().ps_1, Companion_getInstance_21().qs_1);
    this.vr_1 = new HexFormat(true, Companion_getInstance_20().ps_1, Companion_getInstance_21().qs_1);
  }
}
class HexFormat {
  ...
  toString() {
    ...
    // Inline function 'kotlin.text.appendLine' call
    // Inline function 'kotlin.text.appendLine' call
    this_0.i1('    upperCase = ').gh(this.wr_1).i1(',').k1(_Char___init__impl__6a9atx(10));
    // Inline function 'kotlin.text.appendLine' call
    this_0.i1('    bytes = BytesHexFormat(').k1(_Char___init__impl__6a9atx(10));
    // Inline function 'kotlin.text.appendLine' call
    this.xr_1.rs(this_0, '        ').k1(_Char___init__impl__6a9atx(10));
    // Inline function 'kotlin.text.appendLine' call
    this_0.i1('    ),').k1(_Char___init__impl__6a9atx(10));
    // Inline function 'kotlin.text.appendLine' call
    this_0.i1('    number = NumberHexFormat(').k1(_Char___init__impl__6a9atx(10));
    // Inline function 'kotlin.text.appendLine' call
    this.yr_1.rs(this_0, '        ').k1(_Char___init__impl__6a9atx(10));
    // Inline function 'kotlin.text.appendLine' call
    this_0.i1('    )').k1(_Char___init__impl__6a9atx(10));
    this_0.i1(')');
    return this_0.toString();
...
class LinesIterator {
  ...
  m1() {
    ...
    var _delimiterStartIndex = charSequenceLength(this.vs_1);
    var inductionVariable = this.xs_1;
    var last = charSequenceLength(this.vs_1);
    if (inductionVariable < last)
      $l$loop: do {
        var idx = inductionVariable;
        inductionVariable = inductionVariable + 1 | 0;
        var c = charSequenceGet(this.vs_1, idx);
        if (c === _Char___init__impl__6a9atx(10) || c === _Char___init__impl__6a9atx(13)) {
          _delimiterLength = c === _Char___init__impl__6a9atx(13) && (idx + 1 | 0) < charSequenceLength(this.vs_1) && charSequenceGet(this.vs_1, idx + 1 | 0) === _Char___init__impl__6a9atx(10) ? 2 : 1;
       ...
       while (inductionVariable < last);
    this.ws_1 = 1;
    this.zs_1 = _delimiterLength;
    this.ys_1 = _delimiterStartIndex;
    return true;
  }
  n1() {
    if (!this.m1()) {
    ...
    this.ws_1 = 0;
    var lastIndex = this.ys_1;
    var firstIndex = this.xs_1;
    this.xs_1 = this.ys_1 + this.zs_1 | 0;
...
class DelimitedRangesSequence$iterator$1 {
  constructor(this$0) {
    this.ft_1 = this$0;
    this.at_1 = -1;
    this.bt_1 = coerceIn_0(this$0.ht_1, 0, charSequenceLength(this$0.gt_1));
    this.ct_1 = this.bt_1;
    this.dt_1 = null;
    this.et_1 = 0;
  }
...
class DelimitedRangesSequence {
  constructor(input, startIndex, limit, getNextMatch) {
    this.gt_1 = input;
    this.ht_1 = startIndex;
    this.it_1 = limit;
    this.jt_1 = getNextMatch;
  }
  l1() {
...
class lineSequence$$inlined$Sequence$1 {
  constructor($this_lineSequence) {
    this.kt_1 = $this_lineSequence;
  }
  l1() {
    return new LinesIterator(this.kt_1);
  }
}
class System {
  lt() {
...
class Companion_23 {
  constructor() {
    ...
    this.mt_1 = _Duration___init__impl__kdtzql(0n);
    this.nt_1 = durationOfMillis(4611686018427387903n);
    this.ot_1 = durationOfMillis(-4611686018427387903n);
    this.pt_1 = 9223372036854759646n;
    this.qt_1 = _Duration___init__impl__kdtzql(9223372036854759646n);
  }
  rt(rawValue) {
    // Inline function 'kotlin.apply' call
    var this_0 = new Duration(_Duration___init__impl__kdtzql(rawValue));
    var $this$apply = this_0.st_1;
    ...
    if (true) {
      if (isInNanos($this$apply)) {
        ...
        if (!(-4611686018426999999n <= containsArg ? containsArg <= 4611686018426999999n : false))
          throw AssertionError.mf(_get_value__a43j40_0($this$apply).toString() + ' ns is out of nanoseconds range');
      } else {
        var tmp;
        ...
        if (tmp)
          throw AssertionError.mf(_get_value__a43j40_0($this$apply).toString() + ' ms is out of milliseconds range');
        var containsArg_0 = _get_value__a43j40_0($this$apply);
        if (-4611686018426n <= containsArg_0 ? containsArg_0 <= 4611686018426n : false)
          throw AssertionError.mf(_get_value__a43j40_0($this$apply).toString() + ' ms is denormalized');
      }
    }
    return this_0.st_1;
  }
  tt(value) {
    ...
    try {
      ...
      // Inline function 'kotlin.check' call
      if (!!(this_0.st_1 === Companion_getInstance_23().qt_1)) {
      ...
      if ($p instanceof IllegalArgumentException) {
        var e = $p;
        throw IllegalArgumentException.me("Invalid ISO duration string format: '" + value + "'.", e);
      } else {
        throw $p;
      }
    }
...
class Duration {
  ...
  ut(other) {
    return Duration__compareTo_impl_pchp0f(this.st_1, other);
  }
  d(other) {
    return Duration__compareTo_impl_pchp0f_0(this, other);
  }
  toString() {
    return Duration__toString_impl_8d916b(this.st_1);
  }
  hashCode() {
    return Duration__hashCode_impl_u4exz6(this.st_1);
  }
  equals(other) {
    return Duration__equals_impl_ygj6w6(this.st_1, other);
  }
}
class Companion_24 {
  constructor() {
    Companion_instance_24 = this;
    this.vt_1 = new LongParser(4611686018427387903n, true);
    this.wt_1 = new LongParser(9223372036854775807n, false);
  }
}
class LongParser {
  constructor(overflowLimit, allowSign) {
    Companion_getInstance_24();
    this.xt_1 = overflowLimit;
    this.yt_1 = allowSign;
    var tmp = this;
    // Inline function 'kotlin.Long.div' call
    var this_0 = this.xt_1;
    tmp.zt_1 = divide(this_0, fromInt_0(10));
    var tmp_0 = this;
    // Inline function 'kotlin.Long.rem' call
    var this_1 = this.xt_1;
    tmp_0.au_1 = modulo(this_1, fromInt_0(10));
  }
}
...
class Companion_25 {
  constructor() {
    ...
    this.sj_1 = new Instant(-31557014167219200n, 0);
    this.tj_1 = new Instant(31556889864403199n, 999999999);
  }
  uj(epochMilliseconds) {
    ...
    return epochSeconds < -31557014167219200n ? this.sj_1 : epochSeconds > 31556889864403199n ? this.tj_1 : this.bu(epochSeconds, nanosecondsOfSecond);
  }
  cu(epochSeconds, nanosecondAdjustment) {
    // Inline function 'kotlin.floorDiv' call
    ...
    if ((epochSeconds ^ sum) < 0n && (epochSeconds ^ b) >= 0n) {
      return epochSeconds > 0n ? Companion_getInstance_25().tj_1 : Companion_getInstance_25().sj_1;
    }
    var seconds = sum;
    var tmp;
  ...
  du(epochSeconds, nanosecondAdjustment, $super) {
    nanosecondAdjustment = nanosecondAdjustment === VOID ? 0n : nanosecondAdjustment;
    return $super === VOID ? this.cu(epochSeconds, nanosecondAdjustment) : $super.cu.call(this, epochSeconds, nanosecondAdjustment);
  }
  bu(epochSeconds, nanosecondAdjustment) {
    return this.cu(epochSeconds, fromInt_0(nanosecondAdjustment));
  }
  eu(input) {
    return parseIso(input).fu();
  }
}
class Instant {
  constructor(epochSeconds, nanosecondsOfSecond) {
    Companion_getInstance_25();
    this.gu_1 = epochSeconds;
    this.hu_1 = nanosecondsOfSecond;
    var containsArg = this.gu_1;
    // Inline function 'kotlin.require' call
  ...
  iu() {
    if (this.gu_1 >= 0n) {
      ...
      // Inline function 'kotlin.time.safeAddOrElse' call
      var b = fromInt_0(this.hu_1 / 1000000 | 0);
      ...
      // Inline function 'kotlin.time.safeAddOrElse' call
      var b_0 = fromInt_0((this.hu_1 / 1000000 | 0) - 1000 | 0);
  ...
  ju(duration) {
    ...
    if ((a ^ sum) < 0n && (a ^ tmp0) >= 0n) {
      return Duration__isPositive_impl_tvkkt2(duration) ? Companion_getInstance_25().tj_1 : Companion_getInstance_25().sj_1;
    }
    var newEpochSeconds = sum;
    var nanoAdjustment = this.hu_1 + nanosecondsToAdd | 0;
    return Companion_getInstance_25().bu(newEpochSeconds, nanoAdjustment);
  }
  ku(other) {
    var s = compareTo(this.gu_1, other.gu_1);
    if (!(s === 0)) {
      return s;
    }
    return compareTo(this.hu_1, other.hu_1);
  }
  d(other) {
    return this.ku(other instanceof Instant ? other : THROW_CCE());
  }
  equals(other) {
    var tmp;
    if (this === other) {
      ...
      if (other instanceof Instant) {
        tmp_1 = this.gu_1 === other.gu_1;
      } else {
        tmp_1 = false;
      }
      if (tmp_1) {
        tmp_0 = this.hu_1 === other.hu_1;
      } else {
        tmp_0 = false;
      }
      tmp = tmp_0;
  ...
  hashCode() {
    return getBigIntHashCode(this.gu_1) + imul_0(51, this.hu_1) | 0;
  }
  toString() {
...
class Success {
  constructor(epochSeconds, nanosecondsOfSecond) {
    this.tu_1 = epochSeconds;
    this.uu_1 = nanosecondsOfSecond;
  }
  fu() {
    if (this.tu_1 < Companion_getInstance_25().sj_1.gu_1 || this.tu_1 > Companion_getInstance_25().tj_1.gu_1)
      throw InstantFormatException.zu('The parsed date is outside the range representable by Instant (Unix epoch second ' + this.tu_1.toString() + ')');
    return Companion_getInstance_25().bu(this.tu_1, this.uu_1);
  }
}
class Failure {
  ...
  fu() {
    throw InstantFormatException.zu(this.av_1 + ' when parsing an Instant from "' + truncateForErrorMessage(this.bv_1, 64) + '"');
  }
}
class Companion_26 {
  lu(instant) {
    var localSecond = instant.gu_1;
    // Inline function 'kotlin.floorDiv' call
    ...
    return new UnboundLocalDateTime(year, month, day, hours, minutes, second, instant.hu_1);
  }
}
class UnboundLocalDateTime {
  constructor(year, month, day, hour, minute, second, nanosecond) {
    ...
    this.qu_1 = minute;
    this.ru_1 = second;
    this.su_1 = nanosecond;
  }
  toString() {
    return 'UnboundLocalDateTime(' + this.mu_1 + '-' + this.nu_1 + '-' + this.ou_1 + ' ' + this.pu_1 + ':' + this.qu_1 + ':' + this.ru_1 + '.' + this.su_1 + ')';
  }
}
class InstantFormatException extends IllegalArgumentException {
  constructor(message) {
    return new.target.zu(message);
  }
  static zu(message) {
    var $this = this.a2(message);
    captureStack($this, $this.yu_1);
    return $this;
  }
}
...
class DeepRecursiveScopeImpl extends DeepRecursiveScope {
  constructor(block, value) {
    super();
    var tmp = this;
    tmp.ev_1 = isSuspendFunction(block, 2) ? block : THROW_CCE();
    this.fv_1 = value;
    var tmp_0 = this;
    tmp_0.gv_1 = isInterface(this, Continuation) ? this : THROW_CCE();
    this.hv_1 = get_UNDEFINED_RESULT();
  }
  fd() {
    return EmptyCoroutineContext_instance;
  }
  ...
  *cv(value, $completion) {
    ...
    return yield () => {
      var cont = $completion;
      var tmp = this;
      tmp.gv_1 = isInterface(cont, Continuation) ? cont : THROW_CCE();
      this.fv_1 = value;
      return get_COROUTINE_SUSPENDED();
    };
  }
...
class UnsafeLazyImpl {
  constructor(initializer) {
    this.kv_1 = initializer;
    this.lv_1 = UNINITIALIZED_VALUE_instance;
  }
  d3() {
    if (this.lv_1 === UNINITIALIZED_VALUE_instance) {
      this.lv_1 = ensureNotNull(this.kv_1)();
      this.kv_1 = null;
    }
    return this.lv_1;
  }
  mv() {
    return !(this.lv_1 === UNINITIALIZED_VALUE_instance);
  }
  toString() {
    return this.mv() ? toString_0(this.d3()) : 'Lazy value not initialized yet.';
  }
}
...
class Result {
  ...
  toString() {
    return Result__toString_impl_yu5r8k(this.nv_1);
  }
  hashCode() {
    return Result__hashCode_impl_d2zufp(this.nv_1);
  }
  equals(other) {
    return Result__equals_impl_bxgmep(this.nv_1, other);
  }
}
class NotImplementedError extends Error_0 {
  constructor(message) {
    return new.target.ce(message);
  }
  static ce(message) {
    message = message === VOID ? 'An operation is not implemented.' : message;
    var $this = this.bf(message);
    captureStack($this, $this.be_1);
    return $this;
  }
}
class Pair {
  ...
  copy(first, second, $super) {
    ...
    return $super === VOID ? this.qv(first, second) : $super.qv.call(this, first, second);
  }
  hashCode() {
...
class Triple {
  ...
  toString() {
    return '(' + toString_0(this.rv_1) + ', ' + toString_0(this.sv_1) + ', ' + toString_0(this.tv_1) + ')';
  }
  sl() {
    return this.rv_1;
  }
  ...
  hashCode() {
    var result = this.rv_1 == null ? 0 : hashCode(this.rv_1);
    result = imul_0(result, 31) + (this.sv_1 == null ? 0 : hashCode(this.sv_1)) | 0;
    result = imul_0(result, 31) + (this.tv_1 == null ? 0 : hashCode(this.tv_1)) | 0;
    return result;
  }
  equals(other) {
    if (this === other)
    ...
    if (!(other instanceof Triple))
      return false;
    if (!equals(this.rv_1, other.rv_1))
      return false;
    if (!equals(this.sv_1, other.sv_1))
      return false;
...
class Companion_28 {
  constructor() {
    ...
    this.vj_1 = new Uuid(0n, 0n);
    this.wj_1 = 16;
    this.xj_1 = 128;
  }
  yj(mostSignificantBits, leastSignificantBits) {
    var tmp;
...
class Uuid {
  constructor(mostSignificantBits, leastSignificantBits) {
    ...
    this.wv_1 = mostSignificantBits;
    this.xv_1 = leastSignificantBits;
  }
  toString() {
    return this.yv();
  }
  yv() {
    ...
    formatBytesInto(this.wv_1, bytes, 0, 0, 4);
    // Inline function 'kotlin.code' call
    var this_0 = _Char___init__impl__6a9atx(45);
    var tmp$ret$0 = Char__toInt_impl_vasixd(this_0);
    bytes[8] = toByte(tmp$ret$0);
    formatBytesInto(this.wv_1, bytes, 9, 4, 6);
    // Inline function 'kotlin.code' call
    var this_1 = _Char___init__impl__6a9atx(45);
    var tmp$ret$1 = Char__toInt_impl_vasixd(this_1);
    bytes[13] = toByte(tmp$ret$1);
    formatBytesInto(this.wv_1, bytes, 14, 6, 8);
    // Inline function 'kotlin.code' call
    var this_2 = _Char___init__impl__6a9atx(45);
    var tmp$ret$2 = Char__toInt_impl_vasixd(this_2);
    bytes[18] = toByte(tmp$ret$2);
    formatBytesInto(this.xv_1, bytes, 19, 0, 2);
    // Inline function 'kotlin.code' call
    var this_3 = _Char___init__impl__6a9atx(45);
    var tmp$ret$3 = Char__toInt_impl_vasixd(this_3);
    bytes[23] = toByte(tmp$ret$3);
    formatBytesInto(this.xv_1, bytes, 24, 2, 8);
  ...
  equals(other) {
    ...
    if (!(other instanceof Uuid))
      return false;
    return this.wv_1 === other.wv_1 && this.xv_1 === other.xv_1;
  }
  zv(other) {
    var tmp;
  ...
  d(other) {
    return this.zv(other instanceof Uuid ? other : THROW_CCE());
  }
  hashCode() {
    return getBigIntHashCode(this.wv_1 ^ this.xv_1);
  }
}
class Companion_29 {
  constructor() {
    Companion_instance_29 = this;
    this.aw_1 = _UByte___init__impl__g9hnc4(0);
    this.bw_1 = _UByte___init__impl__g9hnc4(-1);
    this.cw_1 = 1;
    this.dw_1 = 8;
  }
}
class UByte {
  ...
  fw(other) {
    return UByte__compareTo_impl_5w5192(this.ew_1, other);
  }
  d(other) {
    return UByte__compareTo_impl_5w5192_0(this, other);
  }
  toString() {
    return UByte__toString_impl_v72jg(this.ew_1);
  }
  hashCode() {
    return UByte__hashCode_impl_mmczcb(this.ew_1);
  }
  equals(other) {
    return UByte__equals_impl_nvqtsf(this.ew_1, other);
  }
}
class Iterator_0 {
  constructor(array) {
  ...
  m1() {
    return this.hw_1 < this.gw_1.length;
  }
  iw() {
    var tmp;
    if (this.hw_1 < this.gw_1.length) {
      var _unary__edvuaz = this.hw_1;
      this.hw_1 = _unary__edvuaz + 1 | 0;
      // Inline function 'kotlin.toUByte' call
      var this_0 = this.gw_1[_unary__edvuaz];
      tmp = _UByte___init__impl__g9hnc4(this_0);
    } else {
      throw NoSuchElementException.i2(this.hw_1.toString());
    }
    return tmp;
  }
  n1() {
    return new UByte(this.iw());
  }
}
class UByteArray {
  constructor(storage) {
  ...
  k2() {
    return _UByteArray___get_size__impl__h6pkdv(this.jw_1);
  }
  l1() {
    return UByteArray__iterator_impl_509y1p(this.jw_1);
  }
  kw(element) {
    return UByteArray__contains_impl_njh19q(this.jw_1, element);
  }
  n2(element) {
    return UByteArray__contains_impl_njh19q_0(this, element);
  }
  j1() {
    return UByteArray__isEmpty_impl_nbfqsa(this.jw_1);
  }
  toString() {
    return UByteArray__toString_impl_ukpl97(this.jw_1);
  }
  hashCode() {
    return UByteArray__hashCode_impl_ip8jx2(this.jw_1);
  }
  equals(other) {
    return UByteArray__equals_impl_roka4u(this.jw_1, other);
  }
}
class Companion_30 {
  constructor() {
    Companion_instance_30 = this;
    this.lw_1 = _UInt___init__impl__l7qpdl(0);
    this.mw_1 = _UInt___init__impl__l7qpdl(-1);
    this.nw_1 = 4;
    this.ow_1 = 32;
  }
}
class UInt {
  ...
  qw(other) {
    return UInt__compareTo_impl_yacclj(this.pw_1, other);
  }
  d(other) {
    return UInt__compareTo_impl_yacclj_0(this, other);
  }
  toString() {
    return UInt__toString_impl_dbgl21(this.pw_1);
  }
  hashCode() {
    return UInt__hashCode_impl_z2mhuw(this.pw_1);
  }
  equals(other) {
    return UInt__equals_impl_ffdoxg(this.pw_1, other);
  }
}
class Iterator_1 {
  constructor(array) {
  ...
  m1() {
    return this.sw_1 < this.rw_1.length;
  }
  tw() {
    var tmp;
    if (this.sw_1 < this.rw_1.length) {
      var _unary__edvuaz = this.sw_1;
      this.sw_1 = _unary__edvuaz + 1 | 0;
      // Inline function 'kotlin.toUInt' call
      var this_0 = this.rw_1[_unary__edvuaz];
      tmp = _UInt___init__impl__l7qpdl(this_0);
    } else {
      throw NoSuchElementException.i2(this.sw_1.toString());
    }
    return tmp;
  }
  n1() {
    return new UInt(this.tw());
  }
}
class UIntArray {
  constructor(storage) {
  ...
  k2() {
    return _UIntArray___get_size__impl__r6l8ci(this.uw_1);
  }
  l1() {
    return UIntArray__iterator_impl_tkdv7k(this.uw_1);
  }
  vw(element) {
    return UIntArray__contains_impl_b16rzj(this.uw_1, element);
  }
  n2(element) {
    return UIntArray__contains_impl_b16rzj_0(this, element);
  }
  j1() {
    return UIntArray__isEmpty_impl_vd8j4n(this.uw_1);
  }
  toString() {
    return UIntArray__toString_impl_3zy802(this.uw_1);
  }
  hashCode() {
    return UIntArray__hashCode_impl_hr7ost(this.uw_1);
  }
  equals(other) {
    return UIntArray__equals_impl_flcmof(this.uw_1, other);
  }
}
class Companion_31 {
  constructor() {
    Companion_instance_31 = this;
    this.ww_1 = new UIntRange(_UInt___init__impl__l7qpdl(-1), _UInt___init__impl__l7qpdl(0));
  }
}
class UIntProgression {
  constructor(start, endInclusive, step) {
    ...
    if (step === -2147483648)
      throw IllegalArgumentException.a2('Step must be greater than Int.MIN_VALUE to avoid overflow on negation.');
    this.bx_1 = start;
    this.cx_1 = getProgressionLastElement_0(start, endInclusive, step);
    this.dx_1 = step;
  }
  l1() {
    return new UIntProgressionIterator(this.bx_1, this.cx_1, this.dx_1);
  }
  j1() {
    var tmp;
    if (this.dx_1 > 0) {
      ...
      var tmp0_0 = this.bx_1;
      // Inline function 'kotlin.UInt.compareTo' call
      var other_0 = this.cx_1;
  ...
  equals(other) {
    ...
    if (other instanceof UIntProgression) {
      tmp = this.j1() && other.j1() || (this.bx_1 === other.bx_1 && this.cx_1 === other.cx_1 && this.dx_1 === other.dx_1);
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    ...
    if (this.j1()) {
      ...
      tmp = imul_0(31, tmp_0 + tmp$ret$1 | 0) + this.dx_1 | 0;
    }
    return tmp;
  }
  toString() {
    return this.dx_1 > 0 ? '' + new UInt(this.bx_1) + '..' + new UInt(this.cx_1) + ' step ' + this.dx_1 : '' + new UInt(this.bx_1) + ' downTo ' + new UInt(this.cx_1) + ' step ' + (-this.dx_1 | 0);
  }
}
class UIntRange extends UIntProgression {
  ...
  mi() {
    return new UInt(this.ax());
  }
  ex() {
    return this.cx_1;
  }
  ni() {
    return new UInt(this.ex());
  }
  vw(value) {
    var tmp;
    // Inline function 'kotlin.UInt.compareTo' call
  ...
  j3(value) {
    return this.vw(value instanceof UInt ? value.pw_1 : THROW_CCE());
  }
  j1() {
    var tmp0 = this.bx_1;
    // Inline function 'kotlin.UInt.compareTo' call
  ...
  equals(other) {
    ...
    if (other instanceof UIntRange) {
      tmp = this.j1() && other.j1() || (this.bx_1 === other.bx_1 && this.cx_1 === other.cx_1);
    } else {
      tmp = false;
    }
    return tmp;
  ...
  toString() {
    return '' + new UInt(this.bx_1) + '..' + new UInt(this.cx_1);
  }
}
class Companion_32 {}
class UIntProgressionIterator {
  constructor(first, last, step) {
    ...
    var tmp_1 = this;
    // Inline function 'kotlin.toUInt' call
    tmp_1.hx_1 = _UInt___init__impl__l7qpdl(step);
    this.ix_1 = this.gx_1 ? first : this.fx_1;
  }
  m1() {
    return this.gx_1;
  }
  tw() {
    ...
    if (value === this.fx_1) {
      ...
      var other = this.hx_1;
      tmp.ix_1 = _UInt___init__impl__l7qpdl(_UInt___get_data__impl__f0vqqw(tmp0) + _UInt___get_data__impl__f0vqqw(other) | 0);
    }
    return value;
  }
  n1() {
...
class Companion_33 {
  constructor() {
    ...
    this.jx_1 = _ULong___init__impl__c78o9k(0n);
    this.kx_1 = _ULong___init__impl__c78o9k(-1n);
    this.lx_1 = 8;
    this.mx_1 = 64;
  }
}
...
class Iterator_2 {
  ...
  m1() {
    return this.px_1 < this.ox_1.length;
  }
  qx() {
    var tmp;
    if (this.px_1 < this.ox_1.length) {
      var _unary__edvuaz = this.px_1;
      this.px_1 = _unary__edvuaz + 1 | 0;
      // Inline function 'kotlin.toULong' call
      var this_0 = this.ox_1[_unary__edvuaz];
      tmp = _ULong___init__impl__c78o9k(this_0);
    } else {
      throw NoSuchElementException.i2(this.px_1.toString());
    }
    return tmp;
  }
  n1() {
    return new ULong(this.qx());
  }
}
class ULongArray {
  constructor(storage) {
  ...
  k2() {
    return _ULongArray___get_size__impl__ju6dtr(this.rx_1);
  }
  l1() {
    return ULongArray__iterator_impl_cq4d2h(this.rx_1);
  }
  a7(element) {
    return ULongArray__contains_impl_v9bgai(this.rx_1, element);
  }
  n2(element) {
    return ULongArray__contains_impl_v9bgai_0(this, element);
  }
  j1() {
    return ULongArray__isEmpty_impl_c3yngu(this.rx_1);
  }
  toString() {
    return ULongArray__toString_impl_wqk1p5(this.rx_1);
  }
  hashCode() {
    return ULongArray__hashCode_impl_aze4wa(this.rx_1);
  }
  equals(other) {
    return ULongArray__equals_impl_vwitwa(this.rx_1, other);
  }
}
class Companion_34 {
  constructor() {
    Companion_instance_34 = this;
    this.sx_1 = _UShort___init__impl__jigrne(0);
    this.tx_1 = _UShort___init__impl__jigrne(-1);
    this.ux_1 = 2;
    this.vx_1 = 16;
  }
}
class UShort {
  ...
  xx(other) {
    return UShort__compareTo_impl_1pfgyc(this.wx_1, other);
  }
  d(other) {
    return UShort__compareTo_impl_1pfgyc_0(this, other);
  }
  toString() {
    return UShort__toString_impl_edaoee(this.wx_1);
  }
  hashCode() {
    return UShort__hashCode_impl_ywngrv(this.wx_1);
  }
  equals(other) {
    return UShort__equals_impl_7t9pdz(this.wx_1, other);
  }
}
class Iterator_3 {
  constructor(array) {
  ...
  m1() {
    return this.zx_1 < this.yx_1.length;
  }
  ay() {
    var tmp;
    if (this.zx_1 < this.yx_1.length) {
      var _unary__edvuaz = this.zx_1;
      this.zx_1 = _unary__edvuaz + 1 | 0;
      // Inline function 'kotlin.toUShort' call
      var this_0 = this.yx_1[_unary__edvuaz];
      tmp = _UShort___init__impl__jigrne(this_0);
    } else {
      throw NoSuchElementException.i2(this.zx_1.toString());
    }
    return tmp;
  }
  n1() {
    return new UShort(this.ay());
  }
}
class UShortArray {
  constructor(storage) {
  ...
  k2() {
    return _UShortArray___get_size__impl__jqto1b(this.by_1);
  }
  l1() {
    return UShortArray__iterator_impl_ktpenn(this.by_1);
  }
  cy(element) {
    return UShortArray__contains_impl_vo7k3g(this.by_1, element);
  }
  n2(element) {
    return UShortArray__contains_impl_vo7k3g_0(this, element);
  }
  j1() {
    return UShortArray__isEmpty_impl_cdd9l0(this.by_1);
  }
  toString() {
    return UShortArray__toString_impl_omz03z(this.by_1);
  }
  hashCode() {
    return UShortArray__hashCode_impl_2vt3b4(this.by_1);
  }
  equals(other) {
    return UShortArray__equals_impl_tyc3mk(this.by_1, other);
  }
}
//endregion
...
function plus_0(_this__u8e3s4, element) {
  var result = ArrayList.d2(_this__u8e3s4.k2() + 1 | 0);
  result.l2(_this__u8e3s4);
  result.e2(element);
  return result;
}
...
function plus_1(_this__u8e3s4, elements) {
  if (isInterface(elements, Collection)) {
    var result = ArrayList.d2(_this__u8e3s4.k2() + elements.k2() | 0);
    result.l2(_this__u8e3s4);
    result.l2(elements);
    return result;
  } else {
  ...
  if (isInterface(_this__u8e3s4, Collection)) {
    ...
    switch (_this__u8e3s4.k2()) {
      ...
      case 1:
        ...
        break;
      default:
        tmp = toCollection_0(_this__u8e3s4, LinkedHashSet.c2(mapCapacity(_this__u8e3s4.k2())));
        break;
    }
    return tmp;
  }
...
function last_0(_this__u8e3s4) {
  if (_this__u8e3s4.j1())
    throw NoSuchElementException.i2('List is empty.');
  return _this__u8e3s4.m2(get_lastIndex_3(_this__u8e3s4));
}
function lastOrNull(_this__u8e3s4) {
  return _this__u8e3s4.j1() ? null : _this__u8e3s4.m2(_this__u8e3s4.k2() - 1 | 0);
}
      ...
      if (isInterface(_this__u8e3s4, RandomAccess)) {
        ...
        if (inductionVariable < last)
          do {
            var index = inductionVariable;
            inductionVariable = inductionVariable + 1 | 0;
            list.e2(_this__u8e3s4.m2(index));
          }
           while (inductionVariable < last);
      } else {
        // Inline function 'kotlin.collections.iterator' call
...
function getOrNull_0(_this__u8e3s4, index) {
  return (0 <= index ? index < _this__u8e3s4.k2() : false) ? _this__u8e3s4.m2(index) : null;
}
...
function firstOrNull_0(_this__u8e3s4) {
  return _this__u8e3s4.j1() ? null : _this__u8e3s4.m2(0);
}
...
function dropLast(_this__u8e3s4, n) {
  ...
  return take_0(_this__u8e3s4, coerceAtLeast(_this__u8e3s4.k2() - n | 0, 0));
}
...
function singleOrNull(_this__u8e3s4) {
  return _this__u8e3s4.k2() === 1 ? _this__u8e3s4.m2(0) : null;
}
    ...
    $l$loop: while (0 <= index ? index < thisSize : false) {
      ...
      if (inductionVariable < windowSize)
        do {
          var index_0 = inductionVariable;
          inductionVariable = inductionVariable + 1 | 0;
          var tmp$ret$4 = _this__u8e3s4.m2(index_0 + index | 0);
          list.e2(tmp$ret$4);
        }
...
function random(_this__u8e3s4, random) {
  if (_this__u8e3s4.j1())
    throw NoSuchElementException.i2('Collection is empty.');
  return elementAt(_this__u8e3s4, random.v2(_this__u8e3s4.k2()));
}
function elementAt(_this__u8e3s4, index) {
  if (isInterface(_this__u8e3s4, KtList))
    return _this__u8e3s4.m2(index);
...
function elementAtOrElse(_this__u8e3s4, index, defaultValue) {
  if (isInterface(_this__u8e3s4, KtList)) {
    ...
    return (0 <= index ? index < _this__u8e3s4.k2() : false) ? _this__u8e3s4.m2(index) : defaultValue(index);
  }
  if (index < 0)
...
function toList_2(_this__u8e3s4) {
  ...
  var result = ArrayList.d2(_this__u8e3s4.k2());
  // Inline function 'kotlin.collections.toPair' call
...
function plus_3(_this__u8e3s4, elements) {
  ...
  var result = LinkedHashSet.c2(mapCapacity(tmp1_elvis_lhs == null ? imul_0(_this__u8e3s4.k2(), 2) : tmp1_elvis_lhs));
  result.l2(_this__u8e3s4);
  addAll_0(result, elements);
  return result;
}
...
function createJsArrayViewFrom$lambda_2($list) {
  return (size) => {
    $list.d4($list.k2() - size | 0, $list.k2()).j4();
    return Unit_instance;
  };
}
...
function reverse(_this__u8e3s4) {
  ...
  if (inductionVariable <= midPoint)
    do {
      var index = inductionVariable;
      inductionVariable = inductionVariable + 1 | 0;
      var tmp = _this__u8e3s4.m2(index);
      _this__u8e3s4.k4(index, _this__u8e3s4.m2(reverseIndex));
...
function increaseLength($this, amount) {
  ...
  // Inline function 'kotlin.js.asDynamic' call
  $this.u1_1.length = $this.k2() + amount | 0;
  return previous;
}
...
function shouldCompact($this, extraCapacity) {
  ...
  var gaps = $this.k9_1 - $this.k2() | 0;
  return spareCapacity < extraCapacity && (gaps + spareCapacity | 0) >= extraCapacity && gaps >= (_get_capacity__a9k9f3($this) / 4 | 0);
}
function ensureCapacity($this, minCapacity) {
  if (minCapacity < 0)
    throw RuntimeException.hb('too many elements');
  if (minCapacity > _get_capacity__a9k9f3($this)) {
    var newSize = Companion_instance_10.ib(_get_capacity__a9k9f3($this), minCapacity);
...
function addKey($this, key) {
  ...
  retry: while (true) {
    var hash_0 = hash($this, key);
    var tentativeMaxProbeDistance = coerceAtMost_0(imul_0($this.j9_1, 2), _get_hashSize__tftcho($this) / 2 | 0);
    var probeDistance = 0;
    while (true) {
      var index = $this.i9_1[hash_0];
      if (index === 0) {
...
function contentEquals_5($this, other) {
  return $this.n9_1 === other.k2() && $this.oa(other.b3());
}
...
function intercepted(_this__u8e3s4) {
  ...
  var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.qd();
  return tmp1_elvis_lhs == null ? _this__u8e3s4 : tmp1_elvis_lhs;
}
function invokeSuspendSuperTypeWithReceiver(_this__u8e3s4, receiver, completion) {
  throw NotImplementedError.ce('It is intrinsic method');
}
...
function createCoroutineUninterceptedGeneratorVersion(_this__u8e3s4, completion) {
  ...
  // Inline function 'kotlin.js.asDynamic' call
  var a = _this__u8e3s4;
  tmp.kd_1 = typeof a === 'function' ? a(continuation) : _this__u8e3s4.de(continuation);
  return continuation;
}
function createCoroutineUninterceptedGeneratorVersion_0(_this__u8e3s4, receiver, completion) {
  ...
  // Inline function 'kotlin.js.asDynamic' call
  var a = _this__u8e3s4;
  tmp.kd_1 = typeof a === 'function' ? a(receiver, continuation) : _this__u8e3s4.ee(receiver, continuation);
  return continuation;
}
function startCoroutineUninterceptedOrReturnGeneratorVersion(_this__u8e3s4, completion) {
  ...
  // Inline function 'kotlin.js.asDynamic' call
  var a = _this__u8e3s4;
  var generator = typeof a === 'function' ? a(continuation) : _this__u8e3s4.de(continuation);
  continuation.kd_1 = generator;
  return continuation.nd();
}
function startCoroutineUninterceptedOrReturnGeneratorVersion_0(_this__u8e3s4, receiver, completion) {
  ...
  // Inline function 'kotlin.js.asDynamic' call
  var a = _this__u8e3s4;
  var generator = typeof a === 'function' ? a(receiver, continuation) : _this__u8e3s4.ee(receiver, continuation);
  continuation.kd_1 = generator;
  return continuation.nd();
}
function startCoroutineUninterceptedOrReturnGeneratorVersion_1(_this__u8e3s4, receiver, param, completion) {
  ...
  // Inline function 'kotlin.js.asDynamic' call
  var a = _this__u8e3s4;
  var generator = typeof a === 'function' ? a(receiver, param, continuation) : _this__u8e3s4.fe(receiver, param, continuation);
  continuation.kd_1 = generator;
  return continuation.nd();
}
function *await_0(promise, $completion) {
  ...
  return yield () => {
    var c = $completion;
    var safe = SafeContinuation.xd(intercepted(c));
...
function init_kotlin_RuntimeException(_this__u8e3s4) {
  captureStack(_this__u8e3s4, _this__u8e3s4.gb_1);
}
function init_kotlin_Exception(_this__u8e3s4) {
  captureStack(_this__u8e3s4, _this__u8e3s4.ne_1);
}
...
function get_js(_this__u8e3s4) {
  return (_this__u8e3s4 instanceof KClassImpl ? _this__u8e3s4 : THROW_CCE()).of();
}
...
function getStarKTypeProjection() {
  return Companion_getInstance_19().xf();
}
function createInvariantKTypeProjection(type) {
  return Companion_getInstance_19().yf(type);
}
...
function findAssociatedObject(_this__u8e3s4, annotationClass) {
  ...
  if (tmp_0) {
    // Inline function 'kotlin.js.asDynamic' call
    var tmp$ret$0 = annotationClass.of();
    ...
    var key = tmp_1;
    // Inline function 'kotlin.js.asDynamic' call
    var tmp1_safe_receiver = _this__u8e3s4.of().$metadata$;
...
function Regex$findAll$lambda(this$0, $input, $startIndex) {
  return () => this$0.yh($input, $startIndex);
}
  ...
  while (index < replacement.length) {
    ...
    if (char === _Char___init__impl__6a9atx(92)) {
      ...
      if (charCodeAt(replacement, index) === _Char___init__impl__6a9atx(123)) {
        ...
        var tmp0_safe_receiver = get_1(match.ti(), groupName);
        var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.si_1;
        ...
        var groups = match.ti();
        var endIndex_0 = readGroupIndex(replacement, index, groups.k2());
        var groupIndex = toInt(substring(replacement, index, endIndex_0));
        if (groupIndex >= groups.k2())
          throw IndexOutOfBoundsException.a3('Group with index ' + groupIndex + ' does not exist');
        var tmp2_safe_receiver = groups.m2(groupIndex);
        var tmp3_elvis_lhs = tmp2_safe_receiver == null ? null : tmp2_safe_receiver.si_1;
...
function get_1(_this__u8e3s4, name) {
  ...
  var tmp;
  if (tmp0_elvis_lhs == null) {
    throw UnsupportedOperationException.ra('Retrieving groups by name is not supported on this platform.');
  } else {
    tmp = tmp0_elvis_lhs;
  }
  var namedGroups = tmp;
  return namedGroups.ui(name);
}
...
function advanceToNextCharacter($this, index) {
  if (index < get_lastIndex_4($this.dj_1)) {
    // Inline function 'kotlin.js.asDynamic' call
    // Inline function 'kotlin.js.unsafeCast' call
    var code1 = $this.dj_1.charCodeAt(index);
    if (55296 <= code1 ? code1 <= 56319 : false) {
      // Inline function 'kotlin.js.asDynamic' call
      // Inline function 'kotlin.js.unsafeCast' call
      var code2 = $this.dj_1.charCodeAt(index + 1 | 0);
...
function concatToString_0(_this__u8e3s4, startIndex, endIndex) {
  ...
  _init_properties_stringJs_kt__bg7zye();
  Companion_instance_10.nh(startIndex, endIndex, _this__u8e3s4.length);
  var result = '';
...
function toCharArray_0(_this__u8e3s4, destination, destinationOffset, startIndex, endIndex) {
  ...
  _init_properties_stringJs_kt__bg7zye();
  Companion_instance_10.nh(startIndex, endIndex, _this__u8e3s4.length);
  Companion_instance_10.nh(destinationOffset, (destinationOffset + endIndex | 0) - startIndex | 0, destination.length);
...
function replace(_this__u8e3s4, oldValue, newValue, ignoreCase) {
  ignoreCase = ignoreCase === VOID ? false : ignoreCase;
  var tmp2 = new RegExp(Companion_getInstance_9().rh(oldValue), ignoreCase ? 'gui' : 'gu');
  // Inline function 'kotlin.text.nativeReplace' call
  var replacement = Companion_getInstance_9().sh(newValue);
  // Inline function 'kotlin.js.asDynamic' call
...
function replace_0(_this__u8e3s4, oldChar, newChar, ignoreCase) {
  ignoreCase = ignoreCase === VOID ? false : ignoreCase;
  var tmp2 = new RegExp(Companion_getInstance_9().rh(toString(oldChar)), ignoreCase ? 'gui' : 'gu');
  // Inline function 'kotlin.text.nativeReplace' call
...
function malformed(size, index, throwOnMalformed) {
  _init_properties_utf8Encoding_kt__9thjs4();
  if (throwOnMalformed)
    throw CharacterCodingException.bh('Malformed sequence starting at ' + (index - 1 | 0));
  return -size | 0;
}
...
function stackTraceToString(_this__u8e3s4) {
  return (new ExceptionTraceBuilder()).oj(_this__u8e3s4);
}
...
function dumpSelfTrace($this, $receiver, indent, qualifier) {
  $this.kj_1.i1(indent).i1(qualifier);
  var shortInfo = $receiver.toString();
  if (hasSeen($this, $receiver)) {
    $this.kj_1.i1('[CIRCULAR REFERENCE, SEE ABOVE: ').i1(shortInfo).i1(']\n');
    return false;
  }
  // Inline function 'kotlin.js.asDynamic' call
  $this.lj_1.push($receiver);
  // Inline function 'kotlin.js.asDynamic' call
  ...
  if (!(stack == null)) {
    ...
    if (stackStart === 0) {
      $this.kj_1.i1(shortInfo).i1('\n');
    }
    // Inline function 'kotlin.text.isEmpty' call
    var this_0 = $this.mj_1;
    if (charSequenceLength(this_0) === 0) {
      $this.mj_1 = stack;
      $this.nj_1 = stackStart;
    } else {
    ...
    if (charSequenceLength(indent) > 0) {
      ...
      while (_iterator__ex2g4s.m1()) {
        ...
        $this.kj_1.i1(item).i1('\n');
      }
    } else {
      $this.kj_1.i1(stack).i1('\n');
    }
  } else {
    $this.kj_1.i1(shortInfo).i1('\n');
  }
...
function dropCommonFrames($this, stack, stackStart) {
  ...
  var preLastBreak = 0;
  var inductionVariable = 0;
  var tmp0 = $this.mj_1.length - $this.nj_1 | 0;
  // Inline function 'kotlin.comparisons.minOf' call
  ...
  if (inductionVariable < last)
    $l$loop: do {
      ...
      if (!(c === charCodeAt($this.mj_1, get_lastIndex_4($this.mj_1) - pos | 0)))
        break $l$loop;
...
function convertDurationUnit(value, sourceUnit, targetUnit) {
  var sourceCompareTarget = compareTo(sourceUnit.rj_1, targetUnit.rj_1);
  var tmp;
  if (sourceCompareTarget > 0) {
    var scale = numberToLong(sourceUnit.rj_1 / targetUnit.rj_1);
    ...
    tmp = divide(value, numberToLong(targetUnit.rj_1 / sourceUnit.rj_1));
  } else {
    tmp = value;
  }
  return tmp;
...
function convertDurationUnitOverflow(value, sourceUnit, targetUnit) {
  var sourceCompareTarget = compareTo(sourceUnit.rj_1, targetUnit.rj_1);
  return sourceCompareTarget > 0 ? multiply_0(value, numberToLong(sourceUnit.rj_1 / targetUnit.rj_1)) : sourceCompareTarget < 0 ? divide(value, numberToLong(targetUnit.rj_1 / sourceUnit.rj_1)) : value;
}
...
function systemClockNow() {
  return Companion_getInstance_25().uj(numberToLong((new Date()).getTime()));
}
...
function uuidParseHexDash(hexDashString) {
  ...
  return Companion_getInstance_28().yj(msb, lsb);
}
...
function ensureCapacity_0($this, minCapacity) {
  ...
  if (minCapacity <= $this.wk_1.length)
    return Unit_instance;
  if ($this.wk_1 === Companion_getInstance_13().yk_1) {
    var tmp = $this;
    // Inline function 'kotlin.arrayOfNulls' call
  ...
  var newCapacity = Companion_instance_10.ib($this.wk_1.length, minCapacity);
...
function copyElements($this, newCapacity) {
  ...
  var tmp0_0 = $this.wk_1;
  var tmp4 = $this.wk_1.length - $this.vk_1 | 0;
  // Inline function 'kotlin.collections.copyInto' call
  var endIndex_0 = $this.vk_1;
  arrayCopy(tmp0_0, newElements, tmp4, 0, endIndex_0);
  $this.vk_1 = 0;
  $this.wk_1 = newElements;
}
function positiveMod($this, index) {
  return index >= $this.wk_1.length ? index - $this.wk_1.length | 0 : index;
}
function negativeMod($this, index) {
  return index < 0 ? index + $this.wk_1.length | 0 : index;
}
function incremented($this, index) {
  return index === get_lastIndex_0($this.wk_1) ? 0 : index + 1 | 0;
}
function decremented($this, index) {
  return index === 0 ? get_lastIndex_0($this.wk_1) : index - 1 | 0;
}
function copyCollectionElements($this, internalIndex, elements) {
  ...
  if (inductionVariable_0 < last_0)
    $l$loop_0: do {
      ...
      if (!iterator.m1())
        break $l$loop_0;
      $this.wk_1[index_0] = iterator.n1();
    }
     while (inductionVariable_0 < last_0);
  $this.xk_1 = $this.xk_1 + elements.k2() | 0;
}
function removeRangeShiftPreceding($this, fromIndex, toIndex) {
  // Inline function 'kotlin.collections.ArrayDeque.internalIndex' call
  var index = fromIndex - 1 | 0;
  var copyFromIndex = positiveMod($this, $this.vk_1 + index | 0);
  // Inline function 'kotlin.collections.ArrayDeque.internalIndex' call
  var index_0 = toIndex - 1 | 0;
  var copyToIndex = positiveMod($this, $this.vk_1 + index_0 | 0);
...
function removeRangeShiftSucceeding($this, fromIndex, toIndex) {
  // Inline function 'kotlin.collections.ArrayDeque.internalIndex' call
  var copyFromIndex = positiveMod($this, $this.vk_1 + toIndex | 0);
  // Inline function 'kotlin.collections.ArrayDeque.internalIndex' call
  var copyToIndex = positiveMod($this, $this.vk_1 + fromIndex | 0);
  var copyCount = $this.xk_1 - toIndex | 0;
  while (copyCount > 0) {
    var tmp0 = copyCount;
    var tmp2 = $this.wk_1.length - copyFromIndex | 0;
    // Inline function 'kotlin.comparisons.minOf' call
    var c = $this.wk_1.length - copyToIndex | 0;
    var segmentLength = Math.min(tmp0, tmp2, c);
    var tmp0_0 = $this.wk_1;
    var tmp2_0 = $this.wk_1;
...
function nullifyNonEmpty($this, internalFromIndex, internalToIndex) {
  if (internalFromIndex < internalToIndex) {
    fill_0($this.wk_1, null, internalFromIndex, internalToIndex);
  } else {
    fill_0($this.wk_1, null, internalFromIndex, $this.wk_1.length);
    fill_0($this.wk_1, null, 0, internalToIndex);
  }
}
...
function init_kotlin_collections_ArrayDeque(_this__u8e3s4) {
  Companion_getInstance_13();
  _this__u8e3s4.vk_1 = 0;
  _this__u8e3s4.xk_1 = 0;
}
...
function optimizeReadOnlyList(_this__u8e3s4) {
  switch (_this__u8e3s4.k2()) {
    case 0:
      return emptyList();
    case 1:
      return listOf(_this__u8e3s4.m2(0));
    default:
      return _this__u8e3s4;
  }
}
function throwIndexOverflow() {
  throw ArithmeticException.ye('Index overflow has happened.');
}
function throwCountOverflow() {
  throw ArithmeticException.ye('Count overflow has happened.');
}
  ...
  if (isInterface(_this__u8e3s4, Collection)) {
    ...
    switch (_this__u8e3s4.k2()) {
      ...
      case 1:
        ...
        break;
      default:
        tmp = toMap_0(_this__u8e3s4, LinkedHashMap.oc(mapCapacity(_this__u8e3s4.k2())));
        break;
    }
    return tmp;
  }
  return optimizeReadOnlyMap(toMap_0(_this__u8e3s4, LinkedHashMap.r5()));
}
function mapOf_0(pairs) {
  return pairs.length > 0 ? toMap_1(pairs, LinkedHashMap.oc(mapCapacity(pairs.length))) : emptyMap();
}
function toMutableMap(_this__u8e3s4) {
  return LinkedHashMap.pc(_this__u8e3s4);
}
...
function putAll(_this__u8e3s4, pairs) {
  ...
  while (_iterator__ex2g4s.m1()) {
    var _destruct__k2r9zo = _iterator__ex2g4s.n1();
    var key = _destruct__k2r9zo.sl();
    var value = _destruct__k2r9zo.tl();
...
function addAll(_this__u8e3s4, elements) {
  return _this__u8e3s4.l2(asList(elements));
}
...
function filterInPlace_0(_this__u8e3s4, predicate, predicateResultToRemove) {
  ...
  if (inductionVariable <= last)
    $l$loop: do {
      ...
      inductionVariable = inductionVariable + 1 | 0;
      var element = _this__u8e3s4.m2(readIndex);
...
function asReversed(_this__u8e3s4) {
  return ReversedList.hm(_this__u8e3s4);
}
function asReversed_0(_this__u8e3s4) {
  return ReversedListReadOnly.jm(_this__u8e3s4);
}
...
function reversePositionIndex(_this__u8e3s4, index) {
  ...
  if (0 <= index ? index <= _this__u8e3s4.k2() : false) {
    ...
    throw IndexOutOfBoundsException.a3('Position index ' + index + ' must be in range [' + numberRangeToNumber(0, _this__u8e3s4.k2()).toString() + '].');
  }
  return tmp;
}
...
function iterator(block) {
  ...
  iterator.um_1 = createCoroutineUninterceptedGeneratorVersion_0(block, iterator, iterator);
  return iterator;
}
...
function exceptionalState($this) {
  switch ($this.rm_1) {
    ...
    default:
      return IllegalStateException.o('Unexpected state of the iterator: ' + $this.rm_1);
  }
}
...
function calcNext($this) {
  while ($this.fn_1.m1()) {
    var item = $this.fn_1.n1();
    if ($this.in_1.ln_1(item) === $this.in_1.kn_1) {
      $this.hn_1 = item;
      $this.gn_1 = 1;
      return Unit_instance;
    }
...
function calcNext_0($this) {
  $this.mn_1 = $this.nn_1 === -2 ? $this.on_1.pn_1() : $this.on_1.qn_1(ensureNotNull($this.mn_1));
  $this.nn_1 = $this.mn_1 == null ? 0 : 1;
}
  ...
  return constructCallableReference(function *($this$iterator, $completion) {
    ...
    if (gap >= 0) {
      ...
      $l$loop: while (_iterator__ex2g4s.m1()) {
        ...
        buffer.e2(e);
        if (buffer.k2() === $size) {
          yield* $this$iterator.qm(buffer, $completion);
          if ($reuseBuffer) {
            buffer.j4();
          } else
      ...
      // Inline function 'kotlin.collections.isNotEmpty' call
      if (!buffer.j1()) {
        tmp_0 = $partialWindows || buffer.k2() === $size ? (yield* $this$iterator.qm(buffer, $completion)) : void 0;
      }
      tmp = tmp_0;
    } else {
      var buffer_0 = RingBuffer.co(bufferInitialCapacity);
      // Inline function 'kotlin.collections.iterator' call
      ...
      $l$loop_0: while (_iterator__ex2g4s_0.m1()) {
        ...
        buffer_0.fo(e_0);
        if (buffer_0.do()) {
          if (buffer_0.ao_1 < $size) {
            buffer_0 = buffer_0.eo($size);
            continue $l$loop_0;
          }
          yield* $this$iterator.qm($reuseBuffer ? buffer_0 : ArrayList.w1(buffer_0), $completion);
          buffer_0.go($step);
        }
      }
      var tmp_1;
      if ($partialWindows) {
        while (buffer_0.ao_1 > $step) {
          yield* $this$iterator.qm($reuseBuffer ? buffer_0 : ArrayList.w1(buffer_0), $completion);
          buffer_0.go($step);
        }
        var tmp_2;
        // Inline function 'kotlin.collections.isNotEmpty' call
        if (!buffer_0.j1()) {
          tmp_2 = yield* $this$iterator.qm(buffer_0, $completion);
        }
        tmp_1 = tmp_2;
      }
      tmp = tmp_1;
...
function CoroutineContext$plus$lambda(acc, element) {
  var removed = acc.lo(element.c3());
  var tmp;
  if (removed === EmptyCoroutineContext_instance) {
    tmp = element;
  } else {
    var interceptor = removed.rd(Key_instance);
    var tmp_0;
    if (interceptor == null) {
      tmp_0 = new CombinedContext(removed, element);
    } else {
      var left = removed.lo(Key_instance);
...
function contains_8($this, element) {
  return equals($this.rd(element.c3()), element);
}
function containsAll($this, context) {
  var cur = context;
  while (true) {
    if (!contains_8($this, cur.qo_1))
      return false;
    var next = cur.po_1;
    if (next instanceof CombinedContext) {
      cur = next;
...
function enumEntries(entries) {
  return EnumEntriesList.to(entries);
}
...
function shouldPadOnEncode($this) {
  return $this.ap_1.equals(PaddingOption_PRESENT_getInstance()) || $this.ap_1.equals(PaddingOption_PRESENT_OPTIONAL_getInstance());
}
function decodeImpl($this, source, destination, destinationOffset, startIndex, endIndex) {
  var decodeMap = $this.xo_1 ? get_base64UrlDecodeMap() : get_base64DecodeMap();
  var payload = 0;
  var byteStart = -8;
  var sourceIndex = startIndex;
  var destinationIndex = destinationOffset;
  ...
  if (!(byteStart === -8) && !hasPadding && $this.ap_1.equals(PaddingOption_PRESENT_getInstance())) {
...
function checkPaddingIsAllowed($this, padIndex) {
  if ($this.ap_1.equals(PaddingOption_ABSENT_getInstance())) {
...
function Random_0(seed) {
  return XorWowRandom.wq(convertToInt(seed), convertToInt(shiftRight(seed, 32)));
}
...
function Random_1(seed) {
  return XorWowRandom.wq(seed, seed >> 31);
}
...
function checkInvariants($this) {
  // Inline function 'kotlin.require' call
  if (!!(($this.qq_1 | $this.rq_1 | $this.sq_1 | $this.tq_1 | $this.uq_1) === 0)) {
...
function toHexString(_this__u8e3s4, format) {
  format = format === VOID ? Companion_getInstance_22().ur_1 : format;
  _init_properties_HexExtensions_kt__wu8rc3();
...
function toHexString_0(_this__u8e3s4, format) {
  format = format === VOID ? Companion_getInstance_22().ur_1 : format;
  _init_properties_HexExtensions_kt__wu8rc3();
  var digits = format.wr_1 ? '0123456789ABCDEF' : '0123456789abcdef';
  var numberFormat = format.yr_1;
  if (numberFormat.es_1) {
...
function toHexString_1(_this__u8e3s4, startIndex, endIndex, format) {
  ...
  var byteToDigits = format.wr_1 ? get_BYTE_TO_UPPER_CASE_HEX_DIGITS() : get_BYTE_TO_LOWER_CASE_HEX_DIGITS();
  var bytesFormat = format.xr_1;
  if (bytesFormat.ms_1) {
...
function toHexStringImpl(_this__u8e3s4, numberFormat, digits, bits) {
  ...
  var minLength = numberFormat.cs_1;
  var pads = coerceAtLeast(minLength - typeHexLength | 0, 0);
  var prefix = numberFormat.zr_1;
  var suffix = numberFormat.as_1;
  var removeZeros = numberFormat.bs_1;
  // Inline function 'kotlin.Long.plus' call
...
function toHexStringSlowPath(_this__u8e3s4, startIndex, endIndex, bytesFormat, byteToDigits) {
  _init_properties_HexExtensions_kt__wu8rc3();
  var bytesPerLine = bytesFormat.gs_1;
  var bytesPerGroup = bytesFormat.hs_1;
  var bytePrefix = bytesFormat.ks_1;
  var byteSuffix = bytesFormat.ls_1;
  var byteSeparator = bytesFormat.js_1;
  var groupSeparator = bytesFormat.is_1;
...
function toHexStringShortByteSeparatorNoPrefixAndSuffix(_this__u8e3s4, startIndex, endIndex, bytesFormat, byteToDigits) {
  _init_properties_HexExtensions_kt__wu8rc3();
  var byteSeparatorLength = bytesFormat.js_1.length;
  // Inline function 'kotlin.require' call
  // Inline function 'kotlin.require' call
  ...
  if (byteSeparatorLength === 0) {
    ...
    var byteSeparatorChar = charCodeAt(bytesFormat.js_1, 0);
...
function replaceIndent(_this__u8e3s4, newIndent) {
  ...
  return joinTo_0(destination_1, StringBuilder.kc(tmp2), '\n').toString();
}
function replaceIndentByMargin(_this__u8e3s4, newIndent, marginPrefix) {
  ...
  return joinTo_0(destination, StringBuilder.kc(tmp2), '\n').toString();
}
...
function numberFormatError(input) {
  throw NumberFormatException.if("Invalid number format: '" + input + "'");
}
...
function substring_1(_this__u8e3s4, range) {
  return substring(_this__u8e3s4, range.mi(), range.ni() + 1 | 0);
}
...
function split_1(_this__u8e3s4, delimiter, ignoreCase, limit) {
  ...
  var result = ArrayList.d2(isLimited ? coerceAtMost_0(limit, 10) : 10);
  $l$loop: do {
...
function substring_2(_this__u8e3s4, range) {
  return toString_1(charSequenceSubSequence(_this__u8e3s4, range.mi(), range.ni() + 1 | 0));
}
...
function calcNext_1($this) {
  if ($this.ct_1 < 0) {
    ...
    var tmp_0;
    if ($this.ft_1.it_1 > 0) {
      $this.et_1 = $this.et_1 + 1 | 0;
      tmp_0 = $this.et_1 >= $this.ft_1.it_1;
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
      ...
      tmp = $this.ct_1 > charSequenceLength($this.ft_1.gt_1);
    }
    if (tmp) {
      $this.dt_1 = numberRangeToNumber($this.bt_1, get_lastIndex_4($this.ft_1.gt_1));
      $this.ct_1 = -1;
    } else {
      var match = $this.ft_1.jt_1($this.ft_1.gt_1, $this.ct_1);
      if (match == null) {
        $this.dt_1 = numberRangeToNumber($this.bt_1, get_lastIndex_4($this.ft_1.gt_1));
        $this.ct_1 = -1;
      } else {
        var index = match.sl();
        var length = match.tl();
        $this.dt_1 = until($this.bt_1, index);
        $this.bt_1 = index + length | 0;
        $this.ct_1 = $this.bt_1 + (length === 0 ? 1 : 0) | 0;
      }
    }
    $this.at_1 = 1;
  }
...
function Duration__isInfinite_impl_tsn9y3($this) {
  return _get_rawValue__5zfu4e($this) === _get_rawValue__5zfu4e(Companion_getInstance_23().nt_1) || _get_rawValue__5zfu4e($this) === _get_rawValue__5zfu4e(Companion_getInstance_23().ot_1);
}
...
function Duration__compareTo_impl_pchp0f_0($this, other) {
  return Duration__compareTo_impl_pchp0f($this.st_1, other instanceof Duration ? other.st_1 : THROW_CCE());
}
...
function Duration__toLong_impl_shr43i($this, unit) {
  ...
  return tmp0_subject === _get_rawValue__5zfu4e(Companion_getInstance_23().nt_1) ? 9223372036854775807n : tmp0_subject === _get_rawValue__5zfu4e(Companion_getInstance_23().ot_1) ? -9223372036854775808n : convertDurationUnit(_get_value__a43j40_0($this), _get_storageUnit__szjgha($this), unit);
}
...
function Duration__toString_impl_8d916b($this) {
  ...
  if (tmp0_subject === 0n) {
    tmp = '0s';
  } else if (tmp0_subject === _get_rawValue__5zfu4e(Companion_getInstance_23().nt_1)) {
    tmp = 'Infinity';
  } else if (tmp0_subject === _get_rawValue__5zfu4e(Companion_getInstance_23().ot_1)) {
    tmp = '-Infinity';
  } else {
    ...
    var components = 0;
    if (hasDays) {
      this_0.ih(tmp0).k1(_Char___init__impl__6a9atx(100));
    ...
    if (hasHours || (hasDays && (hasMinutes || hasSeconds))) {
      ...
      this_0.hh(tmp2).k1(_Char___init__impl__6a9atx(104));
    }
    if (hasMinutes || (hasSeconds && (hasHours || hasDays))) {
      ...
      this_0.hh(tmp4).k1(_Char___init__impl__6a9atx(109));
    }
    if (hasSeconds) {
      ...
      if (!(tmp6 === 0) || hasDays || hasHours || hasMinutes) {
        ...
        this_0.hh(nanoseconds).i1('ns');
    }
    if (isNegative && components > 1) {
      this_0.jh(1, _Char___init__impl__6a9atx(40)).k1(_Char___init__impl__6a9atx(41));
    }
    tmp = this_0.toString();
  }
  return tmp;
...
function appendFractional($this, $receiver, whole, fractional, fractionalSize, unit, isoZeroes) {
  ...
  if (!(fractional === 0)) {
    ...
    if (!isoZeroes && nonZeroDigits < 3) {
      ...
      $receiver.fh(fracString, 0, nonZeroDigits);
    } else {
      // Inline function 'kotlin.text.appendRange' call
      var endIndex = imul_0((nonZeroDigits + 2 | 0) / 3 | 0, 3);
      $receiver.fh(fracString, 0, endIndex);
    }
  }
  $receiver.i1(unit);
}
function Duration__toIsoString_impl_9h6wsm($this) {
  ...
  if (hasHours) {
    this_0.ih(hours).k1(_Char___init__impl__6a9atx(72));
  }
  if (hasMinutes) {
    this_0.hh(tmp2).k1(_Char___init__impl__6a9atx(77));
  }
...
function parseDuration(value, strictIso, throwException) {
  ...
  if (charSequenceLength(value) === 0) {
    ...
    return Companion_getInstance_23().qt_1;
  }
  var index = 0;
    ...
    if (charCodeAt(value, index) === _Char___init__impl__6a9atx(80)) {
      ...
      if (strictIso) {
        ...
        if (regionMatches(value, tmp_0, 'Infinity', 0, tmp$ret$4, true)) {
          tmp = Companion_getInstance_23().nt_1;
        } else {
  ...
  var result = tmp;
  return isNegative && !(result === Companion_getInstance_23().qt_1) ? Duration__unaryMinus_impl_x2k1y0(result) : result;
}
...
function durationOfNanos(normalNanos) {
  return Companion_getInstance_23().rt(shiftLeft(normalNanos, 1));
}
function parseIsoStringFormat(value, startIndex, throwException) {
  ...
  $l$loop: while (index < value.length) {
    ...
    var sign;
    var tmp0 = Companion_getInstance_24().vt_1;
    var tmp4 = index;
    var tmp$ret$2;
    $l$block: {
...
function parseDefaultStringFormat(value, startIndex, hasSign, throwException) {
  ...
  while (index < length) {
    ...
    var longStartIndex = index;
    var tmp0 = Companion_getInstance_24().wt_1;
    var tmp4 = index;
    var tmp$ret$3;
    $l$block: {
      // Inline function 'kotlin.time.LongParser.parse' call
...
function formatIso(instant) {
  ...
  // Inline function 'kotlin.apply' call
  var this_0 = StringBuilder.h1();
  var ldt = Companion_instance_26.lu(instant);
  var number = ldt.mu_1;
  ...
  if (abs_0(number) < 1000) {
    ...
    if (number >= 0) {
      ...
      innerBuilder.hh(number + 10000 | 0).mh(0);
    } else {
      // Inline function 'kotlin.text.deleteAt' call
      innerBuilder.hh(number - 10000 | 0).mh(1);
    }
    this_0.j2(innerBuilder);
  } else {
    if (number >= 10000) {
  ...
  this_0.k1(_Char___init__impl__6a9atx(45));
  formatIso$appendTwoDigits(this_0, this_0, ldt.nu_1);
  this_0.k1(_Char___init__impl__6a9atx(45));
  formatIso$appendTwoDigits(this_0, this_0, ldt.ou_1);
  this_0.k1(_Char___init__impl__6a9atx(84));
  formatIso$appendTwoDigits(this_0, this_0, ldt.pu_1);
  this_0.k1(_Char___init__impl__6a9atx(58));
  formatIso$appendTwoDigits(this_0, this_0, ldt.qu_1);
  this_0.k1(_Char___init__impl__6a9atx(58));
  formatIso$appendTwoDigits(this_0, this_0, ldt.ru_1);
  if (!(ldt.su_1 === 0)) {
    this_0.k1(_Char___init__impl__6a9atx(46));
    var zerosToStrip = 0;
    while ((ldt.su_1 % get_POWERS_OF_TEN()[zerosToStrip + 1 | 0] | 0) === 0) {
      zerosToStrip = zerosToStrip + 1 | 0;
    }
    zerosToStrip = zerosToStrip - (zerosToStrip % 3 | 0) | 0;
    var numberToOutput = ldt.su_1 / get_POWERS_OF_TEN()[zerosToStrip] | 0;
...
function parseIso(isoString) {
  ...
  var daySeconds = (imul_0(this_0.pu_1, 3600) + imul_0(this_0.qu_1, 60) | 0) + this_0.ru_1 | 0;
  // Inline function 'kotlin.Long.times' call
  // Inline function 'kotlin.Long.plus' call
...
function invoke(_this__u8e3s4, value) {
  _init_properties_DeepRecursive_kt__zbwcac();
  return (new DeepRecursiveScopeImpl(_this__u8e3s4.dv_1, value)).iv();
}
...
function Result__equals_impl_bxgmep($this, other) {
  if (!(other instanceof Result))
    return false;
  var tmp0_other_with_cast = other.nv_1;
...
function UByte__compareTo_impl_5w5192_0($this, other) {
  return UByte__compareTo_impl_5w5192($this.ew_1, other instanceof UByte ? other.ew_1 : THROW_CCE());
}
...
function UByteArray__contains_impl_njh19q_0($this, element) {
  if (!(element instanceof UByte))
    return false;
  return UByteArray__contains_impl_njh19q($this.jw_1, element instanceof UByte ? element.ew_1 : THROW_CCE());
}
...
function UInt__compareTo_impl_yacclj_0($this, other) {
  return UInt__compareTo_impl_yacclj($this.pw_1, other instanceof UInt ? other.pw_1 : THROW_CCE());
}
...
function UIntArray__contains_impl_b16rzj_0($this, element) {
  if (!(element instanceof UInt))
    return false;
  return UIntArray__contains_impl_b16rzj($this.uw_1, element instanceof UInt ? element.pw_1 : THROW_CCE());
}
...
function UIntArray__equals_impl_flcmof($this, other) {
  if (!(other instanceof UIntArray))
    return false;
  var tmp0_other_with_cast = other.uw_1;
  if (!equals($this, tmp0_other_with_cast))
    return false;
  return true;
}
...
function ULongArray__contains_impl_v9bgai_0($this, element) {
  if (!(element instanceof ULong))
    return false;
  return ULongArray__contains_impl_v9bgai($this.rx_1, element instanceof ULong ? element.m3_1 : THROW_CCE());
}
...
function ULongArray__equals_impl_vwitwa($this, other) {
  if (!(other instanceof ULongArray))
    return false;
  var tmp0_other_with_cast = other.rx_1;
  if (!equals($this, tmp0_other_with_cast))
    return false;
  return true;
}
...
function UShort__compareTo_impl_1pfgyc_0($this, other) {
  return UShort__compareTo_impl_1pfgyc($this.wx_1, other instanceof UShort ? other.wx_1 : THROW_CCE());
}
...
function UShortArray__contains_impl_vo7k3g_0($this, element) {
  if (!(element instanceof UShort))
    return false;
  return UShortArray__contains_impl_vo7k3g($this.by_1, element instanceof UShort ? element.wx_1 : THROW_CCE());
}
...
function UShortArray__equals_impl_tyc3mk($this, other) {
  if (!(other instanceof UShortArray))
    return false;
  var tmp0_other_with_cast = other.by_1;
  if (!equals($this, tmp0_other_with_cast))
    return false;
  return true;
}
...
initMetadataForClass(Exception, 'Exception', Exception.oe);
initMetadataForClass(RuntimeException, 'RuntimeException', RuntimeException.je);
...
initMetadataForClass(HashSet, 'HashSet', HashSet.ua, VOID, [KtMutableSet]);
...
protoOf(InternalHashMap).oa = containsAllEntries;
...
initMetadataForClass(IllegalArgumentException, 'IllegalArgumentException', IllegalArgumentException.le);
initMetadataForClass(NoSuchElementException, 'NoSuchElementException', NoSuchElementException.n7);
initMetadataForClass(IndexOutOfBoundsException, 'IndexOutOfBoundsException', IndexOutOfBoundsException.te);
...
initMetadataForClass(ArithmeticException, 'ArithmeticException', ArithmeticException.xe);
initMetadataForClass(Error_0, 'Error', Error_0.af);
initMetadataForClass(NumberFormatException, 'NumberFormatException', NumberFormatException.hf);
initMetadataForClass(AssertionError, 'AssertionError', AssertionError.lf);
initMetadataForClass(UninitializedPropertyAccessException, 'UninitializedPropertyAccessException', UninitializedPropertyAccessException.nf);
initMetadataForClass(ConcurrentModificationException, 'ConcurrentModificationException', ConcurrentModificationException.tb);
...
initMetadataForClass(CharacterCodingException, 'CharacterCodingException', CharacterCodingException.ch);
...
initMetadataForClass(ArrayDeque, 'ArrayDeque', ArrayDeque.al);
...
protoOf(CombinedContext).no = plus;
initMetadataForClass(CombinedContext, 'CombinedContext', VOID, VOID, [CoroutineContext]);
initMetadataForClass(AbstractCoroutineContextKey, 'AbstractCoroutineContextKey');
protoOf(AbstractCoroutineContextElement).rd = get;
protoOf(AbstractCoroutineContextElement).mo = fold;
protoOf(AbstractCoroutineContextElement).lo = minusKey;
protoOf(AbstractCoroutineContextElement).no = plus;
...
initMetadataForClass(NotImplementedError, 'NotImplementedError', NotImplementedError.ce);
