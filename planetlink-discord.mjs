...
class DiscordAction extends AccountActionImpl {
  constructor(account, auth) {
    ...
    super(account);
    this.auth = auth;
    this.dlk_1 = new DiscordActionHelper(this);
  }
  o61() {
    return this.auth;
  }
  ...
  *w2t($completion) {
    return yield* this.dlk_1.glk($completion);
  }
  *f2x($completion) {
    var tmp0_elvis_lhs = this.me;
    return tmp0_elvis_lhs == null ? (yield* this.dlk_1.glk($completion)) : tmp0_elvis_lhs;
  }
  *x2t(id, $completion) {
    return yield* this.dlk_1.hlk(id, $completion);
  }
  *g2w(id, paging, $completion) {
    ...
    return yield* this.dlk_1.ti3(tmp$ret$0, paging, $completion);
  }
  ...
  *h2v(id, $completion) {
    return yield* this.dlk_1.ilk(id, $completion);
  }
  *f2v(req, $completion) {
    yield* this.dlk_1.f2v(req, $completion);
  ...
  *p2v(id, $completion) {
    yield* this.dlk_1.p2v(id, $completion);
    return Unit_instance;
  }
  *j2v(id, $completion) {
    yield* this.dlk_1.j2v(id, $completion);
    return Unit_instance;
  }
  *k2v(id, $completion) {
    yield* this.dlk_1.k2v(id, $completion);
    return Unit_instance;
  }
  *n2v(id, reaction, $completion) {
    yield* this.dlk_1.n2v(id, reaction, $completion);
    return Unit_instance;
  }
  *o2v(id, reaction, $completion) {
    yield* this.dlk_1.o2v(id, reaction, $completion);
    return Unit_instance;
  }
  *c2w(paging, $completion) {
    return yield* this.dlk_1.jlk(paging, $completion);
  }
  *e2w(id, paging, $completion) {
    ...
    return yield* this.dlk_1.klk(tmp$ret$0, paging, $completion);
  }
  *q2w(paging, $completion) {
    return yield* this.dlk_1.q2w(paging, $completion);
  }
  *v2w(callback, $completion) {
    return this.dlk_1.llk(callback);
  }
...
class DiscordActionHelper {
  ...
  *glk($completion) {
    return yield* this.flk_1.nlk(DiscordActionHelper$fetchUserMe$slambda(this), $completion);
  }
  *hlk(id, $completion) {
    return yield* this.flk_1.nlk(DiscordActionHelper$getUser$slambda(this, id), $completion);
  }
  *ti3(channelId, paging, $completion) {
    var userMe = yield* this.flk_1.g2x($completion);
    return yield* this.flk_1.nlk(DiscordActionHelper$getChannelTimeLine$slambda(paging, this, channelId, userMe), $completion);
  }
  *ilk(id, $completion) {
    var channelId = getChannelId(this, id);
    var userMe = yield* this.flk_1.g2x($completion);
    return yield* this.flk_1.nlk(DiscordActionHelper$getComment$slambda(this, channelId, id, userMe), $completion);
  }
  *f2v(req, $completion) {
    var channelId = yield* /*#__NOINLINE__*/resolveChannelId(this, req, $completion);
    yield* this.flk_1.olk(DiscordActionHelper$postComment$slambda(this, channelId, req), $completion);
    return Unit_instance;
  }
  *p2v(id, $completion) {
    var channelId = getChannelId(this, id);
    yield* this.flk_1.olk(DiscordActionHelper$deleteComment$slambda(this, channelId, id), $completion);
    return Unit_instance;
  }
  *j2v(id, $completion) {
  ...
  *n2v(id, reaction, $completion) {
    var channelId = getChannelId(this, id);
    yield* this.flk_1.olk(DiscordActionHelper$reactionComment$slambda(this, channelId, id, reaction), $completion);
    return Unit_instance;
  }
  *o2v(id, reaction, $completion) {
    var channelId = getChannelId(this, id);
    yield* this.flk_1.olk(DiscordActionHelper$unreactionComment$slambda(this, channelId, id, reaction), $completion);
    return Unit_instance;
  }
  *jlk(paging, $completion) {
    return yield* this.flk_1.nlk(DiscordActionHelper$fetchSpaces$slambda(paging, this), $completion);
  }
  *klk(guildId, paging, $completion) {
    return yield* this.flk_1.nlk(DiscordActionHelper$channels$slambda(this, guildId, paging), $completion);
  }
  *q2w(paging, $completion) {
    return yield* this.flk_1.nlk(DiscordActionHelper$messageThread$slambda(this, paging), $completion);
  }
  llk(callback) {
...
class DiscordAuth {
  ...
  getAccountWithToken(token) {
    ...
    tmp.cll_1 = new DiscordAccessor(tmp1_elvis_lhs == null ? DiscordFactory_instance.instance(token) : tmp1_elvis_lhs, token);
...
class sam$kotlin_Comparator$0 {
  constructor(function_0) {
    this.gll_1 = function_0;
  }
  sj(a, b) {
    return this.gll_1(a, b);
  }
  compare(a, b) {
    return this.sj(a, b);
  }
...
class DiscordMapper$attributedText$MentionInfo {
  constructor(displayName, id) {
    this.ell_1 = displayName;
    this.fll_1 = id;
  }
  toString() {
    return 'MentionInfo(displayName=' + this.ell_1 + ', id=' + this.fll_1 + ')';
  }
  hashCode() {
    var result = getStringHashCode(this.ell_1);
    result = imul(result, 31) + getStringHashCode(this.fll_1) | 0;
    return result;
  }
  equals(other) {
    if (this === other)
    ...
    if (!(other instanceof DiscordMapper$attributedText$MentionInfo))
      return false;
    if (!(this.ell_1 === other.ell_1))
      return false;
    if (!(this.fll_1 === other.fll_1))
      return false;
    return true;
  }
}
class DiscordMapper {
  constructor() {
    ...
    var this_0 = '<@!?([0-9]+)>';
    tmp.ulk_1 = Regex.ji(this_0);
  }
  vlk(user, service) {
    // Inline function 'kotlin.apply' call
    var this_0 = DiscordUser.lll(service);
    var tmp = this_0;
  ...
  xlk(message, userMe, service) {
    // Inline function 'kotlin.apply' call
    var this_0 = DiscordComment.mll(service);
    var tmp = this_0;
    var tmp0_elvis_lhs = message.id;
    tmp.id = _ID___init__impl__k1lb7e(tmp0_elvis_lhs == null ? '' : tmp0_elvis_lhs);
    this_0.channelId = message.channelId;
    this_0.guildId = message.guildId;
    this_0.createAt = DiscordMapper_getInstance().nll(message.timestamp);
    ...
    if (tmp1_safe_receiver == null) {
      ...
      // Inline function 'kotlin.let' call
      tmp_1 = DiscordMapper_getInstance().vlk(tmp1_safe_receiver, service);
    }
    tmp_0.user = tmp_1;
    this_0.text = attributedText(DiscordMapper_getInstance(), message);
    this_0.directMessage = message.guildId == null;
    this_0.medias = DiscordMapper_getInstance().oll(message);
    this_0.j35(DiscordMapper_getInstance().pll(message.reactions, userMe));
    var tmp_2 = this_0;
    ...
    if (tmp7_safe_receiver == null) {
      ...
      while (inductionVariable < last) {
        ...
        var tmp$ret$6 = DiscordMapper_getInstance().qll(item);
    ...
    if (tmp9_safe_receiver == null) {
      ...
      while (inductionVariable_0 < last_0) {
        ...
        var tmp$ret$9 = DiscordMapper_getInstance().rll(item_0);
    ...
    this_0.reactionDetails = DiscordMapper_getInstance().sll(message.reactions);
    return this_0;
  }
  wlk(messages, userMe, service, paging) {
    ...
    while (_iterator__ex2g4s.m1()) {
      ...
      var tmp$ret$2 = DiscordMapper_getInstance().xlk(item, userMe, service);
  ...
  tll(guild, service) {
    // Inline function 'kotlin.apply' call
    var this_0 = DiscordSpace.ull(service);
    var tmp = this_0;
  ...
  ylk(guilds, service, paging) {
    ...
    while (_iterator__ex2g4s.m1()) {
      var item = _iterator__ex2g4s.n1();
      var tmp$ret$2 = DiscordMapper_getInstance().tll(item, service);
      destination.i2(tmp$ret$2);
    }
  ...
  vll(channel, service) {
    // Inline function 'kotlin.apply' call
    var this_0 = DiscordChannel.wll(service);
    var tmp = this_0;
  ...
  zlk(channels, service, paging) {
    ...
    while (_iterator__ex2g4s.m1()) {
      var item = _iterator__ex2g4s.n1();
      var tmp$ret$2 = DiscordMapper_getInstance().vll(item, service);
      destination.i2(tmp$ret$2);
    }
  ...
  xll(channel, service) {
    // Inline function 'kotlin.apply' call
    var this_0 = DiscordThread.yll(service);
    var tmp = this_0;
    var tmp0_elvis_lhs = channel.id;
    tmp.id = _ID___init__impl__k1lb7e(tmp0_elvis_lhs == null ? '' : tmp0_elvis_lhs);
    ...
    if (tmp4_safe_receiver == null) {
      ...
      while (inductionVariable_0 < last_0) {
        ...
        inductionVariable_0 = inductionVariable_0 + 1 | 0;
        var tmp$ret$11 = DiscordMapper_getInstance().vlk(item, service);
  ...
  bll(channels, service, paging) {
    ...
    while (_iterator__ex2g4s.m1()) {
      var item = _iterator__ex2g4s.n1();
      var tmp$ret$2 = DiscordMapper_getInstance().xll(item, service);
      destination.i2(tmp$ret$2);
    }
    model.n39(destination);
    model.l39(Companion_instance_3.fromPaging(paging));
  ...
  oll(message) {
    ...
    while (inductionVariable < last) {
      var item = this_0[inductionVariable];
      inductionVariable = inductionVariable + 1 | 0;
      var tmp$ret$4 = DiscordMapper_getInstance().zll(item);
...
class DiscordStreamListenerImpl {
  ...
  onMessageCreate(message) {
    ...
    if (isInterface(tmp, UpdateCommentCallback)) {
      var comment = DiscordMapper_getInstance().xlk(message, null, this.blm_1);
      this.alm_1.onUpdate(new CommentEvent(comment));
    }
  }
  ...
  onMessageDelete(event) {
    ...
    if (isInterface(tmp, DeleteCommentCallback)) {
      ...
      if (tmp0_safe_receiver == null)
        ...
        // Inline function 'kotlin.let' call
        this.alm_1.onDelete(new IdentifyEvent(tmp0_safe_receiver));
      }
    }
  }
  onOpen() {
    ...
    if (isInterface(tmp, ConnectCallback)) {
      this.alm_1.onConnect();
    }
  }
  onClose() {
    var tmp = this.alm_1;
    if (isInterface(tmp, DisconnectCallback)) {
      this.alm_1.onDisconnect();
    }
  }
  onError(error) {
    var tmp = this.alm_1;
    if (isInterface(tmp, ErrorCallback)) {
      this.alm_1.onError(ExceptionHandler_instance.z3k(error, ServiceType_Discord_getInstance()));
    }
  }
}
class PlanetLinkEx {
  clm(_this__u8e3s4, apiHost) {
    return new DiscordAuth(apiHost);
  }
  discord(_this__u8e3s4, apiHost, $super) {
    apiHost = apiHost === VOID ? null : apiHost;
    return $super === VOID ? this.clm(_this__u8e3s4, apiHost) : $super.clm.call(this, _this__u8e3s4, apiHost);
  }
}
class ServiceEx {
  dlm(_this__u8e3s4) {
...
class DiscordComment extends Comment {
  ...
  j35(value) {
    this.rlk_1 = toMutableList(value);
  }
  k35() {
    var tmp0_elvis_lhs = this.rlk_1;
    return tmp0_elvis_lhs == null ? emptyList() : tmp0_elvis_lhs;
  }
  applyReaction(reaction) {
    if (this.rlk_1 == null) {
      this.rlk_1 = mutableListOf([reaction]);
      return Unit_instance;
    }
    // Inline function 'kotlin.collections.find' call
    var tmp0 = ensureNotNull(this.rlk_1);
    var tmp$ret$1;
    $l$block: {
    ...
    ensureNotNull(this.rlk_1).i2(reaction);
  }
  m35() {
    // Inline function 'kotlin.also' call
...
function DiscordAction$proceed$lambda(e) {
  ...
  return tmp0_safe_receiver == null ? null : tmp0_safe_receiver.kkw_1;
}
function DiscordAction$proceed$lambda_0(e) {
  var tmp0_safe_receiver = e instanceof DiscordException ? e : null;
  return tmp0_safe_receiver == null ? null : tmp0_safe_receiver.lkw_1;
}
...
function _get_auth__d3zq1v($this) {
  return $this.flk_1.auth;
}
function _get_service__d270n8($this) {
  return $this.flk_1.account.service;
}
...
function *resolveChannelId($this, req, $completion) {
  ...
  if (!(recipientId == null || charSequenceLength(recipientId) === 0)) {
    return yield* $this.flk_1.nlk(DiscordActionHelper$resolveChannelId$slambda($this, recipientId), $completion);
  }
...
function DiscordActionHelper$fetchUserMe$slambda(this$0) {
  return constructCallableReference(function *($completion) {
    ...
    var user = DiscordMapper_getInstance().vlk(response.data, _get_service__d270n8(this$0));
    this$0.flk_1.mlk(user);
    return user;
  }, 0);
}
function DiscordActionHelper$getUser$slambda(this$0, $id) {
  return constructCallableReference(function *($completion) {
    ...
    return DiscordMapper_getInstance().vlk(response.data, _get_service__d270n8(this$0));
  }, 0);
}
function DiscordActionHelper$getChannelTimeLine$slambda($paging, this$0, $channelId, $userMe) {
  return constructCallableReference(function *($completion) {
    ...
    return DiscordMapper_getInstance().wlk(toList(response.data), $userMe, _get_service__d270n8(this$0), $paging);
  }, 0);
}
function DiscordActionHelper$getComment$slambda(this$0, $channelId, $id, $userMe) {
  return constructCallableReference(function *($completion) {
    ...
    return DiscordMapper_getInstance().xlk(response.data, $userMe, _get_service__d270n8(this$0));
  }, 0);
}
...
function DiscordActionHelper$fetchSpaces$slambda($paging, this$0) {
  return constructCallableReference(function *($completion) {
    ...
    dp.count = limit;
    return DiscordMapper_getInstance().ylk(toList(response.data), _get_service__d270n8(this$0), dp);
  }, 0);
}
function DiscordActionHelper$channels$slambda(this$0, $guildId, $paging) {
  return constructCallableReference(function *($completion) {
    ...
    return DiscordMapper_getInstance().zlk(toList(response.data), _get_service__d270n8(this$0), $paging);
  }, 0);
}
function DiscordActionHelper$messageThread$slambda(this$0, $paging) {
  return constructCallableReference(function *($completion) {
    ...
    return DiscordMapper_getInstance().bll(toList(response.data), _get_service__d270n8(this$0), $paging);
  }, 0);
}
...
function attributedText($this, message) {
  ...
  var last_0 = 0;
  var _iterator__ex2g4s = DiscordMapper_getInstance().ulk_1.oi(content).l1();
  while (_iterator__ex2g4s.m1()) {
  ...
  while (_iterator__ex2g4s_0.m1()) {
    ...
    if (element_0.kind.equals(AttributedKind_PLAIN_getInstance())) {
      ...
      while (_iterator__ex2g4s_1.m1()) {
        ...
        this_3.j3c_1 = '@' + info.ell_1;
        this_3.k3c_1 = info.fll_1;
