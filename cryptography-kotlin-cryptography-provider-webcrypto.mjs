...
class WebCryptoAes {
  constructor(algorithmName, keyWrapper) {
    this.cng_1 = algorithmName;
    this.dng_1 = keyWrapper;
  }
}
...
class Companion {
  constructor() {
    ...
    this.vnf_1 = new WebCryptoDigest('SHA-1', SHA1_getInstance());
    this.wnf_1 = new WebCryptoDigest('SHA-256', SHA256_getInstance());
    this.xnf_1 = new WebCryptoDigest('SHA-384', SHA384_getInstance());
    this.ynf_1 = new WebCryptoDigest('SHA-512', SHA512_getInstance());
  }
}
class WebCryptoDigest {
  constructor(algorithm, id) {
    Companion_getInstance_12();
    this.eng_1 = algorithm;
    this.fng_1 = id;
  }
  bnd() {
    return this;
...
class EcPrivateKey extends WebCryptoEncodableKey {
  constructor($outer, privateKey, $box) {
    ...
    this.lng_1 = privateKey;
  }
}
class WebCryptoEc {
  constructor(algorithmName, publicKeyWrapper, privateKeyWrapper, keyPairWrapper) {
    this.png_1 = algorithmName;
    this.qng_1 = publicKeyWrapper;
    this.rng_1 = privateKeyWrapper;
    var tmp = this;
    var tmp0 = this.qng_1.nng_1;
    // Inline function 'kotlin.collections.plus' call
    var elements = this.rng_1.nng_1;
    // Inline function 'kotlin.js.asDynamic' call
    tmp.sng_1 = tmp0.concat(elements);
    var tmp_0 = this;
    tmp_0.tng_1 = WebCryptoEc$keyPairWrapper$lambda(keyPairWrapper, this);
  }
}
...
class EcdhKeyPair {
  constructor(publicKey, privateKey) {
    this.ung_1 = publicKey;
    this.vng_1 = privateKey;
  }
}
...
class EcdsaKeyPair {
  constructor(publicKey, privateKey) {
    this.wng_1 = publicKey;
    this.xng_1 = privateKey;
  }
}
...
class WebCryptoEdDsa {
  constructor() {
    ...
    // Inline function 'kotlin.js.asDynamic' call
    var tmp_0 = ['verify'];
    tmp.gnh_1 = new WebCryptoKeyWrapper(tmp_0, WebCryptoEdDsa$EdDsaPublicKey$_init_$ref_xkwfek());
    var tmp_1 = this;
    // Inline function 'kotlin.arrayOf' call
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    var tmp_2 = ['sign'];
    tmp_1.hnh_1 = new WebCryptoKeyWrapper(tmp_2, WebCryptoEdDsa$EdDsaPrivateKey$_init_$ref_9jweho());
    var tmp_3 = this;
    var tmp0 = this.gnh_1.nng_1;
    // Inline function 'kotlin.collections.plus' call
    var elements = this.hnh_1.nng_1;
    // Inline function 'kotlin.js.asDynamic' call
    tmp_3.inh_1 = tmp0.concat(elements);
    var tmp_4 = this;
    tmp_4.jnh_1 = WebCryptoEdDsa$keyPairWrapper$lambda;
  }
}
...
class WebCryptoHmac {
  constructor() {
    ...
    tmp.nnh_1 = new WebCryptoKeyWrapper(tmp_0, WebCryptoHmac$HmacKey$_init_$ref_enwl2t());
  }
}
...
class RsaPrivateKey extends WebCryptoEncodableKey {
  constructor($outer, privateKey, $box) {
    ...
    this.tnh_1 = privateKey;
  }
}
class WebCryptoRsa {
  constructor(algorithmName, publicKeyWrapper, privateKeyWrapper, keyPairWrapper) {
    this.vnh_1 = algorithmName;
    this.wnh_1 = publicKeyWrapper;
    this.xnh_1 = privateKeyWrapper;
    var tmp = this;
    var tmp0 = this.wnh_1.nng_1;
    // Inline function 'kotlin.collections.plus' call
    var elements = this.xnh_1.nng_1;
    // Inline function 'kotlin.js.asDynamic' call
    tmp.ynh_1 = tmp0.concat(elements);
    var tmp_0 = this;
    tmp_0.znh_1 = WebCryptoRsa$keyPairWrapper$lambda(keyPairWrapper, this);
  }
}
...
class RsaOaepKeyPair {
  constructor(publicKey, privateKey) {
    this.ani_1 = publicKey;
    this.bni_1 = privateKey;
  }
}
...
class RsaPkcs1KeyPair {
  constructor(publicKey, privateKey) {
    this.cni_1 = publicKey;
    this.dni_1 = privateKey;
  }
}
...
class RsaPssKeyPair {
  constructor(publicKey, privateKey) {
    this.eni_1 = publicKey;
    this.fni_1 = privateKey;
  }
}
...
class WebCryptoXdh {
  constructor() {
    ...
    // Inline function 'kotlin.js.asDynamic' call
    var tmp_0 = [];
    tmp.oni_1 = new WebCryptoKeyWrapper(tmp_0, WebCryptoXdh$XdhPublicKey$_init_$ref_58foni());
    var tmp_1 = this;
    // Inline function 'kotlin.arrayOf' call
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    var tmp_2 = ['deriveBits'];
    tmp_1.pni_1 = new WebCryptoKeyWrapper(tmp_2, WebCryptoXdh$XdhPrivateKey$_init_$ref_gt5z3q());
    var tmp_3 = this;
    var tmp0 = this.oni_1.nng_1;
    // Inline function 'kotlin.collections.plus' call
    var elements = this.pni_1.nng_1;
    // Inline function 'kotlin.js.asDynamic' call
    tmp_3.qni_1 = tmp0.concat(elements);
    var tmp_4 = this;
    tmp_4.rni_1 = WebCryptoXdh$keyPairWrapper$lambda;
  }
}
...
function WebCryptoEc$keyPairWrapper$lambda($keyPairWrapper, this$0) {
  return (it) => $keyPairWrapper(this$0.qng_1.ong_1(it.publicKey), this$0.rng_1.ong_1(it.privateKey));
}
...
function WebCryptoRsa$keyPairWrapper$lambda($keyPairWrapper, this$0) {
  return (it) => $keyPairWrapper(this$0.wnh_1.ong_1(it.publicKey), this$0.xnh_1.ong_1(it.privateKey));
}
...
function initHook$init$() {
  CryptographySystem_getInstance().vnb(get_defaultProvider(), 100);
