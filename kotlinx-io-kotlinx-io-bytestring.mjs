...
class Companion {
  constructor() {
    ...
    this.e21_1 = ByteString.i21(new Int8Array(0), null);
    this.f21_1 = toCharArray('0123456789abcdef');
  }
  j21(byteArray) {
    return ByteString.i21(byteArray, null);
  }
}
class ByteString {
  constructor(data, dummy) {
    return new.target.i21(data, dummy);
  }
  static i21(data, dummy) {
  ...
  static k21(data, startIndex, endIndex) {
    Companion_getInstance();
    startIndex = startIndex === VOID ? 0 : startIndex;
    endIndex = endIndex === VOID ? data.length : endIndex;
    return this.i21(copyOfRange(data, startIndex, endIndex), null);
  }
  l2() {
    return this.g21_1.length;
  }
  equals(other) {
    if (this === other)
      return true;
    ...
    if (!(other instanceof ByteString))
      THROW_CCE();
    if (!(other.g21_1.length === this.g21_1.length))
      return false;
    if (!(other.h21_1 === 0) && !(this.h21_1 === 0) && !(other.h21_1 === this.h21_1))
      return false;
    return contentEquals(this.g21_1, other.g21_1);
  }
  hashCode() {
    var hc = this.h21_1;
    if (hc === 0) {
      hc = contentHashCode(this.g21_1);
      this.h21_1 = hc;
    }
    return hc;
  }
  n2(index) {
    ...
    return this.g21_1[index];
  }
  p20(startIndex, endIndex) {
    var tmp;
    if (startIndex === endIndex) {
      tmp = Companion_getInstance().e21_1;
    } else {
      tmp = ByteString.k21(this.g21_1, startIndex, endIndex);
    }
    return tmp;
  }
  l21(startIndex, endIndex, $super) {
    endIndex = endIndex === VOID ? this.l2() : endIndex;
    return $super === VOID ? this.p20(startIndex, endIndex) : $super.p20.call(this, startIndex, endIndex);
  }
  m21(other) {
    if (other === this)
      return 0;
    var localData = this.g21_1;
    var otherData = other.g21_1;
  ...
  d(other) {
    return this.m21(other instanceof ByteString ? other : THROW_CCE());
  }
  toString() {
    if (isEmpty(this)) {
    ...
    if (inductionVariable < last)
      do {
        ...
        inductionVariable = inductionVariable + 1 | 0;
        var b = localData[i];
        $this$with.k1(Companion_getInstance().f21_1[(b >>> 4 | 0) & 15]);
        $this$with.k1(Companion_getInstance().f21_1[b & 15]);
      }
       while (inductionVariable < last);
...
class UnsafeByteStringOperations {
  o21(array) {
    return Companion_getInstance().j21(array);
  }
}
//endregion
...
function ByteString_0(bytes) {
  ...
  if (bytes.length === 0) {
    ...
    tmp = Companion_getInstance().j21(bytes);
  }
  return tmp;
}
function decodeToString_0(_this__u8e3s4) {
  return decodeToString(_this__u8e3s4.n21());
}
