...
class Companion {
  constructor() {
    ...
    this.c21_1 = ByteString.g21(new Int8Array(0), null);
    this.d21_1 = toCharArray('0123456789abcdef');
  }
  h21(byteArray) {
    return ByteString.g21(byteArray, null);
  }
}
class ByteString {
  constructor(data, dummy) {
    return new.target.g21(data, dummy);
  }
  static g21(data, dummy) {
  ...
  static i21(data, startIndex, endIndex) {
    Companion_getInstance();
    startIndex = startIndex === VOID ? 0 : startIndex;
    endIndex = endIndex === VOID ? data.length : endIndex;
    return this.g21(copyOfRange(data, startIndex, endIndex), null);
  }
  l2() {
    return this.e21_1.length;
  }
  equals(other) {
    if (this === other)
      return true;
    ...
    if (!(other instanceof ByteString))
      THROW_CCE();
    if (!(other.e21_1.length === this.e21_1.length))
      return false;
    if (!(other.f21_1 === 0) && !(this.f21_1 === 0) && !(other.f21_1 === this.f21_1))
      return false;
    return contentEquals(this.e21_1, other.e21_1);
  }
  hashCode() {
    var hc = this.f21_1;
    if (hc === 0) {
      hc = contentHashCode(this.e21_1);
      this.f21_1 = hc;
    }
    return hc;
  }
  n2(index) {
    ...
    return this.e21_1[index];
  }
  n20(startIndex, endIndex) {
    var tmp;
    if (startIndex === endIndex) {
      tmp = Companion_getInstance().c21_1;
    } else {
      tmp = ByteString.i21(this.e21_1, startIndex, endIndex);
    }
    return tmp;
  }
  j21(startIndex, endIndex, $super) {
    endIndex = endIndex === VOID ? this.l2() : endIndex;
    return $super === VOID ? this.n20(startIndex, endIndex) : $super.n20.call(this, startIndex, endIndex);
  }
  k21(other) {
    if (other === this)
      return 0;
    var localData = this.e21_1;
    var otherData = other.e21_1;
  ...
  d(other) {
    return this.k21(other instanceof ByteString ? other : THROW_CCE());
  }
  toString() {
    if (isEmpty(this)) {
    ...
    if (inductionVariable < last)
      do {
        ...
        inductionVariable = inductionVariable + 1 | 0;
        var b = localData[i];
        $this$with.k1(Companion_getInstance().d21_1[(b >>> 4 | 0) & 15]);
        $this$with.k1(Companion_getInstance().d21_1[b & 15]);
      }
       while (inductionVariable < last);
...
class UnsafeByteStringOperations {
  m21(array) {
    return Companion_getInstance().h21(array);
  }
}
//endregion
...
function ByteString_0(bytes) {
  ...
  if (bytes.length === 0) {
    ...
    tmp = Companion_getInstance().h21(bytes);
  }
  return tmp;
}
function decodeToString_0(_this__u8e3s4) {
  return decodeToString(_this__u8e3s4.l21());
}
