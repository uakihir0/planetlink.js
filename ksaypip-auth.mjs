...
class SaypipAuthConfig {
  constructor(baseUrl, clientId, clientSecret, redirectUri, scopes, authorizationEndpoint, tokenEndpoint, revokeEndpoint) {
    ...
    scopes = scopes === VOID ? toList(OAuthScope_getInstance().qmw_1) : scopes;
    ...
    this.inc_1 = baseUrl;
    this.jnc_1 = clientId;
    this.knc_1 = clientSecret;
    this.lnc_1 = redirectUri;
    this.mnc_1 = scopes;
    this.nnc_1 = authorizationEndpoint;
    this.onc_1 = tokenEndpoint;
    this.pnc_1 = revokeEndpoint;
  }
  qnc() {
    var tmp0_elvis_lhs = this.nnc_1;
    return tmp0_elvis_lhs == null ? this.inc_1 + '/api/auth/oauth2/authorize' : tmp0_elvis_lhs;
  }
  rnc() {
    var tmp0_elvis_lhs = this.onc_1;
    return tmp0_elvis_lhs == null ? this.inc_1 + '/api/auth/oauth2/token' : tmp0_elvis_lhs;
  }
  toString() {
    return 'SaypipAuthConfig(baseUrl=' + this.inc_1 + ', clientId=' + this.jnc_1 + ', clientSecret=' + this.knc_1 + ', redirectUri=' + this.lnc_1 + ', scopes=' + toString(this.mnc_1) + ', authorizationEndpoint=' + this.nnc_1 + ', tokenEndpoint=' + this.onc_1 + ', revokeEndpoint=' + this.pnc_1 + ')';
  }
  hashCode() {
    var result = getStringHashCode(this.inc_1);
    result = imul(result, 31) + getStringHashCode(this.jnc_1) | 0;
    result = imul(result, 31) + (this.knc_1 == null ? 0 : getStringHashCode(this.knc_1)) | 0;
    result = imul(result, 31) + (this.lnc_1 == null ? 0 : getStringHashCode(this.lnc_1)) | 0;
    result = imul(result, 31) + hashCode(this.mnc_1) | 0;
    result = imul(result, 31) + (this.nnc_1 == null ? 0 : getStringHashCode(this.nnc_1)) | 0;
    result = imul(result, 31) + (this.onc_1 == null ? 0 : getStringHashCode(this.onc_1)) | 0;
    result = imul(result, 31) + (this.pnc_1 == null ? 0 : getStringHashCode(this.pnc_1)) | 0;
    return result;
  }
  equals(other) {
    if (this === other)
    ...
    if (!(other instanceof SaypipAuthConfig))
      return false;
    if (!(this.inc_1 === other.inc_1))
      return false;
    if (!(this.jnc_1 === other.jnc_1))
      return false;
    if (!(this.knc_1 == other.knc_1))
      return false;
    if (!(this.lnc_1 == other.lnc_1))
      return false;
    if (!equals(this.mnc_1, other.mnc_1))
      return false;
    if (!(this.nnc_1 == other.nnc_1))
      return false;
    if (!(this.onc_1 == other.onc_1))
      return false;
    if (!(this.pnc_1 == other.pnc_1))
      return false;
    return true;
  }
}
...
class $serializer {
  constructor() {
    ...
    this.vnc_1 = tmp0_serialDesc;
  }
  wnc(encoder, value) {
    var tmp0_desc = this.vnc_1;
  ...
  tz(encoder, value) {
    return this.wnc(encoder, value instanceof OAuthTokenResponse ? value : THROW_CCE());
  }
  uz(decoder) {
    var tmp0_desc = this.vnc_1;
    var tmp1_flag = true;
    ...
    return OAuthTokenResponse.xnc(tmp3_bitMask0, tmp4_local0, tmp5_local1, tmp6_local2, tmp7_local3, tmp8_local4, null);
  }
  gz() {
    return this.vnc_1;
  }
...
class OAuthTokenResponse {
  ...
  static xnc(seen0, accessToken, tokenType, expiresIn, refreshToken, scope, serializationConstructorMarker) {
    if (!(0 === (0 & seen0))) {
      throwMissingFieldException(seen0, 0, $serializer_getInstance().vnc_1);
    }
...
class PkceHelper {
  ...
  and(codeVerifier) {
    var hasher = Companion_instance.knb().onb(SHA256_getInstance()).bnd();
    var digest = hasher.znb(encodeToByteArray(codeVerifier));
...
class OAuthResourceImpl {
  ...
  gnd(context, request) {
    ...
    var tmp1_elvis_lhs = tmp0_elvis_lhs == null ? context.dnc_1 : tmp0_elvis_lhs;
    var clientId = tmp1_elvis_lhs == null ? this.fnd_1.jnc_1 : tmp1_elvis_lhs;
    var tmp2_elvis_lhs = request.redirectUri;
    var tmp3_elvis_lhs = tmp2_elvis_lhs == null ? context.enc_1 : tmp2_elvis_lhs;
    var redirectUri = tmp3_elvis_lhs == null ? this.fnd_1.lnc_1 : tmp3_elvis_lhs;
    var tmp4_safe_receiver = request.scopes;
    var tmp5_elvis_lhs = tmp4_safe_receiver == null ? null : toList(tmp4_safe_receiver);
    var tmp6_elvis_lhs = tmp5_elvis_lhs == null ? context.fnc_1 : tmp5_elvis_lhs;
    var scopes = tmp6_elvis_lhs == null ? this.fnd_1.mnc_1 : tmp6_elvis_lhs;
    if (isBlank(clientId))
      throw SaypipException.ymn('clientId is required.');
    // Inline function 'kotlin.text.isNullOrBlank' call
    if (redirectUri == null || isBlank(redirectUri))
      throw SaypipException.ymn('redirectUri is required.');
    var tmp7_elvis_lhs = context.hnc_1;
    var tmp;
    if (tmp7_elvis_lhs == null) {
      // Inline function 'kotlin.also' call
      var this_0 = PkceHelper_instance.znc();
      context.hnc_1 = this_0;
      tmp = this_0;
    } else {
      tmp = tmp7_elvis_lhs;
    }
    ...
    var tmp9_elvis_lhs = tmp8_elvis_lhs == null ? context.gnc_1 : tmp8_elvis_lhs;
    var tmp_0;
    if (tmp9_elvis_lhs == null) {
      // Inline function 'kotlin.also' call
      var this_1 = RandomHelper_instance.cnd(32);
      context.gnc_1 = this_1;
      tmp_0 = this_1;
    } else {
      tmp_0 = tmp9_elvis_lhs;
    }
    var state = tmp_0;
    context.dnc_1 = clientId;
    context.enc_1 = redirectUri;
    context.fnc_1 = scopes;
    context.gnc_1 = state;
    // Inline function 'kotlin.apply' call
    var this_2 = URLBuilder(this.fnd_1.qnc());
    ...
    this_2.b49_1.r3s('code_challenge', PkceHelper_instance.and(codeVerifier));
  ...
  hnd(context, request) {
    ...
    if (tmp0_elvis_lhs == null) {
      throw SaypipException.ymn('code is required.');
    } else {
      tmp = tmp0_elvis_lhs;
    }
    var code = tmp;
    var tmp1_elvis_lhs = context.enc_1;
    var tmp2_elvis_lhs = tmp1_elvis_lhs == null ? this.fnd_1.lnc_1 : tmp1_elvis_lhs;
    var tmp_0;
    ...
    var tmp3_elvis_lhs = context.hnc_1;
    var tmp_1;
    if (tmp3_elvis_lhs == null) {
      throw SaypipException.ymn('codeVerifier is missing: build the authorization URL first.');
    } else {
  ...
  ind(context, request) {
    ...
    var tmp;
    if (tmp0_elvis_lhs == null) {
      throw SaypipException.ymn('refreshToken is required.');
    } else {
      tmp = tmp0_elvis_lhs;
    }
...
class SaypipAuthImpl {
  constructor(config) {
    this.jnd_1 = config;
    this.knd_1 = new OAuthContext();
    this.lnd_1 = new OAuthResourceImpl(this.jnd_1);
  }
  mnd() {
    return this.lnd_1;
  }
...
function tokenRequest($this, context, fields) {
  var tmp0_elvis_lhs = context.dnc_1;
  var clientId = tmp0_elvis_lhs == null ? $this.fnd_1.jnc_1 : tmp0_elvis_lhs;
...
function *tokenCall($this, clientId, fields, basic, $completion) {
  ...
  $l$block: {
    ...
    try {
      // Inline function 'kotlin.also' call
      var this_0 = pwn($this, (new HttpRequest()).z54($this.fnd_1.rnc()).a55(MediaType_getInstance().yn7_1), 'client_id', clientId);
...
function clientAuth($this, $receiver, clientId, basic) {
  var tmp0_elvis_lhs = $this.fnd_1.knc_1;
  var tmp;
  if (tmp0_elvis_lhs == null) {
    return $receiver;
  } else {
...
function isClientAuthMethodMismatch($this, e) {
  var tmp;
  if (e.tmn_1 === 400 || e.tmn_1 === 401) {
    var tmp0_safe_receiver = e.umn_1;
...
function OAuthResourceImpl$tokenRequest$slambda(this$0, $clientId, $fields) {
  return constructCallableReference(function *($this$toBlocking, $completion) {
    var tmp;
    try {
      tmp = yield* /*#__NOINLINE__*/tokenCall(this$0, $clientId, $fields, !(this$0.fnd_1.knc_1 == null), $completion);
    } catch ($p) {
      var tmp_0;
      if ($p instanceof SaypipException) {
        var e = $p;
        var tmp_1;
        if (!(this$0.fnd_1.knc_1 == null) && isClientAuthMethodMismatch(this$0, e)) {
