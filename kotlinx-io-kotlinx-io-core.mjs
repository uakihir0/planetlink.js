...
function write$default(source, startIndex, endIndex, $super) {
  ...
  var tmp;
  if ($super === VOID) {
    this.e23(source, startIndex, endIndex);
    tmp = Unit_instance;
  } else {
    tmp = $super.e23.call(this, source, startIndex, endIndex);
  }
  return tmp;
}
class Buffer {
  ...
  w21(byteCount) {
    ...
    if (this.l2() < byteCount) {
      throw EOFException.t21("Buffer doesn't contain required number of bytes (size: " + this.l2().toString() + ', required: ' + byteCount.toString() + ')');
    }
  }
  x21(byteCount) {
    // Inline function 'kotlin.require' call
  ...
  y21() {
    ...
    var v = segment.h22();
    this.p21_1 = subtract(this.p21_1, 1n);
    if (segmentSize === 1) {
      this.g22();
    }
    return v;
  ...
  i22() {
    ...
    if (segmentSize < 2) {
      ...
      var tmp_0 = (this.y21() & 255) << 8;
      // Inline function 'kotlinx.io.and' call
      var tmp$ret$1 = this.y21() & 255;
      return toShort(tmp_0 | tmp$ret$1);
    }
    var v = segment.j22();
    this.p21_1 = subtract(this.p21_1, 2n);
    if (segmentSize === 2) {
      this.g22();
    }
    return v;
  ...
  l22(out, startIndex, endIndex) {
    checkBounds(this.l2(), startIndex, endIndex);
    if (startIndex === endIndex)
      return Unit_instance;
    var currentOffset = startIndex;
    var remainingByteCount = subtract(endIndex, startIndex);
    out.p21_1 = add(out.p21_1, remainingByteCount);
    var s = this.n21_1;
    while (currentOffset >= fromInt(ensureNotNull(s).b22_1 - s.a22_1 | 0)) {
      currentOffset = subtract(currentOffset, fromInt(s.b22_1 - s.a22_1 | 0));
      s = s.e22_1;
    }
    while (remainingByteCount > 0n) {
      var copy = ensureNotNull(s).m22();
      copy.a22_1 = copy.a22_1 + convertToInt(currentOffset) | 0;
      var tmp = copy;
      var tmp0 = copy.a22_1 + convertToInt(remainingByteCount) | 0;
      // Inline function 'kotlin.comparisons.minOf' call
      var b = copy.b22_1;
      tmp.b22_1 = Math.min(tmp0, b);
      // Inline function 'kotlinx.io.Buffer.pushSegment' call
      if (out.n21_1 == null) {
        out.n21_1 = copy;
        out.o21_1 = copy;
      } else if (false) {
        out.o21_1 = ensureNotNull(out.o21_1).n22(copy).o22();
        if (ensureNotNull(out.o21_1).f22_1 == null) {
          out.n21_1 = out.o21_1;
        }
      } else {
        out.o21_1 = ensureNotNull(out.o21_1).n22(copy);
      }
      remainingByteCount = subtract(remainingByteCount, fromInt(copy.b22_1 - copy.a22_1 | 0));
      currentOffset = 0n;
      s = s.e22_1;
    }
  }
  p22() {
    ...
    if (result === 0n)
      return 0n;
    var tail = ensureNotNull(this.o21_1);
    if (tail.b22_1 < 8192 && tail.d22_1) {
      result = subtract(result, fromInt(tail.b22_1 - tail.a22_1 | 0));
    }
    return result;
  }
  q22(position) {
    ...
    if (position === 0n) {
      return ensureNotNull(this.n21_1).r22(0);
    }
    $l$block_1: {
      // Inline function 'kotlinx.io.seek' call
      if (this.n21_1 == null) {
        return ensureNotNull(null).r22(convertToInt(subtract(position, -1n)));
      }
      if (subtract(this.l2(), position) < position) {
        var s = this.o21_1;
        var offset = this.l2();
        $l$loop: while (!(s == null) && offset > position) {
          offset = subtract(offset, fromInt(s.b22_1 - s.a22_1 | 0));
          if (offset <= position)
            break $l$loop;
          s = s.f22_1;
        }
        var tmp0 = s;
        var offset_0 = offset;
        return ensureNotNull(tmp0).r22(convertToInt(subtract(position, offset_0)));
      } else {
        var s_0 = this.n21_1;
        var offset_1 = 0n;
        $l$loop_0: while (!(s_0 == null)) {
          ...
          var other = s_0.b22_1 - s_0.a22_1 | 0;
        ...
        return ensureNotNull(tmp0_1).r22(convertToInt(subtract(position, offset_2)));
      }
    }
  }
  j4() {
    return this.s22(this.l2());
  }
  s22(byteCount) {
    ...
    while (remainingByteCount > 0n) {
      ...
      var tmp;
      if (tmp0_elvis_lhs == null) {
        throw EOFException.t21('Buffer exhausted before skipping ' + byteCount.toString() + ' bytes.');
      } else {
        tmp = tmp0_elvis_lhs;
      }
      var head = tmp;
      ...
      var b = head.b22_1 - head.a22_1 | 0;
      // Inline function 'kotlin.comparisons.minOf' call
      var b_0 = fromInt(b);
      var tmp$ret$3 = tmp0 <= b_0 ? tmp0 : b_0;
      var toSkip = convertToInt(tmp$ret$3);
      this.p21_1 = subtract(this.p21_1, fromInt(toSkip));
      remainingByteCount = subtract(remainingByteCount, fromInt(toSkip));
      head.a22_1 = head.a22_1 + toSkip | 0;
      if (head.a22_1 === head.b22_1) {
        this.g22();
      }
    }
  }
  t22(sink, startIndex, endIndex) {
    ...
    s.u22(sink, startIndex, startIndex + toCopy | 0);
    this.p21_1 = subtract(this.p21_1, fromInt(toCopy));
    if (isEmpty(s)) {
      this.g22();
    }
    return toCopy;
  ...
  x22(sink, byteCount) {
    ...
    if (this.l2() < byteCount) {
      sink.w22(this, this.l2());
      throw EOFException.t21('Buffer exhausted before writing ' + byteCount.toString() + ' bytes. Only ' + this.l2().toString() + ' bytes were written.');
    }
    sink.w22(this, byteCount);
  }
  y22(sink) {
  ...
  a23(minimumCapacity) {
    ...
    if (this.o21_1 == null) {
      var result = SegmentPool_instance.d23();
      this.n21_1 = result;
      this.o21_1 = result;
      return result;
    }
    var t = ensureNotNull(this.o21_1);
    if ((t.b22_1 + minimumCapacity | 0) > 8192 || !t.d22_1) {
      var newTail = t.n22(SegmentPool_instance.d23());
      this.o21_1 = newTail;
      return newTail;
    }
    return t;
  }
  e23(source, startIndex, endIndex) {
    // Inline function 'kotlinx.io.checkBounds' call
    ...
    while (currentOffset < endIndex) {
      ...
      var b = tail.f23();
      var toCopy = Math.min(tmp0, b);
      tail.g23(source, currentOffset, currentOffset + toCopy | 0);
      currentOffset = currentOffset + toCopy | 0;
    }
    var tmp = this;
    var tmp0_0 = this.p21_1;
    // Inline function 'kotlin.Long.plus' call
    var other = endIndex - startIndex | 0;
    tmp.p21_1 = add(tmp0_0, fromInt(other));
  }
  i23(source, byteCount) {
    // Inline function 'kotlinx.io.checkByteCount' call
    // Inline function 'kotlin.require' call
    if (!(byteCount >= 0n)) {
      var message = 'byteCount (' + byteCount.toString() + ') < 0';
    ...
    var remainingByteCount = byteCount;
    while (remainingByteCount > 0n) {
      var read = source.v22(this, remainingByteCount);
      if (read === -1n) {
        throw EOFException.t21('Source exhausted before reading ' + byteCount.toString() + ' bytes. ' + ('Only ' + subtract(byteCount, remainingByteCount).toString() + ' were read.'));
      }
      remainingByteCount = subtract(remainingByteCount, read);
    }
  }
  w22(source, byteCount) {
    // Inline function 'kotlin.require' call
    if (!!(source === this)) {
      var message = 'source == this';
      throw IllegalArgumentException.a2(toString(message));
    }
    checkOffsetAndCount(source.p21_1, 0n, byteCount);
    var remainingByteCount = byteCount;
    while (remainingByteCount > 0n) {
      if (remainingByteCount < fromInt(ensureNotNull(source.n21_1).l2())) {
        var tail = this.o21_1;
        var tmp;
        if (!(tail == null) && tail.d22_1) {
          var tmp0 = remainingByteCount;
          // Inline function 'kotlin.Long.plus' call
          var other = tail.b22_1;
          var tmp0_0 = add(tmp0, fromInt(other));
          // Inline function 'kotlin.Long.minus' call
          var other_0 = tail.j23() ? 0 : tail.a22_1;
          tmp = subtract(tmp0_0, fromInt(other_0)) <= 8192n;
        } else {
          tmp = false;
        }
        if (tmp) {
          ensureNotNull(source.n21_1).l23(tail, convertToInt(remainingByteCount));
          source.p21_1 = subtract(source.p21_1, remainingByteCount);
          this.p21_1 = add(this.p21_1, remainingByteCount);
          return Unit_instance;
        } else {
          source.n21_1 = ensureNotNull(source.n21_1).k23(convertToInt(remainingByteCount));
        }
      }
      var segmentToMove = ensureNotNull(source.n21_1);
      var movedByteCount = fromInt(segmentToMove.l2());
      source.n21_1 = segmentToMove.m23();
      if (source.n21_1 == null) {
        source.o21_1 = null;
      }
      // Inline function 'kotlinx.io.Buffer.pushSegment' call
      if (this.n21_1 == null) {
        this.n21_1 = segmentToMove;
        this.o21_1 = segmentToMove;
      } else if (true) {
        this.o21_1 = ensureNotNull(this.o21_1).n22(segmentToMove).o22();
        if (ensureNotNull(this.o21_1).f22_1 == null) {
          this.n21_1 = this.o21_1;
        }
      } else {
        this.o21_1 = ensureNotNull(this.o21_1).n22(segmentToMove);
      }
      source.p21_1 = subtract(source.p21_1, movedByteCount);
      this.p21_1 = add(this.p21_1, movedByteCount);
  ...
  n23(source) {
    ...
    $l$loop: while (true) {
      var readCount = source.v22(this, 8192n);
      if (readCount === -1n)
        break $l$loop;
  ...
  o23(byte) {
    this.a23(1).p23(byte);
    this.p21_1 = add(this.p21_1, 1n);
  }
  q23(short) {
    this.a23(2).r23(short);
    this.p21_1 = add(this.p21_1, 2n);
  }
  f7() {
    return Unit_instance;
  }
  toString() {
    ...
    while (!(curr == null)) {
      ...
      while (bytesWritten < len && idx < segment.l2()) {
        ...
        var b_0 = tmp0.s23(segment, _unary__edvuaz);
  ...
  g22() {
    var oldHead = ensureNotNull(this.n21_1);
    var nextHead = oldHead.e22_1;
    this.n21_1 = nextHead;
    if (nextHead == null) {
      this.o21_1 = null;
    } else {
    ...
    oldHead.e22_1 = null;
    SegmentPool_instance.t23(oldHead);
  }
  u23() {
    var oldTail = ensureNotNull(this.o21_1);
    var newTail = oldTail.f22_1;
    this.o21_1 = newTail;
    if (newTail == null) {
      this.n21_1 = null;
    } else {
    ...
    oldTail.f22_1 = null;
    SegmentPool_instance.t23(oldTail);
  }
}
class PeekSource {
  constructor(upstream) {
    this.v23_1 = upstream;
    this.w23_1 = this.v23_1.u21();
    this.x23_1 = this.w23_1.n21_1;
    var tmp = this;
    var tmp0_safe_receiver = this.w23_1.n21_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.a22_1;
    tmp.y23_1 = tmp1_elvis_lhs == null ? -1 : tmp1_elvis_lhs;
    this.z23_1 = false;
    this.a24_1 = 0n;
  }
  v22(sink, byteCount) {
    ...
    // Inline function 'kotlin.check' call
    if (!(this.x23_1 == null || (this.x23_1 === this.w23_1.n21_1 && this.y23_1 === ensureNotNull(this.w23_1.n21_1).a22_1))) {
    ...
    if (!this.v23_1.x21(tmp$ret$7))
      return -1n;
    if (this.x23_1 == null && !(this.w23_1.n21_1 == null)) {
      this.x23_1 = this.w23_1.n21_1;
      this.y23_1 = ensureNotNull(this.w23_1.n21_1).a22_1;
    }
    // Inline function 'kotlin.comparisons.minOf' call
    var b = subtract(this.w23_1.l2(), this.a24_1);
    var toCopy = byteCount <= b ? byteCount : b;
    this.w23_1.l22(sink, this.a24_1, add(this.a24_1, toCopy));
    this.a24_1 = add(this.a24_1, toCopy);
    return toCopy;
  }
  f7() {
    this.z23_1 = true;
...
class RealSource {
  ...
  v22(sink, byteCount) {
    ...
    if (this.d24_1.l2() === 0n) {
      var read = this.b24_1.v22(this.d24_1, 8192n);
      if (read === -1n)
        return -1n;
    }
    // Inline function 'kotlin.comparisons.minOf' call
    ...
    return this.d24_1.v22(sink, toRead);
  }
  v21() {
    // Inline function 'kotlinx.io.RealSource.checkNotClosed' call
    // Inline function 'kotlin.check' call
    ...
    return this.d24_1.v21() && this.b24_1.v22(this.d24_1, 8192n) === -1n;
  }
  w21(byteCount) {
    if (!this.x21(byteCount))
      throw EOFException.t21("Source doesn't contain required number of bytes (" + byteCount.toString() + ').');
  }
  x21(byteCount) {
    // Inline function 'kotlinx.io.RealSource.checkNotClosed' call
    // Inline function 'kotlin.check' call
    ...
    while (this.d24_1.l2() < byteCount) {
      if (this.b24_1.v22(this.d24_1, 8192n) === -1n)
        return false;
    }
    return true;
  }
  ...
  t22(sink, startIndex, endIndex) {
    ...
    return this.d24_1.t22(sink, startIndex, startIndex + toRead | 0);
  }
  x22(sink, byteCount) {
    try {
      this.w21(byteCount);
      ...
      if ($p instanceof EOFException) {
        var e = $p;
        sink.w22(this.d24_1, this.d24_1.l2());
        throw e;
      } else {
        throw $p;
      }
    }
    this.d24_1.x22(sink, byteCount);
  }
  y22(sink) {
    var totalBytesWritten = 0n;
    while (!(this.b24_1.v22(this.d24_1, 8192n) === -1n)) {
      var emitByteCount = this.d24_1.p22();
      if (emitByteCount > 0n) {
        totalBytesWritten = add(totalBytesWritten, emitByteCount);
        sink.w22(this.d24_1, emitByteCount);
      }
    }
    if (this.d24_1.l2() > 0n) {
      totalBytesWritten = add(totalBytesWritten, this.d24_1.l2());
      sink.w22(this.d24_1, this.d24_1.l2());
    }
  ...
  toString() {
    return 'buffered(' + toString(this.b24_1) + ')';
  }
}
class Companion {
  constructor() {
...
class Segment {
  ...
  static h24() {
    ...
    $this.z21_1 = new Int8Array(8192);
    $this.d22_1 = true;
    $this.c22_1 = null;
    return $this;
  }
  static j24(data, pos, limit, shareToken, owner) {
    var $this = createThis(this);
    init_kotlinx_io_Segment($this);
    $this.z21_1 = data;
    $this.a22_1 = pos;
    $this.b22_1 = limit;
    $this.c22_1 = shareToken;
    $this.d22_1 = owner;
    return $this;
  }
  m22() {
    var tmp0_elvis_lhs = this.c22_1;
    var tmp;
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlin.also' call
      var this_0 = SegmentPool_instance.k24();
      this.c22_1 = this_0;
      tmp = this_0;
    } else {
      tmp = tmp0_elvis_lhs;
    ...
    var t = tmp;
    var tmp_0 = this.a22_1;
    var tmp_1 = this.b22_1;
    // Inline function 'kotlin.also' call
    t.l24();
    return Segment.j24(this.z21_1, tmp_0, tmp_1, t, false);
  }
  m23() {
    var result = this.e22_1;
    if (!(this.f22_1 == null)) {
      ensureNotNull(this.f22_1).e22_1 = this.e22_1;
    }
    if (!(this.e22_1 == null)) {
      ensureNotNull(this.e22_1).f22_1 = this.f22_1;
    }
    this.e22_1 = null;
    this.f22_1 = null;
    return result;
  ...
  n22(segment) {
    segment.f22_1 = this;
    segment.e22_1 = this.e22_1;
    if (!(this.e22_1 == null)) {
      ensureNotNull(this.e22_1).f22_1 = segment;
    }
    this.e22_1 = segment;
    return segment;
  }
  k23(byteCount) {
    // Inline function 'kotlin.require' call
    if (!(byteCount > 0 && byteCount <= (this.b22_1 - this.a22_1 | 0))) {
    ...
    if (byteCount >= 1024) {
      ...
      prefix = SegmentPool_instance.d23();
      var tmp0 = this.z21_1;
      var tmp2 = prefix.z21_1;
      var tmp5 = this.a22_1;
      // Inline function 'kotlin.collections.copyInto' call
      var endIndex = this.a22_1 + byteCount | 0;
    ...
    prefix.b22_1 = prefix.a22_1 + byteCount | 0;
    this.a22_1 = this.a22_1 + byteCount | 0;
    if (!(this.f22_1 == null)) {
      ensureNotNull(this.f22_1).n22(prefix);
    } else {
      prefix.e22_1 = this;
      this.f22_1 = prefix;
    }
  ...
  o22() {
    ...
    if (!ensureNotNull(this.f22_1).d22_1)
      return this;
    var byteCount = this.b22_1 - this.a22_1 | 0;
    var availableByteCount = (8192 - ensureNotNull(this.f22_1).b22_1 | 0) + (ensureNotNull(this.f22_1).j23() ? 0 : ensureNotNull(this.f22_1).a22_1) | 0;
    if (byteCount > availableByteCount)
      return this;
    var predecessor = this.f22_1;
    this.l23(ensureNotNull(predecessor), byteCount);
    var successor = this.m23();
    // Inline function 'kotlin.check' call
    if (!(successor == null)) {
      throw IllegalStateException.o('Check failed.');
    }
    SegmentPool_instance.t23(this);
    return predecessor;
  }
  p23(byte) {
    var _unary__edvuaz = this.b22_1;
    this.b22_1 = _unary__edvuaz + 1 | 0;
    this.z21_1[_unary__edvuaz] = byte;
  }
  r23(short) {
    var data = this.z21_1;
    var limit = this.b22_1;
  ...
  h22() {
    ...
    return this.z21_1[_unary__edvuaz];
  }
  j22() {
    var data = this.z21_1;
    var pos = this.a22_1;
  ...
  l23(sink, byteCount) {
    ...
    if ((sink.b22_1 + byteCount | 0) > 8192) {
      if (sink.j23())
        throw IllegalArgumentException.re();
      if (((sink.b22_1 + byteCount | 0) - sink.a22_1 | 0) > 8192)
        throw IllegalArgumentException.re();
      var tmp0 = sink.z21_1;
      var tmp2 = sink.z21_1;
      var tmp5 = sink.a22_1;
      // Inline function 'kotlin.collections.copyInto' call
      var endIndex = sink.b22_1;
      // Inline function 'kotlin.js.unsafeCast' call
      // Inline function 'kotlin.js.asDynamic' call
      var tmp = tmp0;
      // Inline function 'kotlin.js.unsafeCast' call
      // Inline function 'kotlin.js.asDynamic' call
      arrayCopy(tmp, tmp2, 0, tmp5, endIndex);
      sink.b22_1 = sink.b22_1 - sink.a22_1 | 0;
      sink.a22_1 = 0;
    }
    var tmp0_0 = this.z21_1;
    var tmp2_0 = sink.z21_1;
    var tmp4 = sink.b22_1;
    var tmp6 = this.a22_1;
    // Inline function 'kotlin.collections.copyInto' call
    var endIndex_0 = this.a22_1 + byteCount | 0;
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    var tmp_0 = tmp0_0;
    // Inline function 'kotlin.js.unsafeCast' call
    ...
    sink.b22_1 = sink.b22_1 + byteCount | 0;
    this.a22_1 = this.a22_1 + byteCount | 0;
  }
  u22(dst, dstStartOffset, dstEndOffset) {
    var len = dstEndOffset - dstStartOffset | 0;
    var tmp0 = this.z21_1;
    var tmp6 = this.a22_1;
    // Inline function 'kotlin.collections.copyInto' call
    var endIndex = this.a22_1 + len | 0;
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    var tmp = tmp0;
    // Inline function 'kotlin.js.unsafeCast' call
    ...
    this.a22_1 = this.a22_1 + len | 0;
  }
  g23(src, srcStartOffset, srcEndOffset) {
    var tmp2 = this.z21_1;
    // Inline function 'kotlin.collections.copyInto' call
    var destinationOffset = this.b22_1;
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    var tmp = src;
    // Inline function 'kotlin.js.unsafeCast' call
    ...
    this.b22_1 = this.b22_1 + (srcEndOffset - srcStartOffset | 0) | 0;
  }
  l2() {
    return this.b22_1 - this.a22_1 | 0;
  }
  f23() {
    return this.z21_1.length - this.b22_1 | 0;
  }
  m24(readOnly) {
    return this.z21_1;
  }
  r22(index) {
    return this.z21_1[this.a22_1 + index | 0];
  }
  n24(index, value) {
    this.z21_1[this.b22_1 + index | 0] = value;
  }
  o24(index, b0, b1) {
    var d = this.z21_1;
    var l = this.b22_1;
...
class SegmentReadContextImpl$1 {
  s23(segment, offset) {
    return segment.r22(offset);
  }
}
class SegmentWriteContextImpl$1 {
  u24(segment, offset, value) {
    segment.n24(offset, value);
  }
  t24(segment, offset, b0, b1) {
    segment.o24(offset, b0, b1);
  }
  s24(segment, offset, b0, b1, b2) {
    segment.p24(offset, b0, b1, b2);
  }
  r24(segment, offset, b0, b1, b2, b3) {
    segment.q24(offset, b0, b1, b2, b3);
  }
}
class BufferIterationContextImpl$1 {
  s23(segment, offset) {
    return get_SegmentReadContextImpl().s23(segment, offset);
  }
}
  ...
  $l$block_1: {
    ...
    if (subtract(_this__u8e3s4.l2(), startIndex) < startIndex) {
      ...
      do {
        ...
        segment_0 = segment_0.e22_1;
      }
       while (!(segment_0 == null) && offset_1 < endOffset);
      return -1n;
    } else {
      var s_0 = _this__u8e3s4.n21_1;
      var offset_2 = 0n;
      $l$loop_0: while (!(s_0 == null)) {
        var tmp0_4 = offset_2;
        // Inline function 'kotlin.Long.plus' call
        var other_1 = s_0.b22_1 - s_0.a22_1 | 0;
...
function readByteString(_this__u8e3s4, byteCount) {
  return UnsafeByteStringOperations_instance.m21(readByteArray_0(_this__u8e3s4, byteCount));
}
...
function init_kotlinx_io_Segment(_this__u8e3s4) {
  ...
  _this__u8e3s4.b22_1 = 0;
  _this__u8e3s4.c22_1 = null;
  _this__u8e3s4.d22_1 = false;
...
function indexOf_0(_this__u8e3s4, byte, startOffset, endOffset) {
  ...
  var p = _this__u8e3s4.a22_1;
  var data = _this__u8e3s4.m24(true);
...
function indexOf_1(_this__u8e3s4, byte, startIndex, endIndex) {
  ...
  $l$loop: while (true) {
    ...
    if (offset < endIndex) {
      ...
      tmp_0 = _this__u8e3s4.x21(tmp$ret$2);
    } else {
      tmp_0 = false;
    }
    if (!tmp_0) {
    ...
    var tmp_1 = _this__u8e3s4.u21();
    var tmp_2 = offset;
    // Inline function 'kotlin.comparisons.minOf' call
    var b = _this__u8e3s4.u21().l2();
    var tmp$ret$3 = endIndex <= b ? endIndex : b;
    var idx = indexOf(tmp_1, byte, tmp_2, tmp$ret$3);
    if (!(idx === -1n)) {
      return idx;
    }
    offset = _this__u8e3s4.u21().l2();
  }
  return -1n;
}
function readByteArrayImpl(_this__u8e3s4, size) {
  ...
  if (size === -1) {
    ...
    while (_this__u8e3s4.u21().l2() < 2147483647n && _this__u8e3s4.x21(fetchSize)) {
      // Inline function 'kotlin.Long.times' call
      var this_0 = fetchSize;
      fetchSize = multiply(this_0, fromInt(2));
    }
    // Inline function 'kotlin.check' call
    if (!(_this__u8e3s4.u21().l2() < 2147483647n)) {
      var message = "Can't create an array of size " + _this__u8e3s4.u21().l2().toString();
      throw IllegalStateException.o(toString(message));
    }
    arraySize = convertToInt(_this__u8e3s4.u21().l2());
  } else {
    _this__u8e3s4.w21(fromInt(size));
  }
  var array = new Int8Array(arraySize);
  readTo(_this__u8e3s4.u21(), array);
  return array;
}
function readTo(_this__u8e3s4, sink, startIndex, endIndex) {
  ...
  while (offset < endIndex) {
    var bytesRead = _this__u8e3s4.t22(sink, offset, endIndex);
    if (bytesRead === -1) {
      throw EOFException.t21('Source exhausted before reading ' + (endIndex - startIndex | 0) + ' bytes. ' + ('Only ' + bytesRead + ' bytes were read.'));
    }
...
function readString(_this__u8e3s4, byteCount) {
  ...
  return commonReadUtf8(_this__u8e3s4.u21(), byteCount);
}
function readString_0(_this__u8e3s4) {
  _this__u8e3s4.x21(9223372036854775807n);
  return commonReadUtf8(_this__u8e3s4.u21(), _this__u8e3s4.u21().l2());
}
  ...
  while (i < endIndex) {
    ...
    if (c < 128) {
      $l$block_0: {
        ...
        ctx.u24(tail, segmentOffset + _unary__edvuaz | 0, toByte(c));
        $l$loop: while (i < runLimit) {
          ...
          ctx.u24(tail, segmentOffset + _unary__edvuaz_0 | 0, toByte(c));
        }
        var bytesWritten = i + segmentOffset | 0;
        if (bytesWritten === 1) {
          tail.b22_1 = tail.b22_1 + bytesWritten | 0;
          var tmp = this_0;
          // Inline function 'kotlin.Long.plus' call
          var this_3 = this_0.p21_1;
          tmp.p21_1 = add(this_3, fromInt(bytesWritten));
          break $l$block_0;
        }
        // Inline function 'kotlin.check' call
        if (!(0 <= bytesWritten ? bytesWritten <= tail.f23() : false)) {
          var message = 'Invalid number of bytes written: ' + bytesWritten + '. Should be in 0..' + tail.f23();
          throw IllegalStateException.o(toString(message));
        }
        if (!(bytesWritten === 0)) {
          tail.b22_1 = tail.b22_1 + bytesWritten | 0;
          var tmp_0 = this_0;
          // Inline function 'kotlin.Long.plus' call
          var this_4 = this_0.p21_1;
          tmp_0.p21_1 = add(this_4, fromInt(bytesWritten));
          break $l$block_0;
        }
        if (isEmpty(tail)) {
          this_0.u23();
      ...
      $l$block_2: {
        // Inline function 'kotlinx.io.unsafe.UnsafeBufferOperations.writeToTail' call
        var tail_0 = this_0.a23(2);
        get_SegmentWriteContextImpl().t24(tail_0, 0, toByte(c >> 6 | 192), toByte(c & 63 | 128));
        var bytesWritten_0 = 2;
        if (bytesWritten_0 === 2) {
          tail_0.b22_1 = tail_0.b22_1 + bytesWritten_0 | 0;
          var tmp_1 = this_0;
          // Inline function 'kotlin.Long.plus' call
          var this_5 = this_0.p21_1;
          tmp_1.p21_1 = add(this_5, fromInt(bytesWritten_0));
          break $l$block_2;
        }
        // Inline function 'kotlin.check' call
        if (!(0 <= bytesWritten_0 ? bytesWritten_0 <= tail_0.f23() : false)) {
          var message_0 = 'Invalid number of bytes written: ' + bytesWritten_0 + '. Should be in 0..' + tail_0.f23();
        ...
        if (!(bytesWritten_0 === 0)) {
          ...
          var tmp_2 = this_0;
          // Inline function 'kotlin.Long.plus' call
          var this_6 = this_0.p21_1;
          tmp_2.p21_1 = add(this_6, fromInt(bytesWritten_0));
          break $l$block_2;
        }
        if (isEmpty(tail_0)) {
          this_0.u23();
      ...
      $l$block_4: {
        // Inline function 'kotlinx.io.unsafe.UnsafeBufferOperations.writeToTail' call
        var tail_1 = this_0.a23(3);
        get_SegmentWriteContextImpl().s24(tail_1, 0, toByte(c >> 12 | 224), toByte(c >> 6 & 63 | 128), toByte(c & 63 | 128));
        var bytesWritten_1 = 3;
        if (bytesWritten_1 === 3) {
          tail_1.b22_1 = tail_1.b22_1 + bytesWritten_1 | 0;
          var tmp_3 = this_0;
          // Inline function 'kotlin.Long.plus' call
          var this_7 = this_0.p21_1;
          tmp_3.p21_1 = add(this_7, fromInt(bytesWritten_1));
          break $l$block_4;
        }
        // Inline function 'kotlin.check' call
        if (!(0 <= bytesWritten_1 ? bytesWritten_1 <= tail_1.f23() : false)) {
          var message_1 = 'Invalid number of bytes written: ' + bytesWritten_1 + '. Should be in 0..' + tail_1.f23();
          throw IllegalStateException.o(toString(message_1));
        }
        if (!(bytesWritten_1 === 0)) {
          tail_1.b22_1 = tail_1.b22_1 + bytesWritten_1 | 0;
          var tmp_4 = this_0;
          // Inline function 'kotlin.Long.plus' call
          var this_8 = this_0.p21_1;
          tmp_4.p21_1 = add(this_8, fromInt(bytesWritten_1));
          break $l$block_4;
        }
        if (isEmpty(tail_1)) {
          this_0.u23();
      ...
      if (c > 56319 || !(56320 <= low ? low <= 57343 : false)) {
        ...
        this_0.o23(toByte(tmp$ret$29));
        i = i + 1 | 0;
      } else {
        var codePoint = 65536 + ((c & 1023) << 10 | low & 1023) | 0;
        $l$block_6: {
          // Inline function 'kotlinx.io.unsafe.UnsafeBufferOperations.writeToTail' call
          var tail_2 = this_0.a23(4);
          get_SegmentWriteContextImpl().r24(tail_2, 0, toByte(codePoint >> 18 | 240), toByte(codePoint >> 12 & 63 | 128), toByte(codePoint >> 6 & 63 | 128), toByte(codePoint & 63 | 128));
          var bytesWritten_2 = 4;
          if (bytesWritten_2 === 4) {
            tail_2.b22_1 = tail_2.b22_1 + bytesWritten_2 | 0;
            var tmp_6 = this_0;
            // Inline function 'kotlin.Long.plus' call
            var this_11 = this_0.p21_1;
            tmp_6.p21_1 = add(this_11, fromInt(bytesWritten_2));
            break $l$block_6;
          }
          // Inline function 'kotlin.check' call
          if (!(0 <= bytesWritten_2 ? bytesWritten_2 <= tail_2.f23() : false)) {
            var message_2 = 'Invalid number of bytes written: ' + bytesWritten_2 + '. Should be in 0..' + tail_2.f23();
          ...
          if (!(bytesWritten_2 === 0)) {
            ...
            var tmp_7 = this_0;
            // Inline function 'kotlin.Long.plus' call
            var this_12 = this_0.p21_1;
            tmp_7.p21_1 = add(this_12, fromInt(bytesWritten_2));
            break $l$block_6;
          }
          if (isEmpty(tail_2)) {
            this_0.u23();
...
function init_kotlinx_io_IOException(_this__u8e3s4) {
  captureStack(_this__u8e3s4, _this__u8e3s4.w24_1);
}
function init_kotlinx_io_EOFException(_this__u8e3s4) {
  captureStack(_this__u8e3s4, _this__u8e3s4.s21_1);
}
...
protoOf(Buffer).h23 = write$default;
...
initMetadataForClass(IOException, 'IOException', IOException.x24);
initMetadataForClass(EOFException, 'EOFException', EOFException.a25);
