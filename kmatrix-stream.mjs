...
function syncStreamWithTimeout(timeout, maxRetry, $super) {
  ...
  return $super === VOID ? this.ckt(timeout, maxRetry) : $super.ckt.call(this, timeout, maxRetry);
}
function syncStreamWithRequest(request, maxRetry, $super) {
  maxRetry = maxRetry === VOID ? 5 : maxRetry;
  return $super === VOID ? this.dkt(request, maxRetry) : $super.dkt.call(this, request, maxRetry);
}
...
class MatrixStreamImpl$defaultConfig$1 {
  ...
  vkt(_set____db54di) {
    this.qkt_1 = _set____db54di;
  }
  pjv() {
    return this.qkt_1;
  }
  wkt(_set____db54di) {
    this.rkt_1 = _set____db54di;
  }
  nkt() {
    return this.rkt_1;
  }
...
class MatrixStreamImpl$copy$1 {
  constructor(this$0) {
    this.ikt_1 = this$0.hkt_1.qkt_1;
    this.jkt_1 = this$0.hkt_1.rkt_1;
    this.kkt_1 = this$0.hkt_1.skt_1;
    this.lkt_1 = this$0.hkt_1.tkt_1;
    this.mkt_1 = this$0.hkt_1.ukt_1;
  }
  vkt(_set____db54di) {
    this.ikt_1 = _set____db54di;
  }
  pjv() {
    return this.ikt_1;
  }
  wkt(_set____db54di) {
    this.jkt_1 = _set____db54di;
  }
  nkt() {
    return this.jkt_1;
  }
...
class MatrixStreamImpl {
  constructor(uri, accessToken) {
    this.ekt_1 = uri;
    this.fkt_1 = accessToken;
    var tmp = this;
    tmp.gkt_1 = Json(VOID, MatrixStreamImpl$json$lambda);
    var tmp_0 = this;
    tmp_0.hkt_1 = new MatrixStreamImpl$defaultConfig$1();
  }
  uri() {
    return this.ekt_1;
  }
  ...
  ckt(timeout, maxRetry) {
    var config = copy(this, this.hkt_1);
    if (timeout == null)
      null;
    else {
...
class MatrixStreamException extends RuntimeException {
  constructor(message, cause) {
    return new.target.aku(message, cause);
  }
  static aku(message, cause) {
    cause = cause === VOID ? null : cause;
    var $this = this.se(message, cause);
    captureStack($this, $this.zkt_1);
    return $this;
  }
}
//endregion
...
function *fetchSync($this, uri, accessToken, since, request, timeout, $completion) {
  ...
  if (!queryParams.j1()) {
    ...
    var destination = ArrayList.h2(queryParams.l2());
      ...
      try {
        ...
        $l$block: {
          ...
          try {
            ...
            header(this_1, 'Accept', Application_getInstance().b3y_1.toString());
            // Inline function 'io.ktor.client.request.get' call
            this_1.s4m_1 = Companion_getInstance().p45_1;
            // Inline function 'io.ktor.client.request.request' call
            // Inline function 'io.ktor.client.call.body' call
            var tmp_0 = (yield* (new HttpStatement(this_1, tmp0)).i52($completion)).q4n();
            // Inline function 'io.ktor.util.reflect.typeInfo' call
            var tmp_1 = PrimitiveClasses_getInstance().xg();
            // Inline function 'io.ktor.util.reflect.typeOfOrNull' call
            var tmp_2;
            try {
              tmp_2 = createKType(PrimitiveClasses_getInstance().xg(), arrayOf([]), false);
            } catch ($p) {
              var tmp_3;
            ...
            var tmp_4 = yield* tmp_0.n4n(tmp$ret$27, $completion);
        ...
        return this_2.s10(tmp$ret$30, body);
      } catch ($p_1) {
  ...
  throw tmp0_elvis_lhs == null ? IOException.a25('Unknown error fetching sync') : tmp0_elvis_lhs;
}
function copy($this, $receiver) {
  // Inline function 'kotlin.apply' call
  var this_0 = new MatrixStreamImpl$copy$1($this);
  this_0.ikt_1 = $receiver.pjv();
  this_0.jkt_1 = $receiver.nkt();
  this_0.kkt_1 = $receiver.okt();
  this_0.lkt_1 = $receiver.pkt();
  this_0.mkt_1 = $receiver.l78();
  return this_0;
}
...
function MatrixStreamImpl$syncStreamInternal$slambda($request, $config, this$0) {
  return constructCallableReference(function *($this$flow, $completion) {
    ...
    while ($config.l78()) {
      try {
        var response = yield* /*#__NOINLINE__*/fetchSync(this$0, this$0.ekt_1, this$0.fkt_1, since, $request, $config.pjv(), $completion);
        since = response.nextBatch;
        retryCount = 0;
        yield* $this$flow.n2n(response, $completion);
      } catch ($p) {
        if ($p instanceof Exception) {
          var e = $p;
          if (retryCount >= $config.nkt()) {
            throw MatrixStreamException.aku('Max retry count reached: ' + retryCount, e);
          }
          var tmp0 = multiply($config.okt(), shiftLeft(1n, retryCount));
          // Inline function 'kotlin.comparisons.minOf' call
          var b = $config.pkt();
          var tmp$ret$0 = tmp0 <= b ? tmp0 : b;
          var backoff = add(tmp$ret$0, Default_getInstance().lr(1000n));
...
function MatrixStreamImpl$fetchSync$lambda$lambda($timeout) {
  return ($this$install) => {
    $this$install.g4w(add($timeout, 5000n));
    return Unit_instance;
  };
}
function MatrixStreamImpl$fetchSync$lambda$lambda_0(this$0) {
  return ($this$install) => {
    json($this$install, this$0.gkt_1);
    return Unit_instance;
  };
}
function MatrixStreamImpl$fetchSync$lambda($timeout, this$0) {
  return ($this$HttpClient) => {
    ...
    $this$HttpClient.b4n(tmp, MatrixStreamImpl$fetchSync$lambda$lambda($timeout));
    var tmp_0 = get_ContentNegotiation();
    $this$HttpClient.b4n(tmp_0, MatrixStreamImpl$fetchSync$lambda$lambda_0(this$0));
    return Unit_instance;
  };
}
