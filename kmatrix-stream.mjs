...
function syncStreamWithTimeout(timeout, maxRetry, $super) {
  ...
  return $super === VOID ? this.mks(timeout, maxRetry) : $super.mks.call(this, timeout, maxRetry);
}
function syncStreamWithRequest(request, maxRetry, $super) {
  maxRetry = maxRetry === VOID ? 5 : maxRetry;
  return $super === VOID ? this.nks(request, maxRetry) : $super.nks.call(this, request, maxRetry);
}
...
class MatrixStreamImpl$defaultConfig$1 {
  ...
  fkt(_set____db54di) {
    this.akt_1 = _set____db54di;
  }
  zju() {
    return this.akt_1;
  }
  gkt(_set____db54di) {
    this.bkt_1 = _set____db54di;
  }
  xks() {
    return this.bkt_1;
  }
...
class MatrixStreamImpl$copy$1 {
  constructor(this$0) {
    this.sks_1 = this$0.rks_1.akt_1;
    this.tks_1 = this$0.rks_1.bkt_1;
    this.uks_1 = this$0.rks_1.ckt_1;
    this.vks_1 = this$0.rks_1.dkt_1;
    this.wks_1 = this$0.rks_1.ekt_1;
  }
  fkt(_set____db54di) {
    this.sks_1 = _set____db54di;
  }
  zju() {
    return this.sks_1;
  }
  gkt(_set____db54di) {
    this.tks_1 = _set____db54di;
  }
  xks() {
    return this.tks_1;
  }
...
class MatrixStreamImpl {
  constructor(uri, accessToken) {
    this.oks_1 = uri;
    this.pks_1 = accessToken;
    var tmp = this;
    tmp.qks_1 = Json(VOID, MatrixStreamImpl$json$lambda);
    var tmp_0 = this;
    tmp_0.rks_1 = new MatrixStreamImpl$defaultConfig$1();
  }
  uri() {
    return this.oks_1;
  }
  ...
  mks(timeout, maxRetry) {
    var config = copy(this, this.rks_1);
    if (timeout == null)
      null;
    else {
...
class MatrixStreamException extends RuntimeException {
  constructor(message, cause) {
    return new.target.kkt(message, cause);
  }
  static kkt(message, cause) {
    cause = cause === VOID ? null : cause;
    var $this = this.se(message, cause);
    captureStack($this, $this.jkt_1);
    return $this;
  }
}
//endregion
...
function copy($this, $receiver) {
  ...
  this_0.sks_1 = $receiver.zju();
  this_0.tks_1 = $receiver.xks();
  this_0.uks_1 = $receiver.yks();
  this_0.vks_1 = $receiver.zks();
  this_0.wks_1 = $receiver.l78();
  return this_0;
}
...
function MatrixStreamImpl$syncStreamInternal$slambda($request, $config, this$0) {
  return constructCallableReference(function *($this$flow, $completion) {
    ...
    while ($config.l78()) {
      try {
        var response = yield* /*#__NOINLINE__*/fetchSync(this$0, this$0.oks_1, this$0.pks_1, since, $request, $config.zju(), $completion);
        ...
        if ($p instanceof Exception) {
          var e = $p;
          if (retryCount >= $config.xks()) {
            throw MatrixStreamException.kkt('Max retry count reached: ' + retryCount, e);
          }
          var tmp0 = multiply($config.yks(), shiftLeft(1n, retryCount));
...
function MatrixStreamImpl$fetchSync$lambda$lambda_0(this$0) {
  return ($this$install) => {
    json($this$install, this$0.qks_1);
    return Unit_instance;
  };
}
