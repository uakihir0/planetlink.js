...
class CIOMultipartDataBase {
  constructor(coroutineContext, channel, contentType, contentLength, formFieldLimit) {
    ...
    this.u4c_1 = coroutineContext;
    this.v4c_1 = null;
    this.w4c_1 = parseMultipart(this, channel, contentType, contentLength, formFieldLimit);
  }
  o25() {
    return this.u4c_1;
  }
...
class HttpHeadersMap {
  constructor(builder) {
    ...
    this.y4c_1 = 0;
    this.z4c_1 = 0;
    this.a4d_1 = get_HeadersDataPool().g3p();
  }
  bj(name) {
    if (this.y4c_1 === 0)
      return null;
    ...
    var hash = abs(this_0);
    var headerIndex = hash % this.z4c_1 | 0;
    while (!(this.a4d_1.f4d(imul(headerIndex, 6) + 0 | 0) === -1)) {
      if (headerHasName(this, name, imul(headerIndex, 6))) {
        return this.h4d(imul(headerIndex, 6));
      }
      headerIndex = (headerIndex + 1 | 0) % this.z4c_1 | 0;
    }
    return null;
  }
  i4d() {
    return this.a4d_1.e4d();
  }
  g4d(nameStartIndex, nameEndIndex, valueStartIndex, valueEndIndex) {
    if (thresholdReached(this)) {
      resize(this);
    }
    // Inline function 'kotlin.math.absoluteValue' call
    var this_0 = hashCodeLowerCase(this.x4c_1, nameStartIndex, nameEndIndex);
    var hash = abs(this_0);
    var name = this.x4c_1.c(nameStartIndex, nameEndIndex);
    var headerIndex = hash % this.z4c_1 | 0;
    ...
    this.a4d_1.q4d(headerOffset + 0 | 0, hash);
    this.a4d_1.q4d(headerOffset + 1 | 0, nameStartIndex);
    this.a4d_1.q4d(headerOffset + 2 | 0, nameEndIndex);
    this.a4d_1.q4d(headerOffset + 3 | 0, valueStartIndex);
    this.a4d_1.q4d(headerOffset + 4 | 0, valueEndIndex);
    this.a4d_1.q4d(headerOffset + 5 | 0, -1);
    if (!(sameNameHeaderIndex === -1)) {
      this.a4d_1.q4d(imul(sameNameHeaderIndex, 6) + 5 | 0, headerIndex);
    }
    this.y4c_1 = this.y4c_1 + 1 | 0;
  }
  r4d(headerOffset) {
    var nameStartIndex = this.a4d_1.f4d(headerOffset + 1 | 0);
    var nameEndIndex = this.a4d_1.f4d(headerOffset + 2 | 0);
    return this.x4c_1.c(nameStartIndex, nameEndIndex);
  }
  h4d(headerOffset) {
    var valueStartIndex = this.a4d_1.f4d(headerOffset + 3 | 0);
    var valueEndIndex = this.a4d_1.f4d(headerOffset + 4 | 0);
    return this.x4c_1.c(valueStartIndex, valueEndIndex);
  }
  s1m() {
    this.y4c_1 = 0;
    this.z4c_1 = 0;
    get_HeadersDataPool().h3p(this.a4d_1);
    this.a4d_1 = get_HeadersDataPool().g3p();
  }
  toString() {
...
class HeadersData {
  constructor() {
    ...
    tmp.b4d_1 = ArrayList.j2();
  }
  c4d() {
    return this.b4d_1.l2();
  }
  d4d(subArraysCount) {
    ...
    if (inductionVariable < subArraysCount)
      do {
        ...
        this.b4d_1.e2(get_IntArrayPool().g3p());
      }
       while (inductionVariable < subArraysCount);
  }
  f4d(index) {
    return this.b4d_1.n2(index / 768 | 0)[index % 768 | 0];
  }
  q4d(index, value) {
    this.b4d_1.n2(index / 768 | 0)[index % 768 | 0] = value;
  }
  e4d() {
    return sequence(HeadersData$headersStarts$slambda(this));
  }
  s1m() {
    var _iterator__ex2g4s = this.b4d_1.l1();
    while (_iterator__ex2g4s.m1()) {
      var array = _iterator__ex2g4s.n1();
      get_IntArrayPool().h3p(array);
    }
    this.b4d_1.j4();
  }
}
class IntArrayPool$1 extends DefaultPool {
  ...
  v4d(instance) {
    fill(instance, -1);
    return protoOf(DefaultPool).e3p.call(this, instance);
  }
  e3p(instance) {
    return this.v4d(isIntArray(instance) ? instance : THROW_CCE());
  }
}
class HeadersDataPool$1 extends DefaultPool {
  ...
  e3p(instance) {
    return this.z4d(instance instanceof HeadersData ? instance : THROW_CCE());
  }
}
class ParserException extends IllegalStateException {
  constructor(message) {
    return new.target.g4e(message);
  }
  static g4e(message) {
    var $this = this.o(message);
    captureStack($this, $this.f4e_1);
    return $this;
  }
}
...
class Companion {
  h4e(from) {
    ...
    return this.u4e(from, tmp, AsciiCharTree$Companion$build$lambda_0);
  }
  u4e(from, length, charAt) {
    var tmp$ret$0;
    $l$block_0: {
...
class SubSequenceImpl {
  ...
  a() {
    return this.x4e_1 - this.w4e_1 | 0;
  }
  b(index) {
    var withOffset = index + this.w4e_1 | 0;
  ...
  c(startIndex, endIndex) {
    ...
    // Inline function 'kotlin.require' call
    if (!(endIndex <= (this.x4e_1 - this.w4e_1 | 0))) {
      var message_1 = 'end should be less than length (' + this.a() + ')';
      throw IllegalArgumentException.a2(toString(message_1));
    }
    if (startIndex === endIndex)
      return '';
    return new SubSequenceImpl(this.z4e_1, this.w4e_1 + startIndex | 0, this.w4e_1 + endIndex | 0);
  }
  toString() {
    var tmp0_elvis_lhs = this.y4e_1;
    var tmp;
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlin.also' call
      var this_0 = toString(copy(this.z4e_1, this.w4e_1, this.x4e_1));
      this.y4e_1 = this_0;
      tmp = this_0;
    } else {
      tmp = tmp0_elvis_lhs;
  ...
  equals(other) {
    ...
    if (!(charSequenceLength(other) === this.a()))
      return false;
    return rangeEqualsImpl(this.z4e_1, this.w4e_1, other, 0, this.a());
  }
  hashCode() {
    var tmp0_safe_receiver = this.y4e_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : getStringHashCode(tmp0_safe_receiver);
    return tmp1_elvis_lhs == null ? hashCodeImpl(this.z4e_1, this.w4e_1, this.x4e_1) : tmp1_elvis_lhs;
  }
}
class CharArrayBuilder {
  ...
  b(index) {
    ...
    // Inline function 'kotlin.require' call
    if (!(index < this.p4d_1)) {
      var message_0 = 'index ' + index + ' is not in range [0, ' + this.p4d_1 + ')';
      throw IllegalArgumentException.a2(toString(message_0));
    }
  ...
  c(startIndex, endIndex) {
    ...
    // Inline function 'kotlin.require' call
    if (!(endIndex <= this.p4d_1)) {
      var message_1 = 'endIndex (' + endIndex + ') is greater than length (' + this.p4d_1 + ')';
      throw IllegalArgumentException.a2(toString(message_1));
    }
    return new SubSequenceImpl(this, startIndex, endIndex);
  }
  toString() {
    var tmp0_elvis_lhs = this.m4d_1;
    var tmp;
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlin.also' call
      var this_0 = toString(copy(this, 0, this.p4d_1));
      this.m4d_1 = this_0;
      tmp = this_0;
    } else {
      tmp = tmp0_elvis_lhs;
  ...
  equals(other) {
    if (!(!(other == null) ? isCharSequence(other) : false))
      return false;
    if (!(this.p4d_1 === charSequenceLength(other)))
      return false;
    return rangeEqualsImpl(this, 0, other, 0, this.p4d_1);
  }
  hashCode() {
    var tmp0_safe_receiver = this.m4d_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : getStringHashCode(tmp0_safe_receiver);
    return tmp1_elvis_lhs == null ? hashCodeImpl(this, 0, this.p4d_1) : tmp1_elvis_lhs;
  }
  k1(value) {
    nonFullBuffer(this)[ensureNotNull(this.l4d_1).length - this.o4d_1 | 0] = value;
    this.m4d_1 = null;
    this.o4d_1 = this.o4d_1 - 1 | 0;
    this.p4d_1 = this.p4d_1 + 1 | 0;
    return this;
  }
  kh(value, startIndex, endIndex) {
    ...
    while (current < endIndex) {
      ...
      var offset = buffer.length - this.o4d_1 | 0;
      ...
      this.o4d_1 = this.o4d_1 - bytesToCopy | 0;
    }
    this.m4d_1 = null;
    this.p4d_1 = this.p4d_1 + (endIndex - startIndex | 0) | 0;
    return this;
  }
  k2(value) {
    if (value == null)
    ...
    if (!(list == null)) {
      ...
      if (inductionVariable < last)
        do {
          var i = inductionVariable;
          inductionVariable = inductionVariable + 1 | 0;
          this.j4d_1.h3p(list.n2(i));
        }
         while (inductionVariable < last);
    } else {
      var tmp0_safe_receiver = this.l4d_1;
      if (tmp0_safe_receiver == null)
        null;
      else {
        // Inline function 'kotlin.let' call
        this.j4d_1.h3p(tmp0_safe_receiver);
      }
      this.l4d_1 = null;
    }
    this.n4d_1 = true;
...
class UnsupportedMediaTypeExceptionCIO extends IOException {
  constructor(message) {
    return new.target.p4e(message);
  }
  static p4e(message) {
    var $this = this.y24(message);
    captureStack($this, $this.o4e_1);
    return $this;
  }
}
class MutableRange {
  ...
  toString() {
    return 'MutableRange(start=' + this.a4e_1 + ', end=' + this.b4e_1 + ')';
  }
}
//endregion
...
function thresholdReached($this) {
  return $this.y4c_1 >= $this.z4c_1 * 0.75;
}
function resize($this) {
  var prevSize = $this.y4c_1;
  var prevData = $this.a4d_1;
  $this.y4c_1 = 0;
  $this.z4c_1 = imul($this.z4c_1, 2) | 128;
  var tmp = $this;
  // Inline function 'kotlin.apply' call
  var this_0 = get_HeadersDataPool().g3p();
  this_0.d4d(imul(prevData.c4d(), 2) | 1);
  tmp.a4d_1 = this_0;
  var _iterator__ex2g4s = prevData.e4d().l1();
  while (_iterator__ex2g4s.m1()) {
    var headerOffset = _iterator__ex2g4s.n1();
    $this.g4d(prevData.f4d(headerOffset + 1 | 0), prevData.f4d(headerOffset + 2 | 0), prevData.f4d(headerOffset + 3 | 0), prevData.f4d(headerOffset + 4 | 0));
  }
  get_HeadersDataPool().h3p(prevData);
  // Inline function 'kotlin.require' call
  // Inline function 'kotlin.require' call
  if (!(prevSize === $this.y4c_1)) {
...
function headerHasName($this, name, headerOffset) {
  var nameStartIndex = $this.a4d_1.f4d(headerOffset + 1 | 0);
  var nameEndIndex = $this.a4d_1.f4d(headerOffset + 2 | 0);
  return equalsLowerCase($this.x4c_1, nameStartIndex, nameEndIndex, name);
}
function HeadersData$headersStarts$slambda(this$0) {
  return constructCallableReference(function *($this$sequence, $completion) {
    var joinedIndex = 0;
    var _iterator__ex2g4s = this$0.b4d_1.l1();
    while (_iterator__ex2g4s.m1()) {
      var arr = _iterator__ex2g4s.n1();
      var localIndex = 0;
      while (localIndex < arr.length) {
        if (!(this$0.f4d(joinedIndex + 0 | 0) === -1)) {
          yield* $this$sequence.ln(joinedIndex, $completion);
        }
...
function dumpTo(_this__u8e3s4, indent, out) {
  _init_properties_HttpHeadersMap_kt__hwatby();
  var _iterator__ex2g4s = _this__u8e3s4.i4d().l1();
  while (_iterator__ex2g4s.m1()) {
    var offset = _iterator__ex2g4s.n1();
    out.k2(indent);
    out.k2(_this__u8e3s4.r4d(offset));
    out.k2(' => ');
    out.k2(_this__u8e3s4.h4d(offset));
    out.k2('\n');
  }
}
...
function *parseHeaders(input, builder, range, $completion) {
  ...
  try {
    $l$loop: while (true) {
      ...
      range.b4e_1 = builder.p4d_1;
      var rangeLength = range.b4e_1 - range.a4e_1 | 0;
      if (rangeLength === 0)
        break $l$loop;
      if (rangeLength >= 8192) {
      ...
      var nameStart = range.a4e_1;
      var nameEnd = parseHeaderName(builder, range);
      var headerEnd = range.b4e_1;
      parseHeaderValue(builder, range);
      var valueStart = range.a4e_1;
      var valueEnd = range.b4e_1;
      range.a4e_1 = headerEnd;
      headers.g4d(nameStart, nameEnd, valueStart, valueEnd);
    }
    var host = headers.bj('Host');
    if (!(host == null)) {
...
function parseHeaderName(text, range) {
  _init_properties_HttpParser_kt__gbdom1();
  var index = range.a4e_1;
  var end = range.b4e_1;
  while (index < end) {
    var ch = text.b(index);
    if (ch === _Char___init__impl__6a9atx(58) && !(index === range.a4e_1)) {
      range.a4e_1 = index + 1 | 0;
      return index;
    }
    if (isDelimiter(ch)) {
      parseHeaderNameFailed(text, index, range.a4e_1, ch);
    }
    index = index + 1 | 0;
  }
...
function parseHeaderValue(text, range) {
  ...
  range.a4e_1 = valueStart;
  range.b4e_1 = valueLastIndex + 1 | 0;
}
function validateHostHeader(host) {
  _init_properties_HttpParser_kt__gbdom1();
  if (endsWith(host, ':')) {
    throw ParserException.g4e("Host header with ':' should contains port: " + toString(host));
  }
  var tmp$ret$0;
  $l$block: {
  ...
  if (tmp$ret$0) {
    throw ParserException.g4e('Host cannot contain any of the following symbols: ' + toString(get_hostForbiddenSymbols()));
  }
}
...
function parseHeaderNameFailed(text, index, start, ch) {
  ...
  if (ch === _Char___init__impl__6a9atx(58)) {
    throw ParserException.g4e('Empty header names are not allowed as per RFC7230.');
  }
  if (index === start) {
    throw ParserException.g4e('Multiline headers via line folding is not supported since it is deprecated as per RFC7230.');
  }
  characterIsNotAllowed(text, ch);
}
function noColonFound(text, range) {
  _init_properties_HttpParser_kt__gbdom1();
  var tmp2 = range.a4e_1;
  // Inline function 'kotlin.text.substring' call
  var endIndex = range.b4e_1;
  var tmp$ret$0 = toString(charSequenceSubSequence(text, tmp2, endIndex));
  throw ParserException.g4e('No colon in HTTP header in ' + tmp$ret$0 + ' in builder: \n' + toString(text));
}
function characterIsNotAllowed(text, ch) {
  _init_properties_HttpParser_kt__gbdom1();
  // Inline function 'kotlin.code' call
  var tmp$ret$0 = Char__toInt_impl_vasixd(ch);
  throw ParserException.g4e('Character with code ' + (tmp$ret$0 & 255) + ' is not allowed in header names, \n' + toString(text));
}
...
function _init_properties_HttpParser_kt__gbdom1() {
  if (!properties_initialized_HttpParser_kt_uedryv) {
    ...
    httpLineEndings = LineEndingMode__plus_impl_ttpz2j(Companion_getInstance_0().h3o_1, Companion_getInstance_0().g3o_1);
    versions = Companion_instance.h4e(listOf(['HTTP/1.0', 'HTTP/1.1']));
  }
}
function get_CrLf() {
...
function parseMultipart(_this__u8e3s4, input, contentType, contentLength, maxPartSize) {
  ...
  _init_properties_Multipart_kt__ato98a();
  if (!MultiPart_getInstance().p3y(contentType)) {
    throw UnsupportedMediaTypeExceptionCIO.p4e('Failed to parse multipart: Content-Type should be multipart/* but it is ' + toString(contentType));
  }
  var boundaryByteBuffer = parseBoundaryInternal(contentType);
  var boundaryBytes = ByteString.i21(boundaryByteBuffer);
...
function parseBoundaryInternal(contentType) {
  ...
  if (boundaryParameter === -1) {
    throw IOException.y24("Failed to parse multipart: Content-Type's boundary parameter is missing");
  }
  ...
  if (inductionVariable < last)
    loop: do {
      ...
      if ((v & 65535) > 127) {
        throw IOException.y24('Failed to parse multipart: wrong boundary byte 0x' + toString_0(v, 16) + ' - should be 7bit character');
      }
      switch (state) {
        case 0:
     ...
     while (inductionVariable < last);
  if (position._v === 4) {
    throw IOException.y24('Empty multipart boundary is not allowed');
  }
...
function *parsePartHeadersImpl(input, $completion) {
  ...
  try {
    ...
    var tmp;
    if (tmp0_elvis_lhs == null) {
      throw EOFException.t21('Failed to parse multipart headers: unexpected end of stream');
    } else {
      tmp = tmp0_elvis_lhs;
    }
    return tmp;
...
function *parsePartBodyImpl(boundaryPrefixed, input, output, headers, limit, $completion) {
  var tmp0_safe_receiver = headers.bj('Content-Length');
...
function throwLimitExceeded(actual, limit) {
  _init_properties_Multipart_kt__ato98a();
  throw IOException.y24('Multipart content length exceeds limit ' + actual.toString() + ' > ' + limit.toString() + '; ' + "limit is defined using 'formFieldLimit' argument");
}
function parseBoundaryInternal$put(position, boundaryBytes, value) {
  if (position._v >= boundaryBytes.length) {
    throw IOException.y24("Failed to parse multipart: boundary shouldn't be longer than 70 characters");
  }
...
function parseMultipart$slambda$slambda($firstBoundary, $countedInput) {
  return constructCallableReference(function *($this$writer, $completion) {
    yield* /*#__NOINLINE__*/parsePreambleImpl($firstBoundary, $countedInput, $this$writer.w3n_1, 8193n, $completion);
    yield* $this$writer.w3n_1.z3m($completion);
    return Unit_instance;
  }, 1);
}
function parseMultipart$slambda($input, $boundaryPrefixed, $maxPartSize, $totalLength) {
  return constructCallableReference(function *($this$produce, $completion) {
    ...
    var readBeforeParse = countedInput.e3o();
    var firstBoundary = $boundaryPrefixed.j21(get_PrefixString().l2());
    var preambleData = yield* readRemaining(writer($this$produce, VOID, VOID, parseMultipart$slambda$slambda(firstBoundary, countedInput)).m3n_1, $completion);
    var tmp;
    if (get_remaining(preambleData) > 0n) {
      tmp = yield* $this$produce.i2l(new Preamble(preambleData), $completion);
    }
    $l$loop: while (!countedInput.p3m() && !(yield* skipIfFound(countedInput, get_PrefixString(), $completion))) {
      ...
      try {
        ...
        if ($p instanceof Error) {
          var cause = $p;
          if (headers.x2c(cause)) {
            var tmp0_safe_receiver = headersMap;
            if (tmp0_safe_receiver == null)
              null;
            else {
              tmp0_safe_receiver.s1m();
            }
          }
          close(body, cause);
          throw cause;
    ...
    var tmp_0;
    if (!($totalLength == null)) {
      var consumedExceptEpilogue = subtract(countedInput.e3o(), readBeforeParse);
      var size = subtract($totalLength, consumedExceptEpilogue);
      if (size > 2147483647n)
        throw IOException.y24('Failed to parse multipart: prologue is too long');
      var tmp_1;
      if (size > 0n) {
        tmp_1 = yield* $this$produce.i2l(new Epilogue(yield* readPacket(countedInput, convertToInt(size), $completion)), $completion);
      }
      tmp_0 = tmp_1;
    } else {
      var epilogueContent = yield* readRemaining(countedInput, $completion);
      var tmp_2;
      if (!epilogueContent.v21()) {
        tmp_2 = yield* $this$produce.i2l(new Epilogue(epilogueContent), $completion);
      }
      tmp_0 = tmp_2;
    }
    return Unit_instance;
...
function _init_properties_Multipart_kt__ato98a() {
  if (!properties_initialized_Multipart_kt_wu0sh0) {
    ...
    CrLf = ByteString.i21(toByteArray_0('\r\n'));
...
function getImpl($this, index) {
  return bufferForIndex($this, index)[index % ensureNotNull($this.l4d_1).length | 0];
}
...
function bufferForIndex($this, index) {
  ...
  return list.n2(index / ensureNotNull($this.l4d_1).length | 0);
}
...
function nonFullBuffer($this) {
  return $this.o4d_1 === 0 ? appendNewArray($this) : ensureNotNull($this.l4d_1);
}
function appendNewArray($this) {
  var newBuffer = $this.j4d_1.g3p();
  var existing = $this.l4d_1;
  $this.l4d_1 = newBuffer;
  $this.o4d_1 = newBuffer.length;
  $this.n4d_1 = false;
  if (!(existing == null)) {
    var tmp0_elvis_lhs = $this.k4d_1;
    var tmp;
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlin.also' call
...
function currentPosition($this) {
  return ensureNotNull($this.l4d_1).length - $this.o4d_1 | 0;
}
...
function DefaultHttpMethods$lambda(it) {
  _init_properties_Chars_kt__d3i39x();
  return it.t45_1.length;
}
function DefaultHttpMethods$lambda_0(m, idx) {
  _init_properties_Chars_kt__d3i39x();
  return new Char(charCodeAt(m.t45_1, idx));
}
...
function _init_properties_Chars_kt__d3i39x() {
  if (!properties_initialized_Chars_kt_phjfhp) {
    ...
    var tmp_0 = Companion_getInstance().s45_1;
    var tmp_1 = DefaultHttpMethods$lambda;
    DefaultHttpMethods = tmp.u4e(tmp_0, tmp_1, DefaultHttpMethods$lambda_0);
