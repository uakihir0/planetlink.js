...
class CIOMultipartDataBase {
  constructor(coroutineContext, channel, contentType, contentLength, formFieldLimit) {
    ...
    this.a4d_1 = coroutineContext;
    this.b4d_1 = null;
    this.c4d_1 = parseMultipart(this, channel, contentType, contentLength, formFieldLimit);
  }
  q25() {
    return this.a4d_1;
  }
...
class HttpHeadersMap {
  constructor(builder) {
    ...
    this.e4d_1 = 0;
    this.f4d_1 = 0;
    this.g4d_1 = get_HeadersDataPool().m3p();
  }
  dj(name) {
    if (this.e4d_1 === 0)
      return null;
    ...
    var hash = abs(this_0);
    var headerIndex = hash % this.f4d_1 | 0;
    while (!(this.g4d_1.l4d(imul(headerIndex, 6) + 0 | 0) === -1)) {
      if (headerHasName(this, name, imul(headerIndex, 6))) {
        return this.n4d(imul(headerIndex, 6));
      }
      headerIndex = (headerIndex + 1 | 0) % this.f4d_1 | 0;
    }
    return null;
  }
  o4d() {
    return this.g4d_1.k4d();
  }
  m4d(nameStartIndex, nameEndIndex, valueStartIndex, valueEndIndex) {
    if (thresholdReached(this)) {
      resize(this);
    }
    // Inline function 'kotlin.math.absoluteValue' call
    var this_0 = hashCodeLowerCase(this.d4d_1, nameStartIndex, nameEndIndex);
    var hash = abs(this_0);
    var name = this.d4d_1.c(nameStartIndex, nameEndIndex);
    var headerIndex = hash % this.f4d_1 | 0;
    ...
    this.g4d_1.w4d(headerOffset + 0 | 0, hash);
    this.g4d_1.w4d(headerOffset + 1 | 0, nameStartIndex);
    this.g4d_1.w4d(headerOffset + 2 | 0, nameEndIndex);
    this.g4d_1.w4d(headerOffset + 3 | 0, valueStartIndex);
    this.g4d_1.w4d(headerOffset + 4 | 0, valueEndIndex);
    this.g4d_1.w4d(headerOffset + 5 | 0, -1);
    if (!(sameNameHeaderIndex === -1)) {
      this.g4d_1.w4d(imul(sameNameHeaderIndex, 6) + 5 | 0, headerIndex);
    }
    this.e4d_1 = this.e4d_1 + 1 | 0;
  }
  x4d(headerOffset) {
    var nameStartIndex = this.g4d_1.l4d(headerOffset + 1 | 0);
    var nameEndIndex = this.g4d_1.l4d(headerOffset + 2 | 0);
    return this.d4d_1.c(nameStartIndex, nameEndIndex);
  }
  n4d(headerOffset) {
    var valueStartIndex = this.g4d_1.l4d(headerOffset + 3 | 0);
    var valueEndIndex = this.g4d_1.l4d(headerOffset + 4 | 0);
    return this.d4d_1.c(valueStartIndex, valueEndIndex);
  }
  u1m() {
    this.e4d_1 = 0;
    this.f4d_1 = 0;
    get_HeadersDataPool().n3p(this.g4d_1);
    this.g4d_1 = get_HeadersDataPool().m3p();
  }
  toString() {
...
class HeadersData {
  constructor() {
    ...
    tmp.h4d_1 = ArrayList.j2();
  }
  i4d() {
    return this.h4d_1.l2();
  }
  j4d(subArraysCount) {
    ...
    if (inductionVariable < subArraysCount)
      do {
        ...
        this.h4d_1.i2(get_IntArrayPool().m3p());
      }
       while (inductionVariable < subArraysCount);
  }
  l4d(index) {
    return this.h4d_1.n2(index / 768 | 0)[index % 768 | 0];
  }
  w4d(index, value) {
    this.h4d_1.n2(index / 768 | 0)[index % 768 | 0] = value;
  }
  k4d() {
    return sequence(HeadersData$headersStarts$slambda(this));
  }
  u1m() {
    var _iterator__ex2g4s = this.h4d_1.l1();
    while (_iterator__ex2g4s.m1()) {
      var array = _iterator__ex2g4s.n1();
      get_IntArrayPool().n3p(array);
    }
    this.h4d_1.j4();
  }
}
class IntArrayPool$1 extends DefaultPool {
  ...
  b4e(instance) {
    fill(instance, -1);
    return protoOf(DefaultPool).k3p.call(this, instance);
  }
  k3p(instance) {
    return this.b4e(isIntArray(instance) ? instance : THROW_CCE());
  }
}
class HeadersDataPool$1 extends DefaultPool {
  ...
  k3p(instance) {
    return this.f4e(instance instanceof HeadersData ? instance : THROW_CCE());
  }
}
class ParserException extends IllegalStateException {
  constructor(message) {
    return new.target.m4e(message);
  }
  static m4e(message) {
    var $this = this.o(message);
    captureStack($this, $this.l4e_1);
    return $this;
  }
}
...
class Companion {
  n4e(from) {
    ...
    return this.a4f(from, tmp, AsciiCharTree$Companion$build$lambda_0);
  }
  a4f(from, length, charAt) {
    var tmp$ret$0;
    $l$block_0: {
    ...
    if (tmp1_elvis_lhs == null) {
      throw NoSuchElementException.e2('Unable to build char tree from an empty list');
    } else {
...
class SubSequenceImpl {
  ...
  a() {
    return this.d4f_1 - this.c4f_1 | 0;
  }
  b(index) {
    var withOffset = index + this.c4f_1 | 0;
  ...
  c(startIndex, endIndex) {
    ...
    // Inline function 'kotlin.require' call
    if (!(endIndex <= (this.d4f_1 - this.c4f_1 | 0))) {
      var message_1 = 'end should be less than length (' + this.a() + ')';
      throw IllegalArgumentException.a2(toString(message_1));
    }
    if (startIndex === endIndex)
      return '';
    return new SubSequenceImpl(this.f4f_1, this.c4f_1 + startIndex | 0, this.c4f_1 + endIndex | 0);
  }
  toString() {
    var tmp0_elvis_lhs = this.e4f_1;
    var tmp;
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlin.also' call
      var this_0 = toString(copy(this.f4f_1, this.c4f_1, this.d4f_1));
      this.e4f_1 = this_0;
      tmp = this_0;
    } else {
      tmp = tmp0_elvis_lhs;
  ...
  equals(other) {
    ...
    if (!(charSequenceLength(other) === this.a()))
      return false;
    return rangeEqualsImpl(this.f4f_1, this.c4f_1, other, 0, this.a());
  }
  hashCode() {
    var tmp0_safe_receiver = this.e4f_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : getStringHashCode(tmp0_safe_receiver);
    return tmp1_elvis_lhs == null ? hashCodeImpl(this.f4f_1, this.c4f_1, this.d4f_1) : tmp1_elvis_lhs;
  }
}
class CharArrayBuilder {
  ...
  b(index) {
    ...
    // Inline function 'kotlin.require' call
    if (!(index < this.v4d_1)) {
      var message_0 = 'index ' + index + ' is not in range [0, ' + this.v4d_1 + ')';
      throw IllegalArgumentException.a2(toString(message_0));
    }
  ...
  c(startIndex, endIndex) {
    ...
    // Inline function 'kotlin.require' call
    if (!(endIndex <= this.v4d_1)) {
      var message_1 = 'endIndex (' + endIndex + ') is greater than length (' + this.v4d_1 + ')';
      throw IllegalArgumentException.a2(toString(message_1));
    }
    return new SubSequenceImpl(this, startIndex, endIndex);
  }
  toString() {
    var tmp0_elvis_lhs = this.s4d_1;
    var tmp;
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlin.also' call
      var this_0 = toString(copy(this, 0, this.v4d_1));
      this.s4d_1 = this_0;
      tmp = this_0;
    } else {
      tmp = tmp0_elvis_lhs;
  ...
  equals(other) {
    if (!(!(other == null) ? isCharSequence(other) : false))
      return false;
    if (!(this.v4d_1 === charSequenceLength(other)))
      return false;
    return rangeEqualsImpl(this, 0, other, 0, this.v4d_1);
  }
  hashCode() {
    var tmp0_safe_receiver = this.s4d_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : getStringHashCode(tmp0_safe_receiver);
    return tmp1_elvis_lhs == null ? hashCodeImpl(this, 0, this.v4d_1) : tmp1_elvis_lhs;
  }
  k1(value) {
    nonFullBuffer(this)[ensureNotNull(this.r4d_1).length - this.u4d_1 | 0] = value;
    this.s4d_1 = null;
  ...
  mh(value, startIndex, endIndex) {
    ...
    while (current < endIndex) {
      ...
      var offset = buffer.length - this.u4d_1 | 0;
      ...
      this.u4d_1 = this.u4d_1 - bytesToCopy | 0;
    }
    this.s4d_1 = null;
    this.v4d_1 = this.v4d_1 + (endIndex - startIndex | 0) | 0;
    return this;
  }
  k2(value) {
    if (value == null)
      return this;
    return this.mh(value, 0, charSequenceLength(value));
  }
  u1m() {
    var list = this.q4d_1;
    if (!(list == null)) {
      ...
      if (inductionVariable < last)
        do {
          var i = inductionVariable;
          inductionVariable = inductionVariable + 1 | 0;
          this.p4d_1.n3p(list.n2(i));
        }
         while (inductionVariable < last);
    } else {
      var tmp0_safe_receiver = this.r4d_1;
      if (tmp0_safe_receiver == null)
        null;
      else {
        // Inline function 'kotlin.let' call
        this.p4d_1.n3p(tmp0_safe_receiver);
      }
      this.r4d_1 = null;
    }
    this.t4d_1 = true;
...
class UnsupportedMediaTypeExceptionCIO extends IOException {
  constructor(message) {
    return new.target.v4e(message);
  }
  static v4e(message) {
    var $this = this.a25(message);
    captureStack($this, $this.u4e_1);
    return $this;
  }
}
class MutableRange {
  ...
  toString() {
    return 'MutableRange(start=' + this.g4e_1 + ', end=' + this.h4e_1 + ')';
  }
}
//endregion
...
function thresholdReached($this) {
  return $this.e4d_1 >= $this.f4d_1 * 0.75;
}
function resize($this) {
  var prevSize = $this.e4d_1;
  var prevData = $this.g4d_1;
  $this.e4d_1 = 0;
  $this.f4d_1 = imul($this.f4d_1, 2) | 128;
  var tmp = $this;
  // Inline function 'kotlin.apply' call
  var this_0 = get_HeadersDataPool().m3p();
  this_0.j4d(imul(prevData.i4d(), 2) | 1);
  tmp.g4d_1 = this_0;
  var _iterator__ex2g4s = prevData.k4d().l1();
  while (_iterator__ex2g4s.m1()) {
    var headerOffset = _iterator__ex2g4s.n1();
    $this.m4d(prevData.l4d(headerOffset + 1 | 0), prevData.l4d(headerOffset + 2 | 0), prevData.l4d(headerOffset + 3 | 0), prevData.l4d(headerOffset + 4 | 0));
  }
  get_HeadersDataPool().n3p(prevData);
  // Inline function 'kotlin.require' call
  // Inline function 'kotlin.require' call
  if (!(prevSize === $this.e4d_1)) {
...
function headerHasName($this, name, headerOffset) {
  var nameStartIndex = $this.g4d_1.l4d(headerOffset + 1 | 0);
  var nameEndIndex = $this.g4d_1.l4d(headerOffset + 2 | 0);
  return equalsLowerCase($this.d4d_1, nameStartIndex, nameEndIndex, name);
}
function HeadersData$headersStarts$slambda(this$0) {
  return constructCallableReference(function *($this$sequence, $completion) {
    var joinedIndex = 0;
    var _iterator__ex2g4s = this$0.h4d_1.l1();
    while (_iterator__ex2g4s.m1()) {
      var arr = _iterator__ex2g4s.n1();
      var localIndex = 0;
      while (localIndex < arr.length) {
        if (!(this$0.l4d(joinedIndex + 0 | 0) === -1)) {
          yield* $this$sequence.nn(joinedIndex, $completion);
        }
...
function dumpTo(_this__u8e3s4, indent, out) {
  _init_properties_HttpHeadersMap_kt__hwatby();
  var _iterator__ex2g4s = _this__u8e3s4.o4d().l1();
  while (_iterator__ex2g4s.m1()) {
    var offset = _iterator__ex2g4s.n1();
    out.k2(indent);
    out.k2(_this__u8e3s4.x4d(offset));
    out.k2(' => ');
...
function *parseHeaders(input, builder, range, $completion) {
  ...
  try {
    $l$loop: while (true) {
      ...
      range.h4e_1 = builder.v4d_1;
      var rangeLength = range.h4e_1 - range.g4e_1 | 0;
      if (rangeLength === 0)
        break $l$loop;
      if (rangeLength >= 8192) {
      ...
      var nameStart = range.g4e_1;
      var nameEnd = parseHeaderName(builder, range);
      var headerEnd = range.h4e_1;
      parseHeaderValue(builder, range);
      var valueStart = range.g4e_1;
      var valueEnd = range.h4e_1;
      range.g4e_1 = headerEnd;
      headers.m4d(nameStart, nameEnd, valueStart, valueEnd);
    }
    var host = headers.dj('Host');
    if (!(host == null)) {
...
function parseHeaderName(text, range) {
  _init_properties_HttpParser_kt__gbdom1();
  var index = range.g4e_1;
  var end = range.h4e_1;
  while (index < end) {
    var ch = text.b(index);
    if (ch === _Char___init__impl__6a9atx(58) && !(index === range.g4e_1)) {
      range.g4e_1 = index + 1 | 0;
      return index;
    }
    if (isDelimiter(ch)) {
      parseHeaderNameFailed(text, index, range.g4e_1, ch);
    }
    index = index + 1 | 0;
  }
...
function parseHeaderValue(text, range) {
  ...
  range.g4e_1 = valueStart;
  range.h4e_1 = valueLastIndex + 1 | 0;
}
function validateHostHeader(host) {
  _init_properties_HttpParser_kt__gbdom1();
  if (endsWith(host, ':')) {
    throw ParserException.m4e("Host header with ':' should contains port: " + toString(host));
  }
  var tmp$ret$0;
  $l$block: {
  ...
  if (tmp$ret$0) {
    throw ParserException.m4e('Host cannot contain any of the following symbols: ' + toString(get_hostForbiddenSymbols()));
  }
}
...
function parseHeaderNameFailed(text, index, start, ch) {
  ...
  if (ch === _Char___init__impl__6a9atx(58)) {
    throw ParserException.m4e('Empty header names are not allowed as per RFC7230.');
  }
  if (index === start) {
    throw ParserException.m4e('Multiline headers via line folding is not supported since it is deprecated as per RFC7230.');
  }
  characterIsNotAllowed(text, ch);
}
function noColonFound(text, range) {
  _init_properties_HttpParser_kt__gbdom1();
  var tmp2 = range.g4e_1;
  // Inline function 'kotlin.text.substring' call
  var endIndex = range.h4e_1;
  var tmp$ret$0 = toString(charSequenceSubSequence(text, tmp2, endIndex));
  throw ParserException.m4e('No colon in HTTP header in ' + tmp$ret$0 + ' in builder: \n' + toString(text));
}
function characterIsNotAllowed(text, ch) {
  _init_properties_HttpParser_kt__gbdom1();
  // Inline function 'kotlin.code' call
  var tmp$ret$0 = Char__toInt_impl_vasixd(ch);
  throw ParserException.m4e('Character with code ' + (tmp$ret$0 & 255) + ' is not allowed in header names, \n' + toString(text));
}
...
function _init_properties_HttpParser_kt__gbdom1() {
  if (!properties_initialized_HttpParser_kt_uedryv) {
    ...
    httpLineEndings = LineEndingMode__plus_impl_ttpz2j(Companion_getInstance_0().n3o_1, Companion_getInstance_0().m3o_1);
    versions = Companion_instance.n4e(listOf(['HTTP/1.0', 'HTTP/1.1']));
  }
}
function get_CrLf() {
...
function parseMultipart(_this__u8e3s4, input, contentType, contentLength, maxPartSize) {
  ...
  _init_properties_Multipart_kt__ato98a();
  if (!MultiPart_getInstance().v3y(contentType)) {
    throw UnsupportedMediaTypeExceptionCIO.v4e('Failed to parse multipart: Content-Type should be multipart/* but it is ' + toString(contentType));
  }
  var boundaryByteBuffer = parseBoundaryInternal(contentType);
  var boundaryBytes = ByteString.k21(boundaryByteBuffer);
...
function parseBoundaryInternal(contentType) {
  ...
  if (boundaryParameter === -1) {
    throw IOException.a25("Failed to parse multipart: Content-Type's boundary parameter is missing");
  }
  ...
  if (inductionVariable < last)
    loop: do {
      ...
      if ((v & 65535) > 127) {
        throw IOException.a25('Failed to parse multipart: wrong boundary byte 0x' + toString_0(v, 16) + ' - should be 7bit character');
      }
      switch (state) {
        case 0:
     ...
     while (inductionVariable < last);
  if (position._v === 4) {
    throw IOException.a25('Empty multipart boundary is not allowed');
  }
...
function *parsePartHeadersImpl(input, $completion) {
  ...
  try {
    ...
    var tmp;
    if (tmp0_elvis_lhs == null) {
      throw EOFException.v21('Failed to parse multipart headers: unexpected end of stream');
    } else {
      tmp = tmp0_elvis_lhs;
    }
    return tmp;
...
function *parsePartBodyImpl(boundaryPrefixed, input, output, headers, limit, $completion) {
  var tmp0_safe_receiver = headers.dj('Content-Length');
...
function throwLimitExceeded(actual, limit) {
  _init_properties_Multipart_kt__ato98a();
  throw IOException.a25('Multipart content length exceeds limit ' + actual.toString() + ' > ' + limit.toString() + '; ' + "limit is defined using 'formFieldLimit' argument");
}
function parseBoundaryInternal$put(position, boundaryBytes, value) {
  if (position._v >= boundaryBytes.length) {
    throw IOException.a25("Failed to parse multipart: boundary shouldn't be longer than 70 characters");
  }
...
function parseMultipart$slambda$slambda($firstBoundary, $countedInput) {
  return constructCallableReference(function *($this$writer, $completion) {
    yield* /*#__NOINLINE__*/parsePreambleImpl($firstBoundary, $countedInput, $this$writer.c3o_1, 8193n, $completion);
    yield* $this$writer.c3o_1.f3n($completion);
    return Unit_instance;
  }, 1);
}
function parseMultipart$slambda($input, $boundaryPrefixed, $maxPartSize, $totalLength) {
  return constructCallableReference(function *($this$produce, $completion) {
    ...
    var readBeforeParse = countedInput.k3o();
    var firstBoundary = $boundaryPrefixed.l21(get_PrefixString().l2());
    var preambleData = yield* readRemaining(writer($this$produce, VOID, VOID, parseMultipart$slambda$slambda(firstBoundary, countedInput)).s3n_1, $completion);
    var tmp;
    if (get_remaining(preambleData) > 0n) {
      tmp = yield* $this$produce.o2l(new Preamble(preambleData), $completion);
    }
    $l$loop: while (!countedInput.v3m() && !(yield* skipIfFound(countedInput, get_PrefixString(), $completion))) {
      ...
      try {
        ...
        if ($p instanceof Error) {
          var cause = $p;
          if (headers.z2c(cause)) {
            var tmp0_safe_receiver = headersMap;
            if (tmp0_safe_receiver == null)
              null;
            else {
              tmp0_safe_receiver.u1m();
            }
          }
          close(body, cause);
          throw cause;
    ...
    var tmp_0;
    if (!($totalLength == null)) {
      var consumedExceptEpilogue = subtract(countedInput.k3o(), readBeforeParse);
      var size = subtract($totalLength, consumedExceptEpilogue);
      if (size > 2147483647n)
        throw IOException.a25('Failed to parse multipart: prologue is too long');
      var tmp_1;
      if (size > 0n) {
        tmp_1 = yield* $this$produce.o2l(new Epilogue(yield* readPacket(countedInput, convertToInt(size), $completion)), $completion);
      }
      tmp_0 = tmp_1;
    } else {
      var epilogueContent = yield* readRemaining(countedInput, $completion);
      var tmp_2;
      if (!epilogueContent.x21()) {
        tmp_2 = yield* $this$produce.o2l(new Epilogue(epilogueContent), $completion);
      }
      tmp_0 = tmp_2;
    }
    return Unit_instance;
...
function _init_properties_Multipart_kt__ato98a() {
  if (!properties_initialized_Multipart_kt_wu0sh0) {
    ...
    CrLf = ByteString.k21(toByteArray_0('\r\n'));
  ...
  while (_iterator__ex2g4s_0.m1()) {
    ...
    while (_iterator__ex2g4s_2.m1()) {
      ...
      if (length(element_2) === nextIdx) {
        destination_1.i2(element_2);
      }
    }
    resultList.i2(new Node(ch, destination_1, children));
  }
}
...
function getImpl($this, index) {
  return bufferForIndex($this, index)[index % ensureNotNull($this.r4d_1).length | 0];
}
...
function bufferForIndex($this, index) {
  ...
  return list.n2(index / ensureNotNull($this.r4d_1).length | 0);
}
...
function nonFullBuffer($this) {
  return $this.u4d_1 === 0 ? appendNewArray($this) : ensureNotNull($this.r4d_1);
}
function appendNewArray($this) {
  var newBuffer = $this.p4d_1.m3p();
  var existing = $this.r4d_1;
  $this.r4d_1 = newBuffer;
  $this.u4d_1 = newBuffer.length;
  $this.t4d_1 = false;
  if (!(existing == null)) {
...
function currentPosition($this) {
  return ensureNotNull($this.r4d_1).length - $this.u4d_1 | 0;
}
...
function numberFormatException(cs) {
  _init_properties_Chars_kt__d3i39x();
  throw NumberFormatException.qf('Invalid number ' + toString(cs) + ': too large for Long type');
}
...
function numberFormatException_0(cs, idx) {
  _init_properties_Chars_kt__d3i39x();
  throw NumberFormatException.qf('Invalid number: ' + toString(cs) + ', wrong digit: ' + toString_1(charSequenceGet(cs, idx)) + ' at position ' + idx);
}
function DefaultHttpMethods$lambda(it) {
  _init_properties_Chars_kt__d3i39x();
  return it.z45_1.length;
}
function DefaultHttpMethods$lambda_0(m, idx) {
  _init_properties_Chars_kt__d3i39x();
  return new Char(charCodeAt(m.z45_1, idx));
}
...
function _init_properties_Chars_kt__d3i39x() {
  if (!properties_initialized_Chars_kt_phjfhp) {
    ...
    var tmp_0 = Companion_getInstance().y45_1;
    var tmp_1 = DefaultHttpMethods$lambda;
    DefaultHttpMethods = tmp.a4f(tmp_0, tmp_1, DefaultHttpMethods$lambda_0);
