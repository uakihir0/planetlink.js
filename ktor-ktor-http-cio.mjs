...
class CIOMultipartDataBase {
  constructor(coroutineContext, channel, contentType, contentLength, formFieldLimit) {
    ...
    this.i49_1 = coroutineContext;
    this.j49_1 = null;
    this.k49_1 = parseMultipart(this, channel, contentType, contentLength, formFieldLimit);
  }
  s24() {
    return this.i49_1;
  }
...
class HttpHeadersMap {
  constructor(builder) {
    ...
    this.m49_1 = 0;
    this.n49_1 = 0;
    this.o49_1 = get_HeadersDataPool().t3l();
  }
  ui(name) {
    if (this.m49_1 === 0)
      return null;
    ...
    var hash = abs(this_0);
    var headerIndex = hash % this.n49_1 | 0;
    while (!(this.o49_1.t49(imul(headerIndex, 6) + 0 | 0) === -1)) {
      if (headerHasName(this, name, imul(headerIndex, 6))) {
        return this.v49(imul(headerIndex, 6));
      }
      headerIndex = (headerIndex + 1 | 0) % this.n49_1 | 0;
    }
    return null;
  }
  w49() {
    return this.o49_1.s49();
  }
  u49(nameStartIndex, nameEndIndex, valueStartIndex, valueEndIndex) {
    if (thresholdReached(this)) {
      resize(this);
    }
    // Inline function 'kotlin.math.absoluteValue' call
    var this_0 = hashCodeLowerCase(this.l49_1, nameStartIndex, nameEndIndex);
    var hash = abs(this_0);
    var name = this.l49_1.c(nameStartIndex, nameEndIndex);
    var headerIndex = hash % this.n49_1 | 0;
    ...
    this.o49_1.e4a(headerOffset + 0 | 0, hash);
    this.o49_1.e4a(headerOffset + 1 | 0, nameStartIndex);
    this.o49_1.e4a(headerOffset + 2 | 0, nameEndIndex);
    this.o49_1.e4a(headerOffset + 3 | 0, valueStartIndex);
    this.o49_1.e4a(headerOffset + 4 | 0, valueEndIndex);
    this.o49_1.e4a(headerOffset + 5 | 0, -1);
    if (!(sameNameHeaderIndex === -1)) {
      this.o49_1.e4a(imul(sameNameHeaderIndex, 6) + 5 | 0, headerIndex);
    }
    this.m49_1 = this.m49_1 + 1 | 0;
  }
  f4a(headerOffset) {
    var nameStartIndex = this.o49_1.t49(headerOffset + 1 | 0);
    var nameEndIndex = this.o49_1.t49(headerOffset + 2 | 0);
    return this.l49_1.c(nameStartIndex, nameEndIndex);
  }
  v49(headerOffset) {
    var valueStartIndex = this.o49_1.t49(headerOffset + 3 | 0);
    var valueEndIndex = this.o49_1.t49(headerOffset + 4 | 0);
    return this.l49_1.c(valueStartIndex, valueEndIndex);
  }
  w1l() {
    this.m49_1 = 0;
    this.n49_1 = 0;
    get_HeadersDataPool().u3l(this.o49_1);
    this.o49_1 = get_HeadersDataPool().t3l();
  }
  toString() {
...
class HeadersData {
  constructor() {
    ...
    tmp.p49_1 = ArrayList.p2();
  }
  q49() {
    return this.p49_1.k2();
  }
  r49(subArraysCount) {
    ...
    if (inductionVariable < subArraysCount)
      do {
        ...
        this.p49_1.e2(get_IntArrayPool().t3l());
      }
       while (inductionVariable < subArraysCount);
  }
  t49(index) {
    return this.p49_1.m2(index / 768 | 0)[index % 768 | 0];
  }
  e4a(index, value) {
    this.p49_1.m2(index / 768 | 0)[index % 768 | 0] = value;
  }
  s49() {
    return sequence(HeadersData$headersStarts$slambda(this));
  }
  w1l() {
    var _iterator__ex2g4s = this.p49_1.l1();
    while (_iterator__ex2g4s.m1()) {
      var array = _iterator__ex2g4s.n1();
      get_IntArrayPool().u3l(array);
    }
    this.p49_1.j4();
  }
}
class IntArrayPool$1 extends DefaultPool {
  ...
  j4a(instance) {
    fill(instance, -1);
    return protoOf(DefaultPool).r3l.call(this, instance);
  }
  r3l(instance) {
    return this.j4a(isIntArray(instance) ? instance : THROW_CCE());
  }
}
class HeadersDataPool$1 extends DefaultPool {
  ...
  r3l(instance) {
    return this.n4a(instance instanceof HeadersData ? instance : THROW_CCE());
  }
}
class ParserException extends IllegalStateException {
  constructor(message) {
    return new.target.u4a(message);
  }
  static u4a(message) {
    var $this = this.o(message);
    captureStack($this, $this.t4a_1);
    return $this;
  }
}
...
class Companion {
  v4a(from) {
    ...
    return this.i4b(from, tmp, AsciiCharTree$Companion$build$lambda_0);
  }
  i4b(from, length, charAt) {
    var tmp$ret$0;
    $l$block_0: {
...
class SubSequenceImpl {
  ...
  a() {
    return this.l4b_1 - this.k4b_1 | 0;
  }
  b(index) {
    var withOffset = index + this.k4b_1 | 0;
  ...
  c(startIndex, endIndex) {
    ...
    // Inline function 'kotlin.require' call
    if (!(endIndex <= (this.l4b_1 - this.k4b_1 | 0))) {
      var message_1 = 'end should be less than length (' + this.a() + ')';
      throw IllegalArgumentException.a2(toString(message_1));
    }
    if (startIndex === endIndex)
      return '';
    return new SubSequenceImpl(this.n4b_1, this.k4b_1 + startIndex | 0, this.k4b_1 + endIndex | 0);
  }
  toString() {
    var tmp0_elvis_lhs = this.m4b_1;
    var tmp;
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlin.also' call
      var this_0 = toString(copy(this.n4b_1, this.k4b_1, this.l4b_1));
      this.m4b_1 = this_0;
      tmp = this_0;
    } else {
      tmp = tmp0_elvis_lhs;
  ...
  equals(other) {
    ...
    if (!(charSequenceLength(other) === this.a()))
      return false;
    return rangeEqualsImpl(this.n4b_1, this.k4b_1, other, 0, this.a());
  }
  hashCode() {
    var tmp0_safe_receiver = this.m4b_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : getStringHashCode(tmp0_safe_receiver);
    return tmp1_elvis_lhs == null ? hashCodeImpl(this.n4b_1, this.k4b_1, this.l4b_1) : tmp1_elvis_lhs;
  }
}
class CharArrayBuilder {
  ...
  b(index) {
    ...
    // Inline function 'kotlin.require' call
    if (!(index < this.d4a_1)) {
      var message_0 = 'index ' + index + ' is not in range [0, ' + this.d4a_1 + ')';
      throw IllegalArgumentException.a2(toString(message_0));
    }
  ...
  c(startIndex, endIndex) {
    ...
    // Inline function 'kotlin.require' call
    if (!(endIndex <= this.d4a_1)) {
      var message_1 = 'endIndex (' + endIndex + ') is greater than length (' + this.d4a_1 + ')';
      throw IllegalArgumentException.a2(toString(message_1));
    }
  ...
  toString() {
    ...
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlin.also' call
      var this_0 = toString(copy(this, 0, this.d4a_1));
      this.a4a_1 = this_0;
      tmp = this_0;
    } else {
      tmp = tmp0_elvis_lhs;
  ...
  equals(other) {
    if (!(!(other == null) ? isCharSequence(other) : false))
      return false;
    if (!(this.d4a_1 === charSequenceLength(other)))
      return false;
    return rangeEqualsImpl(this, 0, other, 0, this.d4a_1);
  }
  hashCode() {
    var tmp0_safe_receiver = this.a4a_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : getStringHashCode(tmp0_safe_receiver);
    return tmp1_elvis_lhs == null ? hashCodeImpl(this, 0, this.d4a_1) : tmp1_elvis_lhs;
  }
  k1(value) {
    nonFullBuffer(this)[ensureNotNull(this.z49_1).length - this.c4a_1 | 0] = value;
    this.a4a_1 = null;
    this.c4a_1 = this.c4a_1 - 1 | 0;
    this.d4a_1 = this.d4a_1 + 1 | 0;
    return this;
  }
  eh(value, startIndex, endIndex) {
    ...
    while (current < endIndex) {
      ...
      var offset = buffer.length - this.c4a_1 | 0;
      ...
      this.c4a_1 = this.c4a_1 - bytesToCopy | 0;
    }
    this.a4a_1 = null;
    this.d4a_1 = this.d4a_1 + (endIndex - startIndex | 0) | 0;
    return this;
  }
  j2(value) {
    if (value == null)
      return this;
    return this.eh(value, 0, charSequenceLength(value));
  }
  w1l() {
    var list = this.y49_1;
    if (!(list == null)) {
      ...
      if (inductionVariable < last)
        do {
          var i = inductionVariable;
          inductionVariable = inductionVariable + 1 | 0;
          this.x49_1.u3l(list.m2(i));
        }
         while (inductionVariable < last);
    } else {
      var tmp0_safe_receiver = this.z49_1;
      if (tmp0_safe_receiver == null)
        null;
      else {
        // Inline function 'kotlin.let' call
        this.x49_1.u3l(tmp0_safe_receiver);
      }
      this.z49_1 = null;
    }
    this.b4a_1 = true;
...
class UnsupportedMediaTypeExceptionCIO extends IOException {
  constructor(message) {
    return new.target.d4b(message);
  }
  static d4b(message) {
    var $this = this.c24(message);
    captureStack($this, $this.c4b_1);
    return $this;
  }
}
class MutableRange {
  ...
  toString() {
    return 'MutableRange(start=' + this.o4a_1 + ', end=' + this.p4a_1 + ')';
  }
}
//endregion
...
function thresholdReached($this) {
  return $this.m49_1 >= $this.n49_1 * 0.75;
}
function resize($this) {
  var prevSize = $this.m49_1;
  var prevData = $this.o49_1;
  $this.m49_1 = 0;
  $this.n49_1 = imul($this.n49_1, 2) | 128;
  var tmp = $this;
  // Inline function 'kotlin.apply' call
  var this_0 = get_HeadersDataPool().t3l();
  this_0.r49(imul(prevData.q49(), 2) | 1);
  tmp.o49_1 = this_0;
  var _iterator__ex2g4s = prevData.s49().l1();
  while (_iterator__ex2g4s.m1()) {
    var headerOffset = _iterator__ex2g4s.n1();
    $this.u49(prevData.t49(headerOffset + 1 | 0), prevData.t49(headerOffset + 2 | 0), prevData.t49(headerOffset + 3 | 0), prevData.t49(headerOffset + 4 | 0));
  }
  get_HeadersDataPool().u3l(prevData);
  // Inline function 'kotlin.require' call
  // Inline function 'kotlin.require' call
  if (!(prevSize === $this.m49_1)) {
...
function headerHasName($this, name, headerOffset) {
  var nameStartIndex = $this.o49_1.t49(headerOffset + 1 | 0);
  var nameEndIndex = $this.o49_1.t49(headerOffset + 2 | 0);
  return equalsLowerCase($this.l49_1, nameStartIndex, nameEndIndex, name);
}
function HeadersData$headersStarts$slambda(this$0) {
  return constructCallableReference(function *($this$sequence, $completion) {
    var joinedIndex = 0;
    var _iterator__ex2g4s = this$0.p49_1.l1();
    while (_iterator__ex2g4s.m1()) {
      var arr = _iterator__ex2g4s.n1();
      var localIndex = 0;
      while (localIndex < arr.length) {
        if (!(this$0.t49(joinedIndex + 0 | 0) === -1)) {
          yield* $this$sequence.qm(joinedIndex, $completion);
        }
...
function dumpTo(_this__u8e3s4, indent, out) {
  _init_properties_HttpHeadersMap_kt__hwatby();
  var _iterator__ex2g4s = _this__u8e3s4.w49().l1();
  while (_iterator__ex2g4s.m1()) {
    var offset = _iterator__ex2g4s.n1();
    out.j2(indent);
    out.j2(_this__u8e3s4.f4a(offset));
    out.j2(' => ');
    out.j2(_this__u8e3s4.v49(offset));
    out.j2('\n');
  }
}
...
function *parseHeaders(input, builder, range, $completion) {
  ...
  try {
    $l$loop: while (true) {
      ...
      range.p4a_1 = builder.d4a_1;
      var rangeLength = range.p4a_1 - range.o4a_1 | 0;
      if (rangeLength === 0)
        break $l$loop;
      if (rangeLength >= 8192) {
      ...
      var nameStart = range.o4a_1;
      var nameEnd = parseHeaderName(builder, range);
      var headerEnd = range.p4a_1;
      parseHeaderValue(builder, range);
      var valueStart = range.o4a_1;
      var valueEnd = range.p4a_1;
      range.o4a_1 = headerEnd;
      headers.u49(nameStart, nameEnd, valueStart, valueEnd);
    }
    var host = headers.ui('Host');
    if (!(host == null)) {
...
function parseHeaderName(text, range) {
  _init_properties_HttpParser_kt__gbdom1();
  var index = range.o4a_1;
  var end = range.p4a_1;
  while (index < end) {
    var ch = text.b(index);
    if (ch === _Char___init__impl__6a9atx(58) && !(index === range.o4a_1)) {
      range.o4a_1 = index + 1 | 0;
      return index;
    }
    if (isDelimiter(ch)) {
      parseHeaderNameFailed(text, index, range.o4a_1, ch);
    }
    index = index + 1 | 0;
  }
...
function parseHeaderValue(text, range) {
  ...
  range.o4a_1 = valueStart;
  range.p4a_1 = valueLastIndex + 1 | 0;
}
function validateHostHeader(host) {
  _init_properties_HttpParser_kt__gbdom1();
  if (endsWith(host, ':')) {
    throw ParserException.u4a("Host header with ':' should contains port: " + toString(host));
  }
  var tmp$ret$0;
  $l$block: {
  ...
  if (tmp$ret$0) {
    throw ParserException.u4a('Host cannot contain any of the following symbols: ' + toString(get_hostForbiddenSymbols()));
  }
}
...
function parseHeaderNameFailed(text, index, start, ch) {
  ...
  if (ch === _Char___init__impl__6a9atx(58)) {
    throw ParserException.u4a('Empty header names are not allowed as per RFC7230.');
  }
  if (index === start) {
    throw ParserException.u4a('Multiline headers via line folding is not supported since it is deprecated as per RFC7230.');
  }
  characterIsNotAllowed(text, ch);
}
function noColonFound(text, range) {
  _init_properties_HttpParser_kt__gbdom1();
  var tmp2 = range.o4a_1;
  // Inline function 'kotlin.text.substring' call
  var endIndex = range.p4a_1;
  var tmp$ret$0 = toString(charSequenceSubSequence(text, tmp2, endIndex));
  throw ParserException.u4a('No colon in HTTP header in ' + tmp$ret$0 + ' in builder: \n' + toString(text));
}
function characterIsNotAllowed(text, ch) {
  _init_properties_HttpParser_kt__gbdom1();
  // Inline function 'kotlin.code' call
  var tmp$ret$0 = Char__toInt_impl_vasixd(ch);
  throw ParserException.u4a('Character with code ' + (tmp$ret$0 & 255) + ' is not allowed in header names, \n' + toString(text));
}
...
function _init_properties_HttpParser_kt__gbdom1() {
  if (!properties_initialized_HttpParser_kt_uedryv) {
    ...
    httpLineEndings = LineEndingMode__plus_impl_ttpz2j(Companion_getInstance_0().u3k_1, Companion_getInstance_0().t3k_1);
    versions = Companion_instance.v4a(listOf(['HTTP/1.0', 'HTTP/1.1']));
  }
}
function get_CrLf() {
...
function parseMultipart(_this__u8e3s4, input, contentType, contentLength, maxPartSize) {
  ...
  _init_properties_Multipart_kt__ato98a();
  if (!MultiPart_getInstance().d3v(contentType)) {
    throw UnsupportedMediaTypeExceptionCIO.d4b('Failed to parse multipart: Content-Type should be multipart/* but it is ' + toString(contentType));
  }
  var boundaryByteBuffer = parseBoundaryInternal(contentType);
  var boundaryBytes = ByteString.m20(boundaryByteBuffer);
...
function parseBoundaryInternal(contentType) {
  ...
  if (boundaryParameter === -1) {
    throw IOException.c24("Failed to parse multipart: Content-Type's boundary parameter is missing");
  }
  ...
  if (inductionVariable < last)
    loop: do {
      ...
      if ((v & 65535) > 127) {
        throw IOException.c24('Failed to parse multipart: wrong boundary byte 0x' + toString_0(v, 16) + ' - should be 7bit character');
      }
      switch (state) {
        case 0:
     ...
     while (inductionVariable < last);
  if (position._v === 4) {
    throw IOException.c24('Empty multipart boundary is not allowed');
  }
...
function *parsePartHeadersImpl(input, $completion) {
  ...
  try {
    ...
    var tmp;
    if (tmp0_elvis_lhs == null) {
      throw EOFException.x20('Failed to parse multipart headers: unexpected end of stream');
    } else {
      tmp = tmp0_elvis_lhs;
    }
    return tmp;
...
function *parsePartBodyImpl(boundaryPrefixed, input, output, headers, limit, $completion) {
  var tmp0_safe_receiver = headers.ui('Content-Length');
...
function throwLimitExceeded(actual, limit) {
  _init_properties_Multipart_kt__ato98a();
  throw IOException.c24('Multipart content length exceeds limit ' + actual.toString() + ' > ' + limit.toString() + '; ' + "limit is defined using 'formFieldLimit' argument");
}
function parseBoundaryInternal$put(position, boundaryBytes, value) {
  if (position._v >= boundaryBytes.length) {
    throw IOException.c24("Failed to parse multipart: boundary shouldn't be longer than 70 characters");
  }
...
function parseMultipart$slambda$slambda($firstBoundary, $countedInput) {
  return constructCallableReference(function *($this$writer, $completion) {
    yield* /*#__NOINLINE__*/parsePreambleImpl($firstBoundary, $countedInput, $this$writer.j3k_1, 8193n, $completion);
    yield* $this$writer.j3k_1.m3j($completion);
    return Unit_instance;
  }, 1);
}
function parseMultipart$slambda($input, $boundaryPrefixed, $maxPartSize, $totalLength) {
  return constructCallableReference(function *($this$produce, $completion) {
    ...
    var readBeforeParse = countedInput.r3k();
    var firstBoundary = $boundaryPrefixed.n20(get_PrefixString().k2());
    var preambleData = yield* readRemaining(writer($this$produce, VOID, VOID, parseMultipart$slambda$slambda(firstBoundary, countedInput)).z3j_1, $completion);
    var tmp;
    if (get_remaining(preambleData) > 0n) {
      tmp = yield* $this$produce.i2k(new Preamble(preambleData), $completion);
    }
    $l$loop: while (!countedInput.c3j() && !(yield* skipIfFound(countedInput, get_PrefixString(), $completion))) {
      ...
      try {
        ...
        if ($p instanceof Error) {
          var cause = $p;
          if (headers.b2c(cause)) {
            var tmp0_safe_receiver = headersMap;
            if (tmp0_safe_receiver == null)
              null;
            else {
              tmp0_safe_receiver.w1l();
            }
          }
          close(body, cause);
          throw cause;
    ...
    var tmp_0;
    if (!($totalLength == null)) {
      var consumedExceptEpilogue = subtract(countedInput.r3k(), readBeforeParse);
      var size = subtract($totalLength, consumedExceptEpilogue);
      if (size > 2147483647n)
        throw IOException.c24('Failed to parse multipart: prologue is too long');
      var tmp_1;
      if (size > 0n) {
        tmp_1 = yield* $this$produce.i2k(new Epilogue(yield* readPacket(countedInput, convertToInt(size), $completion)), $completion);
      }
      tmp_0 = tmp_1;
    } else {
      var epilogueContent = yield* readRemaining(countedInput, $completion);
      var tmp_2;
      if (!epilogueContent.z20()) {
        tmp_2 = yield* $this$produce.i2k(new Epilogue(epilogueContent), $completion);
      }
      tmp_0 = tmp_2;
    }
    return Unit_instance;
...
function _init_properties_Multipart_kt__ato98a() {
  if (!properties_initialized_Multipart_kt_wu0sh0) {
    ...
    CrLf = ByteString.m20(toByteArray_0('\r\n'));
...
function getImpl($this, index) {
  return bufferForIndex($this, index)[index % ensureNotNull($this.z49_1).length | 0];
}
...
function bufferForIndex($this, index) {
  ...
  return list.m2(index / ensureNotNull($this.z49_1).length | 0);
}
...
function nonFullBuffer($this) {
  return $this.c4a_1 === 0 ? appendNewArray($this) : ensureNotNull($this.z49_1);
}
function appendNewArray($this) {
  var newBuffer = $this.x49_1.t3l();
  var existing = $this.z49_1;
  $this.z49_1 = newBuffer;
  $this.c4a_1 = newBuffer.length;
  $this.b4a_1 = false;
  if (!(existing == null)) {
...
function currentPosition($this) {
  return ensureNotNull($this.z49_1).length - $this.c4a_1 | 0;
}
...
function numberFormatException(cs) {
  _init_properties_Chars_kt__d3i39x();
  throw NumberFormatException.if('Invalid number ' + toString(cs) + ': too large for Long type');
}
...
function numberFormatException_0(cs, idx) {
  _init_properties_Chars_kt__d3i39x();
  throw NumberFormatException.if('Invalid number: ' + toString(cs) + ', wrong digit: ' + toString_1(charSequenceGet(cs, idx)) + ' at position ' + idx);
}
function DefaultHttpMethods$lambda(it) {
  _init_properties_Chars_kt__d3i39x();
  return it.i42_1.length;
}
function DefaultHttpMethods$lambda_0(m, idx) {
  _init_properties_Chars_kt__d3i39x();
  return new Char(charCodeAt(m.i42_1, idx));
}
...
function _init_properties_Chars_kt__d3i39x() {
  if (!properties_initialized_Chars_kt_phjfhp) {
    ...
    var tmp_0 = Companion_getInstance().h42_1;
    var tmp_1 = DefaultHttpMethods$lambda;
    DefaultHttpMethods = tmp.i4b(tmp_0, tmp_1, DefaultHttpMethods$lambda_0);
