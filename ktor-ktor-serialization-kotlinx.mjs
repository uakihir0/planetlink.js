...
import {
  ...
  ByteReadChannel2ndu7k90iil3s as ByteReadChannel,
...
class sam$kotlinx_coroutines_flow_FlowCollector$0 {
  constructor(function_0) {
    this.xkm_1 = function_0;
  }
  *h2n(value, $completion) {
    return yield* this.xkm_1(value, $completion);
  }
  c5() {
    return this.xkm_1;
  }
...
class KotlinxSerializationConverter$serialize$$inlined$map$1 {
  constructor($this, $contentType, $charset, $typeInfo, $value) {
    this.ykm_1 = $this;
    this.zkm_1 = $contentType;
    this.akn_1 = $charset;
    this.bkn_1 = $typeInfo;
    this.ckn_1 = $value;
  }
  *g2n(collector, $completion) {
    var tmp = KotlinxSerializationConverter$serialize$o$collect$slambda(collector, this.zkm_1, this.akn_1, this.bkn_1, this.ckn_1);
    yield* this.ykm_1.e2n(new sam$kotlinx_coroutines_flow_FlowCollector$0(tmp), $completion);
    return Unit_instance;
  }
  e2n(collector, $completion) {
    return this.g2n(collector, $completion);
  }
}
class KotlinxSerializationConverter {
  constructor(format) {
    this.dkn_1 = format;
    this.ekn_1 = extensions(this.dkn_1);
    var tmp;
    var tmp_0 = this.dkn_1;
    if (isInterface(tmp_0, BinaryFormat)) {
      tmp = true;
    } else {
      var tmp_1 = this.dkn_1;
      tmp = isInterface(tmp_1, StringFormat);
    }
    // Inline function 'kotlin.require' call
    if (!tmp) {
      var message = 'Only binary and string formats are supported, ' + toString(this.dkn_1) + ' is not supported.';
      throw IllegalArgumentException.a2(toString(message));
    }
  }
  *fkn(contentType, charset, typeInfo, value, $completion) {
    // Inline function 'kotlinx.coroutines.flow.map' call
    // Inline function 'kotlinx.coroutines.flow.unsafeTransform' call
    var this_0 = asFlow(this.ekn_1);
    ...
    var tmp_0;
    try {
      tmp_0 = serializerForTypeInfo(this.dkn_1.pz(), typeInfo);
    } catch ($p) {
      var tmp_1;
      if ($p instanceof SerializationException) {
        var cause = $p;
        tmp_1 = guessSerializer(value, this.dkn_1.pz());
      } else {
        throw $p;
      }
      tmp_0 = tmp_1;
    ...
    return serializeContent(this, serializer, this.dkn_1, value, contentType, charset);
  }
  vkm(contentType, charset, typeInfo, value, $completion) {
    return this.fkn(contentType, charset, typeInfo, value, $completion);
  }
  *g4k(charset, typeInfo, content, $completion) {
    var contentPacket = yield* readRemaining(content, $completion);
    var _iterator__ex2g4s = this.ekn_1.l1();
    $l$loop: while (_iterator__ex2g4s.m1()) {
      var ext = _iterator__ex2g4s.n1();
      var tmp0_elvis_lhs = yield* ext.g4k(charset, typeInfo, ByteReadChannel(contentPacket), $completion);
      var tmp;
    ...
    var serializer = serializerForTypeInfo(this.dkn_1.pz(), typeInfo);
    try {
      var tmp1_subject = this.dkn_1;
      var tmp_0;
      if (isInterface(tmp1_subject, StringFormat)) {
        tmp_0 = this.dkn_1.q10(serializer, readText(contentPacket, charset));
      } else {
        if (isInterface(tmp1_subject, BinaryFormat)) {
          tmp_0 = this.dkn_1.s10(serializer, readByteArray(contentPacket));
        } else {
          discard(contentPacket);
          // Inline function 'kotlin.error' call
          var message = 'Unsupported format ' + toString(this.dkn_1);
      ...
      if ($p instanceof Error) {
        var cause = $p;
        throw JsonConvertException.z4j('Illegal input: ' + cause.message, cause);
      } else {
        throw $p;
      }
    }
...
function extensions(format) {
  ...
  while (_iterator__ex2g4s.m1()) {
    ...
    var tmp0_safe_receiver = element.wkm(format);
...
function serialization(_this__u8e3s4, contentType, format) {
  _this__u8e3s4.e4k(contentType, new KotlinxSerializationConverter(format));
}
function KotlinxSerializationConverter$serialize$o$collect$slambda($$this$unsafeFlow, $contentType, $charset, $typeInfo, $value) {
  return constructCallableReference(function *(value, $completion) {
    ...
    var tmp$ret$1 = yield* value.vkm($contentType, $charset, $typeInfo, $value, $completion);
    yield* $this$transform.h2n(tmp$ret$1, $completion);
    return Unit_instance;
  }, 1);
}
function serializeContent($this, serializer, format, value, contentType, charset) {
  ...
  if (isInterface(format, StringFormat)) {
    var content = format.p10(isInterface(serializer, KSerializer) ? serializer : THROW_CCE(), value);
    tmp = new TextContent(content, withCharsetIfNeeded(contentType, charset));
  } else {
    if (isInterface(format, BinaryFormat)) {
      var content_0 = format.r10(isInterface(serializer, KSerializer) ? serializer : THROW_CCE(), value);
...
function serializerForTypeInfo(_this__u8e3s4, typeInfo) {
  ...
  var tmp0_safe_receiver = typeInfo.c3w_1;
  var tmp;
  if (tmp0_safe_receiver == null) {
    tmp = null;
  } else {
  ...
  if (tmp1_elvis_lhs == null) {
    var tmp2_safe_receiver = module_0.v11(typeInfo.b3w_1);
    tmp_1 = tmp2_safe_receiver == null ? null : maybeNullable(tmp2_safe_receiver, typeInfo);
  } else {
    tmp_1 = tmp1_elvis_lhs;
  }
  var tmp3_elvis_lhs = tmp_1;
  return tmp3_elvis_lhs == null ? maybeNullable(serializer(typeInfo.b3w_1), typeInfo) : tmp3_elvis_lhs;
}
      ...
      if (isArray(value)) {
        ...
        if (isInterface(value, KtSet)) {
          ...
          if (isInterface(value, KtMap)) {
            ...
            var tmp3_elvis_lhs = module_0.v11(getKClassFromExpression(value));
...
function checkTypeParameters(type, typeInfo, module_0) {
  ...
  while (_iterator__ex2g4s.m1()) {
    ...
    var tmp;
    try {
      var tmp0_safe_receiver = element.ss_1;
      var tmp_0;
      if (tmp0_safe_receiver == null) {
        tmp_0 = null;
      } else {
  ...
  var tmp_3;
  if (nonSerializableArgs.l2() === 1) {
    tmp_3 = to('', 'is');
  } else {
    tmp_3 = to('s', 'are');
  }
  var _destruct__k2r9zo = tmp_3;
  var s = _destruct__k2r9zo.nm();
  var be = _destruct__k2r9zo.om();
  throw SerializationException.f11('Serializer for type argument' + s + ' ' + argNames + ' ' + be + " not found for '" + typeInfo.b3w_1.f1() + "'. " + ('Ensure that the listed type' + s + ' ' + be + " marked as '@Serializable'."));
}
