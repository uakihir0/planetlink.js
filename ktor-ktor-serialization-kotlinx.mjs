...
class sam$kotlinx_coroutines_flow_FlowCollector$0 {
  constructor(function_0) {
    this.dks_1 = function_0;
  }
  *n2n(value, $completion) {
    return yield* this.dks_1(value, $completion);
  }
  c5() {
    return this.dks_1;
  }
...
class KotlinxSerializationConverter$serialize$$inlined$map$1 {
  constructor($this, $contentType, $charset, $typeInfo, $value) {
    this.eks_1 = $this;
    this.fks_1 = $contentType;
    this.gks_1 = $charset;
    this.hks_1 = $typeInfo;
    this.iks_1 = $value;
  }
  *m2n(collector, $completion) {
    var tmp = KotlinxSerializationConverter$serialize$o$collect$slambda(collector, this.fks_1, this.gks_1, this.hks_1, this.iks_1);
    yield* this.eks_1.k2n(new sam$kotlinx_coroutines_flow_FlowCollector$0(tmp), $completion);
...
class KotlinxSerializationConverter {
  constructor(format) {
    this.jks_1 = format;
    this.kks_1 = extensions(this.jks_1);
    var tmp;
    var tmp_0 = this.jks_1;
    if (isInterface(tmp_0, BinaryFormat)) {
      tmp = true;
    } else {
      var tmp_1 = this.jks_1;
      tmp = isInterface(tmp_1, StringFormat);
    }
    // Inline function 'kotlin.require' call
    if (!tmp) {
      var message = 'Only binary and string formats are supported, ' + toString(this.jks_1) + ' is not supported.';
      throw IllegalArgumentException.a2(toString(message));
    }
  }
  *lks(contentType, charset, typeInfo, value, $completion) {
    // Inline function 'kotlinx.coroutines.flow.map' call
    // Inline function 'kotlinx.coroutines.flow.unsafeTransform' call
    var this_0 = asFlow(this.kks_1);
    ...
    var tmp_0;
    try {
      tmp_0 = serializerForTypeInfo(this.jks_1.rz(), typeInfo);
    } catch ($p) {
      var tmp_1;
      if ($p instanceof SerializationException) {
        var cause = $p;
        tmp_1 = guessSerializer(value, this.jks_1.rz());
      } else {
        throw $p;
      }
      tmp_0 = tmp_1;
    ...
    return serializeContent(this, serializer, this.jks_1, value, contentType, charset);
  }
  bks(contentType, charset, typeInfo, value, $completion) {
    return this.lks(contentType, charset, typeInfo, value, $completion);
  }
  *m4k(charset, typeInfo, content, $completion) {
    var contentPacket = yield* readRemaining(content, $completion);
    var _iterator__ex2g4s = this.kks_1.l1();
    ...
    var serializer = serializerForTypeInfo(this.jks_1.rz(), typeInfo);
    try {
      var tmp1_subject = this.jks_1;
      var tmp_0;
      if (isInterface(tmp1_subject, StringFormat)) {
        tmp_0 = this.jks_1.s10(serializer, readText(contentPacket, charset));
      } else {
        if (isInterface(tmp1_subject, BinaryFormat)) {
          tmp_0 = this.jks_1.u10(serializer, readByteArray(contentPacket));
        } else {
          discard(contentPacket);
          // Inline function 'kotlin.error' call
          var message = 'Unsupported format ' + toString(this.jks_1);
...
function extensions(format) {
  ...
  while (_iterator__ex2g4s.m1()) {
    ...
    var tmp0_safe_receiver = element.cks(format);
...
function KotlinxSerializationConverter$serialize$o$collect$slambda($$this$unsafeFlow, $contentType, $charset, $typeInfo, $value) {
  return constructCallableReference(function *(value, $completion) {
    ...
    var tmp$ret$1 = yield* value.bks($contentType, $charset, $typeInfo, $value, $completion);
