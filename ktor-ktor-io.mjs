...
class Companion {
  constructor() {
    ...
    this.f3l_1 = new Closed(null);
    var tmp = this;
    // Inline function 'kotlin.Companion.success' call
    tmp.g3l_1 = _Result___init__impl__xyqfz8(Unit_instance);
  }
}
class Empty {
  toString() {
...
class Closed {
  ...
  toString() {
    return 'Closed(cause=' + toString(this.h3l_1) + ')';
  }
  hashCode() {
    return this.h3l_1 == null ? 0 : hashCode(this.h3l_1);
  }
  equals(other) {
    if (this === other)
      return true;
    if (!(other instanceof Closed))
      return false;
    if (!equals(this.h3l_1, other.h3l_1))
      return false;
    return true;
  }
}
class Task {}
function resume() {
  return this.j3l().pd(Companion_getInstance().g3l_1);
}
function resume_0(throwable) {
  ...
  return tmp.pd(tmp1_elvis_lhs == null ? Companion_getInstance().g3l_1 : tmp1_elvis_lhs.lw_1);
}
class Read {
  constructor(continuation) {
    this.n3l_1 = continuation;
    this.o3l_1 = null;
    if (get_DEVELOPMENT_MODE()) {
      var tmp = this;
      // Inline function 'kotlin.also' call
      var this_0 = newThrowable('ReadTask 0x' + toString_0(hashCode(this.n3l_1), 16));
...
class Write {
  constructor(continuation) {
    this.p3l_1 = continuation;
    this.q3l_1 = null;
    if (get_DEVELOPMENT_MODE()) {
      var tmp = this;
      // Inline function 'kotlin.also' call
      var this_0 = newThrowable('WriteTask 0x' + toString_0(hashCode(this.p3l_1), 16));
      stackTraceToString(this_0);
      tmp.q3l_1 = this_0;
    }
  }
...
function awaitContent$default(min, $completion, $super) {
  min = min === VOID ? 1 : min;
  return $super === VOID ? this.w3m(min, $completion) : $super.w3m.call(this, min, $completion);
}
...
class ByteChannel {
  constructor(autoFlush) {
    ...
    this.r3l_1 = autoFlush;
    this.s3l_1 = new Buffer();
    this.t3l_1 = 0;
    this.u3l_1 = new Object();
    this.v3l_1 = atomic$ref$1(Empty_instance);
    this.w3l_1 = new Buffer();
  ...
  c3m() {
    return this.t3l_1 < 1048576;
  }
  d3m() {
    var tmp0_safe_receiver = this.y3l_1.kotlinx$atomicfu$value;
    if (tmp0_safe_receiver == null)
      ...
      if (tmp0_subject == null) {
        ...
        if (isInterface(tmp0_subject, CopyableThrowable)) {
          tmp = access$_get_origin__hdh1qz(tmp0_safe_receiver).m2d();
        } else {
          if (tmp0_subject instanceof CancellationException) {
            ...
            tmp = ClosedReadChannelException.i3m(p0);
          }
        }
      }
    ...
    if (this.p3m()) {
      ...
      if (tmp0_safe_receiver == null) {
        ...
        if (tmp0_subject == null) {
          ...
          if (isInterface(tmp0_subject, CopyableThrowable)) {
            tmp_0 = access$_get_origin__hdh1qz(tmp0_safe_receiver).m2d();
          } else {
            if (tmp0_subject instanceof CancellationException) {
              ...
              var p0 = access$_get_origin__hdh1qz(tmp0_safe_receiver);
              tmp_0 = ClosedWriteChannelException.o3m(p0);
            }
          }
        }
      ...
      if (tmp == null)
        throw ClosedWriteChannelException.o3m();
    }
    return this.x3l_1;
  }
  q3m() {
      ...
      if (tmp0_subject == null) {
        ...
        if (isInterface(tmp0_subject, CopyableThrowable)) {
          ...
          if (tmp0_subject instanceof CancellationException) {
            ...
            var p0 = access$_get_origin__hdh1qz(tmp0_safe_receiver);
            tmp_0 = ClosedByteChannelException.u3m(p0);
          }
        }
      }
      tmp = tmp_0;
  ...
  p3m() {
    return !(this.y3l_1.kotlinx$atomicfu$value == null);
  }
  v3m() {
    return !(this.q3m() == null) || (this.p3m() && this.t3l_1 === 0 && this.w3l_1.x21());
  }
  *w3m(min, $completion) {
    rethrowCloseCauseIfNeeded_0(this);
    if (this.w3l_1.l2() >= fromInt(min))
      return true;
    // Inline function 'io.ktor.utils.io.ByteChannel.sleepWhile' call
    var this_0 = this;
    $l$loop: while (add(numberToLong(this.t3l_1), this.w3l_1.l2()) < fromInt(min) && this.y3l_1.kotlinx$atomicfu$value == null) {
      ...
      (yield () => {
        ...
        $l$block_0: {
          ...
          var previous = tmp0.v3l_1.kotlinx$atomicfu$value;
          if (!(previous instanceof Closed)) {
            if (!tmp0.v3l_1.atomicfu$compareAndSet(previous, tmp2)) {
              tmp2.l3l();
              break $l$block_0;
            }
          }
          if (previous instanceof Read) {
            previous.m3l(ConcurrentIOException.b3n(tmp2.k3l(), previous.i3l()));
          } else {
            if (isInterface(previous, Task)) {
              previous.l3l();
            } else {
              if (previous instanceof Closed) {
                tmp2.m3l(previous.h3l_1);
                break $l$block_0;
              } else {
          ...
          if (!(add(numberToLong(this.t3l_1), this.w3l_1.l2()) < fromInt(min) && this.y3l_1.kotlinx$atomicfu$value == null)) {
            // Inline function 'io.ktor.utils.io.ByteChannel.resumeSlot' call
            var current = tmp0.v3l_1.kotlinx$atomicfu$value;
            var tmp;
            if (current instanceof Read) {
              tmp = tmp0.v3l_1.atomicfu$compareAndSet(current, Empty_instance);
            } else {
              tmp = false;
            }
            if (tmp) {
    ...
    if (this.w3l_1.l2() < 1048576n) {
      moveFlushToReadBuffer(this);
    }
    return this.w3l_1.l2() >= fromInt(min);
  }
  *d3n($completion) {
    rethrowCloseCauseIfNeeded_0(this);
    this.e3n();
    ...
    // Inline function 'io.ktor.utils.io.ByteChannel.sleepWhile' call
    var this_0 = this;
    $l$loop: while (!this.c3m() && this.y3l_1.kotlinx$atomicfu$value == null) {
      // Inline function 'kotlinx.coroutines.suspendCancellableCoroutine' call
      // Inline function 'kotlin.js.suspendCoroutineUninterceptedOrReturnJS' call
      (yield () => {
        var uCont = $completion;
        ...
        $l$block_0: {
          ...
          if (!(!this.c3m() && this.y3l_1.kotlinx$atomicfu$value == null)) {
            // Inline function 'io.ktor.utils.io.ByteChannel.resumeSlot' call
            var current = tmp0.v3l_1.kotlinx$atomicfu$value;
            var tmp;
  ...
  e3n() {
    ...
    this.u3l_1;
    var count = convertToInt(this.x3l_1.l2());
    this.s3l_1.p23(this.x3l_1);
    this.t3l_1 = this.t3l_1 + count | 0;
    // Inline function 'io.ktor.utils.io.ByteChannel.resumeSlot' call
    var current = this.v3l_1.kotlinx$atomicfu$value;
    var tmp;
    if (current instanceof Read) {
      tmp = this.v3l_1.atomicfu$compareAndSet(current, Empty_instance);
    } else {
      tmp = false;
    }
    if (tmp) {
  ...
  f7() {
    this.e3n();
    if (!this.y3l_1.atomicfu$compareAndSet(null, get_CLOSED()))
      return Unit_instance;
    closeSlot(this, null);
  }
  *f3n($completion) {
  ...
  g3n(cause) {
    if (!(this.y3l_1.kotlinx$atomicfu$value == null))
      return Unit_instance;
    var closedToken = new CloseToken(cause);
    this.y3l_1.atomicfu$compareAndSet(null, closedToken);
    // Inline function 'io.ktor.utils.io.Companion.wrapCause' call
    ...
    if (tmp0_subject == null) {
      ...
      if (isInterface(tmp0_subject, CopyableThrowable)) {
        tmp = access$_get_origin__hdh1qz(closedToken).m2d();
      } else {
        if (tmp0_subject instanceof CancellationException) {
          ...
          tmp = ClosedByteChannelException.u3m(p0);
        }
      }
    }
  ...
  h3n(handler) {
    var existingCause = this.y3l_1.kotlinx$atomicfu$value;
    if (!(existingCause == null)) {
      ...
      if (tmp0_subject == null) {
        ...
        if (isInterface(tmp0_subject, CopyableThrowable)) {
          tmp = access$_get_origin__hdh1qz(existingCause).m2d();
        } else {
          if (tmp0_subject instanceof CancellationException) {
    ...
    if (!this.z3l_1.atomicfu$compareAndSet(null, handler)) {
    ...
    var cause = this.y3l_1.kotlinx$atomicfu$value;
    if (!(cause == null) && this.z3l_1.atomicfu$compareAndSet(handler, null)) {
      // Inline function 'io.ktor.utils.io.Companion.wrapCause' call
      ...
      if (tmp0_subject_0 == null) {
        ...
        if (isInterface(tmp0_subject_0, CopyableThrowable)) {
          tmp_1 = access$_get_origin__hdh1qz(cause).m2d();
        } else {
          if (tmp0_subject_0 instanceof CancellationException) {
            ...
            tmp_1 = ClosedByteChannelException.u3m(p0_0);
          }
        }
      }
      handler(tmp_1);
...
class ConcurrentIOException extends IllegalStateException {
  constructor(taskName, cause) {
    return new.target.b3n(taskName, cause);
  }
  static b3n(taskName, cause) {
    cause = cause === VOID ? null : cause;
    var $this = this.q('Concurrent ' + taskName + ' attempts', cause);
    captureStack($this, $this.a3n_1);
    return $this;
  }
}
class ByteChannelScanner {
  constructor(channel, matchString, writeChannel, limit) {
    ...
    this.i3n_1 = channel;
    this.j3n_1 = matchString;
    this.k3n_1 = writeChannel;
    this.l3n_1 = limit;
    ...
    this.m3n_1 = this.i3n_1.d3m();
    this.n3n_1 = buildPartialMatchTable(this);
    this.o3n_1 = new Buffer();
    this.p3n_1 = 0n;
    this.q3n_1 = 0;
  }
  *r3n(ignoreMissing, $completion) {
    this.p3n_1 = 0n;
    while (!this.m3n_1.x21() || (yield* this.i3n_1.c3n(VOID, $completion))) {
    ...
    if (!ignoreMissing) {
      throw IOException.a25('Expected "' + toSingleLineString(this, this.j3n_1) + '" but encountered end of input');
    }
    this.p3n_1 = add(this.p3n_1, this.o3n_1.a23(this.k3n_1.j3m()));
    yield* this.k3n_1.d3n($completion);
    return this.p3n_1;
  }
}
...
class Companion_0 {
  constructor() {
    ...
    var tmp = this;
    tmp.w3n_1 = new ByteReadChannel$Companion$Empty$1();
  }
}
class WriterJob {
...
class NO_CALLBACK$1 {
  constructor() {
    this.e3o_1 = EmptyCoroutineContext_instance;
  }
  nd() {
    return this.e3o_1;
  }
...
class CountedByteReadChannel {
  ...
  q3m() {
    return this.g3o_1.q3m();
  }
  v3m() {
    return this.h3o_1.x21() && this.g3o_1.v3m();
  }
  d3m() {
  ...
  *w3m(min, $completion) {
    if (this.d3m().l2() >= fromInt(min)) {
      return true;
    }
    if (yield* this.g3o_1.w3m(min, $completion)) {
      transferFromDelegate(this);
      return true;
    }
    return false;
  ...
  g3n(cause) {
    this.g3o_1.g3n(cause);
    this.h3o_1.f7();
  }
}
class ClosedByteChannelException extends IOException {
  constructor(cause) {
    return new.target.u3m(cause);
  }
  static u3m(cause) {
    cause = cause === VOID ? null : cause;
    var $this = this.b25(cause == null ? null : cause.message, cause);
    captureStack($this, $this.t3m_1);
    return $this;
  }
}
...
class Companion_2 {
  constructor() {
    ...
    this.l3o_1 = _LineEndingMode___init__impl__jo5bul(1);
    this.m3o_1 = _LineEndingMode___init__impl__jo5bul(2);
    this.n3o_1 = _LineEndingMode___init__impl__jo5bul(4);
    this.o3o_1 = _LineEndingMode___init__impl__jo5bul(7);
    this.p3o_1 = listOf([new LineEndingMode(this.l3o_1), new LineEndingMode(this.m3o_1), new LineEndingMode(this.n3o_1)]);
  }
}
class LineEndingMode {
  ...
  toString() {
    return LineEndingMode__toString_impl_j4h76r(this.q3o_1);
  }
  hashCode() {
    return LineEndingMode__hashCode_impl_2mopm4(this.q3o_1);
  }
  equals(other) {
    return LineEndingMode__equals_impl_qyr4nk(this.q3o_1, other);
  }
}
class SourceByteReadChannel {
  ...
  q3m() {
    var tmp0_safe_receiver = this.s3o_1;
    var tmp;
    if (tmp0_safe_receiver == null) {
      tmp = null;
    } else {
  ...
  v3m() {
    return this.r3o_1.x21();
  }
  d3m() {
    var tmp0_safe_receiver = this.q3m();
    if (tmp0_safe_receiver == null)
      null;
    else {
      // Inline function 'kotlin.let' call
  ...
  *w3m(min, $completion) {
    ...
    return this.r3o_1.z21(fromInt(min));
  }
  g3n(cause) {
    if (!(this.s3o_1 == null))
      return Unit_instance;
    ...
    tmp.s3o_1 = new CloseToken(IOException.b25(tmp1_elvis_lhs == null ? 'Channel was cancelled' : tmp1_elvis_lhs, cause));
  }
}
class MalformedInputException extends IOException {
  constructor(message) {
    return new.target.w3o(message);
  }
  static w3o(message) {
    var $this = this.a25(message);
    captureStack($this, $this.v3o_1);
    return $this;
  }
}
class TooLongLineException extends MalformedInputException {
  constructor(message) {
    return new.target.b3o(message);
  }
  static b3o(message) {
    var $this = this.w3o(message);
    captureStack($this, $this.a3o_1);
    return $this;
  }
}
class ObjectPool {}
...
class Companion_3 {
  o3p(name) {
    switch (name) {
      ...
      case 'UTF8':
      case 'utf8':
        return Charsets_getInstance().x3o_1;
    }
    var tmp;
    var tmp_0;
    switch (name) {
...
class Charset {
  ...
  equals(other) {
    ...
    if (!(other instanceof Charset))
      THROW_CCE();
    return this.z3o_1 === other.z3o_1;
  }
  hashCode() {
    return getStringHashCode(this.z3o_1);
  }
  toString() {
    return this.z3o_1;
  }
...
class Charsets {
  constructor() {
    ...
    this.x3o_1 = new CharsetImpl('UTF-8');
    this.y3o_1 = new CharsetImpl('ISO-8859-1');
  }
}
...
class CharsetEncoderImpl extends CharsetEncoder {
  ...
  toString() {
    return 'CharsetEncoderImpl(charset=' + this.u3p_1.toString() + ')';
  }
  hashCode() {
    return this.u3p_1.hashCode();
  }
  equals(other) {
    if (this === other)
      return true;
...
class CharsetDecoderImpl extends CharsetDecoder {
  ...
  toString() {
    return 'CharsetDecoderImpl(charset=' + this.w3p_1.toString() + ')';
  }
  hashCode() {
...
class toKtor$1 {
  constructor($this_toKtor) {
    this.x3p_1 = $this_toKtor;
  }
  r3p(buffer) {
    return this.x3p_1.decode(buffer);
  }
}
  ...
  r3p(buffer) {
    ...
    if (inductionVariable < last)
      $l$loop: do {
        ...
        if (point > 255) {
          builder.q23(toByte(point >> 8));
        }
        builder.q23(toByte(point & 255));
      }
       while (inductionVariable < last);
...
function closeSlot($this, cause) {
  var closeContinuation = !(cause == null) ? new Closed(cause) : Companion_getInstance().f3l_1;
  var continuation = $this.v3l_1.atomicfu$getAndSet(closeContinuation);
  if (isInterface(continuation, Task)) {
    continuation.m3l(cause);
  }
  var tmp0_safe_receiver = $this.z3l_1.atomicfu$getAndSet(null);
  if (tmp0_safe_receiver == null)
    null;
  else
...
function ByteChannel$invokeOnClose$lambda_1(this$0, $handler) {
  return () => {
    this$0.z3l_1.atomicfu$compareAndSet($handler, null);
    return Unit_instance;
  };
}
function ByteReadChannel_0(content, offset, length) {
  ...
  this_0.g23(content, offset, offset + length | 0);
  var source = this_0;
...
function buildPartialMatchTable($this) {
  var table = new Int32Array($this.j3n_1.l2());
  var j = 0;
  var inductionVariable = 1;
  var last = $this.j3n_1.l2();
  if (inductionVariable < last)
    do {
      var i = inductionVariable;
      inductionVariable = inductionVariable + 1 | 0;
      while (j > 0 && !($this.j3n_1.n2(i) === $this.j3n_1.n2(j))) {
        j = table[j - 1 | 0];
      }
      if ($this.j3n_1.n2(i) === $this.j3n_1.n2(j)) {
        j = j + 1 | 0;
      }
      table[i] = j;
    }
...
function *advanceToNextPotentialMatch($this, $completion) {
  while (!$this.m3n_1.x21() || (yield* $this.i3n_1.c3n(VOID, $completion))) {
    var nextMatch = indexOf($this.m3n_1, $this.j3n_1.n2(0));
    if (nextMatch === -1n) {
      var tmp = $this.m3n_1;
      checkBounds($this, (tmp instanceof Buffer ? tmp : THROW_CCE()).l2());
      $this.p3n_1 = add($this.p3n_1, $this.m3n_1.a23($this.k3n_1.j3m()));
      yield* flushIfNeeded($this.k3n_1, $completion);
    } else {
      checkBounds($this, nextMatch);
      var tmp_0 = $this;
      var tmp_1 = $this.p3n_1;
      var tmp_2 = $this.k3n_1.j3m();
      tmp_0.p3n_1 = add(tmp_1, $this.m3n_1.x22(tmp_2 instanceof Buffer ? tmp_2 : THROW_CCE(), nextMatch));
      yield* flushIfNeeded($this.k3n_1, $completion);
      return Unit_instance;
    }
  }
...
function *checkFullMatch($this, $completion) {
  while (!$this.m3n_1.x21() || (yield* $this.i3n_1.c3n(VOID, $completion))) {
    var byte = $this.m3n_1.a22();
    if ($this.q3n_1 > 0 && !(byte === $this.j3n_1.n2($this.q3n_1))) {
      var oldMatchIndex = $this.q3n_1;
      while ($this.q3n_1 > 0 && !(byte === $this.j3n_1.n2($this.q3n_1))) {
        $this.q3n_1 = $this.n3n_1[$this.q3n_1 - 1 | 0];
      }
      var retained = fromInt(oldMatchIndex - $this.q3n_1 | 0);
      checkBounds($this, retained);
      var tmp = $this;
      var tmp_0 = $this.p3n_1;
      var tmp_1 = $this.k3n_1.j3m();
      tmp.p3n_1 = add(tmp_0, $this.o3n_1.x22(tmp_1 instanceof Buffer ? tmp_1 : THROW_CCE(), retained));
      if ($this.q3n_1 === 0 && !(byte === $this.j3n_1.n2($this.q3n_1))) {
        yield* writeByte($this.k3n_1, byte, $completion);
        var _unary__edvuaz = $this.p3n_1;
        $this.p3n_1 = add(_unary__edvuaz, get_ONE());
        return false;
      }
    }
    $this.q3n_1 = $this.q3n_1 + 1 | 0;
    if ($this.q3n_1 === $this.j3n_1.l2()) {
      return true;
    }
    $this.o3n_1.q23(byte);
  }
...
function checkBounds($this, extra) {
  if (add($this.p3n_1, extra) > $this.l3n_1) {
    throw IOException.a25('Limit of ' + $this.l3n_1.toString() + ' bytes exceeded ' + ('while searching for "' + toSingleLineString($this, $this.j3n_1) + '"'));
  }
}
...
function attachWriterJob(_this__u8e3s4, writerJob) {
  var tmp = writerJob.s3n_1;
  var tmp0_safe_receiver = tmp instanceof ByteChannel ? tmp : null;
  if (tmp0_safe_receiver == null)
    null;
  else {
    tmp0_safe_receiver.h3n(attachWriterJob$lambda(_this__u8e3s4));
  }
}
function attachWriterJob$lambda($this_attachWriterJob) {
  return (cause) => {
    var tmp;
    if (!(cause == null)) {
      $this_attachWriterJob.g3n(cause);
      tmp = Unit_instance;
    }
    return Unit_instance;
  };
...
function cancel_0(_this__u8e3s4) {
  _this__u8e3s4.g3n(IOException.a25('Channel was cancelled'));
}
function *readRemaining(_this__u8e3s4, $completion) {
  var result = BytePacketBuilder();
  while (!_this__u8e3s4.v3m()) {
    result.p23(_this__u8e3s4.d3m());
    yield* _this__u8e3s4.c3n(VOID, $completion);
  }
...
function *copyTo(_this__u8e3s4, channel, limit, $completion) {
  var remaining = limit;
  try {
    while (!_this__u8e3s4.v3m() && remaining > 0n) {
      if (_this__u8e3s4.d3m().x21()) {
        yield* _this__u8e3s4.c3n(VOID, $completion);
      }
      var tmp0 = remaining;
      // Inline function 'kotlin.comparisons.minOf' call
      var b = get_remaining(_this__u8e3s4.d3m());
      var count = tmp0 <= b ? tmp0 : b;
      _this__u8e3s4.d3m().z22(channel.j3m(), count);
      remaining = subtract(remaining, count);
      yield* channel.d3n($completion);
    }
  } catch ($p) {
    if ($p instanceof Error) {
      var cause = $p;
      _this__u8e3s4.g3n(cause);
...
function rethrowCloseCauseIfNeeded(_this__u8e3s4) {
  var tmp0_safe_receiver = _this__u8e3s4.q3m();
  if (tmp0_safe_receiver == null)
    null;
  else {
    // Inline function 'kotlin.let' call
...
function *discard(_this__u8e3s4, max, $completion) {
  ...
  var remaining = max;
  while (remaining > 0n && !_this__u8e3s4.v3m()) {
    ...
    var b = get_remaining(_this__u8e3s4.d3m());
    var count = tmp0 <= b ? tmp0 : b;
    discard_0(_this__u8e3s4.d3m(), count);
    remaining = subtract(remaining, count);
  }
...
function *copyTo_0(_this__u8e3s4, channel, $completion) {
  ...
  try {
    while (!_this__u8e3s4.v3m()) {
      result = add(result, _this__u8e3s4.d3m().a23(channel.j3m()));
      yield* channel.d3n($completion);
      yield* _this__u8e3s4.c3n(VOID, $completion);
    }
  } catch ($p) {
...
function *readAvailable(_this__u8e3s4, buffer, offset, length, $completion) {
  ...
  if (_this__u8e3s4.v3m())
    return -1;
  return readAvailable_0(_this__u8e3s4.d3m(), buffer, offset, length);
}
...
function *readPacket(_this__u8e3s4, packet, $completion) {
  ...
  $l$loop: while (result.l2() < fromInt(packet)) {
    ...
    if (_this__u8e3s4.v3m())
      break $l$loop;
    if (get_remaining(_this__u8e3s4.d3m()) > subtract(numberToLong(packet), result.l2())) {
      _this__u8e3s4.d3m().z22(result, subtract(numberToLong(packet), result.l2()));
    } else {
      _this__u8e3s4.d3m().a23(result);
    }
  }
  if (result.l2() < fromInt(packet)) {
    throw EOFException.v21('Not enough data available, required ' + packet + ' bytes but only ' + result.l2().toString() + ' available');
  }
  return result;
}
function *readUntil(_this__u8e3s4, matchString, writeChannel, limit, ignoreMissing, $completion) {
  ...
  return yield* (new ByteChannelScanner(_this__u8e3s4, matchString, writeChannel, limit)).r3n(ignoreMissing, $completion);
}
...
function get_availableForRead(_this__u8e3s4) {
  return convertToInt(_this__u8e3s4.d3m().w21().l2());
}
function *peek(_this__u8e3s4, count, $completion) {
  if (_this__u8e3s4.v3m())
    return null;
  if (!(yield* _this__u8e3s4.w3m(count, $completion)))
    return null;
  return readByteString(_this__u8e3s4.d3m().b23(), count);
}
function *internalReadLineTo(_this__u8e3s4, out, limit, lenientLineEnding, throwOnIncompleteLine, $completion) {
  var readBuffer = _this__u8e3s4.d3m();
  if (readBuffer.x21()) {
    yield* _this__u8e3s4.c3n(VOID, $completion);
  }
  if (_this__u8e3s4.v3m())
    return -1n;
  var consumed = {_v: 0n};
  $l$loop: while (consumed._v < limit && !_this__u8e3s4.v3m()) {
    ...
    if (lfIndex > 0n) {
      var tmp;
      var tmp_0 = readBuffer.w21();
      // Inline function 'kotlin.Long.minus' call
      var tmp$ret$0 = subtract(lfIndex, fromInt(1));
      if (tmp_0.s22(tmp$ret$0) === 13) {
        tmp = 1n;
      } else {
        tmp = 0n;
      }
    ...
    var tmp_1 = readBuffer.w21();
    // Inline function 'kotlin.Long.minus' call
    var tmp$ret$2 = subtract(count, fromInt(1));
    if (tmp_1.s22(tmp$ret$2) === 13) {
      // Inline function 'kotlin.Long.minus' call
    ...
    if (consumed._v < limit && get_remaining(readBuffer) === 0n && !(yield* _this__u8e3s4.c3n(VOID, $completion)))
      break $l$loop;
  }
  if (consumed._v === 0n && _this__u8e3s4.v3m())
    return -1n;
  // Inline function 'kotlin.check' call
  ...
  if (consumed._v === limit) {
    if (limit === 9223372036854775807n)
      throw TooLongLineException.b3o('Max line length exceeded');
    if (get_remaining(readBuffer) === 0n && !(yield* _this__u8e3s4.c3n(VOID, $completion))) {
      throwEndOfStreamException(consumed._v);
    }
    var tmp0_subject = readBuffer.w21().s22(0n);
    if (tmp0_subject === 10) {
      discard_0(readBuffer, 1n);
      return consumed._v;
...
function throwEndOfStreamException(consumed) {
  throw EOFException.v21('Unexpected end of stream after reading ' + consumed.toString() + ' characters');
}
function throwTooLongLineException(limit) {
  throw TooLongLineException.b3o('Line exceeds limit of ' + limit.toString() + ' characters');
}
...
function *internalReadLineTo$discardCrlfOrCr(_this__u8e3s4, $this_internalReadLineTo, $lenientLineEnding, $completion) {
  if ((get_remaining(_this__u8e3s4) >= 2n || (yield* $this_internalReadLineTo.w3m(2, $completion))) && _this__u8e3s4.w21().s22(1n) === 10) {
...
function *flushIfNeeded(_this__u8e3s4, $completion) {
  ...
  if (_this__u8e3s4.b3m() || get_size(_this__u8e3s4.j3m()) >= 1048576)
    yield* _this__u8e3s4.d3n($completion);
  return Unit_instance;
}
function ByteWriteChannel$flushAndClose$ref(p0) {
  return constructCallableReference(function *($completion) {
    return yield* p0.f3n($completion);
...
function invokeOnCompletion(_this__u8e3s4, block) {
  _init_properties_ByteWriteChannelOperations_kt__i7slrs();
  return _this__u8e3s4.s28().t26(block);
}
function *writeFully(_this__u8e3s4, value, startIndex, endIndex, $completion) {
  startIndex = startIndex === VOID ? 0 : startIndex;
  endIndex = endIndex === VOID ? value.length : endIndex;
  _this__u8e3s4.j3m().g23(value, startIndex, endIndex);
...
function *writePacket(_this__u8e3s4, source, $completion) {
  while (!source.x21()) {
    _this__u8e3s4.j3m().k23(source, get_remaining(source));
    yield* flushIfNeeded(_this__u8e3s4, $completion);
  }
  return Unit_instance;
}
function writer_0(_this__u8e3s4, coroutineContext, channel, block) {
  ...
  this_0.t26(writer$lambda(channel));
  var job = this_0;
...
function *writeByte(_this__u8e3s4, value, $completion) {
  _this__u8e3s4.j3m().q23(value);
  yield* flushIfNeeded(_this__u8e3s4, $completion);
  return Unit_instance;
}
function writer$slambda($block, $channel) {
  return constructCallableReference(function *($this$launch, $completion) {
    var nested = Job(get_job($this$launch.q25()));
    var tmp;
    try {
      yield* $block(new WriterScope($channel, $this$launch.q25().mp(nested)), $completion);
      nested.a2d();
      var tmp_0;
      if (get_job($this$launch.q25()).n26()) {
        $channel.g3n(get_job($this$launch.q25()).q26());
        tmp_0 = Unit_instance;
      }
      tmp = tmp_0;
    } catch ($p) {
      ...
      yield* nested.x26($completion);
      // Inline function 'kotlin.runCatching' call
      var tmp_2;
      try {
        yield* $channel.f3n($completion);
        // Inline function 'kotlin.Companion.success' call
...
function transferFromDelegate($this) {
  updateConsumed($this);
  var appended = $this.h3o_1.p23($this.g3o_1.d3m());
  $this.i3o_1 = add($this.i3o_1, appended);
}
function updateConsumed($this) {
  $this.j3o_1 = add($this.j3o_1, subtract($this.i3o_1, $this.h3o_1.l2()));
  $this.i3o_1 = $this.h3o_1.l2();
}
...
function LineEndingMode__toString_impl_j4h76r($this) {
  var tmp;
  if ($this === Companion_getInstance_2().l3o_1) {
    tmp = 'CR';
  } else if ($this === Companion_getInstance_2().m3o_1) {
    tmp = 'LF';
  } else if ($this === Companion_getInstance_2().n3o_1) {
    tmp = 'CRLF';
  } else {
    // Inline function 'kotlin.collections.filter' call
    var tmp0 = Companion_getInstance_2().p3o_1;
    // Inline function 'kotlin.collections.filterTo' call
    var destination = ArrayList.j2();
    var _iterator__ex2g4s = tmp0.l1();
    while (_iterator__ex2g4s.m1()) {
      var element = _iterator__ex2g4s.n1();
      var it = element.q3o_1;
...
function writeFully_0(_this__u8e3s4, buffer, offset, length) {
  offset = offset === VOID ? 0 : offset;
  length = length === VOID ? buffer.length - offset | 0 : length;
  _this__u8e3s4.g23(buffer, offset, offset + length | 0);
}
function build(_this__u8e3s4) {
  return _this__u8e3s4.w21();
}
function get_size(_this__u8e3s4) {
  return convertToInt(_this__u8e3s4.w21().l2());
}
...
function ByteReadPacket(array, offset, length) {
  ...
  // Inline function 'kotlin.apply' call
  var this_0 = new Buffer();
  this_0.g23(array, offset, offset + length | 0);
  return this_0;
}
function get_remaining(_this__u8e3s4) {
  _init_properties_ByteReadPacket_kt__28475y();
  return _this__u8e3s4.w21().l2();
}
function discard_0(_this__u8e3s4, count) {
  count = count === VOID ? 9223372036854775807n : count;
  _init_properties_ByteReadPacket_kt__28475y();
  _this__u8e3s4.z21(count);
  // Inline function 'kotlin.comparisons.minOf' call
  var b = get_remaining(_this__u8e3s4);
  var countToDiscard = count <= b ? count : b;
  _this__u8e3s4.w21().u22(countToDiscard);
  return countToDiscard;
}
function takeWhile(_this__u8e3s4, block) {
  _init_properties_ByteReadPacket_kt__28475y();
  while (!_this__u8e3s4.x21() && block(_this__u8e3s4.w21())) {
  }
}
...
function readAvailable_0(_this__u8e3s4, buffer, offset, length) {
  offset = offset === VOID ? 0 : offset;
  length = length === VOID ? buffer.length - offset | 0 : length;
  var result = _this__u8e3s4.v22(buffer, offset, offset + length | 0);
  return result === -1 ? 0 : result;
}
function toByteArray_0(_this__u8e3s4, charset) {
  charset = charset === VOID ? Charsets_getInstance().x3o_1 : charset;
  if (charset.equals(Charsets_getInstance().x3o_1))
    return encodeToByteArray(_this__u8e3s4, VOID, VOID, true);
  return encodeToByteArray_0(charset.a3p(), _this__u8e3s4, 0, _this__u8e3s4.length);
}
function readText_0(_this__u8e3s4, charset, max) {
  ...
  if (charset.equals(Charsets_getInstance().x3o_1)) {
    if (max === 2147483647)
      return readString_0(_this__u8e3s4);
    var tmp0 = _this__u8e3s4.w21().l2();
    // Inline function 'kotlin.math.min' call
    var b = fromInt(max);
    var count = tmp0 <= b ? tmp0 : b;
    return readString(_this__u8e3s4, count);
  }
  return decode(charset.b3p(), _this__u8e3s4, max);
}
function writeText(_this__u8e3s4, text, fromIndex, toIndex, charset) {
  fromIndex = fromIndex === VOID ? 0 : fromIndex;
  toIndex = toIndex === VOID ? charSequenceLength(text) : toIndex;
  charset = charset === VOID ? Charsets_getInstance().x3o_1 : charset;
  if (charset === Charsets_getInstance().x3o_1) {
    return writeString(_this__u8e3s4, toString_1(text), fromIndex, toIndex);
  }
  encodeToImpl(charset.a3p(), _this__u8e3s4, text, fromIndex, toIndex);
}
...
function decode_0(_this__u8e3s4, input, dst, max) {
  ...
  try {
    ...
    // Inline function 'kotlin.js.asDynamic' call
    tmp = decoder.r3p(array);
  } catch ($p) {
    var tmp_0;
    if ($p instanceof Error) {
      var cause = $p;
      var tmp0_elvis_lhs = cause.message;
      throw MalformedInputException.w3o('Failed to decode bytes: ' + (tmp0_elvis_lhs == null ? 'no cause provided' : tmp0_elvis_lhs));
    } else {
      throw $p;
    }
  }
...
function encodeImpl(_this__u8e3s4, input, fromIndex, toIndex, dst) {
  ...
  if (get_charset_0(_this__u8e3s4).equals(Charsets_getInstance().y3o_1)) {
    return encodeISO88591(input, fromIndex, toIndex, dst);
  }
  // Inline function 'kotlin.require' call
  if (!(get_charset_0(_this__u8e3s4) === Charsets_getInstance().x3o_1)) {
...
function ioDispatcher() {
  return Dispatchers_getInstance().k2h_1;
}
function encodeISO88591(input, fromIndex, toIndex, dst) {
  ...
  if (inductionVariable < toIndex)
    do {
      ...
      dst.q23(toByte(character));
    }
     while (inductionVariable < toIndex);
  return toIndex - fromIndex | 0;
}
function failedToMapError(ch) {
  throw MalformedInputException.w3o('The character with unicode point ' + ch + " couldn't be mapped to ISO-8859-1 character");
}
...
protoOf(Read).l3l = resume;
protoOf(Read).m3l = resume_0;
initMetadataForClass(Read, 'Read', VOID, VOID, [Task]);
protoOf(Write).l3l = resume;
protoOf(Write).m3l = resume_0;
...
protoOf(ByteChannel).c3n = awaitContent$default;
...
protoOf(ByteReadChannel$Companion$Empty$1).c3n = awaitContent$default;
...
protoOf(CountedByteReadChannel).c3n = awaitContent$default;
initMetadataForClass(CountedByteReadChannel, 'CountedByteReadChannel', VOID, VOID, [ByteReadChannel], [1]);
initMetadataForClass(ClosedByteChannelException, 'ClosedByteChannelException', ClosedByteChannelException.u3m);
initMetadataForClass(ClosedReadChannelException, 'ClosedReadChannelException', ClosedReadChannelException.i3m);
initMetadataForClass(ClosedWriteChannelException, 'ClosedWriteChannelException', ClosedWriteChannelException.o3m);
initMetadataForClass(LineEnding, 'LineEnding');
initMetadataForCompanion(Companion_2);
initMetadataForClass(LineEndingMode, 'LineEndingMode');
protoOf(SourceByteReadChannel).c3n = awaitContent$default;
