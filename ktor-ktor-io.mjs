...
class Companion {
  constructor() {
    ...
    this.z3k_1 = new Closed(null);
    var tmp = this;
    // Inline function 'kotlin.Companion.success' call
    tmp.a3l_1 = _Result___init__impl__xyqfz8(Unit_instance);
  }
}
class Empty {
  toString() {
...
class Closed {
  ...
  toString() {
    return 'Closed(cause=' + toString(this.b3l_1) + ')';
  }
  hashCode() {
    return this.b3l_1 == null ? 0 : hashCode(this.b3l_1);
  }
  equals(other) {
    if (this === other)
      return true;
...
class Task {}
function resume() {
  return this.d3l().nd(Companion_getInstance().a3l_1);
}
function resume_0(throwable) {
  ...
  return tmp.nd(tmp1_elvis_lhs == null ? Companion_getInstance().a3l_1 : tmp1_elvis_lhs.jw_1);
}
class Read {
  constructor(continuation) {
    this.h3l_1 = continuation;
    this.i3l_1 = null;
    if (get_DEVELOPMENT_MODE()) {
      var tmp = this;
      // Inline function 'kotlin.also' call
      var this_0 = newThrowable('ReadTask 0x' + toString_0(hashCode(this.h3l_1), 16));
...
class Write {
  constructor(continuation) {
    this.j3l_1 = continuation;
    this.k3l_1 = null;
    if (get_DEVELOPMENT_MODE()) {
      var tmp = this;
      // Inline function 'kotlin.also' call
      var this_0 = newThrowable('WriteTask 0x' + toString_0(hashCode(this.j3l_1), 16));
      stackTraceToString(this_0);
      tmp.k3l_1 = this_0;
    }
  }
...
function awaitContent$default(min, $completion, $super) {
  min = min === VOID ? 1 : min;
  return $super === VOID ? this.q3m(min, $completion) : $super.q3m.call(this, min, $completion);
}
...
class ByteChannel {
  constructor(autoFlush) {
    ...
    this.l3l_1 = autoFlush;
    this.m3l_1 = new Buffer();
    this.n3l_1 = 0;
    this.o3l_1 = new Object();
    this.p3l_1 = atomic$ref$1(Empty_instance);
    this.q3l_1 = new Buffer();
    this.r3l_1 = new Buffer();
    this.s3l_1 = atomic$ref$1(null);
    this.t3l_1 = atomic$ref$1(null);
  }
  v3l() {
    return this.l3l_1;
  }
  w3l() {
    return this.n3l_1 < 1048576;
  }
  x3l() {
    var tmp0_safe_receiver = this.s3l_1.kotlinx$atomicfu$value;
    if (tmp0_safe_receiver == null)
      ...
      if (tmp0_subject == null) {
        ...
        if (isInterface(tmp0_subject, CopyableThrowable)) {
          tmp = access$_get_origin__hdh1qz(tmp0_safe_receiver).j2d();
        } else {
          if (tmp0_subject instanceof CancellationException) {
            ...
            tmp = ClosedReadChannelException.c3m(p0);
          }
        }
      }
    ...
    if (this.j3m()) {
      ...
      if (tmp0_safe_receiver == null) {
        ...
        if (tmp0_subject == null) {
          ...
          if (isInterface(tmp0_subject, CopyableThrowable)) {
            tmp_0 = access$_get_origin__hdh1qz(tmp0_safe_receiver).j2d();
          } else {
            if (tmp0_subject instanceof CancellationException) {
              ...
              var p0 = access$_get_origin__hdh1qz(tmp0_safe_receiver);
              tmp_0 = ClosedWriteChannelException.i3m(p0);
            }
          }
        }
      ...
      if (tmp == null)
        throw ClosedWriteChannelException.i3m();
    }
    return this.r3l_1;
  }
  k3m() {
      ...
      if (tmp0_subject == null) {
        ...
        if (isInterface(tmp0_subject, CopyableThrowable)) {
          ...
          if (tmp0_subject instanceof CancellationException) {
            ...
            var p0 = access$_get_origin__hdh1qz(tmp0_safe_receiver);
            tmp_0 = ClosedByteChannelException.o3m(p0);
          }
        }
      }
      tmp = tmp_0;
  ...
  j3m() {
    return !(this.s3l_1.kotlinx$atomicfu$value == null);
  }
  p3m() {
    return !(this.k3m() == null) || (this.j3m() && this.n3l_1 === 0 && this.q3l_1.v21());
  }
  *q3m(min, $completion) {
    rethrowCloseCauseIfNeeded_0(this);
    if (this.q3l_1.l2() >= fromInt(min))
      return true;
    // Inline function 'io.ktor.utils.io.ByteChannel.sleepWhile' call
    var this_0 = this;
    $l$loop: while (add(numberToLong(this.n3l_1), this.q3l_1.l2()) < fromInt(min) && this.s3l_1.kotlinx$atomicfu$value == null) {
      ...
      (yield () => {
        ...
        $l$block_0: {
          ...
          var previous = tmp0.p3l_1.kotlinx$atomicfu$value;
          if (!(previous instanceof Closed)) {
            if (!tmp0.p3l_1.atomicfu$compareAndSet(previous, tmp2)) {
              tmp2.f3l();
              break $l$block_0;
            }
          }
          if (previous instanceof Read) {
            previous.g3l(ConcurrentIOException.v3m(tmp2.e3l(), previous.c3l()));
          } else {
            if (isInterface(previous, Task)) {
              previous.f3l();
            } else {
              if (previous instanceof Closed) {
                tmp2.g3l(previous.b3l_1);
                break $l$block_0;
              } else {
          ...
          if (!(add(numberToLong(this.n3l_1), this.q3l_1.l2()) < fromInt(min) && this.s3l_1.kotlinx$atomicfu$value == null)) {
            // Inline function 'io.ktor.utils.io.ByteChannel.resumeSlot' call
            var current = tmp0.p3l_1.kotlinx$atomicfu$value;
            var tmp;
            if (current instanceof Read) {
              tmp = tmp0.p3l_1.atomicfu$compareAndSet(current, Empty_instance);
            } else {
              tmp = false;
            }
            if (tmp) {
        ...
        return cancellable.f29();
      });
    }
    if (this.q3l_1.l2() < 1048576n) {
      moveFlushToReadBuffer(this);
    }
    return this.q3l_1.l2() >= fromInt(min);
  }
  *x3m($completion) {
    rethrowCloseCauseIfNeeded_0(this);
    this.y3m();
    ...
    // Inline function 'io.ktor.utils.io.ByteChannel.sleepWhile' call
    var this_0 = this;
    $l$loop: while (!this.w3l() && this.s3l_1.kotlinx$atomicfu$value == null) {
      // Inline function 'kotlinx.coroutines.suspendCancellableCoroutine' call
      // Inline function 'kotlin.js.suspendCoroutineUninterceptedOrReturnJS' call
      (yield () => {
        var uCont = $completion;
        ...
        $l$block_0: {
          ...
          if (!(!this.w3l() && this.s3l_1.kotlinx$atomicfu$value == null)) {
            // Inline function 'io.ktor.utils.io.ByteChannel.resumeSlot' call
            var current = tmp0.p3l_1.kotlinx$atomicfu$value;
            var tmp;
  ...
  y3m() {
    ...
    this.o3l_1;
    var count = convertToInt(this.r3l_1.l2());
    this.m3l_1.n23(this.r3l_1);
    this.n3l_1 = this.n3l_1 + count | 0;
    // Inline function 'io.ktor.utils.io.ByteChannel.resumeSlot' call
    var current = this.p3l_1.kotlinx$atomicfu$value;
    var tmp;
    if (current instanceof Read) {
      tmp = this.p3l_1.atomicfu$compareAndSet(current, Empty_instance);
    } else {
      tmp = false;
    }
    if (tmp) {
  ...
  f7() {
    this.y3m();
    if (!this.s3l_1.atomicfu$compareAndSet(null, get_CLOSED()))
      return Unit_instance;
    closeSlot(this, null);
  }
  *z3m($completion) {
  ...
  a3n(cause) {
    if (!(this.s3l_1.kotlinx$atomicfu$value == null))
      return Unit_instance;
    var closedToken = new CloseToken(cause);
    this.s3l_1.atomicfu$compareAndSet(null, closedToken);
    // Inline function 'io.ktor.utils.io.Companion.wrapCause' call
    ...
    if (tmp0_subject == null) {
      ...
      if (isInterface(tmp0_subject, CopyableThrowable)) {
        tmp = access$_get_origin__hdh1qz(closedToken).j2d();
      } else {
        if (tmp0_subject instanceof CancellationException) {
          ...
          tmp = ClosedByteChannelException.o3m(p0);
        }
      }
    }
  ...
  b3n(handler) {
    var existingCause = this.s3l_1.kotlinx$atomicfu$value;
    if (!(existingCause == null)) {
      ...
      if (tmp0_subject == null) {
        ...
        if (isInterface(tmp0_subject, CopyableThrowable)) {
          tmp = access$_get_origin__hdh1qz(existingCause).j2d();
        } else {
          if (tmp0_subject instanceof CancellationException) {
    ...
    if (!this.t3l_1.atomicfu$compareAndSet(null, handler)) {
    ...
    var cause = this.s3l_1.kotlinx$atomicfu$value;
    if (!(cause == null) && this.t3l_1.atomicfu$compareAndSet(handler, null)) {
      // Inline function 'io.ktor.utils.io.Companion.wrapCause' call
      ...
      if (tmp0_subject_0 == null) {
        ...
        if (isInterface(tmp0_subject_0, CopyableThrowable)) {
          tmp_1 = access$_get_origin__hdh1qz(cause).j2d();
        } else {
          if (tmp0_subject_0 instanceof CancellationException) {
            ...
            tmp_1 = ClosedByteChannelException.o3m(p0_0);
          }
        }
      }
      handler(tmp_1);
...
class ConcurrentIOException extends IllegalStateException {
  constructor(taskName, cause) {
    return new.target.v3m(taskName, cause);
  }
  static v3m(taskName, cause) {
...
class ByteChannelScanner {
  constructor(channel, matchString, writeChannel, limit) {
    ...
    this.c3n_1 = channel;
    this.d3n_1 = matchString;
    this.e3n_1 = writeChannel;
    this.f3n_1 = limit;
    ...
    this.g3n_1 = this.c3n_1.x3l();
    this.h3n_1 = buildPartialMatchTable(this);
    this.i3n_1 = new Buffer();
    this.j3n_1 = 0n;
    this.k3n_1 = 0;
  }
  *l3n(ignoreMissing, $completion) {
    this.j3n_1 = 0n;
    while (!this.g3n_1.v21() || (yield* this.c3n_1.w3m(VOID, $completion))) {
    ...
    if (!ignoreMissing) {
      throw IOException.y24('Expected "' + toSingleLineString(this, this.d3n_1) + '" but encountered end of input');
    }
    this.j3n_1 = add(this.j3n_1, this.i3n_1.y22(this.e3n_1.d3m()));
    yield* this.e3n_1.x3m($completion);
    return this.j3n_1;
  }
}
...
class Companion_0 {
  constructor() {
    ...
    var tmp = this;
    tmp.q3n_1 = new ByteReadChannel$Companion$Empty$1();
  }
}
class WriterJob {
...
class NO_CALLBACK$1 {
  constructor() {
    this.y3n_1 = EmptyCoroutineContext_instance;
  }
  ld() {
    return this.y3n_1;
  }
...
class CountedByteReadChannel {
  ...
  k3m() {
    return this.a3o_1.k3m();
  }
  p3m() {
    return this.b3o_1.v21() && this.a3o_1.p3m();
  }
  x3l() {
  ...
  *q3m(min, $completion) {
    if (this.x3l().l2() >= fromInt(min)) {
      return true;
    }
    if (yield* this.a3o_1.q3m(min, $completion)) {
      transferFromDelegate(this);
      return true;
    }
    return false;
  ...
  a3n(cause) {
    this.a3o_1.a3n(cause);
    this.b3o_1.f7();
  }
}
class ClosedByteChannelException extends IOException {
  constructor(cause) {
    return new.target.o3m(cause);
  }
  static o3m(cause) {
    cause = cause === VOID ? null : cause;
    var $this = this.z24(cause == null ? null : cause.message, cause);
    captureStack($this, $this.n3m_1);
    return $this;
  }
}
class ClosedReadChannelException extends ClosedByteChannelException {
  constructor(cause) {
    return new.target.c3m(cause);
  }
  static c3m(cause) {
    cause = cause === VOID ? null : cause;
    var $this = this.o3m(cause);
    captureStack($this, $this.b3m_1);
    return $this;
  }
}
class ClosedWriteChannelException extends ClosedByteChannelException {
  constructor(cause) {
    return new.target.i3m(cause);
  }
  static i3m(cause) {
    cause = cause === VOID ? null : cause;
    var $this = this.o3m(cause);
...
class Companion_2 {
  constructor() {
    ...
    this.f3o_1 = _LineEndingMode___init__impl__jo5bul(1);
    this.g3o_1 = _LineEndingMode___init__impl__jo5bul(2);
    this.h3o_1 = _LineEndingMode___init__impl__jo5bul(4);
    this.i3o_1 = _LineEndingMode___init__impl__jo5bul(7);
    this.j3o_1 = listOf([new LineEndingMode(this.f3o_1), new LineEndingMode(this.g3o_1), new LineEndingMode(this.h3o_1)]);
  }
}
class LineEndingMode {
  ...
  toString() {
    return LineEndingMode__toString_impl_j4h76r(this.k3o_1);
  }
  hashCode() {
    return LineEndingMode__hashCode_impl_2mopm4(this.k3o_1);
  }
  equals(other) {
    return LineEndingMode__equals_impl_qyr4nk(this.k3o_1, other);
  }
}
class SourceByteReadChannel {
  ...
  k3m() {
    var tmp0_safe_receiver = this.m3o_1;
    var tmp;
    if (tmp0_safe_receiver == null) {
      tmp = null;
    } else {
  ...
  p3m() {
    return this.l3o_1.v21();
  }
  x3l() {
    var tmp0_safe_receiver = this.k3m();
    if (tmp0_safe_receiver == null)
      null;
    else {
      // Inline function 'kotlin.let' call
  ...
  *q3m(min, $completion) {
    ...
    return this.l3o_1.x21(fromInt(min));
  }
  a3n(cause) {
    if (!(this.m3o_1 == null))
      return Unit_instance;
    ...
    tmp.m3o_1 = new CloseToken(IOException.z24(tmp1_elvis_lhs == null ? 'Channel was cancelled' : tmp1_elvis_lhs, cause));
  }
}
class MalformedInputException extends IOException {
  constructor(message) {
    return new.target.q3o(message);
  }
  static q3o(message) {
    var $this = this.y24(message);
    captureStack($this, $this.p3o_1);
    return $this;
  }
}
class TooLongLineException extends MalformedInputException {
  constructor(message) {
    return new.target.v3n(message);
  }
  static v3n(message) {
    var $this = this.q3o(message);
    captureStack($this, $this.u3n_1);
    return $this;
  }
}
class ObjectPool {}
...
class DefaultPool {
  ...
  g3p() {
    if (this.c3p_1 === 0)
      return this.z3o();
    this.c3p_1 = this.c3p_1 - 1 | 0;
    var idx = this.c3p_1;
    var tmp = this.b3p_1[idx];
    var instance = !(tmp == null) ? tmp : THROW_CCE();
    this.b3p_1[idx] = null;
    return this.e3p(instance);
  }
  h3p(instance) {
    this.f3p(instance);
    if (this.c3p_1 === this.a3p_1) {
      this.d3p(instance);
    } else {
      var _unary__edvuaz = this.c3p_1;
      this.c3p_1 = _unary__edvuaz + 1 | 0;
      this.b3p_1[_unary__edvuaz] = instance;
    }
  }
  e28() {
...
class Companion_3 {
  i3p(name) {
    switch (name) {
      ...
      case 'UTF8':
      case 'utf8':
        return Charsets_getInstance().r3o_1;
    }
    var tmp;
    var tmp_0;
    switch (name) {
    ...
    if (tmp) {
      return Charsets_getInstance().s3o_1;
    }
...
class Charset {
  ...
  equals(other) {
    ...
    if (!(other instanceof Charset))
      THROW_CCE();
    return this.t3o_1 === other.t3o_1;
  }
  hashCode() {
    return getStringHashCode(this.t3o_1);
  }
  toString() {
    return this.t3o_1;
  }
...
class Charsets {
  constructor() {
    ...
    this.r3o_1 = new CharsetImpl('UTF-8');
    this.s3o_1 = new CharsetImpl('ISO-8859-1');
  }
}
...
class CharsetEncoderImpl extends CharsetEncoder {
  ...
  toString() {
    return 'CharsetEncoderImpl(charset=' + this.o3p_1.toString() + ')';
  }
  hashCode() {
  ...
  equals(other) {
    ...
    if (!(other instanceof CharsetEncoderImpl))
      return false;
    if (!this.o3p_1.equals(other.o3p_1))
      return false;
    return true;
  }
}
class CharsetDecoderImpl extends CharsetDecoder {
  ...
  toString() {
    return 'CharsetDecoderImpl(charset=' + this.q3p_1.toString() + ')';
  }
  hashCode() {
  ...
  equals(other) {
    ...
    if (!(other instanceof CharsetDecoderImpl))
      return false;
    if (!this.q3p_1.equals(other.q3p_1))
      return false;
    return true;
  }
}
class toKtor$1 {
  constructor($this_toKtor) {
    this.r3p_1 = $this_toKtor;
  }
  l3p(buffer) {
    return this.r3p_1.decode(buffer);
  }
}
  ...
  l3p(buffer) {
    ...
    if (inductionVariable < last)
      $l$loop: do {
        ...
        if (point > 255) {
          builder.o23(toByte(point >> 8));
        }
        builder.o23(toByte(point & 255));
      }
       while (inductionVariable < last);
...
function closeSlot($this, cause) {
  var closeContinuation = !(cause == null) ? new Closed(cause) : Companion_getInstance().z3k_1;
  var continuation = $this.p3l_1.atomicfu$getAndSet(closeContinuation);
  if (isInterface(continuation, Task)) {
    continuation.g3l(cause);
  }
  var tmp0_safe_receiver = $this.t3l_1.atomicfu$getAndSet(null);
  if (tmp0_safe_receiver == null)
    null;
  else
...
function ByteChannel$invokeOnClose$lambda_1(this$0, $handler) {
  return () => {
    this$0.t3l_1.atomicfu$compareAndSet($handler, null);
    return Unit_instance;
  };
}
function ByteReadChannel_0(content, offset, length) {
  ...
  this_0.e23(content, offset, offset + length | 0);
  var source = this_0;
...
function buildPartialMatchTable($this) {
  var table = new Int32Array($this.d3n_1.l2());
  var j = 0;
  var inductionVariable = 1;
  var last = $this.d3n_1.l2();
  if (inductionVariable < last)
    do {
      var i = inductionVariable;
      inductionVariable = inductionVariable + 1 | 0;
      while (j > 0 && !($this.d3n_1.n2(i) === $this.d3n_1.n2(j))) {
        j = table[j - 1 | 0];
      }
      if ($this.d3n_1.n2(i) === $this.d3n_1.n2(j)) {
        j = j + 1 | 0;
      }
      table[i] = j;
    }
...
function *advanceToNextPotentialMatch($this, $completion) {
  while (!$this.g3n_1.v21() || (yield* $this.c3n_1.w3m(VOID, $completion))) {
    var nextMatch = indexOf($this.g3n_1, $this.d3n_1.n2(0));
    if (nextMatch === -1n) {
      var tmp = $this.g3n_1;
      checkBounds($this, (tmp instanceof Buffer ? tmp : THROW_CCE()).l2());
      $this.j3n_1 = add($this.j3n_1, $this.g3n_1.y22($this.e3n_1.d3m()));
      yield* flushIfNeeded($this.e3n_1, $completion);
    } else {
      checkBounds($this, nextMatch);
      var tmp_0 = $this;
      var tmp_1 = $this.j3n_1;
      var tmp_2 = $this.e3n_1.d3m();
      tmp_0.j3n_1 = add(tmp_1, $this.g3n_1.v22(tmp_2 instanceof Buffer ? tmp_2 : THROW_CCE(), nextMatch));
      yield* flushIfNeeded($this.e3n_1, $completion);
      return Unit_instance;
    }
  }
...
function *checkFullMatch($this, $completion) {
  while (!$this.g3n_1.v21() || (yield* $this.c3n_1.w3m(VOID, $completion))) {
    var byte = $this.g3n_1.y21();
    if ($this.k3n_1 > 0 && !(byte === $this.d3n_1.n2($this.k3n_1))) {
      var oldMatchIndex = $this.k3n_1;
      while ($this.k3n_1 > 0 && !(byte === $this.d3n_1.n2($this.k3n_1))) {
        $this.k3n_1 = $this.h3n_1[$this.k3n_1 - 1 | 0];
      }
      var retained = fromInt(oldMatchIndex - $this.k3n_1 | 0);
      checkBounds($this, retained);
      var tmp = $this;
      var tmp_0 = $this.j3n_1;
      var tmp_1 = $this.e3n_1.d3m();
      tmp.j3n_1 = add(tmp_0, $this.i3n_1.v22(tmp_1 instanceof Buffer ? tmp_1 : THROW_CCE(), retained));
      if ($this.k3n_1 === 0 && !(byte === $this.d3n_1.n2($this.k3n_1))) {
        yield* writeByte($this.e3n_1, byte, $completion);
        var _unary__edvuaz = $this.j3n_1;
        $this.j3n_1 = add(_unary__edvuaz, get_ONE());
        return false;
      }
    }
    $this.k3n_1 = $this.k3n_1 + 1 | 0;
    if ($this.k3n_1 === $this.d3n_1.l2()) {
      return true;
    }
    $this.i3n_1.o23(byte);
  }
...
function checkBounds($this, extra) {
  if (add($this.j3n_1, extra) > $this.f3n_1) {
    throw IOException.y24('Limit of ' + $this.f3n_1.toString() + ' bytes exceeded ' + ('while searching for "' + toSingleLineString($this, $this.d3n_1) + '"'));
  }
}
...
function attachWriterJob(_this__u8e3s4, writerJob) {
  var tmp = writerJob.m3n_1;
  var tmp0_safe_receiver = tmp instanceof ByteChannel ? tmp : null;
  if (tmp0_safe_receiver == null)
    null;
  else {
    tmp0_safe_receiver.b3n(attachWriterJob$lambda(_this__u8e3s4));
  }
}
function attachWriterJob$lambda($this_attachWriterJob) {
  return (cause) => {
    var tmp;
    if (!(cause == null)) {
      $this_attachWriterJob.a3n(cause);
      tmp = Unit_instance;
    }
    return Unit_instance;
  };
...
function cancel_0(_this__u8e3s4) {
  _this__u8e3s4.a3n(IOException.y24('Channel was cancelled'));
}
function *readRemaining(_this__u8e3s4, $completion) {
  var result = BytePacketBuilder();
  while (!_this__u8e3s4.p3m()) {
    result.n23(_this__u8e3s4.x3l());
    yield* _this__u8e3s4.w3m(VOID, $completion);
  }
...
function *copyTo(_this__u8e3s4, channel, limit, $completion) {
  var remaining = limit;
  try {
    while (!_this__u8e3s4.p3m() && remaining > 0n) {
      if (_this__u8e3s4.x3l().v21()) {
        yield* _this__u8e3s4.w3m(VOID, $completion);
      }
      var tmp0 = remaining;
      // Inline function 'kotlin.comparisons.minOf' call
      var b = get_remaining(_this__u8e3s4.x3l());
      var count = tmp0 <= b ? tmp0 : b;
      _this__u8e3s4.x3l().x22(channel.d3m(), count);
      remaining = subtract(remaining, count);
      yield* channel.x3m($completion);
    }
  } catch ($p) {
    if ($p instanceof Error) {
      var cause = $p;
      _this__u8e3s4.a3n(cause);
...
function rethrowCloseCauseIfNeeded(_this__u8e3s4) {
  var tmp0_safe_receiver = _this__u8e3s4.k3m();
  if (tmp0_safe_receiver == null)
    null;
  else {
    // Inline function 'kotlin.let' call
...
function *discard(_this__u8e3s4, max, $completion) {
  ...
  var remaining = max;
  while (remaining > 0n && !_this__u8e3s4.p3m()) {
    ...
    var b = get_remaining(_this__u8e3s4.x3l());
    var count = tmp0 <= b ? tmp0 : b;
    discard_0(_this__u8e3s4.x3l(), count);
    remaining = subtract(remaining, count);
  }
...
function *copyTo_0(_this__u8e3s4, channel, $completion) {
  ...
  try {
    while (!_this__u8e3s4.p3m()) {
      result = add(result, _this__u8e3s4.x3l().y22(channel.d3m()));
      yield* channel.x3m($completion);
      yield* _this__u8e3s4.w3m(VOID, $completion);
    }
  } catch ($p) {
...
function *readAvailable(_this__u8e3s4, buffer, offset, length, $completion) {
  ...
  if (_this__u8e3s4.p3m())
    return -1;
  return readAvailable_0(_this__u8e3s4.x3l(), buffer, offset, length);
}
...
function *readPacket(_this__u8e3s4, packet, $completion) {
  ...
  $l$loop: while (result.l2() < fromInt(packet)) {
    ...
    if (_this__u8e3s4.p3m())
      break $l$loop;
    if (get_remaining(_this__u8e3s4.x3l()) > subtract(numberToLong(packet), result.l2())) {
      _this__u8e3s4.x3l().x22(result, subtract(numberToLong(packet), result.l2()));
    } else {
      _this__u8e3s4.x3l().y22(result);
    }
  }
  if (result.l2() < fromInt(packet)) {
    throw EOFException.t21('Not enough data available, required ' + packet + ' bytes but only ' + result.l2().toString() + ' available');
  }
  return result;
}
function *readUntil(_this__u8e3s4, matchString, writeChannel, limit, ignoreMissing, $completion) {
  ...
  return yield* (new ByteChannelScanner(_this__u8e3s4, matchString, writeChannel, limit)).l3n(ignoreMissing, $completion);
}
...
function get_availableForRead(_this__u8e3s4) {
  return convertToInt(_this__u8e3s4.x3l().u21().l2());
}
function *peek(_this__u8e3s4, count, $completion) {
  if (_this__u8e3s4.p3m())
    return null;
  if (!(yield* _this__u8e3s4.q3m(count, $completion)))
    return null;
  return readByteString(_this__u8e3s4.x3l().z22(), count);
}
function *internalReadLineTo(_this__u8e3s4, out, limit, lenientLineEnding, throwOnIncompleteLine, $completion) {
  var readBuffer = _this__u8e3s4.x3l();
  if (readBuffer.v21()) {
    yield* _this__u8e3s4.w3m(VOID, $completion);
  }
  if (_this__u8e3s4.p3m())
    return -1n;
  var consumed = {_v: 0n};
  $l$loop: while (consumed._v < limit && !_this__u8e3s4.p3m()) {
    ...
    if (lfIndex > 0n) {
      var tmp;
      var tmp_0 = readBuffer.u21();
      // Inline function 'kotlin.Long.minus' call
      var tmp$ret$0 = subtract(lfIndex, fromInt(1));
      if (tmp_0.q22(tmp$ret$0) === 13) {
        tmp = 1n;
      } else {
        tmp = 0n;
      }
    ...
    var tmp_1 = readBuffer.u21();
    // Inline function 'kotlin.Long.minus' call
    var tmp$ret$2 = subtract(count, fromInt(1));
    if (tmp_1.q22(tmp$ret$2) === 13) {
      // Inline function 'kotlin.Long.minus' call
    ...
    if (consumed._v < limit && get_remaining(readBuffer) === 0n && !(yield* _this__u8e3s4.w3m(VOID, $completion)))
      break $l$loop;
  }
  if (consumed._v === 0n && _this__u8e3s4.p3m())
    return -1n;
  // Inline function 'kotlin.check' call
  ...
  if (consumed._v === limit) {
    if (limit === 9223372036854775807n)
      throw TooLongLineException.v3n('Max line length exceeded');
    if (get_remaining(readBuffer) === 0n && !(yield* _this__u8e3s4.w3m(VOID, $completion))) {
      throwEndOfStreamException(consumed._v);
    }
    var tmp0_subject = readBuffer.u21().q22(0n);
    if (tmp0_subject === 10) {
      discard_0(readBuffer, 1n);
      return consumed._v;
...
function throwEndOfStreamException(consumed) {
  throw EOFException.t21('Unexpected end of stream after reading ' + consumed.toString() + ' characters');
}
function throwTooLongLineException(limit) {
  throw TooLongLineException.v3n('Line exceeds limit of ' + limit.toString() + ' characters');
}
...
function *internalReadLineTo$discardCrlfOrCr(_this__u8e3s4, $this_internalReadLineTo, $lenientLineEnding, $completion) {
  if ((get_remaining(_this__u8e3s4) >= 2n || (yield* $this_internalReadLineTo.q3m(2, $completion))) && _this__u8e3s4.u21().q22(1n) === 10) {
...
function *flushIfNeeded(_this__u8e3s4, $completion) {
  ...
  if (_this__u8e3s4.v3l() || get_size(_this__u8e3s4.d3m()) >= 1048576)
    yield* _this__u8e3s4.x3m($completion);
  return Unit_instance;
}
function ByteWriteChannel$flushAndClose$ref(p0) {
  return constructCallableReference(function *($completion) {
    return yield* p0.z3m($completion);
...
function invokeOnCompletion(_this__u8e3s4, block) {
  _init_properties_ByteWriteChannelOperations_kt__i7slrs();
  return _this__u8e3s4.q28().r26(block);
}
function *writeFully(_this__u8e3s4, value, startIndex, endIndex, $completion) {
  startIndex = startIndex === VOID ? 0 : startIndex;
  endIndex = endIndex === VOID ? value.length : endIndex;
  _this__u8e3s4.d3m().e23(value, startIndex, endIndex);
...
function *writePacket(_this__u8e3s4, source, $completion) {
  while (!source.v21()) {
    _this__u8e3s4.d3m().i23(source, get_remaining(source));
    yield* flushIfNeeded(_this__u8e3s4, $completion);
  }
  return Unit_instance;
}
function writer_0(_this__u8e3s4, coroutineContext, channel, block) {
  ...
  this_0.r26(writer$lambda(channel));
  var job = this_0;
...
function *writeByte(_this__u8e3s4, value, $completion) {
  _this__u8e3s4.d3m().o23(value);
  yield* flushIfNeeded(_this__u8e3s4, $completion);
  return Unit_instance;
}
function writer$slambda($block, $channel) {
  return constructCallableReference(function *($this$launch, $completion) {
    var nested = Job(get_job($this$launch.o25()));
    var tmp;
    try {
      yield* $block(new WriterScope($channel, $this$launch.o25().kp(nested)), $completion);
      nested.y2c();
      var tmp_0;
      if (get_job($this$launch.o25()).l26()) {
        $channel.a3n(get_job($this$launch.o25()).o26());
        tmp_0 = Unit_instance;
      }
      tmp = tmp_0;
    } catch ($p) {
      ...
      yield* nested.v26($completion);
      // Inline function 'kotlin.runCatching' call
      var tmp_2;
      try {
        yield* $channel.z3m($completion);
        // Inline function 'kotlin.Companion.success' call
...
function transferFromDelegate($this) {
  updateConsumed($this);
  var appended = $this.b3o_1.n23($this.a3o_1.x3l());
  $this.c3o_1 = add($this.c3o_1, appended);
}
function updateConsumed($this) {
  $this.d3o_1 = add($this.d3o_1, subtract($this.c3o_1, $this.b3o_1.l2()));
  $this.c3o_1 = $this.b3o_1.l2();
}
...
function LineEndingMode__toString_impl_j4h76r($this) {
  var tmp;
  if ($this === Companion_getInstance_2().f3o_1) {
    tmp = 'CR';
  } else if ($this === Companion_getInstance_2().g3o_1) {
    tmp = 'LF';
  } else if ($this === Companion_getInstance_2().h3o_1) {
    tmp = 'CRLF';
  } else {
    // Inline function 'kotlin.collections.filter' call
    var tmp0 = Companion_getInstance_2().j3o_1;
    // Inline function 'kotlin.collections.filterTo' call
    var destination = ArrayList.j2();
    var _iterator__ex2g4s = tmp0.l1();
    while (_iterator__ex2g4s.m1()) {
      var element = _iterator__ex2g4s.n1();
      var it = element.k3o_1;
...
function writeFully_0(_this__u8e3s4, buffer, offset, length) {
  offset = offset === VOID ? 0 : offset;
  length = length === VOID ? buffer.length - offset | 0 : length;
  _this__u8e3s4.e23(buffer, offset, offset + length | 0);
}
function build(_this__u8e3s4) {
  return _this__u8e3s4.u21();
}
function get_size(_this__u8e3s4) {
  return convertToInt(_this__u8e3s4.u21().l2());
}
...
function ByteReadPacket(array, offset, length) {
  ...
  // Inline function 'kotlin.apply' call
  var this_0 = new Buffer();
  this_0.e23(array, offset, offset + length | 0);
  return this_0;
}
function get_remaining(_this__u8e3s4) {
  _init_properties_ByteReadPacket_kt__28475y();
  return _this__u8e3s4.u21().l2();
}
function discard_0(_this__u8e3s4, count) {
  count = count === VOID ? 9223372036854775807n : count;
  _init_properties_ByteReadPacket_kt__28475y();
  _this__u8e3s4.x21(count);
  // Inline function 'kotlin.comparisons.minOf' call
  var b = get_remaining(_this__u8e3s4);
  var countToDiscard = count <= b ? count : b;
  _this__u8e3s4.u21().s22(countToDiscard);
  return countToDiscard;
}
function takeWhile(_this__u8e3s4, block) {
  _init_properties_ByteReadPacket_kt__28475y();
  while (!_this__u8e3s4.v21() && block(_this__u8e3s4.u21())) {
  }
}
...
function readAvailable_0(_this__u8e3s4, buffer, offset, length) {
  offset = offset === VOID ? 0 : offset;
  length = length === VOID ? buffer.length - offset | 0 : length;
  var result = _this__u8e3s4.t22(buffer, offset, offset + length | 0);
  return result === -1 ? 0 : result;
}
function toByteArray_0(_this__u8e3s4, charset) {
  charset = charset === VOID ? Charsets_getInstance().r3o_1 : charset;
  if (charset.equals(Charsets_getInstance().r3o_1))
    return encodeToByteArray(_this__u8e3s4, VOID, VOID, true);
  return encodeToByteArray_0(charset.u3o(), _this__u8e3s4, 0, _this__u8e3s4.length);
}
function readText_0(_this__u8e3s4, charset, max) {
  ...
  if (charset.equals(Charsets_getInstance().r3o_1)) {
    if (max === 2147483647)
      return readString_0(_this__u8e3s4);
    var tmp0 = _this__u8e3s4.u21().l2();
    // Inline function 'kotlin.math.min' call
    var b = fromInt(max);
    var count = tmp0 <= b ? tmp0 : b;
    return readString(_this__u8e3s4, count);
  }
  return decode(charset.v3o(), _this__u8e3s4, max);
}
function writeText(_this__u8e3s4, text, fromIndex, toIndex, charset) {
  fromIndex = fromIndex === VOID ? 0 : fromIndex;
  toIndex = toIndex === VOID ? charSequenceLength(text) : toIndex;
  charset = charset === VOID ? Charsets_getInstance().r3o_1 : charset;
  if (charset === Charsets_getInstance().r3o_1) {
    return writeString(_this__u8e3s4, toString_1(text), fromIndex, toIndex);
  }
  encodeToImpl(charset.u3o(), _this__u8e3s4, text, fromIndex, toIndex);
}
...
function get_name(_this__u8e3s4) {
  return _this__u8e3s4.t3o_1;
}
function forName(_this__u8e3s4, name) {
  return Companion_instance_4.i3p(name);
}
function decode_0(_this__u8e3s4, input, dst, max) {
  var decoder = Decoder(get_name(get_charset(_this__u8e3s4)), true);
  var tmp0 = input.u21().l2();
  // Inline function 'kotlin.comparisons.minOf' call
  var b = fromInt(max);
  var count = tmp0 <= b ? tmp0 : b;
  ...
  try {
    ...
    // Inline function 'kotlin.js.asDynamic' call
    tmp = decoder.l3p(array);
  } catch ($p) {
    var tmp_0;
    if ($p instanceof Error) {
      var cause = $p;
      var tmp0_elvis_lhs = cause.message;
      throw MalformedInputException.q3o('Failed to decode bytes: ' + (tmp0_elvis_lhs == null ? 'no cause provided' : tmp0_elvis_lhs));
    } else {
      throw $p;
    }
  }
...
function encodeImpl(_this__u8e3s4, input, fromIndex, toIndex, dst) {
  ...
  if (get_charset_0(_this__u8e3s4).equals(Charsets_getInstance().s3o_1)) {
    return encodeISO88591(input, fromIndex, toIndex, dst);
  }
  // Inline function 'kotlin.require' call
  if (!(get_charset_0(_this__u8e3s4) === Charsets_getInstance().r3o_1)) {
...
function ioDispatcher() {
  return Dispatchers_getInstance().h2h_1;
}
function encodeISO88591(input, fromIndex, toIndex, dst) {
  ...
  if (inductionVariable < toIndex)
    do {
      ...
      dst.o23(toByte(character));
    }
     while (inductionVariable < toIndex);
  return toIndex - fromIndex | 0;
}
function failedToMapError(ch) {
  throw MalformedInputException.q3o('The character with unicode point ' + ch + " couldn't be mapped to ISO-8859-1 character");
}
...
protoOf(Read).f3l = resume;
protoOf(Read).g3l = resume_0;
initMetadataForClass(Read, 'Read', VOID, VOID, [Task]);
protoOf(Write).f3l = resume;
protoOf(Write).g3l = resume_0;
...
protoOf(ByteChannel).w3m = awaitContent$default;
...
protoOf(ByteReadChannel$Companion$Empty$1).w3m = awaitContent$default;
...
protoOf(CountedByteReadChannel).w3m = awaitContent$default;
initMetadataForClass(CountedByteReadChannel, 'CountedByteReadChannel', VOID, VOID, [ByteReadChannel], [1]);
initMetadataForClass(ClosedByteChannelException, 'ClosedByteChannelException', ClosedByteChannelException.o3m);
initMetadataForClass(ClosedReadChannelException, 'ClosedReadChannelException', ClosedReadChannelException.c3m);
initMetadataForClass(ClosedWriteChannelException, 'ClosedWriteChannelException', ClosedWriteChannelException.i3m);
initMetadataForClass(LineEnding, 'LineEnding');
initMetadataForCompanion(Companion_2);
initMetadataForClass(LineEndingMode, 'LineEndingMode');
protoOf(SourceByteReadChannel).w3m = awaitContent$default;
