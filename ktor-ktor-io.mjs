...
class Companion {
  constructor() {
    ...
    this.m3h_1 = new Closed(null);
    var tmp = this;
    // Inline function 'kotlin.Companion.success' call
    tmp.n3h_1 = _Result___init__impl__xyqfz8(Unit_instance);
  }
}
class Empty {
  toString() {
...
class Closed {
  ...
  toString() {
    return 'Closed(cause=' + toString(this.o3h_1) + ')';
  }
  hashCode() {
    return this.o3h_1 == null ? 0 : hashCode(this.o3h_1);
  }
  equals(other) {
    if (this === other)
      return true;
...
class Task {}
function resume() {
  return this.q3h().hd(Companion_getInstance().n3h_1);
}
function resume_0(throwable) {
  ...
  return tmp.hd(tmp1_elvis_lhs == null ? Companion_getInstance().n3h_1 : tmp1_elvis_lhs.nv_1);
}
class Read {
  constructor(continuation) {
    this.u3h_1 = continuation;
    this.v3h_1 = null;
    if (get_DEVELOPMENT_MODE()) {
      var tmp = this;
      // Inline function 'kotlin.also' call
      var this_0 = newThrowable('ReadTask 0x' + toString_0(hashCode(this.u3h_1), 16));
...
class Write {
  constructor(continuation) {
    this.w3h_1 = continuation;
    this.x3h_1 = null;
    if (get_DEVELOPMENT_MODE()) {
      var tmp = this;
      // Inline function 'kotlin.also' call
      var this_0 = newThrowable('WriteTask 0x' + toString_0(hashCode(this.w3h_1), 16));
      stackTraceToString(this_0);
      tmp.x3h_1 = this_0;
    }
  }
...
function awaitContent$default(min, $completion, $super) {
  min = min === VOID ? 1 : min;
  return $super === VOID ? this.d3j(min, $completion) : $super.d3j.call(this, min, $completion);
}
...
class ByteChannel {
  constructor(autoFlush) {
    ...
    this.y3h_1 = autoFlush;
    this.z3h_1 = new Buffer();
    this.a3i_1 = 0;
    this.b3i_1 = new Object();
    this.c3i_1 = atomic$ref$1(Empty_instance);
    this.d3i_1 = new Buffer();
    this.e3i_1 = new Buffer();
    this.f3i_1 = atomic$ref$1(null);
    this.g3i_1 = atomic$ref$1(null);
  }
  i3i() {
    return this.y3h_1;
  }
  j3i() {
    return this.a3i_1 < 1048576;
  }
  k3i() {
    var tmp0_safe_receiver = this.f3i_1.kotlinx$atomicfu$value;
    if (tmp0_safe_receiver == null)
      ...
      if (tmp0_subject == null) {
        ...
        if (isInterface(tmp0_subject, CopyableThrowable)) {
          tmp = access$_get_origin__hdh1qz(tmp0_safe_receiver).n2c();
        } else {
          if (tmp0_subject instanceof CancellationException) {
            ...
            tmp = ClosedReadChannelException.p3i(p0);
          }
        }
      }
    ...
    if (this.w3i()) {
      ...
      if (tmp0_safe_receiver == null) {
        ...
        if (tmp0_subject == null) {
          ...
          if (isInterface(tmp0_subject, CopyableThrowable)) {
            tmp_0 = access$_get_origin__hdh1qz(tmp0_safe_receiver).n2c();
          } else {
            if (tmp0_subject instanceof CancellationException) {
              ...
              var p0 = access$_get_origin__hdh1qz(tmp0_safe_receiver);
              tmp_0 = ClosedWriteChannelException.v3i(p0);
            }
          }
        }
      ...
      if (tmp == null)
        throw ClosedWriteChannelException.v3i();
    }
    return this.e3i_1;
  }
  x3i() {
      ...
      if (tmp0_subject == null) {
        ...
        if (isInterface(tmp0_subject, CopyableThrowable)) {
          ...
          if (tmp0_subject instanceof CancellationException) {
            ...
            var p0 = access$_get_origin__hdh1qz(tmp0_safe_receiver);
            tmp_0 = ClosedByteChannelException.b3j(p0);
          }
        }
      }
      tmp = tmp_0;
  ...
  w3i() {
    return !(this.f3i_1.kotlinx$atomicfu$value == null);
  }
  c3j() {
    return !(this.x3i() == null) || (this.w3i() && this.a3i_1 === 0 && this.d3i_1.z20());
  }
  *d3j(min, $completion) {
    rethrowCloseCauseIfNeeded_0(this);
    if (this.d3i_1.k2() >= fromInt(min))
      return true;
    // Inline function 'io.ktor.utils.io.ByteChannel.sleepWhile' call
    var this_0 = this;
    $l$loop: while (add(numberToLong(this.a3i_1), this.d3i_1.k2()) < fromInt(min) && this.f3i_1.kotlinx$atomicfu$value == null) {
      ...
      (yield () => {
        ...
        $l$block_0: {
          ...
          var previous = tmp0.c3i_1.kotlinx$atomicfu$value;
          if (!(previous instanceof Closed)) {
            if (!tmp0.c3i_1.atomicfu$compareAndSet(previous, tmp2)) {
              tmp2.s3h();
              break $l$block_0;
            }
          }
          if (previous instanceof Read) {
            previous.t3h(ConcurrentIOException.i3j(tmp2.r3h(), previous.p3h()));
          } else {
            if (isInterface(previous, Task)) {
              previous.s3h();
            } else {
              if (previous instanceof Closed) {
                tmp2.t3h(previous.o3h_1);
                break $l$block_0;
              } else {
          ...
          if (!(add(numberToLong(this.a3i_1), this.d3i_1.k2()) < fromInt(min) && this.f3i_1.kotlinx$atomicfu$value == null)) {
            // Inline function 'io.ktor.utils.io.ByteChannel.resumeSlot' call
            var current = tmp0.c3i_1.kotlinx$atomicfu$value;
            var tmp;
            if (current instanceof Read) {
              tmp = tmp0.c3i_1.atomicfu$compareAndSet(current, Empty_instance);
            } else {
              tmp = false;
            }
            if (tmp) {
        ...
        return cancellable.j28();
      });
    }
    if (this.d3i_1.k2() < 1048576n) {
      moveFlushToReadBuffer(this);
    }
    return this.d3i_1.k2() >= fromInt(min);
  }
  *k3j($completion) {
    rethrowCloseCauseIfNeeded_0(this);
    this.l3j();
    ...
    // Inline function 'io.ktor.utils.io.ByteChannel.sleepWhile' call
    var this_0 = this;
    $l$loop: while (!this.j3i() && this.f3i_1.kotlinx$atomicfu$value == null) {
      // Inline function 'kotlinx.coroutines.suspendCancellableCoroutine' call
      // Inline function 'kotlin.js.suspendCoroutineUninterceptedOrReturnJS' call
      (yield () => {
        var uCont = $completion;
        ...
        $l$block_0: {
          ...
          if (!(!this.j3i() && this.f3i_1.kotlinx$atomicfu$value == null)) {
            // Inline function 'io.ktor.utils.io.ByteChannel.resumeSlot' call
            var current = tmp0.c3i_1.kotlinx$atomicfu$value;
            var tmp;
  ...
  l3j() {
    ...
    this.b3i_1;
    var count = convertToInt(this.e3i_1.k2());
    this.z3h_1.r22(this.e3i_1);
    this.a3i_1 = this.a3i_1 + count | 0;
    // Inline function 'io.ktor.utils.io.ByteChannel.resumeSlot' call
    var current = this.c3i_1.kotlinx$atomicfu$value;
    var tmp;
    if (current instanceof Read) {
      tmp = this.c3i_1.atomicfu$compareAndSet(current, Empty_instance);
    } else {
      tmp = false;
    }
    if (tmp) {
  ...
  f7() {
    this.l3j();
    if (!this.f3i_1.atomicfu$compareAndSet(null, get_CLOSED()))
      return Unit_instance;
    closeSlot(this, null);
  }
  *m3j($completion) {
  ...
  n3j(cause) {
    if (!(this.f3i_1.kotlinx$atomicfu$value == null))
      return Unit_instance;
    var closedToken = new CloseToken(cause);
    this.f3i_1.atomicfu$compareAndSet(null, closedToken);
    // Inline function 'io.ktor.utils.io.Companion.wrapCause' call
    ...
    if (tmp0_subject == null) {
      ...
      if (isInterface(tmp0_subject, CopyableThrowable)) {
        tmp = access$_get_origin__hdh1qz(closedToken).n2c();
      } else {
        if (tmp0_subject instanceof CancellationException) {
          ...
          tmp = ClosedByteChannelException.b3j(p0);
        }
      }
    }
  ...
  o3j(handler) {
    var existingCause = this.f3i_1.kotlinx$atomicfu$value;
    if (!(existingCause == null)) {
      ...
      if (tmp0_subject == null) {
        ...
        if (isInterface(tmp0_subject, CopyableThrowable)) {
          tmp = access$_get_origin__hdh1qz(existingCause).n2c();
        } else {
          if (tmp0_subject instanceof CancellationException) {
    ...
    if (!this.g3i_1.atomicfu$compareAndSet(null, handler)) {
    ...
    var cause = this.f3i_1.kotlinx$atomicfu$value;
    if (!(cause == null) && this.g3i_1.atomicfu$compareAndSet(handler, null)) {
      // Inline function 'io.ktor.utils.io.Companion.wrapCause' call
      ...
      if (tmp0_subject_0 == null) {
        ...
        if (isInterface(tmp0_subject_0, CopyableThrowable)) {
          tmp_1 = access$_get_origin__hdh1qz(cause).n2c();
        } else {
          if (tmp0_subject_0 instanceof CancellationException) {
            ...
            tmp_1 = ClosedByteChannelException.b3j(p0_0);
          }
        }
      }
      handler(tmp_1);
...
class ConcurrentIOException extends IllegalStateException {
  constructor(taskName, cause) {
    return new.target.i3j(taskName, cause);
  }
  static i3j(taskName, cause) {
    cause = cause === VOID ? null : cause;
    var $this = this.q('Concurrent ' + taskName + ' attempts', cause);
    captureStack($this, $this.h3j_1);
    return $this;
  }
}
class ByteChannelScanner {
  constructor(channel, matchString, writeChannel, limit) {
    ...
    this.p3j_1 = channel;
    this.q3j_1 = matchString;
    this.r3j_1 = writeChannel;
    this.s3j_1 = limit;
    ...
    this.t3j_1 = this.p3j_1.k3i();
    this.u3j_1 = buildPartialMatchTable(this);
    this.v3j_1 = new Buffer();
    this.w3j_1 = 0n;
    this.x3j_1 = 0;
  }
  *y3j(ignoreMissing, $completion) {
    this.w3j_1 = 0n;
    while (!this.t3j_1.z20() || (yield* this.p3j_1.j3j(VOID, $completion))) {
    ...
    if (!ignoreMissing) {
      throw IOException.c24('Expected "' + toSingleLineString(this, this.q3j_1) + '" but encountered end of input');
    }
    this.w3j_1 = add(this.w3j_1, this.v3j_1.c22(this.r3j_1.q3i()));
    yield* this.r3j_1.k3j($completion);
    return this.w3j_1;
  }
}
...
class Companion_0 {
  constructor() {
    ...
    var tmp = this;
    tmp.d3k_1 = new ByteReadChannel$Companion$Empty$1();
  }
}
class WriterJob {
...
class NO_CALLBACK$1 {
  constructor() {
    this.l3k_1 = EmptyCoroutineContext_instance;
  }
  fd() {
    return this.l3k_1;
  }
...
class CountedByteReadChannel {
  ...
  x3i() {
    return this.n3k_1.x3i();
  }
  c3j() {
    return this.o3k_1.z20() && this.n3k_1.c3j();
  }
  k3i() {
  ...
  *d3j(min, $completion) {
    if (this.k3i().k2() >= fromInt(min)) {
      return true;
    }
    if (yield* this.n3k_1.d3j(min, $completion)) {
      transferFromDelegate(this);
      return true;
    }
    return false;
  ...
  n3j(cause) {
    this.n3k_1.n3j(cause);
    this.o3k_1.f7();
  }
}
class ClosedByteChannelException extends IOException {
  constructor(cause) {
    return new.target.b3j(cause);
  }
  static b3j(cause) {
    cause = cause === VOID ? null : cause;
    var $this = this.d24(cause == null ? null : cause.message, cause);
    captureStack($this, $this.a3j_1);
    return $this;
  }
}
class ClosedReadChannelException extends ClosedByteChannelException {
  constructor(cause) {
    return new.target.p3i(cause);
  }
  static p3i(cause) {
    cause = cause === VOID ? null : cause;
    var $this = this.b3j(cause);
...
class ClosedWriteChannelException extends ClosedByteChannelException {
  constructor(cause) {
    return new.target.v3i(cause);
  }
  static v3i(cause) {
    cause = cause === VOID ? null : cause;
    var $this = this.b3j(cause);
    captureStack($this, $this.u3i_1);
    return $this;
  }
}
...
class Companion_2 {
  constructor() {
    ...
    this.s3k_1 = _LineEndingMode___init__impl__jo5bul(1);
    this.t3k_1 = _LineEndingMode___init__impl__jo5bul(2);
    this.u3k_1 = _LineEndingMode___init__impl__jo5bul(4);
    this.v3k_1 = _LineEndingMode___init__impl__jo5bul(7);
    this.w3k_1 = listOf([new LineEndingMode(this.s3k_1), new LineEndingMode(this.t3k_1), new LineEndingMode(this.u3k_1)]);
  }
}
class LineEndingMode {
  ...
  toString() {
    return LineEndingMode__toString_impl_j4h76r(this.x3k_1);
  }
  hashCode() {
    return LineEndingMode__hashCode_impl_2mopm4(this.x3k_1);
  }
  equals(other) {
    return LineEndingMode__equals_impl_qyr4nk(this.x3k_1, other);
  }
}
class SourceByteReadChannel {
  ...
  c3j() {
    return this.y3k_1.z20();
  }
  k3i() {
    var tmp0_safe_receiver = this.x3i();
    if (tmp0_safe_receiver == null)
      null;
    else {
      // Inline function 'kotlin.let' call
  ...
  *d3j(min, $completion) {
    ...
    return this.y3k_1.b21(fromInt(min));
  }
  n3j(cause) {
    if (!(this.z3k_1 == null))
      return Unit_instance;
    ...
    tmp.z3k_1 = new CloseToken(IOException.d24(tmp1_elvis_lhs == null ? 'Channel was cancelled' : tmp1_elvis_lhs, cause));
  }
}
class MalformedInputException extends IOException {
  constructor(message) {
    return new.target.d3l(message);
  }
  static d3l(message) {
    var $this = this.c24(message);
    captureStack($this, $this.c3l_1);
    return $this;
  }
}
class TooLongLineException extends MalformedInputException {
  constructor(message) {
    return new.target.i3k(message);
  }
  static i3k(message) {
    var $this = this.d3l(message);
    captureStack($this, $this.h3k_1);
    return $this;
  }
}
class ObjectPool {}
...
class DefaultPool {
  ...
  t3l() {
    if (this.p3l_1 === 0)
      return this.m3l();
    this.p3l_1 = this.p3l_1 - 1 | 0;
    var idx = this.p3l_1;
    var tmp = this.o3l_1[idx];
    var instance = !(tmp == null) ? tmp : THROW_CCE();
    this.o3l_1[idx] = null;
    return this.r3l(instance);
  }
  u3l(instance) {
    this.s3l(instance);
    if (this.p3l_1 === this.n3l_1) {
      this.q3l(instance);
    } else {
      var _unary__edvuaz = this.p3l_1;
      this.p3l_1 = _unary__edvuaz + 1 | 0;
      this.o3l_1[_unary__edvuaz] = instance;
    }
  }
  i27() {
...
class Companion_3 {
  v3l(name) {
    switch (name) {
      ...
      case 'UTF8':
      case 'utf8':
        return Charsets_getInstance().e3l_1;
    }
    var tmp;
    var tmp_0;
    switch (name) {
    ...
    if (tmp) {
      return Charsets_getInstance().f3l_1;
    }
...
class Charset {
  ...
  equals(other) {
    ...
    if (!(other instanceof Charset))
      THROW_CCE();
    return this.g3l_1 === other.g3l_1;
  }
  hashCode() {
    return getStringHashCode(this.g3l_1);
  }
  toString() {
    return this.g3l_1;
  }
...
class Charsets {
  constructor() {
    ...
    this.e3l_1 = new CharsetImpl('UTF-8');
    this.f3l_1 = new CharsetImpl('ISO-8859-1');
  }
}
...
class CharsetEncoderImpl extends CharsetEncoder {
  ...
  toString() {
    return 'CharsetEncoderImpl(charset=' + this.c3m_1.toString() + ')';
  }
  hashCode() {
    return this.c3m_1.hashCode();
  }
  equals(other) {
    if (this === other)
      return true;
    if (!(other instanceof CharsetEncoderImpl))
      return false;
    if (!this.c3m_1.equals(other.c3m_1))
      return false;
    return true;
  }
}
class CharsetDecoderImpl extends CharsetDecoder {
  ...
  toString() {
    return 'CharsetDecoderImpl(charset=' + this.e3m_1.toString() + ')';
  }
  hashCode() {
...
class toKtor$1 {
  constructor($this_toKtor) {
    this.f3m_1 = $this_toKtor;
  }
  z3l(buffer) {
    return this.f3m_1.decode(buffer);
  }
}
  ...
  z3l(buffer) {
    ...
    if (inductionVariable < last)
      $l$loop: do {
        ...
        if (point > 255) {
          builder.s22(toByte(point >> 8));
        }
        builder.s22(toByte(point & 255));
      }
       while (inductionVariable < last);
...
function closeSlot($this, cause) {
  var closeContinuation = !(cause == null) ? new Closed(cause) : Companion_getInstance().m3h_1;
  var continuation = $this.c3i_1.atomicfu$getAndSet(closeContinuation);
  if (isInterface(continuation, Task)) {
    continuation.t3h(cause);
  }
  var tmp0_safe_receiver = $this.g3i_1.atomicfu$getAndSet(null);
  if (tmp0_safe_receiver == null)
    null;
  else
...
function ByteChannel$invokeOnClose$lambda_1(this$0, $handler) {
  return () => {
    this$0.g3i_1.atomicfu$compareAndSet($handler, null);
    return Unit_instance;
  };
}
function ByteReadChannel_0(content, offset, length) {
  ...
  this_0.i22(content, offset, offset + length | 0);
  var source = this_0;
...
function buildPartialMatchTable($this) {
  var table = new Int32Array($this.q3j_1.k2());
  var j = 0;
  var inductionVariable = 1;
  var last = $this.q3j_1.k2();
  if (inductionVariable < last)
    do {
      var i = inductionVariable;
      inductionVariable = inductionVariable + 1 | 0;
      while (j > 0 && !($this.q3j_1.m2(i) === $this.q3j_1.m2(j))) {
        j = table[j - 1 | 0];
      }
      if ($this.q3j_1.m2(i) === $this.q3j_1.m2(j)) {
        j = j + 1 | 0;
      }
      table[i] = j;
    }
...
function *advanceToNextPotentialMatch($this, $completion) {
  while (!$this.t3j_1.z20() || (yield* $this.p3j_1.j3j(VOID, $completion))) {
    var nextMatch = indexOf($this.t3j_1, $this.q3j_1.m2(0));
    if (nextMatch === -1n) {
      var tmp = $this.t3j_1;
      checkBounds($this, (tmp instanceof Buffer ? tmp : THROW_CCE()).k2());
      $this.w3j_1 = add($this.w3j_1, $this.t3j_1.c22($this.r3j_1.q3i()));
      yield* flushIfNeeded($this.r3j_1, $completion);
    } else {
      checkBounds($this, nextMatch);
      var tmp_0 = $this;
      var tmp_1 = $this.w3j_1;
      var tmp_2 = $this.r3j_1.q3i();
      tmp_0.w3j_1 = add(tmp_1, $this.t3j_1.z21(tmp_2 instanceof Buffer ? tmp_2 : THROW_CCE(), nextMatch));
      yield* flushIfNeeded($this.r3j_1, $completion);
      return Unit_instance;
    }
  }
...
function *checkFullMatch($this, $completion) {
  while (!$this.t3j_1.z20() || (yield* $this.p3j_1.j3j(VOID, $completion))) {
    var byte = $this.t3j_1.c21();
    if ($this.x3j_1 > 0 && !(byte === $this.q3j_1.m2($this.x3j_1))) {
      var oldMatchIndex = $this.x3j_1;
      while ($this.x3j_1 > 0 && !(byte === $this.q3j_1.m2($this.x3j_1))) {
        $this.x3j_1 = $this.u3j_1[$this.x3j_1 - 1 | 0];
      }
      var retained = fromInt(oldMatchIndex - $this.x3j_1 | 0);
      checkBounds($this, retained);
      var tmp = $this;
      var tmp_0 = $this.w3j_1;
      var tmp_1 = $this.r3j_1.q3i();
      tmp.w3j_1 = add(tmp_0, $this.v3j_1.z21(tmp_1 instanceof Buffer ? tmp_1 : THROW_CCE(), retained));
      if ($this.x3j_1 === 0 && !(byte === $this.q3j_1.m2($this.x3j_1))) {
        yield* writeByte($this.r3j_1, byte, $completion);
        var _unary__edvuaz = $this.w3j_1;
        $this.w3j_1 = add(_unary__edvuaz, get_ONE());
        return false;
      }
    }
    $this.x3j_1 = $this.x3j_1 + 1 | 0;
    if ($this.x3j_1 === $this.q3j_1.k2()) {
      return true;
    }
    $this.v3j_1.s22(byte);
  }
...
function checkBounds($this, extra) {
  if (add($this.w3j_1, extra) > $this.s3j_1) {
    throw IOException.c24('Limit of ' + $this.s3j_1.toString() + ' bytes exceeded ' + ('while searching for "' + toSingleLineString($this, $this.q3j_1) + '"'));
  }
}
...
function attachWriterJob(_this__u8e3s4, writerJob) {
  var tmp = writerJob.z3j_1;
  var tmp0_safe_receiver = tmp instanceof ByteChannel ? tmp : null;
  if (tmp0_safe_receiver == null)
    null;
  else {
    tmp0_safe_receiver.o3j(attachWriterJob$lambda(_this__u8e3s4));
  }
}
function attachWriterJob$lambda($this_attachWriterJob) {
  return (cause) => {
    var tmp;
    if (!(cause == null)) {
      $this_attachWriterJob.n3j(cause);
      tmp = Unit_instance;
    }
    return Unit_instance;
  };
...
function cancel_0(_this__u8e3s4) {
  _this__u8e3s4.n3j(IOException.c24('Channel was cancelled'));
}
function *readRemaining(_this__u8e3s4, $completion) {
  var result = BytePacketBuilder();
  while (!_this__u8e3s4.c3j()) {
    result.r22(_this__u8e3s4.k3i());
    yield* _this__u8e3s4.j3j(VOID, $completion);
  }
...
function *copyTo(_this__u8e3s4, channel, limit, $completion) {
  var remaining = limit;
  try {
    while (!_this__u8e3s4.c3j() && remaining > 0n) {
      if (_this__u8e3s4.k3i().z20()) {
        yield* _this__u8e3s4.j3j(VOID, $completion);
      }
      var tmp0 = remaining;
      // Inline function 'kotlin.comparisons.minOf' call
      var b = get_remaining(_this__u8e3s4.k3i());
      var count = tmp0 <= b ? tmp0 : b;
      _this__u8e3s4.k3i().b22(channel.q3i(), count);
      remaining = subtract(remaining, count);
      yield* channel.k3j($completion);
    }
  } catch ($p) {
    if ($p instanceof Error) {
      var cause = $p;
      _this__u8e3s4.n3j(cause);
...
function rethrowCloseCauseIfNeeded(_this__u8e3s4) {
  var tmp0_safe_receiver = _this__u8e3s4.x3i();
  if (tmp0_safe_receiver == null)
    null;
  else {
    // Inline function 'kotlin.let' call
...
function *discard(_this__u8e3s4, max, $completion) {
  ...
  var remaining = max;
  while (remaining > 0n && !_this__u8e3s4.c3j()) {
    ...
    var b = get_remaining(_this__u8e3s4.k3i());
    var count = tmp0 <= b ? tmp0 : b;
    discard_0(_this__u8e3s4.k3i(), count);
    remaining = subtract(remaining, count);
  }
...
function *copyTo_0(_this__u8e3s4, channel, $completion) {
  ...
  try {
    while (!_this__u8e3s4.c3j()) {
      result = add(result, _this__u8e3s4.k3i().c22(channel.q3i()));
      yield* channel.k3j($completion);
      yield* _this__u8e3s4.j3j(VOID, $completion);
    }
  } catch ($p) {
...
function *readAvailable(_this__u8e3s4, buffer, offset, length, $completion) {
  ...
  if (_this__u8e3s4.c3j())
    return -1;
  return readAvailable_0(_this__u8e3s4.k3i(), buffer, offset, length);
}
...
function *readPacket(_this__u8e3s4, packet, $completion) {
  ...
  $l$loop: while (result.k2() < fromInt(packet)) {
    ...
    if (_this__u8e3s4.c3j())
      break $l$loop;
    if (get_remaining(_this__u8e3s4.k3i()) > subtract(numberToLong(packet), result.k2())) {
      _this__u8e3s4.k3i().b22(result, subtract(numberToLong(packet), result.k2()));
    } else {
      _this__u8e3s4.k3i().c22(result);
    }
  }
  if (result.k2() < fromInt(packet)) {
    throw EOFException.x20('Not enough data available, required ' + packet + ' bytes but only ' + result.k2().toString() + ' available');
  }
  return result;
}
function *readUntil(_this__u8e3s4, matchString, writeChannel, limit, ignoreMissing, $completion) {
  ...
  return yield* (new ByteChannelScanner(_this__u8e3s4, matchString, writeChannel, limit)).y3j(ignoreMissing, $completion);
}
...
function get_availableForRead(_this__u8e3s4) {
  return convertToInt(_this__u8e3s4.k3i().y20().k2());
}
function *peek(_this__u8e3s4, count, $completion) {
  if (_this__u8e3s4.c3j())
    return null;
  if (!(yield* _this__u8e3s4.d3j(count, $completion)))
    return null;
  return readByteString(_this__u8e3s4.k3i().d22(), count);
}
function *internalReadLineTo(_this__u8e3s4, out, limit, lenientLineEnding, throwOnIncompleteLine, $completion) {
  var readBuffer = _this__u8e3s4.k3i();
  if (readBuffer.z20()) {
    yield* _this__u8e3s4.j3j(VOID, $completion);
  }
  if (_this__u8e3s4.c3j())
    return -1n;
  var consumed = {_v: 0n};
  $l$loop: while (consumed._v < limit && !_this__u8e3s4.c3j()) {
    ...
    if (lfIndex > 0n) {
      var tmp;
      var tmp_0 = readBuffer.y20();
      // Inline function 'kotlin.Long.minus' call
      var tmp$ret$0 = subtract(lfIndex, fromInt(1));
      if (tmp_0.u21(tmp$ret$0) === 13) {
        tmp = 1n;
      } else {
        tmp = 0n;
      }
    ...
    var tmp_1 = readBuffer.y20();
    // Inline function 'kotlin.Long.minus' call
    var tmp$ret$2 = subtract(count, fromInt(1));
    if (tmp_1.u21(tmp$ret$2) === 13) {
      // Inline function 'kotlin.Long.minus' call
    ...
    if (consumed._v < limit && get_remaining(readBuffer) === 0n && !(yield* _this__u8e3s4.j3j(VOID, $completion)))
      break $l$loop;
  }
  if (consumed._v === 0n && _this__u8e3s4.c3j())
    return -1n;
  // Inline function 'kotlin.check' call
  ...
  if (consumed._v === limit) {
    if (limit === 9223372036854775807n)
      throw TooLongLineException.i3k('Max line length exceeded');
    if (get_remaining(readBuffer) === 0n && !(yield* _this__u8e3s4.j3j(VOID, $completion))) {
      throwEndOfStreamException(consumed._v);
    }
    var tmp0_subject = readBuffer.y20().u21(0n);
    if (tmp0_subject === 10) {
      discard_0(readBuffer, 1n);
      return consumed._v;
...
function throwEndOfStreamException(consumed) {
  throw EOFException.x20('Unexpected end of stream after reading ' + consumed.toString() + ' characters');
}
function throwTooLongLineException(limit) {
  throw TooLongLineException.i3k('Line exceeds limit of ' + limit.toString() + ' characters');
}
...
function *internalReadLineTo$discardCrlfOrCr(_this__u8e3s4, $this_internalReadLineTo, $lenientLineEnding, $completion) {
  if ((get_remaining(_this__u8e3s4) >= 2n || (yield* $this_internalReadLineTo.d3j(2, $completion))) && _this__u8e3s4.y20().u21(1n) === 10) {
...
function *flushIfNeeded(_this__u8e3s4, $completion) {
  ...
  if (_this__u8e3s4.i3i() || get_size(_this__u8e3s4.q3i()) >= 1048576)
...
function ByteWriteChannel$flushAndClose$ref(p0) {
  return constructCallableReference(function *($completion) {
    return yield* p0.m3j($completion);
...
function invokeOnCompletion(_this__u8e3s4, block) {
  _init_properties_ByteWriteChannelOperations_kt__i7slrs();
  return _this__u8e3s4.u27().v25(block);
}
function *writeFully(_this__u8e3s4, value, startIndex, endIndex, $completion) {
  startIndex = startIndex === VOID ? 0 : startIndex;
  endIndex = endIndex === VOID ? value.length : endIndex;
  _this__u8e3s4.q3i().i22(value, startIndex, endIndex);
...
function *writePacket(_this__u8e3s4, source, $completion) {
  while (!source.z20()) {
    _this__u8e3s4.q3i().m22(source, get_remaining(source));
    yield* flushIfNeeded(_this__u8e3s4, $completion);
  }
  return Unit_instance;
}
function writer_0(_this__u8e3s4, coroutineContext, channel, block) {
  ...
  this_0.v25(writer$lambda(channel));
  var job = this_0;
...
function *writeByte(_this__u8e3s4, value, $completion) {
  _this__u8e3s4.q3i().s22(value);
  yield* flushIfNeeded(_this__u8e3s4, $completion);
  return Unit_instance;
}
function writer$slambda($block, $channel) {
  return constructCallableReference(function *($this$launch, $completion) {
    var nested = Job(get_job($this$launch.s24()));
    var tmp;
    try {
      yield* $block(new WriterScope($channel, $this$launch.s24().no(nested)), $completion);
      nested.c2c();
      var tmp_0;
      if (get_job($this$launch.s24()).p25()) {
        $channel.n3j(get_job($this$launch.s24()).s25());
        tmp_0 = Unit_instance;
      }
      tmp = tmp_0;
    } catch ($p) {
      ...
      yield* nested.z25($completion);
      // Inline function 'kotlin.runCatching' call
      var tmp_2;
      try {
        yield* $channel.m3j($completion);
        // Inline function 'kotlin.Companion.success' call
...
function transferFromDelegate($this) {
  updateConsumed($this);
  var appended = $this.o3k_1.r22($this.n3k_1.k3i());
  $this.p3k_1 = add($this.p3k_1, appended);
}
function updateConsumed($this) {
  $this.q3k_1 = add($this.q3k_1, subtract($this.p3k_1, $this.o3k_1.k2()));
  $this.p3k_1 = $this.o3k_1.k2();
}
...
function LineEndingMode__toString_impl_j4h76r($this) {
  var tmp;
  if ($this === Companion_getInstance_2().s3k_1) {
    tmp = 'CR';
  } else if ($this === Companion_getInstance_2().t3k_1) {
    tmp = 'LF';
  } else if ($this === Companion_getInstance_2().u3k_1) {
    tmp = 'CRLF';
  } else {
    // Inline function 'kotlin.collections.filter' call
    var tmp0 = Companion_getInstance_2().w3k_1;
    // Inline function 'kotlin.collections.filterTo' call
    var destination = ArrayList.p2();
    var _iterator__ex2g4s = tmp0.l1();
    while (_iterator__ex2g4s.m1()) {
      var element = _iterator__ex2g4s.n1();
      var it = element.x3k_1;
...
function writeFully_0(_this__u8e3s4, buffer, offset, length) {
  offset = offset === VOID ? 0 : offset;
  length = length === VOID ? buffer.length - offset | 0 : length;
  _this__u8e3s4.i22(buffer, offset, offset + length | 0);
}
function build(_this__u8e3s4) {
  return _this__u8e3s4.y20();
}
function get_size(_this__u8e3s4) {
  return convertToInt(_this__u8e3s4.y20().k2());
}
...
function ByteReadPacket(array, offset, length) {
  ...
  // Inline function 'kotlin.apply' call
  var this_0 = new Buffer();
  this_0.i22(array, offset, offset + length | 0);
  return this_0;
}
function get_remaining(_this__u8e3s4) {
  _init_properties_ByteReadPacket_kt__28475y();
  return _this__u8e3s4.y20().k2();
}
function discard_0(_this__u8e3s4, count) {
  count = count === VOID ? 9223372036854775807n : count;
  _init_properties_ByteReadPacket_kt__28475y();
  _this__u8e3s4.b21(count);
  // Inline function 'kotlin.comparisons.minOf' call
  var b = get_remaining(_this__u8e3s4);
  var countToDiscard = count <= b ? count : b;
  _this__u8e3s4.y20().w21(countToDiscard);
  return countToDiscard;
}
function takeWhile(_this__u8e3s4, block) {
  _init_properties_ByteReadPacket_kt__28475y();
  while (!_this__u8e3s4.z20() && block(_this__u8e3s4.y20())) {
  }
}
...
function readAvailable_0(_this__u8e3s4, buffer, offset, length) {
  offset = offset === VOID ? 0 : offset;
  length = length === VOID ? buffer.length - offset | 0 : length;
  var result = _this__u8e3s4.x21(buffer, offset, offset + length | 0);
  return result === -1 ? 0 : result;
}
function toByteArray_0(_this__u8e3s4, charset) {
  charset = charset === VOID ? Charsets_getInstance().e3l_1 : charset;
  if (charset.equals(Charsets_getInstance().e3l_1))
    return encodeToByteArray(_this__u8e3s4, VOID, VOID, true);
  return encodeToByteArray_0(charset.h3l(), _this__u8e3s4, 0, _this__u8e3s4.length);
}
function readText_0(_this__u8e3s4, charset, max) {
  ...
  if (charset.equals(Charsets_getInstance().e3l_1)) {
    if (max === 2147483647)
      return readString_0(_this__u8e3s4);
    var tmp0 = _this__u8e3s4.y20().k2();
    // Inline function 'kotlin.math.min' call
    var b = fromInt(max);
    var count = tmp0 <= b ? tmp0 : b;
    return readString(_this__u8e3s4, count);
  }
  return decode(charset.i3l(), _this__u8e3s4, max);
}
function writeText(_this__u8e3s4, text, fromIndex, toIndex, charset) {
  fromIndex = fromIndex === VOID ? 0 : fromIndex;
  toIndex = toIndex === VOID ? charSequenceLength(text) : toIndex;
  charset = charset === VOID ? Charsets_getInstance().e3l_1 : charset;
  if (charset === Charsets_getInstance().e3l_1) {
    return writeString(_this__u8e3s4, toString_1(text), fromIndex, toIndex);
  }
  encodeToImpl(charset.h3l(), _this__u8e3s4, text, fromIndex, toIndex);
}
...
function isSupported(_this__u8e3s4, name) {
  return Companion_instance_4.w3l(name);
}
function forName(_this__u8e3s4, name) {
  return Companion_instance_4.v3l(name);
}
function decode_0(_this__u8e3s4, input, dst, max) {
  var decoder = Decoder(get_name(get_charset(_this__u8e3s4)), true);
  var tmp0 = input.y20().k2();
  // Inline function 'kotlin.comparisons.minOf' call
  var b = fromInt(max);
  var count = tmp0 <= b ? tmp0 : b;
  ...
  try {
    ...
    // Inline function 'kotlin.js.asDynamic' call
    tmp = decoder.z3l(array);
  } catch ($p) {
    var tmp_0;
    if ($p instanceof Error) {
      var cause = $p;
      var tmp0_elvis_lhs = cause.message;
      throw MalformedInputException.d3l('Failed to decode bytes: ' + (tmp0_elvis_lhs == null ? 'no cause provided' : tmp0_elvis_lhs));
    } else {
      throw $p;
    }
  }
...
function encodeImpl(_this__u8e3s4, input, fromIndex, toIndex, dst) {
  ...
  if (get_charset_0(_this__u8e3s4).equals(Charsets_getInstance().f3l_1)) {
    return encodeISO88591(input, fromIndex, toIndex, dst);
  }
  // Inline function 'kotlin.require' call
  if (!(get_charset_0(_this__u8e3s4) === Charsets_getInstance().e3l_1)) {
...
function ioDispatcher() {
  return Dispatchers_getInstance().l2g_1;
}
function encodeISO88591(input, fromIndex, toIndex, dst) {
  ...
  if (inductionVariable < toIndex)
    do {
      ...
      dst.s22(toByte(character));
    }
     while (inductionVariable < toIndex);
  return toIndex - fromIndex | 0;
}
function failedToMapError(ch) {
  throw MalformedInputException.d3l('The character with unicode point ' + ch + " couldn't be mapped to ISO-8859-1 character");
}
...
protoOf(Read).s3h = resume;
protoOf(Read).t3h = resume_0;
initMetadataForClass(Read, 'Read', VOID, VOID, [Task]);
protoOf(Write).s3h = resume;
protoOf(Write).t3h = resume_0;
...
protoOf(ByteChannel).j3j = awaitContent$default;
...
protoOf(ByteReadChannel$Companion$Empty$1).j3j = awaitContent$default;
...
protoOf(CountedByteReadChannel).j3j = awaitContent$default;
initMetadataForClass(CountedByteReadChannel, 'CountedByteReadChannel', VOID, VOID, [ByteReadChannel], [1]);
initMetadataForClass(ClosedByteChannelException, 'ClosedByteChannelException', ClosedByteChannelException.b3j);
initMetadataForClass(ClosedReadChannelException, 'ClosedReadChannelException', ClosedReadChannelException.p3i);
initMetadataForClass(ClosedWriteChannelException, 'ClosedWriteChannelException', ClosedWriteChannelException.v3i);
initMetadataForClass(LineEnding, 'LineEnding');
initMetadataForCompanion(Companion_2);
initMetadataForClass(LineEndingMode, 'LineEndingMode');
protoOf(SourceByteReadChannel).j3j = awaitContent$default;
