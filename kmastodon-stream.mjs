...
class StreamClient {
  constructor(uri) {
    this.pcn_1 = uri;
    this.qcn_1 = new WebsocketRequest();
    this.rcn_1 = false;
    this.scn_1 = null;
    this.tcn_1 = null;
    this.ucn_1 = null;
    this.vcn_1 = null;
    this.qcn_1.l56(this.pcn_1);
    var tmp = this.qcn_1;
    tmp.c56_1 = StreamClient$slambda(this);
    var tmp_0 = this.qcn_1;
    tmp_0.e56_1 = StreamClient$lambda(this);
    var tmp_1 = this.qcn_1;
    tmp_1.f56_1 = StreamClient$lambda_0(this);
  }
  *p37($completion) {
    yield* this.qcn_1.m56($completion);
...
class StreamResourceImpl {
  constructor(uri, accessToken) {
    this.wcn_1 = uri;
    this.xcn_1 = accessToken;
  }
  ycn() {
    return new UserStreamImpl(this.wcn_1, mapOf([to('access_token', accessToken(this)), to('stream', Companion_instance_2.zcn())]));
  }
  aco(type) {
    return new PublicStreamImpl(this.wcn_1, mapOf([to('access_token', accessToken(this)), to('stream', Companion_instance_1.bco(type))]));
  }
  cco() {
    return new DirectStreamImpl(this.wcn_1, mapOf([to('access_token', accessToken(this)), to('stream', Companion_instance_0.zcn())]));
  }
}
class Companion {
  constructor() {
    ...
    tmp.dco_1 = [null, null, lazy(tmp_0, StreamResponse$Companion$$childSerializers$_anonymous__eplt4n)];
  }
}
class $serializer {
  constructor() {
    ...
    tmp0_serialDesc.q1b('event', true);
    tmp0_serialDesc.q1b('payload', true);
    tmp0_serialDesc.q1b('stream', true);
    this.eco_1 = tmp0_serialDesc;
  }
  fco(encoder, value) {
    var tmp0_desc = this.eco_1;
    var tmp1_output = encoder.y13(tmp0_desc);
    var tmp2_cached = Companion_getInstance().dco_1;
    if (tmp1_output.u15(tmp0_desc, 0) ? true : !(value.gco_1 == null)) {
      tmp1_output.q15(tmp0_desc, 0, StringSerializer_getInstance(), value.gco_1);
    }
    if (tmp1_output.u15(tmp0_desc, 1) ? true : !(value.hco_1 == null)) {
      tmp1_output.q15(tmp0_desc, 1, StringSerializer_getInstance(), value.hco_1);
    }
    if (tmp1_output.u15(tmp0_desc, 2) ? true : !(value.ico_1 == null)) {
      tmp1_output.q15(tmp0_desc, 2, tmp2_cached[2].d3(), value.ico_1);
    }
    tmp1_output.z13(tmp0_desc);
  }
  tz(encoder, value) {
    return this.fco(encoder, value instanceof StreamResponse ? value : THROW_CCE());
  }
  uz(decoder) {
    var tmp0_desc = this.eco_1;
    var tmp1_flag = true;
    ...
    var tmp8_cached = Companion_getInstance().dco_1;
    if (tmp7_input.n14()) {
    ...
    return StreamResponse.jco(tmp3_bitMask0, tmp4_local0, tmp5_local1, tmp6_local2, null);
  }
  gz() {
    return this.eco_1;
  }
  g1c() {
    var tmp0_cached = Companion_getInstance().dco_1;
    // Inline function 'kotlin.arrayOf' call
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
...
class StreamResponse {
  ...
  static jco(seen0, event, payload, stream, serializationConstructorMarker) {
    Companion_getInstance();
    if (!(0 === (0 & seen0))) {
      throwMissingFieldException(seen0, 0, $serializer_getInstance().eco_1);
    }
...
class BaseStreamImpl {
  ...
  *nco($completion) {
    ...
    var streamUrl = (yield* instanceV1$virtualSuspendBridge(MastodonFactory_instance.instance(this.kco_1).instances(), $completion)).data.urls.streamingApi + '/api/v1/streaming?' + queryString;
...
class DirectStreamImpl extends BaseStreamImpl {
  ...
  uco(listener, lifeCycle) {
    // Inline function 'kotlin.also' call
    this.sco_1 = listener;
    this.tco_1 = lifeCycle;
    return this;
  }
  *p37($completion) {
    var tmp0 = this.sco_1;
    ...
    var client = yield* this.nco($completion);
    var tmp = client;
    tmp.scn_1 = DirectStreamImpl$open$lambda(listener);
    var tmp_0 = client;
    tmp_0.tcn_1 = LifeCycleListener$onConnect$ref(lifeCycle);
    var tmp_1 = client;
    tmp_1.ucn_1 = LifeCycleListener$onDisconnect$ref(lifeCycle);
    var tmp_2 = client;
    tmp_2.vcn_1 = LifeCycleListener$onError$ref(lifeCycle);
    yield* client.p37($completion);
    return Unit_instance;
  }
  f7() {
    var tmp0_safe_receiver = this.mco_1;
  ...
  vco() {
    var tmp0_safe_receiver = this.mco_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.rcn_1;
...
class PublicStreamImpl extends BaseStreamImpl {
  ...
  *p37($completion) {
    ...
    var client = yield* this.nco($completion);
    var tmp = client;
    tmp.scn_1 = PublicStreamImpl$open$lambda(listener);
    var tmp_0 = client;
    tmp_0.tcn_1 = LifeCycleListener$onConnect$ref(lifeCycle);
    var tmp_1 = client;
    tmp_1.ucn_1 = LifeCycleListener$onDisconnect$ref(lifeCycle);
...
class UserStreamImpl extends BaseStreamImpl {
  ...
  hcp(listener, lifeCycle) {
    // Inline function 'kotlin.also' call
    this.fcp_1 = listener;
    this.gcp_1 = lifeCycle;
    return this;
  }
  *p37($completion) {
    var tmp0 = this.fcp_1;
    ...
    var client = yield* this.nco($completion);
    var tmp = client;
    tmp.scn_1 = UserStreamImpl$open$lambda(listener);
    var tmp_0 = client;
    tmp_0.tcn_1 = LifeCycleListener$onConnect$ref(lifeCycle);
    var tmp_1 = client;
    tmp_1.ucn_1 = LifeCycleListener$onDisconnect$ref(lifeCycle);
...
function onMessage($this, message) {
  var tmp0_safe_receiver = $this.scn_1;
  if (tmp0_safe_receiver == null)
    null;
  else {
    ...
    var this_0 = InternalUtility_getInstance().gck_1;
    ...
    tmp0_safe_receiver(this_0.s10(tmp$ret$4, message));
  }
}
...
function StreamClient$lambda(this$0) {
  return (it) => {
    this$0.rcn_1 = true;
    var tmp0_safe_receiver = this$0.tcn_1;
    if (tmp0_safe_receiver == null)
      null;
    else
      tmp0_safe_receiver();
...
function StreamClient$lambda_0(this$0) {
  return (it) => {
    this$0.rcn_1 = false;
    var tmp0_safe_receiver = this$0.ucn_1;
    if (tmp0_safe_receiver == null)
      null;
    else
      tmp0_safe_receiver();
...
function DirectStreamImpl$open$lambda($listener) {
  return (it) => {
    var tmp;
    if (it.gco_1 === 'update' && !(it.hco_1 == null)) {
      var tmp0 = InternalUtility_getInstance();
      // Inline function 'work.socialhub.kmastodon.internal.InternalUtility.fromJson' call
      var obj = ensureNotNull(it.hco_1);
      // Inline function 'kotlinx.serialization.json.Json.decodeFromString' call
      var this_0 = tmp0.gck_1;
      // Inline function 'kotlinx.serialization.serializer' call
      var this_1 = this_0.rz();
      // Inline function 'kotlinx.serialization.internal.cast' call
      ...
      // Inline function 'kotlin.let' call
      var this_3 = this_0.s10(tmp$ret$2, obj);
      $listener.oco(this_3);
      tmp = Unit_instance;
    }
    return Unit_instance;
...
function UserStreamImpl$open$lambda($listener) {
  return (it) => {
    ...
    var tmp_0;
    if (it.gco_1 === 'notification') {
      var tmp0_0 = InternalUtility_getInstance();
      // Inline function 'work.socialhub.kmastodon.internal.InternalUtility.fromJson' call
      var obj_0 = ensureNotNull(it.hco_1);
      // Inline function 'kotlinx.serialization.json.Json.decodeFromString' call
      var this_4 = tmp0_0.gck_1;
      // Inline function 'kotlinx.serialization.serializer' call
      var this_5 = this_4.rz();
      // Inline function 'kotlinx.serialization.internal.cast' call
      ...
      // Inline function 'kotlin.let' call
      var this_7 = this_4.s10(tmp$ret$8, obj_0);
      $listener.bcp(this_7);
      tmp_0 = Unit_instance;
    }
    return Unit_instance;
