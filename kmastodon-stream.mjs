...
class StreamClient {
  constructor(uri) {
    this.ich_1 = uri;
    this.jch_1 = new WebsocketRequest();
    this.kch_1 = false;
    this.lch_1 = null;
    this.mch_1 = null;
    this.nch_1 = null;
    this.och_1 = null;
    this.jch_1.b56(this.ich_1);
    var tmp = this.jch_1;
    tmp.s55_1 = StreamClient$slambda(this);
    var tmp_0 = this.jch_1;
    tmp_0.u55_1 = StreamClient$lambda(this);
    var tmp_1 = this.jch_1;
    tmp_1.v55_1 = StreamClient$lambda_0(this);
  }
  *g37($completion) {
    yield* this.jch_1.c56($completion);
...
class StreamResourceImpl {
  constructor(uri, accessToken) {
    this.pch_1 = uri;
    this.qch_1 = accessToken;
  }
  rch() {
    return new UserStreamImpl(this.pch_1, mapOf([to('access_token', accessToken(this)), to('stream', Companion_instance_2.sch())]));
  }
  tch(type) {
    return new PublicStreamImpl(this.pch_1, mapOf([to('access_token', accessToken(this)), to('stream', Companion_instance_1.uch(type))]));
  }
  vch() {
    return new DirectStreamImpl(this.pch_1, mapOf([to('access_token', accessToken(this)), to('stream', Companion_instance_0.sch())]));
  }
}
class Companion {
  constructor() {
    ...
    tmp.wch_1 = [null, null, lazy(tmp_0, StreamResponse$Companion$$childSerializers$_anonymous__eplt4n)];
  }
}
class $serializer {
  constructor() {
    ...
    tmp0_serialDesc.n1b('event', true);
    tmp0_serialDesc.n1b('payload', true);
    tmp0_serialDesc.n1b('stream', true);
    this.xch_1 = tmp0_serialDesc;
  }
  ych(encoder, value) {
    var tmp0_desc = this.xch_1;
    var tmp1_output = encoder.v13(tmp0_desc);
    var tmp2_cached = Companion_getInstance().wch_1;
    if (tmp1_output.r15(tmp0_desc, 0) ? true : !(value.zch_1 == null)) {
      tmp1_output.n15(tmp0_desc, 0, StringSerializer_getInstance(), value.zch_1);
    }
    if (tmp1_output.r15(tmp0_desc, 1) ? true : !(value.aci_1 == null)) {
      tmp1_output.n15(tmp0_desc, 1, StringSerializer_getInstance(), value.aci_1);
    }
    if (tmp1_output.r15(tmp0_desc, 2) ? true : !(value.bci_1 == null)) {
      tmp1_output.n15(tmp0_desc, 2, tmp2_cached[2].d3(), value.bci_1);
    }
    tmp1_output.w13(tmp0_desc);
  }
  qz(encoder, value) {
    return this.ych(encoder, value instanceof StreamResponse ? value : THROW_CCE());
  }
  rz(decoder) {
    var tmp0_desc = this.xch_1;
    var tmp1_flag = true;
    ...
    var tmp8_cached = Companion_getInstance().wch_1;
    if (tmp7_input.k14()) {
    ...
    return StreamResponse.cci(tmp3_bitMask0, tmp4_local0, tmp5_local1, tmp6_local2, null);
  }
  dz() {
    return this.xch_1;
  }
  d1c() {
    var tmp0_cached = Companion_getInstance().wch_1;
    // Inline function 'kotlin.arrayOf' call
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
...
class StreamResponse {
  ...
  static cci(seen0, event, payload, stream, serializationConstructorMarker) {
    Companion_getInstance();
    if (!(0 === (0 & seen0))) {
      throwMissingFieldException(seen0, 0, $serializer_getInstance().xch_1);
    }
...
class BaseStreamImpl {
  ...
  *gci($completion) {
    ...
    var streamUrl = (yield* instanceV1$virtualSuspendBridge(MastodonFactory_instance.instance(this.dci_1).instances(), $completion)).data.urls.streamingApi + '/api/v1/streaming?' + queryString;
...
class DirectStreamImpl extends BaseStreamImpl {
  ...
  nci(listener, lifeCycle) {
    // Inline function 'kotlin.also' call
    this.lci_1 = listener;
    this.mci_1 = lifeCycle;
    return this;
  }
  *g37($completion) {
    var tmp0 = this.lci_1;
    ...
    var client = yield* this.gci($completion);
    var tmp = client;
    tmp.lch_1 = DirectStreamImpl$open$lambda(listener);
    var tmp_0 = client;
    tmp_0.mch_1 = LifeCycleListener$onConnect$ref(lifeCycle);
    var tmp_1 = client;
    tmp_1.nch_1 = LifeCycleListener$onDisconnect$ref(lifeCycle);
    var tmp_2 = client;
    tmp_2.och_1 = LifeCycleListener$onError$ref(lifeCycle);
    yield* client.g37($completion);
    return Unit_instance;
  }
  f7() {
    var tmp0_safe_receiver = this.fci_1;
  ...
  oci() {
    var tmp0_safe_receiver = this.fci_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.kch_1;
...
class PublicStreamImpl extends BaseStreamImpl {
  ...
  *g37($completion) {
    ...
    var client = yield* this.gci($completion);
    var tmp = client;
    tmp.lch_1 = PublicStreamImpl$open$lambda(listener);
    var tmp_0 = client;
    tmp_0.mch_1 = LifeCycleListener$onConnect$ref(lifeCycle);
    var tmp_1 = client;
    tmp_1.nch_1 = LifeCycleListener$onDisconnect$ref(lifeCycle);
...
class UserStreamImpl extends BaseStreamImpl {
  ...
  acj(listener, lifeCycle) {
    // Inline function 'kotlin.also' call
    this.yci_1 = listener;
    this.zci_1 = lifeCycle;
    return this;
  }
  *g37($completion) {
    var tmp0 = this.yci_1;
    ...
    var client = yield* this.gci($completion);
    var tmp = client;
    tmp.lch_1 = UserStreamImpl$open$lambda(listener);
    var tmp_0 = client;
    tmp_0.mch_1 = LifeCycleListener$onConnect$ref(lifeCycle);
    var tmp_1 = client;
    tmp_1.nch_1 = LifeCycleListener$onDisconnect$ref(lifeCycle);
...
function onMessage($this, message) {
  var tmp0_safe_receiver = $this.lch_1;
  if (tmp0_safe_receiver == null)
    null;
  else {
    ...
    var this_0 = InternalUtility_getInstance().zcd_1;
    ...
    tmp0_safe_receiver(this_0.p10(tmp$ret$4, message));
  }
}
...
function StreamClient$lambda(this$0) {
  return (it) => {
    this$0.kch_1 = true;
    var tmp0_safe_receiver = this$0.mch_1;
    if (tmp0_safe_receiver == null)
      null;
    else
      tmp0_safe_receiver();
...
function StreamClient$lambda_0(this$0) {
  return (it) => {
    this$0.kch_1 = false;
    var tmp0_safe_receiver = this$0.nch_1;
    if (tmp0_safe_receiver == null)
      null;
    else
      tmp0_safe_receiver();
...
function DirectStreamImpl$open$lambda($listener) {
  return (it) => {
    var tmp;
    if (it.zch_1 === 'update' && !(it.aci_1 == null)) {
      var tmp0 = InternalUtility_getInstance();
      // Inline function 'work.socialhub.kmastodon.internal.InternalUtility.fromJson' call
      var obj = ensureNotNull(it.aci_1);
      // Inline function 'kotlinx.serialization.json.Json.decodeFromString' call
      var this_0 = tmp0.zcd_1;
      // Inline function 'kotlinx.serialization.serializer' call
      var this_1 = this_0.oz();
      // Inline function 'kotlinx.serialization.internal.cast' call
      ...
      // Inline function 'kotlin.let' call
      var this_3 = this_0.p10(tmp$ret$2, obj);
      $listener.hci(this_3);
      tmp = Unit_instance;
    }
    return Unit_instance;
...
function UserStreamImpl$open$lambda($listener) {
  return (it) => {
    ...
    var tmp_0;
    if (it.zch_1 === 'notification') {
      var tmp0_0 = InternalUtility_getInstance();
      // Inline function 'work.socialhub.kmastodon.internal.InternalUtility.fromJson' call
      var obj_0 = ensureNotNull(it.aci_1);
      // Inline function 'kotlinx.serialization.json.Json.decodeFromString' call
      var this_4 = tmp0_0.zcd_1;
      // Inline function 'kotlinx.serialization.serializer' call
      var this_5 = this_4.oz();
      // Inline function 'kotlinx.serialization.internal.cast' call
      ...
      // Inline function 'kotlin.let' call
      var this_7 = this_4.p10(tmp$ret$8, obj_0);
      $listener.uci(this_7);
      tmp_0 = Unit_instance;
    }
    return Unit_instance;
