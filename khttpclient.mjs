...
class HttpParameter {
  ...
  f54() {
    switch (this.e54()) {
      case 'txt':
        return Text_getInstance().w3z_1;
      case 'html':
        return Text_getInstance().z3z_1;
      case 'css':
        return Text_getInstance().x3z_1;
      case 'csv':
        return Text_getInstance().y3z_1;
      case 'jpg':
      case 'jpeg':
        return Image_getInstance().e3z_1;
      case 'png':
        return Image_getInstance().g3z_1;
      case 'gif':
        return Image_getInstance().b3z_1;
      case 'svg':
        return Image_getInstance().h3z_1;
      case 'mpeg':
        return Video_getInstance().g40_1;
      case 'mp4':
        return Video_getInstance().h40_1;
      case 'mov':
        return Video_getInstance().j40_1;
      case 'webm':
        return ContentType.t3x('video', 'webm');
      case 'json':
        return Application_getInstance().b3y_1;
      case 'xml':
        return Application_getInstance().h3y_1;
      case 'zip':
        return Application_getInstance().k3y_1;
      case 'pdf':
        return Application_getInstance().n3y_1;
    }
...
class HttpRequest {
  constructor() {
    ...
    this.k54_1 = null;
    this.l54_1 = null;
    this.m54_1 = 'kHttpClient/1.0';
    var tmp = this;
    // Inline function 'kotlin.collections.mutableListOf' call
    tmp.n54_1 = ArrayList.j2();
    var tmp_0 = this;
    // Inline function 'kotlin.collections.mutableMapOf' call
    tmp_0.o54_1 = LinkedHashMap.r5();
    this.p54_1 = false;
    this.q54_1 = false;
    this.r54_1 = true;
    this.s54_1 = false;
  ...
  b55(key, value) {
    ...
    this.o54_1.o4(key, value);
    return this;
  }
  c55(forceMultipartFormData) {
    // Inline function 'kotlin.also' call
    this.p54_1 = forceMultipartFormData;
    return this;
  }
  d55(forceApplicationFormUrlEncoded) {
    // Inline function 'kotlin.also' call
    this.q54_1 = forceApplicationFormUrlEncoded;
    return this;
  }
  e55(followRedirect) {
    // Inline function 'kotlin.also' call
    this.r54_1 = followRedirect;
    return this;
  }
  f55(skipSSLValidation) {
    // Inline function 'kotlin.also' call
    this.s54_1 = skipSSLValidation;
    return this;
  }
  g55(key, value) {
    // Inline function 'kotlin.also' call
    this.n54_1.i2(Companion_instance.v53(key, toString(value)));
    return this;
  }
  h55(queries) {
    // Inline function 'kotlin.also' call
  ...
  i55(key, value) {
    // Inline function 'kotlin.also' call
    this.n54_1.i2(Companion_instance.w53(key, toString(value)));
    return this;
  }
  j55(params) {
    // Inline function 'kotlin.also' call
  ...
  x53(key, fileName, fileBody) {
    // Inline function 'kotlin.also' call
    this.n54_1.i2(Companion_instance.x53(key, fileName, fileBody));
    return this;
  }
  y53(json) {
    // Inline function 'kotlin.also' call
    this.n54_1.i2(Companion_instance.y53(json));
    return this;
  }
  *k55($completion) {
    return yield* /*#__NOINLINE__*/proceed(this, Companion_getInstance_1().p45_1, $completion);
  }
  *l55($completion) {
    return yield* /*#__NOINLINE__*/proceed(this, Companion_getInstance_1().q45_1, $completion);
  }
  *m55($completion) {
    return yield* /*#__NOINLINE__*/proceed(this, Companion_getInstance_1().r45_1, $completion);
  }
  *n55($completion) {
    return yield* /*#__NOINLINE__*/proceed(this, Companion_getInstance_1().t45_1, $completion);
  }
  *o55($completion) {
    return yield* /*#__NOINLINE__*/proceed(this, Companion_getInstance_1().s45_1, $completion);
  }
}
class Companion_0 {
  constructor() {
    ...
    var tmp = this;
    tmp.w54_1 = Json(VOID, HttpResponse$Companion$mapper$lambda);
  }
  *x54(response, $completion) {
    ...
    var tmp_5 = yield* tmp_1.n4n(tmp$ret$1, $completion);
...
class HttpResponse {
  constructor(status, headers, body) {
    ...
    this.r55_1 = body;
    var tmp = this;
    tmp.s55_1 = lazy(HttpResponse$stringBody$delegate$lambda(this));
  }
  t55() {
    var tmp0 = this.s55_1;
    var tmp = KProperty1;
...
class WebsocketRequest {
  constructor() {
    ...
    this.y55_1 = null;
    this.z55_1 = null;
    this.a56_1 = 'kHttpClient/1.0';
    var tmp = this;
    // Inline function 'kotlin.collections.mutableMapOf' call
    tmp.b56_1 = LinkedHashMap.r5();
    var tmp_0 = this;
    tmp_0.c56_1 = WebsocketRequest$textListener$slambda();
    var tmp_1 = this;
    tmp_1.d56_1 = WebsocketRequest$bytesListener$slambda();
    var tmp_2 = this;
    tmp_2.e56_1 = WebsocketRequest$onOpenListener$lambda;
    var tmp_3 = this;
    tmp_3.f56_1 = WebsocketRequest$onCloseListener$lambda;
    var tmp_4 = this;
    tmp_4.g56_1 = WebsocketRequest$onErrorListener$lambda;
    this.h56_1 = null;
    this.i56_1 = CompletableDeferred();
    this.j56_1 = false;
    this.k56_1 = CoroutineScope(Dispatchers_getInstance().k2h_1.mp(SupervisorJob()));
  }
  l56(url) {
    // Inline function 'kotlin.also' call
    this.y55_1 = url;
  ...
  *m56($completion) {
  ...
  f7() {
    ...
    var tmp0_safe_receiver = this.h56_1;
  ...
  $l$block_0: {
    ...
    try {
      ...
      if (tmp0_safe_receiver == null)
        ...
        // Inline function 'kotlin.collections.set' call
        $this.o54_1.o4('Accept', tmp0_safe_receiver);
      }
      var tmp1_safe_receiver = $this.m54_1;
      if (tmp1_safe_receiver == null)
        null;
      else {
        // Inline function 'kotlin.let' call
        var tmp0_0 = $this.o54_1;
        // Inline function 'kotlin.collections.set' call
        var key = 'User-Agent';
      ...
      if (!(req.k54_1 == null)) {
        ...
        takeFrom(this_0.r4m_1, URLBuilder(tmp_0));
      } else {
        url(this_0, req.g54_1, req.h54_1, req.j54_1, req.i54_1);
      }
      headers(this_0, HttpRequest$proceed$lambda_0(req));
      timeout(this_0, HttpRequest$proceed$lambda_1(req));
      if (!$this.p54_1 && !$this.q54_1 && req.n54_1.l2() === 1 && canSendOnly($this, first(req.n54_1))) {
        var param = first(req.n54_1);
        // Inline function 'io.ktor.client.request.setBody' call
        var body = new ByteArrayContent(ensureNotNull(param.d54_1), param.f54());
        if (body == null) {
          this_0.u4m_1 = NullBody_instance;
          // Inline function 'io.ktor.util.reflect.typeInfo' call
          ...
          if (body instanceof OutgoingContent) {
            ...
            this_0.l4q(tmp$ret$17);
          }
        }
      } else {
        if (method.equals(Companion_getInstance_1().p45_1)) {
          // Inline function 'kotlin.collections.forEach' call
          var _iterator__ex2g4s = req.n54_1.l1();
          while (_iterator__ex2g4s.m1()) {
            var element = _iterator__ex2g4s.n1();
            if (element.z53_1.s1_1 === 0) {
              this_0.r4m_1.b49_1.r3s(element.a54_1, ensureNotNull(element.b54_1));
            } else {
          ...
          while (_iterator__ex2g4s_1.m1()) {
            ...
            if (element_1.z53_1.equals(Type_PARAM_getInstance())) {
              destination_0.i2(element_1);
            }
          }
          var params = destination_0;
          // Inline function 'kotlin.collections.filter' call
          var tmp0_4 = req.n54_1;
          // Inline function 'kotlin.collections.filterTo' call
          ...
          while (_iterator__ex2g4s_2.m1()) {
            ...
            if (element_2.z53_1.equals(Type_FILE_getInstance())) {
          ...
          if (!queries.j1()) {
            ...
            while (_iterator__ex2g4s_3.m1()) {
              ...
              this_0.r4m_1.b49_1.r3s(element_3.a54_1, ensureNotNull(element_3.b54_1));
            }
          }
          var tmp_7;
          // Inline function 'kotlin.collections.isNotEmpty' call
          ...
          if (tmp_7) {
            if ($this.q54_1) {
              ...
              contentType(this_0, Application_getInstance().m3y_1);
              ...
              while (_iterator__ex2g4s_4.m1()) {
                ...
                this_1.r3s(element_4.a54_1, ensureNotNull(element_4.b54_1));
              }
              var tmp$ret$36 = this_1.s40();
              // Inline function 'io.ktor.client.request.setBody' call
              ...
              if (body_0 == null) {
                ...
                if (body_0 instanceof OutgoingContent) {
                  ...
                  this_0.l4q(tmp$ret$44);
                }
              }
            } else {
              contentType(this_0, MultiPart_getInstance().q3z_1);
              ...
              while (_iterator__ex2g4s_5.m1()) {
                ...
                this_2.y50(element_5.a54_1, ensureNotNull(element_5.b54_1));
              }
              // Inline function 'kotlin.collections.forEach' call
              var _iterator__ex2g4s_6 = files.l1();
              while (_iterator__ex2g4s_6.m1()) {
                var element_6 = _iterator__ex2g4s_6.n1();
                var tmp_14 = ensureNotNull(element_6.d54_1);
                // Inline function 'io.ktor.http.Companion.build' call
                Companion_getInstance();
                // Inline function 'kotlin.apply' call
                var this_3 = new HeadersBuilder();
                append(this_3, 'Content-Type', element_6.f54());
                this_3.r3s('Content-Disposition', 'filename=' + element_6.c54_1);
                var tmp$ret$53 = this_3.s40();
                this_2.z50(element_6.a54_1, tmp_14, tmp$ret$53);
              }
              // Inline function 'kotlin.collections.toTypedArray' call
              var this_4 = this_2.a51();
      ...
      // Inline function 'io.ktor.client.request.request' call
      var tmp$ret$8 = yield* (new HttpStatement(this_0, tmp0)).i52($completion);
      tmp$ret$0 = yield* tmp.x54(tmp$ret$8, $completion);
      break $l$block_0;
    } catch ($p_5) {
...
function canSendOnly($this, param) {
  if (param.z53_1.equals(Type_JSON_getInstance()))
    return true;
  var tmp0_subject = param.f54();
  return tmp0_subject.equals(Application_getInstance().b3y_1) ? true : tmp0_subject.equals(Image_getInstance().e3z_1) ? true : tmp0_subject.equals(Image_getInstance().g3z_1) ? true : tmp0_subject.equals(Image_getInstance().b3z_1) ? true : tmp0_subject.equals(Video_getInstance().g40_1) ? true : tmp0_subject.equals(Video_getInstance().h40_1) ? true : tmp0_subject.equals(Video_getInstance().j40_1) ? true : tmp0_subject.equals(ContentType.t3x('video', 'webm')) ? true : false;
}
function HttpRequest$proceed$lambda($req) {
  return ($this$HttpClient) => {
    ...
    $this$HttpClient.d4m_1 = $req.r54_1;
    return Unit_instance;
  };
}
function HttpRequest$proceed$lambda_0($req) {
  return ($this$headers) => {
    // Inline function 'kotlin.collections.forEach' call
    // Inline function 'kotlin.collections.iterator' call
    var _iterator__ex2g4s = $req.o54_1.b3().l1();
    while (_iterator__ex2g4s.m1()) {
      var element = _iterator__ex2g4s.n1();
      // Inline function 'kotlin.collections.component1' call
      var k = element.c3();
...
function HttpRequest$proceed$lambda_1($req) {
  return ($this$timeout) => {
    $this$timeout.g4w($req.t54_1);
    $this$timeout.h4w($req.u54_1);
    $this$timeout.i4w($req.v54_1);
    return Unit_instance;
  };
}
...
function *start($this, $completion) {
  ...
  var tmp0_safe_receiver = $completion.nd().zd(Key_instance);
  if (tmp0_safe_receiver == null)
    null;
  else {
    tmp0_safe_receiver.t26(WebsocketRequest$start$lambda_3($this));
  }
  yield* opened.r29($completion);
  yield* $this.i56_1.r29($completion);
  return $this;
}
function buildUrl($this) {
  ...
  var s = $this.u55_1 === 'ws' || $this.u55_1 === 'wss' ? $this.u55_1 : 'wss';
  var tmp0 = $this.v55_1;
  var tmp$ret$2;
  $l$block: {
    // Inline function 'kotlin.checkNotNull' call
  ...
  var tmp3_safe_receiver = $this.w55_1;
  var tmp_0;
...
function WebsocketRequest$start$lambda($opened, this$0) {
  return (it) => {
    ...
    try {
      ...
      if ($p instanceof Error) {
        var e = $p;
        this$0.g56_1(RuntimeException.se('onOpenListener failed', e));
        tmp_0 = Unit_instance;
      } else {
        throw $p;
      }
...
function WebsocketRequest$start$lambda_0(this$0, $opened) {
  return (it) => {
    ...
    var tmp;
    if (!$opened.m26()) {
      $opened.z2c(RuntimeException.kb('WebSocket closed before open'));
      tmp = Unit_instance;
    }
    var tmp_0;
    if (!this$0.j56_1) {
      this$0.j56_1 = true;
      tmp_0 = this$0.f56_1(this$0);
    }
    return this$0.i56_1.y2c(Unit_instance);
  };
}
...
function WebsocketRequest$start$lambda$slambda(this$0, $data) {
  return constructCallableReference(function *($this$launch, $completion) {
    yield* this$0.c56_1($data, $completion);
    return Unit_instance;
  }, 1);
}
function WebsocketRequest$start$lambda$slambda_0(this$0, $bytes) {
  return constructCallableReference(function *($this$launch, $completion) {
    yield* this$0.d56_1($bytes, $completion);
    return Unit_instance;
  }, 1);
}
function WebsocketRequest$start$lambda_2(this$0) {
  return (event) => {
    ...
    if (!(data == null) ? typeof data === 'string' : false) {
      launch(this$0.k56_1, VOID, VOID, WebsocketRequest$start$lambda$slambda(this$0, data));
      tmp = Unit_instance;
    } else {
      if (data instanceof ArrayBuffer) {
        ...
        launch(this$0.k56_1, VOID, VOID, WebsocketRequest$start$lambda$slambda_0(this$0, bytes));
        tmp = Unit_instance;
      }
    }
    return Unit_instance;
...
function WebsocketRequest$start$lambda_3(this$0) {
  return (it) => {
    var tmp0_safe_receiver = this$0.h56_1;
    if (tmp0_safe_receiver == null)
      null;
    else {
      tmp0_safe_receiver.close();
...
export {
  ...
  HttpResponse as HttpResponsexhe02ouh4cl4,
};
//endregion
