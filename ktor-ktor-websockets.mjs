...
class Companion {
  constructor() {
    ...
    while (_iterator__ex2g4s.m1()) {
      ...
      var tmp$ret$2 = element.f4f_1;
      destination.o4(tmp$ret$2, element);
    }
    tmp.g4f_1 = destination;
    this.h4f_1 = Codes_INTERNAL_ERROR_getInstance();
  }
  i4f(code) {
    return this.g4f_1.v4(code);
  }
}
...
class CloseReason {
  constructor(code, message) {
    return new.target.l4f(code, message);
  }
  static l4f(code, message) {
    var $this = createThis(this);
    $this.j4f_1 = code;
    $this.k4f_1 = message;
    return $this;
  }
  static m4f(code, message) {
    return this.l4f(code.f4f_1, message);
  }
  n4f() {
    return Companion_getInstance().i4f(this.j4f_1);
  }
  toString() {
    var tmp0_elvis_lhs = this.n4f();
    return 'CloseReason(reason=' + toString(tmp0_elvis_lhs == null ? this.j4f_1 : tmp0_elvis_lhs) + ', message=' + this.k4f_1 + ')';
  }
  hashCode() {
    var result = this.j4f_1;
    result = imul(result, 31) + getStringHashCode(this.k4f_1) | 0;
    return result;
  }
  equals(other) {
    if (this === other)
...
function *send(frame, $completion) {
  yield* this.s4f().i2l(frame, $completion);
...
class Companion_0 {
  constructor() {
    ...
    this.s4g_1 = Pong.o4h(new Int8Array(0), NonDisposableHandle_instance);
  }
}
class DefaultWebSocketSessionImpl {
  constructor(raw, pingIntervalMillis, timeoutMillis, incomingFramesConfig, outgoingFramesConfig) {
    ...
    this.x4f_1 = raw;
    this.y4f_1 = atomic$ref$1(null);
    this.z4f_1 = CompletableDeferred();
    this.a4g_1 = Job();
    this.b4g_1 = this.x4f_1.o25().ip(Key_instance).kp(this.a4g_1).kp(new CoroutineName('ws-default'));
    this.c4g_1 = from(Factory_getInstance(), incomingFramesConfig);
    this.d4g_1 = from(Factory_getInstance(), outgoingFramesConfig);
    this.e4g_1 = atomic$boolean$1(false);
    var tmp = this;
    // Inline function 'kotlin.collections.mutableListOf' call
    tmp.f4g_1 = ArrayList.j2();
    this.g4g_1 = atomic$boolean$1(false);
    this.h4g_1 = pingIntervalMillis;
    this.i4g_1 = timeoutMillis;
    this.j4g_1 = this.z4f_1;
  }
  o25() {
    return this.b4g_1;
  }
  ...
  p4f(value) {
    this.x4f_1.p4f(value);
  }
  q4f() {
    return this.x4f_1.q4f();
  }
  o4f(negotiatedExtensions) {
    if (!this.g4g_1.atomicfu$compareAndSet(false, true)) {
    ...
    if (get_isTraceEnabled(this_0)) {
      ...
      this_0.m3w(tmp$ret$2);
    }
    this.f4g_1.m2(negotiatedExtensions);
    runOrCancelPinger(this);
    var incomingJob = runIncomingProcessor(this, ponger(this, this.s4f()));
  ...
  *x3m($completion) {
    yield* this.x4f_1.x3m($completion);
    return Unit_instance;
  }
}
...
class FrameTooBigException extends Exception {
  constructor(frameSize, cause) {
    return new.target.d4h(frameSize, cause);
  }
  static d4h(frameSize, cause) {
    cause = cause === VOID ? null : cause;
    var $this = this.ye(cause);
    captureStack($this, $this.c4h_1);
    $this.b4h_1 = frameSize;
    delete $this.message;
    return $this;
  }
  r() {
    var sizeSuffix = this.b4h_1 >= 0n ? ': ' + this.b4h_1.toString() : '';
    return 'Frame is too big' + sizeSuffix;
  }
  j2d() {
    return FrameTooBigException.d4h(this.b4h_1, this);
  }
  get message() {
    return this.r();
  }
...
class Companion_1 {
  constructor() {
    ...
    tmp.v4h_1 = ensureNotNull(tmp$ret$0).u4h_1;
    var tmp_0 = this;
    var tmp_1 = 0;
    var tmp_2 = this.v4h_1 + 1 | 0;
...
class Companion_2 {
  constructor() {
    ...
    this_0.v4f_1 = this_0.f4i();
    this_0.w4f_1 = this_0.f4i();
    tmp.u4f_1 = this_0;
  }
}
class WebSocketChannelsConfig {
  constructor() {
    ...
    this.v4f_1 = Companion_getInstance_3().g4i_1;
    this.w4f_1 = Companion_getInstance_3().g4i_1;
  }
  f4i() {
    return Companion_getInstance_3().g4i_1;
  }
}
class Companion_3 {
  constructor() {
    Companion_instance_3 = this;
    this.g4i_1 = new ChannelConfig(2147483647, ChannelOverflow_SUSPEND_getInstance());
  }
}
class ChannelConfig {
  constructor(capacity, onOverflow) {
    ...
    this.h4i_1 = capacity;
    this.i4i_1 = onOverflow;
  }
  j4i() {
    return this.i4i_1.equals(ChannelOverflow_SUSPEND_getInstance()) && !(this.h4i_1 === 2147483647);
  }
}
...
class BoundedChannel {
  constructor(capacity, delegate) {
    delegate = delegate === VOID ? Companion_instance_4.o4i(capacity) : delegate;
    this.p4i_1 = delegate;
  }
  q4i(element) {
    var result = this.p4i_1.j2l(element);
    if (!_ChannelResult___get_isSuccess__impl__odq1z9(result) && !_ChannelResult___get_isClosed__impl__mg7kuu(result)) {
      this.s2l(ChannelOverflowException.n4i('Channel overflowed'));
    }
    return result;
  }
  j2l(element) {
    return this.q4i(element);
  }
  *r4i(element, $completion) {
    yield* this.p4i_1.i2l(element, $completion);
    return Unit_instance;
  }
  i2l(element, $completion) {
    return this.r4i(element, $completion);
  }
  s2l(cause) {
    return this.p4i_1.s2l(cause);
  }
  b2l() {
    return this.p4i_1.b2l();
  }
  *s4i($completion) {
    return yield* this.p4i_1.l2l($completion);
  }
  l2l($completion) {
    return this.s4i($completion);
  }
  l1() {
    return this.p4i_1.l1();
  }
  y26(cause) {
    this.p4i_1.y26(cause);
  }
}
class ChannelOverflowException extends RuntimeException {
  constructor(message) {
    return new.target.n4i(message);
  }
  static n4i(message) {
...
class WebSocketExtensionsConfig {
  constructor() {
    var tmp = this;
    // Inline function 'kotlin.collections.mutableListOf' call
    tmp.v4i_1 = ArrayList.j2();
    var tmp_0 = this;
    // Inline function 'kotlin.arrayOf' call
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp_0.w4i_1 = [false, false, false];
  }
  l40() {
...
class WebSocketExtensionHeader {
  constructor(name, parameters) {
    this.x4i_1 = name;
    this.y4i_1 = parameters;
  }
  toString() {
    return this.x4i_1 + ' ' + parametersToString(this);
  }
}
class Frame {
  static h4j(fin, frameType, data, disposableHandle, rsv1, rsv2, rsv3) {
    ...
    var $this = createThis(this);
    $this.t4g_1 = fin;
    $this.u4g_1 = frameType;
    $this.v4g_1 = data;
    $this.w4g_1 = disposableHandle;
    $this.x4g_1 = rsv1;
    $this.y4g_1 = rsv2;
    $this.z4g_1 = rsv3;
    return $this;
  ...
  toString() {
    return 'Frame ' + this.u4g_1.toString() + ' (fin=' + this.t4g_1 + ', buffer len = ' + this.v4g_1.length + ')';
  }
}
class Binary extends Frame {
  constructor(fin, data, rsv1, rsv2, rsv3) {
    return new.target.g4j(fin, data, rsv1, rsv2, rsv3);
  }
  static g4j(fin, data, rsv1, rsv2, rsv3) {
    rsv1 = rsv1 === VOID ? false : rsv1;
    rsv2 = rsv2 === VOID ? false : rsv2;
    rsv3 = rsv3 === VOID ? false : rsv3;
    return this.h4j(fin, FrameType_BINARY_getInstance(), data, NonDisposableHandle_instance, rsv1, rsv2, rsv3);
  }
  static i4j(fin, data) {
    return this.g4j(fin, data, false, false, false);
  }
}
class Text extends Frame {
  constructor(fin, data, rsv1, rsv2, rsv3) {
    return new.target.q4j(fin, data, rsv1, rsv2, rsv3);
  }
  static q4j(fin, data, rsv1, rsv2, rsv3) {
    rsv1 = rsv1 === VOID ? false : rsv1;
    rsv2 = rsv2 === VOID ? false : rsv2;
    rsv3 = rsv3 === VOID ? false : rsv3;
    return this.h4j(fin, FrameType_TEXT_getInstance(), data, NonDisposableHandle_instance, rsv1, rsv2, rsv3);
  }
  static r4j(fin, data) {
    return this.q4j(fin, data, false, false, false);
  }
  static s4j(text) {
    return this.r4j(true, toByteArray(text));
  }
}
class Close extends Frame {
  constructor(data) {
    return new.target.t4j(data);
  }
  static t4j(data) {
    return this.h4j(true, FrameType_CLOSE_getInstance(), data, NonDisposableHandle_instance, false, false, false);
  }
  static r4g(reason) {
    // Inline function 'io.ktor.utils.io.core.buildPacket' call
    var builder = new Buffer();
    builder.q23(reason.j4f_1);
    writeText(builder, reason.k4f_1);
    return this.u4j(builder);
  }
  static u4j(packet) {
    return this.t4j(readByteArray(packet));
  }
  static v4j() {
    return this.t4j(Companion_getInstance_5().p4h_1);
  }
}
class Ping extends Frame {
  constructor(data) {
    return new.target.e4i(data);
  }
  static e4i(data) {
    return this.h4j(true, FrameType_PING_getInstance(), data, NonDisposableHandle_instance, false, false, false);
  }
}
class Pong extends Frame {
  constructor(data, disposableHandle) {
    return new.target.o4h(data, disposableHandle);
  }
  static o4h(data, disposableHandle) {
    disposableHandle = disposableHandle === VOID ? NonDisposableHandle_instance : disposableHandle;
    return this.h4j(true, FrameType_PONG_getInstance(), data, disposableHandle, false, false, false);
  }
}
class Companion_5 {
  constructor() {
    Companion_instance_5 = this;
    this.p4h_1 = new Int8Array(0);
  }
  q4h(fin, frameType, data, rsv1, rsv2, rsv3) {
    var tmp;
    switch (frameType.s1_1) {
      case 1:
        tmp = Binary.g4j(fin, data, rsv1, rsv2, rsv3);
        break;
      case 0:
        tmp = Text.q4j(fin, data, rsv1, rsv2, rsv3);
        break;
      case 2:
        tmp = Close.t4j(data);
        break;
      case 3:
        ...
        break;
      case 4:
        tmp = Pong.o4h(data, NonDisposableHandle_instance);
        break;
      default:
...
function DefaultWebSocketSession_0(session, pingIntervalMillis, timeoutMillis, channelsConfig) {
  ...
  channelsConfig = channelsConfig === VOID ? Companion_getInstance_2().u4f_1 : channelsConfig;
  _init_properties_DefaultWebSocketSession_kt__469s0y();
  ...
  return new DefaultWebSocketSessionImpl(session, pingIntervalMillis, timeoutMillis, channelsConfig.v4f_1, channelsConfig.w4f_1);
}
function runIncomingProcessor($this, ponger) {
  var tmp = get_IncomingProcessorCoroutineName().kp(Dispatchers_getInstance().i2h_1);
...
function runOutgoingProcessor($this) {
  var tmp = get_OutgoingProcessorCoroutineName().kp(Dispatchers_getInstance().i2h_1);
...
function *outgoingProcessorLoop($this, $completion) {
  var _iterator__ex2g4s = $this.d4g_1.l1();
  $l$loop: while (yield* _iterator__ex2g4s.u2k($completion)) {
    var frame = _iterator__ex2g4s.n1();
    // Inline function 'io.ktor.util.logging.trace' call
    var this_0 = get_LOGGER();
    if (get_isTraceEnabled(this_0)) {
      var tmp$ret$1 = 'Sending ' + frame.toString() + ' from session ' + toString($this);
      this_0.m3w(tmp$ret$1);
    }
    var tmp;
    ...
    yield* $this.x4f_1.s4f().i2l(processedFrame, $completion);
  }
  return Unit_instance;
}
function *sendCloseSequence($this, reason, exception, $completion) {
  ...
  $this.a4g_1.y2c();
  var reasonToSend = reason == null ? CloseReason.m4f(Codes_NORMAL_getInstance(), '') : reason;
  try {
    runOrCancelPinger($this);
    if (!(reasonToSend.j4f_1 === Codes_CLOSED_ABNORMALLY_getInstance().f4f_1)) {
      yield* $this.x4f_1.s4f().i2l(Close.r4g(reasonToSend), $completion);
    }
  }finally {
    $this.z4f_1.w2c(reasonToSend);
    if (!(exception == null)) {
      $this.d4g_1.s2l(exception);
      $this.c4g_1.s2l(exception);
    }
  }
  return Unit_instance;
}
function tryClose($this) {
  return $this.e4g_1.atomicfu$compareAndSet(false, true);
}
function runOrCancelPinger($this) {
  var interval = $this.h4g_1;
  var tmp;
  if ($this.e4g_1.kotlinx$atomicfu$value) {
    tmp = null;
  } else if (interval > 0n) {
    var tmp_0 = $this.x4f_1.s4f();
  ...
  var newPinger = tmp;
  var tmp0_safe_receiver = $this.y4f_1.atomicfu$getAndSet(newPinger);
  if (tmp0_safe_receiver == null)
    null;
  else
    tmp0_safe_receiver.u2l();
  var tmp2_safe_receiver = newPinger == null ? null : new ChannelResult(newPinger.j2l(Companion_getInstance_0().s4g_1));
  if (tmp2_safe_receiver == null)
    null;
  else
    _ChannelResult___get_isSuccess__impl__odq1z9(tmp2_safe_receiver.h2l_1);
  if ($this.e4g_1.kotlinx$atomicfu$value && !(newPinger == null)) {
    runOrCancelPinger($this);
  }
}
function *checkMaxFrameSize($this, packet, frame, $completion) {
  var tmp = frame.v4g_1.length;
  var tmp1_elvis_lhs = packet == null ? null : get_size(packet);
  var size = tmp + (tmp1_elvis_lhs == null ? 0 : tmp1_elvis_lhs) | 0;
  if (fromInt(size) > $this.q4f()) {
    if (packet == null)
      null;
    else {
      packet.f7();
    }
    yield* close($this, CloseReason.m4f(Codes_TOO_BIG_getInstance(), 'Frame is too big: ' + size + '. Max size is ' + $this.q4f().toString()), $completion);
    throw FrameTooBigException.d4h(fromInt(size));
  }
  return Unit_instance;
}
function processIncomingExtensions($this, frame) {
  ...
  var _iterator__ex2g4s = $this.e4h().l1();
  while (_iterator__ex2g4s.m1()) {
    var element = _iterator__ex2g4s.n1();
    var current = accumulator;
    accumulator = element.f4h(current);
  }
  return accumulator;
}
function processOutgoingExtensions($this, frame) {
  ...
  while (_iterator__ex2g4s.m1()) {
    var element = _iterator__ex2g4s.n1();
    var current = accumulator;
    accumulator = element.g4h(current);
  }
  return accumulator;
}
...
function DefaultWebSocketSessionImpl$start$slambda($incomingJob, $outgoingJob, this$0) {
  return constructCallableReference(function *($this$launch, $completion) {
    yield* $incomingJob.v26($completion);
    yield* $outgoingJob.v26($completion);
    this$0.a4g_1.z26();
    return Unit_instance;
  }, 1);
}
  ...
  return constructCallableReference(function *($this$launch, $completion) {
    ...
    try {
          ...
          while (yield* _iterator__ex2g4s.u2k($completion)) {
            ...
            $l$block_0: {
              ...
              if (get_isTraceEnabled(this_0)) {
                ...
                this_0.m3w(tmp$ret$5);
              }
              if (e instanceof Close) {
                if (!this$0.s4f().b2l()) {
                  var tmp = this$0.s4f();
                  var tmp1_elvis_lhs = readReason(e);
                  yield* tmp.i2l(Close.r4g(tmp1_elvis_lhs == null ? get_NORMAL_CLOSE() : tmp1_elvis_lhs), $completion);
                }
                closeFramePresented = true;
                return Unit_instance;
              } else {
                if (e instanceof Pong) {
                  var tmp2_safe_receiver = this$0.y4f_1.kotlinx$atomicfu$value;
                  if (tmp2_safe_receiver == null)
                    null;
                  else
                    yield* tmp2_safe_receiver.i2l(e, $completion);
                } else {
                  if (e instanceof Ping)
                    yield* $ponger.i2l(e, $completion);
                  else {
                    ...
                    if (!e.t4g_1) {
                      ...
                      writeFully(frameBody, e.v4g_1);
                      break $l$block_0;
                    }
                    if (firstFrame == null) {
                      yield* this$0.c4g_1.i2l(processIncomingExtensions(this$0, e), $completion);
                      break $l$block_0;
                    }
                    writeFully(ensureNotNull(frameBody), e.v4g_1);
                    var defragmented = Companion_getInstance_5().q4h(true, firstFrame.u4g_1, readByteArray(build(frameBody)), firstFrame.x4g_1, firstFrame.y4g_1, firstFrame.z4g_1);
                    firstFrame = null;
                    yield* this$0.c4g_1.i2l(processIncomingExtensions(this$0, defragmented), $completion);
                  }
                }
              }
            }
      ...
      if (!closeFramePresented) {
        yield* close(this$0, CloseReason.m4f(Codes_CLOSED_ABNORMALLY_getInstance(), 'Connection was closed without close frame'), $completion);
      }
    }
    return Unit_instance;
  }, 1);
...
function DefaultWebSocketSessionImpl$runOutgoingProcessor$slambda(this$0) {
  return constructCallableReference(function *($this$launch, $completion) {
    ...
    try {
      ...
      if ($p instanceof ClosedSendChannelException) {
        ...
        if ($p instanceof ClosedReceiveChannelException) {
          ...
          if ($p instanceof CancellationException) {
            ...
            tmp_0 = yield* /*#__NOINLINE__*/sendCloseSequence(this$0, CloseReason.m4f(Codes_NORMAL_getInstance(), ''), VOID, $completion);
          } else {
            if ($p instanceof ChannelIOException) {
              ...
              if ($p instanceof Error) {
                var cause = $p;
                this$0.d4g_1.y26(CancellationException.p('Failed to send frame', cause));
                yield* closeExceptionally(this$0.x4f_1, cause, $completion);
                return Unit_instance;
              } else {
                throw $p;
              }
      ...
      this$0.d4g_1.w2l();
      yield* close(this$0.x4f_1, VOID, $completion);
    }
    return Unit_instance;
  }, 1);
}
function DefaultWebSocketSessionImpl$runOrCancelPinger$slambda(this$0) {
  return constructCallableReference(function *(it, $completion) {
    yield* /*#__NOINLINE__*/sendCloseSequence(this$0, it, IOException.y24('Ping timeout'), $completion);
    return Unit_instance;
  }, 1);
}
...
function _init_properties_DefaultWebSocketSession_kt__469s0y() {
  if (!properties_initialized_DefaultWebSocketSession_kt_6cjlhc) {
    ...
    NORMAL_CLOSE = CloseReason.m4f(Codes_NORMAL_getInstance(), 'OK');
...
function readReason(_this__u8e3s4) {
  if (_this__u8e3s4.v4g_1.length < 2) {
    return null;
  }
  // Inline function 'io.ktor.utils.io.core.buildPacket' call
  var builder = new Buffer();
  writeFully(builder, _this__u8e3s4.v4g_1);
  var packet = builder;
  var code = packet.i22();
  var message = readText(packet);
  return CloseReason.l4f(code, message);
}
...
function pinger(_this__u8e3s4, outgoing, periodMillis, timeoutMillis, onTimeout) {
  ...
  var tmp = actorJob.kp(get_PingerCoroutineName());
  launch(_this__u8e3s4, tmp, VOID, pinger$slambda(periodMillis, timeoutMillis, onTimeout, channel, outgoing));
  var tmp_0 = ensureNotNull(_this__u8e3s4.o25().xd(Key_instance));
  tmp_0.r26(pinger$lambda(actorJob));
  return channel;
}
    ...
    try {
      ...
      $l$block: {
        ...
        try {
          ...
          while (yield* _iterator__ex2g4s.u2k($completion)) {
            var e = _iterator__ex2g4s.n1();
            get_LOGGER().m3w('Received ping message, sending pong message');
            yield* $outgoing.i2l(Pong.o4h(e.v4g_1), $completion);
          }
          break $l$block;
        } catch ($p) {
          if ($p instanceof Error) {
...
function pinger$slambda$slambda_0($outgoing, $pingMessage, $channel) {
  return constructCallableReference(function *($this$withTimeoutOrNull, $completion) {
    get_LOGGER().m3w('WebSocket Pinger: sending ping frame');
    yield* $outgoing.i2l(Ping.e4i(toByteArray($pingMessage, Charsets_getInstance().s3o_1)), $completion);
    $l$loop: while (true) {
      var msg = yield* $channel.l2l($completion);
      if (decodeToString(msg.v4g_1, 0, 0 + msg.v4g_1.length | 0) === $pingMessage) {
        get_LOGGER().m3w('WebSocket Pinger: received valid pong frame ' + msg.toString());
        break $l$loop;
      }
      get_LOGGER().m3w('WebSocket Pinger: received invalid pong frame ' + msg.toString() + ', continue waiting');
    }
    return Unit_instance;
  }, 1);
}
function pinger$slambda($periodMillis, $timeoutMillis, $onTimeout, $channel, $outgoing) {
  return constructCallableReference(function *($this$launch, $completion) {
    get_LOGGER().m3w('Starting WebSocket pinger coroutine with period ' + $periodMillis.toString() + ' ms and timeout ' + $timeoutMillis.toString() + ' ms');
    ...
    try {
      $l$loop: while (true) {
        ...
        if (rc == null) {
          get_LOGGER().m3w('WebSocket pinger has timed out');
          yield* $onTimeout(CloseReason.m4f(Codes_INTERNAL_ERROR_getInstance(), 'Ping timeout'), $completion);
          break $l$loop;
        }
      }
      tmp = Unit_instance;
...
function from(_this__u8e3s4, config) {
  ...
  var tmp;
  if (config.h4i_1 === 2147483647) {
    tmp = Channel(2147483647);
  } else if (config.i4i_1.equals(ChannelOverflow_SUSPEND_getInstance())) {
    tmp = Channel(config.h4i_1, BufferOverflow_SUSPEND_getInstance());
  } else if (config.i4i_1.equals(ChannelOverflow_CLOSE_getInstance())) {
    tmp = new BoundedChannel(config.h4i_1);
  } else {
    // Inline function 'kotlin.error' call
...
function BoundedChannel$Companion$createDelegate$lambda($channel) {
  return (it) => {
    ...
    if (!tmp_0.b2l()) {
      ...
      tmp_1.s2l(ChannelOverflowException.n4i('Channel overflowed'));
      tmp = Unit_instance;
    }
    return Unit_instance;
  };
...
function parametersToString($this) {
  return $this.y4i_1.j1() ? '' : '; ' + joinToString($this.y4i_1, ';');
}
...
function *close(_this__u8e3s4, reason, $completion) {
  reason = reason === VOID ? CloseReason.m4f(Codes_NORMAL_getInstance(), '') : reason;
  try {
    yield* _this__u8e3s4.t4f(Close.r4g(reason), $completion);
...
function *closeExceptionally(_this__u8e3s4, cause, $completion) {
  ...
  if (cause instanceof CancellationException) {
    tmp = CloseReason.m4f(Codes_NORMAL_getInstance(), '');
  } else {
    tmp = CloseReason.m4f(Codes_INTERNAL_ERROR_getInstance(), cause.toString());
  }
  var reason = tmp;
...
protoOf(DefaultWebSocketSessionImpl).t4f = send;
...
protoOf(BoundedChannel).u2l = close$default;
protoOf(BoundedChannel).w2l = cancel$default;
...
initMetadataForClass(Close, 'Close', Close.v4j);
