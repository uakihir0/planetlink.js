...
class Companion {
  constructor() {
    ...
    while (_iterator__ex2g4s.m1()) {
      ...
      var tmp$ret$2 = element.l4f_1;
      destination.o4(tmp$ret$2, element);
    }
    tmp.m4f_1 = destination;
    this.n4f_1 = Codes_INTERNAL_ERROR_getInstance();
  }
  o4f(code) {
    return this.m4f_1.v4(code);
  }
}
...
class CloseReason {
  constructor(code, message) {
    return new.target.r4f(code, message);
  }
  static r4f(code, message) {
    var $this = createThis(this);
    $this.p4f_1 = code;
    $this.q4f_1 = message;
    return $this;
  }
  static s4f(code, message) {
    return this.r4f(code.l4f_1, message);
  }
  t4f() {
    return Companion_getInstance().o4f(this.p4f_1);
  }
  toString() {
    var tmp0_elvis_lhs = this.t4f();
    return 'CloseReason(reason=' + toString(tmp0_elvis_lhs == null ? this.p4f_1 : tmp0_elvis_lhs) + ', message=' + this.q4f_1 + ')';
  }
  hashCode() {
    var result = this.p4f_1;
    result = imul(result, 31) + getStringHashCode(this.q4f_1) | 0;
    return result;
  }
  equals(other) {
    if (this === other)
...
function *send(frame, $completion) {
  yield* this.y4f().o2l(frame, $completion);
...
class Companion_0 {
  constructor() {
    ...
    this.y4g_1 = Pong.u4h(new Int8Array(0), NonDisposableHandle_instance);
  }
}
class DefaultWebSocketSessionImpl {
  constructor(raw, pingIntervalMillis, timeoutMillis, incomingFramesConfig, outgoingFramesConfig) {
    ...
    this.d4g_1 = raw;
    this.e4g_1 = atomic$ref$1(null);
    this.f4g_1 = CompletableDeferred();
    this.g4g_1 = Job();
    this.h4g_1 = this.d4g_1.q25().kp(Key_instance).mp(this.g4g_1).mp(new CoroutineName('ws-default'));
    this.i4g_1 = from(Factory_getInstance(), incomingFramesConfig);
    this.j4g_1 = from(Factory_getInstance(), outgoingFramesConfig);
    this.k4g_1 = atomic$boolean$1(false);
    var tmp = this;
    // Inline function 'kotlin.collections.mutableListOf' call
    tmp.l4g_1 = ArrayList.j2();
    this.m4g_1 = atomic$boolean$1(false);
    this.n4g_1 = pingIntervalMillis;
    this.o4g_1 = timeoutMillis;
    this.p4g_1 = this.f4g_1;
  }
  q25() {
    return this.h4g_1;
  }
  ...
  v4f(value) {
    this.d4g_1.v4f(value);
  }
  w4f() {
    return this.d4g_1.w4f();
  }
  u4f(negotiatedExtensions) {
    if (!this.m4g_1.atomicfu$compareAndSet(false, true)) {
    ...
    if (get_isTraceEnabled(this_0)) {
      ...
      this_0.s3w(tmp$ret$2);
    }
    this.l4g_1.m2(negotiatedExtensions);
    runOrCancelPinger(this);
    var incomingJob = runIncomingProcessor(this, ponger(this, this.y4f()));
  ...
  *d3n($completion) {
    yield* this.d4g_1.d3n($completion);
    return Unit_instance;
  }
}
...
class FrameTooBigException extends Exception {
  constructor(frameSize, cause) {
    return new.target.j4h(frameSize, cause);
  }
  static j4h(frameSize, cause) {
    cause = cause === VOID ? null : cause;
    var $this = this.af(cause);
    captureStack($this, $this.i4h_1);
    $this.h4h_1 = frameSize;
    delete $this.message;
    return $this;
  }
  r() {
    var sizeSuffix = this.h4h_1 >= 0n ? ': ' + this.h4h_1.toString() : '';
    return 'Frame is too big' + sizeSuffix;
  }
  m2d() {
    return FrameTooBigException.j4h(this.h4h_1, this);
  }
  get message() {
    return this.r();
  }
...
class Companion_1 {
  constructor() {
    ...
    tmp.b4i_1 = ensureNotNull(tmp$ret$0).a4i_1;
    var tmp_0 = this;
    var tmp_1 = 0;
    var tmp_2 = this.b4i_1 + 1 | 0;
...
class Companion_2 {
  constructor() {
    ...
    this_0.b4g_1 = this_0.l4i();
    this_0.c4g_1 = this_0.l4i();
    tmp.a4g_1 = this_0;
  }
}
class WebSocketChannelsConfig {
  constructor() {
    ...
    this.b4g_1 = Companion_getInstance_3().m4i_1;
    this.c4g_1 = Companion_getInstance_3().m4i_1;
  }
  l4i() {
    return Companion_getInstance_3().m4i_1;
  }
}
class Companion_3 {
  constructor() {
    Companion_instance_3 = this;
    this.m4i_1 = new ChannelConfig(2147483647, ChannelOverflow_SUSPEND_getInstance());
  }
}
class ChannelConfig {
  constructor(capacity, onOverflow) {
    ...
    this.n4i_1 = capacity;
    this.o4i_1 = onOverflow;
  }
  p4i() {
    return this.o4i_1.equals(ChannelOverflow_SUSPEND_getInstance()) && !(this.n4i_1 === 2147483647);
  }
}
...
class BoundedChannel {
  constructor(capacity, delegate) {
    delegate = delegate === VOID ? Companion_instance_4.u4i(capacity) : delegate;
    this.v4i_1 = delegate;
  }
  w4i(element) {
    var result = this.v4i_1.p2l(element);
    if (!_ChannelResult___get_isSuccess__impl__odq1z9(result) && !_ChannelResult___get_isClosed__impl__mg7kuu(result)) {
      this.y2l(ChannelOverflowException.t4i('Channel overflowed'));
    }
    return result;
  }
  p2l(element) {
    return this.w4i(element);
  }
  *x4i(element, $completion) {
    yield* this.v4i_1.o2l(element, $completion);
    return Unit_instance;
  }
  o2l(element, $completion) {
    return this.x4i(element, $completion);
  }
  y2l(cause) {
    return this.v4i_1.y2l(cause);
  }
  h2l() {
    return this.v4i_1.h2l();
  }
  *y4i($completion) {
    return yield* this.v4i_1.r2l($completion);
  }
  r2l($completion) {
    return this.y4i($completion);
  }
  l1() {
    return this.v4i_1.l1();
  }
  a27(cause) {
    this.v4i_1.a27(cause);
  }
}
class ChannelOverflowException extends RuntimeException {
  constructor(message) {
    return new.target.t4i(message);
  }
  static t4i(message) {
    var $this = this.kb(message);
    captureStack($this, $this.s4i_1);
    return $this;
  }
}
...
class WebSocketExtensionsConfig {
  constructor() {
    var tmp = this;
    // Inline function 'kotlin.collections.mutableListOf' call
    tmp.b4j_1 = ArrayList.j2();
    var tmp_0 = this;
    // Inline function 'kotlin.arrayOf' call
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp_0.c4j_1 = [false, false, false];
  }
  s40() {
...
class WebSocketExtensionHeader {
  constructor(name, parameters) {
    this.d4j_1 = name;
    this.e4j_1 = parameters;
  }
  toString() {
    return this.d4j_1 + ' ' + parametersToString(this);
  }
}
class Frame {
  static n4j(fin, frameType, data, disposableHandle, rsv1, rsv2, rsv3) {
    ...
    var $this = createThis(this);
    $this.z4g_1 = fin;
    $this.a4h_1 = frameType;
    $this.b4h_1 = data;
    $this.c4h_1 = disposableHandle;
    $this.d4h_1 = rsv1;
    $this.e4h_1 = rsv2;
    $this.f4h_1 = rsv3;
    return $this;
  ...
  toString() {
    return 'Frame ' + this.a4h_1.toString() + ' (fin=' + this.z4g_1 + ', buffer len = ' + this.b4h_1.length + ')';
  }
}
class Binary extends Frame {
  ...
  static m4j(fin, data, rsv1, rsv2, rsv3) {
    ...
    rsv2 = rsv2 === VOID ? false : rsv2;
    rsv3 = rsv3 === VOID ? false : rsv3;
    return this.n4j(fin, FrameType_BINARY_getInstance(), data, NonDisposableHandle_instance, rsv1, rsv2, rsv3);
  }
  static o4j(fin, data) {
...
class Text extends Frame {
  constructor(fin, data, rsv1, rsv2, rsv3) {
    return new.target.w4j(fin, data, rsv1, rsv2, rsv3);
  }
  static w4j(fin, data, rsv1, rsv2, rsv3) {
    rsv1 = rsv1 === VOID ? false : rsv1;
    rsv2 = rsv2 === VOID ? false : rsv2;
    rsv3 = rsv3 === VOID ? false : rsv3;
    return this.n4j(fin, FrameType_TEXT_getInstance(), data, NonDisposableHandle_instance, rsv1, rsv2, rsv3);
  }
  static x4j(fin, data) {
    return this.w4j(fin, data, false, false, false);
  }
  static y4j(text) {
    return this.x4j(true, toByteArray(text));
  }
}
class Close extends Frame {
  constructor(data) {
    return new.target.z4j(data);
  }
  static z4j(data) {
    return this.n4j(true, FrameType_CLOSE_getInstance(), data, NonDisposableHandle_instance, false, false, false);
  }
  static x4g(reason) {
    // Inline function 'io.ktor.utils.io.core.buildPacket' call
    var builder = new Buffer();
    builder.s23(reason.p4f_1);
    writeText(builder, reason.q4f_1);
    return this.a4k(builder);
  }
  static a4k(packet) {
    return this.z4j(readByteArray(packet));
  }
  static b4k() {
    return this.z4j(Companion_getInstance_5().v4h_1);
  }
}
class Ping extends Frame {
  constructor(data) {
    return new.target.k4i(data);
  }
  static k4i(data) {
    return this.n4j(true, FrameType_PING_getInstance(), data, NonDisposableHandle_instance, false, false, false);
  }
}
class Pong extends Frame {
  constructor(data, disposableHandle) {
    return new.target.u4h(data, disposableHandle);
  }
  static u4h(data, disposableHandle) {
    disposableHandle = disposableHandle === VOID ? NonDisposableHandle_instance : disposableHandle;
    return this.n4j(true, FrameType_PONG_getInstance(), data, disposableHandle, false, false, false);
  }
}
class Companion_5 {
  constructor() {
    Companion_instance_5 = this;
    this.v4h_1 = new Int8Array(0);
  }
  w4h(fin, frameType, data, rsv1, rsv2, rsv3) {
    var tmp;
    switch (frameType.s1_1) {
      case 1:
        tmp = Binary.m4j(fin, data, rsv1, rsv2, rsv3);
        break;
      case 0:
        tmp = Text.w4j(fin, data, rsv1, rsv2, rsv3);
        break;
      case 2:
        tmp = Close.z4j(data);
        break;
      case 3:
        ...
        break;
      case 4:
        tmp = Pong.u4h(data, NonDisposableHandle_instance);
        break;
      default:
...
function DefaultWebSocketSession_0(session, pingIntervalMillis, timeoutMillis, channelsConfig) {
  ...
  channelsConfig = channelsConfig === VOID ? Companion_getInstance_2().a4g_1 : channelsConfig;
  _init_properties_DefaultWebSocketSession_kt__469s0y();
  ...
  return new DefaultWebSocketSessionImpl(session, pingIntervalMillis, timeoutMillis, channelsConfig.b4g_1, channelsConfig.c4g_1);
}
function runIncomingProcessor($this, ponger) {
  var tmp = get_IncomingProcessorCoroutineName().mp(Dispatchers_getInstance().l2h_1);
...
function runOutgoingProcessor($this) {
  var tmp = get_OutgoingProcessorCoroutineName().mp(Dispatchers_getInstance().l2h_1);
...
function *outgoingProcessorLoop($this, $completion) {
  var _iterator__ex2g4s = $this.j4g_1.l1();
  $l$loop: while (yield* _iterator__ex2g4s.a2l($completion)) {
    var frame = _iterator__ex2g4s.n1();
    // Inline function 'io.ktor.util.logging.trace' call
    var this_0 = get_LOGGER();
    if (get_isTraceEnabled(this_0)) {
      var tmp$ret$1 = 'Sending ' + frame.toString() + ' from session ' + toString($this);
      this_0.s3w(tmp$ret$1);
    }
    var tmp;
    ...
    yield* $this.d4g_1.y4f().o2l(processedFrame, $completion);
  }
  return Unit_instance;
}
function *sendCloseSequence($this, reason, exception, $completion) {
  ...
  $this.g4g_1.a2d();
  var reasonToSend = reason == null ? CloseReason.s4f(Codes_NORMAL_getInstance(), '') : reason;
  try {
    runOrCancelPinger($this);
    if (!(reasonToSend.p4f_1 === Codes_CLOSED_ABNORMALLY_getInstance().l4f_1)) {
      yield* $this.d4g_1.y4f().o2l(Close.x4g(reasonToSend), $completion);
    }
  }finally {
    $this.f4g_1.y2c(reasonToSend);
    if (!(exception == null)) {
      $this.j4g_1.y2l(exception);
      $this.i4g_1.y2l(exception);
    }
  }
  return Unit_instance;
}
function tryClose($this) {
  return $this.k4g_1.atomicfu$compareAndSet(false, true);
}
function runOrCancelPinger($this) {
  var interval = $this.n4g_1;
  var tmp;
  if ($this.k4g_1.kotlinx$atomicfu$value) {
    tmp = null;
  } else if (interval > 0n) {
    var tmp_0 = $this.d4g_1.y4f();
  ...
  var newPinger = tmp;
  var tmp0_safe_receiver = $this.e4g_1.atomicfu$getAndSet(newPinger);
  if (tmp0_safe_receiver == null)
    null;
  else
    tmp0_safe_receiver.a2m();
  var tmp2_safe_receiver = newPinger == null ? null : new ChannelResult(newPinger.p2l(Companion_getInstance_0().y4g_1));
  if (tmp2_safe_receiver == null)
    null;
  else
    _ChannelResult___get_isSuccess__impl__odq1z9(tmp2_safe_receiver.n2l_1);
  if ($this.k4g_1.kotlinx$atomicfu$value && !(newPinger == null)) {
    runOrCancelPinger($this);
  }
}
function *checkMaxFrameSize($this, packet, frame, $completion) {
  var tmp = frame.b4h_1.length;
  var tmp1_elvis_lhs = packet == null ? null : get_size(packet);
  var size = tmp + (tmp1_elvis_lhs == null ? 0 : tmp1_elvis_lhs) | 0;
  if (fromInt(size) > $this.w4f()) {
    if (packet == null)
      null;
    else {
      packet.f7();
    }
    yield* close($this, CloseReason.s4f(Codes_TOO_BIG_getInstance(), 'Frame is too big: ' + size + '. Max size is ' + $this.w4f().toString()), $completion);
    throw FrameTooBigException.j4h(fromInt(size));
  }
  return Unit_instance;
}
function processIncomingExtensions($this, frame) {
  ...
  var _iterator__ex2g4s = $this.k4h().l1();
  while (_iterator__ex2g4s.m1()) {
    var element = _iterator__ex2g4s.n1();
    var current = accumulator;
    accumulator = element.l4h(current);
  }
  return accumulator;
}
function processOutgoingExtensions($this, frame) {
  ...
  while (_iterator__ex2g4s.m1()) {
    var element = _iterator__ex2g4s.n1();
    var current = accumulator;
    accumulator = element.m4h(current);
  }
  return accumulator;
}
...
function DefaultWebSocketSessionImpl$start$slambda($incomingJob, $outgoingJob, this$0) {
  return constructCallableReference(function *($this$launch, $completion) {
    yield* $incomingJob.x26($completion);
    yield* $outgoingJob.x26($completion);
    this$0.g4g_1.b27();
    return Unit_instance;
  }, 1);
}
  ...
  return constructCallableReference(function *($this$launch, $completion) {
    ...
    try {
          ...
          while (yield* _iterator__ex2g4s.a2l($completion)) {
            ...
            $l$block_0: {
              ...
              if (get_isTraceEnabled(this_0)) {
                ...
                this_0.s3w(tmp$ret$5);
              }
              if (e instanceof Close) {
                if (!this$0.y4f().h2l()) {
                  var tmp = this$0.y4f();
                  var tmp1_elvis_lhs = readReason(e);
                  yield* tmp.o2l(Close.x4g(tmp1_elvis_lhs == null ? get_NORMAL_CLOSE() : tmp1_elvis_lhs), $completion);
                }
                closeFramePresented = true;
                return Unit_instance;
              } else {
                if (e instanceof Pong) {
                  var tmp2_safe_receiver = this$0.e4g_1.kotlinx$atomicfu$value;
                  if (tmp2_safe_receiver == null)
                    null;
                  else
                    yield* tmp2_safe_receiver.o2l(e, $completion);
                } else {
                  if (e instanceof Ping)
                    yield* $ponger.o2l(e, $completion);
                  else {
                    ...
                    if (!e.z4g_1) {
                      ...
                      writeFully(frameBody, e.b4h_1);
                      break $l$block_0;
                    }
                    if (firstFrame == null) {
                      yield* this$0.i4g_1.o2l(processIncomingExtensions(this$0, e), $completion);
                      break $l$block_0;
                    }
                    writeFully(ensureNotNull(frameBody), e.b4h_1);
                    var defragmented = Companion_getInstance_5().w4h(true, firstFrame.a4h_1, readByteArray(build(frameBody)), firstFrame.d4h_1, firstFrame.e4h_1, firstFrame.f4h_1);
                    firstFrame = null;
                    yield* this$0.i4g_1.o2l(processIncomingExtensions(this$0, defragmented), $completion);
                  }
                }
              }
            }
      ...
      if (!closeFramePresented) {
        yield* close(this$0, CloseReason.s4f(Codes_CLOSED_ABNORMALLY_getInstance(), 'Connection was closed without close frame'), $completion);
      }
    }
    return Unit_instance;
  }, 1);
...
function DefaultWebSocketSessionImpl$runOutgoingProcessor$slambda(this$0) {
  return constructCallableReference(function *($this$launch, $completion) {
    ...
    try {
      ...
      if ($p instanceof ClosedSendChannelException) {
        ...
        if ($p instanceof ClosedReceiveChannelException) {
          ...
          if ($p instanceof CancellationException) {
            ...
            tmp_0 = yield* /*#__NOINLINE__*/sendCloseSequence(this$0, CloseReason.s4f(Codes_NORMAL_getInstance(), ''), VOID, $completion);
          } else {
            if ($p instanceof ChannelIOException) {
              ...
              if ($p instanceof Error) {
                var cause = $p;
                this$0.j4g_1.a27(CancellationException.p('Failed to send frame', cause));
                yield* closeExceptionally(this$0.d4g_1, cause, $completion);
                return Unit_instance;
              } else {
                throw $p;
              }
      ...
      this$0.j4g_1.c2m();
      yield* close(this$0.d4g_1, VOID, $completion);
    }
    return Unit_instance;
  }, 1);
}
function DefaultWebSocketSessionImpl$runOrCancelPinger$slambda(this$0) {
  return constructCallableReference(function *(it, $completion) {
    yield* /*#__NOINLINE__*/sendCloseSequence(this$0, it, IOException.a25('Ping timeout'), $completion);
    return Unit_instance;
  }, 1);
}
...
function _init_properties_DefaultWebSocketSession_kt__469s0y() {
  if (!properties_initialized_DefaultWebSocketSession_kt_6cjlhc) {
    ...
    NORMAL_CLOSE = CloseReason.s4f(Codes_NORMAL_getInstance(), 'OK');
...
function readReason(_this__u8e3s4) {
  if (_this__u8e3s4.b4h_1.length < 2) {
    return null;
  }
  // Inline function 'io.ktor.utils.io.core.buildPacket' call
  var builder = new Buffer();
  writeFully(builder, _this__u8e3s4.b4h_1);
  var packet = builder;
  var code = packet.k22();
  var message = readText(packet);
  return CloseReason.r4f(code, message);
}
...
function pinger(_this__u8e3s4, outgoing, periodMillis, timeoutMillis, onTimeout) {
  ...
  var tmp = actorJob.mp(get_PingerCoroutineName());
  launch(_this__u8e3s4, tmp, VOID, pinger$slambda(periodMillis, timeoutMillis, onTimeout, channel, outgoing));
  var tmp_0 = ensureNotNull(_this__u8e3s4.q25().zd(Key_instance));
  tmp_0.t26(pinger$lambda(actorJob));
  return channel;
}
    ...
    try {
      ...
      $l$block: {
        ...
        try {
          ...
          while (yield* _iterator__ex2g4s.a2l($completion)) {
            var e = _iterator__ex2g4s.n1();
            get_LOGGER().s3w('Received ping message, sending pong message');
            yield* $outgoing.o2l(Pong.u4h(e.b4h_1), $completion);
          }
          break $l$block;
        } catch ($p) {
          if ($p instanceof Error) {
...
function pinger$slambda$slambda_0($outgoing, $pingMessage, $channel) {
  return constructCallableReference(function *($this$withTimeoutOrNull, $completion) {
    get_LOGGER().s3w('WebSocket Pinger: sending ping frame');
    yield* $outgoing.o2l(Ping.k4i(toByteArray($pingMessage, Charsets_getInstance().y3o_1)), $completion);
    $l$loop: while (true) {
      var msg = yield* $channel.r2l($completion);
      if (decodeToString(msg.b4h_1, 0, 0 + msg.b4h_1.length | 0) === $pingMessage) {
        get_LOGGER().s3w('WebSocket Pinger: received valid pong frame ' + msg.toString());
        break $l$loop;
      }
      get_LOGGER().s3w('WebSocket Pinger: received invalid pong frame ' + msg.toString() + ', continue waiting');
    }
    return Unit_instance;
  }, 1);
}
function pinger$slambda($periodMillis, $timeoutMillis, $onTimeout, $channel, $outgoing) {
  return constructCallableReference(function *($this$launch, $completion) {
    get_LOGGER().s3w('Starting WebSocket pinger coroutine with period ' + $periodMillis.toString() + ' ms and timeout ' + $timeoutMillis.toString() + ' ms');
    ...
    try {
      $l$loop: while (true) {
        ...
        if (rc == null) {
          get_LOGGER().s3w('WebSocket pinger has timed out');
          yield* $onTimeout(CloseReason.s4f(Codes_INTERNAL_ERROR_getInstance(), 'Ping timeout'), $completion);
          break $l$loop;
        }
      }
      tmp = Unit_instance;
...
function from(_this__u8e3s4, config) {
  ...
  var tmp;
  if (config.n4i_1 === 2147483647) {
    tmp = Channel(2147483647);
  } else if (config.o4i_1.equals(ChannelOverflow_SUSPEND_getInstance())) {
    tmp = Channel(config.n4i_1, BufferOverflow_SUSPEND_getInstance());
  } else if (config.o4i_1.equals(ChannelOverflow_CLOSE_getInstance())) {
    tmp = new BoundedChannel(config.n4i_1);
  } else {
    // Inline function 'kotlin.error' call
...
function BoundedChannel$Companion$createDelegate$lambda($channel) {
  return (it) => {
    ...
    if (!tmp_0.h2l()) {
      ...
      tmp_1.y2l(ChannelOverflowException.t4i('Channel overflowed'));
      tmp = Unit_instance;
    }
    return Unit_instance;
  };
...
function parametersToString($this) {
  return $this.e4j_1.j1() ? '' : '; ' + joinToString($this.e4j_1, ';');
}
...
function *close(_this__u8e3s4, reason, $completion) {
  reason = reason === VOID ? CloseReason.s4f(Codes_NORMAL_getInstance(), '') : reason;
  try {
    yield* _this__u8e3s4.z4f(Close.x4g(reason), $completion);
...
function *closeExceptionally(_this__u8e3s4, cause, $completion) {
  ...
  if (cause instanceof CancellationException) {
    tmp = CloseReason.s4f(Codes_NORMAL_getInstance(), '');
  } else {
    tmp = CloseReason.s4f(Codes_INTERNAL_ERROR_getInstance(), cause.toString());
  }
  var reason = tmp;
...
protoOf(DefaultWebSocketSessionImpl).z4f = send;
...
protoOf(BoundedChannel).a2m = close$default;
protoOf(BoundedChannel).c2m = cancel$default;
...
initMetadataForClass(Close, 'Close', Close.b4k);
