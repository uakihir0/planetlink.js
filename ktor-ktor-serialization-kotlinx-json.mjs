...
function json(_this__u8e3s4, json, contentType) {
  ...
  contentType = contentType === VOID ? Application_getInstance().b3y_1 : contentType;
  _init_properties_JsonSupport_kt__yf438r();
...
function DefaultJson$lambda($this$Json) {
  ...
  $this$Json.m1n_1 = true;
  $this$Json.x1n_1 = true;
  $this$Json.y1n_1 = true;
  $this$Json.n1n_1 = false;
  $this$Json.z1n_1 = false;
