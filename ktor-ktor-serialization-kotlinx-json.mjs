...
function json(_this__u8e3s4, json, contentType) {
  ...
  contentType = contentType === VOID ? Application_getInstance().v3x_1 : contentType;
  _init_properties_JsonSupport_kt__yf438r();
...
function DefaultJson$lambda($this$Json) {
  ...
  $this$Json.k1n_1 = true;
  $this$Json.v1n_1 = true;
  $this$Json.w1n_1 = true;
  $this$Json.l1n_1 = false;
  $this$Json.x1n_1 = false;
