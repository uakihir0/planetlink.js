...
class Big extends Endian {
  ...
  b8k(source, dest, destOffset, sourceIndexStart, sourceIndexEnd) {
  ...
  c8k(source, dest, destOffset, sourceIndexStart, sourceIndexEnd) {
    // Inline function 'org.kotlincrypto.bitops.endian.internal.packArray' call
    var destPos = destOffset;
    var sourcePos = sourceIndexStart;
    while (sourcePos < sourceIndexEnd) {
...
export {
  Big_getInstance as Big_getInstance2a0hzz2j69bgw,
};
//endregion
