...
class Companion {
  knb() {
    return CryptographySystem_getInstance().mnb();
  }
}
class CryptographyProvider {
  onb(identifier) {
    var tmp0_elvis_lhs = this.nnb(identifier);
    var tmp;
...
class CryptographySystem {
  constructor() {
    ...
    this.lnb_1 = new CryptographySystemImpl();
    loadProviders(this);
  }
  mnb() {
    return this.lnb_1.mnb();
  }
  vnb(provider, priority) {
    return this.lnb_1.vnb(provider, priority);
  }
}
class CompositeProvider extends CryptographyProvider {
  constructor(providers) {
    super();
    this.wnb_1 = providers;
  }
  nnb(identifier) {
    var tmp0 = this.wnb_1;
    var tmp$ret$0;
    $l$block: {
      ...
      while (_iterator__ex2g4s.m1()) {
        ...
        var result = element.nnb(identifier);
        if (!(result == null)) {
          tmp$ret$0 = result;
          break $l$block;
        }
...
class sam$kotlin_Comparator$0 {
  constructor(function_0) {
    this.xnb_1 = function_0;
  }
  sj(a, b) {
    return this.xnb_1(a, b);
  }
  compare(a, b) {
    return this.sj(a, b);
  }
...
class CryptographySystemImpl {
  constructor() {
    ...
    tmp.pnb_1 = LinkedHashMap.r5();
    var tmp_0 = this;
    tmp_0.qnb_1 = lazy(CryptographySystemImpl$lazyRegisteredProviders$lambda(this));
    this.rnb_1 = null;
    var tmp_1 = this;
    tmp_1.snb_1 = lazy(CryptographySystemImpl$lazyDefaultProvider$lambda(this));
    this.tnb_1 = null;
    var tmp_2 = this;
    tmp_2.unb_1 = lazy(CryptographySystemImpl$lazyDefaultRandom$lambda(this));
  }
  mnb() {
    return this.snb_1.d3();
  }
  vnb(provider, priority) {
    ...
    this.pnb_1.o4(priority, provider);
  }
}
...
function update$default(source, startIndex, endIndex, $super) {
  ...
  var tmp;
  if ($super === VOID) {
    this.cnc(source, startIndex, endIndex);
    tmp = Unit_instance;
  } else {
    tmp = $super.cnc.call(this, source, startIndex, endIndex);
  }
  return tmp;
}
//endregion
...
function CryptographySystemImpl$lazyDefaultProvider$lambda(this$0) {
  return () => {
    var tmp0_elvis_lhs = this$0.rnb_1;
    var tmp;
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlin.let' call
      var it = this$0.qnb_1.d3();
      var tmp_0;
      switch (it.l2()) {
        case 0:
...
function CryptographySystemImpl$lazyDefaultRandom$lambda(this$0) {
  return () => {
    var tmp0_elvis_lhs = this$0.tnb_1;
