...
class ConverterRegistration {
  constructor(converter, contentTypeToSend, contentTypeMatcher) {
    this.pkr_1 = converter;
    this.qkr_1 = contentTypeToSend;
    this.rkr_1 = contentTypeMatcher;
  }
}
class ContentNegotiationConfig$defaultMatcher$1 {
  ...
  tkr(contentType) {
    return contentType.o40(this.skr_1);
  }
}
class ContentNegotiationConfig {
  constructor() {
    this.ukr_1 = toMutableSet(plus(get_DefaultIgnoredTypes(), get_DefaultCommonIgnoredTypes()));
    var tmp = this;
    // Inline function 'kotlin.collections.mutableListOf' call
    tmp.vkr_1 = ArrayList.j2();
    this.wkr_1 = null;
  }
  j4k(contentType, converter, configuration) {
    ...
    this.xkr(contentType, converter, matcher, configuration);
  }
  xkr(contentTypeToSend, converter, contentTypeMatcher, configuration) {
    // Inline function 'kotlin.apply' call
    configuration(converter);
    var registration = new ConverterRegistration(converter, contentTypeToSend, contentTypeMatcher);
    this.vkr_1.i2(registration);
  }
}
class ContentConverterException extends Exception {
  constructor(message) {
    return new.target.aks(message);
  }
  static aks(message) {
    var $this = this.xe(message);
    captureStack($this, $this.zkr_1);
    return $this;
  }
}
...
function ContentNegotiation$lambda($this$createClientPlugin) {
  _init_properties_ContentNegotiation_kt__o183go();
  var registrations = $this$createClientPlugin.m4r_1.vkr_1;
  var ignoredTypes = $this$createClientPlugin.m4r_1.ukr_1;
...
function *invoke$convertRequest(registrations, $this_createClientPlugin, ignoredTypes, request, body, $completion) {
    ...
    while (_iterator__ex2g4s.m1()) {
      ...
      $l$block_0: {
        ...
        while (_iterator__ex2g4s_0.m1()) {
          ...
          if (element.qkr_1.o40(element_0)) {
            tmp$ret$3 = false;
            break $l$block_0;
          }
        }
  ...
  while (_iterator__ex2g4s_1.m1()) {
    ...
    $l$block_2: {
      ...
      while (_iterator__ex2g4s_2.m1()) {
        ...
        if (Companion_getInstance().tw(element_2).o40(element_1.qkr_1)) {
          tmp$ret$8 = false;
          break $l$block_2;
        }
      }
    ...
    if (tmp$ret$8) {
      var qValue = $this_createClientPlugin.m4r_1.wkr_1;
      var contentTypeToSend = qValue == null ? element_1.qkr_1 : element_1.qkr_1.l40('q', qValue.toString());
  ...
  while (_iterator__ex2g4s_4.m1()) {
    ...
    if (element_4.rkr_1.tkr(contentType_0)) {
  ...
  $l$block_5: {
    ...
    while (_iterator__ex2g4s_5.m1()) {
      ...
      var result = yield* element_5.pkr_1.bks(contentType_0, tmp_7, tmp_8, tmp$ret$24, $completion);
      if (!(result == null)) {
        get_LOGGER().s3w('Converted request body using ' + toString(element_5.pkr_1) + ' for ' + request.r4m_1.toString());
      }
      var result_0 = result;
      if (!(result_0 == null)) {
        tmp$ret$22 = result_0;
  ...
  if (tmp2_elvis_lhs == null) {
    ...
    throw ContentConverterException.aks(tmp_11 + joinToString(matchingRegistrations, VOID, VOID, VOID, VOID, VOID, ContentNegotiation$lambda$convertRequest$lambda));
  } else {
...
function *invoke$convertResponse(ignoredTypes, registrations, $this_createClientPlugin, requestUrl, info, body, responseContentType, charset, $completion) {
  ...
  while (_iterator__ex2g4s.m1()) {
    var element = _iterator__ex2g4s.n1();
    if (element.rkr_1.tkr(responseContentType)) {
      destination.i2(element);
    }
  }
