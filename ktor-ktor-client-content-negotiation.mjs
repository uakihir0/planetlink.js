...
class ConverterRegistration {
  constructor(converter, contentTypeToSend, contentTypeMatcher) {
    this.jkm_1 = converter;
    this.kkm_1 = contentTypeToSend;
    this.lkm_1 = contentTypeMatcher;
  }
}
class ContentNegotiationConfig$defaultMatcher$1 {
  ...
  nkm(contentType) {
    return contentType.i40(this.mkm_1);
  }
}
class ContentNegotiationConfig {
  constructor() {
    this.okm_1 = toMutableSet(plus(get_DefaultIgnoredTypes(), get_DefaultCommonIgnoredTypes()));
    var tmp = this;
    // Inline function 'kotlin.collections.mutableListOf' call
    tmp.pkm_1 = ArrayList.j2();
    this.qkm_1 = null;
  }
  d4k(contentType, converter, configuration) {
    var matcher = contentType.i40(Application_getInstance().v3x_1) ? JsonContentTypeMatcher_instance : defaultMatcher(this, contentType);
    this.rkm(contentType, converter, matcher, configuration);
  }
  rkm(contentTypeToSend, converter, contentTypeMatcher, configuration) {
    // Inline function 'kotlin.apply' call
    configuration(converter);
    var registration = new ConverterRegistration(converter, contentTypeToSend, contentTypeMatcher);
    this.pkm_1.e2(registration);
  }
}
class ContentConverterException extends Exception {
  constructor(message) {
    return new.target.ukm(message);
  }
  static ukm(message) {
    var $this = this.ve(message);
    captureStack($this, $this.tkm_1);
    return $this;
  }
}
class JsonContentTypeMatcher {
  nkm(contentType) {
    if (contentType.i40(Application_getInstance().v3x_1)) {
      return true;
    }
    var value = contentType.h40().toString();
    return Application_getInstance().p3y(value) && endsWith(value, '+json', true);
  }
}
//endregion
function get_LOGGER() {
...
function ContentNegotiation$lambda($this$createClientPlugin) {
  _init_properties_ContentNegotiation_kt__o183go();
  var registrations = $this$createClientPlugin.g4r_1.pkm_1;
  var ignoredTypes = $this$createClientPlugin.g4r_1.okm_1;
  $this$createClientPlugin.s4w(ContentNegotiation$lambda$slambda(registrations, $this$createClientPlugin, ignoredTypes));
  $this$createClientPlugin.q4t(ContentNegotiation$lambda$slambda_0(ignoredTypes, registrations, $this$createClientPlugin));
  return Unit_instance;
}
function ContentNegotiation$lambda$convertRequest$lambda(it) {
  _init_properties_ContentNegotiation_kt__o183go();
  return toString(it.jkm_1);
}
function *invoke$convertRequest(registrations, $this_createClientPlugin, ignoredTypes, request, body, $completion) {
  var tmp;
  if (request.q4m_1.x3p(get_ExcludedContentTypes())) {
    var excluded = request.q4m_1.v3p(get_ExcludedContentTypes());
    ...
    while (_iterator__ex2g4s.m1()) {
      ...
      $l$block_0: {
        ...
        while (_iterator__ex2g4s_0.m1()) {
          ...
          if (element.kkm_1.i40(element_0)) {
            tmp$ret$3 = false;
            break $l$block_0;
          }
        }
  ...
  var tmp0_elvis_lhs = request.n4m_1.g3s('Accept');
  ...
  while (_iterator__ex2g4s_1.m1()) {
    ...
    $l$block_2: {
      ...
      while (_iterator__ex2g4s_2.m1()) {
        ...
        if (Companion_getInstance().rw(element_2).i40(element_1.kkm_1)) {
          tmp$ret$8 = false;
          break $l$block_2;
        }
      }
    ...
    if (tmp$ret$8) {
      var qValue = $this_createClientPlugin.g4r_1.qkm_1;
      var contentTypeToSend = qValue == null ? element_1.kkm_1 : element_1.kkm_1.f40('q', qValue.toString());
      get_LOGGER().m3w('Adding Accept=' + contentTypeToSend.toString() + ' header for ' + request.l4m_1.toString());
  ...
  if (tmp_2) {
    get_LOGGER().m3w('Body type ' + toString(getKClassFromExpression(body)) + ' is in ignored types. ' + ('Skipping ContentNegotiation for ' + request.l4m_1.toString() + '.'));
    return null;
  }
  ...
  if (tmp0_elvis_lhs_0 == null) {
    ...
    get_LOGGER().m3w("Request doesn't have Content-Type header. Skipping ContentNegotiation for " + request.l4m_1.toString() + '.');
    return null;
  } else {
  ...
  if (body instanceof Unit) {
    get_LOGGER().m3w('Sending empty body for ' + request.l4m_1.toString());
    request.n4m_1.n3s('Content-Type');
  ...
  while (_iterator__ex2g4s_4.m1()) {
    ...
    if (element_4.lkm_1.nkm(contentType_0)) {
  ...
  if (tmp1_elvis_lhs == null) {
    // Inline function 'kotlin.run' call
    get_LOGGER().m3w('None of the registered converters match request Content-Type=' + contentType_0.toString() + '. ' + ('Skipping ContentNegotiation for ' + request.l4m_1.toString() + '.'));
    return null;
  } else {
  ...
  if (request.f4x() == null) {
    get_LOGGER().m3w('Request has unknown body type. Skipping ContentNegotiation for ' + request.l4m_1.toString() + '.');
    return null;
  }
  request.n4m_1.n3s('Content-Type');
  var tmp$ret$22;
  $l$block_5: {
    ...
    while (_iterator__ex2g4s_5.m1()) {
      ...
      var tmp_7 = tmp0_elvis_lhs_1 == null ? Charsets_getInstance().r3o_1 : tmp0_elvis_lhs_1;
      var tmp_8 = ensureNotNull(request.f4x());
      // Inline function 'kotlin.takeIf' call
      var tmp_9;
      ...
      var result = yield* element_5.jkm_1.vkm(contentType_0, tmp_7, tmp_8, tmp$ret$24, $completion);
      if (!(result == null)) {
        get_LOGGER().m3w('Converted request body using ' + toString(element_5.jkm_1) + ' for ' + request.l4m_1.toString());
      }
      var result_0 = result;
      if (!(result_0 == null)) {
        tmp$ret$22 = result_0;
  ...
  if (tmp2_elvis_lhs == null) {
    ...
    throw ContentConverterException.ukm(tmp_11 + joinToString(matchingRegistrations, VOID, VOID, VOID, VOID, VOID, ContentNegotiation$lambda$convertRequest$lambda));
  } else {
...
function *invoke$convertResponse(ignoredTypes, registrations, $this_createClientPlugin, requestUrl, info, body, responseContentType, charset, $completion) {
  ...
  if (!isInterface(body, ByteReadChannel)) {
    get_LOGGER().m3w('Response body is already transformed. Skipping ContentNegotiation for ' + requestUrl.toString() + '.');
    return null;
  }
  if (ignoredTypes.o2(info.b3w_1)) {
    get_LOGGER().m3w('Response body type ' + toString(info.b3w_1) + ' is in ignored types. ' + ('Skipping ContentNegotiation for ' + requestUrl.toString() + '.'));
    return null;
  }
  // Inline function 'kotlin.collections.filter' call
  // Inline function 'kotlin.collections.filterTo' call
  ...
  while (_iterator__ex2g4s.m1()) {
    var element = _iterator__ex2g4s.n1();
    if (element.lkm_1.nkm(responseContentType)) {
      destination.e2(element);
    }
  }
  ...
  if (tmp0_elvis_lhs == null) {
    // Inline function 'kotlin.run' call
    get_LOGGER().m3w('None of the registered converters match response with Content-Type=' + responseContentType.toString() + '. ' + ('Skipping ContentNegotiation for ' + requestUrl.toString() + '.'));
    return null;
  } else {
  ...
  if (!isInterface(result, ByteReadChannel)) {
    get_LOGGER().m3w('Response body was converted to ' + toString(getKClassFromExpression(result)) + ' for ' + requestUrl.toString() + '.');
  }
  return result;
}
...
function ContentNegotiation$lambda$slambda_0($ignoredTypes, $registrations, $this_createClientPlugin) {
  return constructCallableReference(function *($this$transformResponseBody, response, body, info, $completion) {
    ...
    var charset_0 = tmp1_elvis_lhs == null ? Charsets_getInstance().r3o_1 : tmp1_elvis_lhs;
    return yield* /*#__NOINLINE__*/invoke$convertResponse($ignoredTypes, $registrations, $this_createClientPlugin, get_request(response).m4n(), info, body, contentType, charset_0, $completion);
  }, 4);
}
...
protoOf(ContentNegotiationConfig).e4k = register$default;
