...
class ConverterRegistration {
  constructor(converter, contentTypeToSend, contentTypeMatcher) {
    this.fks_1 = converter;
    this.gks_1 = contentTypeToSend;
    this.hks_1 = contentTypeMatcher;
  }
}
class ContentNegotiationConfig$defaultMatcher$1 {
  ...
  jks(contentType) {
    return contentType.o40(this.iks_1);
  }
}
class ContentNegotiationConfig {
  constructor() {
    this.kks_1 = toMutableSet(plus(get_DefaultIgnoredTypes(), get_DefaultCommonIgnoredTypes()));
    var tmp = this;
    // Inline function 'kotlin.collections.mutableListOf' call
    tmp.lks_1 = ArrayList.j2();
    this.mks_1 = null;
  }
  j4k(contentType, converter, configuration) {
    var matcher = contentType.o40(Application_getInstance().b3y_1) ? JsonContentTypeMatcher_instance : defaultMatcher(this, contentType);
    this.nks(contentType, converter, matcher, configuration);
  }
  nks(contentTypeToSend, converter, contentTypeMatcher, configuration) {
    // Inline function 'kotlin.apply' call
    configuration(converter);
    var registration = new ConverterRegistration(converter, contentTypeToSend, contentTypeMatcher);
    this.lks_1.i2(registration);
  }
}
class ContentConverterException extends Exception {
  constructor(message) {
    return new.target.qks(message);
  }
  static qks(message) {
    var $this = this.xe(message);
    captureStack($this, $this.pks_1);
    return $this;
  }
}
class JsonContentTypeMatcher {
  jks(contentType) {
    if (contentType.o40(Application_getInstance().b3y_1)) {
      return true;
    }
    var value = contentType.n40().toString();
    return Application_getInstance().v3y(value) && endsWith(value, '+json', true);
  }
}
//endregion
function get_LOGGER() {
...
function ContentNegotiationConfig$_init_$ref_1ne3ob() {
  return constructCallableReference(() => new ContentNegotiationConfig(), 0, 0, 103, '<init>');
}
function ContentNegotiation$lambda($this$createClientPlugin) {
  _init_properties_ContentNegotiation_kt__o183go();
  var registrations = $this$createClientPlugin.m4r_1.lks_1;
  var ignoredTypes = $this$createClientPlugin.m4r_1.kks_1;
  $this$createClientPlugin.y4w(ContentNegotiation$lambda$slambda(registrations, $this$createClientPlugin, ignoredTypes));
  $this$createClientPlugin.w4t(ContentNegotiation$lambda$slambda_0(ignoredTypes, registrations, $this$createClientPlugin));
  return Unit_instance;
}
function ContentNegotiation$lambda$convertRequest$lambda(it) {
  _init_properties_ContentNegotiation_kt__o183go();
  return toString(it.fks_1);
}
function *invoke$convertRequest(registrations, $this_createClientPlugin, ignoredTypes, request, body, $completion) {
  var tmp;
  if (request.w4m_1.d3q(get_ExcludedContentTypes())) {
    var excluded = request.w4m_1.b3q(get_ExcludedContentTypes());
    ...
    while (_iterator__ex2g4s.m1()) {
      ...
      $l$block_0: {
        ...
        while (_iterator__ex2g4s_0.m1()) {
          ...
          if (element.gks_1.o40(element_0)) {
            tmp$ret$3 = false;
            break $l$block_0;
          }
        }
  ...
  var tmp0_elvis_lhs = request.t4m_1.j3s('Accept');
  ...
  while (_iterator__ex2g4s_1.m1()) {
    ...
    $l$block_2: {
      ...
      while (_iterator__ex2g4s_2.m1()) {
        ...
        if (Companion_getInstance().tw(element_2).o40(element_1.gks_1)) {
          tmp$ret$8 = false;
          break $l$block_2;
        }
      }
    ...
    if (tmp$ret$8) {
      var qValue = $this_createClientPlugin.m4r_1.mks_1;
      var contentTypeToSend = qValue == null ? element_1.gks_1 : element_1.gks_1.l40('q', qValue.toString());
      get_LOGGER().s3w('Adding Accept=' + contentTypeToSend.toString() + ' header for ' + request.r4m_1.toString());
  ...
  if (tmp_2) {
    get_LOGGER().s3w('Body type ' + toString(getKClassFromExpression(body)) + ' is in ignored types. ' + ('Skipping ContentNegotiation for ' + request.r4m_1.toString() + '.'));
    return null;
  }
  ...
  if (tmp0_elvis_lhs_0 == null) {
    ...
    get_LOGGER().s3w("Request doesn't have Content-Type header. Skipping ContentNegotiation for " + request.r4m_1.toString() + '.');
    return null;
  } else {
  ...
  if (body instanceof Unit) {
    get_LOGGER().s3w('Sending empty body for ' + request.r4m_1.toString());
    request.t4m_1.t3s('Content-Type');
  ...
  while (_iterator__ex2g4s_4.m1()) {
    ...
    if (element_4.hks_1.jks(contentType_0)) {
      destination_0.i2(element_4);
    }
  }
  ...
  if (tmp1_elvis_lhs == null) {
    // Inline function 'kotlin.run' call
    get_LOGGER().s3w('None of the registered converters match request Content-Type=' + contentType_0.toString() + '. ' + ('Skipping ContentNegotiation for ' + request.r4m_1.toString() + '.'));
    return null;
  } else {
  ...
  if (request.l4x() == null) {
    get_LOGGER().s3w('Request has unknown body type. Skipping ContentNegotiation for ' + request.r4m_1.toString() + '.');
    return null;
  }
  request.t4m_1.t3s('Content-Type');
  var tmp$ret$22;
  $l$block_5: {
    ...
    while (_iterator__ex2g4s_5.m1()) {
      ...
      var tmp_7 = tmp0_elvis_lhs_1 == null ? Charsets_getInstance().x3o_1 : tmp0_elvis_lhs_1;
      var tmp_8 = ensureNotNull(request.l4x());
      // Inline function 'kotlin.takeIf' call
      var tmp_9;
      ...
      var result = yield* element_5.fks_1.rks(contentType_0, tmp_7, tmp_8, tmp$ret$24, $completion);
      if (!(result == null)) {
        get_LOGGER().s3w('Converted request body using ' + toString(element_5.fks_1) + ' for ' + request.r4m_1.toString());
      }
      var result_0 = result;
      if (!(result_0 == null)) {
        tmp$ret$22 = result_0;
  ...
  if (tmp2_elvis_lhs == null) {
    ...
    throw ContentConverterException.qks(tmp_11 + joinToString(matchingRegistrations, VOID, VOID, VOID, VOID, VOID, ContentNegotiation$lambda$convertRequest$lambda));
  } else {
...
function *invoke$convertResponse(ignoredTypes, registrations, $this_createClientPlugin, requestUrl, info, body, responseContentType, charset, $completion) {
  ...
  if (!isInterface(body, ByteReadChannel)) {
    get_LOGGER().s3w('Response body is already transformed. Skipping ContentNegotiation for ' + requestUrl.toString() + '.');
    return null;
  }
  if (ignoredTypes.o2(info.h3w_1)) {
    get_LOGGER().s3w('Response body type ' + toString(info.h3w_1) + ' is in ignored types. ' + ('Skipping ContentNegotiation for ' + requestUrl.toString() + '.'));
    return null;
  }
  // Inline function 'kotlin.collections.filter' call
  // Inline function 'kotlin.collections.filterTo' call
  ...
  while (_iterator__ex2g4s.m1()) {
    var element = _iterator__ex2g4s.n1();
    if (element.hks_1.jks(responseContentType)) {
      destination.i2(element);
    }
  }
  ...
  if (tmp0_elvis_lhs == null) {
    // Inline function 'kotlin.run' call
    get_LOGGER().s3w('None of the registered converters match response with Content-Type=' + responseContentType.toString() + '. ' + ('Skipping ContentNegotiation for ' + requestUrl.toString() + '.'));
    return null;
  } else {
  ...
  if (!isInterface(result, ByteReadChannel)) {
    get_LOGGER().s3w('Response body was converted to ' + toString(getKClassFromExpression(result)) + ' for ' + requestUrl.toString() + '.');
  }
  return result;
}
...
function ContentNegotiation$lambda$slambda_0($ignoredTypes, $registrations, $this_createClientPlugin) {
  return constructCallableReference(function *($this$transformResponseBody, response, body, info, $completion) {
    ...
    var charset_0 = tmp1_elvis_lhs == null ? Charsets_getInstance().x3o_1 : tmp1_elvis_lhs;
    return yield* /*#__NOINLINE__*/invoke$convertResponse($ignoredTypes, $registrations, $this_createClientPlugin, get_request(response).s4n(), info, body, contentType, charset_0, $completion);
  }, 4);
}
...
function _init_properties_ContentNegotiation_kt__o183go() {
  if (!properties_initialized_ContentNegotiation_kt_1ayduy) {
    ...
    DefaultCommonIgnoredTypes = setOf([PrimitiveClasses_getInstance().bh(), PrimitiveClasses_getInstance().xg(), getKClass(HttpStatusCode), getKClass(ByteReadChannel), getKClass(OutgoingContent), getKClass(ClientSSESession), getKClass(ClientSSESessionWithDeserialization)]);
...
protoOf(ContentNegotiationConfig).k4k = register$default;
